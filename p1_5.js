window.ALEVEL_QUESTIONS = [
    {
        ...
        "steps": [
            "Differentiate the equation of the curve using the quotient rule, where $u = 6\\sin 2x$ and $v = 4 - \\cos 2x$:<br>$$u' = 12\\cos 2x, \\quad v' = 2\\sin 2x$$<br>$$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{12\\cos 2x(4 - \\cos 2x) - 6\\sin 2x(2\\sin 2x)}{(4 - \\cos 2x)^2} = \\dfrac{48\\cos 2x - 12(\\cos^2 2x + \\sin^2 2x)}{(4 - \\cos 2x)^2} = \\dfrac{48\\cos 2x - 12}{(4 - \\cos 2x)^2}$$",
            "Substitute $x = \\dfrac{1}{2}\\pi$ into the derivative to find the gradient of the tangent at $P$:<br>$$\\text{At } x = \\dfrac{1}{2}\\pi, \\quad 2x = \\pi, \\quad \\cos \\pi = -1$$<br>$$\\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{x=\\pi/2} = \\dfrac{48(-1) - 12}{(4 - (-1))^2} = \\dfrac{-60}{25} = -\\dfrac{12}{5}$$<br>The gradient of the normal is the negative reciprocal of the tangent gradient:<br>$$m_{\\text{normal}} = \\dfrac{5}{12}$$",
            "Use the point-gradient formula $y - y_1 = m(x - x_1)$ with the point $P\\left(\\dfrac{1}{2}\\pi, 0\\right)$ to find the equation of the normal:<br>$$y - 0 = \\dfrac{5}{12}\\left(x - \\dfrac{1}{2}\\pi\\right) \\implies y = \\dfrac{5}{12}x - \\dfrac{5}{24}\\pi$$",
            ...
            "Evaluate the first integral $I_1 = \\int_{0}^{\\pi/2} \\dfrac{6\\sin 2x}{4 - \\cos 2x} \\text{d}x$ using the substitution $u = 4 - \\cos 2x$, which gives $\\text{d}u = 2\\sin 2x \\text{d}x$:<br>$$\\text{When } x = 0, \\, u = 4 - \\cos 0 = 3 \\quad \\text{and} \\quad \\text{when } x = \\dfrac{1}{2}\\pi, \\, u = 4 - \\cos \\pi = 5$$<br>$$I_1 = \\int_{3}^{5} \\dfrac{3}{u} \\text{d}u = \\Big[ 3\\ln u \\Big]_{3}^{5} = 3\\ln 5 - 3\\ln 3 = \\ln\\left(\\dfrac{125}{27}\\right)$$$",
            "Evaluate the second integral $I_2 = \\int_{0}^{\\pi/2} \\left( \\dfrac{5}{12}x - \\dfrac{5\\pi}{24} \\right) \\text{d}x$:<br>$$I_2 = \\left[ \\dfrac{5}{24}x^2 - \\dfrac{5\\pi}{24}x \\right]_{0}^{\\pi/2} = \\dfrac{5}{24}\\left(\\dfrac{\\pi^2}{4}\\right) - \\dfrac{5\\pi}{24}\\left(\\dfrac{\\pi}{2}\\right) = \\dfrac{5\\pi^2}{96} - \\dfrac{10\\pi^2}{96} = -\\dfrac{5\\pi^2}{96}$$<br>Subtracting $I_2$ from $I_1$ yields the final exact area:<br>$$A = I_1 - I_2 = \\ln\\left(\\dfrac{125}{27}\\right) - \\left(-\\dfrac{5\\pi^2}{96}\\right) = \\ln\\left(\\dfrac{125}{27}\\right) + \\dfrac{5}{96}\\pi^2$$<br><br>Final Answer: $$y = \\dfrac{5}{12}x - \\dfrac{5\\pi}{24}, \\quad \\text{Area} = \\ln\\left(\\dfrac{125}{27}\\right) + \\dfrac{5}{96}\\pi^2$$"
        ],
        "pi_options": [
            {
            ...
            },
            {
                ...
                "feedback": "Be careful with your signs when subtracting the two integrals. The second integral $I_2$ evaluates to $-\\dfrac{5}{96}\\pi^2$. Subtracting this negative quantity from $I_1$ yields a positive addition: $I_1 - I_2 = I_1 - \\left(-\\dfrac{5\\pi^2}{96}\\right) = I_1 + \\dfrac{5}{96}\\pi^2$."
            }
        ],
        "bradley_insight": {
            "type": "pro-tip",
    ...
    },
    {
        ...
        "steps": [
            ...
            "Differentiate the equation of the curve using the quotient rule, where $u = 2x+1$ and $v = x^2+x+2$:<br>$$u' = 2, \\quad v' = 2x + 1$$<br>$$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{2(x^2 + x + 2) - (2x + 1)(2x + 1)}{(x^2 + x + 2)^2} = \\dfrac{2x^2 + 2x + 4 - (4x^2 + 4x + 1)}{(x^2 + x + 2)^2} = \\dfrac{-2x^2 - 2x + 3}{(x^2 + x + 2)^2}$$",
            ...
            "Find the equation of the normal line using the point-gradient formula with $P\\left(1, \\dfrac{3}{4}\\right)$:<br>$$y - \\dfrac{3}{4} = 16(x - 1) \\implies y = 16x - 16 + \\dfrac{3}{4} \\implies y = 16x - \\dfrac{61}{4}$$",
            ...
            "Evaluate the curve integral $I_1 = \\int_{0}^{1} \\dfrac{2x + 1}{x^2 + x + 2} \\text{d}x$ using the logarithmic substitution $u = x^2 + x + 2$, where $\\text{d}u = (2x + 1)\\text{d}x$:<br>$$I_1 = \\Big[ \\ln(x^2 + x + 2) \\Big]_{0}^{1} = \\ln 4 - \\ln 2 = \\ln\\left(\\dfrac{4}{2}\\right) = \\ln 2$$",
            "Evaluate the normal line integral $I_2 = \\int_{0}^{1} \\left( 16x - \\dfrac{61}{4} \\right) \\text{d}x$:<br>$$I_2 = \\left[ 8x^2 - \\dfrac{61}{4}x \\right]_{0}^{1} = 8 - \\dfrac{61}{4} = -\\dfrac{29}{4}$$<br>Subtracting the two results gives the final exact area:<br>$$A = I_1 - I_2 = \\ln 2 - \\left(-\\dfrac{29}{4}\\right) = \\ln 2 + \\dfrac{29}{4}$$<br><br>Final Answer: $$y = 16x - \\dfrac{61}{4}, \\quad \\text{Area} = \\ln 2 + \\dfrac{29}{4}$$"
        ],
        "pi_options": [
            {
    ...
    },
    {
        ...
        "steps": [
            ...
            "Differentiate the equation of the curve using the product rule:<br>$$\\dfrac{\\text{d}y}{\\text{d}x} = 8\\cos x \\cos^3 x + 8\\sin x \\left(3\\cos^2 x(-\\sin x)\\right) = 8\\cos^4 x - 24\\sin^2 x \\cos^2 x$$<br>Factorizing using $\\sin^2 x = 1 - \\cos^2 x$ gives:<br>$$\\dfrac{\\text{d}y}{\\text{d}x} = 8\\cos^2 x(\\cos^2 x - 3(1 - \\cos^2 x)) = 8\\cos^2 x(4\\cos^2 x - 3)$$",
            ...
            "Use the point-gradient formula with $P\\left(\\dfrac{1}{3}\\pi, \\dfrac{\\sqrt{3}}{2}\\right)$ to obtain the equation of the normal:<br>$$y - \\dfrac{\\sqrt{3}}{2} = \\dfrac{1}{4}\\left(x - \\dfrac{1}{3}\\pi\\right) \\implies y = \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2}$$",
            ...
            "Evaluate the first integral $I_1 = \\int_{0}^{\\pi/3} 8\\sin x \\cos^3 x \\text{d}x$ using substitution with $u = \\cos x$, which gives $\\text{d}u = -\\sin x \\text{d}x$:<br>$$\\text{When } x = 0, \\, u = 1 \\quad \\text{and} \\quad \\text{when } x = \\dfrac{1}{3}\\pi, \\, u = \\dfrac{1}{2}$$<br>$$I_1 = \\int_{1/2}^{1} 8u^3 \\text{d}u = \\Big[ 2u^4 \\Big]_{1/2}^{1} = 2(1)^4 - 2\\left(\\dfrac{1}{2}\\right)^4 = 2 - \\dfrac{1}{8} = \\dfrac{15}{8}$$",
            "Evaluate the second integral $I_2 = \\int_{0}^{\\pi/3} \\left( \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2} \\right) \\text{d}x$:<br>$$I_2 = \\left[ \\dfrac{1}{8}x^2 + \\left( \\dfrac{\\sqrt{3}}{2} - \\dfrac{\\pi}{12} \\right)x \\right]_{0}^{\\pi/3} = \\dfrac{1}{8}\\left(\\dfrac{\\pi^2}{9}\\right) + \\left( \\dfrac{\\sqrt{3}}{2} - \\dfrac{\\pi}{12} \\right)\\left(\\dfrac{\\pi}{3}\\right) = \\dfrac{\\sqrt{3}\\pi}{6} - \\dfrac{\\pi^2}{72}$$<br>Subtracting $I_2$ from $I_1$ yields the final exact area:<br>$$A = I_1 - I_2 = \\dfrac{15}{8} - \\left( \\dfrac{\\sqrt{3}\\pi}{6} - \\dfrac{\\pi^2}{72} \\right) = \\dfrac{15}{8} - \\dfrac{\\sqrt{3}}{6}\\pi + \\dfrac{1}{72}\\pi^2$$<br><br>Final Answer: $$y = \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2}, \\quad \\text{Area} = \\dfrac{15}{8} - \\dfrac{\\sqrt{3}}{6}\\pi + \\dfrac{1}{72}\\pi^2$$"
        ],
        "pi_options": [
            {
    ...
    },
    {
        ...
        "steps": [
            ...
            "Differentiate the parametric equations with respect to $t$ to find $\\dfrac{\\text{d}y}{\\text{d}x}$:<br>$$\\dfrac{\\text{d}x}{\\text{d}t} = \\cos t, \\quad \\dfrac{\\text{d}y}{\\text{d}t} = 2\\cos 2t \\implies \\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{2\\cos 2t}{\\cos t}$$<br>Substitute $t = \\dfrac{1}{6}\\pi$ to find the tangent gradient:<br>$$\\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{t=\\pi/6} = \\dfrac{2\\cos\\left(\\dfrac{1}{3}\\pi\\right)}{\\cos\\left(\\dfrac{1}{6}\\pi\\right)} = \\dfrac{2\\left(\\dfrac{1}{2}\\right)}{\\dfrac{\\sqrt{3}}{2}} = \\dfrac{2}{\\sqrt{3}}$$",
            "Find the normal gradient, which is the negative reciprocal of the tangent gradient:<br>$$m_{\\text{normal}} = -\\dfrac{\\sqrt{3}}{2}$$<br>Use the point-gradient formula with $\\left(\\dfrac{1}{2}, \\dfrac{\\sqrt{3}}{2}\\right)$ to get the equation of the normal:<br>$$y - \\dfrac{\\sqrt{3}}{2} = -\\dfrac{\\sqrt{3}}{2}\\left(x - \\dfrac{1}{2}\\right) \\implies y = -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4}$$",
            ...
            "Evaluate the parametric curve area $A_1 = \\int_{0}^{1} y \\text{d}x$ by changing the variable to $t$ where $\\text{d}x = \\cos t \\text{d}t$:<br>$$A_1 = \\int_{0}^{\\pi/2} (\\sin 2t)(\\cos t) \\text{d}t = \\int_{0}^{\\pi/2} 2\\sin t \\cos^2 t \\text{d}t$$<br>Using substitution $u = \\cos t$, $\\text{d}u = -\\sin t \\text{d}t$, the limits are $u(0) = 1$ and $u(\\pi/2) = 0$:<br>$$A_1 = \\int_{0}^{1} 2u^2 \\text{d}u = \\left[ \\dfrac{2}{3}u^3 \\right]_{0}^{1} = \\dfrac{2}{3}$$",
            "Evaluate the normal line area $A_2 = \\int_{1}^{3/2} \\left( -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4} \\right) \\text{d}x$:<br>$$A_2 = \\left[ -\\dfrac{\\sqrt{3}}{4}x^2 + \\dfrac{3\\sqrt{3}}{4}x \\right]_{1}^{3/2} = \\left( -\\dfrac{9\\sqrt{3}}{16} + \\dfrac{9\\sqrt{3}}{8} \\right) - \\left( -\\dfrac{\\sqrt{3}}{4} + \\dfrac{3\\sqrt{3}}{4} \\right) = \\dfrac{\\sqrt{3}}{16}$$<br>Summing $A_1$ and $A_2$ yields the total exact area:<br>$$\\text{Area} = \\dfrac{2}{3} + \\dfrac{\\sqrt{3}}{16}$$<br><br>Final Answer: $$y = -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4}, \\quad \\text{Area} = \\dfrac{2}{3} + \\dfrac{\\sqrt{3}}{16}$$"
        ],
        "pi_options": [
            {
    ...
    },
    {
        ...
        "steps": [
            ...
            "Differentiate the curve's equation using the product rule:<br>$$\\dfrac{\\text{d}y}{\\text{d}x} = 4\\ln(2x) + 4x\\left(\\dfrac{2}{2x}\\right) = 4\\ln(2x) + 4$$<br>Substitute $x = \\dfrac{1}{2}e$ to find the tangent gradient at $P$:<br>$$\\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{x=e/2} = 4\\ln e + 4 = 8$$<br>The gradient of the normal is the negative reciprocal of the tangent gradient, which is $-\\dfrac{1}{8}$.",
            "Use the point-gradient formula with $P\\left(\\dfrac{1}{2}e, 2e\\right)$ to get the equation of the normal:<br>$$y - 2e = -\\dfrac{1}{8}\\left(x - \\dfrac{1}{2}e\\right) \\implies y = -\\dfrac{1}{8}x + \\dfrac{e}{16} + 2e \\implies y = -\\dfrac{1}{8}x + \\dfrac{33e}{16}$$",
            ...
            "Evaluate $A_1 = \\int_{1/2}^{e/2} 4x\\ln(2x) \\text{d}x$ using integration by parts with $u = \\ln(2x)$ and $\\text{d}v = 4x \\text{d}x$:<br>$$\\text{d}u = \\dfrac{1}{x} \\text{d}x, \\quad v = 2x^2$$<br>$$\\int 4x\\ln(2x) \\text{d}x = 2x^2\\ln(2x) - \\int 2x \\text{d}x = 2x^2\\ln(2x) - x^2$$<br>Evaluating this from $x = \\dfrac{1}{2}$ to $x = \\dfrac{1}{2}e$:<br>$$A_1 = \\left( 2\\left(\\dfrac{e}{2}\\right)^2\\ln e - \\left(\\dfrac{e}{2}\\right)^2 \\right) - \\left( 2\\left(\\dfrac{1}{2}\\right)^2\\ln 1 - \\left(\\dfrac{1}{2}\\right)^2 \\right) = \\left( \\dfrac{e^2}{2} - \\dfrac{e^2}{4} \\right) - \\left( 0 - \\dfrac{1}{4} \\right) = \\dfrac{e^2}{4} + \\dfrac{1}{4}$$",
            "Evaluate $A_2 = \\int_{e/2}^{33e/2} \\left( -\\dfrac{1}{8}x + \\dfrac{33e}{16} \\right) \\text{d}x$. Since this region is a right-angled triangle with base $\\dfrac{33e}{2} - \\dfrac{e}{2} = 16e$ and height $2e$:<br>$$A_2 = \\dfrac{1}{2} \\times 16e \\times 2e = 16e^2$$<br>Summing the two areas gives the final exact area:<br>$$\\text{Area} = A_1 + A_2 = \\left( \\dfrac{e^2}{4} + \\dfrac{1}{4} \\right) + 16e^2 = \\dfrac{65}{4}e^2 + \\dfrac{1}{4}$$<br><br>Final Answer: $$y = -\\dfrac{1}{8}x + \\dfrac{33e}{16}, \\quad \\text{Area} = \\dfrac{65}{4}e^2 + \\dfrac{1}{4}$$"
        ],
        "pi_options": [
            {
