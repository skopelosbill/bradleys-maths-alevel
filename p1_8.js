window.ALEVEL_QUESTIONS = [
    {
        ...
        "steps": [
            ...
            "<strong>Step 2: Solve for the stationary points</strong><br>Set the first derivative equal to zero to find the critical values of $x$:<br>\\begin{aligned}\n3x^2 - 12x &= 0 \\cr\n3x(x - 4) &= 0 \\cr\nx = 0 \\quad &\\text{or} \\quad x = 4\n\\end{aligned}<br>Substitute these values of $x$ back into the original equation to find their corresponding $y$-coordinates:<ul><li>For $x = 0$:<br>\\begin{aligned}\ny &= 0^3 - 6(0)^2 \\cr\ny &= 0 \\implies (0, 0)\n\\end{aligned}</li><li>For $x = 4$:<br>\\begin{aligned}\ny &= 4^3 - 6(4)^2 \\cr\ny &= 64 - 96 \\cr\ny &= -32 \\implies (4, -32)\n\\end{aligned}</li></ul>",
            "<strong>Step 3: Determine the nature of the stationary points</strong><br>Find the second derivative of the function:<br>\\begin{aligned}\n\\dfrac{\\text{d}^2y}{\\text{d}x^2} &= 6x - 12\n\\end{aligned}<br>Evaluate the second derivative at each critical point:<ul><li>At $x = 0$:<br>\\begin{aligned}\n\\dfrac{\\text{d}^2y}{\\text{d}x^2} &= 6(0) - 12 \\cr\n\\dfrac{\\text{d}^2y}{\\text{d}x^2} &= -12 < 0 \\implies (0, 0) \\text{ is a local maximum}\n\\end{aligned}</li><li>At $x = 4$:<br>\\begin{aligned}\n\\dfrac{\\text{d}^2y}{\\text{d}x^2} &= 6(4) - 12 \\cr\n\\dfrac{\\text{d}^2y}{\\text{d}x^2} &= 12 > 0 \\implies (4, -32) \\text{ is a local minimum}\n\\end{aligned}</li></ul>",
            "<strong>Step 4: Find the coordinate intercepts and sketch the curve</strong><br>Find where the curve crosses the axes:<br>To find the $y$-intercept, set $x = 0$:<br>\\begin{aligned}\ny &= 0^3 - 6(0)^2 \\cr\ny &= 0 \\implies (0, 0)\n\\end{aligned}<br>To find the $x$-intercepts, set $y = 0$:<br>\\begin{aligned}\nx^3 - 6x^2 &= 0 \\cr\nx^2(x - 6) &= 0\n\\end{aligned}<br>This gives the intercepts $x = 0$ (touching point) and $x = 6$ (crossing point) at:<br>$$(0, 0) \\quad \\text{and} \\quad (6, 0)$$Using these key features, the sketch of the curve $C$ is shown below:<br><br><img src='images/p1/004351_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
    ...
    },
    {
        ...
        "steps": [
            ...
            "<strong>Step 2: Find the stationary points</strong><br>Set the derivative equal to zero to find the critical values of $x$:<br>\\begin{aligned}\n12 - 3x^2 &= 0 \\cr\n3(4 - x^2) &= 0 \\cr\nx = 2 \\quad &\\text{or} \\quad x = -2\n\\end{aligned}<br>Substitute these back into the original equation to find their $y$-coordinates:<ul><li>For $x = 2$:<br>\\begin{aligned}\ny &= 12(2) - 2^3 \\cr\ny &= 24 - 8 \\cr\ny &= 16 \\implies (2, 16)\n\\end{aligned}</li><li>For $x = -2$:<br>\\begin{aligned}\ny &= 12(-2) - (-2)^3 \\cr\ny &= -24 - (-8) \\cr\ny &= -16 \\implies (-2, -16)\n\\end{aligned}</li></ul>",
            "<strong>Step 3: Determine the nature of the stationary points</strong><br>Find the second derivative of the curve:<br>\\begin{aligned}\n\\dfrac{\\text{d}^2y}{\\text{d}x^2} &= -6x\n\\end{aligned}<br>Evaluate the second derivative at each critical point:<ul><li>At $x = 2$:<br>\\begin{aligned}\n\\dfrac{\\text{d}^2y}{\\text{d}x^2} &= -6(2) \\cr\n\\dfrac{\\text{d}^2y}{\\text{d}x^2} &= -12 < 0 \\implies (2, 16) \\text{ is a local maximum}\n\\end{aligned}</li><li>At $x = -2$:<br>\\begin{aligned}\n\\dfrac{\\text{d}^2y}{\\text{d}x^2} &= -6(-2) \\cr\n\\dfrac{\\text{d}^2y}{\\text{d}x^2} &= 12 > 0 \\implies (-2, -16) \\text{ is a local minimum}\n\\end{aligned}</li></ul>",
            "<strong>Step 4: Determine coordinate intercepts and sketch</strong><br>Find where the curve crosses the axes:<br>To find the $y$-intercept, set $x = 0$:<br>\\begin{aligned}\ny &= 12(0) - 0^3 \\cr\ny &= 0 \\implies (0, 0)\n\\end{aligned}<br>To find the $x$-intercepts, set $y = 0$:<br>\\begin{aligned}\n12x - x^3 &= 0 \\cr\nx(12 - x^2) &= 0\n\\end{aligned}<br>This gives the intercepts $x = 0$ or $x = \\pm\\sqrt{ 12 } \\approx \\pm 3.46$.<br>Using these features, the sketch of the curve $C$ is shown below:<br><br><img src='images/p1/004353_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
    ...
    },
    {
        ...
        "steps": [
            "<strong>Step 1: Sketch the primary curve $y = f(x)$</strong><br>The function $f(x) = 9 - x^2$ is an inverted parabola (negative quadratic). To find the intercepts and turning point:<ul><li>The maximum turning point lies at $(0, 9)$.</li><li>The $y$-intercept is $(0, 9)$.</li><li>To find the $x$-intercepts, set $y = 0$:<br>\\begin{aligned}\n9 - x^2 &= 0 \\cr\nx^2 &= 9 \\cr\nx &= \\pm 3 \\implies (3, 0) \\text{ and } (-3, 0)\n\\end{aligned}</li></ul>",
