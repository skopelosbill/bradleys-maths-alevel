...
},
{
  ...
  },
  {
    ...
    "Final Answer: <strong>(a)</strong> $3(x+1)^2 + 5$ <strong>(b)</strong> Turning Point: $(-1,5)$, $y$-intercept: $(0,8)$ <strong>(c)(i)</strong> Translation by \\( \\begin{pmatrix} 2 \\cr -3 \\end{pmatrix} \\) <strong>(c)(ii)</strong> $0 < h(x) \\le 3$"    
    ],
    "pi_options": [
        {
