window.ALEVEL_QUESTIONS = [
    ...
    },
    {
        ...
        "steps": [
            "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 15\\text{e}^{-0.5x}$ and $v = \\sin x$:<br>$$u' = -7.5\\text{e}^{-0.5x}$$<br>$$v' = \\cos x$$<br>$$\\text{f}'(x) = u'v + uv' = -7.5\\text{e}^{-0.5x}\\sin x + 15\\text{e}^{-0.5x}\\cos x$$",
    ...
    },
    {
        ...
        "steps": [
            "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 8\\text{e}^{-0.2x}$ and $v = \\sin x$:<br>$$u' = -1.6\\text{e}^{-0.2x}$$<br>$$v' = \\cos x$$<br>$$\\text{f}'(x) = u'v + uv' = -1.6\\text{e}^{-0.2x}\\sin x + 8\\text{e}^{-0.2x}\\cos x$$",
    ...
    },
    {
        ...
        "steps": [
            "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 12\\text{e}^{-\\frac{1}{3}x}$ and $v = \\sin x$:<br>$$u' = -4\\text{e}^{-\\frac{1}{3}x}$$<br>$$v' = \\cos x$$<br>$$\\text{f}'(x) = u'v + uv' = -4\\text{e}^{-\\frac{1}{3}x}\\sin x + 12\\text{e}^{-\\frac{1}{3}x}\\cos x$$",
    ...
    },
    {
        ...
        "steps": [
            "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 6\\text{e}^{-0.125x}$ and $v = \\sin x$:<br>$$u' = -0.75\\text{e}^{-0.125x}$$<br>$$v' = \\cos x$$<br>$$\\text{f}'(x) = u'v + uv' = -0.75\\text{e}^{-0.125x}\\sin x + 6\\text{e}^{-0.125x}\\cos x$$",
    ...
    },
    {
        ...
        "steps": [
            "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 20\\text{e}^{-\\frac{1}{6}x}$ and $v = \\sin x$:<br>$$u' = -\\frac{10}{3}\\text{e}^{-\\frac{1}{6}x}$$<br>$$v' = \\cos x$$<br>$$\\text{f}'(x) = u'v + uv' = -\\frac{10}{3}\\text{e}^{-\\frac{1}{6}x}\\sin x + 20\\text{e}^{-\\frac{1}{6}x}\\cos x$$",
    ...
    },
    {
        ...
        "steps": [
            "<strong>Part (a):</strong> We differentiate our equation, $x = 5\\sin 3y$, implicitly with respect to $x$:<br>$$\\dfrac{\\text{d}}{\\text{d}x}(x) = \\dfrac{\\text{d}}{\\text{d}x}(5\\sin 3y)$$<br>$$1 = 5\\cos 3y \\cdot \\left(3\\dfrac{\\text{d}y}{\\text{d}x}\\right)$$<br>$$1 = 15\\cos 3y \\cdot \\dfrac{\\text{d}y}{\\text{d}x} \\implies \\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{1}{15\\cos 3y}$$",
