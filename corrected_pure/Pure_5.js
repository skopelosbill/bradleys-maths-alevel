window.ALEVEL_QUESTIONS = [
        {
                ...
                "steps": [
                        "Differentiate the equation of the curve using the quotient rule, where $u = 6\\sin 2x$ and $v = 4 - \\cos 2x$:<br>\\begin{aligned}\nu' &= 12\\cos 2x, \\quad v' \\cr\n&= 2\\sin 2x\n\\end{aligned}<br>We apply the quotient rule to find the derivative:<br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{12\\cos 2x(4 - \\cos 2x) - 6\\sin 2x(2\\sin 2x)}{(4 - \\cos 2x)^2} \\\\\\ &= \\dfrac{48\\cos 2x - 12\\cos^2 2x - 12\\sin^2 2x}{(4 - \\cos 2x)^2} \\\\\\ &= \\dfrac{48\\cos 2x - 12(\\cos^2 2x + \\sin^2 2x)}{(4 - \\cos 2x)^2} \\\\\\ &= \\dfrac{48\\cos 2x - 12}{(4 - \\cos 2x)^2} \\end{aligned}$$",
                        "Substitute $x = \\dfrac{1}{2}\\pi$ into the derivative to find the gradient of the tangent at $P$:<br>\\begin{aligned}\n\\text{At } x &= \\dfrac{1}{2}\\pi, \\quad 2x \\cr\n&= \\pi, \\quad \\cos \\pi \\cr\n&= -1\n\\end{aligned}<br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{x=\\pi/2} &= \\dfrac{48(-1) - 12}{(4 - (-1))^2} \\\\\\ &= \\dfrac{-60}{25} \\\\\\ &= -\\dfrac{12}{5} \\end{aligned}$$<br>The gradient of the normal is the negative reciprocal of the tangent gradient:<br>$$m_{\\text{normal}} = \\dfrac{5}{12}$$",
        ...
        },
        {
                ...
                "steps": [
                        "Find the coordinates of the point $P$. Substitute $x = 1$ into the curve's equation:<br>\\begin{aligned}\ny &= \\dfrac{2(1) + 1}{1^2 + 1 + 2} \\cr\n&= \\dfrac{3}{4}\n\\end{aligned}<br>So the coordinates of $P$ are $\\left(1, \\dfrac{3}{4}\\right)$.",
                        "Differentiate the equation of the curve using the quotient rule, where $u = 2x+1$ and $v = x^2+x+2$:<br>\\begin{aligned}\nu' &= 2, \\quad v' \\cr\n&= 2x + 1\n\\end{aligned}<br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{2(x^2 + x + 2) - (2x + 1)(2x + 1)}{(x^2 + x + 2)^2} \\\\\\ &= \\dfrac{2x^2 + 2x + 4 - (4x^2 + 4x + 1)}{(x^2 + x + 2)^2} \\\\\\ &= \\dfrac{-2x^2 - 2x + 3}{(x^2 + x + 2)^2} \\end{aligned}$$",
                        "Substitute $x = 1$ into the derivative to find the tangent gradient at $P$:<br>\\begin{aligned}\n\\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{x = 1} \\cr\n&= \\dfrac{-2(1)^2 - 2(1) + 3}{(1^2 + 1 + 2)^2} \\cr\n&= \\dfrac{-1}{16}\n\\end{aligned}<br>The gradient of the normal is the negative reciprocal of the tangent gradient, which is $16$.",
                        ...
                        "Set up the integral for the area bounded by the curve, the normal, and the $y$-axis from $x = 0$ to $x = 1$. Since the curve lies above the normal in this interval, the area is:<br>\\begin{aligned}\nA &= \\int_{0}^{1} \\left( \\dfrac{2x + 1}{x^2 + x + 2} - \\left( 16x - \\dfrac{61}{4} \\right) \\right) \\text{d}x \\cr\n&= I_1 - I_2\n\\end{aligned}",
                        ...
                        "Evaluate the normal line integral $I_2 = \\int_{0}^{1} \\left( 16x - \\dfrac{61}{4} \\right) \\text{d}x$:<br>$$\\begin{aligned} I_2 &= \\left[ 8x^2 - \\dfrac{61}{4}x \\right]_{0}^{1} \\\\\\ &= 8 - \\dfrac{61}{4} \\\\\\ &= -\\dfrac{29}{4} \\end{aligned}$$<br>Subtracting the two results gives the final exact area:<br>$$\\begin{aligned} A &= I_1 - I_2 \\\\\\ &= \\ln 2 - \\left(-\\dfrac{29}{4}\\right) \\\\\\ &= \\ln 2 + \\dfrac{29}{4} \\end{aligned}$$",
                "Final Answer: \\begin{aligned}\ny &= 16x - \\dfrac{61}{4}, \\quad \\text{Area} \\cr\n&= \\ln 2 + \\dfrac{29}{4}\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        "Find the coordinates of the point $P$. Substitute $x = \\dfrac{1}{3}\\pi$ into the curve's equation:<br>\\begin{aligned}\ny &= 8\\sin\\left(\\dfrac{1}{3}\\pi\\right)\\cos^3\\left(\\dfrac{1}{3}\\pi\\right) \\cr\n&= 8\\left(\\dfrac{\\sqrt{3}}{2}\\right)\\left(\\dfrac{1}{2}\\right)^3 \\cr\n&= \\dfrac{\\sqrt{3}}{2}\n\\end{aligned}<br>The coordinates of $P$ are $\\left(\\dfrac{1}{3}\\pi, \\dfrac{\\sqrt{3}}{2}\\right)$.",
                        ...
                        "Substitute $x = \\dfrac{1}{3}\\pi$ into the derivative to find the tangent gradient at $P$:<br>\\begin{aligned}\n\\cos\\left(\\dfrac{1}{3}\\pi\\right) &= \\dfrac{1}{2} \\cr\n\\cos^2\\left(\\dfrac{1}{3}\\pi\\right) &= \\dfrac{1}{4}\n\\end{aligned}<br>\\begin{aligned}\n\\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{x = \\pi/3} \\cr\n&= 8\\left(\\dfrac{1}{4}\\right)\\left(4\\left(\\dfrac{1}{4}\\right) - 3\\right) \\cr\n&= 2(1 - 3) \\cr\n&= -4\n\\end{aligned}<br>The gradient of the normal is the negative reciprocal of the tangent gradient, which is $\\dfrac{1}{4}$.",
                        ...
                        "Set up the integral for the area bounded by the curve, the normal, and the $y$-axis from $x = 0$ to $x = \\dfrac{1}{3}\\pi$. The curve lies above the normal, so:<br>\\begin{aligned}\nA &= \\int_{0}^{\\pi/3} \\left( 8\\sin x \\cos^3 x - \\left( \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2} \\right) \\right) \\text{d}x \\cr\n&= I_1 - I_2\n\\end{aligned}",
                        "Evaluate the first integral $I_1 = \\int_{0}^{\\pi/3} 8\\sin x \\cos^3 x \\text{d}x$ using substitution with $u = \\cos x$, which gives $\\text{d}u = -\\sin x \\text{d}x$:<br>\\begin{aligned}\n\\text{When } x &= 0, \\, u \\cr\n&= 1 \\quad \\text{and} \\quad \\text{when } x \\cr\n&= \\dfrac{1}{3}\\pi, \\, u \\cr\n&= \\dfrac{1}{2}\n\\end{aligned}<br>$$\\begin{aligned} I_1 &= \\int_{1/2}^{1} 8u^3 \\text{d}u \\\\\\ &= \\Big[ 2u^4 \\Big]_{1/2}^{1} \\\\\\ &= 2(1)^4 - 2\\left(\\dfrac{1}{2}\\right)^4 \\\\\\ &= 2 - \\dfrac{1}{8} \\\\\\ &= \\dfrac{15}{8} \\end{aligned}$$",
                        "Evaluate the second integral $I_2 = \\int_{0}^{\\pi/3} \\left( \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2} \\right) \\text{d}x$:<br>$$\\begin{aligned} I_2 &= \\left[ \\dfrac{1}{8}x^2 + \\left( \\dfrac{\\sqrt{3}}{2} - \\dfrac{\\pi}{12} \\right)x \\right]_{0}^{\\pi/3} \\\\\\ &= \\dfrac{1}{8}\\left(\\dfrac{\\pi^2}{9}\\right) + \\left( \\dfrac{\\sqrt{3}}{2} - \\dfrac{\\pi}{12} \\right)\\left(\\dfrac{\\pi}{3}\\right) \\\\\\ &= \\dfrac{\\pi^2}{72} + \\dfrac{\\sqrt{3}\\pi}{6} - \\dfrac{\\pi^2}{36} \\\\\\ &= \\dfrac{\\sqrt{3}\\pi}{6} - \\dfrac{\\pi^2}{72} \\end{aligned}$$<br>Subtracting $I_2$ from $I_1$ yields the final exact area:<br>$$\\begin{aligned} A &= I_1 - I_2 \\\\\\ &= \\dfrac{15}{8} - \\left( \\dfrac{\\sqrt{3}\\pi}{6} - \\dfrac{\\pi^2}{72} \\right) \\\\\\ &= \\dfrac{15}{8} - \\dfrac{\\sqrt{3}\\\\6}\\pi + \\dfrac{1}{72}\\pi^2 \\end{aligned}$$",
                "Final Answer: \\begin{aligned}\ny &= \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2}, \\quad \\text{Area} \\cr\n&= \\dfrac{15}{8} - \\dfrac{\\sqrt{3}}{6}\\pi + \\dfrac{1}{72}\\pi^2\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        "Find the coordinates of the point at $t = \\dfrac{1}{6}\\pi$:<br>\\begin{aligned}\nx &= \\sin\\left(\\dfrac{1}{6}\\pi\\right) \\cr\n&= \\dfrac{1}{2}, \\quad y \\cr\n&= \\sin\\left(\\dfrac{1}{3}\\pi\\right) \\cr\n&= \\dfrac{\\sqrt{3}}{2}\n\\end{aligned}<br>The point is $\\left(\\dfrac{1}{2}, \\dfrac{\\sqrt{3}}{2}\\right)$.",
                        "Differentiate the parametric equations with respect to $t$ to find $\\dfrac{\\text{d}y}{\\text{d}x}$:<br>\\begin{aligned}\n\\dfrac{\\text{d}x}{\\text{d}t} &= \\cos t, \\quad \\dfrac{\\text{d}y}{\\text{d}t} = 2\\cos 2t \\cr\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{2\\cos 2t}{\\cos t}\n\\end{aligned}<br>Substitute $t = \\dfrac{1}{6}\\pi$ to find the tangent gradient:<br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{t=\\pi/6} &= \\dfrac{2\\cos\\left(\\dfrac{1}{3}\\pi\\right)}{\\cos\\left(\\dfrac{1}{6}\\pi\\right)} \\\\\\ &= \\dfrac{2\\left(\\dfrac{1}{2}\\right)}{\\dfrac{\\sqrt{3}}{2}} \\\\\\ &= \\dfrac{2}{\\sqrt{3}} \\end{aligned}$$",
                ...
                "Final Answer: \\begin{aligned}\ny &= -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4}, \\quad \\text{Area} \\cr\n&= \\dfrac{2}{3} + \\dfrac{\\sqrt{3}}{16}\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        "Find the coordinates of the point $P$. Substitute $x = \\dfrac{1}{2}e$ into the curve's equation:<br>\\begin{aligned}\ny &= 4\\left(\\dfrac{1}{2}e\\right)\\ln\\left(2\\left(\\dfrac{1}{2}e\\right)\\right) \\cr\n&= 2e\\ln e \\cr\n&= 2e\n\\end{aligned}<br>So the coordinates of $P$ are $\\left(\\dfrac{1}{2}e, 2e\\right)$.",
                        "Differentiate the curve's equation using the product rule:<br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= 4\\ln(2x) + 4x\\left(\\dfrac{2}{2x}\\right) \\\\\\ &= 4\\ln(2x) + 4 \\end{aligned}$$<br>Substitute $x = \\dfrac{1}{2}e$ to find the tangent gradient at $P$:<br>\\begin{aligned}\n\\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{x = e/2} \\cr\n&= 4\\ln e + 4 \\cr\n&= 8\n\\end{aligned}<br>The gradient of the normal is the negative reciprocal of the tangent gradient, which is $-\\dfrac{1}{8}$.",
                        ...
                        "Evaluate $A_1 = \\int_{1/2}^{e/2} 4x\\ln(2x) \\text{d}x$ using integration by parts with $u = \\ln(2x)$ and $\\text{d}v = 4x \\text{d}x$:<br>\\begin{aligned}\n\\text{d}u &= \\dfrac{1}{x} \\text{d}x, \\quad v \\cr\n&= 2x^2\n\\end{aligned}<br>$$\\begin{aligned} \\int 4x\\ln(2x) \\text{d}x &= 2x^2\\ln(2x) - \\int 2x^2\\left(\\dfrac{1}{x}\\right) \\text{d}x \\\\\\ &= 2x^2\\ln(2x) - \\int 2x \\text{d}x \\\\\\ &= 2x^2\\ln(2x) - x^2 \\end{aligned}$$<br>Evaluating this from $x = \\dfrac{1}{2}$ to $x = \\dfrac{1}{2}e$:<br>$$\\begin{aligned} A_1 &= \\left( 2\\left(\\dfrac{e}{2}\\right)^2\\ln e - \\left(\\dfrac{e}{2}\\right)^2 \\right) - \\left( 2\\left(\\dfrac{1}{2}\\right)^2\\ln 1 - \\left(\\dfrac{1}{2}\\right)^2 \\right) \\\\\\ &= \\left( \\dfrac{e^2}{2} - \\dfrac{e^2}{4} \\right) - \\left( 0 - \\dfrac{1}{4} \\right) \\\\\\ &= \\dfrac{e^2}{4} + \\dfrac{1}{4} \\end{aligned}$$",
                        "Evaluate $A_2 = \\int_{e/2}^{33e/2} \\left( -\\dfrac{1}{8}x + \\dfrac{33e}{16} \\right) \\text{d}x$. Since this region is a right-angled triangle with base $\\dfrac{33e}{2} - \\dfrac{e}{2} = 16e$ and height $2e$:<br>\\begin{aligned}\nA_2 &= \\dfrac{1}{2} \\times 16e \\times 2e \\cr\n&= 16e^2\n\\end{aligned}<br>Summing the two areas gives the final exact area:<br>$$\\begin{aligned} \\text{Area} &= A_1 + A_2 \\\\\\ &= \\left( \\dfrac{e^2}{4} + \\dfrac{1}{4} \\right) + 16e^2 \\\\\\ &= \\dfrac{65}{4}e^2 + \\dfrac{1}{4} \\end{aligned}$$",
                "Final Answer: \\begin{aligned}\ny &= -\\dfrac{1}{8}x + \\dfrac{33e}{16}, \\quad \\text{Area} \\cr\n&= \\dfrac{65}{4}e^2 + \\dfrac{1}{4}\n\\end{aligned}"
                ],
                "pi_options": [
                        {
