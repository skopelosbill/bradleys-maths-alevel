window.ALEVEL_QUESTIONS = [
        {
                ...
                "steps": [
                        ...
                        "Substitute $x = \\dfrac{1}{2}\\pi$ into the derivative to find the gradient of the tangent at $P$:<br>\\begin{aligned}\n\\text{At } x &= \\dfrac{1}{2}\\pi,\\cr\n2x &= \\pi, \\cr\n\\cos \\pi &= -1\n\\end{aligned}<br>$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{x=\\pi/2} &= \\dfrac{48(-1) - 12}{(4 - (-1))^2}\\cr\n&= \\dfrac{-60}{25}\\cr\n&= -\\dfrac{12}{5} \\end{aligned}$<br>The gradient of the normal is the negative reciprocal of the tangent gradient:<br>$$m_{\\text{normal}} = \\dfrac{5}{12}$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Evaluate the normal line integral $I_2 = \\int_{0}^{1} \\left( 16x - \\dfrac{61}{4} \\right) \\text{d}x$:<br>$\\begin{aligned} I_2 &= \\left[ 8x^2 - \\dfrac{61}{4}x \\right]_{0}^{1}$ $&= 8 - \\dfrac{61}{4}$ $&= -\\dfrac{29}{4} \\end{aligned}$<br>Subtracting the two results gives the final exact area:<br>$\\begin{aligned} A &= I_1 - I_2$ $&= \\ln 2 - \\left(-\\dfrac{29}{4}\\right)$ $&= \\ln 2 + \\dfrac{29}{4} \\end{aligned}$<br><br>Final Answer: \\begin{aligned}\ny &= 16x - \\dfrac{61}{4}, \\quad \\text{Area} \\cr\n&= \\ln 2 + \\dfrac{29}{4}\n\\end{aligned}"
                ],
                "pi_options": [
                        {
