window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Evaluate and compare the long-term behaviour as $t \\to \\infty$:<br>For the first model:<br>$$\\text{As } t \\to \\infty, \\quad P(t) = \\sqrt{6250t + 10000} \\to \\infty$$<br>For the revised model:<br>\\begin{aligned}\n\\text{As } t \\to \\infty, \\quad e^{-0.5t} \\to 0 \\cr\nP(t) \\to \\dfrac{300}{1} &= 300\n\\end{aligned}<br>The first model predicts unbounded growth, while the revised model predicts the population will level off and saturate at $300$ cells.<br><br>Final Answer: \\begin{aligned}\nP(t) &= \\sqrt{6250t + 10000}, \\quad P(t) \\cr\n&= \\dfrac{300}{2e^{-0.5t} + 1}\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Analyze the long-term behaviour as $t \\to \\infty$:<br>For the first model:<br>\\begin{aligned}\n\\text{As } t \\to \\infty, \\quad 0.8^t \\to 0 \\cr\nx(t) \\to 10\\left(1 - 0\\right) &= 10\n\\end{aligned}<br>For the revised model:<br>$$\\text{As } t \\to \\infty, \\quad \\ln(t + 1) \\to \\infty \\implies \\dfrac{100}{3\\ln(t + 1) + 10} \\to 0 \\implies x(t) \\to 10$$<br>Both models predict that the concentration will saturate at a limit of $10$ units/L. However, the first model approaches this limit much faster (exponential decay of the remaining concentration gap) compared to the slow logarithmic decay of the revised model.<br><br>Final Answer: \\begin{aligned}\nx(t) &= 10\\left(1 - 0.8^t\\right), \\quad x(t) \\cr\n&= 10 - \\dfrac{100}{3\\ln(t + 1) + 10}\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Examine the long-term behaviour as $t \\to \\infty$:<br>For the first model:<br>\\begin{aligned}\n\\text{As } t \\to \\infty, \\quad 2^{-t/10} \\to 0 \\cr\n\\theta(t) \\to 20 + 0 &= 20\n\\end{aligned}<br>For the revised model:<br>\\begin{aligned}\n\\text{As } t \\to \\infty, \\quad \\sqrt{t + 4} \\to \\infty \\cr\n\\left( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\right)^{-2} \\to 0 \\cr\n\\theta(t) \\to 20 + 0 &= 20\n\\end{aligned}<br>Both models predict that the liquid will cool down to approach the room temperature of $20^\\circ\\text{C}$ in the long term, and neither model projects that the temperature will fall below this ambient level.<br><br>Final Answer: \\begin{aligned}\n\\theta(t) &= 20 + 64\\cdot 2^{-t/10}, \\quad \\theta(t) \\cr\n&= 20 + \\left( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\right)^{-2}\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Integrate the separable differential equation:<br>$\\begin{aligned} \\int \\dfrac{1}{V} \\,\\text{d}V &= \\int k \\,\\text{d}t$ $\\ln V &= kt + C$ $V(t) &= Ae^{kt} \\end{aligned}$<br>where $A = e^C$. Substitute the boundary conditions:<br>Substitute $t = 0, \\, V = 10 \\implies A = 10$.<br>Now substitute $t = 5, \\, V = 20$ into $V(t) = 10e^{kt}$:<br>$\\begin{aligned} 20 &= 10e^{5k}$ $2 &= e^{5k}$ $5k &= \\ln 2$ $k &= \\dfrac{\\ln 2}{5} \\end{aligned}$<br>Substituting $k$ back into the model gives:<br>\\begin{aligned}\nV(t) &= 10e^{\\frac{\\ln 2}{5}t} \\cr\n&= 10\\cdot 2^{t/5}\n\\end{aligned}",
                        ...
                        "Compare the long-term behaviour and find the depletion point:<br>For the first model, $V(t) = 10\\cdot 2^{t/5} \\to \\infty$ as $t \\to \\infty$, representing unbounded compound growth.<br>For the revised model, $V(t) = 20 - 10e^{0.1t}$ eventually decreases because the withdrawal term exceeds the growth term. The fund is exhausted when $V(t) = 0$:<br>$\\begin{aligned} 20 - 10e^{0.1t} &= 0$ $10e^{0.1t} &= 20$ $e^{0.1t} &= 2$ $0.1t &= \\ln 2$ $t &= 10\\ln 2 \\end{aligned}$<br>The fund runs out after exactly $10\\ln 2$ years (approximately $6.93$ years).<br><br>Final Answer: \\begin{aligned}\nV(t) &= 10\\cdot 2^{t/5}, \\quad V(t) \\cr\n&= 20 - 10e^{0.1t}, \\quad t \\cr\n&= 10\\ln 2 \\text{ years}\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Solve by separating the variables and integrating both sides:<br>$\\begin{aligned} \\int \\dfrac{1}{B} \\,\\text{d}B &= \\int k \\,\\text{d}t$ $\\ln B &= kt + C$ $B(t) &= Ae^{kt} \\end{aligned}$<br>where $A = e^C$. Substitute $t = 0, \\, B = 100 \\implies A = 100$.<br>Substitute $t = 1, \\, B = 150$ into $B(t) = 100e^{kt}$:<br>$\\begin{aligned} 150 &= 100e^{k}$ $e^k &= 1.5$ $k &= \\ln 1.5 \\end{aligned}$<br>So the first model is:<br>\\begin{aligned}\nB(t) &= 100e^{(\\ln 1.5)t} \\cr\n&= 100\\cdot 1.5^t\n\\end{aligned}",
                        "For the logistic model, separate the variables:<br>$$\\dfrac{1}{B(500 - B)} \\,\\text{d}B = \\dfrac{1}{2000} \\,\\text{d}t$$<br>Decompose the left-hand fraction using partial fractions:<br>\\begin{aligned}\n\\dfrac{1}{B(500 - B)} &= \\dfrac{X}{B} + \\dfrac{Y}{500 - B} \\cr\n1 &= X(500 - B) + YB\n\\end{aligned}<br>By substituting $B = 0 \\implies X = \\dfrac{1}{500}$, and $B = 500 \\implies Y = \\dfrac{1}{500}$.<br>So the decomposed expression is:<br>$$\\dfrac{1}{B(500 - B)} = \\dfrac{1}{500}\\left( \\dfrac{1}{B} + \\dfrac{1}{500 - B} \\right)$$,",
