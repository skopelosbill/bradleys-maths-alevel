window.ALEVEL_QUESTIONS = [
        {
                ...
                "steps": [
                        "Differentiate the equation of the curve using the quotient rule, where $u = 6\\sin 2x$ and $v = 4 - \\cos 2x$:<br>\\begin{aligned}\nu' &= 12\\cos 2x,\\cr\nv' &= 2\\sin 2x\n\\end{aligned}",
                        "We apply the quotient rule to find the derivative:<br>\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{12\\cos 2x(4 - \\cos 2x) - 6\\sin 2x(2\\sin 2x)}{(4 - \\cos 2x)^2}\\cr\n&= \\dfrac{48\\cos 2x - 12\\cos^2 2x - 12\\sin^2 2x}{(4 - \\cos 2x)^2}\\cr\n&= \\dfrac{48\\cos 2x - 12(\\cos^2 2x + \\sin^2 2x)}{(4 - \\cos 2x)^2}\\cr\n&= \\dfrac{48\\cos 2x - 12}{(4 - \\cos 2x)^2} \\end{aligned}",
                        "Substitute $x = \\dfrac{1}{2}\\pi$ into the derivative to find the gradient of the tangent at $P$:<br>\\begin{aligned}\n\\text{At } x &= \\dfrac{1}{2}\\pi,\\cr\n2x &= \\pi, \\cr\n\\cos \\pi &= -1\\end{aligned}<br>\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{x=\\pi/2} &= \\dfrac{48(-1) - 12}{(4 - (-1))^2}\\cr\n&= \\dfrac{-60}{25}\\cr\n&= -\\dfrac{12}{5} \\end{aligned}",
                        "The gradient of the normal is the negative reciprocal of the tangent gradient:<br>$$m_{\\text{normal}} = \\dfrac{5}{12}$$",
                        "Use the point-gradient formula $y - y_1 = m(x - x_1)$ with the point $P\\left(\\dfrac{1}{2}\\pi, 0\\right)$ to find the equation of the normal:<br>\\begin{aligned} y - 0 &= \\dfrac{5}{12}\\left(x - \\dfrac{1}{2}\\pi\\right)\\cr\ny &= \\dfrac{5}{12}x - \\dfrac{5}{24}\\pi \\end{aligned}",
                        "Set up the integral for the area. The curve and the normal meet at $x = \\dfrac{1}{2}\\pi$, and the region is bounded on the left by the $y$-axis ($x = 0$). For $0 \\le x \\le \\dfrac{1}{2}\\pi$, the curve lies above the normal line. Therefore, the area is:<br>\\begin{aligned}\nA &= \\int_{0}^{\\pi/2} \\left( \\dfrac{6\\sin 2x}{4 - \\cos 2x} - \\left( \\dfrac{5}{12}x - \\dfrac{5\\pi}{24} \\right) \\right) \\text{d}x \\cr\n&= I_1 - I_2\n\\end{aligned}",
                        "Evaluate the first integral $I_1 = \\int_{0}^{\\pi/2} \\dfrac{6\\sin 2x}{4 - \\cos 2x} \\text{d}x$ using the substitution $u = 4 - \\cos 2x$, which gives $\\text{d}u = 2\\sin 2x \\text{d}x\\:<br>\\begin{aligned}\n\\text{When } x &= 0\\cr\n u &= 4 - \\cos 0 \\cr\n &= 3 \\cr\n \\text{ and when } x &= \\dfrac{1}{2}\\pi\\cr\n u &= 4 - \\cos \\pi \\cr\n&= 5\n\\end{aligned}<br>\\begin{aligned} I_1 &= \\int_{3}^{5} \\dfrac{3}{u} \\text{d}u \\cr\n &= \\Big[ 3\\ln u \\Big]_{3}^{5}\\cr\n &= 3\\ln 5 - 3\\ln 3\\cr\n&= \\ln\\left(\\dfrac{125}{27}\\right) \\end{aligned}",
                        "Evaluate the second integral $I_2 = \\int_{0}^{\\pi/2} \\left( \\dfrac{5}{12}x - \\dfrac{5\\pi}{24} \\right) \\text{d}x$:<br>\\begin{aligned} I_2 &= \\left[ \\dfrac{5}{24}x^2 - \\dfrac{5\\pi}{24}x \\right]_{0}^{\\pi/2}\\cr\n&= \\dfrac{5}{24}\\left(\\dfrac{\\pi^2}{4}\\right) - \\dfrac{5\\pi}{24}\\left(\\dfrac{\\pi}{2}\\right)\\cr\n&= \\dfrac{5\\pi^2}{96} - \\dfrac{10\\pi^2}{96}\\cr\n&= -\\dfrac{5\\pi^2}{96} \\end{aligned}",
                        "Subtracting $I_2$ from $I_1$ yields the final exact area:<br>\\begin{aligned} A &= I_1 - I_2\\cr\n&= \\ln\\left(\\dfrac{125}{27}\\right) - \\left(-\\dfrac{5\\pi^2}{96}\\right)\\cr\n&= \\ln\\left(\\dfrac{125}{27}\\right) + \\dfrac{5}{96}\\pi^2 \\end{aligned}",
                        "Final Answer: \\begin{aligned}\ny &= \\dfrac{5}{12}x - \\dfrac{5\\pi}{24}, \\quad \\text{Area} \\cr\n&= \\ln\\left(\\dfrac{125}{27}\\right) + \\dfrac{5}{96}\\pi^2\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "Substitute $x = 1$ into the derivative to find the tangent gradient at $P$:<br>\\begin{aligned} \\dfrac{\\mathrm{d}y}{\\mathrm{d}x}\\bigg|_{x = 1} &= \\dfrac{ -2(1)^2 - 2(1) + 3 }{ (1^2 + 1 + 2)^2 } \\cr\n&= \\dfrac{ -1 }{ 16 } \\end{aligned}<br>The gradient of the normal is the negative reciprocal of the tangent gradient, which is $16$.",
                "Find the equation of the normal line using the point-gradient formula with $P\\left( 1, \\dfrac{ 3 }{ 4 } \\right)$:<br>\\begin{aligned} y - \\dfrac{ 3 }{ 4 } &= 16(x - 1) \\cr\ny &= 16x - 16 + \\dfrac{ 3 }{ 4 } \\cr\ny &= 16x - \\dfrac{ 61 }{ 4 } \\end{aligned}",
                "Set up the integral for the area bounded by the curve, the normal, and the $y$-axis from $x = 0$ to $x = 1$. Since the curve lies above the normal in this interval, the area is:<br>\\begin{aligned} A &= \\int_{0}^{1} \\left( \\dfrac{ 2x + 1 }{ x^2 + x + 2 } - \\left( 16x - \\dfrac{ 61 }{ 4 } \\right) \\right) \\mathrm{d}x \\cr\n&= I_1 - I_2 \\end{aligned}",
                "Evaluate the curve integral $I_1 = \\int_{0}^{1} \\dfrac{ 2x + 1 }{ x^2 + x + 2 } \\mathrm{d}x$ using the logarithmic substitution $u = x^2 + x + 2$, where $\\mathrm{d}u = (2x + 1)\\mathrm{d}x$:<br>\\begin{aligned} I_1 &= \\Big[ \\ln(x^2 + x + 2) \\Big]_{0}^{1} \\cr\n&= \\ln 4 - \\ln 2 \\cr\n&= \\ln\\left( \\dfrac{ 4 }{ 2 } \\right) \\cr\n&= \\ln 2 \\end{aligned}",
        ...
        "question": "The curve $C$ has equation:<br>$$y = 8\\sin x \\cos^3 x, \\quad \\text{for } 0 \\le x \\le \\dfrac{1}{2}\\pi$$<br><strong>1.</strong> Show that the equation of the normal to the curve $C$ at the point $P$ where $x = \\dfrac{1}{3}\\pi$ is $y = \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2}$.<br><strong>2.</strong> Find the exact area of the shaded region bounded by the curve $C$, the normal to the curve, and the $y$-axis.",
        "steps": [
                "Find the coordinates of the point $P$. Substitute $x = \\dfrac{1}{3}\\pi$ into the curve's equation:<br>\\begin{aligned} y &= 8\\sin\\left(\\dfrac{1}{3}\\pi\\right)\\cos^3\\left(\\dfrac{1}{3}\\pi\\right) \\cr\n&= 8\\left(\\dfrac{\\sqrt{3}}{2}\\right)\\left(\\dfrac{1}{2}\\right)^3 \\cr\n&= \\dfrac{\\sqrt{3}}{2} \\end{aligned}<br>The coordinates of $P$ are $P\\left(\\dfrac{1}{3}\\pi, \\dfrac{\\sqrt{3}}{2}\\right)$.",
                "Differentiate the equation of the curve using the product rule:<br>\\begin{aligned} \\dfrac{\\mathrm{d}y}{\\mathrm{d}x} &= 8\\cos x \\cos^3 x + 8\\sin x \\left(3\\cos^2 x(-\\sin x)\\right) \\cr\n&= 8\\cos^4 x - 24\\sin^2 x \\cos^2 x \\cr\n&= 8\\cos^2 x(\\cos^2 x - 3(1 - \\cos^2 x)) \\cr\n&= 8\\cos^2 x(4\\cos^2 x - 3) \\end{aligned}",
                "Substitute $x = \\dfrac{1}{3}\\pi$ into the derivative to find the tangent gradient at $P$:<br>\\begin{aligned} \\cos\\left(\\dfrac{1}{3}\\pi\\right) &= \\dfrac{1}{2} \\cr\n\\cos^2\\left(\\dfrac{1}{3}\\pi\\right) &= \\dfrac{1}{4} \\end{aligned}<br>\\begin{aligned} \\dfrac{\\mathrm{d}y}{\\mathrm{d}x}\\bigg|_{x = \\pi/3} &= 8\\left(\\dfrac{1}{4}\\right)\\left(4\\left(\\dfrac{1}{4}\\right) - 3\\right) \\cr\n&= 2(1 - 3) \\cr\n&= -4 \\end{aligned}<br>The gradient of the normal is the negative reciprocal of the tangent gradient, which is $\\dfrac{1}{4}$.",
                "Use the point-gradient formula with $P\\left(\\dfrac{1}{3}\\pi, \\dfrac{\\sqrt{3}}{2}\\right)$ to obtain the equation of the normal:<br>\\begin{aligned} y - \\dfrac{\\sqrt{3}}{2} &= \\dfrac{1}{4}\\left(x - \\dfrac{1}{3}\\pi\\right) \\cr\ny &= \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2} \\end{aligned}",
                "Set up the integral for the area bounded by the curve, the normal, and the $y$-axis from $x = 0$ to $x = \\dfrac{1}{3}\\pi$. The curve lies above the normal, so:<br>\\begin{aligned} A &= \\int_{0}^{\\pi/3} \\left( 8\\sin x \\cos^3 x - \\left( \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2} \\right) \\right) \\mathrm{d}x \\cr\n&= I_1 - I_2 \\end{aligned}",
                "Evaluate the first integral $I_1 = \\int_{0}^{\\pi/3} 8\\sin x \\cos^3 x \\mathrm{d}x$ using substitution with $u = \\cos x$, which gives $\\mathrm{d}u = -\\sin x \\mathrm{d}x$:<br>\\begin{aligned} \\text{When } x &= 0, \\cr\nu &= 1 \\cr\n\\text{and when } x &= \\dfrac{1}{3}\\pi, \\cr\nu &= \\dfrac{1}{2} \\end{aligned}<br>\\begin{aligned} I_1 &= \\int_{1/2}^{1} 8u^3 \\mathrm{d}u \\cr\n&= \\Big[ 2u^4 \\Big]_{1/2}^{1} \\cr\n&= 2(1)^4 - 2\\left(\\dfrac{1}{2}\\right)^4 \\cr\n&= 2 - \\dfrac{1}{8} \\cr\n&= \\dfrac{15}{8} \\end{aligned}",
                "Evaluate the second integral $I_2 = \\int_{0}^{\\pi/3} \\left( \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2} \\right) \\mathrm{d}x$:<br>\\begin{aligned} I_2 &= \\left[ \\dfrac{1}{8}x^2 + \\left( \\dfrac{\\sqrt{3}}{2} - \\dfrac{\\pi}{12} \\right)x \\right]_{0}^{\\pi/3} \\cr\n&= \\dfrac{1}{8}\\left(\\dfrac{\\pi^2}{9}\\right) + \\left( \\dfrac{\\sqrt{3}}{2} - \\dfrac{\\pi}{12} \\right)\\left(\\dfrac{\\pi}{3}\\right) \\cr\n&= \\dfrac{\\pi^2}{72} + \\dfrac{\\sqrt{3}\\pi}{6} - \\dfrac{\\pi^2}{36} \\cr\n&= \\dfrac{\\sqrt{3}\\pi}{6} - \\dfrac{\\pi^2}{72} \\end{aligned}<br>Subtracting $I_2$ from $I_1$ yields the final exact area:<br>\\begin{aligned} A &= I_1 - I_2 \\cr\n&= \\dfrac{15}{8} - \\left( \\dfrac{\\sqrt{3}\\pi}{6} - \\dfrac{\\pi^2}{72} \\right) \\cr\n&= \\dfrac{15}{8} - \\dfrac{\\sqrt{3}}{6}\\pi + \\dfrac{1}{72}\\pi^2 \\end{aligned}",
                "Final Answer: \\begin{aligned} y &= \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2}, \\quad \\text{Area} \\cr\n&= \\dfrac{15}{8} - \\dfrac{\\sqrt{3}}{6}\\pi + \\dfrac{1}{72}\\pi^2 \\end{aligned}"
        ],
                "pi_options": [
                        {
        ...
        "question": "A curve $C$ is defined parametrically by the equations:<br>$$x = \\sin t, \\quad y = \\sin 2t, \\quad \\text{for } 0 \\le t \\le \\dfrac{1}{2}\\pi$$<br><strong>1.</strong> Find the equation of the normal to the curve $C$ at the point where $t = \\dfrac{1}{6}\\pi$.<br><strong>2.</strong> Find the exact area of the region bounded by the curve $C$, the normal to the curve, and the $x$-axis.",
        "steps": [
                "Find the coordinates of the point at $t = \\dfrac{1}{6}\\pi$:<br>\\begin{aligned} x &= \\sin\\left(\\dfrac{1}{6}\\pi\\right) \\cr\n&= \\dfrac{1}{2} \\end{aligned}<br>\\begin{aligned} y &= \\sin\\left(\\dfrac{1}{3}\\pi\\right) \\cr\n&= \\dfrac{\\sqrt{3}}{2} \\end{aligned}<br>The point $P$ is $P\\left(\\dfrac{1}{2}, \\dfrac{\\sqrt{3}}{2}\\right)$.",
                "Differentiate the parametric equations with respect to $t$ to find $\\dfrac{\\mathrm{d}y}{\\mathrm{d}x}$:<br>\\begin{aligned} \\dfrac{\\mathrm{d}x}{\\mathrm{d}t} &= \\cos t, \\cr\n\\dfrac{\\mathrm{d}y}{\\mathrm{d}t} &= 2\\cos 2t \\cr\n\\dfrac{\\mathrm{d}y}{\\mathrm{d}x} &= \\dfrac{2\\cos 2t}{\\cos t} \\end{aligned}<br>Substitute $t = \\dfrac{1}{6}\\pi$ to find the tangent gradient:<br>\\begin{aligned} \\dfrac{\\mathrm{d}y}{\\mathrm{d}x}\\bigg|_{t = \\pi/6} &= \\dfrac{2\\cos\\left(\\dfrac{1}{3}\\pi\\right)}{\\cos\\left(\\dfrac{1}{6}\\pi\\right)} \\cr\n&= \\dfrac{2\\left(\\dfrac{1}{2}\\right)}{\\dfrac{\\sqrt{3}}{2}} \\cr\n&= \\dfrac{2}{\\sqrt{3}} \\end{aligned}",
                "Find the normal gradient, which is the negative reciprocal of the tangent gradient:<br>$$m_{\\text{normal}} = -\\dfrac{\\sqrt{3}}{2}$$<br>Use the point-gradient formula with $P\\left(\\dfrac{1}{2}, \\dfrac{\\sqrt{3}}{2}\\right)$ to get the equation of the normal:<br>\\begin{aligned} y - \\dfrac{\\sqrt{3}}{2} &= -\\dfrac{\\sqrt{3}}{2}\\left(x - \\dfrac{1}{2}\\right) \\cr\ny &= -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4} \\end{aligned}",
                "Find the intersections of the curve and the normal with the $x$-axis ($y = 0$):<br>The curve intersects the $x$-axis when $y = \\sin 2t = 0$. Since $0 \\le t \\le \\dfrac{1}{2}\\pi$, we have $t = 0$ (the origin) and $t = \\dfrac{1}{2}\\pi$, which gives $x = \\sin\\left(\\dfrac{1}{2}\\pi\\right) = 1$.<br><br>The normal intersects the $x$-axis when $y = 0$:<br>\\begin{aligned} 0 &= -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4} \\cr\n\\dfrac{\\sqrt{3}}{2}x &= \\dfrac{3\\sqrt{3}}{4} \\cr\nx &= \\dfrac{3}{2} \\end{aligned}<br>The curve and normal meet at $x = \\dfrac{1}{2}$.",
                "Divide the shaded area into two separate regions:<br><br><strong>Region 1 ($A_1$):</strong> Area under the curve from $x = 0$ to $x = 1$.<br><strong>Region 2 ($A_2$):</strong> Area under the normal from $x = 1$ to $x = \\dfrac{3}{2}$.<br><br>$$A = A_1 + A_2$$",
                "Evaluate the parametric curve area $A_1 = \\int_{0}^{1} y \\mathrm{d}x$ by changing the variable to $t$ where $\\mathrm{d}x = \\cos t \\mathrm{d}t$:<br>\\begin{aligned} A_1 &= \\int_{0}^{\\pi/2} (\\sin 2t)(\\cos t) \\mathrm{d}t \\cr\n&= \\int_{0}^{\\pi/2} (2\\sin t\\cos t)(\\cos t) \\mathrm{d}t \\cr\n&= \\int_{0}^{\\pi/2} 2\\sin t \\cos^2 t \\mathrm{d}t \\end{aligned}<br>Using the substitution $u = \\cos t$, where $\\mathrm{d}u = -\\sin t \\mathrm{d}t$, the limits are $u(0) = 1$ and $u(\\pi/2) = 0$:<br>\\begin{aligned} A_1 &= \\int_{0}^{1} 2u^2 \\mathrm{d}u \\cr\n&= \\left[ \\dfrac{2}{3}u^3 \\right]_{0}^{1} \\cr\n&= \\dfrac{2}{3} \\end{aligned}",
                "Evaluate the normal line area $A_2 = \\int_{1}^{3/2} \\left( -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4} \\right) \\mathrm{d}x$:<br>\\begin{aligned} A_2 &= \\left[ -\\dfrac{\\sqrt{3}}{4}x^2 + \\dfrac{3\\sqrt{3}}{4}x \\right]_{1}^{3/2} \\cr\n&= \\left( -\\dfrac{\\sqrt{3}}{4}\\left(\\dfrac{9}{4}\\right) + \\dfrac{3\\sqrt{3}}{4}\\left(\\dfrac{3}{2}\\right) \\right) - \\left( -\\dfrac{\\sqrt{3}}{4} + \\dfrac{3\\sqrt{3}}{4} \\right) \\cr\n&= \\left( -\\dfrac{9\\sqrt{3}}{16} + \\dfrac{18\\sqrt{3}}{16} \\right) - \\dfrac{2\\sqrt{3}}{4} \\cr\n&= \\dfrac{9\\sqrt{3}}{16} - \\dfrac{8\\sqrt{3}}{16} \\cr\n&= \\dfrac{\\sqrt{3}}{16} \\end{aligned}<br>Summing $A_1$ and $A_2$ yields the total exact area:<br>\\begin{aligned} \\text{Area} &= A_1 + A_2 \\cr\n&= \\dfrac{2}{3} + \\dfrac{\\sqrt{3}}{16} \\end{aligned}",
                "Final Answer: \\begin{aligned} y &= -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4}, \\quad \\text{Area} \\cr\n&= \\dfrac{2}{3} + \\dfrac{\\sqrt{3}}{16} \\end{aligned}"
        ],
                "pi_options": [
                        {
        ...
        "question": "The curve $C$ has equation:<br>$$y = 4x \\ln(2x), \\quad \\text{for } x > 0$$<br><strong>1.</strong> Find the equation of the normal to the curve $C$ at the point $P$ where $x = \\dfrac{1}{2}e$.<br><strong>2.</strong> Find the exact area of the region bounded by the curve $C$, the normal to the curve, and the $x$-axis.",
        "steps": [
                "Find the coordinates of the point $P$. Substitute $x = \\dfrac{1}{2}e$ into the curve's equation:<br>\\begin{aligned} y &= 4\\left(\\dfrac{1}{2}e\\right)\\ln\\left(2\\left(\\dfrac{1}{2}e\\right)\\right) \\cr\n&= 2e\\ln e \\cr\n&= 2e \\end{aligned}<br>So the coordinates of $P$ are $P\\left(\\dfrac{1}{2}e, 2e\\right)$.",
                "Differentiate the curve's equation using the product rule:<br>\\begin{aligned} \\dfrac{\\mathrm{d}y}{\\mathrm{d}x} &= 4\\ln(2x) + 4x\\left(\\dfrac{2}{2x}\\right) \\cr\n&= 4\\ln(2x) + 4 \\end{aligned}<br>Substitute $x = \\dfrac{1}{2}e$ to find the tangent gradient at $P$:<br>\\begin{aligned} \\dfrac{\\mathrm{d}y}{\\mathrm{d}x}\\bigg|_{x = e/2} &= 4\\ln e + 4 \\cr\n&= 8 \\end{aligned}<br>The gradient of the normal is the negative reciprocal of the tangent gradient, which is $-\\dfrac{1}{8}$.",
                "Use the point-gradient formula with $P\\left(\\dfrac{1}{2}e, 2e\\right)$ to get the equation of the normal:<br>\\begin{aligned} y - 2e &= -\\dfrac{1}{8}\\left(x - \\dfrac{1}{2}e\\right) \\cr\ny &= -\\dfrac{1}{8}x + \\dfrac{e}{16} + 2e \\cr\ny &= -\\dfrac{1}{8}x + \\dfrac{33e}{16} \\end{aligned}",
                "Find the intersections of the curve and normal with the $x$-axis ($y = 0$):<br>The curve intersects the $x$-axis when $4x\\ln(2x) = 0$. Since $x > 0$, we have $\\ln(2x) = 0 \\implies 2x = 1 \\implies x = \\dfrac{1}{2}$.<br><br>The normal intersects the $x$-axis when $y = 0$:<br>\\begin{aligned} 0 &= -\\dfrac{1}{8}x + \\dfrac{33e}{16} \\cr\n\\dfrac{1}{8}x &= \\dfrac{33e}{16} \\cr\nx &= \\dfrac{33e}{2} \\end{aligned}<br>The boundary between the curve and the normal is at $x = \\dfrac{1}{2}e$.",
                "Set up the integrals to find the area of the region. The area is divided into two separate regions:<br><br><strong>Region 1 ($A_1$):</strong> Area under the curve from $x = \\dfrac{1}{2}$ to $x = \\dfrac{1}{2}e$.<br><strong>Region 2 ($A_2$):</strong> Area under the normal from $x = \\dfrac{1}{2}e$ to $x = \\dfrac{33e}{2}$.",
                "Evaluate $A_1 = \\int_{1/2}^{e/2} 4x\\ln(2x) \\mathrm{d}x$ using integration by parts:<br>\\begin{aligned} u &= \\ln(2x) \\implies \\mathrm{d}u = \\dfrac{1}{x}\\mathrm{d}x \\cr\n\\mathrm{d}v &= 4x\\mathrm{d}x \\implies v = 2x^2 \\end{aligned}<br>\\begin{aligned} \\int 4x\\ln(2x) \\mathrm{d}x &= 2x^2\\ln(2x) - \\int 2x^2\\left(\\dfrac{1}{x}\\right) \\mathrm{d}x \\cr\n&= 2x^2\\ln(2x) - \\int 2x \\mathrm{d}x \\cr\n&= 2x^2\\ln(2x) - x^2 \\end{aligned}<br>Evaluating this from $x = \\dfrac{1}{2}$ to $x = \\dfrac{1}{2}e$:<br>\\begin{aligned} A_1 &= \\left[ 2x^2\\ln(2x) - x^2 \\right]_{1/2}^{e/2} \\cr\n&= \\left( 2\\left(\\dfrac{e}{2}\\right)^2\\ln e - \\left(\\dfrac{e}{2}\\right)^2 \\right) - \\left( 2\\left(\\dfrac{1}{2}\\right)^2\\ln 1 - \\left(\\dfrac{1}{2}\\right)^2 \\right) \\cr\n&= \\left( \\dfrac{e^2}{2} - \\dfrac{e^2}{4} \\right) - \\left( 0 - \\dfrac{1}{4} \\right) \\cr\n&= \\dfrac{e^2}{4} + \\dfrac{1}{4} \\end{aligned}",
                "Evaluate $A_2 = \\int_{e/2}^{33e/2} \\left( -\\dfrac{1}{8}x + \\dfrac{33e}{16} \\right) \\mathrm{d}x$. Since this region is a right-angled triangle with base $\\dfrac{33e}{2} - \\dfrac{e}{2} = 16e$ and height $2e$:<br>\\begin{aligned} A_2 &= \\dfrac{1}{2} \\times 16e \\times 2e \\cr\n&= 16e^2 \\end{aligned}<br>Summing the two areas gives the final exact area:<br>\\begin{aligned} \\text{Area} &= A_1 + A_2 \\cr\n&= \\left( \\dfrac{e^2}{4} + \\dfrac{1}{4} \\right) + 16e^2 \\cr\n&= \\dfrac{65}{4}e^2 + \\dfrac{1}{4} \\end{aligned}",
                "Final Answer: \\begin{aligned} y &= -\\dfrac{1}{8}x + \\dfrac{33e}{16}, \\quad \\text{Area} \\cr\n&= \\dfrac{65}{4}e^2 + \\dfrac{1}{4} \\end{aligned}"
        ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "img": false,
                "question": "A biologist is attempting to model the population of a yeast colony, $P$, at time $t$ hours. When $t = 0$ there are $100$ cells, and when $t = 2$ there are $150$ cells.<br><br><strong>1.</strong> The biologist first assumes that the rate of increase of the yeast population is inversely proportional to the population size present at time $t$.<br>&nbsp;&nbsp;&nbsp;&nbsp;<strong>(a)</strong> Write down a differential equation to model this situation.<br>&nbsp;&nbsp;&nbsp;&nbsp;<strong>(b)</strong> Solve this differential equation to find $P$ in terms of $t$.<br><br><strong>2.</strong> In a revised model, it is assumed that:<br>$$\\dfrac{\\mathrm{d}P}{\\mathrm{d}t} = \\dfrac{P^2}{300e^{0.5t}}$$<br>Solve this differential equation to find $P$ in terms of $t$, using the same initial population of $100$ cells at $t = 0$.<br><br><strong>3.</strong> Compare the long-term behaviour of the two models.",
                "steps": [
                "Write the rate of increase as a differential equation representing inverse proportionality:<br>$$\\dfrac{\\mathrm{d}P}{\\mathrm{d}t} = \\dfrac{ k }{ P }$$<br>where $k > 0$ is a constant of proportionality.",
                "Solve the differential equation by separating the variables and integrating both sides:<br>\\begin{aligned} P \\mathrm{d}P &= k \\mathrm{d}t \\cr\n\\int P \\mathrm{d}P &= \\int k \\mathrm{d}t \\cr\n\\dfrac{1}{2}P^2 &= kt + C \\cr\nP^2 &= 2kt + D \\end{aligned}<br>where $D = 2C$ is a constant of integration.",
                "Apply the boundary conditions to find the constant values $D$ and $2k$. Substitute $t = 0$ and $P = 100$ into the equation:<br>\\begin{aligned} 100^2 &= 2k(0) + D \\cr\nD &= 10000 \\end{aligned}<br>Now substitute $t = 2$, $P = 150$, and $D = 10000$ to find $2k$:<br>\\begin{aligned} 150^2 &= 2k(2) + 10000 \\cr\n22500 &= 4k + 10000 \\cr\n4k &= 12500 \\cr\n2k &= 6250 \\end{aligned}<br>Substitute $2k = 6250$ and $D = 10000$ back into the solved equation. Since $P \\ge 0$, we take the positive square root:<br>$$P(t) = \\sqrt{ 6250t + 10000 }$$",
                "For the revised model, separate the variables and integrate both sides:<br>\\begin{aligned} \\dfrac{\\mathrm{d}P}{\\mathrm{d}t} &= \\dfrac{ P^2 }{ 300e^{0.5t} } \\cr\n\\dfrac{1}{P^2} \\mathrm{d}P &= \\dfrac{1}{300}e^{-0.5t} \\mathrm{d}t \\cr\n\\int P^{-2} \\mathrm{d}P &= \\int \\dfrac{1}{300}e^{-0.5t} \\mathrm{d}t \\cr\n-\\dfrac{1}{P} &= -\\dfrac{1}{150}e^{-0.5t} + A \\end{aligned}",
                "Clean up the equation by multiplying both sides by $-1$:<br>$$\\dfrac{1}{P} = \\dfrac{1}{150}e^{-0.5t} + A'$$<br>where $A' = -A$. Substitute the initial condition $t = 0$ and $P = 100$ to find $A'$:<br>\\begin{aligned} \\dfrac{1}{100} &= \\dfrac{1}{150}e^{0} + A' \\cr\n\\dfrac{1}{100} &= \\dfrac{1}{150} + A' \\cr\nA' &= \\dfrac{1}{100} - \\dfrac{1}{150} \\cr\n&= \\dfrac{1}{300} \\end{aligned}<br>Combine the fractions and solve for $P(t)$:<br>\\begin{aligned} \\dfrac{1}{P} &= \\dfrac{1}{150}e^{-0.5t} + \\dfrac{1}{300} \\cr\n\\dfrac{1}{P} &= \\dfrac{ 2e^{-0.5t} + 1 }{ 300 } \\cr\nP(t) &= \\dfrac{ 300 }{ 2e^{-0.5t} + 1 } \\end{aligned}",
                "Evaluate and compare the long-term behaviour as $t \\to \\infty$:<br>For the first model:<br>$$\\text{As } t \\to \\infty, \\quad P(t) = \\sqrt{ 6250t + 10000 } \\to \\infty$$<br>For the revised model:<br>\\begin{aligned} \\text{As } t \\to \\infty, \\quad e^{-0.5t} &\\to 0 \\cr\nP(t) &\\to \\dfrac{300}{1} = 300 \\end{aligned}<br>The first model predicts unbounded growth, while the revised model predicts the population will level off and saturate at $300$ cells.<br><br>Final Answer: \\begin{aligned} P(t) &= \\sqrt{ 6250t + 10000 } \\cr\nP(t) &= \\dfrac{ 300 }{ 2e^{-0.5t} + 1 } \\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "img": false,
                 "question": "A clinical researcher is studying the concentration of a newly administered drug in a patient's bloodstream. Let $x$ represent the concentration of the drug (in units/L) at time $t$ hours. Initially, when $t = 0$, the concentration is $x = 0$. After $1$ hour, the concentration is $2$ units/L.<br><br><strong>1.</strong> The researcher first assumes that the rate of increase of the drug concentration is proportional to the difference between a maximum saturation level of $10$ units/L and the current concentration $x$.<br>&nbsp;&nbsp;&nbsp;&nbsp;<strong>(a)</strong> Write down a differential equation to model this situation.<br>&nbsp;&nbsp;&nbsp;&nbsp;<strong>(b)</strong> Solve this differential equation to find $x$ in terms of $t$.<br><br><strong>2.</strong> In a revised model, it is assumed that:<br>$$\\dfrac{\\mathrm{d}x}{\\mathrm{d}t} = \\dfrac{3(10 - x)^2}{100(t + 1)}$$<br>Solve this differential equation to find $x$ in terms of $t$, using the same initial condition of $x = 0$ at $t = 0$.<br><br><strong>3.</strong> Compare the long-term behaviour of the two models as $t \\to \\infty$.",
                "steps": [
                "Write the rate of increase for the first model as a differential equation:<br>$$\\dfrac{\\mathrm{d}x}{\\mathrm{d}t} = k(10 - x)$$<br>where $k > 0$ is a constant of proportionality.",
                "Solve the differential equation by separating the variables and integrating both sides:<br>\\begin{aligned} \\dfrac{1}{10 - x} \\mathrm{d}x &= k \\mathrm{d}t \\cr\n\\int \\dfrac{1}{10 - x} \\mathrm{d}x &= \\int k \\mathrm{d}t \\cr\n-\\ln(10 - x) &= kt + C \\cr\n\\ln(10 - x) &= -kt - C \\cr\n10 - x &= Ae^{-kt} \\end{aligned}<br>where $A = e^{-C}$ is a constant of integration.",
                "Apply the boundary conditions to find the values of $A$ and $k$. Substitute $t = 0$ and $x = 0$ into the equation:<br>\\begin{aligned} 10 - 0 &= Ae^{0} \\cr\nA &= 10 \\end{aligned}<br>This gives $x(t) = 10\\left(1 - e^{-kt}\\right)$. Now substitute $t = 1$ and $x = 2$ to find $k$:<br>\\begin{aligned} 2 &= 10\\left(1 - e^{-k}\\right) \\cr\n0.2 &= 1 - e^{-k} \\cr\ne^{-k} &= 0.8 \\cr\n-k &= \\ln 0.8 \\cr\nk &= -\\ln 0.8 \\end{aligned}<br>Substituting $e^{-kt} = (e^{-k})^t = 0.8^t$ yields:<br>$$x(t) = 10\\left(1 - 0.8^t\\right)$$",
                "For the revised model, separate the variables and integrate both sides:<br>\\begin{aligned} \\dfrac{\\mathrm{d}x}{\\mathrm{d}t} &= \\dfrac{3(10 - x)^2}{100(t + 1)} \\cr\n\\dfrac{1}{(10 - x)^2} \\mathrm{d}x &= \\dfrac{3}{100(t + 1)} \\mathrm{d}t \\cr\n\\int (10 - x)^{-2} \\mathrm{d}x &= \\int \\dfrac{3}{100(t + 1)} \\mathrm{d}t \\cr\n\\dfrac{1}{10 - x} &= \\dfrac{3}{100}\\ln(t + 1) + C' \\end{aligned}",
                "Apply the initial condition $t = 0$ and $x = 0$ to find $C'$:<br>\\begin{aligned} \\dfrac{1}{10 - 0} &= \\dfrac{3}{100}\\ln(1) + C' \\cr\n\\dfrac{1}{10} &= 0 + C' \\cr\nC' &= \\dfrac{1}{10} \\end{aligned}<br>Now substitute $C' = \\dfrac{1}{10}$ back and isolate $x$:<br>\\begin{aligned} \\dfrac{1}{10 - x} &= \\dfrac{3}{100}\\ln(t + 1) + \\dfrac{1}{10} \\cr\n\\dfrac{1}{10 - x} &= \\dfrac{ 3\\ln(t + 1) + 10 }{ 100 } \\cr\n10 - x &= \\dfrac{ 100 }{ 3\\ln(t + 1) + 10 } \\cr\nx(t) &= 10 - \\dfrac{ 100 }{ 3\\ln(t + 1) + 10 } \\end{aligned}",
                "Analyze the long-term behaviour as $t \\to \\infty$:<br>For the first model:<br>\\begin{aligned} \\text{As } t \\to \\infty, \\quad 0.8^t &\\to 0 \\cr\nx(t) &\\to 10\\left(1 - 0\\right) = 10 \\end{aligned}<br>For the revised model:<br>\\begin{aligned} \\text{As } t \\to \\infty, \t\\quad \\ln(t + 1) \\to \\infty &\\implies \\dfrac{100}{3\\ln(t + 1) + 10} \\to 0 \\cr\n&\\implies x(t) \\to 10 \\end{aligned}<br>Both models predict that the concentration will saturate at a limit of $10$ units/L. However, the first model approaches this limit much faster (exponential decay of the remaining concentration gap) compared to the slow logarithmic decay of the revised model.<br><br>Final Answer: \\begin{aligned} x(t) &= 10\\left(1 - 0.8^t\\right) \\cr\nx(t) &= 10 - \\dfrac{ 100 }{ 3\\ln(t + 1) + 10 } \\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "img": false,
                "question": "A liquid is cooling in a temperature-controlled laboratory. Let $\\theta$ be the temperature of the liquid in $^{\\circ}\\mathrm{C}$ at time $t$ minutes. The ambient room temperature is kept constant at $20^{\\circ}\\mathrm{C}$. At $t = 0$, the liquid is at $84^{\\circ}\\mathrm{C}$, and at $t = 10$ minutes, it has cooled to $52^{\\circ}\\mathrm{C}$.<br><br><strong>1.</strong> A classic model assumes that the rate of decrease of the liquid's temperature is proportional to the difference between its current temperature $\\theta$ and the ambient room temperature.<br>&nbsp;&nbsp;&nbsp;&nbsp;<strong>(a)</strong> Write down a differential equation to model this situation.<br>&nbsp;&nbsp;&nbsp;&nbsp;<strong>(b)</strong> Solve this differential equation to find $\\theta$ in terms of $t$.<br><br><strong>2.</strong> In a revised model, the rate of cooling is assumed to be governed by:<br>$$\\dfrac{\\mathrm{d}\\theta}{\\mathrm{d}t} = -\\dfrac{(\\theta - 20)^{3/2}}{30\\sqrt{t + 4}}$$<br>Solve this differential equation to find $\\theta$ in terms of $t$, using the same initial temperature of $84^{\\circ}\\mathrm{C}$ at $t = 0$.<br><br><strong>3.</strong> State, with a brief reason, what both models predict about the temperature of the liquid in the long term.",
                "steps": [
                "Represent Newton's Law of Cooling as a differential equation, writing the rate of decrease as a negative rate of change:<br>$$\\dfrac{\\mathrm{d}\\theta}{\\mathrm{d}t} = -k(\\theta - 20)$$<br>where $k > 0$ is a constant of proportionality.",
                "Separate the variables and integrate to solve the equation:<br>\\begin{aligned} \\dfrac{1}{\\theta - 20} \\mathrm{d}\\theta &= -k \\mathrm{d}t \\cr\n\\int \\dfrac{1}{\\theta - 20} \\mathrm{d}\\theta &= \\int -k \\mathrm{d}t \\cr\n\\ln(\\theta - 20) &= -kt + C \\cr\n\\theta - 20 &= Ae^{-kt} \\cr\n\\theta(t) &= 20 + Ae^{-kt} \\end{aligned}",
                "Apply the initial conditions to find the constants $A$ and $k$. Substitute $t = 0$ and $\\theta = 84$:<br>\\begin{aligned} 84 &= 20 + Ae^{0} \\cr\nA &= 64 \\end{aligned}<br>This gives $\\theta(t) = 20 + 64e^{-kt}$. Substitute $t = 10$ and $\\theta = 52$ to find $k$:<br>\\begin{aligned} 52 &= 20 + 64e^{-10k} \\cr\n32 &= 64e^{-10k} \\cr\ne^{-10k} &= 0.5 \\cr\n-10k &= \\ln 0.5 \\cr\nk &= \\dfrac{ \\ln 2 }{ 10 } \\end{aligned}<br>Substituting $e^{-kt} = (e^{-10k})^{t/10} = 0.5^{t/10} = 2^{-t/10}$ yields:<br>$$\\theta(t) = 20 + 64\\cdot 2^{-t/10}$$",
                "For the revised model, separate variables and integrate:<br>\\begin{aligned} \\dfrac{\\mathrm{d}\\theta}{\\mathrm{d}t} &= -\\dfrac{(\\theta - 20)^{3/2}}{30\\sqrt{t + 4}} \\cr\n(\\theta - 20)^{-3/2} \\mathrm{d}\\theta &= -\\dfrac{1}{30}(t + 4)^{-1/2} \\mathrm{d}t \\cr\n\\int (\\theta - 20)^{-3/2} \\mathrm{d}\\theta &= -\\dfrac{1}{30}\\int (t + 4)^{-1/2} \\mathrm{d}t \\cr\n-2(\\theta - 20)^{-1/2} &= -\\dfrac{1}{30}\\left(2\\sqrt{t + 4}\\right) + C \\cr\n2(\\theta - 20)^{-1/2} &= \\dfrac{1}{15}\\sqrt{t + 4} - C \\end{aligned}",
                "Multiply both sides by $\\dfrac{1}{2}$ to simplify:<br>$$(\\theta - 20)^{-1/2} = \\dfrac{1}{30}\\sqrt{t + 4} + C'$$<br>where $C' = -\\dfrac{1}{2}C$. Use the initial condition $t = 0$ and $\\theta = 84$ to find $C'$:<br>\\begin{aligned} (84 - 20)^{-1/2} &= \\dfrac{1}{30}\\sqrt{0 + 4} + C' \\cr\n64^{-1/2} &= \\dfrac{1}{30}(2) + C' \\cr\n\\dfrac{1}{8} &= \\dfrac{1}{15} + C' \\cr\nC' &= \\dfrac{1}{8} - \\dfrac{1}{15} \\cr\n&= \\dfrac{ 15 - 8 }{ 120 } \\cr\n&= \\dfrac{7}{120} \\end{aligned}",
                "Substitute $C'$ and isolate $\\theta$:<br>\\begin{aligned} (\\theta - 20)^{-1/2} &= \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\cr\n\\theta(t) - 20 &= \\left( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\right)^{-2} \\cr\n\\theta(t) &= 20 + \\left( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\right)^{-2} \\end{aligned}",
                "Examine the long-term behaviour as $t \\to \\infty$:<br>For the first model:<br>\\begin{aligned} \\text{As } t \\to \\infty, \\quad 2^{-t/10} &\\to 0 \\cr\n\\theta(t) &\\to 20 + 0 = 20 \\end{aligned}<br>For the revised model:<br>\\begin{aligned} \\text{As } t \\to \\infty, \\quad \\sqrt{t + 4} &\\to \\infty \\cr\n\\left( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\right)^{-2} &\\to 0 \\cr\n\\theta(t) &\\to 20 + 0 = 20 \\end{aligned}<br>Both models predict that the liquid will cool down to approach the room temperature of $20^{\\circ}\\mathrm{C}$ in the long term, and neither model projects that the temperature will fall below this ambient level.<br><br>Final Answer: \\begin{aligned} \\theta(t) &= 20 + 64\\cdot 2^{-t/10} \\cr\n\\theta(t) &= 20 + \\left( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\right)^{-2} \\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "img": false,
                "question": "An investor establishes a retirement fund. Let $V$ represent the value of the fund (in thousands of pounds) at time $t$ years. Initially, when $t = 0$, the fund has a value of $V = 10$. After $5$ years, the value of the fund is $V = 20$.<br><br><strong>1.</strong> A simple model assumes that the rate of increase of the fund's value is directly proportional to its current value.<br>&nbsp;&nbsp;&nbsp;&nbsp;<strong>(a)</strong> Write down a differential equation to model this situation.<br>&nbsp;&nbsp;&nbsp;&nbsp;<strong>(b)</strong> Solve this differential equation to find $V$ in terms of $t$.<br><br><strong>2.</strong> In a revised model, the investor makes continuous annual withdrawals, and the rate of change of the fund's value is given by:<br>$$\\dfrac{\\mathrm{d}V}{\\mathrm{d}t} = 0.1V - 2$$<br>Solve this differential equation to find $V$ in terms of $t$, using the same initial value of $V = 10$ at $t = 0$.<br><br><strong>3.</strong> Compare the long-term behaviour predicted by the two models. Determine the exact time at which the fund is projected to run out under the revised model.",
                "steps": [
                "Represent the rate of change for direct proportionality as a differential equation:<br>$$\\dfrac{\\mathrm{d}V}{\\mathrm{d}t} = kV$$<br>where $k > 0$ is a constant of proportionality.",
                "Integrate the separable differential equation:<br>\\begin{aligned} \\int \\dfrac{1}{V} \\mathrm{d}V &= \\int k \\mathrm{d}t \\cr\n\\ln V &= kt + C \\cr\nV(t) &= Ae^{kt} \\end{aligned}<br>where $A = e^C$. Substitute the boundary conditions to find the constants $A$ and $k$.<br><br>Substitute $t = 0$ and $V = 10$ to find $A$:<br>$$A = 10$$<br>Now substitute $t = 5$, $V = 20$, and $A = 10$ to find $k$:<br>\\begin{aligned} 20 &= 10e^{5k} \\cr\n2 &= e^{5k} \\cr\n5k &= \\ln 2 \\cr\nk &= \\dfrac{ \\ln 2 }{ 5 } \\end{aligned}<br>Substituting $k$ back into the model gives:<br>\\begin{aligned} V(t) &= 10e^{\\frac{ \\ln 2 }{ 5 }t} \\cr\n&= 10 \\cdot 2^{t/5} \\end{aligned}",
                "For the revised model, separate variables and integrate:<br>\\begin{aligned} \\dfrac{\\mathrm{d}V}{\\mathrm{d}t} &= 0.1V - 2 \\cr\n\\dfrac{1}{0.1V - 2} \\mathrm{d}V &= \\mathrm{d}t \\cr\n\\int \\dfrac{1}{0.1V - 2} \\mathrm{d}V &= \\int \\mathrm{d}t \\cr\n10\\ln|0.1V - 2| &= t + C' \\end{aligned}",
                "Solve for $V(t)$:<br>\\begin{aligned} \\ln|0.1V - 2| &= 0.1t + 0.1C' \\cr\n0.1V - 2 &= Be^{0.1t} \\cr\n0.1V &= 2 + Be^{0.1t} \\cr\nV(t) &= 20 + A'e^{0.1t} \\end{aligned}<br>where $A' = 10B$. Substitute the initial condition $t = 0$ and $V = 10$ to find $A'$:<br>\\begin{aligned} 10 &= 20 + A'e^{0} \\cr\nA' &= -10 \\end{aligned}<br>So the value of the fund under the revised model is:<br>$$V(t) = 20 - 10e^{0.1t}$$",
                "Compare the long-term behaviour and find the depletion point:<br>For the first model, $V(t) = 10 \\cdot 2^{t/5} \\to \\infty$ as $t \\to \\infty$, representing unbounded compound growth.<br>For the revised model, $V(t) = 20 - 10e^{0.1t}$ eventually decreases because the withdrawal term exceeds the growth term. The fund is exhausted when $V(t) = 0$:<br>\\begin{aligned} 20 - 10e^{0.1t} &= 0 \\cr\n10e^{0.1t} &= 20 \\cr\ne^{0.1t} &= 2 \\cr\n0.1t &= \\ln 2 \\cr\nt &= 10\\ln 2 \\end{aligned}<br>The fund runs out after exactly $10\\ln 2$ years (approximately $6.93$ years).<br><br>Final Answer: \\begin{aligned} V(t) &= 10 \\cdot 2^{t/5} \\cr\nV(t) &= 20 - 10e^{0.1t} \\cr\nt_{\\text{exhaust}} &= 10\\ln 2 \\text{ years} \\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "img": false,
                 "question": "An environmental scientist is monitoring a bird population, $B$, on an isolated island. When monitoring begins at $t = 0$, there are $100$ birds, and at $t = 1$ year, there are $150$ birds.<br><br><strong>1.</strong> A simple geometric model assumes that the rate of increase of the bird population is directly proportional to the number of birds present.<br>&nbsp;&nbsp;&nbsp;&nbsp;<strong>(a)</strong> Write down a differential equation to model this situation.<br>&nbsp;&nbsp;&nbsp;&nbsp;<strong>(b)</strong> Solve this differential equation to find $B$ in terms of $t$.<br><br><strong>2.</strong> A more realistic logistic model assumes that the island has a maximum carrying capacity of $500$ birds, and that the rate of growth is modeled by the differential equation:<br>$$\\dfrac{\\mathrm{d}B}{\\mathrm{d}t} = \\dfrac{B(500 - B)}{2000}$$<br>Solve this differential equation to find $B$ in terms of $t$, using the same initial population of $100$ birds at $t = 0$.<br><br><strong>3.</strong> Compare the long-term behaviour predicted by the two models as $t \\to \\infty$.",
                "steps": [
                "Represent exponential growth as a differential equation:<br>$$\\dfrac{\\mathrm{d}B}{\\mathrm{d}t} = kB$$<br>where $k > 0$ is a constant of proportionality.",
                "Solve by separating the variables and integrating both sides:<br>\\begin{aligned} \\int \\dfrac{1}{B} \\mathrm{d}B &= \\int k \\mathrm{d}t \\cr\n\\ln B &= kt + C \\cr\nB(t) &= Ae^{kt} \\end{aligned}<br>where $A = e^C$. Substitute the boundary conditions to find the constants $A$ and $k$.<br><br>Substitute $t = 0$ and $B = 100$ to find $A$:<br>$$A = 100$$<br>Now substitute $t = 1$, $B = 150$, and $A = 100$ to find $k$:<br>\\begin{aligned} 150 &= 100e^{k} \\cr\ne^k &= 1.5 \\cr\nk &= \\ln 1.5 \\end{aligned}<br>So the first model is:<br>\\begin{aligned} B(t) &= 100e^{(\\ln 1.5)t} \\cr\n&= 100 \\cdot 1.5^t \\end{aligned}",
                "For the logistic model, separate the variables:<br>$$\\dfrac{ 1 }{ B(500 - B) } \\mathrm{d}B = \\dfrac{ 1 }{ 2000 } \\mathrm{d}t$$<br>Decompose the left-hand fraction using partial fractions:<br>\\begin{aligned} \\dfrac{ 1 }{ B(500 - B) } &= \\dfrac{ X }{ B } + \\dfrac{ Y }{ 500 - B } \\cr\n1 &= X(500 - B) + YB \\end{aligned}<br>By substituting $B = 0 \\implies X = \\dfrac{ 1 }{ 500 }$, and by substituting $B = 500 \\implies Y = \\dfrac{ 1 }{ 500 }$.<br>So the decomposed expression is:<br>$$\\dfrac{ 1 }{ B(500 - B) } = \\dfrac{ 1 }{ 500 }\\left( \\dfrac{ 1 }{ B } + \\dfrac{ 1 }{ 500 - B } \\right)$$$",
                "Integrate both sides using the partial fraction decomposition:<br>\\begin{aligned} \\dfrac{1}{500} \\int \\left( \\dfrac{1}{B} + \\dfrac{1}{500 - B} \right) \\mathrm{d}B &= \\int \\dfrac{1}{2000} \\mathrm{d}t \\cr\n\\dfrac{1}{500}\\left( \\ln|B| - \\ln|500 - B| \\right) &= \\dfrac{t}{2000} + C_1 \\cr\n\\ln\\left( \\dfrac{B}{500 - B} \right) &= \\dfrac{t}{4} + C' \\end{aligned}<br>where $C' = 500C_1$. Taking exponentials of both sides:<br>$$\\dfrac{B}{500 - B} = Ke^{t/4}$$",
                "Substitute the initial condition $t = 0$ and $B = 100$ to find $K$:<br>\\begin{aligned} \\dfrac{100}{500 - 100} &= Ke^{0} \\cr\n\\dfrac{100}{400} &= K \\cr\nK &= \\dfrac{1}{4} \\end{aligned}<br>This gives:<br>$$\\dfrac{B}{500 - B} = \\dfrac{1}{4}e^{t/4}$$",
                "Rearrange to isolate $B(t)$:<br>\\begin{aligned} B &= (500 - B)\\left(\\dfrac{1}{4}e^{t/4}\\right) \\cr\nB &= 125e^{t/4} - \\dfrac{1}{4}Be^{t/4} \\cr\nB\\left(1 + \\dfrac{1}{4}e^{t/4}\\right) &= 125e^{t/4} \\cr\nB(t) &= \\dfrac{125e^{t/4}}{1 + \\dfrac{1}{4}e^{t/4}} \\cr\nB(t) &= \\dfrac{500e^{t/4}}{4 + e^{t/4}} \\end{aligned}",
                "Examine the long-term behaviour as $t \\to \\infty$:<br>For the simple geometric model, $B(t) = 100 \\cdot 1.5^t \\to \\infty$, which predicts unbounded population expansion.<br>For the logistic model, divide the numerator and the denominator by $e^{t/4}$:<br>$$B(t) = \\dfrac{500}{4e^{-t/4} + 1}$$<br>As $t \\to \\infty, \\, e^{-t/4} \\to 0$. Therefore:<br>\\begin{aligned} \\text{As } t \\to \\infty, \\quad e^{-t/4} &\\to 0 \\cr\nB(t) &\\to \\dfrac{500}{0 + 1} = 500 \\end{aligned}<br>The simple model assumes infinite growth, whereas the logistic model predicts the population is bounded and will level off at the carrying capacity of $500$ birds.<br><br>Final Answer: \\begin{aligned} B(t) &= 100\\cdot 1.5^t \\cr\nB(t) &= \\dfrac{500e^{t/4}}{4 + e^{t/4}} \\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Conclude the proof based on the result:<br>Since $f(3) = 0$, by the Factor Theorem, $(x - 3)$ is indeed a factor of $2x^3 - 5x^2 - 4x + 3$.<br><br>Final Answer: \\begin{aligned}\nf(3) &= 0 \\cr\n(x - 3) \\text{ is a factor}\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        "According to the Factor Theorem, because $(x - 2)$ and $(x + 3)$ are factors, evaluating $f(x)$ at their roots $x = 2$ and $x = -3$ must result in $0$:<br>\\begin{aligned}\nf(2) &= 0 \\quad \\text{and} \\quad f(-3) \\cr\n&= 0\n\\end{aligned}",
                        "Evaluate $f(2) = 0$ to set up the first equation:<br>$\\begin{aligned} f(2) &= a(2)^3 + b(2)^2 - 11(2) - 6$ $&= 8a + 4b - 22 - 6$ $&= 8a + 4b - 28 \\end{aligned}$<br>Setting this to $0$ and dividing by $4$ gives:<br>\\begin{aligned}\n2a + b &= 7 \\quad \\cr\n\\quad b &= 7 - 2a \\quad \\text{--- (Equation 1)}\n\\end{aligned}",
                        "Evaluate $f(-3) = 0$ to set up the second equation:<br>$\\begin{aligned} f(-3) &= a(-3)^3 + b(-3)^2 - 11(-3) - 6$ $&= -27a + 9b + 33 - 6$ $&= -27a + 9b + 27 \\end{aligned}$<br>Setting this to $0$ and dividing by $9$ gives:<br>\\begin{aligned}\n-3a + b &= -3 \\quad \\cr\n\\quad b &= 3a - 3 \\quad \\text{--- (Equation 2)}\n\\end{aligned}",
                        "Solve the simultaneous equations by equating the two expressions for $b$:<br>$\\begin{aligned} 7 - 2a &= 3a - 3$ $10 &= 5a$ $a &= 2 \\end{aligned}$",
                        "Substitute $a = 2$ back into Equation 1 to find $b$:<br>$\\begin{aligned} b &= 7 - 2(2)$ $b &= 3 \\end{aligned}$<br><br>Final Answer: \\begin{aligned}\na &= 2, \\quad b \\cr\n&= 3\n\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "$$a = -2, \\quad b = 11$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Conclude based on the change of sign:<br>Since $f(x)$ is continuous on the interval $[0.5, 1.0]$, and there is a change of sign between $x = 0.5$ ($f(0.5) > 0$) and $x = 1.0$ ($f(1.0) < 0$), there must be a root $\\alpha$ in the interval $0.5 < \\alpha < 1.0$.<br><br>Final Answer: \\begin{aligned}\nf(0.5) &= 1.1487 > 0, \\quad f(1.0) = -1.2817 < 0 \\cr\n0.5 < \\alpha < 1.0\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Factorise the quadratic equation:<br>$$\\left( \\tan \\theta + 4 \\right)\\left( \\tan \\theta - 1 \\right) = 0$$<br>This gives two possible values for $\\tan \\theta$:<br>\\begin{aligned}\n\\tan \\theta &= 1 \\quad \\text{or} \\quad \\tan \\theta \\cr\n&= -4\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Factorise the quadratic expression:<br>\\begin{aligned}\n(2\\cot \\theta - 1)(\\cot \\theta + 3) &= 0 \\cr\n\\cot \\theta &= 0.5 \\quad \\text{or} \\quad \\cot \\theta = -3\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Factorise the quadratic equation:<br>$$\\left(3\\sin \\theta - 1\\right)\\left(2\\sin \\theta + 1\\right) = 0$$<br>This gives two possible values for $\\sin \\theta$:<br>\\begin{aligned}\n\\sin \\theta &= \\dfrac{1}{3} \\quad \\text{or} \\quad \\sin \\theta \\cr\n&= -\\dfrac{1}{2}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Factorise out the common term $2\\cos \\theta$:<br>$$2\\cos \\theta\\left(3\\sin \\theta - 2\\right) = 0$$<br>This gives two branches to solve:<br>\\begin{aligned}\n\\cos \\theta &= 0 \\quad \\text{or} \\quad \\sin \\theta \\cr\n&= \\dfrac{2}{3}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Use the standard $n$-th term formula for an arithmetic progression, $u_n = a + (n-1)d$, with first term $a = 5$:<br>\\begin{aligned}\nu_{20} &= 5 + (20 - 1)d \\cr\n&= 5 + 19d\n\\end{aligned}",
                        ...
                        "Calculate the distance run on day $30$ using $a = 5$ and $d = 0.5$:<br>$\\begin{aligned} u_{30} &= a + 29d$ $&= 5 + 29(0.5)$ $&= 5 + 14.5$ $&= 19.5 \\end{aligned}$<br>The athlete runs $19.5$ km on day $30$.<br><br>Final Answer: \\begin{aligned}\nu_{20} &= 5 + 19d, \\quad d \\cr\n&= 0.5, \\quad u_{30} \\cr\n&= 19.5\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Find the corresponding values of $a$ for each value of $r$:<br>$\\begin{aligned} \\text{If } r = \\dfrac{2}{5}: \\quad a &= \\dfrac{6}{2/5} = 15$ $\\text{If } r = \\dfrac{3}{5}: \\quad a &= \\dfrac{6}{3/5} = 10 \\end{aligned}$<br><br>Final Answer: \\begin{aligned}\nr &= \\dfrac{2}{5}, \\, a \\cr\n&= 15 \\quad \\text{and} \\quad r \\cr\n&= \\dfrac{3}{5}, \\, a \\cr\n&= 10\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Use the geometric sum formula $S_n = \\dfrac{a\\left(r^n - 1\\right)}{r - 1}$ to calculate the total sum:<br>$\\begin{aligned} S_{10} &= \\dfrac{10\\left(2^{10} - 1\\right)}{2 - 1}$ $&= 10(1024 - 1)$ $&= 10(1023)$ $&= 10230 \\end{aligned}$<br><br>Final Answer: \\begin{aligned}\n\\sum_{r &= 1}^{50} (3r + 2) \\cr\n&= 3925, \\quad \\sum_{k \\cr\n&= 1}^{10} \\left(5\\cdot 2^k\\right) \\cr\n&= 10230\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Use the solved relation $u_{n+1} = 3u_n + 2$ with $u_3 = 44$ to calculate the value of $u_4$:<br>$\\begin{aligned} u_4 &= 3u_3 + 2$ $&= 3(44) + 2$ $&= 132 + 2$ $&= 134 \\end{aligned}$<br><br>Final Answer: \\begin{aligned}\np &= 3, \\, q \\cr\n&= 2, \\, u_4 \\cr\n&= 134\n\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "$$p = 3, \\, q = 2, \\, u_4 = 132$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Use the standard definitions $\\cot 2x = \\dfrac{\\cos 2x}{\\sin 2x}$ and $\\csc 2x = \\dfrac{1}{\\sin 2x}$ to complete the proof:<br>\\begin{aligned}\n\\dfrac{\\cos 2x}{\\sin 2x} \\cdot \\dfrac{1}{\\sin 2x} &= \\cot 2x \\csc 2x \\cr\n&= \\csc 2x \\cot 2x\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Write down the standard double-angle cosine identity that expresses $\\cos^2 A$ as a linear term:<br>\\begin{aligned}\n\\cos 2A &= 2\\cos^2 A - 1 \\cr\n\\cos^2 A &= \\dfrac{1}{2}\\left(1 + \\cos 2A\\right)\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "The curve intersects the $x$-axis at the boundaries $x = 1$ and $x = c$. To find the exact area, set up the definite integral of the function over this interval:<br>$$A = \\int_{1}^{c} (c - x)\\ln x \\,\\text{d}x$$<br>We can split this into two separate integrals to simplify the integration by parts:<br>\\begin{aligned}\nA &= c \\int_{1}^{c} \\ln x \\,\\text{d}x - \\int_{1}^{c} x\\ln x \\,\\text{d}x \\cr\n&= c I_1 - I_2\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Set up the definite integral for the area bounded by the curve, $x = 1$, and $x = e$:<br>\\begin{aligned}\nA &= \\int_{1}^{e} 3x^2 \\ln x \\,\\text{d}x \\cr\n&= 3 \\int_{1}^{e} x^2 \\ln x \\,\\text{d}x\n\\end{aligned}",
                        ...
                        "Multiply the indefinite integral by the coefficient $3$ before substituting the limits:<br>\\begin{aligned}\n3 \\int x^2 \\ln x \\,\\text{d}x &= 3\\left( \\dfrac{x^3}{3}\\ln x - \\dfrac{x^3}{9} \\right) \\cr\n&= x^3\\ln x - \\dfrac{x^3}{3}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Find the $x$-intercept by setting $y = 0$:<br>$$(x - 2)e^{-x} = 0$$<br>Since $e^{-x} \\ne 0$ for all real $x$, we must have:<br>\\begin{aligned}\nx - 2 &= 0 \\cr\nx &= 2\n\\end{aligned}<br>This confirms the curve intersects the $x$-axis at the point $(2,0)$.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Show that the tangent passes through the origin by substituting $x = 0$ into its equation:<br>\\begin{aligned}\ny &= \\dfrac{0}{e} \\cr\n&= 0\n\\end{aligned}<br>This confirms that the tangent passes through the origin $(0,0)$.",
                        ...
                        "Evaluate the first part, which is a right-angled triangle of base $e$ and height $1$:<br>\\begin{aligned}\n\\int_{0}^{e} \\dfrac{x}{e} \\,\\text{d}x &= \\left[ \\dfrac{x^2}{2e} \\right]_{0}^{e} \\cr\n&= \\dfrac{e^2}{2e} - 0 \\cr\n&= \\dfrac{e}{2}\n\\end{aligned}",
                        ...
                        "Subtract the area under the curve from the area under the tangent to find the exact area of the region:<br>$$A = \\dfrac{e}{2} - 1$$<br><br>Final Answer: \\begin{aligned}\ny &= \\dfrac{x}{e}, \\quad \\text{Area} \\cr\n&= \\dfrac{e}{2} - 1\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Write the line equation in standard linear form $ax + by + c = 0$:<br>\\begin{aligned}\n4y &= 3x - 27 \\cr\n3x - 4y - 27 &= 0\n\\end{aligned}<br>Show the line is a tangent by finding the perpendicular distance from the centre $C(2,1)$ to this line and verifying it equals the radius:<br>\\begin{aligned}\n\\text{Distance} &= \\dfrac{|3(2) - 4(1) - 27|}{\\sqrt{3^2 + (-4)^2}} \\cr\n&= \\dfrac{|6 - 4 - 27|}{5} \\cr\n&= \\dfrac{25}{5} \\cr\n&= 5\n\\end{aligned}<br>Since the perpendicular distance is exactly $5$ (equal to the radius), the line is indeed a tangent.",
                        ...
                        "Substitute $x = 5$ back into the line equation to find the $y$-coordinate of $B$:<br>\\begin{aligned}\ny &= \\dfrac{3(5) - 27}{4} \\cr\n&= \\dfrac{15 - 27}{4} \\cr\n&= -3\n\\end{aligned}<br>So, the point of contact is $B(5, -3)$.",
                        "To prove $ADBC$ is a square, find the equation of the tangent at $A(6,4)$. The gradient of the radius $CA$ is:<br>\\begin{aligned}\nm_{CA} &= \\dfrac{4 - 1}{6 - 2} \\cr\n&= \\dfrac{3}{4}\n\\end{aligned}<br>Since the tangent is perpendicular to the radius, its gradient is $m_{\\text{tangent}} = -\\dfrac{4}{3}$. Use the point-gradient formula with $A(6,4)$ to find its equation:<br>\\begin{aligned}\ny - 4 &= -\\dfrac{4}{3}(x - 6) \\cr\ny &= -\\dfrac{4}{3}x + 12\n\\end{aligned}",
                        ...
                        "Find the coordinates of $E$, the lowest point of the circle, by subtracting the radius from the $y$-coordinate of the centre:<br>\\begin{aligned}\nE &= (2, 1 - 5) \\cr\n&= (2, -4)\n\\end{aligned}<br>Find the angle $\\theta = \\angle ECB$ using the dot product of vectors $\\mathbf{CE}$ and $\\mathbf{CB}$:<br>\\begin{aligned} \\mathbf{CE} &= \\begin{pmatrix} 2 - 2 \\\\\\ -4 - 1 \\end{pmatrix} = \\begin{pmatrix} 0 \\\\\\ -5 \\end{pmatrix} \\\\\\ \\mathbf{CB} &= \\begin{pmatrix} 5 - 2 \\\\\\ -3 - 1 \\end{pmatrix} = \\begin{pmatrix} 3 \\\\\\ -4 \\end{pmatrix} \\\\\\ \\mathbf{CE} \\cdot \\mathbf{CB} &= 0(3) + (-5)(-4) = 20 \\\\\\ \\cos \\theta &= \\dfrac{20}{|\\mathbf{CE}||\\mathbf{CB}|} = \\dfrac{20}{5 \\cdot 5} = \\dfrac{4}{5} \\\\\\ \\theta &= \\arccos\\left(\\dfrac{4}{5}\\right) \\end{aligned}",
                        "Calculate the exact area of the sector $ECB$ using the sector area formula, $A = \\dfrac{1}{2}r^2 \\theta$:<br>\\begin{aligned}\n\\text{Area} &= \\dfrac{1}{2}(25)\\arccos\\left(\\dfrac{4}{5}\\right) \\cr\n&= \\dfrac{25}{2}\\arccos\\left(\\dfrac{4}{5}\\right)\n\\end{aligned}<br><br>Final Answer: $$C(2,1), \\quad B(5,-3), \\quad \\text{Area} = \\dfrac{25}{2}\\arccos\\left(\\dfrac{4}{5}\\right)$$"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Write the line equation in standard linear form $ax + by + c = 0$:<br>\\begin{aligned}\ny &= 2x - 5 \\cr\n2x - y - 5 &= 0\n\\end{aligned}<br>To show the line is a tangent, calculate the perpendicular distance from the centre $(1,2)$ to the line and check if it equals the radius:<br>\\begin{aligned}\n\\text{Distance} &= \\dfrac{|2(1) - 2 - 5|}{\\sqrt{2^2 + (-1)^2}} \\cr\n&= \\dfrac{|2 - 2 - 5|}{\\sqrt{5}} \\cr\n&= \\dfrac{5}{\\sqrt{5}} \\cr\n&= \\sqrt{5}\n\\end{aligned}<br>Since the perpendicular distance from the centre to the line is exactly equal to the radius, the line is indeed a tangent to the circle.",
                        ...
                        "Substitute $x = 3$ back into the line equation to find the $y$-coordinate of $P$:<br>\\begin{aligned}\ny &= 2(3) - 5 \\cr\n&= 1\n\\end{aligned}<br>So, the coordinates of the point of contact are $P(3, 1)$.<br><br>Final Answer: $$P(3,1)$$"
                ],
                "pi_options": [
                        {
                                "ans": "$$P(3,-1)$$",
        ...
        },
        {
                ...
                "steps": [
                        "The centre of the circle is the midpoint of the diameter $AB$. Use the midpoint formula:<br>\\begin{aligned}\n\\text{Centre} &= \\left( \\dfrac{1 + 7}{2}, \\, \\dfrac{2 + 10}{2} \\right) \\cr\n&= (4, 6)\n\\end{aligned}",
                        ...
                        "To find the tangent at $B(7,10)$, calculate the gradient of the radius $CB$:<br>\\begin{aligned}\nm_{CB} &= \\dfrac{10 - 6}{7 - 4} \\cr\n&= \\dfrac{4}{3}\n\\end{aligned}<br>Since the tangent is perpendicular to the radius at the point of contact, its gradient is the negative reciprocal:<br>$$m_{\\text{tangent}} = -\\dfrac{3}{4}$$",
                        "Use the point-gradient formula with $B(7,10)$ to obtain the tangent equation and rearrange it into integer standard form:<br>$\\begin{aligned} y - 10 &= -\\dfrac{3}{4}(x - 7)$ $4(y - 10) &= -3(x - 7)$ $4y - 40 &= -3x + 21$ $3x + 4y - 61 &= 0 \\end{aligned}$<br><br>Final Answer: \\begin{aligned}\n(x - 4)^2 + (y - 6)^2 &= 25, \\quad 3x + 4y - 61 \\cr\n&= 0\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Divide by $2$ to simplify the quadratic equation:<br>$$x^2 - 3x - 10 = 0$$<br>Calculate the discriminant ($b^2 - 4ac$) to show there are two distinct real roots (intersections):<br>\\begin{aligned}\n\\text{Discriminant} &= (-3)^2 - 4(1)(-10) \\cr\n&= 9 + 40 \\cr\n&= 49\n\\end{aligned}<br>Since the discriminant $49 > 0$, the equation has two real roots, proving the line intersects the circle at two distinct points.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Simplify the equation to solve for $c$:<br>$\\begin{aligned} \\dfrac{|2 + c|}{\\sqrt{5}} &= 5$ $|2 + c| &= 5\\sqrt{5} \\end{aligned}$<br>This gives two possible equations:<br>\\begin{aligned}\n2 + c &= 5\\sqrt{5} \\quad \\text{or} \\quad 2 + c \\cr\n&= -5\\sqrt{5}\n\\end{aligned}",
                        "Isolate $c$ to find the two possible exact values:<br>\\begin{aligned}\nc &= -2 + 5\\sqrt{5} \\quad \\text{or} \\quad c \\cr\n&= -2 - 5\\sqrt{5}\n\\end{aligned}<br><br>Final Answer: \\begin{aligned}\nC(3,4), \\, R &= 5, \\, c \\cr\n&= -2 \\pm 5\\sqrt{5}\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Substitute these simplified expressions back into the original sum and collect like terms:<br>\\begin{aligned}\n\\sqrt{45} + \\sqrt{80} &= 3\\sqrt{5} + 4\\sqrt{5} \\cr\n&= 7\\sqrt{5}\n\\end{aligned}",
                        "Identify the values of the constants $a$ and $b$ from the expression $7\\sqrt{5}$ and confirm they are both prime numbers:<br>\\begin{aligned}\na &= 7 \\quad \\text{and} \\quad b \\cr\n&= 5\n\\end{aligned}<br>Since $7$ and $5$ are both prime, the conditions are satisfied.<br><br>Final Answer: \\begin{aligned}\na &= 7, \\quad b \\cr\n&= 5\n\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "$$a = 5, \\quad b = 5$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Expand and simplify the denominator using the difference of two squares identity, $(a-b)(a+b) = a^2 - b^2$:<br>\\begin{aligned}\n\\left(3 - \\sqrt{5}\\right)\\left(3 + \\sqrt{5}\\right) &= 3^2 - \\left(\\sqrt{5}\\right)^2 \\cr\n&= 9 - 5 \\cr\n&= 4\n\\end{aligned}",
                        ...
                        "Combine the simplified numerator and denominator into a single fraction and split it into individual terms:<br>$$\\dfrac{17 + 7\\sqrt{5}}{4} = \\dfrac{17}{4} + \\dfrac{7}{4}\\sqrt{5}$$<br>This matches the required form $x + y\\sqrt{5}$, where $x = \\dfrac{17}{4}$ and $y = \\dfrac{7}{4}$ are both rational numbers.<br><br>Final Answer: \\begin{aligned}\nx &= \\dfrac{17}{4}, \\quad y \\cr\n&= \\dfrac{7}{4}\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Simplify the denominator using the difference of two squares:<br>\\begin{aligned}\n\\left(3 - \\sqrt{3}\\right)\\left(3 + \\sqrt{3}\\right) &= 3^2 - \\left(\\sqrt{3}\\right)^2 \\cr\n&= 9 - 3 \\cr\n&= 6\n\\end{aligned}",
                        "Expand the numerator step-by-step:<br>\\begin{aligned}\n12\\sqrt{3}\\left(3 + \\sqrt{3}\\right) &= 36\\sqrt{3} + 12\\left(3\\right) \\cr\n&= 36\\sqrt{3} + 36\n\\end{aligned}",
                        "Divide the expanded numerator by the simplified denominator, and write it in the required form $p + q\\sqrt{3}$:<br>\\begin{aligned}\n\\text{Length} &= \\dfrac{36 + 36\\sqrt{3}}{6} \\cr\n&= 6 + 6\\sqrt{3}\n\\end{aligned}<br>This matches the required form where $p = 6$ and $q = 6$ are both integers.<br><br>Final Answer: \\begin{aligned}\np &= 6, \\quad q \\cr\n&= 6\n\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "$$p = 6, \\quad q = -6$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Substitute $y = \\sqrt{3}$ back into the expression for $x$ to find its value:<br>$\\begin{aligned} x &= 11 - \\left(\\sqrt{3}\\right)\\sqrt{3}$ $x &= 11 - 3$ $x &= 8 \\end{aligned}$<br><br>Final Answer: \\begin{aligned}\nx &= 8, \\quad y \\cr\n&= \\sqrt{3}\n\\end{aligned}"
                ],
                "pi_options": [
                        {
