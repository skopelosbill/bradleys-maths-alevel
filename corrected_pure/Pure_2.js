window.ALEVEL_QUESTIONS = [
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> The time for the first 3 kilometres is run at a steady pace of $20\\text{ min/km}$:<br>\\begin{aligned}\n\\text{Time}_{1-3} &= 3 \\times 20 \\cr\n&= 60\\text{ minutes}\n\\end{aligned}",
                        "The 4th kilometre takes 4% longer than the 3rd kilometre ($20\\text{ minutes}$):<br>\\begin{aligned}\n\\text{Time}_{4} &= 20 \\times 1.04 \\cr\n&= 20.8\\text{ minutes}\n\\end{aligned}",
                        "The 5th kilometre takes 4% longer than the 4th kilometre:<br>\\begin{aligned}\n\\text{Time}_{5} &= 20.8 \\times 1.04 \\cr\n&= 20 \\times 1.04^2 \\cr\n&= 21.632\\text{ minutes}\n\\end{aligned}",
                        "Adding these times together gives the total estimated time for the first 5 kilometres:<br>\\begin{aligned}\n\\text{Total Time} &= 60 + 20.8 + 21.632 \\cr\n&= 102.432\\text{ minutes}\n\\end{aligned}<br>Converting $0.432$ minutes into seconds: $0.432 \\times 60 = 25.92 \\approx 26\\text{ seconds}$.<br>Therefore, the time is <strong>102 minutes 26 seconds</strong> (to the nearest second).",
                        ...
                        "Using the sum formula, $S_N = \\dfrac{a(r_{\\text{gp}}^N - 1)}{r_{\\text{gp}} - 1}$:<br>\\begin{aligned}\nS_{12} &= \\dfrac{20.8(1.04^{12} - 1)}{1.04 - 1} \\cr\n&= \\dfrac{20.8(1.04^{12} - 1)}{0.04} \\cr\n&= 520(1.04^{12} - 1)\n\\end{aligned}<br>$$S_{12} \\approx 520(1.601032 - 1) \\approx 312.537\\text{ minutes}$$",
                        "Adding the initial $60\\text{ minutes}$ gives the total estimated time:<br>\\begin{aligned}\n\\text{Total Time} &= 60 + 312.537 \\cr\n&= 372.537\\text{ minutes}\n\\end{aligned}<br>Converting to hours, minutes, and seconds:<br>$$\\dfrac{372.537}{60} = 6\\text{ hours and } 12.537\\text{ minutes}$$<br>$$0.537 \\times 60 = 32.22 \\approx 32\\text{ seconds}$$<br>Therefore, the total estimated time is <strong>6 hours, 12 minutes, and 32 seconds</strong>.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> The time for the first 20 metres is drilled at a steady rate of $15\\text{ min/m}$:<br>\\begin{aligned}\n\\text{Time}_{1-20} &= 20 \\times 15 \\cr\n&= 300\\text{ minutes}\n\\end{aligned}",
                        "The 21st metre takes 2% longer than the 20th metre ($15\\text{ minutes}$):<br>\\begin{aligned}\n\\text{Time}_{21} &= 15 \\times 1.02 \\cr\n&= 15.3\\text{ minutes}\n\\end{aligned}",
                        "The 22nd metre takes 2% longer than the 21st metre:<br>\\begin{aligned}\n\\text{Time}_{22} &= 15.3 \\times 1.02 \\cr\n&= 15 \\times 1.02^2 \\cr\n&= 15.606\\text{ minutes}\n\\end{aligned}",
                        "Adding these times together gives the total estimated time for the first 22 metres:<br>\\begin{aligned}\n\\text{Total Time} &= 300 + 15.3 + 15.606 \\cr\n&= 330.906\\text{ minutes}\n\\end{aligned}<br>Converting $0.906$ minutes into seconds: $0.906 \\times 60 = 54.36 \\approx 54\\text{ seconds}$.<br>Therefore, the time is <strong>330 minutes 54 seconds</strong> (to the nearest second).",
                        ...
                        "Using the sum formula, $S_N = \\dfrac{a(r_{\\text{gp}}^N - 1)}{r_{\\text{gp}} - 1}$:<br>\\begin{aligned}\nS_{80} &= \\dfrac{15.3(1.02^{80} - 1)}{1.02 - 1} \\cr\n&= \\dfrac{15.3(1.02^{80} - 1)}{0.02} \\cr\n&= 765(1.02^{80} - 1)\n\\end{aligned}<br>$$S_{80} \\approx 765(4.875439 - 1) \\approx 2964.711\\text{ minutes}$$",
                        "Adding the initial $300\\text{ minutes}$ gives the total estimated time:<br>\\begin{aligned}\n\\text{Total Time} &= 300 + 2964.711 \\cr\n&= 3264.711\\text{ minutes}\n\\end{aligned}<br>Converting to hours, minutes, and seconds:<br>$$\\dfrac{3264.711}{60} = 54\\text{ hours and } 24.711\\text{ minutes}$$<br>$$0.711 \\times 60 = 42.66 \\approx 43\\text{ seconds}$$<br>Therefore, the total estimated time is <strong>54 hours, 24 minutes, and 43 seconds</strong>.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> The time for the first 10 kilometres is cycled at a steady pace of $3\\text{ min/km}$:<br>\\begin{aligned}\n\\text{Time}_{1-10} &= 10 \\times 3 \\cr\n&= 30\\text{ minutes}\n\\end{aligned}",
                        "The 11th kilometre takes 3% longer than the 10th kilometre ($3\\text{ minutes}$):<br>\\begin{aligned}\n\\text{Time}_{11} &= 3 \\times 1.03 \\cr\n&= 3.09\\text{ minutes}\n\\end{aligned}",
                        "The 12th kilometre takes 3% longer than the 11th kilometre:<br>\\begin{aligned}\n\\text{Time}_{12} &= 3.09 \\times 1.03 \\cr\n&= 3 \\times 1.03^2 \\cr\n&= 3.1827\\text{ minutes}\n\\end{aligned}",
                        "Adding these times together gives the total estimated time for the first 12 kilometres:<br>\\begin{aligned}\n\\text{Total Time} &= 30 + 3.09 + 3.1827 \\cr\n&= 36.2727\\text{ minutes}\n\\end{aligned}<br>Converting $0.2727$ minutes into seconds: $0.2727 \\times 60 = 16.362 \\approx 16\\text{ seconds}$.<br>Therefore, the time is <strong>36 minutes 16 seconds</strong> (to the nearest second).",
                        ...
                        "Using the sum formula, $S_N = \\dfrac{a(r_{\\text{gp}}^N - 1)}{r_{\\text{gp}} - 1}$:<br>\\begin{aligned}\nS_{40} &= \\dfrac{3.09(1.03^{40} - 1)}{1.03 - 1} \\cr\n&= \\dfrac{3.09(1.03^{40} - 1)}{0.03} \\cr\n&= 103(1.03^{40} - 1)\n\\end{aligned}<br>$$S_{40} \\approx 103(3.262038 - 1) \\approx 232.990\\text{ minutes}$$",
                        "Adding the initial $300\\text{ minutes}$ gives the total estimated time:<br>\\begin{aligned}\n\\text{Total Time} &= 30 + 232.990 \\cr\n&= 262.990\\text{ minutes}\n\\end{aligned}<br>Converting to hours, minutes, and seconds:<br>$$\\dfrac{262.990}{60} = 4\\text{ hours and } 22.990\\text{ minutes}$$<br>$$0.990 \\times 60 = 59.4 \\approx 59\\text{ seconds}$$<br>Therefore, the total estimated time is <strong>4 hours, 22 minutes, and 59 seconds</strong>.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> The time for the first 3 kilometres is hiked at a steady pace of $12\\text{ min/km}$:<br>\\begin{aligned}\n\\text{Time}_{1-3} &= 3 \\times 12 \\cr\n&= 36\\text{ minutes}\n\\end{aligned}",
                        "The 4th kilometre takes 6% longer than the 3rd kilometre ($12\\text{ minutes}$):<br>\\begin{aligned}\n\\text{Time}_{4} &= 12 \\times 1.06 \\cr\n&= 12.72\\text{ minutes}\n\\end{aligned}",
                        "The 5th kilometre takes 6% longer than the 4th kilometre:<br>\\begin{aligned}\n\\text{Time}_{5} &= 12.72 \\times 1.06 \\cr\n&= 12 \\times 1.06^2 \\cr\n&= 13.4832\\text{ minutes}\n\\end{aligned}",
                        "Adding these times together gives the total estimated time for the first 5 kilometres:<br>\\begin{aligned}\n\\text{Total Time} &= 36 + 12.72 + 13.4832 \\cr\n&= 62.2032\\text{ minutes}\n\\end{aligned}<br>Converting $0.2032$ minutes into seconds: $0.2032 \\times 60 = 12.192 \\approx 12\\text{ seconds}$.<br>Therefore, the time is <strong>62 minutes 12 seconds</strong> (to the nearest second).",
                        ...
                        "Using the sum formula, $S_N = \\dfrac{a(r_{\\text{gp}}^N - 1)}{r_{\\text{gp}} - 1}$:<br>\\begin{aligned}\nS_9 &= \\dfrac{12.72(1.06^9 - 1)}{1.06 - 1} \\cr\n&= \\dfrac{12.72(1.06^9 - 1)}{0.06} \\cr\n&= 212(1.06^9 - 1)\n\\end{aligned}<br>$$S_9 \\approx 212(1.689479 - 1) \\approx 146.169\\text{ minutes}$$",
                        "Adding the initial $36\\text{ minutes}$ gives the total estimated time:<br>\\begin{aligned}\n\\text{Total Time} &= 36 + 146.169 \\cr\n&= 182.169\\text{ minutes}\n\\end{aligned}<br>Converting to hours, minutes, and seconds:<br>$$\\dfrac{182.169}{60} = 3\\text{ hours and } 2.169\\text{ minutes}$$<br>$$2.169 \\times 60 = 10.14 \\approx 10\\text{ seconds}$$<br>Therefore, the total estimated time is <strong>3 hours, 2 minutes, and 10 seconds</strong>.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> The time for the first 2 kilometres is rowed at a steady pace of $8\\text{ min/km}$:<br>\\begin{aligned}\n\\text{Time}_{1-2} &= 2 \\times 8 \\cr\n&= 16\\text{ minutes}\n\\end{aligned}",
                        "The 3rd kilometre takes 4% longer than the 2nd kilometre ($8\\text{ minutes}$):<br>\\begin{aligned}\n\\text{Time}_{3} &= 8 \\times 1.04 \\cr\n&= 8.32\\text{ minutes}\n\\end{aligned}",
                        "The 4th kilometre takes 4% longer than the 3rd kilometre:<br>\\begin{aligned}\n\\text{Time}_{4} &= 8.32 \\times 1.04 \\cr\n&= 8 \\times 1.04^2 \\cr\n&= 8.6528\\text{ minutes}\n\\end{aligned}",
                        "Adding these times together gives the total estimated time for the first 4 kilometres:<br>\\begin{aligned}\n\\text{Total Time} &= 16 + 8.32 + 8.6528 \\cr\n&= 32.9728\\text{ minutes}\n\\end{aligned}<br>Converting $0.9728$ minutes into seconds: $0.9728 \\times 60 = 58.368 \\approx 58\\text{ seconds}$.<br>Therefore, the time is <strong>32 minutes 58 seconds</strong> (to the nearest second).",
                        ...
                        "Using the sum formula, $S_N = \\dfrac{a(r_{\\text{gp}}^N - 1)}{r_{\\text{gp}} - 1}$:<br>\\begin{aligned}\nS_8 &= \\dfrac{8.32(1.04^8 - 1)}{1.04 - 1} \\cr\n&= \\dfrac{8.32(1.04^8 - 1)}{0.04} \\cr\n&= 208(1.04^8 - 1)\n\\end{aligned}<br>$$S_8 \\approx 208(1.368569 - 1) \\approx 76.662\\text{ minutes}$$",
                        "Adding the initial $16\\text{ minutes}$ gives the total estimated time:<br>\\begin{aligned}\n\\text{Total Time} &= 16 + 76.662 \\cr\n&= 92.662\\text{ minutes}\n\\end{aligned}<br>Converting to minutes and seconds:<br>$$\\text{Total Time} = 92\\text{ minutes and } 0.662\\text{ minutes}$$<br>$$0.662 \\times 60 = 39.72 \\approx 40\\text{ seconds}$$<br>Therefore, the total estimated time is <strong>92 minutes 40 seconds</strong>.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 15\\text{e}^{-0.5x}$ and $v = \\sin x$:<br>$$u' = -7.5\\text{e}^{-0.5x}$$<br>$$v' = \\cos x$$<br>\\begin{aligned}\nf'(x) &= u'v + uv' \\cr\n&= -7.5\\text{e}^{-0.5x}\\sin x + 15\\text{e}^{-0.5x}\\cos x\n\\end{aligned}",
                        "Factorising out the exponential term:<br>$$f'(x) = 7.5\\text{e}^{-0.5x} \\left( 2\\cos x - \\sin x \\right)$$<br>At turning points, $f'(x) = 0$. Since $\\text{e}^{-0.5x} \\ne 0$ for all real $x$, we require:<br>\\begin{aligned}\n2\\cos x - \\sin x &= 0 \\cr\n2\\cos x &= \\sin x \\cr\n\\tan x &= 2\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 8\\text{e}^{-0.2x}$ and $v = \\sin x$:<br>$$u' = -1.6\\text{e}^{-0.2x}$$<br>$$v' = \\cos x$$<br>\\begin{aligned}\nf'(x) &= u'v + uv' \\cr\n&= -1.6\\text{e}^{-0.2x}\\sin x + 8\\text{e}^{-0.2x}\\cos x\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 12\\text{e}^{-\\frac{1}{3}x}$ and $v = \\sin x$:<br>$$u' = -4\\text{e}^{-\\frac{1}{3}x}$$<br>$$v' = \\cos x$$<br>\\begin{aligned}\nf'(x) &= u'v + uv' \\cr\n&= -4\\text{e}^{-\\frac{1}{3}x}\\sin x + 12\\text{e}^{-\\frac{1}{3}x}\\cos x\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 6\\text{e}^{-0.125x}$ and $v = \\sin x$:<br>$$u' = -0.75\\text{e}^{-0.125x}$$<br>$$v' = \\cos x$$<br>\\begin{aligned}\nf'(x) &= u'v + uv' \\cr\n&= -0.75\\text{e}^{-0.125x}\\sin x + 6\\text{e}^{-0.125x}\\cos x\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 20\\text{e}^{-\\frac{1}{6}x}$ and $v = \\sin x$:<br>$$u' = -\\frac{10}{3}\\text{e}^{-\\frac{1}{6}x}$$<br>$$v' = \\cos x$$<br>\\begin{aligned}\nf'(x) &= u'v + uv' \\cr\n&= -\\frac{10}{3}\\text{e}^{-\\frac{1}{6}x}\\sin x + 20\\text{e}^{-\\frac{1}{6}x}\\cos x\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Since the curve passes through the point $(4, \\frac{1}{2})$, we substitute $x = 4$ and $y = \\frac{1}{2}$ into the equation to solve for $p$:<br>\\begin{aligned}\n\\frac{1}{2} &= \\dfrac{p - 2(4)}{(2(4) - 6)(4 + 2)} \\cr\n\\frac{1}{2} &= \\dfrac{p - 8}{(2)(6)}\n\\end{aligned}<br>\\begin{aligned}\n\\frac{1}{2} &= \\dfrac{p - 8}{12} \\cr\n6 &= p - 8 \\cr\np &= 14\n\\end{aligned}",
                        "<strong>Part (b):</strong> To find the area of the region $R$, we must find where the curve crosses the $x$-axis (the $x$-intercept). Setting $y = 0$ in the numerator gives:<br>\\begin{aligned}\n14 - 2x &= 0 \\cr\n2x &= 14 \\cr\nx &= 7\n\\end{aligned}",
                        ...
                        "We simplify the integrand by factorising and cancelling a common factor of $2$:<br>\\begin{aligned}\n\\dfrac{14 - 2x}{(2x - 6)(x + 2)} &= \\dfrac{-2(x - 7)}{2(x - 3)(x + 2)} \\cr\n&= -\\dfrac{x - 7}{(x - 3)(x + 2)}\n\\end{aligned}",
                        ...
                        "Substituting these coefficients back into our integral gives:<br>\\begin{aligned}\n\\text{Area} &= \\int_{4}^{7} \\left( \\dfrac{4/5}{x - 3} - \\dfrac{9/5}{x + 2} \\right) \\text{ d}x \\cr\n&= \\left[ \\frac{4}{5}\\ln|x - 3| - \\frac{9}{5}\\ln|x + 2| \\right]_{4}^{7}\n\\end{aligned}",
                        "Evaluating this expression at our upper limit ($7$) and lower limit ($4$):<br>\\begin{aligned}\n\\text{Value at 7} &= \\frac{4}{5}\\ln(4) - \\frac{9}{5}\\ln(9) \\cr\n&= \\frac{8}{5}\\ln(2) - \\frac{18}{5}\\ln(3)\n\\end{aligned}<br>\\begin{aligned}\n\\text{Value at 4} &= \\frac{4}{5}\\ln(1) - \\frac{9}{5}\\ln(6) \\cr\n&= 0 - \\frac{9}{5}(\\ln 2 + \\ln 3) \\cr\n&= -\\frac{9}{5}\\ln(2) - \\frac{9}{5}\\ln(3)\n\\end{aligned}",
                        "Subtracting the lower limit value from the upper limit value yields:<br>$$\\text{Area} = \\left( \\frac{8}{5}\\ln 2 - \\frac{18}{5}\\ln 3 \\right) - \\left( -\\frac{9}{5}\\ln 2 - \\frac{9}{5}\\ln 3 \\right)$$<br>\\begin{aligned}\n\\text{Area} &= \\left( \\frac{8 + 9}{5} \\right)\\ln 2 + \\left( \\frac{-18 + 9}{5} \\right)\\ln 3 \\cr\n&= \\frac{17}{5}\\ln 2 - \\frac{9}{5}\\ln 3\n\\end{aligned}<br>Therefore, the constants are $a = \\frac{17}{5}$, $b = -\\frac{9}{5}$, and $c = 0$.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Since the curve passes through the point $(2, \\frac{1}{2})$, we substitute $x = 2$ and $y = \\frac{1}{2}$ into the equation to solve for $p$:<br>\\begin{aligned}\n\\frac{1}{2} &= \\dfrac{p - 3(2)}{(3(2) - 3)(2 + 2)} \\cr\n\\frac{1}{2} &= \\dfrac{p - 6}{(3)(4)}\n\\end{aligned}<br>\\begin{aligned}\n\\frac{1}{2} &= \\dfrac{p - 6}{12} \\cr\n6 &= p - 6 \\cr\np &= 12\n\\end{aligned}",
                        "<strong>Part (b):</strong> To find the area of the region $R$, we must find where the curve crosses the $x$-axis (the $x$-intercept). Setting $y = 0$ in the numerator gives:<br>\\begin{aligned}\n12 - 3x &= 0 \\cr\n3x &= 12 \\cr\nx &= 4\n\\end{aligned}",
                        ...
                        "We simplify the integrand by factorising and cancelling a common factor of $3$:<br>\\begin{aligned}\n\\dfrac{12 - 3x}{(3x - 3)(x + 2)} &= \\dfrac{-3(x - 4)}{3(x - 1)(x + 2)} \\cr\n&= -\\dfrac{x - 4}{(x - 1)(x + 2)}\n\\end{aligned}",
                        ...
                        "Substituting these coefficients back into our integral gives:<br>\\begin{aligned}\n\\text{Area} &= \\int_{2}^{4} \\left( \\dfrac{1}{x - 1} - \\dfrac{2}{x + 2} \\right) \\text{ d}x \\cr\n&= \\left[ \\ln|x - 1| - 2\\ln|x + 2| \\right]_{2}^{4}\n\\end{aligned}",
                        "Evaluating this expression at our upper limit ($4$) and lower limit ($2$):<br>\\begin{aligned}\n\\text{Value at 4} &= \\ln(3) - 2\\ln(6) \\cr\n&= \\ln(3) - 2(\\ln 2 + \\ln 3) \\cr\n&= -2\\ln(2) - \\ln(3)\n\\end{aligned}<br>\\begin{aligned}\n\\text{Value at 2} &= \\ln(1) - 2\\ln(4) \\cr\n&= 0 - 2(2\\ln 2) \\cr\n&= -4\\ln(2)\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Since the curve passes through the point $(3, \\frac{1}{2})$, we substitute $x = 3$ and $y = \\frac{1}{2}$ into the equation to solve for $p$:<br>\\begin{aligned}\n\\frac{1}{2} &= \\dfrac{p - 4(3)}{(2(3) - 4)(3 + 1)} \\cr\n\\frac{1}{2} &= \\dfrac{p - 12}{(2)(4)}\n\\end{aligned}<br>\\begin{aligned}\n\\frac{1}{2} &= \\dfrac{p - 12}{8} \\cr\n4 &= p - 12 \\cr\np &= 16\n\\end{aligned}",
                        "<strong>Part (b):</strong> To find the area of the region $R$, we must find where the curve crosses the $x$-axis (the $x$-intercept). Setting $y = 0$ in the numerator gives:<br>\\begin{aligned}\n16 - 4x &= 0 \\cr\n4x &= 16 \\cr\nx &= 4\n\\end{aligned}",
                        ...
                        "We simplify the integrand by factorising and cancelling a common factor of $2$:<br>\\begin{aligned}\n\\dfrac{16 - 4x}{(2x - 4)(x + 1)} &= \\dfrac{-4(x - 4)}{2(x - 2)(x + 1)} \\cr\n&= -2\\dfrac{x - 4}{(x - 2)(x + 1)}\n\\end{aligned}",
                        ...
                        "Substituting these coefficients back into our integral gives:<br>\\begin{aligned}\n\\text{Area} &= \\int_{3}^{4} \\left( \\dfrac{4/3}{x - 2} - \\dfrac{10/3}{x + 1} \\right) \\text{ d}x \\cr\n&= \\left[ \\frac{4}{3}\\ln|x - 2| - \\frac{10}{3}\\ln|x + 1| \\right]_{3}^{4}\n\\end{aligned}",
                        "Evaluating this expression at our upper limit ($4$) and lower limit ($3$):<br>$$\\text{Value at 4} = \\frac{4}{3}\\ln(2) - \\frac{10}{3}\\ln(5)$$<br>\\begin{aligned}\n\\text{Value at 3} &= \\frac{4}{3}\\ln(1) - \\frac{10}{3}\\ln(4) \\cr\n&= 0 - \\frac{10}{3}(2\\ln 2) \\cr\n&= -\\frac{20}{3}\\ln(2)\n\\end{aligned}",
                        "Subtracting the lower limit value from the upper limit value yields:<br>$$\\text{Area} = \\left( \\frac{4}{3}\\ln 2 - \\frac{10}{3}\\ln 5 \\right) - \\left( -\\frac{20}{3}\\ln 2 \\right)$$<br>\\begin{aligned}\n\\text{Area} &= \\left( \\frac{4 + 20}{3} \\right)\\ln 2 - \\frac{10}{3}\\ln 5 \\cr\n&= 8\\ln 2 - \\frac{10}{3}\\ln 5\n\\end{aligned}<br>Therefore, the constants are $a = 8$ and $b = -\\frac{10}{3}$.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Since the curve passes through the point $(3, \\frac{1}{2})$, we substitute $x = 3$ and $y = \\frac{1}{2}$ into the equation to solve for $p$:<br>\\begin{aligned}\n\\frac{1}{2} &= \\dfrac{p - 2(3)}{(3(3) - 6)(3 + 1)} \\cr\n\\frac{1}{2} &= \\dfrac{p - 6}{(3)(4)}\n\\end{aligned}<br>\\begin{aligned}\n\\frac{1}{2} &= \\dfrac{p - 6}{12} \\cr\n6 &= p - 6 \\cr\np &= 12\n\\end{aligned}",
                        "<strong>Part (b):</strong> To find the area of the region $R$, we must find where the curve crosses the $x$-axis (the $x$-intercept). Setting $y = 0$ in the numerator gives:<br>\\begin{aligned}\n12 - 2x &= 0 \\cr\n2x &= 12 \\cr\nx &= 6\n\\end{aligned}",
                        ...
                        "We simplify the integrand by factorising:<br>\\begin{aligned}\n\\dfrac{12 - 2x}{(3x - 6)(x + 1)} &= \\dfrac{2(6 - x)}{3(x - 2)(x + 1)} \\cr\n&= \\dfrac{2}{3} \\dfrac{6 - x}{(x - 2)(x + 1)}\n\\end{aligned}",
                        ...
                        "Substituting these coefficients back into our integral gives:<br>\\begin{aligned}\n\\text{Area} &= \\int_{3}^{6} \\left( \\dfrac{8/9}{x - 2} - \\dfrac{14/9}{x + 1} \\right) \\text{ d}x \\cr\n&= \\left[ \\frac{8}{9}\\ln|x - 2| - \\frac{14}{9}\\ln|x + 1| \\right]_{3}^{6}\n\\end{aligned}",
                        "Evaluating this expression at our upper limit ($6$) and lower limit ($3$):<br>\\begin{aligned}\n\\text{Value at 6} &= \\frac{8}{9}\\ln(4) - \\frac{14}{9}\\ln(7) \\cr\n&= \\frac{16}{9}\\ln(2) - \\frac{14}{9}\\ln(7)\n\\end{aligned}<br>\\begin{aligned}\n\\text{Value at 3} &= \\frac{8}{9}\\ln(1) - \\frac{14}{9}\\ln(4) \\cr\n&= 0 - \\frac{14}{9}(2\\ln 2) \\cr\n&= -\\frac{28}{9}\\ln(2)\n\\end{aligned}",
                        "Subtracting the lower limit value from the upper limit value yields:<br>$$\\text{Area} = \\left( \\frac{16}{9}\\ln 2 - \\frac{14}{9}\\ln 7 \\right) - \\left( -\\frac{28}{9}\\ln 2 \\right)$$<br>\\begin{aligned}\n\\text{Area} &= \\left( \\frac{16 + 28}{9} \\right)\\ln 2 - \\frac{14}{9}\\ln 7 \\cr\n&= \\frac{44}{9}\\ln 2 - \\frac{14}{9}\\ln 7\n\\end{aligned}<br>Therefore, the constants are $a = \\frac{44}{9}$ and $b = -\\frac{14}{9}$.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Since the curve passes through the point $(4, \\frac{1}{2})$, we substitute $x = 4$ and $y = \\frac{1}{2}$ into the equation to solve for $p$:<br>\\begin{aligned}\n\\frac{1}{2} &= \\dfrac{p - 3(4)}{(2(4) - 6)(4 + 2)} \\cr\n\\frac{1}{2} &= \\dfrac{p - 12}{(2)(6)}\n\\end{aligned}<br>\\begin{aligned}\n\\frac{1}{2} &= \\dfrac{p - 12}{12} \\cr\n6 &= p - 12 \\cr\np &= 18\n\\end{aligned}",
                        "<strong>Part (b):</strong> To find the area of the region $R$, we must find where the curve crosses the $x$-axis (the $x$-intercept). Setting $y = 0$ in the numerator gives:<br>\\begin{aligned}\n18 - 3x &= 0 \\cr\n3x &= 18 \\cr\nx &= 6\n\\end{aligned}",
                        ...
                        "We simplify the integrand by factorising:<br>\\begin{aligned}\n\\dfrac{18 - 3x}{(2x - 6)(x + 2)} &= \\dfrac{3(6 - x)}{2(x - 3)(x + 2)} \\cr\n&= \\dfrac{3}{2} \\dfrac{6 - x}{(x - 3)(x + 2)}\n\\end{aligned}",
                        ...
                        "Substituting these coefficients back into our integral gives:<br>\\begin{aligned}\n\\text{Area} &= \\int_{4}^{6} \\left( \\dfrac{9/10}{x - 3} - \\dfrac{12/5}{x + 2} \\right) \\text{ d}x \\cr\n&= \\left[ \\frac{9}{10}\\ln|x - 3| - \\frac{12}{5}\\ln|x + 2| \\right]_{4}^{6}\n\\end{aligned}",
                        "Evaluating this expression at our upper limit ($6$) and lower limit ($4$):<br>\\begin{aligned}\n\\text{Value at 6} &= \\frac{9}{10}\\ln(3) - \\frac{12}{5}\\ln(8) \\cr\n&= \\frac{9}{10}\\ln(3) - \\frac{12}{5}(3\\ln 2) \\cr\n&= -\\frac{36}{5}\\ln(2) + \\frac{9}{10}\\ln(3)\n\\end{aligned}<br>\\begin{aligned}\n\\text{Value at 4} &= \\frac{9}{10}\\ln(1) - \\frac{12}{5}\\ln(6) \\cr\n&= 0 - \\frac{12}{5}(\\ln 2 + \\ln 3) \\cr\n&= -\\frac{12}{5}\\ln(2) - \\frac{12}{5}\\ln(3)\n\\end{aligned}",
                        "Subtracting the lower limit value from the upper limit value yields:<br>$$\\text{Area} = \\left( -\\frac{36}{5}\\ln 2 + \\frac{9}{10}\\ln 3 \\right) - \\left( -\\frac{12}{5}\\ln 2 - \\frac{12}{5}\\ln 3 \\right)$$<br>\\begin{aligned}\n\\text{Area} &= \\left( -\\frac{36}{5} + \\frac{12}{5} \\right)\\ln 2 + \\left( \\frac{9}{10} + \\frac{24}{10} \\right)\\ln 3 \\cr\n&= -\\frac{24}{5}\\ln 2 + \\frac{33}{10}\\ln 3\n\\end{aligned}<br>Therefore, the constants are $a = -\\frac{24}{5}$ and $b = \\frac{33}{10}$.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We differentiate the equation of our curve, $x = 3\\sin 2y$, implicitly with respect to $x$:<br>$$\\dfrac{\\text{d}}{\\text{d}x}(x) = \\dfrac{\\text{d}}{\\text{d}x}(3\\sin 2y)$$<br>$$1 = 3\\cos 2y \\cdot \\left(2\\dfrac{\\text{d}y}{\\text{d}x}\\right)$$<br>\\begin{aligned}\n1 &= 6\\cos 2y \\cdot \\dfrac{\\text{d}y}{\\text{d}x} \\cr\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{1}{6\\cos 2y}\n\\end{aligned}",
                        "At the origin, the coordinates are $(0,0)$, which means $y = 0$. Substituting $y = 0$ into our derivative gives:<br>\\begin{aligned}\n\\left. \\dfrac{\\text{d}y}{\\text{d}x} \\right|_{O} &= \\dfrac{1}{6\\cos(0)} \\cr\n&= \\dfrac{1}{6}\n\\end{aligned}",
                        ...
                        "Substituting this into the curve's equation:<br>\\begin{aligned}\nx \\approx 3(2y) &= 6y \\cr\ny \\approx \\dfrac{1}{6}x\n\\end{aligned}",
                        ...
                        "From the original curve equation, we have $\\sin 2y = \\frac{x}{3}$. Substituting this into our expression for $\\cos 2y$ gives:<br>\\begin{aligned}\n\\cos 2y &= \\sqrt{1 - \\left(\\frac{x}{3}\\right)^2} \\cr\n&= \\sqrt{1 - \\frac{x^2}{9}} \\cr\n&= \\sqrt{\\dfrac{9 - x^2}{9}} \\cr\n&= \\dfrac{\\sqrt{9 - x^2}}{3}\n\\end{aligned}",
                        "Now, we substitute this back into our derivative expression:<br>\\begin{aligned}\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{1}{6 \\left( \\frac{\\sqrt{9 - x^2}}{3} \\right)} \\cr\n&= \\dfrac{1}{2\\sqrt{9 - x^2}}\n\\end{aligned}<br>Comparing this with the target form gives the constants as $a = 2$ and $b = 9$.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We differentiate our equation, $x = 5\\sin 3y$, implicitly with respect to $x$:<br>$$\\dfrac{\\text{d}}{\\text{d}x}(x) = \\dfrac{\\text{d}}{\\text{d}x}(5\\sin 3y)$$<br>$$1 = 5\\cos 3y \\cdot \\left(3\\dfrac{\\text{d}y}{\\text{d}x}\\right)$$<br>\\begin{aligned}\n1 &= 15\\cos 3y \\cdot \\dfrac{\\text{d}y}{\\text{d}x} \\cr\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{1}{15\\cos 3y}\n\\end{aligned}",
                        "At the origin, the coordinates are $(0,0)$, which means $y = 0$. Substituting $y = 0$ into our derivative gives:<br>\\begin{aligned}\n\\left. \\dfrac{\\text{d}y}{\\text{d}x} \\right|_{O} &= \\dfrac{1}{15\\cos(0)} \\cr\n&= \\dfrac{1}{15}\n\\end{aligned}",
                        ...
                        "Substituting this into the curve's equation:<br>\\begin{aligned}\nx \\approx 5(3y) &= 15y \\cr\ny \\approx \\dfrac{1}{15}x\n\\end{aligned}",
                        ...
                        "From the original curve equation, we have $\\sin 3y = \\frac{x}{5}$. Substituting this into our expression for $\\cos 3y$ gives:<br>\\begin{aligned}\n\\cos 3y &= \\sqrt{1 - \\left(\\frac{x}{5}\\right)^2} \\cr\n&= \\sqrt{1 - \\frac{x^2}{25}} \\cr\n&= \\sqrt{\\dfrac{25 - x^2}{25}} \\cr\n&= \\dfrac{\\sqrt{25 - x^2}}{5}\n\\end{aligned}",
                        "Now, we substitute this back into our derivative expression:<br>\\begin{aligned}\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{1}{15 \\left( \\frac{\\sqrt{25 - x^2}}{5} \\right)} \\cr\n&= \\dfrac{1}{3\\sqrt{25 - x^2}}\n\\end{aligned}<br>Comparing this with the target form gives the constants as $a = 3$ and $b = 25$.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We differentiate the equation of our curve, $x = 2\\sin 4y$, implicitly with respect to $x$:<br>$$\\dfrac{\\text{d}}{\\text{d}x}(x) = \\dfrac{\\text{d}}{\\text{d}x}(2\\sin 4y)$$<br>$$1 = 2\\cos 4y \\cdot \\left(4\\dfrac{\\text{d}y}{\\text{d}x}\\right)$$<br>\\begin{aligned}\n1 &= 8\\cos 4y \\cdot \\dfrac{\\text{d}y}{\\text{d}x} \\cr\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{1}{8\\cos 4y}\n\\end{aligned}",
                        "At the origin, the coordinates are $(0,0)$, which means $y = 0$. Substituting $y = 0$ into our derivative gives:<br>\\begin{aligned}\n\\left. \\dfrac{\\text{d}y}{\\text{d}x} \\right|_{O} &= \\dfrac{1}{8\\cos(0)} \\cr\n&= \\dfrac{1}{8}\n\\end{aligned}",
                        ...
                        "From the original curve equation, we have $\\sin 4y = \\frac{x}{2}$. Substituting this into our expression for $\\cos 4y$ gives:<br>\\begin{aligned}\n\\cos 4y &= \\sqrt{1 - \\left(\\frac{x}{2}\\right)^2} \\cr\n&= \\sqrt{1 - \\frac{x^2}{4}} \\cr\n&= \\sqrt{\\dfrac{4 - x^2}{4}} \\cr\n&= \\dfrac{\\sqrt{4 - x^2}}{2}\n\\end{aligned}",
                        "Now, we substitute this back into our derivative expression:<br>\\begin{aligned}\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{1}{8 \\left( \\frac{\\sqrt{4 - x^2}}{2} \\right)} \\cr\n&= \\dfrac{1}{4\\sqrt{4 - x^2}}\n\\end{aligned}<br>Comparing this with the target form gives the constants as $a = 4$ and $b = 4$.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We differentiate the equation of our curve, $x = 6\\sin 2y$, implicitly with respect to $x$:<br>$$\\dfrac{\\text{d}}{\\text{d}x}(x) = \\dfrac{\\text{d}}{\\text{d}x}(6\\sin 2y)$$<br>$$1 = 6\\cos 2y \\cdot \\left(2\\dfrac{\\text{d}y}{\\text{d}x}\\right)$$<br>\\begin{aligned}\n1 &= 12\\cos 2y \\cdot \\dfrac{\\text{d}y}{\\text{d}x} \\cr\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{1}{12\\cos 2y}\n\\end{aligned}",
                        "At the origin, the coordinates are $(0,0)$, which means $y = 0$. Substituting $y = 0$ into our derivative gives:<br>\\begin{aligned}\n\\left. \\dfrac{\\text{d}y}{\\text{d}x} \\right|_{O} &= \\dfrac{1}{12\\cos(0)} \\cr\n&= \\dfrac{1}{12}\n\\end{aligned}",
                        "<strong>Part (b)(i):</strong> The small-angle approximation for sine is $\\sin\\theta \\approx \\theta$ when $\\theta$ is small and measured in radians.<br>Applying this approximation with $\\theta = 2y$ gives:<br>$$\\sin 2y \\approx 2y$$",
                        "Substituting this into the curve's equation:<br>\\begin{aligned}\nx \\approx 6(2y) &= 12y \\cr\ny \\approx \\dfrac{1}{12}x\n\\end{aligned}",
                        ...
                        "Using the fundamental identity $\\sin^2 2y + \\cos^2 2y = 1$, we can express $\\cos 2y$ in terms of sine:<br>$$\\cos 2y = \\sqrt{1 - \\sin^2 2y}$$<br>*(Note: Since $-\\frac{\\pi}{4} < y < \\frac{\\pi}{4}$, the angle lies in the interval $-\\frac{\\pi}{2} < 2y < \\frac{\\pi}{2}$, where cosine is strictly positive, so the positive root is correct).* ",
                        "From the original curve equation, we have $\\sin 2y = \\frac{x}{6}$. Substituting this into our expression for $\\cos 2y$ gives:<br>\\begin{aligned}\n\\cos 2y &= \\sqrt{1 - \\left(\\frac{x}{6}\\right)^2} \\cr\n&= \\sqrt{1 - \\frac{x^2}{36}} \\cr\n&= \\sqrt{\\dfrac{36 - x^2}{36}} \\cr\n&= \\dfrac{\\sqrt{36 - x^2}}{6}\n\\end{aligned}",
                        "Now, we substitute this back into our derivative expression:<br>\\begin{aligned}\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{1}{12 \\left( \\frac{\\sqrt{36 - x^2}}{6} \\right)} \\cr\n&= \\dfrac{1}{2\\sqrt{36 - x^2}}\n\\end{aligned}<br>Comparing this with the target form gives the constants as $a = 2$ and $b = 36$.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We differentiate the equation of our curve, $x = 4\\sin 3y$, implicitly with respect to $x$:<br>$$\\dfrac{\\text{d}}{\\text{d}x}(x) = \\dfrac{\\text{d}}{\\text{d}x}(4\\sin 3y)$$<br>$$1 = 4\\cos 3y \\cdot \\left(3\\dfrac{\\text{d}y}{\\text{d}x}\\right)$$<br>\\begin{aligned}\n1 &= 12\\cos 3y \\cdot \\dfrac{\\text{d}y}{\\text{d}x} \\cr\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{1}{12\\cos 3y}\n\\end{aligned}",
                        "At the origin, the coordinates are $(0,0)$, which means $y = 0$. Substituting $y = 0$ into our derivative gives:<br>\\begin{aligned}\n\\left. \\dfrac{\\text{d}y}{\\text{d}x} \\right|_{O} &= \\dfrac{1}{12\\cos(0)} \\cr\n&= \\dfrac{1}{12}\n\\end{aligned}",
                        "<strong>Part (b)(i):</strong> The small-angle approximation for sine is $\\sin\\theta \\approx \\theta$ when $\\theta$ is small and measured in radians.<br>Applying this approximation with $\\theta = 3y$ gives:<br>$$\\sin 3y \\approx 3y$$",
                        "Substituting this into the curve's equation:<br>\\begin{aligned}\nx \\approx 4(3y) &= 12y \\cr\ny \\approx \\dfrac{1}{12}x\n\\end{aligned}",
                        "<strong>Part (b)(ii):</strong> The linear equation $y \\approx \\frac{1}{12}x$ represents the tangent line to the curve at the origin. The gradient of this straight line is $\\frac{1}{12}$, which is exactly equal to the value of the exact derivative $\\dfrac{\\text{d}y}{\\text{d}x}$ at the origin found in Part (a).",
                        ...
                        "From the original curve equation, we have $\\sin 3y = \\frac{x}{4}$. Substituting this into our expression for $\\cos 3y$ gives:<br>\\begin{aligned}\n\\cos 3y &= \\sqrt{1 - \\left(\\frac{x}{4}\\right)^2} \\cr\n&= \\sqrt{1 - \\frac{x^2}{16}} \\cr\n&= \\sqrt{\\dfrac{16 - x^2}{16}} \\cr\n&= \\dfrac{\\sqrt{16 - x^2}}{4}\n\\end{aligned}",
                        "Now, we substitute this back into our derivative expression:<br>\\begin{aligned}\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{1}{12 \\left( \\frac{\\sqrt{16 - x^2}}{4} \\right)} \\cr\n&= \\dfrac{1}{3\\sqrt{16 - x^2}}\n\\end{aligned}<br>Comparing this with the target form gives the constants as $a = 3$ and $b = 16$.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, apply the standard rule for differentiation, $$\\dfrac{\\text{d}}{\\text{d}x}\\left(x^n\\right) = n x^{n-1}$$ where, $$n = -3$$ \\begin{aligned}\n\\dfrac{dy}{dx} &= -3x^{-3-1} \\cr\n&= -3x^{-4}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, apply the standard rule for differentiation, $$\\dfrac{\\text{d}}{\\text{d}x}\\left(x^n\\right) = n x^{n-1}$$ where, $$n = -4$$ \\begin{aligned}\n\\dfrac{dy}{dx} &= -4x^{-4-1} \\cr\n&= -4x^{-5}\n\\end{aligned}",
                        "Finally, convert the derivative back into fractional form.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, apply the standard rule for differentiation, $$\\dfrac{\\text{d}}{\\text{d}x}\\left(x^n\\right) = n x^{n-1}$$ where, $$n = -5$$ \\begin{aligned}\n\\dfrac{dy}{dx} &= -5x^{-5-1} \\cr\n&= -5x^{-6}\n\\end{aligned}",
                        "Finally, convert the derivative back into fractional form.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, apply the standard rule for differentiation, $$\\dfrac{\\text{d}}{\\text{d}x}\\left(a x^n\\right) = a n x^{n-1}$$ where, $$a = 2$$ and $$n = -3$$ \\begin{aligned}\n\\dfrac{dy}{dx} &= 2 \\times \\left(-3\\right)x^{-3-1} \\cr\n&= -6x^{-4}\n\\end{aligned}",
                        "Finally, convert the derivative back into fractional form.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, apply the standard rule for differentiation, $$\\dfrac{\\text{d}}{\\text{d}x}\\left(a x^n\\right) = a n x^{n-1}$$ where, $$a = \\dfrac{1}{2}$$ and $$n = -2$$ \\begin{aligned}\n\\dfrac{dy}{dx} &= \\dfrac{1}{2} \\times \\left(-2\\right)x^{-2-1} \\cr\n&= -1x^{-3}\n\\end{aligned}",
                        "Finally, convert the derivative back into fractional form.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, calculate the first few terms of the sequence to observe the periodic pattern: \\begin{aligned}\nU_1 &= \\dfrac{\\sqrt{3}}{2},\\\\ U_2 \\cr\n&= \\dfrac{\\sqrt{3}}{2},\\\\ U_3 \\cr\n&= 0,\\\\ U_4 \\cr\n&= -\\dfrac{\\sqrt{3}}{2},\\\\ U_5 \\cr\n&= -\\dfrac{\\sqrt{3}}{2},\\\\ U_6 \\cr\n&= 0,\\\\ U_7 \\cr\n&= \\dfrac{\\sqrt{3}}{2}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, calculate the first few terms of the sequence: \\begin{aligned}\nU_1 &= -\\dfrac{1}{2},\\\\ U_2 \\cr\n&= -\\dfrac{1}{2},\\\\ U_3 \\cr\n&= 1,\\\\ U_4 \\cr\n&= -\\dfrac{1}{2}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, calculate the first few terms of the sequence: \\begin{aligned}\nU_1 &= \\dfrac{1}{\\sqrt{2}},\\\\ U_2 \\cr\n&= 1,\\\\ U_3 \\cr\n&= \\dfrac{1}{\\sqrt{2}},\\\\ U_4 \\cr\n&= 0,\\\\ U_5 \\cr\n&= -\\dfrac{1}{\\sqrt{2}},\\\\ U_6 \\cr\n&= -1,\\\\ U_7 \\cr\n&= -\\dfrac{1}{\\sqrt{2}},\\\\ U_8 \\cr\n&= 0,\\\\ U_9 \\cr\n&= \\dfrac{1}{\\sqrt{2}}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Set $y = e^{x-3}$.",
                        "Take the natural logarithm of both sides to rearrange for $x$: \\begin{aligned}\n\\ln(y) &= x - 3 \\cr\nx &= \\ln(y) + 3\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, use the chain rule, $$\\dfrac{dy}{dx} = \\dfrac{\\frac{dy}{dt}}{\\frac{dx}{dt}}$$, to obtain Part (a): \\begin{aligned}\n\\dfrac{dy}{dx} &= \\dfrac{5 \\ln(2) 2^t}{-2 \\ln(2) 2^{-t}} \\cr\n&= -\\dfrac{5}{2} \\times 2^{2t}\n\\end{aligned}",
                        "To find Part (b), rearrange the parametric equations to isolate the exponential terms: \\begin{aligned}\n2^{-t} &= \\dfrac{x-4}{2} \\cr\n2^t &= \\dfrac{2}{x-4}\n\\end{aligned}",
                        "Substitute this into the $y$ equation and expand: \\begin{aligned}\ny + 1 &= 5 \\times \\dfrac{2}{x-4} \\cr\n(y + 1)(x - 4) &= 10 \\cr\nxy + x - 4y &= 14\n\\end{aligned}",
                        "Final Answer: \\begin{aligned}\n\\text{(a) } \\dfrac{dy}{dx} &= -\\dfrac{5}{2} \\times 2^{2t},\\quad \\text{(b) } xy + x - 4y \\cr\n&= 14\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, use the chain rule, $$\\dfrac{dy}{dx} = \\dfrac{\\frac{dy}{dt}}{\\frac{dx}{dt}}$$, to obtain Part (a): \\begin{aligned}\n\\dfrac{dy}{dx} &= \\dfrac{2 \\ln(3) 3^t}{-3 \\ln(3) 3^{-t}} \\cr\n&= -\\dfrac{2}{3} \\times 3^{2t}\n\\end{aligned}",
                        "To find Part (b), rearrange the parametric equations to isolate the exponential terms: \\begin{aligned}\n3^{-t} &= \\dfrac{x-2}{3} \\cr\n3^t &= \\dfrac{3}{x-2}\n\\end{aligned}",
                        "Substitute this into the $y$ equation and expand: \\begin{aligned}\ny + 4 &= 2 \\times \\dfrac{3}{x-2} \\cr\n(y + 4)(x - 2) &= 6 \\cr\nxy + 4x - 2y &= 14\n\\end{aligned}",
                        "Final Answer: \\begin{aligned}\n\\text{(a) } \\dfrac{dy}{dx} &= -\\dfrac{2}{3} \\times 3^{2t},\\quad \\text{(b) } xy + 4x - 2y \\cr\n&= 14\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, use the chain rule, $$\\dfrac{dy}{dx} = \\dfrac{\\frac{dy}{dt}}{\\frac{dx}{dt}}$$, to obtain Part (a): \\begin{aligned}\n\\dfrac{dy}{dx} &= \\dfrac{4 \\ln(2) 2^t}{-5 \\ln(2) 2^{-t}} \\cr\n&= -\\dfrac{4}{5} \\times 2^{2t}\n\\end{aligned}",
                        "To find Part (b), rearrange the parametric equations to isolate the exponential terms: \\begin{aligned}\n2^{-t} &= \\dfrac{x-1}{5} \\cr\n2^t &= \\dfrac{5}{x-1}\n\\end{aligned}",
                        "Substitute this into the $y$ equation and expand: \\begin{aligned}\ny + 3 &= 4 \\times \\dfrac{5}{x-1} \\cr\n(y + 3)(x - 1) &= 20 \\cr\nxy + 3x - y &= 23\n\\end{aligned}",
                        "Final Answer: \\begin{aligned}\n\\text{(a) } \\dfrac{dy}{dx} &= -\\dfrac{4}{5} \\times 2^{2t},\\quad \\text{(b) } xy + 3x - y \\cr\n&= 23\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, use the chain rule, $$\\dfrac{dy}{dx} = \\dfrac{\\frac{dy}{dt}}{\\frac{dx}{dt}}$$, to obtain Part (a): \\begin{aligned}\n\\dfrac{dy}{dx} &= \\dfrac{4 \\ln(3) 3^t}{-2 \\ln(3) 3^{-t}} \\cr\n&= -2 \\times 3^{2t}\n\\end{aligned}",
                        "To find Part (b), rearrange the parametric equations to isolate the exponential terms: \\begin{aligned}\n3^{-t} &= \\dfrac{x-5}{2} \\cr\n3^t &= \\dfrac{2}{x-5}\n\\end{aligned}",
                        "Substitute this into the $y$ equation and expand: \\begin{aligned}\ny + 1 &= 4 \\times \\dfrac{2}{x-5} \\cr\n(y + 1)(x - 5) &= 8 \\cr\nxy + x - 5y &= 13\n\\end{aligned}",
                        "Final Answer: \\begin{aligned}\n\\text{(a) } \\dfrac{dy}{dx} &= -2 \\times 3^{2t},\\quad \\text{(b) } xy + x - 5y \\cr\n&= 13\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Next, use the chain rule, $$\\dfrac{dy}{dx} = \\dfrac{\\frac{dy}{dt}}{\\frac{dx}{dt}}$$, to obtain Part (a): \\begin{aligned}\n\\dfrac{dy}{dx} &= \\dfrac{2 \\ln(2) 2^t}{-3 \\ln(2) 2^{-t}} \\cr\n&= -\\dfrac{2}{3} \\times 2^{2t}\n\\end{aligned}",
                        "To find Part (b), rearrange the parametric equations to isolate the exponential terms: \\begin{aligned}\n2^{-t} &= \\dfrac{x-2}{3} \\cr\n2^t &= \\dfrac{3}{x-2}\n\\end{aligned}",
                        "Substitute this into the $y$ equation and expand: \\begin{aligned}\ny + 6 &= 2 \\times \\dfrac{3}{x-2} \\cr\n(y + 6)(x - 2) &= 6 \\cr\nxy + 6x - 2y &= 18\n\\end{aligned}",
                        "Final Answer: \\begin{aligned}\n\\text{(a) } \\dfrac{dy}{dx} &= -\\dfrac{2}{3} \\times 2^{2t},\\quad \\text{(b) } xy + 6x - 2y \\cr\n&= 18\n\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        "For Part (a), rewrite the function in index form and factor out $9$: \\begin{aligned}\n(9+x)^{-\\frac{1}{2}} &= 9^{-\\frac{1}{2}}\\left(1+\\dfrac{x}{9}\\right)^{-\\frac{1}{2}} \\cr\n&= \\dfrac{1}{3}\\left(1 - \\dfrac{1}{2}\\left(\\dfrac{x}{9}\\right) + \\dfrac{3}{8}\\left(\\dfrac{x}{9}\\right)^2 + \\dots\\right) \\cr\n&= \\dfrac{1}{3} - \\dfrac{x}{54} + \\dfrac{x^2}{648}\n\\end{aligned}",
                        "For Part (b), substitute $x \\implies -x^3$ into your Part (a) expansion: \\begin{aligned}\n\\dfrac{1}{\\sqrt{9-x^3}} &= \\dfrac{1}{3} - \\dfrac{-x^3}{54} + \\dfrac{(-x^3)^2}{648} \\cr\n&= \\dfrac{1}{3} + \\dfrac{x^3}{54} + \\dfrac{x^6}{648}\n\\end{aligned}",
                        "For Part (c), integrate this polynomial approximation from $0$ to $1$: \\begin{aligned}\n\\int_{0}^{1} \\left(\\dfrac{1}{3} + \\dfrac{x^3}{54} + \\dfrac{x^6}{648}\\right) \\text{d}x &= \\left[\\dfrac{x}{3} + \\dfrac{x^4}{216} + \\dfrac{x^7}{4536}\\right]_{0}^{1} \\cr\n&= \\dfrac{1}{3} + \\dfrac{1}{216} + \\dfrac{1}{4536} \\approx 0.3381834\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "For Part (b), substitute $x \\implies -x^2$ into your Part (a) expansion: \\begin{aligned}\n\\dfrac{1}{\\sqrt{1-x^2}} &= 1 - \\dfrac{1}{2}(-x^2) + \\dfrac{3}{8}(-x^2)^2 \\cr\n&= 1 + \\dfrac{1}{2}x^2 + \\dfrac{3}{8}x^4\n\\end{aligned}",
                        "For Part (c), integrate this polynomial approximation from $0$ to $0.5$: \\begin{aligned}\n\\int_{0}^{0.5} \\left(1 + \\dfrac{1}{2}x^2 + \\dfrac{3}{8}x^4\\right) \\text{d}x &= \\left[x + \\dfrac{x^3}{6} + \\dfrac{3x^5}{40}\\right]_{0}^{0.5} \\cr\n&= 0.5 + \\dfrac{0.125}{6} + \\dfrac{0.09375}{40} \\approx 0.5231771\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "For Part (a), rewrite the function in index form and factor out $16$: \\begin{aligned}\n(16+x)^{-\\frac{1}{2}} &= 16^{-\\frac{1}{2}}\\left(1+\\dfrac{x}{16}\\right)^{-\\frac{1}{2}} \\cr\n&= \\dfrac{1}{4}\\left(1 - \\dfrac{1}{2}\\left(\\dfrac{x}{16}\\right) + \\dfrac{3}{8}\\left(\\dfrac{x}{16}\\right)^2 + \\dots\\right) \\cr\n&= \\dfrac{1}{4} - \\dfrac{x}{128} + \\dfrac{3x^2}{8192}\n\\end{aligned}",
                        "For Part (b), substitute $x \\implies -x^3$ into your Part (a) expansion: \\begin{aligned}\n\\dfrac{1}{\\sqrt{16-x^3}} &= \\dfrac{1}{4} - \\dfrac{-x^3}{128} + \\dfrac{3(-x^3)^2}{8192} \\cr\n&= \\dfrac{1}{4} + \\dfrac{x^3}{128} + \\dfrac{3x^6}{8192}\n\\end{aligned}",
                        "For Part (c), integrate this polynomial approximation from $0$ to $1$: \\begin{aligned}\n\\int_{0}^{1} \\left(\\dfrac{1}{4} + \\dfrac{x^3}{128} + \\dfrac{3x^6}{8192}\\right) \\text{d}x &= \\left[\\dfrac{x}{4} + \\dfrac{x^4}{512} + \\dfrac{3x^7}{57344}\\right]_{0}^{1} \\cr\n&= \\dfrac{1}{4} + \\dfrac{1}{512} + \\dfrac{3}{57344} \\approx 0.2520054\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "For Part (a), rewrite the function in index form and factor out $25$: \\begin{aligned}\n(25+x)^{-\\frac{1}{2}} &= 25^{-\\frac{1}{2}}\\left(1+\\dfrac{x}{25}\\right)^{-\\frac{1}{2}} \\cr\n&= \\dfrac{1}{5}\\left(1 - \\dfrac{1}{2}\\left(\\dfrac{x}{25}\\right) + \\dfrac{3}{8}\\left(\\dfrac{x}{25}\\right)^2 + \\dots\\right) \\cr\n&= \\dfrac{1}{5} - \\dfrac{x}{250} + \\dfrac{3x^2}{25000}\n\\end{aligned}",
                        "For Part (b), substitute $x \\implies -x^3$ into your Part (a) expansion: \\begin{aligned}\n\\dfrac{1}{\\sqrt{25-x^3}} &= \\dfrac{1}{5} - \\dfrac{-x^3}{250} + \\dfrac{3(-x^3)^2}{25000} \\cr\n&= \\dfrac{1}{5} + \\dfrac{x^3}{250} + \\dfrac{3x^6}{25000}\n\\end{aligned}",
                        "For Part (c), integrate this polynomial approximation from $0$ to $1$: \\begin{aligned}\n\\int_{0}^{1} \\left(\\dfrac{1}{5} + \\dfrac{x^3}{250} + \\dfrac{3x^6}{25000}\\right) \\text{d}x &= \\left[\\dfrac{x}{5} + \\dfrac{x^4}{1000} + \\dfrac{3x^7}{175000}\\right]_{0}^{1} \\cr\n&= 0.2 + 0.001 + 0.0000171 \\approx 0.2010171\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "For Part (a), rewrite the function in index form and factor out $4$: \\begin{aligned}\n(4+x)^{-\\frac{1}{2}} &= 4^{-\\frac{1}{2}}\\left(1+\\dfrac{x}{4}\\right)^{-\\frac{1}{2}} \\cr\n&= \\dfrac{1}{2}\\left(1 - \\dfrac{1}{2}\\left(\\dfrac{x}{4}\\right) + \\dfrac{3}{8}\\left(\\dfrac{x}{4}\\right)^2 + \\dots\\right) \\cr\n&= \\dfrac{1}{2} - \\dfrac{x}{16} + \\dfrac{3x^2}{256}\n\\end{aligned}",
                        "For Part (b), substitute $x \\implies -x^4$ into your Part (a) expansion: \\begin{aligned}\n\\dfrac{1}{\\sqrt{4-x^4}} &= \\dfrac{1}{2} - \\dfrac{-x^4}{16} + \\dfrac{3(-x^4)^2}{256} \\cr\n&= \\dfrac{1}{2} + \\dfrac{x^4}{16} + \\dfrac{3x^8}{256}\n\\end{aligned}",
                        "For Part (c), integrate this polynomial approximation from $0$ to $1$: \\begin{aligned}\n\\int_{0}^{1} \\left(\\dfrac{1}{2} + \\dfrac{x^4}{16} + \\dfrac{3x^8}{256}\\right) \\text{d}x &= \\left[\\dfrac{x}{2} + \\dfrac{x^5}{80} + \\dfrac{x^9}{768}\\right]_{0}^{1} \\cr\n&= \\dfrac{1}{2} + \\dfrac{1}{80} + \\dfrac{1}{768} \\approx 0.5138021\n\\end{aligned}",
