window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Final Answer: $$\\beta \\approx 0.250.$$ <img src='images/Pure/004006_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'>"
                ],
                "pi_options": [
                        {
                                "ans": "$$\\beta = 0.125$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Simplifying gives \\begin{aligned}\n-2x + 0.2 &= 0 \\cr\nx &= 0.1.\n\\end{aligned}",
                        "Final Answer: $$\\gamma \\approx 0.100.$$ <img src='images/Pure/004007_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'>"
                ],
                "pi_options": [
                        {
                                "ans": "$$\\gamma = 0.200$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Simplifying gives \\begin{aligned}\n0.2 - 2.5x &= 0 \\cr\nx &= 0.08.\n\\end{aligned}",
                        "Final Answer: $$\\varepsilon \\approx 0.080.$$ <img src='images/Pure/004009_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'>"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Simplifying gives \\begin{aligned}\nx + 0.5 &= 0 \\cr\nx &= -0.5.\n\\end{aligned}",
                        "Final Answer: $$\\zeta \\approx -0.500.$$ <img src='images/Pure/004010_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'>"
                ],
                "pi_options": [
                        {
                                "ans": "$$\\zeta = 0.500$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Using the <strong>Quotient Rule</strong>, $\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{ u'v - uv' }{ v^2 }$:<br>$$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{ (-8x-8)(x+1)^2 - (-4x^2-8x) \\cdot 2(x+1) }{ (x+1)^4 }$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Using the <strong>Quotient Rule</strong>, $\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{ u'v - uv' }{ v^2 }$:<br>$$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{ (4x+12)(x+3)^2 - (2x^2+12x) \\cdot 2(x+3) }{ (x+3)^4 }$$",
