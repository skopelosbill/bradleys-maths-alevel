window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Test $n = 1$:<br>\\begin{aligned}\n1^2 + 1 + 11 &= 1 + 1 + 11 \\cr\n&= 13\n\\end{aligned}<br>Since $13$ is only divisible by $1$ and itself, it is a prime number.",
                        "Test $n = 2$:<br>\\begin{aligned}\n2^2 + 2 + 11 &= 4 + 2 + 11 \\cr\n&= 17\n\\end{aligned}<br>Since $17$ is only divisible by $1$ and itself, it is a prime number.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "To show that point $P(2, 1)$ lies on the circle, substitute $x = 2$ and $y = 1$ into the original equation:<br>\\begin{aligned}\n2^2 + 1^2 - 6\\left(2\\right) - 8\\left(1\\right) + 15 &= 4 + 1 - 12 - 8 + 15 \\cr\n&= 0\n\\end{aligned}<br>Since the point satisfies the equation, $P(2, 1)$ lies on the circle.",
        ...
        },
        {
                ...
                "pi_options": [
                        ...
                        {
                                "ans": "$$\\left(x - 3\\right)\\left(2x - 1\\right)\\left(x + 1\\right)$$,<br>$$\\{x : -1 < x < 0.5 \\} \\cup \\{x : x > 3 \\}$$<br>$$ y = 54x^3 - 45x^2 - 12x + 3$$",
                        ...
                        {
                                "ans": "$$\\left(x - 3\\right)\\left(2x - 1\\right)\\left(x + 1\\right)$$<br>>$$\\{x : x < -1 \\} \\cup \\{x : 0.5 < x < 3\\}$$<br>$$y = 6x^3 - 15x^2 - 12x + 3$$",
        ...
        },
        {
                ...
                "steps": [
                        "To prove $x = 1$ is a root, substitute $1$ into the polynomial $g(x)$:<br>\\begin{aligned}\ng(1) &= 1^3 - 6(1)^2 + 11(1) - 6 \\cr\n&= 1 - 6 + 11 - 6 \\cr\n&= 0\n\\end{aligned}<br>Since $g(1) = 0$, the factor theorem states that $(x - 1)$ is a factor of $g(x)$.",
        ...
        },
        {
                ...
                "steps": [
                        "To prove $(x + 1)$ is a factor, evaluate $h(-1)$ using the factor theorem:<br>\\begin{aligned}\nh(-1) &= (-1)^3 - 3(-1)^2 + 4 \\cr\n&= -1 - 3 + 4 \\cr\n&= 0\n\\end{aligned}<br>Since $h(-1) = 0$, $(x + 1)$ is indeed a factor of $h(x)$.",
        ...
        },
        {
                ...
                "steps": [
                        "To prove $x = -1$ is a root, substitute $-1$ into the polynomial $f(x)$:<br>\\begin{aligned}\nf(-1) &= 3(-1)^2 - (-1)^3 - 4 \\cr\n&= 3(1) - (-1) - 4 \\cr\n&= 3 + 1 - 4 \\cr\n&= 0\n\\end{aligned}<br>Since $f(-1) = 0$, $x = -1$ is indeed a root, and $(x + 1)$ is a factor of $f(x)$.",
        ...
        },
        {
                ...
                "steps": [
                        "To model Sarah's times using a geometric progression, we find the first term $a$ and the common ratio $r$.<br>The first term is the time for her first run: $a = 160$ minutes.<br>The second term is $ar = 156.8$ minutes, so:<br>\\begin{aligned}\nr &= \\dfrac{156.8}{160} \\cr\n&= 0.98\n\\end{aligned}",
                        "Write the formula for the time of her $n$-th half marathon, $T_n = a r^{n-1}$:<br>$$T_n = 160\\left(0.98\\right)^{n-1}$$",
                        "To find when her time falls below $130$ minutes, set up the inequality $T_n < 130$:<br>\\begin{aligned}\n160\\left(0.98\\right)^{n-1} < 130 \\cr\n\\left(0.98\\right)^{n-1} < \\dfrac{130}{160} &= 0.8125\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "For the tenth week, we are given $u_{10} = 52$:<br>\\begin{aligned}\n25 + \\left(10 - 1\\right)d &= 52 \\cr\n25 + 9d &= 52\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "First, determine the first term $a$ and common ratio $r$ of the geometric progression:<br>The mass on the first day is $a = 80$ grams.<br>The mass on the second day is $ar = 76$ grams, so:<br>\\begin{aligned}\nr &= \\dfrac{76}{80} \\cr\n&= 0.95\n\\end{aligned}",
                        "Write the formula for the mass on the $n$-th day, $M_n = a r^{n-1}$:<br>$$M_n = 80\\left(0.95\\right)^{n-1}$$",
                        "Set up the inequality $M_n < 40$ to find when the mass falls below $40$ grams:<br>\\begin{aligned}\n80\\left(0.95\\right)^{n-1} < 40 \\cr\n\\left(0.95\\right)^{n-1} < \\dfrac{40}{80} &= 0.5\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "To expand $(9 - x)^{-1/2}$, we first factorise out the $9$ so the first term inside the bracket is $1$:<br>\\begin{aligned}\n(9 - x)^{-1/2} &= \\left[9\\left(1 - \\dfrac{x}{9}\\right)\\right]^{-1/2} \\cr\n&= 9^{-1/2} \\left(1 - \\dfrac{x}{9}\\right)^{-1/2}\n\\end{aligned}<br>$$= \\dfrac{1}{3} \\left(1 - \\dfrac{x}{9}\\right)^{-1/2}$$",
                        "Apply the binomial expansion formula $(1 + y)^n = 1 + ny + \\dfrac{n(n-1)}{2!}y^2 + \\dots$ with $n = -\\dfrac{1}{2}$ and $y = -\\dfrac{x}{9}$:<br>$$\\left(1 - \\dfrac{x}{9}\\right)^{-1/2} = 1 + \\left(-\\dfrac{1}{2}\\right)\\left(-\\dfrac{x}{9}\\right) + \\dfrac{\\left(-\\dfrac{1}{2}\\right)\\left(-\\dfrac{3}{2}\\right)}{2} \\left(-\\dfrac{x}{9}\\right)^2 + \\dots$$<br>\\begin{aligned}\n &= 1 + \\dfrac{x}{18} + \\dfrac{3}{8}\\left(\\dfrac{x^2}{81}\\right) \\cr\n&= 1 + \\dfrac{x}{18} + \\dfrac{x^2}{216} + \\dots\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Complete the square to find the coordinates of the vertex:<br>\\begin{aligned}\nf(x) &= -\\left(x^2 - 6x\\right) + c \\cr\n&= -\\left[\\left(x - 3\\right)^2 - 9\\right] + c\n\\end{aligned}<br>$$f(x) = -\\left(x - 3\\right)^2 + 9 + c$$<br>The maximum value occurs at the vertex where $x = 3$, giving a maximum value of $9 + c$.",
                        "Since the range of the function is $f(x) \\le 14$, the maximum value must equal $14$:<br>\\begin{aligned}\n9 + c &= 14 \\cr\nc &= 5\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "To find the range of the rational function $g(x)$, let $y = g(x)$ and rearrange the equation to express $x$ in terms of $y$:<br>$$y = \\dfrac{2x + 3}{x - 1}$$<br>\\begin{aligned}\ny\\left(x - 1\\right) &= 2x + 3 \\cr\nyx - y &= 2x + 3\n\\end{aligned}",
                        "Group the $x$ terms on one side of the equation:<br>\\begin{aligned}\nyx - 2x &= y + 3 \\cr\nx\\left(y - 2\\right) &= y + 3\n\\end{aligned}<br>$$x = \\dfrac{y + 3}{y - 2}$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "To solve the composite equation $ff(x) = 2$, let $y = f(x)$. This transforms the equation into:<br>\\begin{aligned}\nf(y) &= 2 \\cr\n|2y - 5| - 3 &= 2\n\\end{aligned}",
                        "Solve this basic modulus equation for $y$:<br>$$|2y - 5| = 5$$<br>This splits into two linear cases:<br>\\begin{aligned}\n2y - 5 &= 5 \\cr\n2y &= 10 \\cr\ny &= 5\n\\end{aligned}<br>\\begin{aligned}\n2y - 5 &= -5 \\cr\n2y &= 0 \\cr\ny &= 0\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "First, rewrite $f(x)$ by completing the square:<br>\\begin{aligned}\nf(x) &= x^2 - 4x + 4 \\cr\n&= \\left(x - 2\\right)^2\n\\end{aligned}<br>For $x \\ge 2$, the gradient $f'(x) = 2(x - 2) \\ge 0$, which means the function is strictly increasing. Because it is a one-to-one function on this restricted domain, it has a valid inverse function.",
        ...
        },
        {
                ...
                "steps": [
                        "The function $f(x) = \\dfrac{3x + 1}{x - 3}$ is undefined when its denominator is equal to zero:<br>\\begin{aligned}\nx - 3 &= 0 \\cr\nx &= 3\n\\end{aligned}<br>Therefore, the constant restriction value is $a = 3$.",
                        "To prove $f(x)$ is a self-inverse function, let $y = f(x)$ and solve for $x$ in terms of $y$:<br>\\begin{aligned}\ny &= \\dfrac{3x + 1}{x - 3} \\cr\ny\\left(x - 3\\right) &= 3x + 1\n\\end{aligned}",
                        "Expand and isolate the $x$ terms:<br>\\begin{aligned}\nyx - 3y &= 3x + 1 \\cr\nyx - 3x &= 3y + 1\n\\end{aligned}<br>\\begin{aligned}\nx\\left(y - 3\\right) &= 3y + 1 \\cr\nx &= \\dfrac{3y + 1}{y - 3}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "To find the derivative $\\dfrac{\\text{d}y}{\\text{d}x}$, we first differentiate $x$ and $y$ with respect to the parameter $t$:<br>\\begin{aligned}\n\\dfrac{\\text{d}x}{\\text{d}t} &= 1 - \\dfrac{4}{t^2} \\cr\n&= \\dfrac{t^2 - 4}{t^2}\n\\end{aligned}<br>\\begin{aligned}\n\\dfrac{\\text{d}y}{\\text{d}t} &= 1 + \\dfrac{4}{t^2} \\cr\n&= \\dfrac{t^2 + 4}{t^2}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Differentiate the parametric equations $x = 3\\cos\\theta$ and $y = 4\\sin\\theta$ with respect to the parameter $\\theta$:<br>\\begin{aligned}\n\\dfrac{\\text{d}x}{\\text{d}\\theta} &= -3\\sin\\theta \\quad \\text{and} \\quad \\dfrac{\\text{d}y}{\\text{d}\\theta} \\cr\n&= 4\\cos\\theta\n\\end{aligned}",
                        "Apply the parametric differentiation formula:<br>\\begin{aligned}\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{\\dfrac{\\text{d}y}{\\text{d}\\theta}}{\\dfrac{\\text{d}x}{\\text{d}\\theta}} \\cr\n&= \\dfrac{4\\cos\\theta}{-3\\sin\\theta} \\cr\n&= -\\dfrac{4}{3}\\cot\\theta\n\\end{aligned}",
                        "To find the tangent at $\\theta = \\dfrac{\\pi}{4}$, first evaluate the coordinates of the point of contact:<br>\\begin{aligned}\nx_1 &= 3\\cos\\left(\\dfrac{\\pi}{4}\\right) \\cr\n&= \\dfrac{3\\sqrt{2}}{2}\n\\end{aligned}<br>\\begin{aligned}\ny_1 &= 4\\sin\\left(\\dfrac{\\pi}{4}\\right) \\cr\n&= 4\\left(\\dfrac{\\sqrt{2}}{2}\\right) \\cr\n&= 2\\sqrt{2}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Differentiate the parametric equations $x = e^t + 2$ and $y = e^{2t} - 3$ with respect to the parameter $t$:<br>\\begin{aligned}\n\\dfrac{\\text{d}x}{\\text{d}t} &= e^t \\quad \\text{and} \\quad \\dfrac{\\text{d}y}{\\text{d}t} \\cr\n&= 2e^{2t}\n\\end{aligned}",
                        "Apply the parametric chain rule formula:<br>\\begin{aligned}\n\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{\\dfrac{\\text{d}y}{\\text{d}t}}{\\dfrac{\\text{d}x}{\\text{d}t}} \\cr\n&= \\dfrac{2e^{2t}}{e^t} \\cr\n&= 2e^t\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "For $y = 0 \\implies t^3 - 3t = 0 \\implies t\\left(t^2 - 3\\right) = 0$, which yields three solutions for $t$:<br>\\begin{aligned}\nt &= 0 \\cr\n(0, 0)\n\\end{aligned}<br>\\begin{aligned}\nt &= \\sqrt{3} \\cr\nx &= \\left(\\sqrt{3}\\right)^2 = 3 \\cr\n(3, 0)\n\\end{aligned}\\begin{aligned}\nt &= -\\sqrt{3} \\cr\nx &= \\left(-\\sqrt{3}\\right)^2 = 3 \\cr\n(3, 0)\n\\end{aligned}<br>So the curve meets the axes at the distinct points $(0, 0)$ and $(3, 0)$.",
        ...
        },
        {
                ...
                "steps": [
                        "Differentiate $x$ and $y$ with respect to the parameter $t$:<br>\\begin{aligned}\n\\dfrac{\\text{d}x}{\\text{d}t} &= 2 - \\dfrac{1}{t^2} \\cr\n&= \\dfrac{2t^2 - 1}{t^2}\n\\end{aligned}<br>\\begin{aligned}\n\\dfrac{\\text{d}y}{\\text{d}t} &= 2 + \\dfrac{1}{t^2} \\cr\n&= \\dfrac{2t^2 + 1}{t^2}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Set $M = 100$ and solve for $t$ using natural logarithms:<br>\\begin{aligned}\n200e^{-0.04t} &= 100 \\cr\ne^{-0.04t} &= 0.5\n\\end{aligned}<br>\\begin{aligned}\n-0.04t &= \\ln\\left(0.5\\right) = -\\ln\\left(2\\right) \\cr\nt &= \\dfrac{\\ln\\left(2\\right)}{0.04} = 25\\ln\\left(2\\right) \\approx 17.3 \\text{ minutes}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "To find the initial temperature, substitute $t = 0$ into the temperature equation:<br>\\begin{aligned}\n\\theta &= 20 + 65e^{-0.08\\left(0\\right)} \\cr\n&= 20 + 65e^0 \\cr\n&= 20 + 65\\left(1\\right) \\cr\n&= 85^\\circ\\text{C}\n\\end{aligned}",
                        "To find the time taken to cool to $50^\\circ\\text{C}$, set $\\theta = 50$ and solve for $t$:<br>\\begin{aligned}\n50 &= 20 + 65e^{-0.08t} \\cr\n30 &= 65e^{-0.08t}\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "To find the initial population, substitute $t = 0$ into the population model:<br>\\begin{aligned}\nP &= 800e^{0.15\\left(0\\right)} \\cr\n&= 800e^0 \\cr\n&= 800\n\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Differentiate $X(t)$ and $Y(t)$ with respect to $t$ using the chain rule:<br>\\begin{aligned}\n\\dfrac{\\text{d}X}{\\text{d}t} &= 300\\left(0.06\\right)e^{0.06t} \\cr\n&= 18e^{0.06t}\n\\end{aligned}<br>\\begin{aligned}\n\\dfrac{\\text{d}Y}{\\text{d}t} &= 100\\left(0.10\\right)e^{0.10t} \\cr\n&= 10e^{0.10t}\n\\end{aligned}",
