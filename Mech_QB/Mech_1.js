...
},
{
    ...
    "steps": [
        "<strong>(a) (i) Find R:</strong><br><br>Treat the tractor and trailer as a single combined system of mass $1800\\text{ kg}$. Apply Newton's Second Law ($F = ma$) in the direction of motion:\\begin{aligned} &F_{\\text{resultant}} = m_{\\text{total}} a \\cr &900 - 400 - R = 1800(0.15) \\cr &500 - R = 270 \\cr &R = 500 - 270 \\cr &R = 230\\text{ N} \\end{aligned}",
        "<strong>(a) (ii) Find the tension T:</strong><br><br>Consider only the trailer. The horizontal forces are the tension $T$ forward and the resistance $R = 230\\text{ N}$ backward. Apply $F = ma$:\\begin{aligned} &T - R = m_{\\text{trailer}} a \\cr &T - 230 = 600(0.15) \\cr &T - 230 = 90 \\cr &T = 320\\text{ N} \\end{aligned}",
        ...
        "<strong>(c) (i) Find the distance AB:</strong><br><br>When the trailer releases the rope, tension is zero ($T = 0$). The only horizontal force acting on the $600\\text{ kg}$ trailer is $R = 230\\text{ N}$. Find the new acceleration $a$:\\begin{aligned} &-R = m_{\\text{trailer}} a \\cr &-230 = 600a \\cr &a = -\\dfrac{230}{600} \\cr &a \\approx -0.3833\\text{ m s}^{-2} \\end{aligned}",
        "Use $v^2 = u^2 + 2as$ with $u = 8\\text{ m s}^{-1}$, $v = 0$, and $a = -0.3833\\text{ m s}^{-2}$ to solve for the distance $s = AB$:\\begin{aligned} &v^2 = u^2 + 2as \\cr &0 = 8^2 + 2(-0.3833)s \\cr &0.7667s = 64 \\cr &s = \\dfrac{64}{0.7667} \\cr &s \\approx 83.5\\text{ m} \\end{aligned}",
...
},
{
    ...
    "steps": [
        ...
        "Calculate the component of total weight acting down the slope:\\begin{aligned} &W_x \\cr &\\quad = m_{\\text{total}} g \\sin 8^\\circ \\cr &\\quad = 2000(9.8)\\sin 8^\\circ \\cr &\\quad \\approx 2727.8\\text{ N} \\end{aligned}",
        "Apply Newton's Second Law parallel to the inclined plane (taking up the slope as positive):\\begin{aligned} &D - R_{\\text{total}} - W_x = m_{\\text{total}} a \\cr &D - 400 - 2727.8 = 2000(0.4) \\cr &D - 3127.8 = 800 \\cr &D = 3927.8 \\cr &D \\approx 3930\\text{ N} \\end{aligned}",
        "<strong>(b) Find the tension T:</strong><br><br>Consider the caravan alone. Calculate the component of its weight acting down the slope:\\begin{aligned} &W_{\\text{caravan}} \\cr &\\quad = 800(9.8)\\sin 8^\\circ \\cr &\\quad \\approx 1091.1\\text{ N} \\end{aligned}",
        "Apply $F = ma$ to the caravan directed up the slope:\\begin{aligned} &T - R_{\\text{caravan}} - W_{\\text{caravan}} \\cr &\\quad = m_{\\text{caravan}} a \\cr &T - 150 - 1091.1 = 800(0.4) \\cr &T - 1241.1 = 320 \\cr &T = 1561.1 \\cr &T \\approx 1560\\text{ N} \\end{aligned}",
...
},
{
    ...
    "steps": [
        "<strong>(a) Find the tension in the cable:</strong><br><br>Treat the lift and passenger as a combined system of total mass $580\\text{ kg}$. Apply Newton's Second Law vertically upwards:\\begin{aligned} &T - m_{\\text{total}} g = m_{\\text{total}} a \\cr &T - 580(9.8) = 580(1.2) \\cr &T - 5684 = 696 \\cr &T = 6380\\text{ N} \\end{aligned}",
        ...
        "Apply Newton's Second Law to the passenger vertically upwards:\\begin{aligned} &R - m_{\\text{pass}} g = m_{\\text{pass}} a \\cr &R - 80(9.8) = 80(1.2) \\cr &R - 784 = 96 \\cr &R = 880\\text{ N} \\end{aligned}",
...
},
{
    ...
    "steps": [
        ...
        "Add the two equations together to eliminate $T$ and solve for $a$:\\begin{aligned} &5g - 3g = 8a \\cr &2g = 8a \\cr &a = \\dfrac{2(9.8)}{8} \\cr &a = 2.45\\text{ m s}^{-2} \\end{aligned}",
        "<strong>(b) Find the tension T:</strong><br><br>Substitute $a = 2.45\\text{ m s}^{-2}$ into the equation of motion for the $3\\text{ kg}$ block:\\begin{aligned} &T - 3g = 3a \\cr &T - 3(9.8) = 3(2.45) \\cr &T - 29.4 = 7.35 \\cr &T = 36.75\\text{ N} \\end{aligned}",
        "<strong>(c) Find the force exerted on the pulley:</strong><br><br>The string hangs down on both sides of the pulley wheel, pulling downwards with tension $T$ on each side. The total downward force $F$ exerted on the pulley is:\\begin{aligned} &F \\cr &\\quad = 2T \\cr &\\quad = 2(36.75) \\cr &\\quad = 73.5\\text{ N} \\end{aligned}",
