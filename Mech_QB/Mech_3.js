...
},
{
    ...
    "steps": [
        ...
        "<strong>(f) Sketching the curve:</strong><br><br>The graph of $y = \\dfrac{1360}{x^2}$ is an inverse-square curve in the first quadrant, decreasing smoothly with both axes as asymptotes.<img src='images/Mechanics_pngs/012146_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
...
},
{
    ...
    "steps": [
        ...
        "<strong>(e) Sketching the graph:</strong><br><br>The graph of $T = R^{1.5}$ passes through the origin $(0, 0)$ and curves upwards with increasing gradient in the first quadrant.<img src='images/Mechanics_pngs/012147_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
...
},
{
    ...
    "img": false,
    "question": "A laboratory culture of bacteria is monitored over time. The population, $N\\text{ (in thousands)}$, after $t\\text{ hours}$ is recorded at two intervals in the table below:<table style='width:100%; max-width:240px; margin:15px auto; border-collapse:collapse; text-align:center;'><thead><tr style='border-bottom:2px solid #333;'><th style='padding:6px;'>$t\\text{ (h)}$</th><th style='padding:6px;'>$N\\text{ (k)}$</th><th style='padding:6px;'>$\\ln N$</th></tr></thead><tbody><tr style='border-bottom:1px solid #ddd;'><td style='padding:6px;'>$2.0$</td><td style='padding:6px;'>$45.0$</td><td style='padding:6px;'></td></tr><tr><td style='padding:6px;'>$5.0$</td><td style='padding:6px;'>$360$</td><td style='padding:6px;'></td></tr></tbody></table>The population is modelled by the exponential relationship $N = A \\mathrm{e}^{kt}$, where $A$ and $k$ are constants.<br><br><strong>(a)</strong> Show that $\\ln N$ can be written in the form $c + mt$, stating $c$ and $m$ in terms of $A$ and $k$.<br><br><strong>(b)</strong> Complete the table by calculating the missing values of $\\ln N$, giving each value correct to 4 significant figures.<br><br><strong>(c)</strong> Use the completed table to calculate the values of $c$ and $m$, giving each correct to 3 significant figures.<br><br><strong>(d)</strong> Hence determine the values of $A$ and $k$, giving $A$ correct to 3 significant figures and $k$ correct to 3 decimal places.<br><br><strong>(e)</strong> Sketch the graph of $N$ against $t$ for $t \\ge 0$.<br><br><strong>(f)</strong> Use the model to predict the bacterial population after $8.0\\text{ hours}$.",
    "steps": [
        ...
        "<strong>(e) Sketching the exponential curve:</strong><br><br>The graph starts at vertical intercept $(0, 11.3)$ and displays exponential growth with increasing gradient as $t$ increases.<img src='images/Mechanics_pngs/012148_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
...
},
{
    ...
    "steps": [
        ...
        "<strong>(e) Sketching the decay curve:</strong><br><br>The graph starts at vertical intercept $(0, 101.3)$ and decreases asymptotically towards the horizontal axis $P = 0$ as $h \\to \\infty$.<img src='images/Mechanics_pngs/012149_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
...
},
{
    ...
    "steps": [
        ...
        "<strong>(e) Sketching the power curve:</strong><br><br>Since the exponent $n = 0.75$ lies between $0$ and $1$, the graph of $B = 4.10M^{0.75}$ passes through the origin $(0, 0)$ and curves upwards with decreasing gradient (concave down).<img src='images/Mechanics_pngs/012150_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
