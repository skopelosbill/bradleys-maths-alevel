...
},
{
    ...
    "img": "images/Mechanics_pngs/012081.png",
    "question": "A ball is thrown from a point $A$, which is $2\\text{ m}$ above horizontal ground. The ball is projected with speed $U\\text{ m s}^{-1}$ at an angle $\\alpha$ above the horizontal. The highest point of the trajectory of the ball is $4\\text{ m}$ above the ground.<br><br>The ball is modelled as a particle moving freely under gravity.<br><br><strong>(a)</strong> Show that:<br>$$U^2 = \\dfrac{ 4g }{ \\sin^2\\alpha }$$<br>The ball hits a target $T$ which is at a horizontal distance of $16\\text{ m}$ from $A$ and is at a height of $0.875\\text{ m}$ above the ground, as shown in the diagram.<br><br><strong>(b)</strong> Show that $\\tan\\alpha = \\dfrac{ 9 }{ 16 }$.<br><br><strong>(c)</strong> Find the value of $U$.<br><br><strong>(d)</strong> Find the time it takes for the ball to travel from $A$ to $T$.",
    "steps": [
...
},
{
    ...
    "img": "images/Mechanics_pngs/012084.png",
