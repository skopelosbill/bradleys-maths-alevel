...
},
{
    ...
    "steps": [
        ...
        "Final Answer: $$t = 2\\text{ s}, \\quad \\text{KE} = 14.5\\text{ J},\\text{ }\\mathbf{F}| = 0.8\\text{ N}$$"
    ],
    "pi_options": [
        {
            "ans": "$$t = 2\\text{ s}, \\quad \\text{KE} = 29.0\\text{ J},\\text{ }\\mathbf{F}| = 1.6\\text{ N}$$",
        ...
        {
            "ans": "$$t = 1\\text{ s}, \\quad \\text{KE} = 14.5\\text{ J},\\text{ }\\mathbf{F}| = 0\\text{ N}$$",
        ...
        {
            "ans": "$$t = 2\\text{ s}, \\quad \\text{KE} = 17.0\\text{ J},\\text{ }\\mathbf{F}| = 1.2\\text{ N}$$",
...
},
{
    ...
    "steps": [
        "<strong>(i) Find tension after release:</strong><br><br>Applying Newton's second law ($F = ma$):<br><br>• For $P$ (upwards):\\begin{aligned} &T - 3g = 3a \\end{aligned}<br><br>• For $Q$ (downwards):\\begin{aligned} &7g - T = 7a \\end{aligned}Add equations to eliminate $T$:\\begin{aligned} &4g = 10a \\cr &a \\cr &\\quad = 0.4g \\cr &\\quad = 0.4 \\times 9.8 \\cr &\\quad = 3.92\\text{ m s}^{-2} \\end{aligned}Substitute $a$ into equation for $P$:\\begin{aligned} &T - 3(9.8) = 3(3.92) \\cr &T - 29.4 = 11.76 \\cr &T \\cr &\\quad = 11.76 + 29.4 \\cr &\\quad = 41.16\\text{ N} \\end{aligned}",
        "Speed $v$ when $Q$ descends $2\\text{ m}$ ($a = 3.92\\text{ m s}^{-2}$):\\begin{aligned} &v^2 \\cr &\\quad = 0^2 + 2(3.92)(2) \\cr &\\quad = 15.68 \\cr &v \\cr &\\quad = \\sqrt{15.68} \\cr &\\quad \\approx 3.96\\text{ m s}^{-1} \\end{aligned}",
        "<strong>(ii) Find distance while string is slack:</strong><br><br>When $Q$ stops, the string goes slack. Particle $P$ moves under gravity ($a = -9.8\\text{ m s}^{-2}$) until $v = 0$:\\begin{aligned} &0 = v^2 - 2gs_{\\text{up}} \\cr &0 = 15.68 - 2(9.8)s_{\\text{up}} \\cr &19.6s_{\\text{up}} = 15.68 \\cr &s_{\\text{up}} \\cr &\\quad = \\dfrac{15.68}{19.6} \\cr &\\quad = 0.8\\text{ m} \\end{aligned}",
        "The string remains slack until $P$ falls back to the impact height ($s_{\\text{down}} = 0.8\\text{ m}$):\\begin{aligned} &\\text{Total distance} \\cr &\\quad = s_{\\text{up}} + s_{\\text{down}} \\cr &\\quad = 0.8 + 0.8 \\cr &\\quad = 1.6\\text{ m} \\end{aligned}",
        "Final Answer: $T = 41.16\\text{ N}, \\text{distance} = 1.6\\text{ m}$"
    ],
    "pi_options": [
        {
        ...
        },
        {
            ...
            "feedback": "This tension is correct, but the distance of $2.8\\text{ m}$ is found by adding the initial $2\\text{ m}$ ascent of $P$ to the $0.8\\text{ m}$ slack upward motion. The question only asks for the distance travelled between the instant $Q$ strikes the plane and when the string becomes taut again."
        }
    ],
    "bradley_insight": {
        "type": "caution",
...
},
{
    ...
    "steps": [
        "<strong>(i) Find tension after release:</strong><br><br>Applying Newton's second law ($F = ma$):<br><br>• For $P$ (upwards):\\begin{aligned} &T - 2g = 2a \\end{aligned}<br><br>• For $Q$ (downwards):\\begin{aligned} &3g - T = 3a \\end{aligned}Add equations to eliminate $T$:\\begin{aligned} &g = 5a \\cr &a \\cr &\\quad = 0.2g \\cr &\\quad = 0.2 \\times 9.8 \\cr &\\quad = 1.96\\text{ m s}^{-2} \\end{aligned}Substitute $a$ into equation for $P$:\\begin{aligned} &T - 2(9.8) = 2(1.96) \\cr &T - 19.6 = 3.92 \\cr &T \\cr &\\quad = 3.92 + 19.6 \\cr &\\quad = 23.52\\text{ N} \\end{aligned}",
        "Speed $v$ when $Q$ descends $6.125\\text{ m}$ ($a = 1.96\\text{ m s}^{-2}$):\\begin{aligned} &v^2 \\cr &\\quad = 0^2 + 2(1.96)(6.125) \\cr &\\quad = 24.01 \\cr &v \\cr &\\quad = \\sqrt{24.01} \\cr &\\quad = 4.9\\text{ m s}^{-1} \\end{aligned}",
        "<strong>(ii) Find time until string is taut again:</strong><br><br>When $Q$ stops, the string goes slack. Particle $P$ ascends under gravity ($a = -9.8\\text{ m s}^{-2}$) with $u = 4.9\\text{ m s}^{-1}$ until $v = 0$:\\begin{aligned} &0 = u - gt_{\\text{up}} \\cr &0 = 4.9 - 9.8t_{\\text{up}} \\cr &9.8t_{\\text{up}} = 4.9 \\cr &t_{\\text{up}} \\cr &\\quad = \\dfrac{4.9}{9.8} \\cr &\\quad = 0.5\\text{ s} \\end{aligned}",
        "By symmetry, time falling back to the impact height equals $t_{\\text{up}}$:\\begin{aligned} &\\text{Total time} \\cr &\\quad = t_{\\text{up}} + t_{\\text{down}} \\cr &\\quad = 0.5 + 0.5 \\cr &\\quad = 1\\text{ s} \\end{aligned}",
        "Final Answer: $T = 23.52\\text{ N}, \\text{time} = 1.00\\text{ s}$"
    ],
    "pi_options": [
        {
        ...
        },
        {
            ...
            "feedback": "This tension is incorrect because it assumes $T = 2g = 19.6\\text{ N}$ (as if the system were in static equilibrium). Since the system is accelerating upwards, the tension must exceed the stationary weight ($T = 2(g + a)$, which is $23.52\\text{ N}$)."
        },
        {
...
},
{
    ...
    "steps": [
        "<strong>(i) Find tension after release:</strong><br><br>Applying Newton's second law ($F = ma$):<br><br>• For $Q$ (downwards):\\begin{aligned} &6g - T = 6a \\end{aligned}<br><br>• For $P$ (up the incline, $\\sin 30^{\\circ} = 0.5$):\\begin{aligned} &T - 2g\\sin 30^{\\circ} = 2a \\cr &T - g = 2a \\end{aligned}Add equations to eliminate $T$:\\begin{aligned} &5g = 8a \\cr &a \\cr &\\quad = 0.625g \\cr &\\quad = 0.625 \\times 9.8 \\cr &\\quad = 6.125\\text{ m s}^{-2} \\end{aligned}Substitute $a$ into equation for $P$:\\begin{aligned} &T - 9.8 = 2(6.125) \\cr &T - 9.8 = 12.25 \\cr &T \\cr &\\quad = 12.25 + 9.8 \\cr &\\quad = 22.05\\text{ N} \\end{aligned}",
        "Speed $v$ when $Q$ descends $1.6\\text{ m}$ ($a = 6.125\\text{ m s}^{-2}$):\\begin{aligned} &v^2 \\cr &\\quad = 0^2 + 2(6.125)(1.6) \\cr &\\quad = 19.6 \\cr &v \\cr &\\quad = \\sqrt{19.6}\\text{ m s}^{-1} \\end{aligned}",
        "<strong>(ii) Find distance while string is slack:</strong><br><br>When $Q$ stops, the string goes slack. Acceleration along the plane is:\\begin{aligned} &a_{\\text{slack}} \\cr &\\quad = -g\\sin 30^{\\circ} \\cr &\\quad = -9.8 \\times 0.5 \\cr &\\quad = -4.9\\text{ m s}^{-2} \\end{aligned}Distance $s_{\\text{up}}$ until $v = 0$:\\begin{aligned} &0 = 19.6 + 2(-4.9)s_{\\text{up}} \\cr &9.8s_{\\text{up}} = 19.6 \\cr &s_{\\text{up}} \\cr &\\quad = \\dfrac{19.6}{9.8} \\cr &\\quad = 2\\text{ m} \\end{aligned}",
        "Block $P$ slides back down $2\\text{ m}$ until the string is taut again:\\begin{aligned} &\\text{Total distance} \\cr &\\quad = s_{\\text{up}} + s_{\\text{down}} \\cr &\\quad = 2 + 2 \\cr &\\quad = 4\\text{ m} \\end{aligned}",
        "Final Answer: $T = 22.05\\text{ N}, \\text{distance} = 4.00\\text{ m}$"
    ],
    "pi_options": [
        {
        ...
        },
        {
            ...
            "feedback": "The tension is correct, but the distance of $3.60\\text{ m}$ is incorrect. This error can happen if you add the initial $1.6\\text{ m}$ of motion to the $2.0\\text{ m}$ of slack upward motion. The question asks for the distance travelled only after the instant $Q$ strikes the floor."
        }
    ],
    "bradley_insight": {
        "type": "deeper",
...
},
{
    ...
    "steps": [
        "Normal reaction $R$ on $P$ perpendicular to incline:\\begin{aligned} &R \\cr &\\quad = m_P g\\cos\\theta \\cr &\\quad = 5(9.8)(0.8) \\cr &\\quad = 39.2\\text{ N} \\end{aligned}Maximum friction $F$ opposing motion:\\begin{aligned} &F \\cr &\\quad = \\mu R \\cr &\\quad = 0.25 \\times 39.2 \\cr &\\quad = 9.8\\text{ N} \\end{aligned}",
        "<strong>(i) Find tension after release:</strong><br><br>Applying Newton's second law ($F = ma$):<br><br>• For $Q$ (downwards):\\begin{aligned} &5g - T = 5a \\end{aligned}<br><br>• For $P$ (upwards, friction acts down):\\begin{aligned} &T - 5g\\sin\\theta - F = 5a \\cr &T - 5(9.8)(0.6) - 9.8 = 5a \\cr &T - 39.2 = 5a \\end{aligned}Add equations to eliminate $T$:\\begin{aligned} &49 - 39.2 = 10a \\cr &9.8 = 10a \\cr &a = 0.98\\text{ m s}^{-2} \\end{aligned}Substitute $a$ into equation for $Q$:\\begin{aligned} &49 - T = 5(0.98) \\cr &49 - T = 4.9 \\cr &T \\cr &\\quad = 49 - 4.9 \\cr &\\quad = 44.1\\text{ N} \\end{aligned}",
        "Speed $v$ when $Q$ descends $10\\text{ m}$ ($a = 0.98\\text{ m s}^{-2}$):\\begin{aligned} &v^2 \\cr &\\quad = 0^2 + 2(0.98)(10) \\cr &\\quad = 19.6 \\cr &v \\cr &\\quad = \\sqrt{19.6}\\text{ m s}^{-1} \\end{aligned}",
        "<strong>(ii) Find distance while string is slack:</strong><br><br>When $Q$ stops, the string goes slack. Gravity component and friction oppose upward motion:\\begin{aligned} &-5g\\sin\\theta - F = 5a_{\\text{slack}} \\cr &-29.4 - 9.8 = 5a_{\\text{slack}} \\cr &a_{\\text{slack}} \\cr &\\quad = -\\dfrac{39.2}{5} \\cr &\\quad = -7.84\\text{ m s}^{-2} \\end{aligned}Distance $s_{\\text{up}}$ until $v = 0$:\\begin{aligned} &0 = 19.6 + 2(-7.84)s_{\\text{up}} \\cr &15.68s_{\\text{up}} = 19.6 \\cr &s_{\\text{up}} \\cr &\\quad = \\dfrac{19.6}{15.68} \\cr &\\quad = 1.25\\text{ m} \\end{aligned}",
        "Since $5g\\sin\\theta = 29.4\\text{ N} > 9.8\\text{ N}$, $P$ slides back down $1.25\\text{ m}$ until the string is taut again:\\begin{aligned} &\\text{Total distance} \\cr &\\quad = s_{\\text{up}} + s_{\\text{down}} \\cr &\\quad = 1.25 + 1.25 \\cr &\\quad = 2.5\\text{ m} \\end{aligned}",
        "Final Answer: $T = 44.10\\text{ N}, \\text{distance} = 2.50\\text{ m}$"
    ],
    "pi_options": [
        {
        ...
        },
        {
            ...
            "feedback": "A tension of $49.00\\text{ N}$ is incorrect; this is equal to the weight of $Q$ ($5g$), which would only be true if the system were static. Because the system is accelerating, you must calculate the tension using $T = 5(g - a)$, giving $44.10\\text{ N}$."
        },
        {
...
},
{
    ...
    "steps": [
        "Total mass on left is $m_{\\text{left}} = 4\\text{ kg}$ ($1 + 3$). Applying Newton's second law ($F = ma$):<br><br>• For pan and block ($4\\text{ kg}$, upwards):\\begin{aligned} &T - 4g = 4a \\end{aligned}<br><br>• For $Q$ ($6\\text{ kg}$, downwards):\\begin{aligned} &6g - T = 6a \\end{aligned}Add equations to eliminate $T$:\\begin{aligned} &2g = 10a \\cr &a \\cr &\\quad = 0.2g \\cr &\\quad = 0.2 \\times 9.8 \\cr &\\quad = 1.96\\text{ m s}^{-2} \\end{aligned}",
        "<strong>(i) Find force exerted by $B$ on $P$:</strong><br><br>Consider forces on block $B$ ($3\\text{ kg}$) accelerating upwards at $a = 1.96\\text{ m s}^{-2}$:\\begin{aligned} &R - m_B g = m_B a \\cr &R - 3(9.8) = 3(1.96) \\cr &R - 29.4 = 5.88 \\cr &R \\cr &\\quad = 5.88 + 29.4 \\cr &\\quad = 35.28\\text{ N} \\end{aligned}By Newton's third law, the force exerted on the pan is $35.28\\text{ N}$.",
        "Speed squared $v^2$ when $Q$ descends $2.5\\text{ m}$ ($a = 1.96\\text{ m s}^{-2}$):\\begin{aligned} &v^2 \\cr &\\quad = 0^2 + 2(1.96)(2.5) \\cr &\\quad = 9.8 \\end{aligned}",
        "<strong>(ii) Find distance while string is slack:</strong><br><br>When $Q$ stops, the string goes slack. The pan and block move under gravity ($a = -9.8\\text{ m s}^{-2}$) until $v = 0$:\\begin{aligned} &0 = v^2 - 2gs_{\\text{up}} \\cr &0 = 9.8 - 2(9.8)s_{\\text{up}} \\cr &19.6s_{\\text{up}} = 9.8 \\cr &s_{\\text{up}} \\cr &\\quad = \\dfrac{9.8}{19.6} \\cr &\\quad = 0.5\\text{ m} \\end{aligned}",
        "The string remains slack until the scale pan falls back to the impact height ($s_{\\text{down}} = 0.5\\text{ m}$):\\begin{aligned} &\\text{Total distance} \\cr &\\quad = s_{\\text{up}} + s_{\\text{down}} \\cr &\\quad = 0.5 + 0.5 \\cr &\\quad = 1\\text{ m} \\end{aligned}",
        "Final Answer: $R = 35.28\\text{ N}, \\text{distance} = 1.00\\text{ m}$"
    ],
    "pi_options": [
        {
        ...
        },
        {
            ...
            "feedback": "A contact force of $29.40\\text{ N}$ is incorrect because it is simply the stationary weight of the block ($3g = 29.4\\text{ N}$). Since the block is accelerating upwards, the normal reaction force must exceed its stationary weight ($R = m_B(g+a)$, which equals $35.28\\text{ N}$)."
        },
        {
            "ans": "$R = 35.28\\text{ N}, \\text{distance} = 3.00\\text{ m}$",
            "feedback": "The reaction force is correct, but the distance of $3.00\\text{ m}$ is incorrect. This error may occur if you add the initial $2.5\\text{ m}$ ascent of the scale pan to the $0.5\\text{ m}$ slack upward motion. The question asks only for the distance travelled after $Q$ strikes the floor."
        }
    ],
    "bradley_insight": {
        "type": "pro-tip",
...
},
{
    ...
    "steps": [
        "<strong>(i) (a) Show initial speed is $2\\text{ m s}^{-1}$:</strong><br><br>Using $s = \\dfrac{1}{2}(u + v)t$ with $s = 16\\text{ m}$, $t = 8\\text{ s}$, and $v = 6\\text{ m s}^{-1}$:\\begin{aligned} &16 = \\dfrac{1}{2}(u + 6)(8) \\cr &16 = 4(u + 6) \\cr &4 = u + 6 \\cr &u = -2\\text{ m s}^{-1} \\end{aligned}Initial speed is $|u| = 2\\text{ m s}^{-1}$.<br><br><strong>(i) (b) Find acceleration of $P$:</strong><br><br>Using $v = u + at$:\\begin{aligned} &6 = -2 + 8a \\cr &8 = 8a \\cr &a = 1\\text{ m s}^{-2} \\end{aligned}",
        "<strong>(ii) Show $P$ is never at $B$:</strong><br><br>At point $B$, displacement $s = -5\\text{ m}$. Using $s = ut + \\dfrac{1}{2}at^2$:\\begin{aligned} &-5 = -2t + 0.5t^2 \\cr &0.5t^2 - 2t + 5 = 0 \\cr &t^2 - 4t + 10 = 0 \\end{aligned}Check the discriminant $\\Delta = b^2 - 4ac$:\\begin{aligned} &\\Delta \\cr &\\quad = (-4)^2 - 4(1)(10) \\cr &\\quad = 16 - 40 \\cr &\\quad = -24 \\end{aligned}Since $\\Delta < 0$, no real solutions for $t$ exist. Therefore, $P$ is never at $B$.",
        "<strong>(iii) Find velocity of $Q$ at $A$:</strong><br><br>Differentiate $x_Q(t) = at^3 + bt^2 + ct$:\\begin{aligned} &v_Q(t) = 3at^2 + 2bt + c \\cr &a_Q(t) = 6at + 2b \\end{aligned}Match initial conditions ($t = 0\\text{ s}$) with $P$:\\begin{aligned} &c = -2 \\cr &2b = 1 \\cr &b = 0.5 \\end{aligned}So $x_Q(t) = at^3 + 0.5t^2 - 2t$. At $A$ ($t = 4\\text{ s}$, $x_Q = 16\\text{ m}$):\\begin{aligned} &16 = a(4)^3 + 0.5(4)^2 - 2(4) \\cr &16 = 64a + 8 - 8 \\cr &16 = 64a \\cr &a = 0.25 \\end{aligned}",
        "Velocity equation for $Q$:\\begin{aligned} &v_Q(t) \\cr &\\quad = 3(0.25)t^2 + 2(0.5)t - 2 \\cr &\\quad = 0.75t^2 + t - 2 \\end{aligned}At $t = 4\\text{ s}$:\\begin{aligned} &v_Q(4) \\cr &\\quad = 0.75(4)^2 + 4 - 2 \\cr &\\quad = 0.75(16) + 2 \\cr &\\quad = 12 + 2 \\cr &\\quad = 14\\text{ m s}^{-1} \\end{aligned}",
        "Final Answer: $a = 1\\text{ m s}^{-2}, \\text{velocity} = 14\\text{ m s}^{-1}$"
    ],
    "pi_options": [
        {
...
},
{
    ...
    "steps": [
        "<strong>(i) (a) Show initial speed is $2\\text{ m s}^{-1}$:</strong><br><br>Using $s = \\dfrac{1}{2}(u + v)t$ with $s = 20\\text{ m}$, $t = 5\\text{ s}$, and $v = 10\\text{ m s}^{-1}$:\\begin{aligned} &20 = \\dfrac{1}{2}(u + 10)(5) \\cr &20 = 2.5(u + 10) \\cr &8 = u + 10 \\cr &u = -2\\text{ m s}^{-1} \\end{aligned}Initial speed is $|u| = 2\\text{ m s}^{-1}$.<br><br><strong>(i) (b) Find acceleration of $P$:</strong><br><br>Using $v = u + at$:\\begin{aligned} &10 = -2 + 5a \\cr &12 = 5a \\cr &a \\cr &\\quad = \\dfrac{12}{5} \\cr &\\quad = 2.4\\text{ m s}^{-2} \\end{aligned}",
        "<strong>(ii) Show $P$ is never at $B$:</strong><br><br>At point $B$, $s = -2\\text{ m}$. Using $s = ut + \\dfrac{1}{2}at^2$:\\begin{aligned} &-2 = -2t + 1.2t^2 \\cr &1.2t^2 - 2t + 2 = 0 \\end{aligned}Check discriminant $\\Delta = b^2 - 4ac$:\\begin{aligned} &\\Delta \\cr &\\quad = (-2)^2 - 4(1.2)(2) \\cr &\\quad = 4 - 9.6 \\cr &\\quad = -5.6 \\end{aligned}Since $\\Delta < 0$, no real solutions for $t$ exist. Therefore, $P$ is never at $B$.",
        "<strong>(iii) Find velocity of $Q$ at $A$:</strong><br><br>Integrate $v_Q(t) = 3kt^2 + 2.4t - 2$:\\begin{aligned} &x_Q(t) \\cr &\\quad = \\int (3kt^2 + 2.4t - 2)\\text{d}t \\cr &\\quad = kt^3 + 1.2t^2 - 2t + D \\end{aligned}Since $x_Q(0) = 0$, $D = 0$.<br><br>At $A$ ($t = 2\\text{ s}$, $x_Q = 20\\text{ m}$):\\begin{aligned} &20 = k(2)^3 + 1.2(2)^2 - 2(2) \\cr &20 = 8k + 4.8 - 4 \\cr &20 = 8k + 0.8 \\cr &19.2 = 8k \\cr &k \\cr &\\quad = \\dfrac{19.2}{8} \\cr &\\quad = 2.4 \\end{aligned}",
        "Substitute $k = 2.4$ into $v_Q(t)$:\\begin{aligned} &v_Q(t) \\cr &\\quad = 3(2.4)t^2 + 2.4t - 2 \\cr &\\quad = 7.2t^2 + 2.4t - 2 \\end{aligned}At $t = 2\\text{ s}$:\\begin{aligned} &v_Q(2) \\cr &\\quad = 7.2(2)^2 + 2.4(2) - 2 \\cr &\\quad = 7.2(4) + 4.8 - 2 \\cr &\\quad = 28.8 + 2.8 \\cr &\\quad = 31.6\\text{ m s}^{-1} \\end{aligned}",
        "Final Answer: $a = 2.4\\text{ m s}^{-2}, \\text{velocity} = 31.6\\text{ m s}^{-1}$"
    ],
    "pi_options": [
        {
...
},
{
    ...
    "steps": [
        "<strong>(i) (a) Show initial velocity is $-2\\text{ m s}^{-1}$:</strong><br><br>Using $s = \\dfrac{1}{2}(u + v)t$ with $s = 24\\text{ m}$, $t = 6\\text{ s}$, and $v = 10\\text{ m s}^{-1}$:\\begin{aligned} &24 = \\dfrac{1}{2}(u + 10)(6) \\cr &24 = 3(u + 10) \\cr &8 = u + 10 \\cr &u = -2\\text{ m s}^{-1} \\end{aligned}<strong>(i) (b) Find acceleration of $P$:</strong><br><br>Using $v = u + at$:\\begin{aligned} &10 = -2 + 6a \\cr &12 = 6a \\cr &a = 2\\text{ m s}^{-2} \\end{aligned}",
        "<strong>(ii) Show car $P$ never reaches $B$:</strong><br><br>At marker $B$, $s = -3\\text{ m}$. Using $s = ut + \\dfrac{1}{2}at^2$:\\begin{aligned} &-3 = -2t + t^2 \\cr &t^2 - 2t + 3 = 0 \\end{aligned}Check discriminant $\\Delta = b^2 - 4ac$:\\begin{aligned} &\\Delta \\cr &\\quad = (-2)^2 - 4(1)(3) \\cr &\\quad = 4 - 12 \\cr &\\quad = -8 \\end{aligned}Since $\\Delta < 0$, no real solutions for $t$ exist. Therefore, $P$ never reaches $B$.",
        "<strong>(iii) Find velocity of $Q$ at $A$:</strong><br><br>Differentiate $x_Q(t) = at^3 + bt^2 + ct$:\\begin{aligned} &v_Q(t) = 3at^2 + 2bt + c \\cr &a_Q(t) = 6at + 2b \\end{aligned}Match initial conditions with $P$ at $t = 0\\text{ s}$:\\begin{aligned} &c = -2 \\cr &2b = 2 \\cr &b = 1 \\end{aligned}So $x_Q(t) = at^3 + t^2 - 2t$. At $A$ ($t = 4\\text{ s}$, $x_Q = 24\\text{ m}$):\\begin{aligned} &24 = a(4)^3 + 4^2 - 2(4) \\cr &24 = 64a + 16 - 8 \\cr &24 = 64a + 8 \\cr &16 = 64a \\cr &a = 0.25 \\end{aligned}",
        "Velocity equation for $Q$:\\begin{aligned} &v_Q(t) \\cr &\\quad = 3(0.25)t^2 + 2(1)t - 2 \\cr &\\quad = 0.75t^2 + 2t - 2 \\end{aligned}At $t = 4\\text{ s}$:\\begin{aligned} &v_Q(4) \\cr &\\quad = 0.75(4)^2 + 2(4) - 2 \\cr &\\quad = 0.75(16) + 8 - 2 \\cr &\\quad = 12 + 6 \\cr &\\quad = 18\\text{ m s}^{-1} \\end{aligned}",
        "Final Answer: $a = 2\\text{ m s}^{-2}, \\text{velocity} = 18\\text{ m s}^{-1}$"
    ],
    "pi_options": [
        {
            "ans": "$a = 2\\text{ m s}^{-2}, \\text{velocity} = 14\\text{ m s}^{-1}$",
            "feedback": "The constant acceleration is correct, but a velocity of $14\\text{ m s}^{-1}$ occurs if you incorrectly calculate $b = 0.5$ (by setting $2b = 2$, which gives $b = 1$, not $0.5$)."
        },
        {
    ...
    "bradley_insight": {
        ...
        "content": "Since the car starts with a negative velocity ($u = -2\\text{ m s}^{-1}$) and accelerates forward ($a = 2\\text{ m s}^{-2}$), it must stop and change direction. The turning point occurs when velocity $v_P = 0$, giving $-2 + 2t = 0$, so $t = 1\\text{ s}$. The minimum position of the car is $s(1) = -1\\text{ m}$ (from $-2(1) + 1^2$). Since marker $B$ is at $s = -3\\text{ m}$, the car turns back to the right before it ever reaches $B$."
    }
},
{
    "id": "012099",
    ...
    "steps": [
        "<strong>(i) (a) Show initial velocity is $-4\\text{ m s}^{-1}$:</strong><br><br>Using $s = \\dfrac{1}{2}(u + v)t$ with $s = 40\\text{ m}$, $t = 10\\text{ s}$, and $v = 12\\text{ m s}^{-1}$:\\begin{aligned} &40 = \\dfrac{1}{2}(u + 12)(10) \\cr &40 = 5(u + 12) \\cr &8 = u + 12 \\cr &u = -4\\text{ m s}^{-1} \\end{aligned}<strong>(i) (b) Find acceleration of $P$:</strong><br><br>Using $v = u + at$:\\begin{aligned} &12 = -4 + 10a \\cr &16 = 10a \\cr &a = 1.6\\text{ m s}^{-2} \\end{aligned}",
...
},
{
    ...
    "img": false,
    "question": "<img src='images/Mechanics_pngs/012100.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img><br><br>A particle $P$ moves in a straight line with constant acceleration. At time $t = 0\\text{ s}$, $P$ is at the origin $O$. After $t = 6\\text{ s}$, $P$ is at the point $A$, where $OA = 36\\text{ m}$ in the positive direction. The velocity of $P$ at $A$ is $14\\text{ m s}^{-1}$ in the direction $OA$.<br><br><strong>(i) (a)</strong> Show that the initial speed of $P$ is $2\\text{ m s}^{-1}$.<br><br><strong>(i) (b)</strong> Find the acceleration of $P$.<br><br><strong>(ii)</strong> $B$ is a point on the line such that $OB = 3\\text{ m}$ to the left of $O$. Show that $P$ is never at point $B$.<br><br><strong>(iii)</strong> A second particle $Q$ starts from $O$ at $t = 0\\text{ s}$ and moves along the same track with variable acceleration $a_Q(t) = 12kt + \\dfrac{8}{3}$, where $k$ is a constant. Initially ($t = 0\\text{ s}$), $Q$ has the same velocity as $P$ has initially. $Q$ reaches $A$ when $t = 3\\text{ s}$. Find the velocity of $Q$ at $A$.",
    "steps": [
        "<strong>(i) (a) Show initial speed is $2\\text{ m s}^{-1}$:</strong><br><br>Using $s = \\dfrac{1}{2}(u + v)t$ with $s = 36\\text{ m}$, $t = 6\\text{ s}$, and $v = 14\\text{ m s}^{-1}$:\\begin{aligned} &36 = \\dfrac{1}{2}(u + 14)(6) \\cr &36 = 3(u + 14) \\cr &12 = u + 14 \\cr &u = -2\\text{ m s}^{-1} \\end{aligned}Initial speed is $|u| = 2\\text{ m s}^{-1}$.<br><br><strong>(i) (b) Find acceleration of $P$:</strong><br><br>Using $v = u + at$:\\begin{aligned} &14 = -2 + 6a \\cr &16 = 6a \\cr &a \\cr &\\quad = \\dfrac{16}{6} \\cr &\\quad = \\dfrac{8}{3}\\text{ m s}^{-2} \\end{aligned}",
        "<strong>(ii) Show $P$ is never at $B$:</strong><br><br>At point $B$, $s = -3\\text{ m}$. Using $s = ut + \\dfrac{1}{2}at^2$:\\begin{aligned} &-3 = -2t + \\dfrac{4}{3}t^2 \\cr &\\dfrac{4}{3}t^2 - 2t + 3 = 0 \\cr &4t^2 - 6t + 9 = 0 \\end{aligned}Check discriminant $\\Delta = b^2 - 4ac$:\\begin{aligned} &\\Delta \\cr &\\quad = (-6)^2 - 4(4)(9) \\cr &\\quad = 36 - 144 \\cr &\\quad = -108 \\end{aligned}Since $\\Delta < 0$, no real solutions for $t$ exist. Therefore, $P$ is never at $B$.",
        "<strong>(iii) Find velocity of $Q$ at $A$:</strong><br><br>Integrate $a_Q(t) = 12kt + \\dfrac{8}{3}$:\\begin{aligned} &v_Q(t) \\cr &\\quad = \\int \\big(12kt + \\dfrac{8}{3}\\big)\\text{d}t \\cr &\\quad = 6kt^2 + \\dfrac{8}{3}t + C \\end{aligned}Since $v_Q(0) = -2$, $C = -2$.<br><br>Integrate again for displacement $x_Q(t)$:\\begin{aligned} &x_Q(t) \\cr &\\quad = \\int \\big(6kt^2 + \\dfrac{8}{3}t - 2\\big)\\text{d}t \\cr &\\quad = 2kt^3 + \\dfrac{4}{3}t^2 - 2t + D \\end{aligned}Since $x_Q(0) = 0$, $D = 0$.",
        "At $A$ ($t = 3\\text{ s}$, $x_Q = 36\\text{ m}$):\\begin{aligned} &36 = 2k(3)^3 + \\dfrac{4}{3}(3)^2 - 2(3) \\cr &36 = 54k + 12 - 6 \\cr &36 = 54k + 6 \\cr &30 = 54k \\cr &k \\cr &\\quad = \\dfrac{30}{54} \\cr &\\quad = \\dfrac{5}{9} \\end{aligned}Substitute $k = \\dfrac{5}{9}$ into $v_Q(t)$:\\begin{aligned} &v_Q(t) \\cr &\\quad = 6\\big(\\dfrac{5}{9}\\big)t^2 + \\dfrac{8}{3}t - 2 \\cr &\\quad = \\dfrac{10}{3}t^2 + \\dfrac{8}{3}t - 2 \\end{aligned}At $t = 3\\text{ s}$:\\begin{aligned} &v_Q(3) \\cr &\\quad = \\dfrac{10}{3}(3)^2 + \\dfrac{8}{3}(3) - 2 \\cr &\\quad = 30 + 8 - 2 \\cr &\\quad = 36\\text{ m s}^{-1} \\end{aligned}",
        "Final Answer: $a = \\dfrac{8}{3}\\text{ m s}^{-2}, \\text{velocity} = 36\\text{ m s}^{-1}$"
    ],
    "pi_options": [
        {
    ...
    "bradley_insight": {
        ...
        "content": "When dealing with fractional accelerations (such as $a = \\dfrac{8}{3}\\text{ m s}^{-2}$), avoid rounding to decimals like $2.67\\text{ m s}^{-2}$ early in your working. Keeping terms in exact fractional form prevents rounding propagation errors and ensures that subsequent integrations and constants resolve to beautifully clean, exact integer results (like $k = \\dfrac{5}{9}$ and $v_Q(3) = 36\\text{ m s}^{-1}$)."
    }
}
