window.ALEVEL_QUESTIONS = [
        ...
        "steps": [
            ...
            "Substitute $x = 2$ into the expression for $\\text{f}(x)$:<br>\\begin{aligned} \\text{f}(2) = 2(2)^3 - k(2)^2 + 5(2) + 3k \\end{aligned}",
    ...
    },
    {
        ...
        "steps": [
            "According to the <strong>Factor Theorem</strong>, if $(x + 2)$ is a factor of $\\text{f}(x)$, then evaluating the polynomial at $x = -2$ must equal zero: $\\text{f}(-2) = 0$.",
            "Substitute $x = -2$ into the expression for $\\text{f}(x)$:<br>\\begin{aligned} \\text{f}(-2) = 4(-2)^3 + a(-2)^2 - 7(-2) + 2a \\end{aligned}",
    ...
    },
    {
        ...
        "steps": [
            ...
            "Substitute $x = 1$ into the expression for $\\text{f}(x)$:<br>\\begin{aligned} \\text{f}(1) = 3(1)^3 - 2k(1)^2 + 5(1) + 4k \\end{aligned}",
            "Simplifying the powers and combining terms gives:<br>\\begin{aligned} \\text{f}(1) = 3 - 2k + 5 + 4k \\end{aligned}",
    ...
    },
    {
        ...
        "steps": [
            ...
            "Substitute $x = 3$ into the expression for $\\text{f}(x)$:<br>\\begin{aligned} \\text{f}(3) = 2(3)^3 - a(3)^2 - 8(3) + 3a \\end{aligned}",
    ...
    },
    {
        ...
        "steps": [
            "According to the <strong>Factor Theorem</strong>, if $(x + 3)$ is a factor of $\\text{f}(x)$, then evaluating the polynomial at $x = -3$ must equal zero: $\\text{f}(-3) = 0$.",
            "Substitute $x = -3$ into the expression for $\\text{f}(x)$:<br>\\begin{aligned} \\text{f}(-3) = 2(-3)^3 + 3p(-3)^2 - 2(-3) - 3p \\end{aligned}",
