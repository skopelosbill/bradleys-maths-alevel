window.ALEVEL_QUESTIONS = [
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>Solve the inequality:\\begin{aligned} |3x - 1| \\le 8 \\end{aligned}",
                "steps": [
                        "Rewrite the absolute value inequality as a continuous double inequality to remove the modulus:\\begin{aligned} &|3x - 1| \\le 8 \\cr &\\implies -8 \\le 3x - 1 \\le 8 \\end{aligned}",
                        "Solve the left-hand inequality to find the lower bound for $x$:\\begin{aligned} -8 &\\le 3x - 1 \\cr -7 &\\le 3x \\cr x &\\ge -\\dfrac{7}{3} \\end{aligned}",
                        "Solve the right-hand inequality to find the upper bound for $x$:\\begin{aligned} 3x - 1 &\\le 8 \\cr 3x &\\le 9 \\cr x &\\le 3 \\end{aligned}",
                        "Combine the lower and upper bounds to write the final interval for $x$:\\begin{aligned} -\\dfrac{7}{3} \\le x \\le 3 \\end{aligned}",
                        "Final Answer: \\begin{aligned} -\\dfrac{7}{3} \\le x \\le 3 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} x \\le -\\dfrac{7}{3} \\quad \\text{or} \\quad x \\ge 3 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} -\\dfrac{7}{3} \\le x \\le \\dfrac{7}{3} \\end{aligned}",
                                "feedback": "Check your calculations for the upper bound. When solving $3x - 1 \\le 8$, adding $1$ to both sides gives $3x \\le 9$, which leads to $x \\le 3$, not $x \\le \\dfrac{7}{3}$."
                        },
                        {
                                "ans": "\\begin{aligned} -3 \\le x \\le 3 \\end{aligned}",
                                "feedback": "Check your lower bound calculation. When solving $-8 \\le 3x - 1$, adding $1$ to both sides gives $-7 \\le 3x$, which leads to $x \\ge -\\dfrac{7}{3}$, not $x \\ge -3$."
                        }
                ],
                "bradley_insight": {
                        "type": "pro-tip",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>Solve the inequality:\\begin{aligned} |2x + 3| > 7 \\end{aligned}",
                "steps": [
                        "An inequality of the form $|A| > k$ (where $k > 0$) splits into two separate, disjoint linear cases:\\begin{aligned} 2x + 3 &> 7 \\cr \\text{or} \\quad 2x + 3 &< -7 \\end{aligned}",
                        "Solve the first case, which represents the positive outer region:\\begin{aligned} 2x + 3 &> 7 \\cr 2x &> 4 \\cr x &> 2 \\end{aligned}",
                        "Solve the second case, which represents the negative outer region:\\begin{aligned} 2x + 3 &< -7 \\cr 2x &< -10 \\cr x &< -5 \\end{aligned}",
                        "Combine the two disjoint intervals with 'or' to write the final solution:\\begin{aligned} x < -5 \\quad \\text{or} \\quad x > 2 \\end{aligned}",
                        "Final Answer: \\begin{aligned} x < -5 \\quad \\text{or} \\quad x > 2 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} -5 < x < 2 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} x < -2 \\quad \\text{or} \\quad x > 2 \\end{aligned}",
                                "feedback": "Check your calculations for the negative case. When solving $2x + 3 < -7$, subtracting $3$ from both sides gives $2x < -10$, leading to $x < -5$, not $x < -2$."
                        },
                        {
                                "ans": "\\begin{aligned} x < -5 \\quad \\text{or} \\quad x > 5 \\end{aligned}",
                                "feedback": "Check your calculations for the positive case. When solving $2x + 3 > 7$, subtracting $3$ from both sides gives $2x > 4$, leading to $x > 2$, not $x > 5$."
                        }
                ],
                "bradley_insight": {
                        "type": "pro-tip",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>Solve the inequality:\\begin{aligned} |x - 2| \\le |2x + 1| \\end{aligned}",
                "steps": [
                ...
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} -3 \\le x \\le \\dfrac{1}{3} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} x \\le -\\dfrac{1}{3} \\quad \\text{or} \\quad x \\ge 3 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} x \\le -3 \\quad \\text{or} \\quad x \\ge 3 \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>Solve the inequality:\\begin{aligned} \\dfrac{6}{x - 2} \\le 3 \\end{aligned}",
                "steps": [
                        "First, identify that $x = 2$ is an asymptote where the expression is undefined, so $x \\ne 2$. Bring all terms to the left-hand side:\\begin{aligned} \\dfrac{6}{x - 2} - 3 \\le 0 \\end{aligned}",
                        "Combine the terms over a common denominator to form a single fraction:\\begin{aligned} \\dfrac{6 - 3(x - 2)}{x - 2} &\\le 0 \\cr \\dfrac{6 - 3x + 6}{x - 2} &\\le 0 \\cr \\dfrac{12 - 3x}{x - 2} &\\le 0 \\end{aligned}",
                        "Factorise out the negative multiplier in the numerator to simplify the signs:\\begin{aligned} \\dfrac{-3(x - 4)}{x - 2} \\le 0 \\end{aligned}",
                        "Divide both sides by the negative constant $-3$, remembering that dividing by a negative number reverses the direction of the inequality:\\begin{aligned} \\dfrac{x - 4}{x - 2} \\ge 0 \\end{aligned}",
                        "Identify the critical values of this inequality:<br><br>• $x = 4$ (where the numerator is zero, which is included because of $\\ge$).<br>• $x = 2$ (where the denominator is zero, which is strictly excluded as it is undefined).",
                        "Analyse the signs of the fraction over the three regions created by these critical values:<br><br>• For $x < 2$: both $(x-4)$ and $(x-2)$ are negative, so their quotient is positive (satisfies $\\ge 0$).<br>• For $2 < x < 4$: $(x-4)$ is negative and $(x-2)$ is positive, so their quotient is negative (does not satisfy).<br>• For $x \\ge 4$: both terms are non-negative, so their quotient is positive (satisfies).<br><br>This gives the final solution set:\\begin{aligned} x < 2 \\quad \\text{or} \\quad x \\ge 4 \\end{aligned}",
                        "Final Answer: \\begin{aligned} x < 2 \\quad \\text{or} \\quad x \\ge 4 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} 2 < x \\le 4 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} x \\le 2 \\quad \\text{or} \\quad x \\ge 4 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} x \\le 4 \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>Solve the inequality:\\begin{aligned} |x^2 - 5| < 4 \\end{aligned}",
                "steps": [
                        "Rewrite the absolute value inequality as a continuous double inequality to remove the modulus:\\begin{aligned} -4 < x^2 - 5 < 4 \\end{aligned}",
                        "Solve the left-hand inequality to establish the first condition:\\begin{aligned} -4 &< x^2 - 5 \\cr 1 &< x^2 \\cr x^2 &> 1 \\cr \\implies x &< -1 \\quad \\text{or} \\quad x > 1 \\end{aligned}",
                        "Solve the right-hand inequality to establish the second condition:\\begin{aligned} x^2 - 5 &< 4 \\cr x^2 &< 9 \\cr \\implies -3 &< x < 3 \\end{aligned}",
                        "Intersect the two sets of intervals to find the values of $x$ that satisfy both conditions simultaneously:<br><br>• For the negative branch ($x < -1$) intersected with $-3 < x < 3$:\\begin{aligned} -3 < x < -1 \\end{aligned}• For the positive branch ($x > 1$) intersected with $-3 < x < 3$:\\begin{aligned} 1 < x < 3 \\end{aligned}Combine these two disjoint intervals to write the final solution:\\begin{aligned} -3 < x < -1 \\quad \\text{or} \\quad 1 < x < 3 \\end{aligned}",
                        "Final Answer: \\begin{aligned} -3 < x < -1 \\quad \\text{or} \\quad 1 < x < 3 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} x < -3 \\quad \\text{or} \\quad x > 3 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} -1 < x < 1 \\quad \\text{or} \\quad -3 < x < 3 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} 1 < x < 3 \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>The equation of a curve is given by:$$x^2 - xy^2 + y^3 = 13$$1. Find the coordinates of the points where the curve intersects the line $y = 2$.<br><br>2. Find the gradient of the curve at each of these points.",
    "steps": [
      "To find the points of intersection with the line $y = 2$, substitute $y = 2$ into the curve's equation:\\begin{aligned} x^2 - x(2)^2 + (2)^3 &= 13 \\cr x^2 - 4x + 8 &= 13 \\cr x^2 - 4x - 5 &= 0 \\end{aligned}",
      "Factorise this quadratic equation to solve for $x$:\\begin{aligned} (x - 5)(x + 1) &= 0 \\end{aligned}This yields two solutions: $x = 5$ and $x = -1$.<br><br>Therefore, the coordinates of the two intersection points are $(5, 2)$ and $(-1, 2)$.",
      "Now, differentiate the equation of the curve implicitly with respect to $x$. Apply the product rule carefully to the term $-xy^2$:\\begin{aligned} &\\dfrac{\\text{d}}{\\text{d}x}(x^2) - \\dfrac{\\text{d}}{\\text{d}x}(xy^2) + \\dfrac{\\text{d}}{\\text{d}x}(y^3) = 0 \\cr &2x - \\left( y^2 + 2xy\\dfrac{\\text{d}y}{\\text{d}x} \\right) + 3y^2\\dfrac{\\text{d}y}{\\text{d}x} = 0 \\cr &2x - y^2 - 2xy\\dfrac{\\text{d}y}{\\text{d}x} + 3y^2\\dfrac{\\text{d}y}{\\text{d}x} = 0 \\end{aligned}",
      "Rearrange the differentiated terms to isolate and make $\\dfrac{\\text{d}y}{\\text{d}x}$ the subject:\\begin{aligned} &\\left(3y^2 - 2xy\\right)\\dfrac{\\text{d}y}{\\text{d}x} = y^2 - 2x \\cr &\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{y^2 - 2x}{3y^2 - 2xy} \\end{aligned}",
      "To find the gradient of the curve at the first intersection point $(5, 2)$, substitute $x = 5$ and $y = 2$ into the derivative:\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{(2)^2 - 2(5)}{3(2)^2 - 2(5)(2)} \\cr &= \\dfrac{4 - 10}{12 - 20} \\cr &= \\dfrac{-6}{-8} \\cr &= \\dfrac{3}{4} \\end{aligned}",
      "To find the gradient of the curve at the second intersection point $(-1, 2)$, substitute $x = -1$ and $y = 2$ into the derivative:\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{(2)^2 - 2(-1)}{3(2)^2 - 2(-1)(2)} \\cr &= \\dfrac{4 + 2}{12 + 4} \\cr &= \\dfrac{6}{16} \\cr &= \\dfrac{3}{8} \\end{aligned}",
      "Final Answer: \\begin{aligned} &(5, 2) \\text{ with gradient } \\dfrac{3}{4} \\cr &(-1, 2) \\text{ with gradient } \\dfrac{3}{8} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &(5, 2) \\text{ with gradient } -\\dfrac{3}{16} \\cr &(-1, 2) \\text{ with gradient } \\dfrac{3}{4} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(5, 2) \\text{ with gradient } -3 \\cr &(-1, 2) \\text{ with gradient } \\dfrac{3}{7} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(5, 2) \\text{ with gradient } \\dfrac{3}{4} \\cr &(1, 2) \\text{ with gradient } \\dfrac{1}{4} \\end{aligned}",
    ...
    "bradley_insight": {
      ...
      "content": "A very common error in implicit differentiation occurs when applying the product rule to terms with negative coefficients, such as $-xy^2$. Ensure you treat the entire product within a bracket to avoid sign distribution slips, as $\\dfrac{\\text{d}}{\\text{d}x}(-xy^2) = -\\left(y^2 + 2xy \\dfrac{\\text{d}y}{\\text{d}x}\\right)$, which expands to $-y^2 - 2xy \\dfrac{\\text{d}y}{\\text{d}x}$."
    }
  },
  {
    "id": "004277",
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>A curve has the equation:$$y\\text{e}^{2x} + y^2\\text{e}^x = 6$$1. Show that there is exactly one point on the curve where $y = 1$, and find its exact $x$-coordinate in terms of a natural logarithm.<br><br>2. Find the exact gradient of the curve at this point.",
    "steps": [
      "To find any coordinates where $y = 1$, substitute $y = 1$ into the curve's equation:\\begin{aligned} (1)\\text{e}^{2x} + (1)^2\\text{e}^x &= 6 \\cr \\text{e}^{2x} + \\text{e}^x - 6 &= 0 \\end{aligned}",
      "This is a quadratic equation in terms of $\\text{e}^x$. Let $u = \\text{e}^x$, where $u > 0$ because exponential outputs are strictly positive:\\begin{aligned} u^2 + u - 6 &= 0 \\cr (u + 3)(u - 2) &= 0 \\end{aligned}This gives two mathematical solutions: $u = -3$ and $u = 2$.",
      "Since $u = \\text{e}^x > 0$, we must discard the negative root $u = -3$. Thus, the only valid solution is:\\begin{aligned} \\text{e}^x &= 2 \\cr x &= \\ln 2 \\end{aligned}So, there is exactly one point on the curve where $y = 1$, which is $(\\ln 2, 1)$.",
      "Next, differentiate the curve's equation implicitly with respect to $x$, applying the product rule to both $y\\text{e}^{2x}$ and $y^2\\text{e}^x$:\\begin{aligned} &\\left( \\text{e}^{2x}\\dfrac{\\text{d}y}{\\text{d}x} + 2y\\text{e}^{2x} \\right) \\cr &\\quad + \\left( 2y\\text{e}^x\\dfrac{\\text{d}y}{\\text{d}x} + y^2\\text{e}^x \\right) = 0 \\end{aligned}",
      "Isolate $\\dfrac{\\text{d}y}{\\text{d}x}$ by grouping the derivative terms together:\\begin{aligned} &\\left(\\text{e}^{2x} + 2y\\text{e}^x\\right)\\dfrac{\\text{d}y}{\\text{d}x} \\cr &\\quad = -2y\\text{e}^{2x} - y^2\\text{e}^x \\cr &\\dfrac{\\text{d}y}{\\text{d}x} = -\\dfrac{2y\\text{e}^{2x} + y^2\\text{e}^x}{\\text{e}^{2x} + 2y\\text{e}^x} \\end{aligned}",
      "To find the exact gradient at $(\\ln 2, 1)$, substitute $y = 1$, $\\text{e}^x = 2$, and $\\text{e}^{2x} = 4$ into the derivative expression:\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= -\\dfrac{2(1)(4) + (1)^2(2)}{4 + 2(1)(2)} \\cr &= -\\dfrac{8 + 2}{4 + 4} \\cr &= -\\dfrac{10}{8} \\cr &= -\\dfrac{5}{4} \\end{aligned}",
      "Final Answer: \\begin{aligned} &(\\ln 2, 1) \\cr &\\text{Gradient} = -\\dfrac{5}{4} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &x = \\ln 2 \\text{ and } x = \\ln 3 \\cr &\\text{Gradient} = -\\dfrac{5}{4} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &x = \\ln 2 \\cr &\\text{Gradient} = -1 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &x = \\ln 2 \\cr &\\text{Gradient} = -\\dfrac{3}{4} \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      "Differentiate each term of the curve's equation implicitly with respect to $x$, using the product rule for $-2xy$:\\begin{aligned} &\\dfrac{\\text{d}}{\\text{d}x}(x^2) - \\dfrac{\\text{d}}{\\text{d}x}(2xy) + \\dfrac{\\text{d}}{\\text{d}x}(3y^2) = 0 \\cr &2x - 2\\left( y + x\\dfrac{\\text{d}y}{\\text{d}x} \\right) + 6y\\dfrac{\\text{d}y}{\\text{d}x} = 0 \\cr &2x - 2y - 2x\\dfrac{\\text{d}y}{\\text{d}x} + 6y\\dfrac{\\text{d}y}{\\text{d}x} = 0 \\end{aligned}",
      "Group the $\\dfrac{\\text{d}y}{\\text{d}x}$ terms together and make it the subject of the formula:\\begin{aligned} &\\left(6y - 2x\\right)\\dfrac{\\text{d}y}{\\text{d}x} = 2y - 2x \\cr &\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{2y - 2x}{6y - 2x} \\end{aligned}Factor out and divide by 2 to simplify:\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{y - x}{3y - x} \\end{aligned}",
      "A tangent parallel to the $x$-axis is a horizontal tangent, which occurs where the gradient is zero:\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= 0 \\cr \\dfrac{y - x}{3y - x} &= 0 \\cr y - x &= 0 \\cr y &= x \\end{aligned}",
      "Substitute $y = x$ back into the original curve's equation to find the corresponding coordinates:\\begin{aligned} x^2 - 2x(x) + 3(x)^2 &= 8 \\cr x^2 - 2x^2 + 3x^2 &= 8 \\cr 2x^2 &= 8 \\cr x^2 &= 4 \\end{aligned}This gives $x = 2$ or $x = -2$.",
      "Since $y = x$, the points corresponding to these $x$-values are:\\begin{aligned} x = 2 &\\implies y = 2 \\cr x = -2 &\\implies y = -2 \\end{aligned}Thus, the coordinates of the points with horizontal tangents are $(2, 2)$ and $(-2, -2)$.",
      "Final Answer: \\begin{aligned} &(2, 2) \\cr &(-2, -2) \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\left(2\\sqrt{3}, \\dfrac{2\\sqrt{3}}{3}\\right) \\cr &\\left(-2\\sqrt{3}, -\\dfrac{2\\sqrt{3}}{3}\\right) \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\left(\\dfrac{2\\sqrt{3}}{3}, -\\dfrac{2\\sqrt{3}}{3}\\right) \\cr &\\left(-\\dfrac{2\\sqrt{3}}{3}, \\dfrac{2\\sqrt{3}}{3}\\right) \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(\\sqrt{2}, \\sqrt{2}) \\cr &(-\\sqrt{2}, -\\sqrt{2}) \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Set up the equation of the normal line using the point-gradient formula $y - y_1 = m(x - x_1)$ at $P(1, 2)$:\\begin{aligned} y - 2 &= \\dfrac{16}{5}(x - 1) \\end{aligned}Multiply the entire equation by 5 to remove fractions, then rearrange into the form $ax + by + c = 0$:\\begin{aligned} 5y - 10 &= 16x - 16 \\cr 16x - 5y - 6 &= 0 \\end{aligned}",
      "Final Answer: $$16x - 5y - 6 = 0$$"
    ],
    "pi_options": [
      {
        "ans": "$$5x + 16y - 37 = 0$$",
        "feedback": "This is the equation of the tangent line. Remember that the normal line is perpendicular to the tangent, so its gradient is the negative reciprocal of the tangent's gradient: $m_{\\text{normal}} = \\dfrac{16}{5}$."
      },
      {
        "ans": "$$16x - 5y - 14 = 0$$",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>The equation of a curve is:$$2x^3 + y^3 = 6y$$1. Show that the derivative of the curve is given by:$$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{2x^2}{2 - y^2}$$2. Find the exact coordinates of the points on the curve where the tangent is parallel to the $y$-axis.",
    "steps": [
      "Differentiate each term of the curve's equation implicitly with respect to $x$:\\begin{aligned} \\dfrac{\\text{d}}{\\text{d}x}(2x^3) + \\dfrac{\\text{d}}{\\text{d}x}(y^3) &= \\dfrac{\\text{d}}{\\text{d}x}(6y) \\cr 6x^2 + 3y^2\\dfrac{\\text{d}y}{\\text{d}x} &= 6\\dfrac{\\text{d}y}{\\text{d}x} \\end{aligned}",
      "Group the $\\dfrac{\\text{d}y}{\\text{d}x}$ terms together on one side to solve for the derivative:\\begin{aligned} 6\\dfrac{\\text{d}y}{\\text{d}x} - 3y^2\\dfrac{\\text{d}y}{\\text{d}x} &= 6x^2 \\cr \\left(6 - 3y^2\\right)\\dfrac{\\text{d}y}{\\text{d}x} &= 6x^2 \\cr \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{6x^2}{6 - 3y^2} \\end{aligned}Divide the numerator and denominator by 3 to simplify:\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{2x^2}{2 - y^2} \\end{aligned}",
      "A tangent line parallel to the $y$-axis is a vertical tangent. This occurs where the gradient $\\dfrac{\\text{d}y}{\\text{d}x}$ is undefined, which means setting the denominator to zero:\\begin{aligned} 2 - y^2 &= 0 \\cr y^2 &= 2 \\cr y &= \\pm\\sqrt{2} \\end{aligned}",
      "To find the $x$-coordinates, substitute $y = \\sqrt{2}$ and $y = -\\sqrt{2}$ back into the original curve's equation.<br><br>Case 1: Substitute $y = \\sqrt{2}$:\\begin{aligned} 2x^3 + (\\sqrt{2})^3 &= 6(\\sqrt{2}) \\cr 2x^3 + 2\\sqrt{2} &= 6\\sqrt{2} \\cr 2x^3 &= 4\\sqrt{2} \\cr x^3 &= 2\\sqrt{2} \\end{aligned}",
      "Solve for $x$ by rewriting the term as an index power: $2\\sqrt{2} = (\\sqrt{2})^3$. Taking the cube root gives:\\begin{aligned} x &= \\sqrt{2} \\end{aligned}This gives our first point of vertical tangency: $(\\sqrt{2}, \\sqrt{2})$.",
      "Case 2: Substitute $y = -\\sqrt{2}$ into the curve's equation:\\begin{aligned} 2x^3 + (-\\sqrt{2})^3 &= 6(-\\sqrt{2}) \\cr 2x^3 - 2\\sqrt{2} &= -6\\sqrt{2} \\cr 2x^3 &= -4\\sqrt{2} \\cr x^3 &= -2\\sqrt{2} \\end{aligned}Taking the cube root gives:\\begin{aligned} x &= -\\sqrt{2} \\end{aligned}This gives our second point of vertical tangency: $(-\\sqrt{2}, -\\sqrt{2})$.",
      "Final Answer: \\begin{aligned} &(\\sqrt{2}, \\sqrt{2}) \\cr &(-\\sqrt{2}, -\\sqrt{2}) \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &(2, \\sqrt{2}) \\cr &(-2, -\\sqrt{2}) \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(0, 0) \\cr &(0, \\sqrt{6}) \\cr &(0, -\\sqrt{6}) \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(\\sqrt{2}, -\\sqrt{2}) \\cr &(-\\sqrt{2}, \\sqrt{2}) \\end{aligned}",
        "feedback": "Check your sign evaluation during the substitution step. Substituting $y = -\\sqrt{2}$ into $2x^3 + y^3 = 6y$ yields $2x^3 - 2\\sqrt{2} = -6\\sqrt{2}$. This leads to $2x^3 = -4\\sqrt{2}$, so $x = -\\sqrt{2}$. It seems you made a sign error, resulting in a mixed sign point."
      }
    ],
    "bradley_insight": {
      "type": "pro-tip",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>An A-Level Chemistry student, Bethany, records her score $s$ (out of 100) on a weekly practice quiz against $t$ hours of active preparation.<br><br>Over the course of a term, she notices that her score can be modeled by the quadratic formula:$$s = P - Q(t - R)^2, \\quad t \\ge 0$$where $P$, $Q$, and $R$ are positive constants.<br><br><ul><li>Bethany finds that her maximum score of $80$ is achieved when she spends exactly $3$ hours preparing.</li><li>On a week where she spent no time preparing ($t = 0$), she scored $35$.</li></ul><br><br>1. Find the values of the constants $P$, $Q$, and $R$.<br><br>2. According to this model, if Bethany prepares for $1$ hour and $30$ minutes, what score will she achieve?<br><br>3. Find the maximum amount of time that Bethany could have spent preparing for this quadratic model to remain valid (i.e., for $s \\ge 0$).<br><br>To improve her scores further, Bethany adopts a new study strategy using spaced repetition over several days. She proposes a new exponential model for her quiz score, $s$, after $t$ hours of spaced repetition:$$s = 35 + 55\\left(1 - \\text{e}^{-0.5t}\\right)$$For the next three quizzes, she records her study times and quiz results in the table below:<br><br><table style='width:60%; margin: 10px auto; border-collapse: collapse; text-align: center; border: 1px solid #ccc;'><tr style='border-bottom: 1px solid #ccc; background-color: #f9f9f9;'><th style='padding: 8px;'>$t$ (hours)</th><td style='padding: 8px;'>$2$</td><td style='padding: 8px;'>$4$</td><td style='padding: 8px;'>$6$</td></tr><tr><th style='padding: 8px;'>$s$ (score)</th><td style='padding: 8px;'>$70$</td><td style='padding: 8px;'>$83$</td><td style='padding: 8px;'>$87$</td></tr></table><br><br>4. Verify that Bethany's recorded data is consistent with her new exponential model.<br><br>5. Bethany's teacher advises her to spend at least $15$ hours preparing in future. By considering the limiting value of her score as $t$ becomes very large, determine whether this is good advice.",
    "steps": [
      "For a quadratic model of the form $s = P - Q(t - R)^2$, the vertex represents the maximum value. The maximum occurs at $t = R$ with value $s = P$.<br><br>Comparing this to the given information:\\begin{aligned} R &= 3 \\cr P &= 80 \\end{aligned}",
      "Substitute these values and the boundary point $(t, s) = (0, 35)$ into the quadratic equation to solve for $Q$:\\begin{aligned} 35 &= 80 - Q(0 - 3)^2 \\cr 35 &= 80 - 9Q \\cr 9Q &= 45 \\cr Q &= 5 \\end{aligned}Thus, the constants are $P = 80$, $Q = 5$, and $R = 3$, giving the model equation:$$s = 80 - 5(t - 3)^2$$",
      "To find the predicted score for $1$ hour and $30$ minutes, convert the time to hours ($t = 1.5$) and substitute it into the quadratic model:\\begin{aligned} s &= 80 - 5(1.5 - 3)^2 \\cr &= 80 - 5(-1.5)^2 \\cr &= 80 - 5(2.25) \\cr &= 80 - 11.25 \\cr &= 68.75 \\end{aligned}Bethany's predicted score is $68.75$.",
    ...
    "pi_options": [
      {
        "ans": "\\begin{aligned} &P = 80, \\; Q = 5, \\; R = 3 \\cr &t = 1.5 \\implies s = 77.5 \\cr &\\text{Max validity time} = 7 \\text{ hours} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &P = 80, \\; Q = 5, \\; R = 3 \\cr &t = 1.5 \\implies s = 68.75 \\cr &\\text{Max validity time} = 19 \\text{ hours} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &P = 35, \\; Q = 5, \\; R = 3 \\cr &t = 1.5 \\implies s = 23.75 \\cr &\\text{Max validity time} = 7 \\text{ hours} \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      ...
      "To find the stationary points, set the derivative to $0$ and solve for $x$:\\begin{aligned} 3x^2 - 18x + 24 &= 0 \\cr x^2 - 6x + 8 &= 0 \\cr (x - 2)(x - 4) &= 0 \\end{aligned}This yields two stationary production levels: $x = 2$ and $x = 4$.",
      "Determine the nature of the stationary points using the second derivative:\\begin{aligned} \\dfrac{\\text{d}^2C}{\\text{d}x^2} &= 6x - 18 \\end{aligned}Evaluate this at each stationary point:<ul><li>At $x = 2$: $\\dfrac{\\text{d}^2C}{\\text{d}x^2} = -6 < 0$ (Local Maximum)</li><li>At $x = 4$: $\\dfrac{\\text{d}^2C}{\\text{d}x^2} = 6 > 0$ (Local Minimum)</li></ul>",
      "To find the minimum operating cost when actively producing components ($x > 0$), evaluate the cost function at the local minimum $x = 4$:\\begin{aligned} C(4) &= (4)^3 - 9(4)^2 + 24(4) + 10 \\cr &= 64 - 144 + 96 + 10 \\cr &= 26 \\end{aligned}Since $C = 26$ represents hundreds of pounds, the minimum daily operating cost during active production is $26 \\times 100 = £2,600$.",
      "Final Answer: \\begin{aligned} &\\text{Initial cost} = £1,000 \\cr &x = 2 \\text{ (local max)} \\cr &x = 4 \\text{ (local min)} \\cr &\\text{Minimum active cost} = £2,600 \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{Initial cost} = £10 \\cr &x = 2 \\text{ (max)}, \\; x = 4 \\text{ (min)} \\cr &\\text{Minimum cost} = £26 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Initial cost} = £1,000 \\cr &x = 2 \\text{ (min)}, \\; x = 4 \\text{ (max)} \\cr &\\text{Minimum cost} = £3,000 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Initial cost} = £1,000 \\cr &x = 3, \\; x = 8 \\cr &\\text{Minimum cost} = £2,600 \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      ...
      "To find the temperature after $20$ minutes, substitute $t = 20$ into the model. Since $\\text{e}^{-10k} = \\dfrac{7}{13}$, write the exponential term as a power of this known constant:\\begin{aligned} \\theta(20) &= 20 + 65\\text{e}^{-20k} \\cr &= 20 + 65\\left(\\text{e}^{-10k}\\right)^2 \\cr &= 20 + 65\\left(\\dfrac{7}{13}\\right)^2 \\cr &= 20 + 65\\left(\\dfrac{49}{169}\\right) \\end{aligned}",
      "Simplify this fraction to find the exact temperature after 20 minutes:\\begin{aligned} \\theta(20) &= 20 + 5\\left(\\dfrac{49}{13}\\right) \\cr &= 20 + \\dfrac{245}{13} \\cr &= \\dfrac{260}{13} + \\dfrac{245}{13} \\cr &= \\dfrac{505}{13} \\cr &\\approx 38.8^\\circ\\text{C} \\end{aligned}",
      "To find when the coffee cools to $35^\\circ\\text{C}$, set $\\theta = 35$ and solve for $t$:\\begin{aligned} 35 &= 20 + 65\\text{e}^{-kt} \\cr 15 &= 65\\text{e}^{-kt} \\cr \\dfrac{3}{13} &= \\text{e}^{-kt} \\cr \\ln\\left(\\dfrac{3}{13}\\right) &= -kt \\cr t &= -\\dfrac{1}{k}\\ln\\left(\\dfrac{3}{13}\\right) \\cr t &= \\dfrac{1}{k}\\ln\\left(\\dfrac{13}{3}\\right) \\end{aligned}",
      "Substitute the exact value $k = \\dfrac{1}{10}\\ln\\left(\\dfrac{13}{7}\\right)$ to compute $t$:\\begin{aligned} t &= \\dfrac{10\\ln\\left(\\dfrac{13}{3}\\right)}{\\ln\\left(\\dfrac{13}{7}\\right)} \\cr &\\approx \\dfrac{10 \\times 1.4663}{0.6190} \\cr &\\approx 24.368 \\cr &\\approx 24.4 \\text{ minutes} \\end{aligned}",
      "Final Answer: \\begin{aligned} &k = \\dfrac{1}{10}\\ln\\left(\\dfrac{13}{7}\\right) \\cr &\\theta(20) = \\dfrac{505}{13}^\\circ\\text{C} \\approx 38.8^\\circ\\text{C} \\cr &t = 24.4 \\text{ minutes} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &k = -\\dfrac{1}{10}\\ln\\left(\\dfrac{13}{7}\\right) \\cr &\\theta(20) = 38.8^\\circ\\text{C} \\cr &t = 24.4 \\text{ minutes} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &k = \\dfrac{1}{10}\\ln\\left(\\dfrac{13}{7}\\right) \\cr &\\theta(20) = 45.2^\\circ\\text{C} \\cr &t = 24.4 \\text{ minutes} \\end{aligned}",
        "feedback": "Check your calculation for $\\theta(20)$. Make sure you square the exponential base $\\text{e}^{-10k} = \\dfrac{7}{13}$, since $\\text{e}^{-20k} = \\left(\\text{e}^{-10k}\\right)^2$, which equals $\\dfrac{49}{169}$. It appears you may have multiplied by $\\dfrac{7}{13}$ directly without squaring."
      },
      {
        "ans": "\\begin{aligned} &k = \\dfrac{1}{10}\\ln\\left(\\dfrac{13}{7}\\right) \\cr &\\theta(20) = 38.8^\\circ\\text{C} \\cr &t = 14.7 \\text{ minutes} \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>The population, $P$, of a rare species of bird introduced to a nature reserve $t$ years after introduction is modeled by the formula:$$P = \\dfrac{1200}{1 + 5\\text{e}^{-0.4t}}, \\quad t \\ge 0$$1. Find the initial population of birds introduced to the reserve.<br><br>2. Show that after $5$ years, the bird population is approximately $715$ birds.<br><br>3. State the limiting value of the bird population as $t$ becomes very large, and explain briefly what this represents physically.<br><br>4. Calculate the time, $t$, at which the bird population reaches $1000$. Give your answer to $1$ decimal place.",
    "steps": [
      "To find the initial population, substitute $t = 0$ into the logistic formula:\\begin{aligned} P(0) &= \\dfrac{1200}{1 + 5\\text{e}^{0}} \\cr &= \\dfrac{1200}{1 + 5(1)} \\cr &= \\dfrac{1200}{6} \\cr &= 200 \\end{aligned}The initial population introduced is $200$ birds.",
      "To find the population after $5$ years, substitute $t = 5$:\\begin{aligned} P(5) &= \\dfrac{1200}{1 + 5\\text{e}^{-0.4(5)}} \\cr &= \\dfrac{1200}{1 + 5\\text{e}^{-2}} \\end{aligned}",
      "Use the approximation $\\text{e}^{-2} \\approx 0.1353$ to evaluate the expression:\\begin{aligned} P(5) &\\approx \\dfrac{1200}{1 + 5(0.1353)} \\cr &\\approx \\dfrac{1200}{1 + 0.6765} \\cr &\\approx \\dfrac{1200}{1.6765} \\cr &\\approx 715.78 \\end{aligned}Rounding to the nearest whole number gives $716$ birds, which is approximately $715$ birds.",
      "Find the limiting value of $P$ as $t \\to \\infty$. As $t$ becomes very large, the term $\\text{e}^{-0.4t}$ approaches $0$:\\begin{aligned} \\lim_{t \\to \\infty} P &= \\dfrac{1200}{1 + 5(0)} \\cr &= \\dfrac{1200}{1} \\cr &= 1200 \\end{aligned}In a physical context, this carrying capacity of $1,200$ represents the maximum sustainable population of this bird species that the reserve's resources can support.",
      "To find when the population reaches $1000$ birds, set $P = 1000$ and solve for $t$:\\begin{aligned} 1000 &= \\dfrac{1200}{1 + 5\\text{e}^{-0.4t}} \\cr 1 + 5\\text{e}^{-0.4t} &= \\dfrac{1200}{1000} \\cr 1 + 5\\text{e}^{-0.4t} &= 1.2 \\cr 5\\text{e}^{-0.4t} &= 0.2 \\cr \\text{e}^{-0.4t} &= 0.04 \\end{aligned}",
      "Take natural logarithms of both sides to isolate $t$:\\begin{aligned} -0.4t &= \\ln(0.04) \\cr t &= -\\dfrac{\\ln(0.04)}{0.4} \\cr &\\approx -\\dfrac{-3.2189}{0.4} \\cr &\\approx 8.047 \\cr &\\approx 8.0 \\text{ years} \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\text{Initial population} = 200 \\cr &P(5) \\approx 715 \\text{ birds} \\cr &\\text{Carrying capacity} = 1,200 \\cr &t = 8.0 \\text{ years} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{Initial: } 240 \\cr &P(5) \\approx 715 \\cr &\\text{Limit: } 1,200 \\cr &t = 8.0 \\text{ years} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Initial: } 200 \\cr &P(5) \\approx 715 \\cr &\\text{Limit: } 1,200 \\cr &t = 3.5 \\text{ years} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Initial: } 200 \\cr &P(5) \\approx 715 \\cr &\\text{Limit: } 200 \\cr &t = 8.0 \\text{ years} \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>The height, $h$ (in metres), of a small rocket launched vertically from a platform $t$ seconds after launch is modeled by the quadratic function:$$h = h_0 + ut - 5t^2, \\quad t \\ge 0$$where $h_0$ is the launch height of the platform and $u$ is the initial vertical velocity.<br><br><ul><li>The launch platform has a height of $15$ metres.</li><li>The rocket reaches a maximum height of $35$ metres.</li></ul><br><br>1. State the value of $h_0$, and show that the initial vertical velocity of the rocket is $u = 20\\text{ m/s}$.<br><br>2. Write down the time, $t$, at which the rocket reaches its maximum height.<br><br>3. Find the total time of the rocket's flight before it impacts the ground ($h = 0$). Give your answer in exact surd form.",
    "steps": [
      "The launch height is the height at $t = 0$. Since the platform has a height of $15$ metres:\\begin{aligned} h_0 &= 15 \\end{aligned}This gives the height function: $h = 15 + ut - 5t^2$.",
      "The maximum height of a quadratic curve of the form $h(t) = at^2 + bt + c$ occurs at its vertex, where the time is given by $t = -\\dfrac{b}{2a}$:\\begin{aligned} t_{\\text{max}} &= -\\dfrac{u}{2(-5)} \\cr &= \\dfrac{u}{10} \\end{aligned}",
      "Substitute $t = \\dfrac{u}{10}$ and $h = 35$ into the height equation to solve for the initial velocity $u$:\\begin{aligned} &35 = 15 + u\\left(\\dfrac{u}{10}\\right) \\cr &\\qquad - 5\\left(\\dfrac{u}{10}\\right)^2 \\cr &35 = 15 + \\dfrac{u^2}{10} - \\dfrac{u^2}{20} \\cr &20 = \\dfrac{u^2}{20} \\cr &u^2 = 400 \\cr &u = 20 \\end{aligned}Thus, the initial velocity is $u = 20\\text{ m/s}$ (taking the positive root for an upward launch).",
      "Now substitute $u = 20$ back into our expression for the vertex time to find when the rocket reaches its maximum height:\\begin{aligned} t_{\\text{max}} &= \\dfrac{u}{10} \\cr &= \\dfrac{20}{10} \\cr &= 2 \\text{ seconds} \\end{aligned}",
      "To find the total flight time, set the height to zero ($h = 0$) and solve the quadratic equation using the quadratic formula:\\begin{aligned} -5t^2 + 20t + 15 &= 0 \\cr 5t^2 - 20t - 15 &= 0 \\cr t^2 - 4t - 3 &= 0 \\end{aligned}",
      "Apply the quadratic formula to solve for $t$:\\begin{aligned} t &= \\dfrac{4 \\pm \\sqrt{(-4)^2 - 4(1)(-3)}}{2} \\cr &= \\dfrac{4 \\pm \\sqrt{16 + 12}}{2} \\cr &= \\dfrac{4 \\pm \\sqrt{28}}{2} \\cr &= \\dfrac{4 \\pm 2\\sqrt{7}}{2} \\cr &= 2 \\pm \\sqrt{7} \\end{aligned}Since time must be positive ($t \\ge 0$), we reject $t = 2 - \\sqrt{7} \\approx -0.65$. The total flight time of the rocket is $2 + \\sqrt{7}$ seconds.",
      "Final Answer: \\begin{aligned} &h_0 = 15 \\text{ m}, \\; u = 20\\text{ m/s} \\cr &t_{\\text{max}} = 2 \\text{ seconds} \\cr &t_{\\text{flight}} = 2 + \\sqrt{7} \\text{ seconds} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &h_0 = 15, \\; u = 20 \\cr &t_{\\text{max}} = 2 \\text{ s} \\cr &t_{\\text{flight}} = 2 + \\sqrt{13} \\text{ s} \\end{aligned}",
        "feedback": "Check your quadratic formula calculation when solving $t^2 - 4t - 3 = 0$. The discriminant is $b^2 - 4ac = (-4)^2 - 4(1)(-3)$, which equals $28$. It appears you may have made a sign error and calculated $16 - 12 = 4$ or used a different value inside the square root."
      },
      {
        "ans": "\\begin{aligned} &h_0 = 15, \\; u = 20 \\cr &t_{\\text{max}} = 4 \\text{ s} \\cr &t_{\\text{flight}} = 2 + \\sqrt{7} \\text{ s} \\end{aligned}",
        "feedback": "Check your calculation for the vertex time. The time is given by $t = \\dfrac{u}{10} = 2$ seconds. It seems you may have calculated $\\dfrac{u}{5} = 4$ seconds."
      },
      {
        "ans": "\\begin{aligned} &h_0 = 15, \\; u = 40 \\cr &t_{\\text{max}} = 2 \\text{ s} \\cr &t_{\\text{flight}} = 2 + \\sqrt{7} \\text{ s} \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>Showing all your working, simplify:<br><br>1. $$\\dfrac{60\\sqrt{b}}{(\\sqrt{b} + 5)^2 - (\\sqrt{b} - 5)^2}$$2. $$\\dfrac{5\\sqrt{6} + 2\\sqrt{2}}{\\sqrt{6} + \\sqrt{2}}$$",
    "steps": [
      "To simplify the first expression, begin by expanding the two squared binomial terms in the denominator:\\begin{aligned} (\\sqrt{b} + 5)^2 &= b + 10\\sqrt{b} + 25 \\cr (\\sqrt{b} - 5)^2 &= b - 10\\sqrt{b} + 25 \\end{aligned}",
      "Subtract the second expansion from the first to simplify the denominator:\\begin{aligned} &(\\sqrt{b} + 5)^2 - (\\sqrt{b} - 5)^2 \\cr &\\quad = (b + 10\\sqrt{b} + 25) \\cr &\\qquad - (b - 10\\sqrt{b} + 25) \\cr &\\quad = 20\\sqrt{b} \\end{aligned}",
      "Substitute this back into the original fraction and simplify:\\begin{aligned} &\\dfrac{60\\sqrt{b}}{(\\sqrt{b} + 5)^2 - (\\sqrt{b} - 5)^2} \\cr &\\quad = \\dfrac{60\\sqrt{b}}{20\\sqrt{b}} \\cr &\\quad = 3 \\end{aligned}",
      "To simplify the second expression, multiply both the numerator and the denominator by the conjugate of the denominator, which is $\\sqrt{6} - \\sqrt{2}$:\\begin{aligned} &\\dfrac{5\\sqrt{6} + 2\\sqrt{2}}{\\sqrt{6} + \\sqrt{2}} \\cr &\\quad = \\dfrac{(5\\sqrt{6} + 2\\sqrt{2})(\\sqrt{6} - \\sqrt{2})}{(\\sqrt{6} + \\sqrt{2})(\\sqrt{6} - \\sqrt{2})} \\end{aligned}",
      "Expand the numerator and denominator terms individually:\\begin{aligned} &\\text{Numerator} \\cr & \\qquad= 5(6) - 5\\sqrt{12} + 2\\sqrt{12} - 2(2) \\cr & \\qquad = 30 - 3\\sqrt{12} - 4 \\cr & \\qquad = 26 - 3(2\\sqrt{3}) \\cr & \\qquad = 26 - 6\\sqrt{3} \\cr &\\text{Denominator}\\cr &\\qquad = 6 - 2 \\cr & \\qquad = 4 \\end{aligned}",
      "Divide the expanded numerator by the expanded denominator and simplify the resulting fraction:\\begin{aligned} \\dfrac{26 - 6\\sqrt{3}}{4} &= \\dfrac{26}{4} - \\dfrac{6\\sqrt{3}}{4} \\cr &= \\dfrac{13}{2} - \\dfrac{3}{2}\\sqrt{3} \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\text{1. } 3 \\cr &\\text{2. } \\dfrac{13}{2} - \\dfrac{3}{2}\\sqrt{3} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{1. } 3 \\cr &\\text{2. } \\dfrac{1}{2} + \\dfrac{3}{2}\\sqrt{3} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{1. } \\dfrac{3}{2} \\cr &\\text{2. } \\dfrac{13}{2} - \\dfrac{3}{2}\\sqrt{3} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{1. } 3 \\cr &\\text{2. } 26 - 6\\sqrt{3} \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>Showing all your working, simplify the following expression to the form $A - B\\sqrt{5}$, where $A$ and $B$ are integers:$$(3 - 2\\sqrt{5})^2 + \\dfrac{30}{\\sqrt{5}}$$",
    "steps": [
      "First, expand the squared binomial term using double brackets:\\begin{aligned} (3 - 2\\sqrt{5})^2 &= (3 - 2\\sqrt{5})(3 - 2\\sqrt{5}) \\cr &= 9 - 6\\sqrt{5} - 6\\sqrt{5} + 20 \\cr &= 9 - 12\\sqrt{5} + 20 \\cr &= 29 - 12\\sqrt{5} \\end{aligned}",
      "Next, rationalise the denominator of the fractional term by multiplying the numerator and denominator by $\\sqrt{5}$:\\begin{aligned} \\dfrac{30}{\\sqrt{5}} &= \\dfrac{30\\sqrt{5}}{\\sqrt{5}\\sqrt{5}} \\cr &= \\dfrac{30\\sqrt{5}}{5} \\cr &= 6\\sqrt{5} \\end{aligned}",
      "Substitute both simplified parts back into the original expression and combine the terms:\\begin{aligned} &(3 - 2\\sqrt{5})^2 + \\dfrac{30}{\\sqrt{5}} \\cr &\\quad = (29 - 12\\sqrt{5}) + 6\\sqrt{5} \\cr &\\quad = 29 - 6\\sqrt{5} \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>Showing all your working, simplify the following expression, giving your answer in the form $P - \\sqrt{Q}$, where $P$ and $Q$ are integers:$$\\dfrac{3\\sqrt{2} - \\sqrt{3}}{2\\sqrt{2} + \\sqrt{3}}$$",
    "steps": [
      "To rationalise the denominator, multiply both the numerator and the denominator by the conjugate of the denominator, which is $2\\sqrt{2} - \\sqrt{3}$:\\begin{aligned} &\\dfrac{3\\sqrt{2} - \\sqrt{3}}{2\\sqrt{2} + \\sqrt{3}} \\cr &\\quad = \\dfrac{(3\\sqrt{2} - \\sqrt{3})(2\\sqrt{2} - \\sqrt{3})}{(2\\sqrt{2} + \\sqrt{3})(2\\sqrt{2} - \\sqrt{3})} \\end{aligned}",
      "Expand the denominator using the difference of two squares identity, $(a+b)(a-b) = a^2 - b^2$:\\begin{aligned} &(2\\sqrt{2} + \\sqrt{3})(2\\sqrt{2} - \\sqrt{3}) \\cr &\\quad = (2\\sqrt{2})^2 - (\\sqrt{3})^2 \\cr &\\quad = 8 - 3 \\cr &\\quad = 5 \\end{aligned}",
      "Expand the numerator using double brackets:\\begin{aligned} &(3\\sqrt{2} - \\sqrt{3})(2\\sqrt{2} - \\sqrt{3}) \\cr &\\quad = 12 - 3\\sqrt{6} - 2\\sqrt{6} + 3 \\cr &\\quad = 12 - 5\\sqrt{6} + 3 \\cr &\\quad = 15 - 5\\sqrt{6} \\end{aligned}",
      "Combine the expanded numerator and denominator back into the fraction, and simplify by dividing both terms by 5:\\begin{aligned} \\dfrac{15 - 5\\sqrt{6}}{5} &= \\dfrac{15}{5} - \\dfrac{5\\sqrt{6}}{5} \\cr &= 3 - \\sqrt{6} \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>A rectangle has an area of $(5 + 2\\sqrt{3})\\text{ cm}^2$ and a width of $(2 + \\sqrt{3})\\text{ cm}$.<br><br>1. Find the exact length of the rectangle, giving your answer in the form $a + b\\sqrt{3}$, where $a$ and $b$ are integers.<br><br>2. Hence, find the exact perimeter of the rectangle.",
    "steps": [
      "To find the length of the rectangle, divide the area by the width:\\begin{aligned} \\text{Length} &= \\dfrac{5 + 2\\sqrt{3}}{2 + \\sqrt{3}} \\end{aligned}",
      "Rationalise the denominator by multiplying the numerator and denominator by the conjugate $2 - \\sqrt{3}$:\\begin{aligned} &\\text{Length} \\cr &\\quad = \\dfrac{(5 + 2\\sqrt{3})(2 - \\sqrt{3})}{(2 + \\sqrt{3})(2 - \\sqrt{3})} \\end{aligned}",
      "Expand the denominator using the difference of two squares:\\begin{aligned} (2 + \\sqrt{3})(2 - \\sqrt{3}) &= 2^2 - (\\sqrt{3})^2 \\cr &= 4 - 3 \\cr &= 1 \\end{aligned}",
      "Expand the numerator using double brackets:\\begin{aligned} &(5 + 2\\sqrt{3})(2 - \\sqrt{3}) \\cr &\\quad = 10 - 5\\sqrt{3} + 4\\sqrt{3} - 6 \\cr &\\quad = 4 - \\sqrt{3} \\end{aligned}Since the denominator is 1, the length of the rectangle is $(4 - \\sqrt{3})\\text{ cm}$.",
      "To find the perimeter, use the formula $\\text{Perimeter} = 2(\\text{Length} + \\text{Width})$:\\begin{aligned} \\text{P} &= 2\\left[ (4 - \\sqrt{3}) + (2 + \\sqrt{3}) \\right] \\cr &= 2(4 + 2) \\cr &= 2(6) \\cr &= 12\\text{ cm} \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\text{Length} = (4 - \\sqrt{3})\\text{ cm} \\cr &\\text{Perimeter} = 12\\text{ cm} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{Length} = (4 - \\sqrt{3})\\text{ cm} \\cr &\\text{Perimeter} = (12 - 2\\sqrt{3})\\text{ cm} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Length} = (4 + \\sqrt{3})\\text{ cm} \\cr &\\text{Perimeter} = 12\\text{ cm} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Length} = (16 - 9\\sqrt{3})\\text{ cm} \\cr &\\text{Perimeter} = (36 - 18\\sqrt{3})\\text{ cm} \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>Showing all your working, express the following as a single algebraic fraction in its simplest form:\\begin{aligned} &\\dfrac{\\sqrt{x} + 2}{\\sqrt{x} - 2} - \\dfrac{\\sqrt{x} - 2}{\\sqrt{x} + 2} \\cr &\\qquad \\text{for } x > 4 \\end{aligned}",
    "steps": [
      "To subtract the algebraic fractions, find a common denominator, which is the product of the two denominators: $(\\sqrt{x} - 2)(\\sqrt{x} + 2)$:\\begin{aligned} \\text{Denominator} &= (\\sqrt{x} - 2)(\\sqrt{x} + 2) \\cr &= (\\sqrt{x})^2 - 2^2 \\cr &= x - 4 \\end{aligned}",
      "Adjust the numerators accordingly and set up the single fraction subtraction over the common denominator:\\begin{aligned} &\\text{New Expression} \\cr &\\quad = \\dfrac{(\\sqrt{x} + 2)^2 - (\\sqrt{x} - 2)^2}{x - 4} \\end{aligned}",
      "Expand the two squared binomial terms in the numerator:\\begin{aligned} (\\sqrt{x} + 2)^2 &= x + 4\\sqrt{x} + 4 \\cr (\\sqrt{x} - 2)^2 &= x - 4\\sqrt{x} + 4 \\end{aligned}",
      "Subtract the second numerator expansion from the first inside the fraction:\\begin{aligned} &\\text{Numerator} \\cr &\\quad = (x + 4\\sqrt{x} + 4) \\cr &\\qquad - (x - 4\\sqrt{x} + 4) \\cr &\\quad = 8\\sqrt{x} \\end{aligned}",
      "Combine the simplified numerator and denominator to form the single simplified fraction:\\begin{aligned} \\text{Simplified Fraction} &= \\dfrac{8\\sqrt{x}}{x - 4} \\end{aligned}",
      "Final Answer: $$\\dfrac{8\\sqrt{x}}{x - 4}$$"
    ],
    "pi_options": [
      {
        "ans": "$$\\dfrac{2x + 8}{x - 4}$$",
        "feedback": "Check your sign operations when expanding and subtracting the numerators. Subtracting $(x - 4\\sqrt{x} + 4)$ from $(x + 4\\sqrt{x} + 4)$ yields \\begin{aligned} &(x - x) + (4\\sqrt{x} - (-4\\sqrt{x}))\\cr \\qquad + (4 - 4) = 8\\sqrt{x}\\end{aligned}. It seems you may have added the terms instead of subtracting them, or made a sign distribution error."
      },
      {
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>The points $A$ and $B$ have coordinates $(1, 6)$ and $(4, 0)$ respectively. The straight line $L$ has the equation $x - 2y + 6 = 0$.<br><br>1. The line $L$ intersects the line $AB$ at the point $C$. Find the coordinates of $C$.<br><br>2. Determine the ratio in which the line $L$ divides the line $AB$.<br><br>3. The line $L$ crosses the $x$-axis at the point $D$. Find the coordinates of $D$.<br><br>4. Show that $L$ is perpendicular to $AB$, and calculate the exact area of the triangle $ACD$.",
    "steps": [
      "First, find the equation of the line passing through $A(1, 6)$ and $B(4, 0)$. Begin by calculating the gradient of $AB$:\\begin{aligned} m_{AB} &= \\dfrac{0 - 6}{4 - 1} \\cr &= \\dfrac{-6}{3} \\cr &= -2 \\end{aligned}Using the point-gradient formula with $B(4, 0)$, the equation of $AB$ is:\\begin{aligned} y - 0 &= -2(x - 4) \\cr y &= -2x + 8 \\end{aligned}",
      "To find the coordinates of the intersection point $C$, solve the equations of $L$ and $AB$ simultaneously by substituting $y = -2x + 8$ into the equation of $L$ ($x - 2y + 6 = 0$):\\begin{aligned} x - 2(-2x + 8) + 6 &= 0 \\cr x + 4x - 16 + 6 &= 0 \\cr 5x - 10 &= 0 \\cr 5x &= 10 \\cr x &= 2 \\end{aligned}",
      "Substitute $x = 2$ back into the equation of $AB$ to find the $y$-coordinate of $C$:\\begin{aligned} y &= -2(2) + 8 \\cr &= 4 \\end{aligned}Thus, the coordinates of the intersection point are $C(2, 4)$.",
      "To find the ratio in which $L$ divides $AB$, compare the horizontal displacements of $AC$ and $CB$:\\begin{aligned} x_C - x_A &= 2 - 1 \\cr &= 1 \\cr x_B - x_C &= 4 - 2 \\cr &= 2 \\end{aligned}Since the ratio of the horizontal displacements is $1:2$, the line $L$ divides the line segment $AB$ in the ratio $1:2$.",
      "The line $L$ crosses the $x$-axis at the point $D$. Since any point on the $x$-axis has a $y$-coordinate of $0$, substitute $y = 0$ into the equation of $L$ ($x - 2y + 6 = 0$):\\begin{aligned} x - 2(0) + 6 &= 0 \\cr x + 6 &= 0 \\cr x &= -6 \\end{aligned}Thus, the coordinates of point $D$ are $D(-6, 0)$.",
      "To show that $L$ and $AB$ are perpendicular, compare their gradients. Rearrange the equation of $L$ into standard form $y = mx + c$:\\begin{aligned} x - 2y + 6 &= 0 \\cr 2y &= x + 6 \\cr y &= \\dfrac{1}{2}x + 3 \\end{aligned}Thus, the gradient of $L$ is $m_L = \\dfrac{1}{2}$. Since $m_{AB} \\times m_L = -1$, the lines are perpendicular.",
      "Because $L$ is perpendicular to $AB$ at the intersection point $C$, the triangle $ACD$ is right-angled at $C$. Find the lengths of the base $CD$ and the height $AC$ using the distance formula:\\begin{aligned} AC &= \\sqrt{(2 - 1)^2 + (4 - 6)^2} \\cr &= \\sqrt{1 + 4} \\cr &= \\sqrt{5} \\cr CD &= \\sqrt{(2 - (-6))^2 + (4 - 0)^2} \\cr &= \\sqrt{8^2 + 4^2} \\cr &= \\sqrt{64 + 16} \\cr &= \\sqrt{80} \\cr &= 4\\sqrt{5} \\end{aligned}",
      "Calculate the area of the right-angled triangle $ACD$ using $\\text{Area} = \\dfrac{1}{2} \\times \\text{base} \\times \\text{height}$:\\begin{aligned} \\text{Area} &= \\dfrac{1}{2} \\times AC \\times CD \\cr &= \\dfrac{1}{2} \\times \\sqrt{5} \\times 4\\sqrt{5} \\cr &= \\dfrac{1}{2} \\times 20 \\cr &= 10 \\end{aligned}",
      "Final Answer: \\begin{aligned} &C(2, 4) \\cr &\\text{Ratio} = 1:2 \\cr &D(-6, 0) \\cr &m_{AB} \\times m_L = -1 \\cr &\\text{Area} = 10 \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &C(2, 4) \\cr &\\text{Ratio} = 1:3 \\cr &D(-6, 0) \\cr &\\text{Area} = 10 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &C(2, 4) \\cr &\\text{Ratio} = 1:2 \\cr &D(6, 0) \\cr &\\text{Area} = 10 \\end{aligned}",
        "feedback": "Check your coordinates for point $D$. When substituting $y = 0$ into $x - 2y + 6 = 0$, we get $x + 6 = 0$, so $x = -6$. It seems you made a sign error, resulting in $D(6, 0)$."
      },
      {
        "ans": "\\begin{aligned} &C(2, 4) \\cr &\\text{Ratio} = 1:2 \\cr &D(-6, 0) \\cr &\\text{Area} = 20 \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>The line $L_1$ passes through the points $P(-2, k)$ and $Q(4, 5)$. The straight line $L_2$ is defined by the equation:$$3x - 2y + 8 = 0$$1. Given that the line $L_1$ is parallel to the line $L_2$, find the value of the constant $k$.<br><br>2. Given instead that the line $L_1$ is perpendicular to the line $L_2$, find the value of the constant $k$.",
    "steps": [
      "To find the gradient of the line $L_2$, rearrange its equation into the standard form $y = mx + c$:\\begin{aligned} 3x - 2y + 8 &= 0 \\cr 2y &= 3x + 8 \\cr y &= \\dfrac{3}{2}x + 4 \\end{aligned}Thus, the gradient of the line $L_2$ is $m_2 = \\dfrac{3}{2}$.",
      "Next, write down the algebraic expression for the gradient of $L_1$ passing through $P(-2, k)$ and $Q(4, 5)$:\\begin{aligned} m_1 &= \\dfrac{5 - k}{4 - (-2)} \\cr &= \\dfrac{5 - k}{6} \\end{aligned}",
      "For part 1, parallel lines have equal gradients ($m_1 = m_2$). Set the gradients equal and solve for $k$:\\begin{aligned} \\dfrac{5 - k}{6} &= \\dfrac{3}{2} \\cr 2(5 - k) &= 18 \\cr 10 - 2k &= 18 \\cr -2k &= 8 \\cr k &= -4 \\end{aligned}",
      "For part 2, perpendicular lines have gradients whose product is $-1$ ($m_1 \\times m_2 = -1$). Set up the product equation and solve for $k$:\\begin{aligned} \\left( \\dfrac{5 - k}{6} \\right) \\left( \\dfrac{3}{2} \\right) &= -1 \\cr \\dfrac{3(5 - k)}{12} &= -1 \\cr \\dfrac{5 - k}{4} &= -1 \\cr 5 - k &= -4 \\cr k &= 9 \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\text{Parallel: } k = -4 \\cr &\\text{Perpendicular: } k = 9 \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{Parallel: } k = -4 \\cr &\\text{Perpendicular: } k = -9 \\end{aligned}",
        "feedback": "Check your algebraic signs when solving the perpendicular equation $5 - k = -4$. Subtracting 5 from both sides gives $-k = -9$, so $k = 9$. It seems you made a sign error, resulting in $k = -9$."
      },
      {
        "ans": "\\begin{aligned} &\\text{Parallel: } k = 14 \\cr &\\text{Perpendicular: } k = 9 \\end{aligned}",
        "feedback": "Check your step when solving the parallel equation $\\dfrac{5 - k}{6} = \\dfrac{3}{2}$. Multiplying by 6 gives $5 - k = 9$, which leads to $k = -4$. It seems you may have mistakenly added 5 instead of subtracting, leading to $k = 14$."
      },
      {
        "ans": "\\begin{aligned} &\\text{Parallel: } k = -4 \\cr &\\text{Perpendicular: } k = 1 \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>The points $A$ and $B$ have coordinates $(-3, 2)$ and $(5, 6)$ respectively.<br><br>1. Find the coordinates of the midpoint of $AB$.<br><br>2. Find the gradient of the line segment $AB$.<br><br>3. Hence, find the equation of the perpendicular bisector of $AB$, giving your answer in the form $ax + by + c = 0$, where $a$, $b$, and $c$ are integers to be found.",
    "steps": [
      "To find the coordinates of the midpoint $M$ of $AB$, apply the midpoint formula to the coordinates of $A(-3, 2)$ and $B(5, 6)$:\\begin{aligned} M &= \\left( \\dfrac{-3 + 5}{2}, \\dfrac{2 + 6}{2} \\right) \\cr &= \\left( \\dfrac{2}{2}, \\dfrac{8}{2} \\right) \\cr &= (1, 4) \\end{aligned}",
      "To find the gradient $m_{AB}$ of the line segment $AB$, use the gradient formula:\\begin{aligned} m_{AB} &= \\dfrac{6 - 2}{5 - (-3)} \\cr &= \\dfrac{4}{8} \\cr &= \\dfrac{1}{2} \\end{aligned}",
      "The perpendicular bisector must be perpendicular to $AB$. Find its gradient by taking the negative reciprocal of $m_{AB} = \\dfrac{1}{2}$:\\begin{aligned} m_{\\perp} &= -\\dfrac{1}{m_{AB}} \\cr &= -\\dfrac{1}{1/2} \\cr &= -2 \\end{aligned}",
      "The perpendicular bisector passes through the midpoint $M(1, 4)$. Set up the straight line equation using the point-gradient formula $y - y_1 = m(x - x_1)$:\\begin{aligned} y - 4 &= -2(x - 1) \\cr y - 4 &= -2x + 2 \\end{aligned}",
      "Rearrange the terms into the general form $ax + by + c = 0$ where $a$, $b$, and $c$ are integers:\\begin{aligned} 2x + y - 4 - 2 &= 0 \\cr 2x + y - 6 &= 0 \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\text{Midpoint} = (1, 4) \\cr &m_{AB} = \\dfrac{1}{2} \\cr &2x + y - 6 = 0 \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{Midpoint} = (1, 4) \\cr &m = \\dfrac{1}{2} \\cr &2x + y - 2 = 0 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Midpoint} = (1, 4) \\cr &m = \\dfrac{1}{2} \\cr &x + 2y - 9 = 0 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Midpoint} = (1, 4) \\cr &m = -2 \\cr &2x + y - 6 = 0 \\end{aligned}",
  ...
  },
  {
    ...
    "pi_options": [
      {
        "ans": "\\begin{aligned} &(-5, -2) \\text{ and } (2, 5) \\cr &\\text{Chord Length} = 98 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(5, 8) \\text{ and } (2, 5) \\cr &\\text{Chord Length} = 3\\sqrt{2} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(-5, -2) \\text{ and } (2, 5) \\cr &\\text{Chord Length} = \\sqrt{58} \\end{aligned}",
        "feedback": "Check your substitution of the coordinates into the distance formula. Ensure you calculate $(2 - (-5))^2 = 49$ and $(5 - (-2))^2 = 49$. It seems you may have made a sign error and calculated $(2 - 5)^2 + (-2 - 5)^2$ or similar."
      }
    ],
    "bradley_insight": {
      "type": "caution",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>A rhombus $PQRS$ has vertices at $P(1, 2)$, $Q(5, 5)$, and $R(2, 9)$.<br><br>1. Find the coordinates of the midpoint of the diagonal $PR$.<br><br>2. Since the diagonals of a rhombus bisect each other, find the coordinates of the fourth vertex, $S$.<br><br>3. Show that the diagonals $PR$ and $QS$ are perpendicular.",
    "steps": [
      "To find the coordinates of the midpoint $M$ of the diagonal $PR$, apply the midpoint formula to the coordinates of $P(1, 2)$ and $R(2, 9)$:\\begin{aligned} M &= \\left( \\dfrac{1 + 2}{2}, \\dfrac{2 + 9}{2} \\right) \\cr &= \\left( \\dfrac{3}{2}, \\dfrac{11}{2} \\right) \\end{aligned}",
      "Since the diagonals of a rhombus bisect each other, the midpoint of the diagonal $QS$ must be identical to the midpoint of $PR$, which is $\\left( \\dfrac{3}{2}, \\dfrac{11}{2} \\right)$. Let the coordinates of vertex $S$ be $(a, b)$:\\begin{aligned} \\left( \\dfrac{5 + a}{2}, \\dfrac{5 + b}{2} \\right) &= \\left( \\dfrac{3}{2}, \\dfrac{11}{2} \\right) \\end{aligned}",
      "Equate the individual coordinate components of the midpoint to solve for $a$ and $b$:\\begin{aligned} \\dfrac{5 + a}{2} &= \\dfrac{3}{2} \\cr 5 + a &= 3 \\cr a &= -2 \\cr \\dfrac{5 + b}{2} &= \\dfrac{11}{2} \\cr 5 + b &= 11 \\cr b &= 6 \\end{aligned}Thus, the coordinates of the fourth vertex are $S(-2, 6)$.",
      "To show that the diagonals $PR$ and $QS$ are perpendicular, find and compare their gradients. Calculate the gradient of $PR$ using $P(1, 2)$ and $R(2, 9)$:\\begin{aligned} m_{PR} &= \\dfrac{9 - 2}{2 - 1} \\cr &= \\dfrac{7}{1} \\cr &= 7 \\end{aligned}",
      "Calculate the gradient of $QS$ using $Q(5, 5)$ and $S(-2, 6)$:\\begin{aligned} m_{QS} &= \\dfrac{6 - 5}{-2 - 5} \\cr &= \\dfrac{1}{-7} \\cr &= -\\dfrac{1}{7} \\end{aligned}",
      "Multiply the two gradients to check for perpendicularity:\\begin{aligned} m_{PR} \\times m_{QS} &= 7 \\times \\left( -\\dfrac{1}{7} \\right) \\cr &= -1 \\end{aligned}Since the product of the gradients is $-1$, the diagonals $PR$ and $QS$ are perpendicular.",
      "Final Answer: \\begin{aligned} &\\text{Midpoint} = \\left( \\dfrac{3}{2}, \\dfrac{11}{2} \\right) \\cr &S(-2, 6) \\cr &m_{PR} \\times m_{QS} = -1 \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{Midpoint} = \\left( \\dfrac{3}{2}, \\dfrac{11}{2} \\right) \\cr &S(2, 6) \\cr &\\text{Product} = -1 \\end{aligned}",
        "feedback": "Check your algebraic step when solving $5 + a = 3$ for the $x$-coordinate of $S$. Subtracting $5$ from both sides yields $a = -2$. It seems you made a sign error, resulting in $a = 2$."
      },
      {
        "ans": "\\begin{aligned} &\\text{Midpoint} = \\left( \\dfrac{3}{2}, \\dfrac{11}{2} \\right) \\cr &S(-2, 6) \\cr &\\text{Product} = -\\dfrac{1}{7} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Midpoint} = (3, 11) \\cr &S(1, 7) \\cr &\\text{Product} = -1 \\end{aligned}",
