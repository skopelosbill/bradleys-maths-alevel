window.ALEVEL_QUESTIONS = [
  ...
  },
  {
    ...
    "steps": [
      ...
      "Expand the numerator and denominator terms individually:\\begin{aligned} &\\text{Numerator} \\cr & \\qquad= 5(6) - 5\\sqrt{12} + 2\\sqrt{12} - 2(2) \\cr & \\qquad = 30 - 3\\sqrt{12} - 4 \\cr & \\qquad = 26 - 3(2\\sqrt{3}) \\cr & \\qquad = 26 - 6\\sqrt{3} \\cr &\\text{Denominator} = 6 - 2 \\cr & \\qquad = 4 \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      ...
      "To find the perimeter, use the formula $\\text{Perimeter} = 2(\\text{Length} + \\text{Width})$:\\begin{aligned} \\text{Perimeter} &= 2\\left[ (4 - \\sqrt{3}) + (2 + \\sqrt{3}) \\right] \\cr &= 2(4 + 2) \\cr &= 2(6) \\cr &= 12\\text{ cm} \\end{aligned}",
