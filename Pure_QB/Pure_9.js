window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Step 5: Identify the target quadrants and calculate the angles</strong><br>Since $\\tan \\theta = \\dfrac{ 4 }{ 3 }$ is positive, the solutions must lie in quadrant I and quadrant III:<br>In Quadrant I:<br>$$\\theta = \\tan^{ -1 }\\left( \\dfrac{ 4 }{ 3 } \\right) \\approx 53.1^\\circ$$<br>In Quadrant III:<br>\\begin{aligned}\n\\theta &= 180^\\circ + 53.1^\\circ \\cr\n&= 233.1^\\circ\n\\end{aligned}<br>The solutions (to the nearest tenth of a degree) are: $\\theta \\approx 53.1^\\circ, 233.1^\\circ$."
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Step 4: State all solutions</strong><br>The complete set of solutions is:<br>\\begin{aligned}\nx &= 1, \\quad x \\cr\n&= 3, \\quad x \\cr\n&= -2\n\\end{aligned}"
                ],
                "pi_options": [
                        {
