...
},
{
        ...
        "steps": [
                ...
                "<strong>Step 2: Expand the compound angle term:</strong><br>Using the compound angle identity $\\sin(A + B) = \\sin A\\cos B + \\cos A\\sin B$, we expand the numerator:\\begin{aligned} &\\sin(\\theta + h) \\cr &\\quad = \\sin\\theta\\cos h + \\cos\\theta\\sin h \\end{aligned}Substituting this expansion back into our difference quotient gives:$$\\dfrac{\\sin\\theta\\cos h + \\cos\\theta\\sin h - \\sin\\theta}{h}$$",
                "<strong>Step 3: Group the sines and cosines:</strong><br>We can group the terms containing $\\sin\\theta$ in the numerator to factorise them:\\begin{aligned} &\\dfrac{\\sin\\theta\\cos h + \\cos\\theta\\sin h - \\sin\\theta}{h} \\cr &\\quad = \\dfrac{\\sin\\theta(\\cos h - 1) + \\cos\\theta\\sin h}{h} \\cr &\\quad = \\sin\\theta\\left(\\dfrac{\\cos h - 1}{h}\\right) \\cr &\\qquad + \\cos\\theta\\left(\\dfrac{\\sin h}{h}\\right) \\end{aligned}This is the required algebraic rearrangement before taking limits.",
                "<strong>Step 4: Take the limit as $h \\to 0$:</strong><br>Using the standard limit results that as $h \\to 0$, $\\dfrac{\\sin h}{h} \\to 1$ and $\\dfrac{\\cos h - 1}{h} \\to 0$, we evaluate:\\begin{aligned} \\dfrac{\\text{d}}{\\text{d}\\theta}(\\sin\\theta) &= \\sin\\theta(0) + \\cos\\theta(1) \\cr &= \\cos\\theta \\end{aligned}",
...
},
{
        ...
        "steps": [
                ...
                "<strong>Step 2: Expand the compound angle term:</strong><br>Using the compound angle identity $\\cos(A + B) = \\cos A\\cos B - \\sin A\\sin B$, we expand $\\cos(2x + 2h)$:\\begin{aligned} &\\cos(2x + 2h) \\cr &\\quad = \\cos(2x)\\cos(2h) \\cr &\\qquad - \\sin(2x)\\sin(2h) \\end{aligned}Substituting this expansion back into our difference quotient gives:$$\\dfrac{\\cos(2x)\\cos(2h) - \\sin(2x)\\sin(2h) - \\cos(2x)}{h}$$",
...
},
{
        ...
        "steps": [
                ...
                "<strong>Step 2: Expand the compound angle term:</strong><br>Using the compound angle identity $\\sin(A + B) = \\sin A\\cos B + \\cos A\\sin B$, we expand $\\sin(2x + 2h)$:\\begin{aligned} &\\sin(2x + 2h) \\cr &\\quad = \\sin(2x)\\cos(2h) \\cr &\\qquad + \\cos(2x)\\sin(2h) \\end{aligned}Substituting this expansion back into our difference quotient gives:$$\\dfrac{\\sin(2x)\\cos(2h) + \\cos(2x)\\sin(2h) - \\sin(2x)}{h}$$",
...
},
{
        ...
        "steps": [
                ...
                "<strong>Step 2: Expand the compound angle term:</strong><br>Using the compound angle identity $\\cos(A + B) = \\cos A\\cos B - \\sin A\\sin B$, we expand $\\cos(3\\theta + 3h)$:\\begin{aligned} &\\cos(3\\theta + 3h) \\cr &\\quad = \\cos(3\\theta)\\cos(3h) \\cr &\\qquad - \\sin(3\\theta)\\sin(3h) \\end{aligned}Substituting this expansion back into our difference quotient gives:$$\\dfrac{\\cos(3\\theta)\\cos(3h) - \\sin(3\\theta)\\sin(3h) - \\cos(3\\theta)}{h}$$",
                "<strong>Step 3: Group the terms:</strong><br>We can group the terms containing $\\cos(3\\theta)$ in the numerator to factorise them:\\begin{aligned} &\\dfrac{\\cos(3\\theta)(\\cos(3h) - 1) - \\sin(3\\theta)\\sin(3h)}{h} \\cr &\\quad = \\cos(3\\theta)\\left(\\dfrac{\\cos(3h) - 1}{h}\\right) \\cr &\\qquad - \\sin(3\\theta)\\left(\\dfrac{\\sin(3h)}{h}\\right) \\end{aligned}This is the required algebraic rearrangement before taking limits.",
                "<strong>Step 4: Take the limit as $h \\to 0$:</strong><br>To evaluate the limits, we scale the fractions to match our standard limit forms:\\begin{aligned} \\dfrac{\\cos(3h) - 1}{h} &= 3\\left(\\dfrac{\\cos(3h) - 1}{3h}\\right) \\cr \\dfrac{\\sin(3h)}{h} &= 3\\left(\\dfrac{\\sin(3h)}{3h}\\right) \\end{aligned}As $h \\to 0$, we have $3h \\to 0$. Therefore:\\begin{aligned} \\lim_{h \\to 0} \\left(\\dfrac{\\cos(3h) - 1}{h}\\right) &= 3(0) \\cr &= 0 \\cr \\lim_{h \\to 0} \\left(\\dfrac{\\sin(3h)}{h}\\right) &= 3(1) \\cr &= 3 \\end{aligned}Applying these limits gives:\\begin{aligned} \\dfrac{\\text{d}}{\\text{d}\\theta}(\\cos(3\\theta)) &= \\cos(3\\theta)(0) - \\sin(3\\theta)(3) \\cr &= -3\\sin(3\\theta) \\end{aligned}",
...
},
{
        ...
        "steps": [
                ...
                "<strong>Step 2: Expand the compound angle term:</strong><br>Using the compound angle identity $\\sin(A + B) = \\sin A\\cos B + \\cos A\\sin B$, we expand $\\sin(3\\theta + 3h)$:\\begin{aligned} &\\sin(3\\theta + 3h) \\cr &\\quad = \\sin(3\\theta)\\cos(3h) \\cr &\\qquad + \\cos(3\\theta)\\sin(3h) \\end{aligned}Substituting this expansion back into our difference quotient gives:$$\\dfrac{\\sin(3\\theta)\\cos(3h) + \\cos(3\\theta)\\sin(3h) - \\sin(3\\theta)}{h}$$",
                "<strong>Step 3: Group the terms:</strong><br>We can group the terms containing $\\sin(3\\theta)$ in the numerator to factorise them:\\begin{aligned} &\\dfrac{\\sin(3\\theta)(\\cos(3h) - 1) + \\cos(3\\theta)\\sin(3h)}{h} \\cr &\\quad = \\sin(3\\theta)\\left(\\dfrac{\\cos(3h) - 1}{h}\\right) \\cr &\\qquad + \\cos(3\\theta)\\left(\\dfrac{\\sin(3h)}{h}\\right) \\end{aligned}This is the required algebraic rearrangement before taking limits.",
                "<strong>Step 4: Take the limit as $h \\to 0$:</strong><br>To evaluate the limits, we scale the fractions to match our standard limit forms:\\begin{aligned} \\dfrac{\\cos(3h) - 1}{h} &= 3\\left(\\dfrac{\\cos(3h) - 1}{3h}\\right) \\cr \\dfrac{\\sin(3h)}{h} &= 3\\left(\\dfrac{\\sin(3h)}{3h}\\right) \\end{aligned}As $h \\to 0$, we have $3h \\to 0$. Therefore:\\begin{aligned} \\lim_{h \\to 0} \\left(\\dfrac{\\cos(3h) - 1}{h}\\right) &= 3(0) \\cr &= 0 \\cr \\lim_{h \\to 0} \\left(\\dfrac{\\sin(3h)}{h}\\right) &= 3(1) \\cr &= 3 \\end{aligned}Applying these limits gives:\\begin{aligned} \\dfrac{\\text{d}}{\\text{d}\\theta}(\\sin(3\\theta)) &= \\sin(3\\theta)(0) + \\cos(3\\theta)(3) \\cr &= 3\\cos(3\\theta) \\end{aligned}",
