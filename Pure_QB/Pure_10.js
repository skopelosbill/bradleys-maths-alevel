...
}, 
{
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "We can solve this quadratic equation by factoring. We look for two numbers that multiply to $6400$ and add to $-200$. These numbers are $-40$ and $-160$:<br>\\begin{aligned} ( x - 40 )( x - 160 ) &= 0 \\end{aligned}<br>This gives the roots:<br>\\begin{aligned}x &= 40\\text{ m} \\quad \\text{and} \\quad x \\cr&= 160\\text{ m}\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "We can solve this quadratic equation by factoring. We look for two numbers that multiply to $2000$ and add to $-120$. These numbers are $-20$ and $-100$:<br>\\begin{aligned} ( x - 20 )( x - 100 ) &= 0 \\end{aligned}<br>This gives the roots:<br>\\begin{aligned}x &= 20\\text{ m} \\quad \\text{and} \\quad x \\cr&= 100\\text{ m}\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "We can solve this quadratic equation by factoring. We look for two numbers that multiply to $80$ and add to $-24$. These numbers are $-4$ and $-20$:<br>\\begin{aligned} ( x - 4 )( x - 20 ) &= 0 \\end{aligned}<br>This gives the roots:<br>\\begin{aligned}x &= 4\\text{ m} \\quad \\text{and} \\quad x \\cr&= 20\\text{ m}\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "We can solve this quadratic equation by factoring. We look for two numbers that multiply to $700$ and add to $-80$. These numbers are $-10$ and $-70$:<br>\\begin{aligned} ( x - 10 )( x - 70 ) &= 0 \\end{aligned}<br>This gives the roots:<br>\\begin{aligned}x &= 10\\text{ m} \\quad \\text{and} \\quad x \\cr&= 70\\text{ m}\\end{aligned}",
