window.ALEVEL_QUESTIONS = [
 {
        ...
        "img": false,
        "question": "The equation $3x^3 + x^2 - 2 = 0$ has exactly one real root.<br><br><strong>(a)</strong> Show that, for this equation, the Newton-Raphson formula can be written as:\\begin{aligned} x_{n+1} &= \\dfrac{6x_n^3 + x_n^2 + 2}{9x_n^2 + 2x_n} \\end{aligned} [3]<br><br><strong>(b)</strong> Using the formula given in part (a) with $x_1 = 1$, find the values of $x_2$ and $x_3$, giving your answers to 3 decimal places. [2]<br><br><strong>(c)</strong> Explain why, for this equation, the Newton-Raphson method cannot be used with $x_1 = 0$. [1]",
        "steps": [
                "<strong>Step 1: Define the function and find its derivative for part (a)</strong><br>Let $f(x) = 3x^3 + x^2 - 2$. To apply the Newton-Raphson method, first differentiate $f(x)$ with respect to $x$:\\begin{aligned} f'(x) &= \\dfrac{\\text{d}}{\\text{d}x}(3x^3 + x^2 - 2) \\cr &= 9x^2 + 2x \\end{aligned}",
                "<strong>Step 2: Set up the Newton-Raphson recurrence relation</strong><br>The general Newton-Raphson formula is $x_{n+1} = x_n - \\dfrac{f(x_n)}{f'(x_n)}$. Substitute our expressions for $f(x_n)$ and $f'(x_n)$:\\begin{aligned} &x_{n+1} \\cr &\\quad = x_n - \\dfrac{3x_n^3 + x_n^2 - 2}{9x_n^2 + 2x_n} \\end{aligned}",
                "<strong>Step 3: Combine into a single algebraic fraction to complete part (a)</strong><br>Combine the terms over a common denominator.<br><br>The numerator expands to:\\begin{aligned} &x_n(9x_n^2 + 2x_n) \\cr &\\quad - (3x_n^3 + x_n^2 - 2) \\cr &\\quad = 9x_n^3 + 2x_n^2 - 3x_n^3 \\cr &\\qquad - x_n^2 + 2 \\cr &\\quad = 6x_n^3 + x_n^2 + 2 \\end{aligned}Placing this over the common denominator gives:\\begin{aligned} x_{n+1} &= \\dfrac{6x_n^3 + x_n^2 + 2}{9x_n^2 + 2x_n} \\end{aligned}This matches the required formula.",
                "<strong>Step 4: Perform the iterations for part (b)</strong><br>Substitute $x_1 = 1$ into the formula to calculate $x_2$:\\begin{aligned} x_2 &= \\dfrac{6(1)^3 + 1^2 + 2}{9(1)^2 + 2(1)} \\cr &= \\dfrac{9}{11} \\cr &\\approx 0.818 \\end{aligned}Now, substitute $x_2 = \\dfrac{9}{11}$ back into the formula to find $x_3$:\\begin{aligned} x_3 &= \\dfrac{6\\left(\\dfrac{9}{11}\\right)^3 + \\left(\\dfrac{9}{11}\\right)^2 + 2}{9\\left(\\dfrac{9}{11}\\right)^2 + 2\\left(\\dfrac{9}{11}\\right)} \\cr &= \\dfrac{7927}{10197} \\cr &\\approx 0.777 \\end{aligned}",
                "<strong>Step 5: Formulate the explanation for part (c)</strong><br>Evaluate the derivative $f'(x)$ at our starting value $x_1 = 0$:\\begin{aligned} f'(0) &= 9(0)^2 + 2(0) \\cr &= 0 \\end{aligned}The Newton-Raphson formula involves dividing by the value of the derivative, $f'(x_n)$. Because $f'(0) = 0$, starting with $x_1 = 0$ results in division by zero, which is undefined. Geometrically, this means the tangent to the curve at $x = 0$ is completely horizontal and does not intersect the $x$-axis to provide a next approximation.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) Formula verified} \\cr &\\text{(b) } x_2 \\approx 0.818, \\; x_3 \\approx 0.777 \\cr &\\text{(c) } f'(0) = 0 \\cr &\\quad\\implies \\text{division by zero} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x_2 \\approx 0.818, \\; x_3 \\approx 0.777 \\cr &\\text{Curve not defined at } x = 0 \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x_2 \\approx 0.818, \\; x_3 \\approx 0.777 \\cr &x_1 = 0 \\text{ is too far from root} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x_2 \\approx 0.818, \\; x_3 \\approx 0.818 \\cr &\\text{Derivative is zero} \\end{aligned}",
...
},
{
        ...
        "img": false,
        "question": "The equation $x - \\cos x = 0$ has exactly one real root in the interval $[0, \\pi]$.<br><br><strong>(a)</strong> Show that, for this equation, the Newton-Raphson formula can be written as:\\begin{aligned} x_{n+1} &= \\dfrac{x_n \\sin x_n + \\cos x_n}{1 + \\sin x_n} \\end{aligned} [3]<br><br><strong>(b)</strong> Using the formula given in part (a) with a starting value of $x_1 = 0$, find the values of $x_2$ and $x_3$, giving your answers to 3 decimal places (working in radians). [2]<br><br><strong>(c)</strong> Explain why, for this equation, the Newton-Raphson method cannot be used with a starting value of $x_1 = -\\dfrac{\\pi}{2}$. [1]",
        "steps": [
                "<strong>Step 1: Define the function and find its derivative for part (a)</strong><br>Let $f(x) = x - \\cos x$. Differentiate $f(x)$ with respect to $x$:\\begin{aligned} f'(x) &= \\dfrac{\\text{d}}{\\text{d}x}(x - \\cos x) \\cr &= 1 - (-\\sin x) \\cr &= 1 + \\sin x \\end{aligned}",
                "<strong>Step 2: Set up the Newton-Raphson recurrence relation</strong><br>The general Newton-Raphson formula is $x_{n+1} = x_n - \\dfrac{f(x_n)}{f'(x_n)}$. Substitute our expressions for $f(x_n)$ and $f'(x_n)$:\\begin{aligned} &x_{n+1} \\cr &\\quad = x_n - \\dfrac{x_n - \\cos x_n}{1 + \\sin x_n} \\end{aligned}",
                "<strong>Step 3: Combine into a single algebraic fraction to complete part (a)</strong><br>Combine the terms over a common denominator.<br><br>The numerator expands to:\\begin{aligned} &x_n(1 + \\sin x_n) \\cr &\\quad - (x_n - \\cos x_n) \\cr &\\quad = x_n + x_n \\sin x_n \\cr &\\qquad - x_n + \\cos x_n \\cr &\\quad = x_n \\sin x_n + \\cos x_n \\end{aligned}Placing this over the common denominator yields:\\begin{aligned} x_{n+1} &= \\dfrac{x_n \\sin x_n + \\cos x_n}{1 + \\sin x_n} \\end{aligned}This matches the required formula.",
                "<strong>Step 4: Perform the iterations for part (b)</strong><br>Ensure your calculator is strictly in <strong>radian</strong> mode. Substitute $x_1 = 0$ into the formula to calculate $x_2$:\\begin{aligned} x_2 &= \\dfrac{0 \\sin 0 + \\cos 0}{1 + \\sin 0} \\cr &= \\dfrac{0 + 1}{1 + 0} \\cr &= 1 \\end{aligned}Now, substitute $x_2 = 1$ back into the formula to find $x_3$:\\begin{aligned} x_3 &= \\dfrac{1 \\sin 1 + \\cos 1}{1 + \\sin 1} \\cr &\\approx \\dfrac{1(0.84147) + 0.54030}{1 + 0.84147} \\cr &\\approx \\dfrac{1.38177}{1.84147} \\cr &\\approx 0.750 \\end{aligned}",
                "<strong>Step 5: Formulate the explanation for part (c)</strong><br>Evaluate the derivative $f'(x) = 1 + \\sin x$ at our starting value $x_1 = -\\dfrac{\\pi}{2}$:\\begin{aligned} &f'\\left(-\\dfrac{\\pi}{2}\\right) \\cr &\\quad = 1 + \\sin\\left(-\\dfrac{\\pi}{2}\\right) \\cr &\\quad = 1 + (-1) \\cr &\\quad = 0 \\end{aligned}Because the derivative is $0$ at this starting point, the Newton-Raphson formula would require division by zero, which is mathematically undefined. Therefore, the method cannot be used.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) Formula verified} \\cr &\\text{(b) } x_2 = 1.000, \\; x_3 \\approx 0.750 \\cr &\\text{(c) } f'\\left(-\\dfrac{\\pi}{2}\\right) = 0 \\cr &\\quad\\implies \\text{division by zero} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x_2 = 1.000, \\; x_3 \\approx 0.750 \\cr &\\cos\\left(-\\dfrac{\\pi}{2}\\right) = 0 \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x_2 = 1.000, \\; x_3 \\approx 0.999 \\cr &\\text{Derivative is zero} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x_2 = 1.000, \\; x_3 \\approx 0.750 \\cr &\\text{Angle is negative} \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The equation $x^2 - \\ln x - 3 = 0$, where $x > 0$, has a real root in the interval $[1, 2]$.<br><br><strong>(a)</strong> Show that, for this equation, the Newton-Raphson formula can be written as:\\begin{aligned} x_{n+1} &= \\dfrac{x_n^3 + x_n \\ln x_n + 2x_n}{2x_n^2 - 1} \\end{aligned} [3]<br><br><strong>(b)</strong> Using the formula given in part (a) with a starting value of $x_1 = 2$, find the values of $x_2$ and $x_3$, giving your answers to three significant figures. [2]<br><br><strong>(c)</strong> Explain why, for this equation, the Newton-Raphson method cannot be used with a starting value of $x_1 = \\dfrac{1}{\\sqrt{2}}$. [1]",
                "steps": [
                        "<strong>Step 1: Define the function and find its derivative for part (a)</strong><br>Let $f(x) = x^2 - \\ln x - 3$. Differentiate $f(x)$ with respect to $x$ using the power and logarithmic rules:\\begin{aligned} f'(x) &= \\dfrac{\\text{d}}{\\text{d}x}(x^2 - \\ln x - 3) \\cr &= 2x - \\dfrac{1}{x} \\end{aligned}",
                        "<strong>Step 2: Set up the Newton-Raphson recurrence relation</strong><br>The general Newton-Raphson formula is $x_{n+1} = x_n - \\dfrac{f(x_n)}{f'(x_n)}$. Substitute our expressions:\\begin{aligned} &x_{n+1} \\cr &\\quad = x_n - \\dfrac{x_n^2 - \\ln x_n - 3}{2x_n - \\dfrac{1}{x_n}} \\end{aligned}",
                        "<strong>Step 3: Combine into a single algebraic fraction to complete part (a)</strong><br>Express the fraction with a common denominator in the derivative:<br><br>First, write the denominator as $\\dfrac{2x_n^2 - 1}{x_n}$, which gives:\\begin{aligned} x_{n+1} &= x_n - \\dfrac{x_n(x_n^2 - \\ln x_n - 3)}{2x_n^2 - 1} \\end{aligned}Now combine over the common denominator $2x_n^2 - 1$. The numerator expands to:\\begin{aligned} &x_n(2x_n^2 - 1) \\cr &\\quad - (x_n^3 - x_n \\ln x_n - 3x_n) \\cr &\\quad = 2x_n^3 - x_n - x_n^3 \\cr &\\qquad + x_n \\ln x_n + 3x_n \\cr &\\quad = x_n^3 + x_n \\ln x_n + 2x_n \\end{aligned}Placing this over the common denominator yields:\\begin{aligned} x_{n+1} &= \\dfrac{x_n^3 + x_n \\ln x_n + 2x_n}{2x_n^2 - 1} \\end{aligned}This matches the required formula.",
                        "<strong>Step 4: Perform the iterations for part (b)</strong><br>Substitute $x_1 = 2$ into the formula to calculate $x_2$:\\begin{aligned} x_2 &= \\dfrac{2^3 + 2\\ln 2 + 2(2)}{2(2)^2 - 1} \\cr &= \\dfrac{8 + 2\\ln 2 + 4}{7} \\cr &= \\dfrac{12 + 2\\ln 2}{7} \\cr &\\approx 1.912 \\cr &\\approx 1.91 \\text{ (to 3 s.f.)} \\end{aligned}Now, substitute $x_2 \\approx 1.912$ back into the formula to find $x_3$:\\begin{aligned} x_3 &\\approx \\dfrac{6.990 + 1.239 + 3.824}{6.311} \\cr &\\approx \\dfrac{12.053}{6.311} \\cr &\\approx 1.91 \\text{ (to 3 s.f.)} \\end{aligned}",
                        "<strong>Step 5: Formulate the explanation for part (c)</strong><br>Evaluate the derivative $f'(x) = 2x - \\dfrac{1}{x}$ at our starting value $x_1 = \\dfrac{1}{\\sqrt{2}}$:\\begin{aligned} &f'\\left(\\dfrac{1}{\\sqrt{2}}\\right) \\cr &\\quad = 2\\left(\\dfrac{1}{\\sqrt{2}}\\right) \\cr &\\qquad - \\dfrac{1}{\\left(\\dfrac{1}{\\sqrt{2}}\\right)} \\cr &\\quad = \\sqrt{2} - \\sqrt{2} \\cr &\\quad = 0 \\end{aligned}Because the derivative $f'(x_n)$ is $0$, the Newton-Raphson formula is undefined due to division by zero. Thus, the method cannot be used.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) Formula verified} \\cr &\\text{(b) } x_2 \\approx 1.91, \\; x_3 \\approx 1.91 \\cr &\\text{(c) } f'\\left(\\dfrac{1}{\\sqrt{2}}\\right) = 0 \\cr &\\quad\\implies \\text{division by zero} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x_2 \\approx 1.91, \\; x_3 \\approx 1.91 \\cr &\\ln\\left(\\dfrac{1}{\\sqrt{2}}\\right) \\text{ is negative} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x_2 \\approx 1.91, \\; x_3 \\approx 1.91 \\cr &\\text{Starting value is a fraction} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x_2 \\approx 1.71, \\; x_3 \\approx 1.71 \\cr &\\text{Derivative is zero} \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The equation $\\mathrm{e}^x + 3x - 4 = 0$ has exactly one real root.<br><br><strong>(a)</strong> Show that, for this equation, the Newton-Raphson formula can be written as:\\begin{aligned} x_{n+1} &= \\dfrac{(x_n - 1)\\mathrm{e}^{x_n} + 4}{\\mathrm{e}^{x_n} + 3} \\end{aligned} [3]<br><br><strong>(b)</strong> Using the formula given in part (a) with a starting value of $x_1 = 0$, find the values of $x_2$ and $x_3$, giving your answers to three significant figures. [2]<br><br><strong>(c)</strong> Explain whether or not the Newton-Raphson method can fail due to division by zero for any real starting value of $x_1$. [1]",
                "steps": [
                        "<strong>Step 1: Define the function and find its derivative for part (a)</strong><br>Let $f(x) = \\mathrm{e}^x + 3x - 4$. Differentiate $f(x)$ with respect to $x$:\\begin{aligned} f'(x) &= \\dfrac{\\text{d}}{\\text{d}x}(\\mathrm{e}^x + 3x - 4) \\cr &= \\mathrm{e}^x + 3 \\end{aligned}",
                        "<strong>Step 2: Set up the Newton-Raphson recurrence relation</strong><br>The general Newton-Raphson formula is $x_{n+1} = x_n - \\dfrac{f(x_n)}{f'(x_n)}$. Substitute our expressions:\\begin{aligned} &x_{n+1} \\cr &\\quad = x_n - \\dfrac{\\mathrm{e}^{x_n} + 3x_n - 4}{\\mathrm{e}^{x_n} + 3} \\end{aligned}",
                        "<strong>Step 3: Combine into a single algebraic fraction to complete part (a)</strong><br>Combine over a common denominator.<br><br>The numerator expands to:\\begin{aligned} &x_n(\\mathrm{e}^{x_n} + 3) \\cr &\\quad - (\\mathrm{e}^{x_n} + 3x_n - 4) \\cr &\\quad = x_n \\mathrm{e}^{x_n} + 3x_n - \\mathrm{e}^{x_n} \\cr &\\qquad - 3x_n + 4 \\cr &\\quad = x_n \\mathrm{e}^{x_n} - \\mathrm{e}^{x_n} + 4 \\cr &\\quad = (x_n - 1)\\mathrm{e}^{x_n} + 4 \\end{aligned}Placing this over the common denominator yields:\\begin{aligned} x_{n+1} &= \\dfrac{(x_n - 1)\\mathrm{e}^{x_n} + 4}{\\mathrm{e}^{x_n} + 3} \\end{aligned}This matches the required formula.",
                        "<strong>Step 4: Perform the iterations for part (b)</strong><br>Substitute $x_1 = 0$ into the formula to calculate $x_2$:\\begin{aligned} x_2 &= \\dfrac{(0 - 1)\\mathrm{e}^0 + 4}{\\mathrm{e}^0 + 3} \\cr &= \\dfrac{(-1)(1) + 4}{1 + 3} \\cr &= \\dfrac{3}{4} \\cr &= 0.750 \\quad \\text{(to 3 s.f.)} \\end{aligned}Now, substitute $x_2 = 0.75$ back into the formula to find $x_3$:\\begin{aligned} x_3 &= \\dfrac{(0.75 - 1)\\mathrm{e}^{0.75} + 4}{\\mathrm{e}^{0.75} + 3} \\cr &\\approx \\dfrac{(-0.25)(2.1170) + 4}{2.1170 + 3} \\cr &\\approx \\dfrac{3.47075}{5.1170} \\cr &\\approx 0.678 \\quad \\text{(to 3 s.f.)} \\end{aligned}",
                        "<strong>Step 5: Formulate the explanation for part (c)</strong><br>For the Newton-Raphson method to fail due to division by zero, the derivative $f'(x)$ must be equal to zero at some starting value $x_1$.<br><br>Our derivative is $f'(x) = \\mathrm{e}^x + 3$.<br><br>Since $\\mathrm{e}^x > 0$ for all real values of $x$, it follows that:\\begin{aligned} &f'(x) \\ge 3 > 0 \\cr &\\text{for all } x \\in \\mathbb{R} \\end{aligned}Since the derivative is strictly positive and can never be zero, the Newton-Raphson method <strong>cannot</strong> fail due to division by zero for any real starting value.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) Formula verified} \\cr &\\text{(b) } x_2 = 0.750, \\; x_3 \\approx 0.678 \\cr &\\text{(c) } f'(x) \\ge 3 > 0 \\text{ for all } x \\cr &\\quad\\implies \\text{cannot divide by zero} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x_2 = 0.750, \\; x_3 \\approx 0.678 \\cr &\\mathrm{e}^x + 3 = 0 \\implies x = \\ln(-3) \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x_2 = 0.750, \\; x_3 \\approx 0.678 \\cr &\\text{Fails for } x_1 = -4 \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x_2 = 0.500, \\; x_3 \\approx 0.450 \\cr &\\text{Cannot fail by division by } 0 \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The equation $x^3 - 3x - 1 = 0$ has a real root in the interval $[1.5, 2]$.<br><br><strong>(a)</strong> Show that, for this equation, the Newton-Raphson formula can be written as:\\begin{aligned} x_{n+1} &= \\dfrac{2x_n^3 + 1}{3x_n^2 - 3} \\end{aligned} [3]<br><br><strong>(b)</strong> Using the formula given in part (a) with a starting value of $x_1 = 2$, find the values of $x_2$ and $x_3$, giving your answers to three significant figures. [2]<br><br><strong>(c)</strong> Explain why, for this equation, the Newton-Raphson method cannot be used with a starting value of $x_1 = 1$. [1]",
                "steps": [
                        "<strong>Step 1: Define the function and find its derivative for part (a)</strong><br>Let $f(x) = x^3 - 3x - 1$. Differentiate $f(x)$ with respect to $x$:\\begin{aligned} f'(x) &= \\dfrac{\\text{d}}{\\text{d}x}(x^3 - 3x - 1) \\cr &= 3x^2 - 3 \\end{aligned}",
                        "<strong>Step 2: Set up the Newton-Raphson recurrence relation</strong><br>The general Newton-Raphson formula is $x_{n+1} = x_n - \\dfrac{f(x_n)}{f'(x_n)}$. Substitute our expressions:\\begin{aligned} &x_{n+1} \\cr &\\quad = x_n - \\dfrac{x_n^3 - 3x_n - 1}{3x_n^2 - 3} \\end{aligned}",
                        "<strong>Step 3: Combine into a single algebraic fraction to complete part (a)</strong><br>Combine over a common denominator.<br><br>The numerator expands to:\\begin{aligned} &x_n(3x_n^2 - 3) \\cr &\\quad - (x_n^3 - 3x_n - 1) \\cr &\\quad = 3x_n^3 - 3x_n - x_n^3 \\cr &\\qquad + 3x_n + 1 \\cr &\\quad = 2x_n^3 + 1 \\end{aligned}Placing this over the common denominator yields:\\begin{aligned} x_{n+1} &= \\dfrac{2x_n^3 + 1}{3x_n^2 - 3} \\end{aligned}This matches the required formula.",
                        "<strong>Step 4: Perform the iterations for part (b)</strong><br>Substitute $x_1 = 2$ into the formula to calculate $x_2$:\\begin{aligned} x_2 &= \\dfrac{2(2)^3 + 1}{3(2)^2 - 3} \\cr &= \\dfrac{16 + 1}{12 - 3} \\cr &= \\dfrac{17}{9} \\cr &\\approx 1.89 \\quad \\text{(to 3 s.f.)} \\end{aligned}Now, substitute $x_2 = \\dfrac{17}{9}$ back into the formula to find $x_3$:\\begin{aligned} x_3 &= \\dfrac{2\\left(\\dfrac{17}{9}\\right)^3 + 1}{3\\left(\\dfrac{17}{9}\\right)^2 - 3} \\cr &= \\dfrac{10555}{5616} \\cr &\\approx 1.88 \\quad \\text{(to 3 s.f.)} \\end{aligned}",
                        "<strong>Step 5: Formulate the explanation for part (c)</strong><br>Evaluate the derivative $f'(x) = 3x^2 - 3$ at our starting value $x_1 = 1$:\\begin{aligned} f'(1) &= 3(1)^2 - 3 \\cr &= 0 \\end{aligned}The Newton-Raphson formula involves dividing by the value of the derivative, $f'(x_n)$. Because $f'(1) = 0$, starting with $x_1 = 1$ results in division by zero, which is undefined. Geometrically, this means the tangent to the curve at $x = 1$ is horizontal and does not intersect the $x$-axis to provide a next approximation.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) Formula verified} \\cr &\\text{(b) } x_2 \\approx 1.89, \\; x_3 \\approx 1.88 \\cr &\\text{(c) } f'(1) = 0 \\cr &\\quad\\implies \\text{division by zero} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x_2 \\approx 1.89, \\; x_3 \\approx 1.88 \\cr &1 \\text{ is too close to the root} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x_2 \\approx 1.89, \\; x_3 \\approx 1.88 \\cr &\\text{Curve has an asymptote at } x = 1 \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x_2 \\approx 1.89, \\; x_3 \\approx 1.89 \\cr &\\text{Derivative is zero} \\end{aligned}",
        ...
        },
{
        ...
        "img": false,
        "question": "\\begin{aligned} &f(x) = -2x^3 + 8x^2 - 9x + 9 \\cr &x \\in \\mathbb{R} \\end{aligned}<strong>(a) (i)</strong> Calculate $f(3)$.<br><br><strong>(ii)</strong> Write $f(x)$ as a product of two algebraic factors.<br><br>Using the answer to <strong>(a)(ii)</strong>:<br><br><strong>(b)</strong> Prove that there are exactly two real solutions to the equation $-2y^6 + 8y^4 - 9y^2 + 9 = 0$.<br><br><strong>(c)</strong> Deduce the number of real solutions, for $5\\pi \\le \\theta < 9\\pi$, to the equation:\\begin{aligned} &2\\tan^3\\theta - 8\\tan^2\\theta \\cr &\\quad + 9\\tan\\theta - 9 = 0 \\end{aligned}State the real solutions to the equation in <strong>(b)</strong> and the number of solutions in <strong>(c)</strong>.",
        "steps": [
                "<strong>Part (a)(i):</strong><br>Substitute $x = 3$ into the expression for $f(x)$:\\begin{aligned} &f(3) = -2(3)^3 + 8(3)^2 \\cr &\\qquad - 9(3) + 9 \\cr &\\quad = -54 + 72 - 27 + 9 \\cr &\\quad = 0 \\end{aligned}Since $f(3) = 0$, $x = 3$ is a root, which means $(x - 3)$ is a linear factor of $f(x)$.",
                "<strong>Part (a)(ii):</strong><br>Divide $-2x^3 + 8x^2 - 9x + 9$ by $(x - 3)$ using equating coefficients:\\begin{aligned} &f(x) \\cr &\\quad = (x - 3)(-2x^2 + px + q) \\cr &\\quad = -2x^3 + (p + 6)x^2 \\cr &\\qquad + (q - 3p)x - 3q \\end{aligned}Equating coefficients gives:\\begin{aligned} p + 6 &= 8 \\cr p &= 2 \\cr -3q &= 9 \\cr q &= -3 \\end{aligned}Thus, the factored expression is:\\begin{aligned} f(x) &= (x - 3)(-2x^2 + 2x - 3) \\cr &= (3 - x)(2x^2 - 2x + 3) \\end{aligned}We check the discriminant of the quadratic factor $2x^2 - 2x + 3$:\\begin{aligned} \\Delta &= (-2)^2 - 4(2)(3) \\cr &= 4 - 24 \\cr &= -20 \\end{aligned}Since $\\Delta = -20 < 0$, the quadratic factor has no real roots. Therefore, $x = 3$ is the unique real root of $f(x) = 0$.",
                "<strong>Part (b):</strong><br>We want to find the real solutions to:$$-2y^6 + 8y^4 - 9y^2 + 9 = 0$$Let $x = y^2$. This transforms the equation into:$$-2x^3 + 8x^2 - 9x + 9 = 0$$Which is exactly $f(x) = 0$. Since we showed in part <strong>(a)(ii)</strong> that the only real root is $x = 3$, we have:\\begin{aligned} y^2 &= 3 \\cr y &= \\pm\\sqrt{3} \\end{aligned}The other factor yields $-2(y^2)^2 + 2(y^2) - 3 = 0$, which has no real solutions because its discriminant is negative. Thus, there are exactly two real solutions:$$y = \\pm\\sqrt{3}$$",
                "<strong>Part (c):</strong><br>The equation is:\\begin{aligned} &2\\tan^3\\theta - 8\\tan^2\\theta \\cr &\\quad + 9\\tan\\theta - 9 = 0 \\end{aligned}Multiplying the entire equation by $-1$, we get:\\begin{aligned} &-2\\tan^3\\theta + 8\\tan^2\\theta \\cr &\\quad - 9\\tan\\theta + 9 = 0 \\end{aligned}Let $x = \\tan\\theta$. This equation becomes $f(x) = 0$, which has only one real root, $x = 3$. Therefore:$$\\tan\\theta = 3$$We need to find the number of solutions in the interval $5\\pi \\le \\theta < 9\\pi$.<br><br>The width of the interval is $9\\pi - 5\\pi = 4\\pi$. Since the tangent function $\\tan\\theta$ has a period of $\\pi$, it completes exactly $4$ full cycles over this interval.<br><br>In each period, the equation $\\tan\\theta = 3$ has exactly one unique solution. Thus, there are exactly $4$ real solutions.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a)(i) } f(3) = 0 \\cr &\\text{(a)(ii) } f(x) \\cr &\\quad = (3 - x)(2x^2 - 2x + 3) \\cr &\\text{(b) } y = \\pm\\sqrt{3} \\cr &\\text{(c) } 4 \\text{ real solutions} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &y = \\pm 3 \\cr &8\\text{ solutions} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &y = \\sqrt{3} \\cr &2\\text{ solutions} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &y = \\pm\\sqrt{3} \\cr &2\\text{ solutions} \\end{aligned}",
...
},
{
        ...
        "img": false,
        "question": "\\begin{aligned} &f(x) = 2x^3 + x^2 + x - 4 \\cr &x \\in \\mathbb{R} \\end{aligned}<strong>(a) (i)</strong> Calculate $f(1)$.<br><br><strong>(ii)</strong> Write $f(x)$ as a product of two algebraic factors.<br><br>Using the answer to <strong>(a)(ii)</strong>:<br><br><strong>(b)</strong> Prove that there are exactly two real solutions to the equation $2y^{12} + y^8 + y^4 - 4 = 0$.<br><br><strong>(c)</strong> Deduce the number of real solutions, for $0 \\le \\theta < 4\\pi$, to the equation:\\begin{aligned} &2\\sin^3\\theta + \\sin^2\\theta \\cr &\\quad + \\sin\\theta - 4 = 0 \\end{aligned}State the real solutions to the equation in <strong>(b)</strong> and the number of solutions in <strong>(c)</strong>.",
        "steps": [
                "<strong>Part (a)(i):</strong><br>Substitute $x = 1$ into the expression for $f(x)$:\\begin{aligned} f(1) &= 2(1)^3 + 1^2 + 1 - 4 \\cr &= 2 + 1 + 1 - 4 \\cr &= 0 \\end{aligned}Since $f(1) = 0$, $x = 1$ is a root, meaning $(x - 1)$ is a linear factor of $f(x)$.",
                "<strong>Part (a)(ii):</strong><br>Divide $2x^3 + x^2 + x - 4$ by $(x - 1)$:\\begin{aligned} &2x^3 + x^2 + x - 4 \\cr &\\quad = (x - 1)(2x^2 + 3x + 4) \\end{aligned}We check the discriminant of the quadratic factor $2x^2 + 3x + 4$:\\begin{aligned} \\Delta &= 3^2 - 4(2)(4) \\cr &= 9 - 32 \\cr &= -23 \\end{aligned}Since $\\Delta = -23 < 0$, the quadratic factor has no real roots. Thus, $x = 1$ is the unique real root of $f(x) = 0$.",
                "<strong>Part (b):</strong><br>We solve:$$2y^{12} + y^8 + y^4 - 4 = 0$$Let $x = y^4$. The equation becomes:$$2x^3 + x^2 + x - 4 = 0$$This is exactly $f(x) = 0$. Since $x = 1$ is the unique real root, we have:\\begin{aligned} y^4 &= 1 \\cr y^2 &= 1 \\cr y &= \\pm 1 \\end{aligned}The other branch $y^4 < 0$ has no real roots. Thus, there are exactly two real solutions: $y = \\pm 1$.",
                "<strong>Part (c):</strong><br>The equation is:\\begin{aligned} &2\\sin^3\\theta + \\sin^2\\theta \\cr &\\quad + \\sin\\theta - 4 = 0 \\end{aligned}Let $x = \\sin\\theta$. This yields $f(x) = 0 \\implies \\sin\\theta = 1$.<br><br>We look for solutions in the interval $0 \\le \\theta < 4\\pi$, which represents two complete periods of the sine function.<br><br>The sine function equals $1$ exactly once per period (at the maximum point of each cycle):\\begin{aligned} \\theta &= \\dfrac{\\pi}{2} \\cr \\theta &= \\dfrac{5\\pi}{2} \\end{aligned}Thus, there are exactly $2$ real solutions.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a)(i) } f(1) = 0 \\cr &\\text{(a)(ii) } f(x) \\cr &\\quad = (x - 1)(2x^2 + 3x + 4) \\cr &\\text{(b) } y = \\pm 1 \\cr &\\text{(c) } 2 \\text{ real solutions} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &y = 1 \\cr &4\\text{ solutions} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &y = \\pm 1 \\cr &4\\text{ solutions} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &y = \\pm 1 \\cr &0\\text{ solutions} \\end{aligned}",
...
},
{
        ...
        "img": false,
        "question": "\\begin{aligned} &f(x) = x^3 + x^2 + x + 6 \\cr &x \\in \\mathbb{R} \\end{aligned}<strong>(a) (i)</strong> Calculate $f(-2)$.<br><br><strong>(ii)</strong> Write $f(x)$ as a product of two algebraic factors.<br><br>Using the answer to <strong>(a)(ii)</strong>:<br><br><strong>(b)</strong> Prove that there is exactly one real solution to the equation $y^9 + y^6 + y^3 + 6 = 0$.<br><br><strong>(c)</strong> Deduce the number of real solutions, for $0 \\le \\theta < 2\\pi$, to the equation:\\begin{aligned} &\\cos^3\\theta + \\cos^2\\theta \\cr &\\quad + \\cos\\theta + 6 = 0 \\end{aligned}State the real solutions to the equation in <strong>(b)</strong> and the number of solutions in <strong>(c)</strong>.",
        "steps": [
                "<strong>Part (a)(i):</strong><br>Substitute $x = -2$ into $f(x)$:\\begin{aligned} f(-2) &= (-2)^3 + (-2)^2 - 2 + 6 \\cr &= -8 + 4 - 2 + 6 \\cr &= 0 \\end{aligned}Since $f(-2) = 0$, $x = -2$ is a root, meaning $(x + 2)$ is a linear factor of $f(x)$.",
                "<strong>Part (a)(ii):</strong><br>Divide $x^3 + x^2 + x + 6$ by $(x + 2)$:\\begin{aligned} &x^3 + x^2 + x + 6 \\cr &\\quad = (x + 2)(x^2 - x + 3) \\end{aligned}We check the discriminant of the quadratic factor $x^2 - x + 3$:\\begin{aligned} \\Delta &= (-1)^2 - 4(1)(3) \\cr &= 1 - 12 \\cr &= -11 \\end{aligned}Since $\\Delta = -11 < 0$, there are no real roots from this quadratic factor. Thus, $x = -2$ is the unique real root of $f(x) = 0$.",
                "<strong>Part (b):</strong><br>We solve:$$y^9 + y^6 + y^3 + 6 = 0$$Let $x = y^3$. The equation becomes:$$x^3 + x^2 + x + 6 = 0$$This is $f(x) = 0$. Since $x = -2$ is the only real root, we have:\\begin{aligned} y^3 &= -2 \\cr y &= -\\sqrt[3]{2} \\end{aligned}Unlike even powers, a real number has exactly one real cube root. Hence, there is exactly one real solution: $y = -\\sqrt[3]{2}$.",
                "<strong>Part (c):</strong><br>The equation is:\\begin{aligned} &\\cos^3\\theta + \\cos^2\\theta \\cr &\\quad + \\cos\\theta + 6 = 0 \\end{aligned}Let $x = \\cos\\theta$. This equation becomes $f(x) = 0$, which requires:$$\\cos\\theta = -2$$However, the cosine function has a strict range of $[-1, 1]$. Since $-2$ is outside this range, there are no real values of $\\theta$ that satisfy this equation. Thus, there are $0$ real solutions.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a)(i) } f(-2) = 0 \\cr &\\text{(a)(ii) } f(x) \\cr &\\quad = (x + 2)(x^2 - x + 3) \\cr &\\text{(b) } y = -\\sqrt[3]{2} \\cr &\\text{(c) } 0 \\text{ real solutions} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &y = \\pm\\sqrt[3]{2} \\cr &2\\text{ solutions} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &y = -\\sqrt[3]{2} \\cr &1\\text{ solution} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &y = -2 \\cr &0\\text{ solutions} \\end{aligned}",
...
},
{
        ...
        "img": false,
        "question": "\\begin{aligned} &f(x) = 2x^3 + 3x^2 + 2x - 2 \\cr &x \\in \\mathbb{R} \\end{aligned}<strong>(a) (i)</strong> Calculate $f(0.5)$.<br><br><strong>(ii)</strong> Write $f(x)$ as a product of two algebraic factors.<br><br>Using the answer to <strong>(a)(ii)</strong>:<br><br><strong>(b)</strong> Prove that there are exactly two real solutions to the equation $2y^6 + 3y^4 + 2y^2 - 2 = 0$.<br><br><strong>(c)</strong> Deduce the number of real solutions, for $0 \\le \\theta < 4\\pi$, to the equation:\\begin{aligned} &2\\cos^3\\theta + 3\\cos^2\\theta \\cr &\\quad + 2\\cos\\theta - 2 = 0 \\end{aligned}State the real solutions to the equation in <strong>(b)</strong> and the number of solutions in <strong>(c)</strong>.",
        "steps": [
                "<strong>Part (a)(i):</strong><br>Substitute $x = 0.5$ (or $x = \\dfrac{1}{2}$) into $f(x)$:\\begin{aligned} &f\\left(\\dfrac{1}{2}\\right) \\cr &\\quad = 2\\left(\\dfrac{1}{2}\\right)^3 + 3\\left(\\dfrac{1}{2}\\right)^2 \\cr &\\qquad + 2\\left(\\dfrac{1}{2}\\right) - 2 \\cr &\\quad = 2\\left(\\dfrac{1}{8}\\right) + 3\\left(\\dfrac{1}{4}\\right) + 1 - 2 \\cr &\\quad = \\dfrac{1}{4} + \\dfrac{3}{4} + 1 - 2 \\cr &\\quad = 0 \\end{aligned}Since $f(0.5) = 0$, $x = 0.5$ is a root, meaning $(2x - 1)$ is a linear factor of $f(x)$.",
                "<strong>Part (a)(ii):</strong><br>Divide $2x^3 + 3x^2 + 2x - 2$ by $(2x - 1)$:\\begin{aligned} &2x^3 + 3x^2 + 2x - 2 \\cr &\\quad = (2x - 1)(x^2 + 2x + 2) \\end{aligned}We check the discriminant of the quadratic factor $x^2 + 2x + 2$:\\begin{aligned} \\Delta &= 2^2 - 4(1)(2) \\cr &= 4 - 8 \\cr &= -4 \\end{aligned}Since $\\Delta = -4 < 0$, the quadratic factor has no real roots. Thus, $x = 0.5$ is the only real root of $f(x) = 0$.",
                "<strong>Part (b):</strong><br>We solve:$$2y^6 + 3y^4 + 2y^2 - 2 = 0$$Let $x = y^2$. The equation transforms to $f(x) = 0$, which has the unique real solution $x = 0.5$. Therefore:\\begin{aligned} y^2 &= \\dfrac{1}{2} \\cr y &= \\pm\\dfrac{1}{\\sqrt{2}} \\cr &= \\pm\\dfrac{\\sqrt{2}}{2} \\end{aligned}Since the other factor has a negative discriminant, no further real solutions exist. There are exactly two real solutions: $y = \\pm\\dfrac{\\sqrt{2}}{2}$.",
                "<strong>Part (c):</strong><br>The equation is:\\begin{aligned} &2\\cos^3\\theta + 3\\cos^2\\theta \\cr &\\quad + 2\\cos\\theta - 2 = 0 \\end{aligned}Let $x = \\cos\\theta$. This equation becomes $f(x) = 0$, which has only one real solution, $x = 0.5$. Thus:\\begin{aligned} \\cos\\theta &= \\dfrac{1}{2} \\end{aligned}We seek solutions in the interval $0 \\le \\theta < 4\\pi$, representing two complete periods of the cosine function.<br><br>In each period $[0, 2\\pi)$, the equation $\\cos\\theta = 0.5$ has exactly 2 solutions (at $\\theta = \\dfrac{\\pi}{3}$ and $\\theta = \\dfrac{5\\pi}{3}$).<br><br>Therefore, over two full periods, there are exactly $4$ real solutions.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a)(i) } f(0.5) = 0 \\cr &\\text{(a)(ii) } f(x) \\cr &\\quad = (2x - 1)(x^2 + 2x + 2) \\cr &\\text{(b) } y = \\pm\\dfrac{\\sqrt{2}}{2} \\cr &\\text{(c) } 4 \\text{ real solutions} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &y = \\pm\\dfrac{1}{2} \\cr &2\\text{ solutions} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &y = \\pm\\dfrac{\\sqrt{2}}{2} \\cr &2\\text{ solutions} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &y = \\dfrac{\\sqrt{2}}{2} \\cr &4\\text{ solutions} \\end{aligned}",
...
},
{
        ...
        "img": false,
        "question": "\\begin{aligned} &f(x) = 4x^3 - 2x^2 + x - 3 \\cr &x \\in \\mathbb{R} \\end{aligned}<strong>(a) (i)</strong> Calculate $f(1)$.<br><br><strong>(ii)</strong> Write $f(x)$ as a product of two algebraic factors.<br><br>Using the answer to <strong>(a)(ii)</strong>:<br><br><strong>(b)</strong> Prove that there is exactly one real solution to the equation $4\\mathrm{e}^{3y} - 2\\mathrm{e}^{2y} + \\mathrm{e}^y - 3 = 0$.<br><br><strong>(c)</strong> Deduce the number of real solutions, for $0 \\le \\theta < \\pi$, to the equation:\\begin{aligned} &4\\tan^3(2\\theta) - 2\\tan^2(2\\theta) \\cr &\\quad + \\tan(2\\theta) - 3 = 0 \\end{aligned}State the real solutions to the equation in <strong>(b)</strong> and the number of solutions in <strong>(c)</strong>.",
        "steps": [
                "<strong>Part (a)(i):</strong><br>Substitute $x = 1$ into $f(x)$:\\begin{aligned} f(1) &= 4(1)^3 - 2(1)^2 + 1 - 3 \\cr &= 4 - 2 + 1 - 3 \\cr &= 0 \\end{aligned}Since $f(1) = 0$, $x = 1$ is a root, meaning $(x - 1)$ is a linear factor of $f(x)$.",
                "<strong>Part (a)(ii):</strong><br>Divide $4x^3 - 2x^2 + x - 3$ by $(x - 1)$:\\begin{aligned} &4x^3 - 2x^2 + x - 3 \\cr &\\quad = (x - 1)(4x^2 + 2x + 3) \\end{aligned}We check the discriminant of the quadratic factor $4x^2 + 2x + 3$:\\begin{aligned} \\Delta &= 2^2 - 4(4)(3) \\cr &= 4 - 48 \\cr &= -44 \\end{aligned}Since $\\Delta = -44 < 0$, the quadratic factor has no real roots. Thus, $x = 1$ is the unique real root of $f(x) = 0$.",
                "<strong>Part (b):</strong><br>We solve:$$4\\mathrm{e}^{3y} - 2\\mathrm{e}^{2y} + \\mathrm{e}^y - 3 = 0$$Let $x = \\mathrm{e}^y$ (where $x > 0$). The equation becomes $f(x) = 0$.<br><br>Since the unique real root is $x = 1$, we have:\\begin{aligned} \\mathrm{e}^y &= 1 \\cr y &= \\ln(1) \\cr &= 0 \\end{aligned}Since the quadratic factor yields no real roots, $y = 0$ is the single unique real solution.",
                "<strong>Part (c):</strong><br>The equation is:\\begin{aligned} &4\\tan^3(2\\theta) - 2\\tan^2(2\\theta) \\cr &\\quad + \\tan(2\\theta) - 3 = 0 \\end{aligned}Let $u = \\tan(2\\theta)$. This equation becomes $f(u) = 0$, which has only one real solution, $u = 1$. Thus:$$\\tan(2\\theta) = 1$$We search for solutions in the interval $0 \\le \\theta < \\pi$. Since the argument of the tangent function is $2\\theta$, we must scale the domain:$$0 \\le 2\\theta < 2\\pi$$The tangent function $\\tan(2\\theta)$ has a period of $\\pi$. Therefore, in the interval $[0, 2\\pi)$, the equation $\\tan(2\\theta) = 1$ has exactly two solutions (at $2\\theta = \\dfrac{\\pi}{4}$ and $2\\theta = \\dfrac{5\\pi}{4}$).<br><br>Thus, there are exactly $2$ real solutions for $\\theta$.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a)(i) } f(1) = 0 \\cr &\\text{(a)(ii) } f(x) \\cr &\\quad = (x - 1)(4x^2 + 2x + 3) \\cr &\\text{(b) } y = 0 \\cr &\\text{(c) } 2 \\text{ real solutions} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &y = 1 \\cr &4\\text{ solutions} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &y = 0 \\cr &1\\text{ solution} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &\\text{No real solutions for } y \\cr &2\\text{ solutions} \\end{aligned}",
...
},
{
        ...
        "steps": [
                "<strong>Part (a):</strong><br>We solve the equation $4\\cos x = \\csc x$ in the interval $0 \\le x < \\dfrac{\\pi}{2}$:\\begin{aligned} 4\\cos x &= \\dfrac{1}{\\sin x} \\cr 4\\sin x\\cos x &= 1 \\cr 2(2\\sin x\\cos x) &= 1 \\cr 2\\sin(2x) &= 1 \\cr \\sin(2x) &= \\dfrac{1}{2} \\end{aligned}Since $0 \\le x < \\dfrac{\\pi}{2}$, we have $0 \\le 2x < \\pi$. Thus:\\begin{aligned} 2x &= \\dfrac{\\pi}{6}, \\quad \\dfrac{5\\pi}{6} \\cr x &= \\dfrac{\\pi}{12}, \\quad \\dfrac{5\\pi}{12} \\end{aligned}",
                "<strong>Part (b):</strong><br>We solve $3\\sin\\theta - 3\\cos\\theta = 2$ using the harmonic form $R\\sin(\\theta - \\alpha)$:\\begin{aligned} R\\cos\\alpha &= 3 \\cr R\\sin\\alpha &= 3 \\end{aligned}This gives:\\begin{aligned} R &= \\sqrt{3^2 + 3^2} \\cr &= \\sqrt{18} \\cr &= 3\\sqrt{2} \\end{aligned}and:\\begin{aligned} \\tan\\alpha &= \\dfrac{3}{3} \\cr &= 1 \\cr \\alpha &= 45^\\circ \\end{aligned}So the equation becomes:\\begin{aligned} 3\\sqrt{2}\\sin(\\theta - 45^\\circ) &= 2 \\cr \\sin(\\theta - 45^\\circ) &= \\dfrac{2}{3\\sqrt{2}} \\cr &= \\dfrac{\\sqrt{2}}{3} \\end{aligned}We find the principal angle using a calculator:\\begin{aligned} \\theta - 45^\\circ &= \\arcsin\\left(\\dfrac{\\sqrt{2}}{3}\\right) \\cr &\\approx 28.13^\\circ \\end{aligned}For $0 \\le \\theta < 360^\\circ$, we have $-45^\\circ \\le \\theta - 45^\\circ < 315^\\circ$. The valid solutions for $\\theta - 45^\\circ$ are:\\begin{aligned} \\theta - 45^\\circ &\\approx 28.13^\\circ \\cr \\theta &\\approx 28.13^\\circ + 45^\\circ \\cr &\\approx 73.1^\\circ \\end{aligned}and:\\begin{aligned} \\theta - 45^\\circ &\\approx 180^\\circ - 28.13^\\circ \\cr &\\approx 151.87^\\circ \\cr \\theta &\\approx 151.87^\\circ + 45^\\circ \\cr &\\approx 196.9^\\circ \\end{aligned}Thus, the solutions to 1 decimal place are $\\theta = 73.1^\\circ$ and $\\theta = 196.9^\\circ$.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) } x = \\dfrac{\\pi}{12}, \\; \\dfrac{5\\pi}{12} \\cr &\\text{(b) } \\theta \\approx 73.1^\\circ, \\; 196.9^\\circ \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{6}, \\; \\dfrac{5\\pi}{6} \\cr &\\theta = 73.1^\\circ, \\; 196.9^\\circ \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{12}, \\; \\dfrac{5\\pi}{12} \\cr &\\theta = 28.1^\\circ, \\; 151.9^\\circ \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{12}, \\; \\dfrac{5\\pi}{12} \\cr &\\theta = 73.1^\\circ, \\; 286.9^\\circ \\end{aligned}",
...
},
{
        ...
        "steps": [
                "<strong>Part (a):</strong><br>We use the fundamental identity $\\cos^2 x = 1 - \\sin^2 x$ to rewrite the equation in terms of $\\sin x$:\\begin{aligned} 2(1 - \\sin^2 x) + 3\\sin x &= 3 \\cr 2 - 2\\sin^2 x + 3\\sin x &= 3 \\cr 2\\sin^2 x - 3\\sin x + 1 &= 0 \\end{aligned}Let $y = \\sin x$. This yields a quadratic equation:\\begin{aligned} 2y^2 - 3y + 1 &= 0 \\cr (2y - 1)(y - 1) &= 0 \\end{aligned}So we solve:\\begin{aligned} &\\sin x = \\dfrac{1}{2} \\cr &\\quad \\implies x = \\dfrac{\\pi}{6}, \\; \\dfrac{5\\pi}{6} \\cr &\\sin x = 1 \\cr &\\quad \\implies x = \\dfrac{\\pi}{2} \\end{aligned}Thus, the three exact solutions in the interval $0 \\le x < \\pi$ are $x = \\dfrac{\\pi}{6}, \\; \\dfrac{\\pi}{2}, \\; \\dfrac{5\\pi}{6}$.",
                "<strong>Part (b):</strong><br>We write $4\\sin\\theta + 3\\cos\\theta = 2$ in the harmonic form $R\\sin(\\theta + \\alpha)$:\\begin{aligned} R\\cos\\alpha &= 4 \\cr R\\sin\\alpha &= 3 \\end{aligned}This gives:\\begin{aligned} R &= \\sqrt{4^2 + 3^2} \\cr &= 5 \\end{aligned}and:\\begin{aligned} \\tan\\alpha &= \\dfrac{3}{4} \\cr \\alpha &\\approx 36.87^\\circ \\end{aligned}So the equation becomes:\\begin{aligned} 5\\sin(\\theta + 36.87^\\circ) &= 2 \\cr \\sin(\\theta + 36.87^\\circ) &= 0.4 \\end{aligned}We find the principal angle using a calculator:\\begin{aligned} \\theta + 36.87^\\circ &= \\arcsin(0.4) \\cr &\\approx 23.58^\\circ \\end{aligned}For $0 \\le \\theta < 360^\\circ$, we have $36.87^\\circ \\le \\theta + 36.87^\\circ < 396.87^\\circ$. The valid solutions for $\\theta + 36.87^\\circ$ are:\\begin{aligned} \\theta + 36.87^\\circ &\\approx 180^\\circ - 23.58^\\circ \\cr &\\approx 156.42^\\circ \\cr \\theta &\\approx 156.42^\\circ - 36.87^\\circ \\cr &\\approx 119.6^\\circ \\end{aligned}and:\\begin{aligned} \\theta + 36.87^\\circ &\\approx 360^\\circ + 23.58^\\circ \\cr &\\approx 383.58^\\circ \\cr \\theta &\\approx 383.58^\\circ - 36.87^\\circ \\cr &\\approx 346.7^\\circ \\end{aligned}Note that $23.58^\\circ - 36.87^\\circ = -13.29^\\circ$, which falls outside the required range of $0 \\le \\theta < 360^\\circ$. Thus, the solutions to 1 decimal place are $\\theta = 119.6^\\circ$ and $\\theta = 346.7^\\circ$.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) } x = \\dfrac{\\pi}{6}, \\; \\dfrac{\\pi}{2}, \\; \\dfrac{5\\pi}{6} \\cr &\\text{(b) } \\theta \\approx 119.6^\\circ, \\; 346.7^\\circ \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{6}, \\; \\dfrac{5\\pi}{6} \\cr &\\theta = 119.6^\\circ, \\; 346.7^\\circ \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{6}, \\; \\dfrac{\\pi}{2}, \\; \\dfrac{5\\pi}{6} \\cr &\\theta = 119.6^\\circ, \\; 156.4^\\circ \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{6}, \\; \\dfrac{\\pi}{2}, \\; \\dfrac{5\\pi}{6} \\cr &\\theta = -13.3^\\circ, \\; 119.6^\\circ \\end{aligned}",
...
},
{
        ...
        "steps": [
                "<strong>Part (a):</strong><br>We divide both sides of the equation by $\\cos(2x)$ (noting that $\\cos(2x) \\neq 0$) to express the equation in terms of $\\tan(2x)$:\\begin{aligned} \\dfrac{\\sin(2x)}{\\cos(2x)} &= \\sqrt{3} \\cr \\tan(2x) &= \\sqrt{3} \\end{aligned}Since $0 \\le x < \\pi$, we must scale the domain for $2x$:$$0 \\le 2x < 2\\pi$$The solutions for $2x$ are:\\begin{aligned} 2x &= \\dfrac{\\pi}{3}, \\quad \\dfrac{4\\pi}{3} \\cr x &= \\dfrac{\\pi}{6}, \\quad \\dfrac{2\\pi}{3} \\end{aligned}",
                "<strong>Part (b):</strong><br>We write $12\\cos\\theta - 5\\sin\\theta = 4$ in the harmonic form $R\\cos(\\theta + \\alpha)$:\\begin{aligned} R\\cos\\alpha &= 12 \\cr R\\sin\\alpha &= 5 \\end{aligned}This gives:\\begin{aligned} R &= \\sqrt{12^2 + 5^2} \\cr &= 13 \\end{aligned}and:\\begin{aligned} \\tan\\alpha &= \\dfrac{5}{12} \\cr \\alpha &\\approx 22.62^\\circ \\end{aligned}So the equation becomes:\\begin{aligned} 13\\cos(\\theta + 22.62^\\circ) &= 4 \\cr \\cos(\\theta + 22.62^\\circ) &= \\dfrac{4}{13} \\end{aligned}We find the principal angle using a calculator:\\begin{aligned} \\theta + 22.62^\\circ &= \\arccos\\left(\\dfrac{4}{13}\\right) \\cr &\\approx 72.08^\\circ \\end{aligned}For $0 \\le \\theta < 360^\\circ$, we have $22.62^\\circ \\le \\theta + 22.62^\\circ < 382.62^\\circ$. The valid solutions for $\\theta + 22.62^\\circ$ are:\\begin{aligned} \\theta + 22.62^\\circ &\\approx 72.08^\\circ \\cr \\theta &\\approx 72.08^\\circ - 22.62^\\circ \\cr &\\approx 49.5^\\circ \\end{aligned}and:\\begin{aligned} \\theta + 22.62^\\circ &\\approx 360^\\circ - 72.08^\\circ \\cr &\\approx 287.92^\\circ \\cr \\theta &\\approx 287.92^\\circ - 22.62^\\circ \\cr &\\approx 265.3^\\circ \\end{aligned}Thus, the solutions to 1 decimal place are $\\theta = 49.5^\\circ$ and $\\theta = 265.3^\\circ$.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) } x = \\dfrac{\\pi}{6}, \\; \\dfrac{2\\pi}{3} \\cr &\\text{(b) } \\theta \\approx 49.5^\\circ, \\; 265.3^\\circ \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{6} \\cr &\\theta = 49.5^\\circ, \\; 265.3^\\circ \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{6}, \\; \\dfrac{2\\pi}{3} \\cr &\\theta = 49.5^\\circ, \\; 114.7^\\circ \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{3}, \\; \\dfrac{4\\pi}{3} \\cr &\\theta = 49.5^\\circ, \\; 265.3^\\circ \\end{aligned}",
...
},
{
       ...
       "subtopic": [
        ...
        "steps": [
                "<strong>Part (a):</strong><br>We use the identity $\\tan x = \\dfrac{\\sin x}{\\cos x}$ to rewrite the equation (noting that $\\cos x \\neq 0$):\\begin{aligned} 2\\sin x\\left(\\dfrac{\\sin x}{\\cos x}\\right) &= 3 \\cr 2\\sin^2 x &= 3\\cos x \\end{aligned}Now, substitute the identity $\\sin^2 x = 1 - \\cos^2 x$ to get a quadratic in terms of $\\cos x$:\\begin{aligned} 2(1 - \\cos^2 x) &= 3\\cos x \\cr 2 - 2\\cos^2 x &= 3\\cos x \\cr 2\\cos^2 x + 3\\cos x - 2 &= 0 \\end{aligned}Let $y = \\cos x$. Factor the quadratic equation:\\begin{aligned} 2y^2 + 3y - 2 &= 0 \\cr (2y - 1)(y + 2) &= 0 \\end{aligned}So we solve:\\begin{aligned} &\\cos x = \\dfrac{1}{2} \\cr &\\quad \\implies x = \\dfrac{\\pi}{3}, \\; \\dfrac{5\\pi}{3} \\cr &\\cos x = -2 \\cr &\\quad \\implies \\text{No real solutions} \\end{aligned}Thus, the solutions in the interval $0 \\le x < 2\\pi$ are $x = \\dfrac{\\pi}{3}$ and $x = \\dfrac{5\\pi}{3}$.",
                "<strong>Part (b):</strong><br>We write $2\\sin\\theta + 5\\cos\\theta = 3$ in the harmonic form $R\\sin(\\theta + \\alpha)$:\\begin{aligned} R\\cos\\alpha &= 2 \\cr R\\sin\\alpha &= 5 \\end{aligned}This gives:\\begin{aligned} R &= \\sqrt{2^2 + 5^2} \\cr &= \\sqrt{29} \\end{aligned}and:\\begin{aligned} \\tan\\alpha &= \\dfrac{5}{2} \\cr \\alpha &\\approx 68.20^\\circ \\end{aligned}So the equation becomes:\\begin{aligned} \\sqrt{29}\\sin(\\theta + 68.20^\\circ) &= 3 \\cr \\sin(\\theta + 68.20^\\circ) &= \\dfrac{3}{\\sqrt{29}} \\end{aligned}We find the principal angle using a calculator:\\begin{aligned} \\theta + 68.20^\\circ &= \\arcsin\\left(\\dfrac{3}{\\sqrt{29}}\\right) \\cr &\\approx 33.86^\\circ \\end{aligned}For $0 \\le \\theta < 360^\\circ$, we have $68.20^\\circ \\le \\theta + 68.20^\\circ < 428.20^\\circ$. The valid solutions for $\\theta + 68.20^\\circ$ are:\\begin{aligned} \\theta + 68.20^\\circ &\\approx 180^\\circ - 33.86^\\circ \\cr &\\approx 146.14^\\circ \\cr \\theta &\\approx 146.14^\\circ - 68.20^\\circ \\cr &\\approx 77.9^\\circ \\end{aligned}and:\\begin{aligned} \\theta + 68.20^\\circ &\\approx 360^\\circ + 33.86^\\circ \\cr &\\approx 393.86^\\circ \\cr \\theta &\\approx 393.86^\\circ - 68.20^\\circ \\cr &\\approx 325.7^\\circ \\end{aligned}Note that $33.86^\\circ - 68.20^\\circ = -34.34^\\circ$, which is outside the range $0 \\le \\theta < 360^\\circ$. Thus, the solutions to 1 decimal place are $\\theta = 77.9^\\circ$ and $\\theta = 325.7^\\circ$.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) } x = \\dfrac{\\pi}{3}, \\; \\dfrac{5\\pi}{3} \\cr &\\text{(b) } \\theta \\approx 77.9^\\circ, \\; 325.7^\\circ \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{3}, \\; \\dfrac{2\\pi}{3} \\cr &\\theta = 77.9^\\circ, \\; 325.7^\\circ \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{3}, \\; \\dfrac{5\\pi}{3} \\cr &\\theta = 33.9^\\circ, \\; 146.1^\\circ \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{3}, \\; \\dfrac{5\\pi}{3} \\cr &\\theta = -34.3^\\circ, \\; 77.9^\\circ \\end{aligned}",
...
},
{
        ...
        "steps": [
                "<strong>Part (a):</strong><br>We apply the double angle identity $\\sin(2x) = 2\\sin x\\cos x$ and the identity $\\tan x = \\dfrac{\\sin x}{\\cos x}$ (noting that $\\cos x \\neq 0$):\\begin{aligned} &2(2\\sin x\\cos x) \\cr &\\qquad \\cdot \\left(\\dfrac{\\sin x}{\\cos x}\\right) = 3 \\cr &\\quad 4\\sin^2 x = 3 \\cr &\\quad \\sin^2 x = \\dfrac{3}{4} \\cr &\\quad \\sin x = \\pm\\dfrac{\\sqrt{3}}{2} \\end{aligned}Since we are solving in the interval $0 \\le x < \\pi$, the sine function must be strictly non-negative. Thus, we discard the negative root:\\begin{aligned} \\sin x &= \\dfrac{\\sqrt{3}}{2} \\end{aligned}Solving this in the interval yields:\\begin{aligned} x &= \\dfrac{\\pi}{3}, \\quad \\dfrac{2\\pi}{3} \\end{aligned}",
                "<strong>Part (b):</strong><br>We write $2\\sin\\theta - 3\\cos\\theta = 1$ in the harmonic form $R\\sin(\\theta - \\alpha)$:\\begin{aligned} R\\cos\\alpha &= 2 \\cr R\\sin\\alpha &= 3 \\end{aligned}This gives:\\begin{aligned} R &= \\sqrt{2^2 + 3^2} \\cr &= \\sqrt{13} \\end{aligned}and:\\begin{aligned} \\tan\\alpha &= \\dfrac{3}{2} \\cr \\alpha &\\approx 56.31^\\circ \\end{aligned}So the equation becomes:\\begin{aligned} \\sqrt{13}\\sin(\\theta - 56.31^\\circ) &= 1 \\cr \\sin(\\theta - 56.31^\\circ) &= \\dfrac{1}{\\sqrt{13}} \\end{aligned}We find the principal angle using a calculator:\\begin{aligned} \\theta - 56.31^\\circ &= \\arcsin\\left(\\dfrac{1}{\\sqrt{13}}\\right) \\cr &\\approx 16.10^\\circ \\end{aligned}For $0 \\le \\theta < 360^\\circ$, we have $-56.31^\\circ \\le \\theta - 56.31^\\circ < 303.69^\\circ$. The valid solutions for $\\theta - 56.31^\\circ$ are:\\begin{aligned} \\theta - 56.31^\\circ &\\approx 16.10^\\circ \\cr \\theta &\\approx 16.10^\\circ + 56.31^\\circ \\cr &\\approx 72.4^\\circ \\end{aligned}and:\\begin{aligned} \\theta - 56.31^\\circ &\\approx 180^\\circ - 16.10^\\circ \\cr &\\approx 163.90^\\circ \\cr \\theta &\\approx 163.90^\\circ + 56.31^\\circ \\cr &\\approx 220.2^\\circ \\end{aligned}Thus, the solutions to 1 decimal place are $\\theta = 72.4^\\circ$ and $\\theta = 220.2^\\circ$.",
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) } x = \\dfrac{\\pi}{3}, \\; \\dfrac{2\\pi}{3} \\cr &\\text{(b) } \\theta \\approx 72.4^\\circ, \\; 220.2^\\circ \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{3}, \\; \\dfrac{2\\pi}{3} \\cr &\\quad \\dfrac{4\\pi}{3}, \\; \\dfrac{5\\pi}{3} \\cr &\\theta = 72.4^\\circ, \\; 220.2^\\circ \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{3}, \\; \\dfrac{2\\pi}{3} \\cr &\\theta = 16.1^\\circ, \\; 163.9^\\circ \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x = \\dfrac{\\pi}{3}, \\; \\dfrac{2\\pi}{3} \\cr &\\theta = 72.4^\\circ, \\; 127.6^\\circ \\end{aligned}",
...
}, 
{
        ...
        "steps": [
                "<strong>(a) Finding the quadratic model:</strong><br>The trajectory starts at the origin $O(0,0)$ and lands at the point $(48,0)$, which means the roots of the quadratic function are $x = 0$ and $x = 48$. We can express the model in factored form:$$H = kx(48 - x)$$where $k$ is a constant. The maximum height of $16$ metres occurs at the midpoint of the flight, which is $x = 24$. Therefore, the vertex of the parabola is at the point $(24, 16)$.",
                "Substituting the vertex coordinates $x = 24$ and $H = 16$ into our factored model allows us to solve for $k$:\\begin{aligned} 16 &= k(24)(48 - 24) \\cr 16 &= 576k \\cr k &= \\dfrac{16}{576} \\cr &= \\dfrac{1}{36} \\end{aligned}Therefore, the quadratic equation modeling the trajectory is:$$H = -\\dfrac{1}{36}x^2 + \\dfrac{4}{3}x$$",
                "<strong>(b) Finding the greatest horizontal distance:</strong><br>The horizontal crossbar is $3$ metres above the ground, so we set $H = 3$ and solve for $x$:$$-\\dfrac{1}{36}x^2 + \\dfrac{4}{3}x = 3$$Multiplying the entire equation by $-36$ to clear the fractions and rearranging into standard quadratic form gives:\\begin{aligned} x^2 - 48x &= -108 \\cr x^2 - 48x + 108 &= 0 \\end{aligned}",
                "We can solve this quadratic equation using the quadratic formula:\\begin{aligned} x &= \\dfrac{48 \\pm \\sqrt{2304 - 432}}{2} \\cr &= \\dfrac{48 \\pm \\sqrt{1872}}{2} \\cr &= \\dfrac{48 \\pm 12\\sqrt{13}}{2} \\cr &= 24 \\pm 6\\sqrt{13} \\end{aligned}",
                "Evaluating both roots gives:\\begin{aligned} x &= 24 - 6\\sqrt{13} \\cr &\\approx 2.37\\text{ m} \\cr x &= 24 + 6\\sqrt{13} \\cr &\\approx 45.63\\text{ m} \\end{aligned}The question asks for the <strong>greatest</strong> horizontal distance where the ball is at crossbar height. This corresponds to the larger root where the ball is on its downward trajectory:\\begin{aligned} x &= 24 + 6\\sqrt{13} \\cr &\\approx 45.6\\text{ m} \\end{aligned}",
                ...
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) } H = -\\dfrac{1}{36}x^2 + \\dfrac{4}{3}x \\cr &\\text{(b) } x = 24 + 6\\sqrt{13} \\cr &\\quad \\approx 45.6\\text{ m} \\cr &\\text{(c) Ignores air resistance} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} x &= 24 - 6\\sqrt{13} \\cr &\\approx 2.37\\text{ m} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} x = 48\\text{ m} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} x = 50.2\\text{ m} \\end{aligned}",
...
},
{
        ...
        "steps": [
                "<strong>(a) Finding the quadratic model:</strong><br>The golf ball starts at the origin $O(0,0)$ and lands at the point $(200,0)$, which means the roots of the quadratic function are $x = 0$ and $x = 200$. We can express the model in factored form:$$H = kx(200 - x)$$where $k$ is a constant. The maximum height of $25$ metres occurs at the midpoint of the flight, which is $x = 100$. Therefore, the vertex of the parabola is at $(100, 25)$.",
                "Substituting $x = 100$ and $H = 25$ into our factored model allows us to solve for $k$:\\begin{aligned} 25 &= k(100)(200 - 100) \\cr 25 &= 10000k \\cr k &= \\dfrac{25}{10000} \\cr &= \\dfrac{1}{400} \\end{aligned}Therefore, the quadratic equation modeling the trajectory is:$$H = -\\dfrac{1}{400}x^2 + \\dfrac{1}{2}x$$",
                "<strong>(b) Finding the greatest horizontal distance:</strong><br>The tree is $16$ metres high, so we set $H = 16$ and solve for $x$:$$-\\dfrac{1}{400}x^2 + \\dfrac{1}{2}x = 16$$Multiplying the entire equation by $-400$ to clear the fractions and rearranging into standard quadratic form gives:\\begin{aligned} x^2 - 200x &= -6400 \\cr x^2 - 200x + 6400 &= 0 \\end{aligned}",
                "We can solve this quadratic equation by factoring:\\begin{aligned} (x - 40)(x - 160) &= 0 \\cr x &= 40\\text{ m} \\cr x &= 160\\text{ m} \\end{aligned}",
                "The question asks for the <strong>greatest</strong> horizontal distance where the ball is at tree height ($16$ metres). This corresponds to the larger root where the ball is on its downward trajectory:$$x = 160\\text{ m}$$",
                ...
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) } H = -\\dfrac{1}{400}x^2 + \\dfrac{1}{2}x \\cr &\\text{(b) } x = 160\\text{ m} \\cr &\\text{(c) Ignores air resistance} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} x = 40\\text{ m} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} x = 200\\text{ m} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} x = 228\\text{ m} \\end{aligned}",
        ...
        },
{
        ...
        "steps": [
                "<strong>(a) Finding the quadratic model:</strong><br>The arrow is shot from the origin $O(0,0)$ and lands at $(120,0)$, which means the roots of the quadratic function are $x = 0$ and $x = 120$. We can express the model in factored form:$$H = kx(120 - x)$$where $k$ is a constant. The maximum height of $18$ metres occurs at the midpoint of the flight, which is $x = 60$. Therefore, the vertex of the parabola is at $(60, 18)$.",
                "Substituting $x = 60$ and $H = 18$ into our factored model allows us to solve for $k$:\\begin{aligned} 18 &= k(60)(120 - 60) \\cr 18 &= 3600k \\cr k &= \\dfrac{18}{3600} \\cr &= \\dfrac{1}{200} \\end{aligned}Therefore, the quadratic equation modeling the trajectory is:$$H = -\\dfrac{1}{200}x^2 + \\dfrac{3}{5}x$$",
                "<strong>(b) Finding the greatest horizontal distance:</strong><br>The wall is $10$ metres tall, so we set $H = 10$ and solve for $x$:$$-\\dfrac{1}{200}x^2 + \\dfrac{3}{5}x = 10$$Multiplying the entire equation by $-200$ to clear the fractions and rearranging into standard quadratic form gives:\\begin{aligned} x^2 - 120x &= -2000 \\cr x^2 - 120x + 2000 &= 0 \\end{aligned}",
                "We can solve this quadratic equation by factoring:\\begin{aligned} (x - 20)(x - 100) &= 0 \\cr x &= 20\\text{ m} \\cr x &= 100\\text{ m} \\end{aligned}",
                "The question asks for the <strong>greatest</strong> horizontal distance where the arrow is at wall height ($10$ metres). This corresponds to the larger root where the arrow is on its downward trajectory:$$x = 100\\text{ m}$$",
                ...
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) } H = -\\dfrac{1}{200}x^2 + \\dfrac{3}{5}x \\cr &\\text{(b) } x = 100\\text{ m} \\cr &\\text{(c) Ignores air resistance} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} x = 20\\text{ m} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} x = 120\\text{ m} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} x = 134\\text{ m} \\end{aligned}",
...
},
{
        ...
        "steps": [
                "<strong>(a) Finding the quadratic model:</strong><br>The tennis ball starts at the origin $O(0,0)$ and lands at $(24,0)$, which means the roots of the quadratic function are $x = 0$ and $x = 24$. We can express the model in factored form:$$H = kx(24 - x)$$where $k$ is a constant. The maximum height of $9$ metres occurs at the midpoint of the flight, which is $x = 12$. Therefore, the vertex of the parabola is at $(12, 9)$.",
                "Substituting $x = 12$ and $H = 9$ into our factored model allows us to solve for $k$:\\begin{aligned} 9 &= k(12)(24 - 12) \\cr 9 &= 144k \\cr k &= \\dfrac{9}{144} \\cr &= \\dfrac{1}{16} \\end{aligned}Therefore, the quadratic equation modeling the trajectory is:$$H = -\\dfrac{1}{16}x^2 + \\dfrac{3}{2}x$$",
                "<strong>(b) Finding the greatest horizontal distance:</strong><br>The net barrier is $5$ metres high, so we set $H = 5$ and solve for $x$:$$-\\dfrac{1}{16}x^2 + \\dfrac{3}{2}x = 5$$Multiplying the entire equation by $-16$ to clear the fractions and rearranging into standard quadratic form gives:\\begin{aligned} x^2 - 24x &= -80 \\cr x^2 - 24x + 80 &= 0 \\end{aligned}",
                "We can solve this quadratic equation by factoring:\\begin{aligned} (x - 4)(x - 20) &= 0 \\cr x &= 4\\text{ m} \\cr x &= 20\\text{ m} \\end{aligned}",
                "The question asks for the <strong>greatest</strong> horizontal distance where the ball is at net height ($5$ metres). This corresponds to the larger root where the ball is on its downward trajectory:$$x = 20\\text{ m}$$",
                ...
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) } H = -\\dfrac{1}{16}x^2 + \\dfrac{3}{2}x \\cr &\\text{(b) } x = 20\\text{ m} \\cr &\\text{(c) Ball hit above court level} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} x = 4\\text{ m} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} x = 24\\text{ m} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} x = 27\\text{ m} \\end{aligned}",
        ...
        },
{
        ...
        "steps": [
                "<strong>(a) Finding the quadratic model:</strong><br>The cricket ball starts at the origin $O(0,0)$ and lands at $(80,0)$, which means the roots of the quadratic function are $x = 0$ and $x = 80$. We can express the model in factored form:$$H = kx(80 - x)$$where $k$ is a constant. The maximum height of $16$ metres occurs at the midpoint of the flight, which is $x = 40$. Therefore, the vertex of the parabola is at $(40, 16)$.",
                "Substituting $x = 40$ and $H = 16$ into our factored model allows us to solve for $k$:\\begin{aligned} 16 &= k(40)(80 - 40) \\cr 16 &= 1600k \\cr k &= \\dfrac{16}{1600} \\cr &= \\dfrac{1}{100} \\end{aligned}Therefore, the quadratic equation modeling the trajectory is:$$H = -\\dfrac{1}{100}x^2 + \\dfrac{4}{5}x$$",
                "<strong>(b) Finding the greatest horizontal distance:</strong><br>The sight screen is $7$ metres tall, so we set $H = 7$ and solve for $x$:$$-\\dfrac{1}{100}x^2 + \\dfrac{4}{5}x = 7$$Multiplying the entire equation by $-100$ to clear the fractions and rearranging into standard quadratic form gives:\\begin{aligned} x^2 - 80x &= -700 \\cr x^2 - 80x + 700 &= 0 \\end{aligned}",
                "We can solve this quadratic equation by factoring:\\begin{aligned} (x - 10)(x - 70) &= 0 \\cr x &= 10\\text{ m} \\cr x &= 70\\text{ m} \\end{aligned}",
                "The question asks for the <strong>greatest</strong> horizontal distance where the cricket ball is at the height of the sight screen ($7$ metres). This corresponds to the larger root where the ball is on its downward trajectory:$$x = 70\\text{ m}$$",
                ...
                "<strong>Final Answer</strong>\\begin{aligned} &\\text{(a) } H = -\\dfrac{1}{100}x^2 + \\dfrac{4}{5}x \\cr &\\text{(b) } x = 70\\text{ m} \\cr &\\text{(c) Ignores air resistance} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} x = 10\\text{ m} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} x = 80\\text{ m} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} x = 88\\text{ m} \\end{aligned}",
...
},
{
        ...
        "img": false,
        "question": "Given that $\\theta$ is measured in radians, we prove from first principles that $\\dfrac{\\text{d}}{\\text{d}\\theta}(\\sin\\theta) = \\cos\\theta$ by considering the limit of the difference quotient:$$\\dfrac{\\sin(\\theta + h) - \\sin\\theta}{h}$$Which of the following shows the correct algebraic rearrangement of this expression before the limit is taken as $h \\to 0$?",
        "steps": [
                "<strong>Step 1: Set up the limit of the difference quotient:</strong><br>By definition, the derivative of $\\sin\\theta$ with respect to $\\theta$ is given by the limit:\\begin{aligned} &\\dfrac{\\text{d}}{\\text{d}\\theta}(\\sin\\theta) \\cr &\\quad = \\lim_{h \\to 0} \\dfrac{\\sin(\\theta + h) - \\sin\\theta}{h} \\end{aligned}",
                "<strong>Step 2: Expand the compound angle term:</strong><br>Using the compound angle identity for $\\sin(A + B)$, we expand the numerator:\\begin{aligned} &\\sin(\\theta + h) \\cr &\\quad = \\sin\\theta\\cos h \\cr &\\qquad + \\cos\\theta\\sin h \\end{aligned}Substituting this expansion back into our difference quotient gives:\\begin{aligned} &\\dfrac{1}{h} \\big( \\sin\\theta\\cos h \\cr &\\qquad + \\cos\\theta\\sin h - \\sin\\theta \\big) \\end{aligned}",
                "<strong>Step 3: Group the terms:</strong><br>We group the terms in the numerator and split into two separate fractions:\\begin{aligned} &\\dfrac{\\sin\\theta(\\cos h - 1)}{h} \\cr &\\qquad + \\dfrac{\\cos\\theta\\sin h}{h} \\cr &\\quad = \\sin\\theta\\left(\\dfrac{\\cos h - 1}{h}\\right) \\cr &\\qquad + \\cos\\theta\\left(\\dfrac{\\sin h}{h}\\right) \\end{aligned}This is the required algebraic rearrangement before taking limits.",
                "<strong>Step 4: Take the limit as $h \\to 0$:</strong><br>Using the standard limit results that as $h \\to 0$, $\\dfrac{\\sin h}{h} \\to 1$ and $\\dfrac{\\cos h - 1}{h} \\to 0$, we evaluate:\\begin{aligned} &\\dfrac{\\text{d}}{\\text{d}\\theta}(\\sin\\theta) \\cr &\\quad = \\sin\\theta(0) + \\cos\\theta(1) \\cr &\\quad = \\cos\\theta \\end{aligned}",
                "<strong>Final Answer</strong>\\begin{aligned} &\\sin\\theta\\left(\\dfrac{\\cos h - 1}{h}\\right) \\cr &\\quad + \\cos\\theta\\left(\\dfrac{\\sin h}{h}\\right) \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &\\sin\\theta\\left(\\dfrac{\\cos h + 1}{h}\\right) \\cr &\\quad - \\cos\\theta\\left(\\dfrac{\\sin h}{h}\\right) \\end{aligned}",
                        "feedback": "This option contains a sign error in both the compound angle expansion and the grouping of the $\\sin\\theta$ term."
                },
                {
                        "ans": "\\begin{aligned} &\\cos\\theta\\left(\\dfrac{\\cos h - 1}{h}\\right) \\cr &\\quad + \\sin\\theta\\left(\\dfrac{\\sin h}{h}\\right) \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &\\sin\\theta(\\cos h - 1) \\cr &\\quad + \\cos\\theta\\left(\\dfrac{\\sin h}{h}\\right) \\end{aligned}",
...
},
{
        ...
        "img": false,
        "question": "Given that $x$ is measured in radians, we prove from first principles that $\\dfrac{\\text{d}}{\\text{d}x}(\\cos(2x)) = -2\\sin(2x)$ by considering the limit of the difference quotient:$$\\dfrac{\\cos(2x + 2h) - \\cos(2x)}{h}$$Which of the following shows the correct algebraic rearrangement of this expression before the limit is taken as $h \\to 0$?",
        "steps": [
                ...
                "<strong>Step 3: Group the terms:</strong><br>We group the terms in the numerator and split into two separate fractions:\\begin{aligned} &\\dfrac{\\cos(2x)(\\cos(2h) - 1)}{h} \\cr &\\qquad - \\dfrac{\\sin(2x)\\sin(2h)}{h} \\cr &\\quad = \\cos(2x)\\left(\\dfrac{\\cos(2h) - 1}{h}\\right) \\cr &\\qquad - \\sin(2x)\\left(\\dfrac{\\sin(2h)}{h}\\right) \\end{aligned}This is the required algebraic rearrangement before taking limits.",
                "<strong>Step 4: Take the limit as $h \\to 0$:</strong><br>To evaluate the limits, we scale the fractions to match our standard limit forms:\\begin{aligned} &\\dfrac{\\cos(2h) - 1}{h} \\cr &\\quad = 2\\left(\\dfrac{\\cos(2h) - 1}{2h}\\right) \\cr &\\dfrac{\\sin(2h)}{h} \\cr &\\quad = 2\\left(\\dfrac{\\sin(2h)}{2h}\\right) \\end{aligned}As $h \\to 0$, we have $2h \\to 0$. Therefore:\\begin{aligned} &\\lim_{h \\to 0} \\left(\\dfrac{\\cos(2h) - 1}{h}\\right) \\cr &\\quad = 2(0) \\cr &\\quad = 0 \\cr &\\lim_{h \\to 0} \\left(\\dfrac{\\sin(2h)}{h}\\right) \\cr &\\quad = 2(1) \\cr &\\quad = 2 \\end{aligned}Applying these limits gives:\\begin{aligned} &\\dfrac{\\text{d}}{\\text{d}x}(\\cos(2x)) \\cr &\\quad = \\cos(2x)(0) \\cr &\\qquad - \\sin(2x)(2) \\cr &\\quad = -2\\sin(2x) \\end{aligned}",
        ...
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &\\cos(2x)\\left(\\dfrac{\\cos(2h) + 1}{h}\\right) \\cr &\\quad + \\sin(2x)\\left(\\dfrac{\\sin(2h)}{h}\\right) \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &\\sin(2x)\\left(\\dfrac{\\cos(2h) - 1}{h}\\right) \\cr &\\quad - \\cos(2x)\\left(\\dfrac{\\sin(2h)}{h}\\right) \\end{aligned}",
                        "feedback": "This error occurs if you incorrectly swap the sine and cosine functions in the compound angle identity expansion."
                },
                {
                        "ans": "\\begin{aligned} &\\cos(2x)(\\cos(2h) - 1) \\cr &\\quad - \\sin(2x)\\left(\\dfrac{\\sin(2h)}{h}\\right) \\end{aligned}",
                        "feedback": "This option fails to divide the first factored term by the denominator $h$, violating the rules of algebraic fractions."
                }
        ],
        "bradley_insight": {
...
},
{
        ...
        "img": false,
        "question": "Given that $x$ is measured in radians, we prove from first principles that $\\dfrac{\\text{d}}{\\text{d}x}(\\sin(2x)) = 2\\cos(2x)$ by considering the limit of the difference quotient:$$\\dfrac{\\sin(2x + 2h) - \\sin(2x)}{h}$$Which of the following shows the correct algebraic rearrangement of this expression before the limit is taken as $h \\to 0$?",
        "steps": [
                ...
                "<strong>Step 3: Group the terms:</strong><br>We group the terms in the numerator and split into two separate fractions:\\begin{aligned} &\\dfrac{\\sin(2x)(\\cos(2h) - 1)}{h} \\cr &\\qquad + \\dfrac{\\cos(2x)\\sin(2h)}{h} \\cr &\\quad = \\sin(2x)\\left(\\dfrac{\\cos(2h) - 1}{h}\\right) \\cr &\\qquad + \\cos(2x)\\left(\\dfrac{\\sin(2h)}{h}\\right) \\end{aligned}This is the required algebraic rearrangement before taking limits.",
                "<strong>Step 4: Take the limit as $h \\to 0$:</strong><br>To evaluate the limits, we scale the fractions to match our standard limit forms:\\begin{aligned} &\\dfrac{\\cos(2h) - 1}{h} \\cr &\\quad = 2\\left(\\dfrac{\\cos(2h) - 1}{2h}\\right) \\cr &\\dfrac{\\sin(2h)}{h} \\cr &\\quad = 2\\left(\\dfrac{\\sin(2h)}{2h}\\right) \\end{aligned}As $h \\to 0$, we have $2h \\to 0$. Therefore:\\begin{aligned} &\\lim_{h \\to 0} \\left(\\dfrac{\\cos(2h) - 1}{h}\\right) \\cr &\\quad = 2(0) \\cr &\\quad = 0 \\cr &\\lim_{h \\to 0} \\left(\\dfrac{\\sin(2h)}{h}\\right) \\cr &\\quad = 2(1) \\cr &\\quad = 2 \\end{aligned}Applying these limits gives:\\begin{aligned} &\\dfrac{\\text{d}}{\\text{d}x}(\\sin(2x)) \\cr &\\quad = \\sin(2x)(0) \\cr &\\qquad + \\cos(2x)(2) \\cr &\\quad = 2\\cos(2x) \\end{aligned}",
        ...
        "pi_options": [
                ...
                {
                        "ans": "\\begin{aligned} &\\sin(2x)(\\cos(2h) - 1) \\cr &\\quad + \\cos(2x)\\left(\\dfrac{\\sin(2h)}{h}\\right) \\end{aligned}",
                        "feedback": "This option fails to divide the first factored term by the denominator $h$, violating the rules of algebraic fractions."
                }
        ],
        "bradley_insight": {
...
},
{
        ...
        "img": false,
        "question": "Given that $\\theta$ is measured in radians, we prove from first principles that $\\dfrac{\\text{d}}{\\text{d}\\theta}(\\cos(3\\theta)) = -3\\sin(3\\theta)$ by considering the limit of the difference quotient:$$\\dfrac{\\cos(3\\theta + 3h) - \\cos(3\\theta)}{h}$$Which of the following shows the correct algebraic rearrangement of this expression before the limit is taken as $h \\to 0$?",
        "steps": [
                "<strong>Step 1: Set up the limit of the difference quotient:</strong><br>By definition, the derivative of $\\cos(3\\theta)$ with respect to $\\theta$ is given by the limit:\\begin{aligned} &\\dfrac{\\text{d}}{\\text{d}\\theta}(\\cos(3\\theta)) \\cr &\\quad = \\lim_{h \\to 0} \\dfrac{\\cos(3(\\theta + h)) - \\cos(3\\theta)}{h} \\cr &\\quad = \\lim_{h \\to 0} \\dfrac{\\cos(3\\theta + 3h) - \\cos(3\\theta)}{h} \\end{aligned}",
                "<strong>Step 2: Expand the compound angle term:</strong><br>Using the compound angle identity for $\\cos(A + B)$, we expand $\\cos(3\\theta + 3h)$:\\begin{aligned} &\\cos(3\\theta + 3h) \\cr &\\quad = \\cos(3\\theta)\\cos(3h) \\cr &\\qquad - \\sin(3\\theta)\\sin(3h) \\end{aligned}Substituting this expansion back into our difference quotient gives:\\begin{aligned} &\\dfrac{1}{h} \\big( \\cos(3\\theta)\\cos(3h) \\cr &\\qquad - \\sin(3\\theta)\\sin(3h) \\cr &\\qquad - \\cos(3\\theta) \\big) \\end{aligned}",
                "<strong>Step 3: Group the terms:</strong><br>We group the terms in the numerator and split into two separate fractions:\\begin{aligned} &\\dfrac{\\cos(3\\theta)(\\cos(3h) - 1)}{h} \\cr &\\qquad - \\dfrac{\\sin(3\\theta)\\sin(3h)}{h} \\cr &\\quad = \\cos(3\\theta)\\left(\\dfrac{\\cos(3h) - 1}{h}\\right) \\cr &\\qquad - \\sin(3\\theta)\\left(\\dfrac{\\sin(3h)}{h}\\right) \\end{aligned}This is the required algebraic rearrangement before taking limits.",
                "<strong>Step 4: Take the limit as $h \\to 0$:</strong><br>To evaluate the limits, we scale the fractions to match our standard limit forms:\\begin{aligned} &\\dfrac{\\cos(3h) - 1}{h} \\cr &\\quad = 3\\left(\\dfrac{\\cos(3h) - 1}{3h}\\right) \\cr &\\dfrac{\\sin(3h)}{h} \\cr &\\quad = 3\\left(\\dfrac{\\sin(3h)}{3h}\\right) \\end{aligned}As $h \\to 0$, we have $3h \\to 0$. Therefore:\\begin{aligned} &\\lim_{h \\to 0} \\left(\\dfrac{\\cos(3h) - 1}{h}\\right) \\cr &\\quad = 3(0) \\cr &\\quad = 0 \\cr &\\lim_{h \\to 0} \\left(\\dfrac{\\sin(3h)}{h}\\right) \\cr &\\quad = 3(1) \\cr &\\quad = 3 \\end{aligned}Applying these limits gives:\\begin{aligned} &\\dfrac{\\text{d}}{\\text{d}\\theta}(\\cos(3\\theta)) \\cr &\\quad = \\cos(3\\theta)(0) \\cr &\\qquad - \\sin(3\\theta)(3) \\cr &\\quad = -3\\sin(3\\theta) \\end{aligned}",
                "<strong>Final Answer</strong>\\begin{aligned} &\\cos(3\\theta)\\left(\\dfrac{\\cos(3h) - 1}{h}\\right) \\cr &\\quad - \\sin(3\\theta)\\left(\\dfrac{\\sin(3h)}{h}\\right) \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &\\cos(3\\theta)\\left(\\dfrac{\\cos(3h) + 1}{h}\\right) \\cr &\\quad + \\sin(3\\theta)\\left(\\dfrac{\\sin(3h)}{h}\\right) \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &\\sin(3\\theta)\\left(\\dfrac{\\cos(3h) - 1}{h}\\right) \\cr &\\quad - \\cos(3\\theta)\\left(\\dfrac{\\sin(3h)}{h}\\right) \\end{aligned}",
                        "feedback": "This error occurs if you incorrectly swap the sine and cosine functions in the compound angle identity expansion."
                },
                {
                        "ans": "\\begin{aligned} &\\cos(3\\theta)(\\cos(3h) - 1) \\cr &\\quad - \\sin(3\\theta)\\left(\\dfrac{\\sin(3h)}{h}\\right) \\end{aligned}",
                        "feedback": "This option fails to divide the first factored term by the denominator $h$, violating the rules of algebraic fractions."
                }
        ],
        "bradley_insight": {
...
},
{
        ...
        "img": false,
        "question": "Given that $\\theta$ is measured in radians, we prove from first principles that $\\dfrac{\\text{d}}{\\text{d}\\theta}(\\sin(3\\theta)) = 3\\cos(3\\theta)$ by considering the limit of the difference quotient:$$\\dfrac{\\sin(3\\theta + 3h) - \\sin(3\\theta)}{h}$$Which of the following shows the correct algebraic rearrangement of this expression before the limit is taken as $h \\to 0$?",
        "steps": [
                "<strong>Step 1: Set up the limit of the difference quotient:</strong><br>By definition, the derivative of $\\sin(3\\theta)$ with respect to $\\theta$ is given by the limit:\\begin{aligned} &\\dfrac{\\text{d}}{\\text{d}\\theta}(\\sin(3\\theta)) \\cr &\\quad = \\lim_{h \\to 0} \\dfrac{\\sin(3(\\theta + h)) - \\sin(3\\theta)}{h} \\cr &\\quad = \\lim_{h \\to 0} \\dfrac{\\sin(3\\theta + 3h) - \\sin(3\\theta)}{h} \\end{aligned}",
                "<strong>Step 2: Expand the compound angle term:</strong><br>Using the compound angle identity for $\\sin(A + B)$, we expand $\\sin(3\\theta + 3h)$:\\begin{aligned} &\\sin(3\\theta + 3h) \\cr &\\quad = \\sin(3\\theta)\\cos(3h) \\cr &\\qquad + \\cos(3\\theta)\\sin(3h) \\end{aligned}Substituting this expansion back into our difference quotient gives:\\begin{aligned} &\\dfrac{1}{h} \\big( \\sin(3\\theta)\\cos(3h) \\cr &\\qquad + \\cos(3\\theta)\\sin(3h) \\cr &\\qquad - \\sin(3\\theta) \\big) \\end{aligned}",
                "<strong>Step 3: Group the terms:</strong><br>We group the terms in the numerator and split into two separate fractions:\\begin{aligned} &\\dfrac{\\sin(3\\theta)(\\cos(3h) - 1)}{h} \\cr &\\qquad + \\dfrac{\\cos(3\\theta)\\sin(3h)}{h} \\cr &\\quad = \\sin(3\\theta)\\left(\\dfrac{\\cos(3h) - 1}{h}\\right) \\cr &\\qquad + \\cos(3\\theta)\\left(\\dfrac{\\sin(3h)}{h}\\right) \\end{aligned}This is the required algebraic rearrangement before taking limits.",
                "<strong>Step 4: Take the limit as $h \\to 0$:</strong><br>To evaluate the limits, we scale the fractions to match our standard limit forms:\\begin{aligned} &\\dfrac{\\cos(3h) - 1}{h} \\cr &\\quad = 3\\left(\\dfrac{\\cos(3h) - 1}{3h}\\right) \\cr &\\dfrac{\\sin(3h)}{h} \\cr &\\quad = 3\\left(\\dfrac{\\sin(3h)}{3h}\\right) \\end{aligned}As $h \\to 0$, we have $3h \\to 0$. Therefore:\\begin{aligned} &\\lim_{h \\to 0} \\left(\\dfrac{\\cos(3h) - 1}{h}\\right) \\cr &\\quad = 3(0) \\cr &\\quad = 0 \\cr &\\lim_{h \\to 0} \\left(\\dfrac{\\sin(3h)}{h}\\right) \\cr &\\quad = 3(1) \\cr &\\quad = 3 \\end{aligned}Applying these limits gives:\\begin{aligned} &\\dfrac{\\text{d}}{\\text{d}\\theta}(\\sin(3\\theta)) \\cr &\\quad = \\sin(3\\theta)(0) \\cr &\\qquad + \\cos(3\\theta)(3) \\cr &\\quad = 3\\cos(3\\theta) \\end{aligned}",
                "<strong>Final Answer</strong>\\begin{aligned} &\\sin(3\\theta)\\left(\\dfrac{\\cos(3h) - 1}{h}\\right) \\cr &\\quad + \\cos(3\\theta)\\left(\\dfrac{\\sin(3h)}{h}\\right) \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &\\sin(3\\theta)\\left(\\dfrac{\\cos(3h) + 1}{h}\\right) \\cr &\\quad - \\cos(3\\theta)\\left(\\dfrac{\\sin(3h)}{h}\\right) \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &\\sin(3\\theta)(\\cos(3h) - 1) \\cr &\\quad + \\cos(3\\theta)\\left(\\dfrac{\\sin(3h)}{h}\\right) \\end{aligned}",
                        "feedback": "This option fails to divide the first factored term by the denominator $h$, violating the rules of algebraic fractions."
                }
        ],
        "bradley_insight": {
...
},
{
        ...
        "steps": [
                "<strong>Step 1: Formulate the differential equation:</strong><br>Let $r$ represent the radius of the candy (in mm) at time $t$ (in minutes). Since the rate of decrease of the radius is inversely proportional to $r^2$, we write:$$\\dfrac{\\text{d}r}{\\text{d}t} = -\\dfrac{k}{r^2}$$where $k$ is a positive constant of proportionality.",
                "<strong>Step 2: Separate variables and integrate:</strong><br>We separate the variables and integrate both sides of the equation:\\begin{aligned} r^2 \\text{d}r &= -k \\text{d}t \\cr \\int r^2 \\text{d}r &= \\int -k \\text{d}t \\cr \\dfrac{1}{3}r^3 &= -kt + C \\cr r^3 &= -3kt + 3C \\end{aligned}Let $K = 3k$ and $c = 3C$ to simplify the equation:$$r^3 = -Kt + c$$",
                "<strong>Step 3: Apply the initial and boundary conditions:</strong><br>At $t = 0$, the initial radius is $r = 6$:\\begin{aligned} 6^3 &= -K(0) + c \\cr c &= 216 \\end{aligned}This gives the equation:$$r^3 = 216 - Kt$$Three minutes later, at $t = 3$, the radius is $r = 3$:\\begin{aligned} 3^3 &= 216 - K(3) \\cr 27 &= 216 - 3K \\cr 3K &= 189 \\cr K &= 63 \\end{aligned}Thus, the equation linking the radius and time is:$$r^3 = 216 - 63t$$",
                "<strong>Step 4: Find the total time taken to dissolve:</strong><br>The candy completely dissolves when $r = 0$:\\begin{aligned} 0 &= 216 - 63t \\cr 63t &= 216 \\cr t &= \\dfrac{216}{63} \\cr &= \\dfrac{24}{7}\\text{ minutes} \\cr &\\approx 3.43\\text{ minutes} \\end{aligned}",
                "<strong>Step 5: Convert the time into minutes and seconds:</strong><br>We convert $\\dfrac{24}{7}$ minutes into minutes and seconds:\\begin{aligned} &t = 3\\text{ min} + \\dfrac{3}{7}\\text{ min} \\cr &\\quad = 3\\text{ min} + 25.7\\text{ s} \\cr &\\quad \\approx 3\\text{ min } 26\\text{ s} \\end{aligned}",
                "<strong>Final Answer</strong>\\begin{aligned} &3\\text{ minutes and } 26\\text{ seconds} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &3\\text{ minutes} \\cr &\\quad 43\\text{ seconds} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &4\\text{ minutes} \\cr &\\quad 12\\text{ seconds} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &3\\text{ minutes} \\cr &\\quad 15\\text{ seconds} \\end{aligned}",
...
},
{
        ...
        "steps": [
                "<strong>Step 1: Formulate the differential equation:</strong><br>Let $M$ represent the mass of the radioactive substance (in g) at time $t$ (in hours). Since the rate of decrease of the mass is proportional to the mass itself, we write:$$\\dfrac{\\text{d}M}{\\text{d}t} = -kM$$where $k$ is a positive constant.",
                "<strong>Step 2: Separate variables and integrate:</strong><br>Separating the variables and integrating both sides of the equation gives:\\begin{aligned} \\dfrac{1}{M} \\text{d}M &= -k \\text{d}t \\cr \\int \\dfrac{1}{M} \\text{d}M &= \\int -k \\text{d}t \\cr \\ln M &= -kt + C \\cr M &= A\\mathrm{e}^{-kt} \\end{aligned}where $A = \\mathrm{e}^C$ is a constant.",
                "<strong>Step 3: Apply the initial and boundary conditions:</strong><br>At $t = 0$, the initial mass is $M = 80$:\\begin{aligned} 80 &= A\\mathrm{e}^{-k(0)} \\cr A &= 80 \\end{aligned}This gives the equation:$$M = 80\\mathrm{e}^{-kt}$$Ten hours later, at $t = 10$, the mass is $M = 40$:\\begin{aligned} 40 &= 80\\mathrm{e}^{-10k} \\cr \\mathrm{e}^{-10k} &= \\dfrac{1}{2} \\cr -10k &= \\ln\\left(\\dfrac{1}{2}\\right) \\cr &= -\\ln 2 \\cr k &= \\dfrac{\\ln 2}{10} \\end{aligned}Thus, the equation linking the mass and time is:$$M = 80\\mathrm{e}^{-\\left(\\frac{\\ln 2}{10}\\right)t}$$",
                "<strong>Step 4: Find the time taken to decay to $5\\text{ g}$:</strong><br>Setting $M = 5$, we solve for $t$:\\begin{aligned} 5 &= 80\\mathrm{e}^{-\\left(\\frac{\\ln 2}{10}\\right)t} \\cr \\mathrm{e}^{-\\left(\\frac{\\ln 2}{10}\\right)t} &= \\dfrac{5}{80} \\cr &= \\dfrac{1}{16} \\cr -\\left(\\dfrac{\\ln 2}{10}\\right)t &= \\ln\\left(\\dfrac{1}{16}\\right) \\cr &= -\\ln 16 \\cr &= -4\\ln 2 \\cr \\left(\\dfrac{\\ln 2}{10}\\right)t &= 4\\ln 2 \\cr t &= 40\\text{ hours} \\end{aligned}",
                "<strong>Final Answer</strong>\\begin{aligned} t = 40\\text{ hours} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} t = 30\\text{ hours} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} t = 20\\text{ hours} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} t = 50\\text{ hours} \\end{aligned}",
...
},
{
        ...
        "steps": [
                "<strong>Step 1: Formulate the differential equation:</strong><br>Let $r$ represent the radius of the puddle (in cm) at time $t$ (in hours). Since the rate of decrease of the radius is inversely proportional to the radius itself, we write:$$\\dfrac{\\text{d}r}{\\text{d}t} = -\\dfrac{k}{r}$$where $k$ is a positive constant.",
                "<strong>Step 2: Separate variables and integrate:</strong><br>Separating the variables and integrating both sides of the equation gives:\\begin{aligned} r \\text{d}r &= -k \\text{d}t \\cr \\int r \\text{d}r &= \\int -k \\text{d}t \\cr \\dfrac{1}{2}r^2 &= -kt + C \\cr r^2 &= -2kt + 2C \\end{aligned}Let $K = 2k$ and $c = 2C$ to simplify the equation:$$r^2 = -Kt + c$$",
                "<strong>Step 3: Apply the initial and boundary conditions:</strong><br>At $t = 0$, the initial radius is $r = 10$:\\begin{aligned} 10^2 &= -K(0) + c \\cr c &= 100 \\end{aligned}This gives the equation:$$r^2 = 100 - Kt$$After $5$ hours, at $t = 5$, the radius is $r = 8$:\\begin{aligned} 8^2 &= 100 - K(5) \\cr 64 &= 100 - 5K \\cr 5K &= 36 \\cr K &= 7.2 \\end{aligned}Thus, the equation linking the radius and time is:$$r^2 = 100 - 7.2t$$",
                "<strong>Step 4: Find the total time taken to dry up:</strong><br>The puddle dries up completely when $r = 0$:\\begin{aligned} 0 &= 100 - 7.2t \\cr 7.2t &= 100 \\cr t &= \\dfrac{100}{7.2} \\cr &= \\dfrac{125}{9}\\text{ hours} \\cr &\\approx 13.89\\text{ hours} \\end{aligned}",
                "<strong>Step 5: Convert the time into hours and minutes:</strong><br>We convert $\\dfrac{125}{9}$ hours into hours and minutes:\\begin{aligned} &t = 13\\text{ hours} + \\dfrac{8}{9}\\text{ hours} \\cr &\\quad = 13\\text{ hours} + 53.3\\text{ mins} \\cr &\\quad \\approx 13\\text{ hours } 53\\text{ mins} \\end{aligned}",
                "<strong>Final Answer</strong>\\begin{aligned} &13\\text{ hours and } 53\\text{ minutes} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &13\\text{ hours} \\cr &\\quad 89\\text{ minutes} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &13\\text{ hours} \\cr &\\quad 30\\text{ minutes} \\end{aligned}",
                        "feedback": "This is a rounding error or incorrect approximation made early in the calculations."
                },
                {
                        "ans": "\\begin{aligned} &14\\text{ hours} \\cr &\\quad 12\\text{ minutes} \\end{aligned}",
...
},
{
        ...
        "steps": [
                "<strong>Step 1: Formulate the differential equation:</strong><br>Since the rate of decrease of the depth $h$ is proportional to the square root of $h$, we write:$$\\dfrac{\\text{d}h}{\\text{d}t} = -k\\sqrt{h}$$where $k$ is a positive constant.",
                "<strong>Step 2: Separate variables and integrate:</strong><br>Separating the variables and integrating both sides of the equation gives:\\begin{aligned} \\dfrac{1}{\\sqrt{h}} \\text{d}h &= -k \\text{d}t \\cr \\int h^{-1/2} \\text{d}h &= \\int -k \\text{d}t \\cr 2\\sqrt{h} &= -kt + C \\cr \\sqrt{h} &= -\\dfrac{k}{2}t + \\dfrac{C}{2} \\end{aligned}",
                "<strong>Step 3: Apply the initial and boundary conditions:</strong><br>At $t = 0$, the initial depth is $h = 9$:\\begin{aligned} 2\\sqrt{9} &= -k(0) + C \\cr C &= 6 \\end{aligned}This gives the equation:\\begin{aligned} 2\\sqrt{h} &= 6 - kt \\cr \\sqrt{h} &= 3 - \\dfrac{k}{2}t \\end{aligned}After $12$ minutes, at $t = 12$, the depth is $h = 4$:\\begin{aligned} \\sqrt{4} &= 3 - \\dfrac{k}{2}(12) \\cr 2 &= 3 - 6k \\cr 6k &= 1 \\cr k &= \\dfrac{1}{6} \\end{aligned}Thus, the equation linking the depth and time is:\\begin{aligned} \\sqrt{h} &= 3 - \\dfrac{t}{12} \\cr h &= \\left(3 - \\dfrac{t}{12}\\right)^2 \\end{aligned}",
                "<strong>Step 4: Find the total time taken to empty:</strong><br>The water tank is completely empty when $h = 0$:\\begin{aligned} 3 - \\dfrac{t}{12} &= 0 \\cr \\dfrac{t}{12} &= 3 \\cr t &= 36\\text{ minutes} \\end{aligned}",
                "<strong>Final Answer</strong>\\begin{aligned} t = 36\\text{ minutes} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} t = 24\\text{ minutes} \\end{aligned}",
        ...
        "bradley_insight": {
                ...
                "content": "Remember the power rule for integration: $\\int h^{-1/2}\\text{d}h = \\dfrac{h^{1/2}}{1/2}$, which simplifies to $2\\sqrt{h}$. A common trap is to forget the division by $1/2$ and write it as just $\\sqrt{h}$, which changes the final constants and yields incorrect empty times."
        }
},
{
        "id": "004480",
        ...
        "steps": [
                "<strong>Step 1: Formulate the differential equation:</strong><br>Let $r$ represent the radius of the raindrop (in mm) at time $t$ (in minutes). Since the rate of decrease of the radius is proportional to the radius itself, we write:$$\\dfrac{\\text{d}r}{\\text{d}t} = -kr$$where $k$ is a positive constant.",
                "<strong>Step 2: Separate variables and integrate:</strong><br>Separating the variables and integrating both sides of the equation gives:\\begin{aligned} \\dfrac{1}{r} \\text{d}r &= -k \\text{d}t \\cr \\int \\dfrac{1}{r} \\text{d}r &= \\int -k \\text{d}t \\cr \\ln r &= -kt + C \\cr r &= A\\mathrm{e}^{-kt} \\end{aligned}where $A = \\mathrm{e}^C$ is a constant.",
                "<strong>Step 3: Apply the initial and boundary conditions:</strong><br>At $t = 0$, the initial radius is $r = 4$:\\begin{aligned} 4 &= A\\mathrm{e}^{-k(0)} \\cr A &= 4 \\end{aligned}This gives the equation:$$r = 4\\mathrm{e}^{-kt}$$Ten minutes later, at $t = 10$, the radius is $r = 2$:\\begin{aligned} 2 &= 4\\mathrm{e}^{-10k} \\cr \\mathrm{e}^{-10k} &= \\dfrac{1}{2} \\cr -10k &= \\ln\\left(\\dfrac{1}{2}\\right) \\cr &= -\\ln 2 \\cr k &= \\dfrac{\\ln 2}{10} \\end{aligned}Thus, the equation linking the radius and time is:$$r = 4\\mathrm{e}^{-\\left(\\frac{\\ln 2}{10}\\right)t}$$",
                "<strong>Step 4: Find the time taken to decrease to $0.5\\text{ mm}$:</strong><br>Setting $r = 0.5$, we solve for $t$:\\begin{aligned} 0.5 &= 4\\mathrm{e}^{-\\left(\\frac{\\ln 2}{10}\\right)t} \\cr \\mathrm{e}^{-\\left(\\frac{\\ln 2}{10}\\right)t} &= \\dfrac{0.5}{4} \\cr &= \\dfrac{1}{8} \\cr -\\left(\\dfrac{\\ln 2}{10}\\right)t &= \\ln\\left(\\dfrac{1}{8}\\right) \\cr &= -\\ln 8 \\cr &= -3\\ln 2 \\cr \\left(\\dfrac{\\ln 2}{10}\\right)t &= 3\\ln 2 \\cr t &= 30\\text{ minutes} \\end{aligned}",
                "<strong>Final Answer</strong>\\begin{aligned} t = 30\\text{ minutes} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} t = 20\\text{ minutes} \\end{aligned}",
...
},
{
        ...
        "steps": [
                ...
                "<strong>Final Answer</strong>\\begin{aligned} &x \\approx 0.322\\text{ rad} \\cr &x \\approx -0.785\\text{ rad} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x \\approx -0.322\\text{ rad} \\cr &x \\approx 0.785\\text{ rad} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x \\approx 0.322\\text{ rad} \\cr &x \\approx -0.785\\text{ rad} \\cr &x = 0 \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x \\approx 1.249\\text{ rad} \\cr &x \\approx -0.785\\text{ rad} \\end{aligned}",
...
},
{
        ...
        "steps": [
                "<strong>(a) Proving the identity:</strong><br>We start by expanding the right-hand side (RHS) of the identity using the definitions $\\tan \\theta = \\dfrac{\\sin \\theta}{\\cos \\theta}$ and $\\sin 2\\theta = 2\\sin \\theta \\cos \\theta$:\\begin{aligned} &\\tan \\theta \\sin 2\\theta \\cr &\\quad = \\left(\\dfrac{\\sin \\theta}{\\cos \\theta}\\right)(2\\sin \\theta \\cos \\theta) \\cr &\\quad = 2\\sin^2 \\theta \\end{aligned}Now we expand the left-hand side (LHS) using the double angle identity $\\cos 2\\theta = \\cos^2 \\theta - \\sin^2 \\theta$ and the Pythagorean identity $\\cos^2 \\theta = 1 - \\sin^2 \\theta$:\\begin{aligned} 1 - \\cos 2\\theta &= 1 - (\\cos^2 \\theta - \\sin^2 \\theta) \\cr &= 1 - \\cos^2 \\theta + \\sin^2 \\theta \\cr &= (1 - \\cos^2 \\theta) + \\sin^2 \\theta \\cr &= \\sin^2 \\theta + \\sin^2 \\theta \\cr &= 2\\sin^2 \\theta \\end{aligned}Since LHS = RHS, the identity is proven: $1 - \\cos 2\\theta \\equiv \\tan \\theta \\sin 2\\theta$.",
                "<strong>(b) Solving the equation:</strong><br>We substitute our proven identity $1 - \\cos 2x = \\tan x \\sin 2x$ into the given equation:\\begin{aligned} &(\\sec^2 x - 3)(1 - \\cos 2x) \\cr &\\quad = 3\\tan^2 x \\sin 2x \\cr &(\\sec^2 x - 3)\\tan x \\sin 2x \\cr &\\quad = 3\\tan^2 x \\sin 2x \\cr &(\\sec^2 x - 3)\\tan x \\sin 2x \\cr &\\qquad - 3\\tan^2 x \\sin 2x = 0 \\cr &\\tan x \\sin 2x \\big[ (\\sec^2 x - 3) \\cr &\\qquad - 3\\tan x \\big] = 0 \\end{aligned}",
                "This gives two possible cases to solve:<br><br><strong>Case 1:</strong> $\\tan x \\sin 2x = 0$<br>Since $\\sin 2x = 2\\sin x \\cos x$, this simplifies to $2\\sin^2 x = 0 \\implies \\sin x = 0$, which yields:$$x = 0\\text{ radians}$$This solution lies within our given interval $-\\dfrac{\\pi}{2} < x < \\dfrac{\\pi}{2}$.",
                "<strong>Case 2:</strong> $(\\sec^2 x - 3) - 3\\tan x = 0$<br>Using the identity $\\sec^2 x = 1 + \\tan^2 x$, we rewrite this in terms of $\\tan x$:\\begin{aligned} 1 + \\tan^2 x - 3 - 3\\tan x &= 0 \\cr \\tan^2 x - 3\\tan x - 2 &= 0 \\end{aligned}Solving this quadratic in $\\tan x$ using the quadratic formula:\\begin{aligned} \\tan x &= \\dfrac{3 \\pm \\sqrt{(-3)^2 - 4(1)(-2)}}{2} \\cr &= \\dfrac{3 \\pm \\sqrt{17}}{2} \\end{aligned}",
                "Calculating the numerical values for $x$ in the interval $-\\dfrac{\\pi}{2} < x < \\dfrac{\\pi}{2}$:<br><br>For $\\tan x = \\dfrac{3 + \\sqrt{17}}{2}$:\\begin{aligned} \\tan x &\\approx 3.562 \\cr x &= \\arctan(3.562) \\cr &\\approx 1.297\\text{ rad} \\end{aligned}For $\\tan x = \\dfrac{3 - \\sqrt{17}}{2}$:\\begin{aligned} \\tan x &\\approx -0.562 \\cr x &= \\arctan(-0.562) \\cr &\\approx -0.512\\text{ rad} \\end{aligned}Therefore, the solutions are $x = 0\\text{ radians}$, $x \\approx 1.297\\text{ radians}$, and $x \\approx -0.512\\text{ radians}$.",
                "<strong>Final Answer</strong>\\begin{aligned} &x = 0\\text{ rad} \\cr &x \\approx 1.297\\text{ rad} \\cr &x \\approx -0.512\\text{ rad} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x = 0\\text{ rad} \\cr &x \\approx 1.300\\text{ rad} \\cr &x \\approx -0.510\\text{ rad} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x \\approx 1.297\\text{ rad} \\cr &x \\approx -0.512\\text{ rad} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x = 0\\text{ rad} \\cr &x \\approx -1.297\\text{ rad} \\cr &x \\approx 0.512\\text{ rad} \\end{aligned}",
...
},
{
        ...
        "steps": [
                ...
                "<strong>Final Answer</strong>\\begin{aligned} &x \\approx 0.300\\text{ rad} \\cr &x \\approx -0.681\\text{ rad} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x \\approx 0.300\\text{ rad} \\cr &x \\approx -0.688\\text{ rad} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x \\approx -0.300\\text{ rad} \\cr &x \\approx 0.681\\text{ rad} \\end{aligned}",
                        "feedback": "This error occurs if you make a sign error when solving the quadratic equation or factorising for the roots."
                },
                {
                        "ans": "\\begin{aligned} &x \\approx 0.300\\text{ rad} \\cr &x \\approx -0.681\\text{ rad} \\cr &x = 0 \\end{aligned}",
...
},
{
        ...
        "steps": [
                "<strong>(a) Proving the identity:</strong><br>We start by expanding the right-hand side (RHS) of the identity using the definitions $\\tan \\theta = \\dfrac{\\sin \\theta}{\\cos \\theta}$ and $\\sin 2\\theta = 2\\sin \\theta \\cos \\theta$:\\begin{aligned} &\\tan \\theta \\sin 2\\theta \\cr &\\quad = \\left(\\dfrac{\\sin \\theta}{\\cos \\theta}\\right)(2\\sin \\theta \\cos \\theta) \\cr &\\quad = 2\\sin^2 \\theta \\end{aligned}Now we expand the left-hand side (LHS) using the double angle identity $\\cos 2\\theta = \\cos^2 \\theta - \\sin^2 \\theta$ and the Pythagorean identity $\\cos^2 \\theta = 1 - \\sin^2 \\theta$:\\begin{aligned} 1 - \\cos 2\\theta &= 1 - (\\cos^2 \\theta - \\sin^2 \\theta) \\cr &= 1 - \\cos^2 \\theta + \\sin^2 \\theta \\cr &= (1 - \\cos^2 \\theta) + \\sin^2 \\theta \\cr &= \\sin^2 \\theta + \\sin^2 \\theta \\cr &= 2\\sin^2 \\theta \\end{aligned}Since LHS = RHS, the identity is proven: $1 - \\cos 2\\theta \\equiv \\tan \\theta \\sin 2\\theta$.",
                "<strong>(b) Solving the equation:</strong><br>We substitute our proven identity $1 - \\cos 2x = \\tan x \\sin 2x$ into the given equation:\\begin{aligned} &(\\sec^2 x - 6)(1 - \\cos 2x) \\cr &\\quad = 2\\tan^2 x \\sin 2x \\cr &(\\sec^2 x - 6)\\tan x \\sin 2x \\cr &\\quad = 2\\tan^2 x \\sin 2x \\cr &(\\sec^2 x - 6)\\tan x \\sin 2x \\cr &\\qquad - 2\\tan^2 x \\sin 2x = 0 \\cr &\\tan x \\sin 2x \\big[ (\\sec^2 x - 6) \\cr &\\qquad - 2\\tan x \\big] = 0 \\end{aligned}",
                "This gives two possible cases to solve:<br><br><strong>Case 1:</strong> $\\tan x \\sin 2x = 0$<br>Since $\\sin 2x = 2\\sin x \\cos x$, this simplifies to $2\\sin^2 x = 0 \\implies \\sin x = 0$, which yields:$$x = 0\\text{ radians}$$This solution lies within our given interval $-\\dfrac{\\pi}{2} < x < \\dfrac{\\pi}{2}$.",
                "<strong>Case 2:</strong> $(\\sec^2 x - 6) - 2\\tan x = 0$<br>Using the identity $\\sec^2 x = 1 + \\tan^2 x$, we rewrite this in terms of $\\tan x$:\\begin{aligned} 1 + \\tan^2 x - 6 - 2\\tan x &= 0 \\cr \\tan^2 x - 2\\tan x - 5 &= 0 \\end{aligned}Solving this quadratic in $\\tan x$ using the quadratic formula:\\begin{aligned} \\tan x &= \\dfrac{2 \\pm \\sqrt{(-2)^2 - 4(1)(-5)}}{2} \\cr &= \\dfrac{2 \\pm \\sqrt{24}}{2} \\cr &= 1 \\pm \\sqrt{6} \\end{aligned}",
                "Calculating the numerical values for $x$ in the interval $-\\dfrac{\\pi}{2} < x < \\dfrac{\\pi}{2}$:<br><br>For $\\tan x = 1 + \\sqrt{6}$:\\begin{aligned} \\tan x &\\approx 3.449 \\cr x &= \\arctan(3.449) \\cr &\\approx 1.289\\text{ rad} \\end{aligned}For $\\tan x = 1 - \\sqrt{6}$:\\begin{aligned} \\tan x &\\approx -1.449 \\cr x &= \\arctan(-1.449) \\cr &\\approx -0.967\\text{ rad} \\end{aligned}Therefore, the solutions are $x = 0\\text{ radians}$, $x \\approx 1.289\\text{ radians}$, and $x \\approx -0.967\\text{ radians}$.",
                "<strong>Final Answer</strong>\\begin{aligned} &x = 0\\text{ rad} \\cr &x \\approx 1.289\\text{ rad} \\cr &x \\approx -0.967\\text{ rad} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x = 0\\text{ rad} \\cr &x \\approx 1.290\\text{ rad} \\cr &x \\approx -0.970\\text{ rad} \\end{aligned}",
                ...
                {
                        "ans": "\\begin{aligned} &x \\approx 1.289\\text{ rad} \\cr &x \\approx -0.967\\text{ rad} \\end{aligned}",
                        "feedback": "This error occurs if you divide both sides of the equation directly by the common factor $\\tan x \\sin 2x$, completely deleting the valid solution branch where $\\tan x \\sin 2x = 0 \\implies x = 0$."
                },
                {
                        "ans": "\\begin{aligned} &x = 0\\text{ rad} \\cr &x \\approx -1.289\\text{ rad} \\cr &x \\approx 0.967\\text{ rad} \\end{aligned}",
        ...
        "bradley_insight": {
                ...
                "content": "When using the quadratic formula to solve $\\tan^2 x - 2\\tan x - 5 = 0$, verify your discriminant $(\\Delta = b^2 - 4ac)$ very carefully. It evaluates to $(-2)^2 - 4(1)(-5) = 24$. Since $\\Delta > 0$, we have two distinct real values for $\\tan x$, both of which correspond to valid angles in the interval."
        }
},
{
        "id": "004490",
        ...
        "steps": [
                ...
                "<strong>Final Answer</strong>\\begin{aligned} &x \\approx 0.274\\text{ rad} \\cr &x \\approx -1.059\\text{ rad} \\end{aligned}"
        ],
        "pi_options": [
                {
                        "ans": "\\begin{aligned} &x \\approx 0.274\\text{ rad} \\cr &x \\approx -1.060\\text{ rad} \\end{aligned}",
                        "feedback": "This is a rounding error that occurs if you convert the intermediate quadratic roots of $\\cot x$ into rounded degree values before applying the conversion to radians."
                },
                {
                        "ans": "\\begin{aligned} &x \\approx -0.274\\text{ rad} \\cr &x \\approx 1.059\\text{ rad} \\end{aligned}",
                        "feedback": "This error occurs if you make a sign error when solving the quadratic equation or factorising for the roots."
                },
                {
                        "ans": "\\begin{aligned} &x \\approx 0.274\\text{ rad} \\cr &x \\approx -1.059\\text{ rad} \\cr &x = 0 \\end{aligned}",
                        "feedback": "This error is the result of failing to exclude $x = 0$ from the final solution set, which is outside the domain of definition of $\\csc^2 x$."
                }
        ],
        "bradley_insight": {
                ...
                "content": "When solving $\\cot x = K$ for a negative value like $K \\approx -0.562$, inverting to $\\tan x \\approx -1.781$ is completely robust. Just be sure to verify that the resulting angle ($x \\approx -1.059\\text{ rad}$) falls within the interval $-\\dfrac{\\pi}{2} < x < \\dfrac{\\pi}{2}$, which it does."
        }
},
        {
        "id": "004491",
