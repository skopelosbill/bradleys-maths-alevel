window.ALEVEL_QUESTIONS = [
  {
    ...
    "img": false,
    "question": "A curve $C$ has equation $y = f(x)$ where $f(x) = x^3 - 6x^2$.<br><br><strong>Part (a)</strong> Find the coordinates of the stationary points of $C$ and determine their nature.<br><br><strong>Part (b)</strong> Sketch the curve $C$, clearly indicating the coordinates of the stationary points and the points where the curve crosses the coordinate axes.<br><br><strong>Part (c)</strong> Without performing the integration, state whether the integral below is positive or negative, giving a clear reason for your answer:$$\\int_{2}^{6} (x^3 - 6x^2) \\text{d}x$$",
    "steps": [
    ...
    "pi_options": [
      {
        "ans": "\\begin{aligned} &(0, 0) \\text{ (min)}, \\; (4, -32) \\text{ (max)} \\cr &\\text{Intercepts: } (0, 0), \\; (6, 0) \\cr &\\text{Integral: Negative} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(0, 0) \\text{ (max)}, \\; (4, -32) \\text{ (min)} \\cr &\\text{Intercepts: } (0, 0), \\; (6, 0) \\cr &\\text{Integral: Positive} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(0, 0) \\text{ (max)}, \\; (4, -16) \\text{ (min)} \\cr &\\text{Intercepts: } (0, 0), \\; (6, 0) \\cr &\\text{Integral: Negative} \\end{aligned}",
        "feedback": "Check your calculation of the $y$-coordinate for the stationary point at $x = 4$. Substituting $x = 4$ into $y = x^3 - 6x^2$ gives $64 - 96 = -32$, not $-16$."
      }
    ],
    "bradley_insight": {
      "type": "caution",
  ...
  },
  {
    ...
    "img": false,
    "question": "A curve $C$ has equation $y = 2x^3 - 3x^2 - 12x + 8$.<br><br><strong>Part (a)</strong> Find the coordinates of the stationary points of $C$ and determine their nature.<br><br><strong>Part (b)</strong> Sketch the curve $C$, clearly indicating the coordinates of the stationary points and the $y$-intercept.<br><br><strong>Part (c)</strong> Using your sketch, state the number of distinct real roots of the equation $2x^3 - 3x^2 - 12x + 8 = 0$, giving a clear reason for your answer.",
    "steps": [
    ...
    "pi_options": [
      {
        "ans": "\\begin{aligned} &(-1, 15) \\text{ (max)}, \\; (2, -12) \\text{ (min)} \\cr &y\\text{-intercept: } (0, 8) \\cr &\\text{Roots: } 1 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(-1, 9) \\text{ (max)}, \\; (2, -12) \\text{ (min)} \\cr &y\\text{-intercept: } (0, 8) \\cr &\\text{Roots: } 3 \\end{aligned}",
        "feedback": "Check your calculation of the $y$-coordinate for $x = -1$. Evaluating $y = 2(-1)^3 - 3(-1)^2 - 12(-1) + 8$ gives $-2 - 3 + 12 + 8 = 15$, not $9$."
      },
      {
        "ans": "\\begin{aligned} &(-1, 15) \\text{ (min)}, \\; (2, -12) \\text{ (max)} \\cr &y\\text{-intercept: } (0, 8) \\cr &\\text{Roots: } 3 \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "A curve $C$ has equation $y = 12x - x^3$.<br><br><strong>Part (a)</strong> Find the coordinates of the stationary points of $C$ and determine their nature.<br><br><strong>Part (b)</strong> Sketch the curve $C$, clearly indicating the coordinates of the stationary points and the points where the curve crosses the coordinate axes.<br><br><strong>Part (c)</strong> Without performing the integration, state whether the integral below is positive or negative, giving a clear reason for your answer:$$\\int_{0}^{\\sqrt{12}} (12x - x^3) \\text{d}x$$",
    "steps": [
    ...
    "pi_options": [
      {
        "ans": "\\begin{aligned} &(2, 16) \\text{ (max)}, \\; (-2, -32) \\text{ (min)} \\cr &\\text{Intercepts: } (0, 0), \\; (\\pm\\sqrt{12}, 0) \\cr &\\text{Integral: Positive} \\end{aligned}",
        "feedback": "Be very careful with sign evaluation. Substituting $x = -2$ into $y = 12x - x^3$ gives $-24 - (-8) = -16$, not $-32$. This is a very common sign error when cubing negative bases."
      },
      {
        "ans": "\\begin{aligned} &(2, 16) \\text{ (max)}, \\; (-2, -16) \\text{ (min)} \\cr &\\text{Intercepts: } (0, 0), \\; (\\pm\\sqrt{12}, 0) \\cr &\\text{Integral: Negative} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(2, 16) \\text{ (min)}, \\; (-2, -16) \\text{ (max)} \\cr &\\text{Intercepts: } (0, 0), \\; (\\pm\\sqrt{12}, 0) \\cr &\\text{Integral: Positive} \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "A curve $C$ has equation $y = 2 + \\dfrac{1}{x - 1}$.<br><br><strong>Part (a)</strong> State the equations of the vertical and horizontal asymptotes of $C$.<br><br><strong>Part (b)</strong> Find the coordinates of the points where $C$ crosses the coordinate axes.<br><br><strong>Part (c)</strong> Sketch the curve $C$, clearly indicating the asymptotes and the coordinates of the intersection points with the coordinate axes.",
    "steps": [
      "<strong>Step 1: Identify the asymptotes</strong><br>The vertical asymptote occurs where the denominator of the fraction is equal to zero, causing the function to be undefined:\\begin{aligned} x - 1 &= 0 \\cr x &= 1 \\end{aligned}The horizontal asymptote is found by observing the behavior of $y$ as $x \\to \\pm\\infty$. As $x$ becomes extremely large, $\\dfrac{1}{x - 1} \\to 0$:\\begin{aligned} y \\to 2 \\end{aligned}",
      "<strong>Step 2: Find the axis intercepts</strong><br>To find the $y$-intercept, set $x = 0$:\\begin{aligned} y &= 2 + \\dfrac{1}{0 - 1} \\cr &= 2 - 1 \\cr &= 1 \\implies (0, 1) \\end{aligned}<br><strong>To find the $x$-intercept, set $y = 0$:</strong>\\begin{aligned} 0 &= 2 + \\dfrac{1}{x - 1} \\cr \\dfrac{1}{x - 1} &= -2 \\cr x - 1 &= -0.5 \\cr x &= 0.5 \\implies (0.5, 0) \\end{aligned}",
      "<strong>Step 3: Sketch the curve</strong><br>This is a translated reciprocal curve of $y = \\dfrac{1}{x}$. Draw the asymptotes $x = 1$ and $y = 2$ as dashed lines, and sketch the branches passing through $(0, 1)$ and $(0.5, 0)$:<br><br><img src='images/Pure_SVGs/004354_ans.svg' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
      "Final Answer: \\begin{aligned} &\\text{Asymptotes: } x = 1, \\; y = 2 \\cr &y\\text{-intercept: } (0, 1) \\cr &x\\text{-intercept: } (0.5, 0) \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{Asymptotes: } x = 1, \\; y = 2 \\cr &\\text{Intercepts: } (0, -1), \\; (0.5, 0) \\end{aligned}",
        "feedback": "Check your $y$-intercept calculation. When $x = 0$, $y = 2 - 1 = 1$, not $-1$."
      },
      {
        "ans": "\\begin{aligned} &\\text{Asymptotes: } x = -1, \\; y = 2 \\cr &\\text{Intercepts: } (0, 1), \\; (0.5, 0) \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Asymptotes: } x = 1, \\; y = 2 \\cr &\\text{Intercepts: } (0, 1), \\; (2, 0) \\end{aligned}",
        "feedback": "Check your algebra when solving for the $x$-intercept. Setting $y = 0$ gives $\\dfrac{1}{x - 1} = -2$, so $x - 1 = -0.5$, which yields $x = 0.5$, not $2$."
      }
    ],
    "bradley_insight": {
      "type": "pro-tip",
  ...
  },
  {
    ...
    "steps": [
      ...
      "<strong>Step 3: Sketch the transformed curves</strong><br>The separate sets of axes for the original function and its two transformations are shown side-by-side below:<br><br><img src='images/Pure_SVGs/004355_ans.svg' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
      "Final Answer: \\begin{aligned} &\\text{Turning point: } (0, 9) \\cr &\\text{Intercepts: } (0, 9), \\; (3, 0), \\; (-3, 0) \\cr &\\text{(i) Turning point: } (0, 5) \\cr &\\text{(ii) Turning point: } (-2, 9) \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{Turning point: } (0, 9) \\cr &\\text{(i) Turning point: } (0, 5) \\cr &\\text{(ii) Turning point: } (2, 9) \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Turning point: } (0, 9) \\cr &\\text{(i) Turning point: } (4, 9) \\cr &\\text{(ii) Turning point: } (-2, 9) \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Turning point: } (0, 9) \\cr &\\text{(i) Turning point: } (0, 13) \\cr &\\text{(ii) Turning point: } (-2, 9) \\end{aligned}",
  ...
  "level": "AS",
  "major_area": "Exponentials and Logarithms",
  "topic": "Exponential and Log Functions",
  "subtopic": [
    "Solving Quadratics in Exponential Form"
  ],
  "img": false,
  "question": "<strong>(a)</strong> Solve the logarithmic equation:\\begin{aligned} &2\\log_{10} x \\cr &\\quad = 1 + \\log_{10} 8 - \\log_{10} 5 \\end{aligned}<strong>(b)</strong> Solve the exponential equation:$$5^x = 3e^{0.2x}$$giving your answer correct to 3 decimal places.<br><br><strong>(c)</strong> Express $9^x - 12 \\times 3^x$ in terms of $y$, where $y = 3^x$.<br><br>Hence, solve the equation:$$9^x - 12 \\times 3^x = -27$$",
  "steps": [
    "<strong>Part (a): Solving the logarithmic equation</strong><br><br>To solve the equation, we rewrite the constant 1 as a logarithm in base 10: $1 = \\log_{10} 10$.<br><br>Substitute this into the equation and use the laws of logarithms:\\begin{aligned} &2\\log_{10} x \\cr &\\quad = \\log_{10} 10 + \\log_{10} 8 - \\log_{10} 5 \\cr &\\log_{10}(x^2) \\cr &\\quad = \\log_{10} \\left( \\dfrac{10 \\times 8}{5} \\right) \\cr &\\log_{10}(x^2) = \\log_{10} 16 \\end{aligned}",
    "Now, equate the arguments of the logarithms:\\begin{aligned} x^2 &= 16 \\cr x &= \\pm 4 \\end{aligned}Since the argument of a logarithm must be strictly positive ($x > 0$), we reject $x = -4$.<br><br>Thus, the only valid solution is $x = 4$.",
    "<strong>Part (b): Solving the exponential equation</strong><br><br>Take the natural logarithm ($\\ln$) of both sides of $5^x = 3e^{0.2x}$:\\begin{aligned} \\ln(5^x) &= \\ln(3e^{0.2x}) \\cr x\\ln(5) &= \\ln(3) + 0.2x \\end{aligned}",
    "Rearrange to group the $x$ terms on one side and solve:\\begin{aligned} x\\ln(5) - 0.2x &= \\ln(3) \\cr x(\\ln(5) - 0.2) &= \\ln(3) \\cr x &= \\dfrac{\\ln(3)}{\\ln(5) - 0.2} \\end{aligned}Evaluate this expression numerically:\\begin{aligned} x &\\approx \\dfrac{1.098612}{1.609438 - 0.2} \\cr &\\approx \\dfrac{1.098612}{1.409438} \\cr &\\approx 0.779468 \\end{aligned}Rounding to 3 decimal places gives $x \\approx 0.779$.",
    "<strong>Part (c): Solving the quadratic in exponential form</strong><br><br>Let $y = 3^x$. We can express $9^x$ as $(3^2)^x = (3^x)^2$, which gives $y^2$.<br><br>Substituting these into $9^x - 12 \\times 3^x$, our expression in terms of $y$ is $y^2 - 12y$.<br><br>We now solve the equation $y^2 - 12y = -27$:\\begin{aligned} y^2 - 12y + 27 &= 0 \\cr (y - 3)(y - 9) &= 0 \\end{aligned}This yields $y = 3$ or $y = 9$.",
    "Now substitute back $y = 3^x$ and solve for $x$:<br><br>1. For $y = 3$:\\begin{aligned} 3^x &= 3 \\cr x &= 1 \\end{aligned}<br><br>2. For $y = 9$:\\begin{aligned} 3^x &= 9 \\cr x &= 2 \\end{aligned}Thus, the solutions are $x = 1$ or $x = 2$.",
    "Final Answer:\\begin{aligned} &\\text{(a) } x = 4 \\cr &\\text{(b) } x \\approx 0.779 \\cr &\\text{(c) } x = 1 \\text{ or } x = 2 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &\\text{(a) } x = 4 \\cr &\\text{(b) } x = 0.780 \\cr &\\text{(c) } x = 1 \\text{ or } x = 2 \\end{aligned}",
      "feedback": "This is a rounding slip in part (b). Evaluating $\\dfrac{\\ln(3)}{\\ln(5) - 0.2}$ yields $0.779468\\dots$ Since the digit in the ten-thousandths place is 4, this must round down to $0.779$ instead of up to $0.780$."
    },
    {
      "ans": "\\begin{aligned} &\\text{(a) } x = 4 \\cr &\\text{(b) } x = 0.779 \\cr &\\text{(c) } x = 3 \\text{ or } x = 9 \\end{aligned}",
      "feedback": "In part (c), $y = 3$ and $y = 9$ are the intermediate solutions for $y$, where $y = 3^x$. You must complete the final step of solving for $x$ by writing $3^x = 3$, giving $x = 1$, and $3^x = 9$, giving $x = 2$."
    },
    {
      "ans": "\\begin{aligned} &\\text{(a) } x = 4 \\text{ or } x = -4 \\cr &\\text{(b) } x = 0.779 \\cr &\\text{(c) } x = 1 \\text{ or } x = 2 \\end{aligned}",
...
},
{
  ...
  "img": false,
  "question": "Solve the following equation for $x$:\\begin{aligned} &\\log_2 (2x + 1) \\cr &\\quad - \\log_2 (x - 1) = 3 \\end{aligned}Show all of your working clearly.",
  "steps": [
    "Apply the subtraction law of logarithms ($\\log_b A - \\log_b B = \\log_b \\left( \\dfrac{A}{B} \\right)$) to combine the left-hand side into a single logarithmic term:\\begin{aligned} \\log_2 \\left( \\dfrac{2x + 1}{x - 1} \\right) = 3 \\end{aligned}",
    "To remove the logarithm, rewrite the equation in its equivalent exponential form:\\begin{aligned} \\dfrac{2x + 1}{x - 1} &= 2^3 \\cr &= 8 \\end{aligned}",
    "Solve the resulting linear equation for $x$:\\begin{aligned} 2x + 1 &= 8(x - 1) \\cr 2x + 1 &= 8x - 8 \\cr -6x &= -9 \\cr x &= \\dfrac{-9}{-6} \\cr x &= 1.5 \\end{aligned}",
    "We must verify that $x = 1.5$ satisfies the domain of the original logs:<br><br>1. For $\\log_2 (2x + 1)$: $2(1.5) + 1 = 4$, which is $> 0$ (valid).<br><br>2. For $\\log_2 (x - 1)$: $1.5 - 1 = 0.5$, which is $> 0$ (valid).<br><br>Thus, the solution is $x = 1.5$.",
    "Final Answer:\\begin{aligned} x = 1.5 \\text{ (or } \\dfrac{3}{2}\\text{)} \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} x = -1.5 \\end{aligned}",
      "feedback": "This is a sign error during algebraic rearrangement. Moving terms across the equals sign correctly gives $-6x = -9$, which yields $x = 1.5$."
    },
    {
      "ans": "\\begin{aligned} x = 1.25 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} x = 0.4 \\end{aligned}",
...
},
{
  ...
  "img": false,
  "question": "Solve the exponential equation:$$4^{2x - 1} = 5^{x + 2}$$giving your answer correct to 3 decimal places.",
  "steps": [
    "Take the natural logarithm ($\\ln$) of both sides of the equation:\\begin{aligned} \\ln\\left( 4^{2x - 1} \\right) = \\ln\\left( 5^{x + 2} \\right) \\end{aligned}",
    "Use the power law of logarithms to bring the exponents down as multipliers:\\begin{aligned} (2x - 1)\\ln(4) = (x + 2)\\ln(5) \\end{aligned}",
    "Expand the brackets and group all terms containing $x$ on one side of the equation:\\begin{aligned} &2x\\ln(4) - \\ln(4) \\cr &\\quad = x\\ln(5) + 2\\ln(5) \\cr &2x\\ln(4) - x\\ln(5) \\cr &\\quad = \\ln(4) + 2\\ln(5) \\end{aligned}",
    "Factor out $x$ on the left-hand side and solve:\\begin{aligned} &x\\big(2\\ln(4) - \\ln(5)\\big) \\cr &\\quad = \\ln(4) + 2\\ln(5) \\cr &x = \\dfrac{\\ln(4) + 2\\ln(5)}{2\\ln(4) - \\ln(5)} \\end{aligned}",
    "Evaluate this expression numerically using a calculator:\\begin{aligned} x &\\approx \\dfrac{1.386294 + 3.218876}{2.772588 - 1.609438} \\cr &\\approx \\dfrac{4.605170}{1.163150} \\cr &\\approx 3.959220 \\end{aligned}Rounding to 3 decimal places gives $x \\approx 3.959$.",
    "Final Answer:\\begin{aligned} x \\approx 3.959 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} x = 3.961 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} x = 1.000 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} x = 2.454 \\end{aligned}",
      "feedback": "This error is typically caused by a sign error when grouping the terms, such as subtracting $\\ln(4)$ on the right-hand side instead of adding it, leading to $x = \\dfrac{2\\ln(5) - \\ln(4)}{2\\ln(4) - \\ln(5)}$, which evaluates to approximately $2.454$."
    }
  ],
  "bradley_insight": {
    "type": "pro-tip",
...
},
{
  ...
  "img": false,
  "question": "Solve the equation:$$2^{2x} - 2^{x + 2} - 32 = 0$$giving your answer in its simplest exact form.",
  "steps": [
    "Use the laws of indices to split and rewrite the exponential terms in terms of a single base $2^x$:<br><br>1. $2^{2x} = (2^x)^2$<br><br>2. $2^{x + 2} = 2^x \\times 2^2$, which simplifies to $4(2^x)$.<br><br>Substitute these into our equation:\\begin{aligned} (2^x)^2 - 4(2^x) - 32 = 0 \\end{aligned}",
    "Introduce a substitution variable. Let $y = 2^x$. This transforms the exponential equation into a standard quadratic equation in terms of $y$:\\begin{aligned} y^2 - 4y - 32 = 0 \\end{aligned}",
    "Solve the quadratic equation by factoring:\\begin{aligned} (y - 8)(y + 4) = 0 \\end{aligned}This gives $y = 8$ or $y = -4$.",
    "Now substitute $y = 2^x$ back to solve for $x$:<br><br>1. For $y = 8$:\\begin{aligned} 2^x &= 8 \\cr 2^x &= 2^3 \\cr x &= 3 \\end{aligned}<br><br>2. For $y = -4$:\\begin{aligned} 2^x = -4 \\end{aligned}Since $2^x$ must be strictly positive for all real values of $x$ (the range of $a^x$ is $y > 0$), this equation has no real solutions.<br><br>Thus, the only valid solution is $x = 3$.",
    "Final Answer:\\begin{aligned} x = 3 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} x = 3 \\text{ or } x = -2 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} y = 8 \\text{ or } y = -4 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} x = 5 \\end{aligned}",
...
},
{
  ...
  "topic": "Exponentials and Logarithms",
  "subtopic": [
    "Solving Simultaneous Log Equations"
  ],
  "img": false,
  "question": "Solve the simultaneous equations:\\begin{aligned} \\log_3 x + \\log_3 y &= 2 \\cr \\log_3 (2x - y) &= 1 \\end{aligned}Show all of your algebraic working clearly, explaining why any solutions must be rejected.",
  "steps": [
    "Apply the addition law of logarithms to combine the left-hand side of the first equation:\\begin{aligned} \\log_3(xy) = 2 \\end{aligned}Convert this to its equivalent exponential form:\\begin{aligned} xy &= 3^2 \\cr xy &= 9 \\end{aligned}",
    "Now convert the second equation to its equivalent exponential form:\\begin{aligned} 2x - y &= 3^1 \\cr 2x - y &= 3 \\end{aligned}",
    "We now have a system of simultaneous equations:<br><br>1. $xy = 9$<br><br>2. $2x - y = 3$, which gives $y = 2x - 3$.<br><br>Substitute the expression for $y$ from the second equation into the first equation:\\begin{aligned} x(2x - 3) &= 9 \\cr 2x^2 - 3x - 9 &= 0 \\end{aligned}",
    "Solve the quadratic equation by factoring:\\begin{aligned} 2x^2 - 6x + 3x - 9 &= 0 \\cr 2x(x - 3) + 3(x - 3) &= 0 \\cr (2x + 3)(x - 3) &= 0 \\end{aligned}This gives $x = 3$ or $x = -1.5$ (or $-\\dfrac{3}{2}$).",
    "Now, calculate the corresponding $y$-values using $y = 2x - 3$:<br><br>1. If $x = 3$:\\begin{aligned} y &= 2(3) - 3 \\cr &= 3 \\end{aligned}<br><br>2. If $x = -1.5$:\\begin{aligned} y &= 2(-1.5) - 3 \\cr &= -6 \\end{aligned}",
    "Verify both coordinate pairs against the domains of the original logarithmic equations:<br><br>1. For $(3, 3)$: the log arguments $x = 3$ and $y = 3$ are positive, and $2x - y = 6 - 3 = 3$, which is $> 0$. All are positive, so $(3, 3)$ is a valid solution.<br><br>2. For $(-1.5, -6)$: the log arguments are $x = -1.5 < 0$ and $y = -6 < 0$. Since logarithms of negative numbers are undefined, this coordinate pair must be rejected.<br><br>Thus, the only valid solution is $x = 3, y = 3$.",
    "Final Answer:\\begin{aligned} &x = 3 \\cr &y = 3 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &x = 3, y = 3 \\cr &x = -1.5, y = -6 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &x = 1.5 \\cr &y = 6 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &x = 3 \\cr &y = -3 \\end{aligned}",
  ...
  "steps": [
    "<strong>Part (a): Showing $BAC$ is a right angle</strong><br><br>To show that angle $BAC$ is a right angle, we calculate the gradients of the line segments $AB$ and $AC$ and show that they are perpendicular:<br><br>1. Gradient of $AB$ ($m_{AB}$):\\begin{aligned} m_{AB} &= \\dfrac{10 - 6}{4 - 2} \\cr &= \\dfrac{4}{2} \\cr &= 2 \\end{aligned}<br><br>2. Gradient of $AC$ ($m_{AC}$):\\begin{aligned} m_{AC} &= \\dfrac{4 - 6}{6 - 2} \\cr &= \\dfrac{-2}{4} \\cr &= -\\dfrac{1}{2} \\end{aligned}",
    "Multiply the two gradients to check for perpendicularity:\\begin{aligned} m_{AB} \\times m_{AC} &= 2 \\times \\left( -\\dfrac{1}{2} \\right) \\cr &= -1 \\end{aligned}Since the product of the gradients is $-1$, the lines $AB$ and $AC$ are perpendicular, which proves that $BAC$ is a right angle.",
    "<strong>Part (b): Determining the equation of the circle</strong><br><br>By Thales's Theorem, since $BAC$ is a right angle on the circumference of a circle, the line segment connecting $B(4, 10)$ and $C(6, 4)$ must be a diameter of the circle.<br><br>The centre of the circle is the midpoint of the diameter $BC$:\\begin{aligned} \\text{Centre } (h, k) &= \\left( \\dfrac{4 + 6}{2}, \\dfrac{10 + 4}{2} \\right) \\cr &= (5, 7) \\end{aligned}",
    "The radius squared ($r^2$) is the distance from the centre $(5, 7)$ to any point on the circle, such as $C(6, 4)$:\\begin{aligned} r^2 &= (6 - 5)^2 + (4 - 7)^2 \\cr &= 1^2 + (-3)^2 \\cr &= 1 + 9 \\cr &= 10 \\end{aligned}Now, write the equation of the circle in standard form $(x - h)^2 + (y - k)^2 = r^2$:\\begin{aligned} (x - 5)^2 + (y - 7)^2 = 10 \\end{aligned}",
    "Final Answer:\\begin{aligned} (x - 5)^2 + (y - 7)^2 = 10 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} (x - 5)^2 + (y - 7)^2 = 100 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} (x - 5)^2 + (y - 7)^2 = 40 \\end{aligned}",
      "feedback": "This is a calculation error in finding the radius squared. Make sure you calculate the distance from the centre $(5, 7)$ to one of the points correctly: $r^2 = 1 + 9 = 10$, not $40$."
    },
    {
      "ans": "\\begin{aligned} (x + 5)^2 + (y + 7)^2 = 10 \\end{aligned}",
...
},
{
 ...
 "subtopic": [
  ...
  "steps": [
    "<strong>Part (a): Finding the centre and radius</strong><br><br>Complete the square for both $x$ and $y$ variables in the equation:\\begin{aligned} x^2 - 6x &= (x - 3)^2 - 9 \\cr y^2 + 8y &= (y + 4)^2 - 16 \\end{aligned}Substitute these back into the original equation:\\begin{aligned} &(x - 3)^2 - 9 + (y + 4)^2 \\cr &\\qquad - 16 - 9 = 0 \\cr &(x - 3)^2 + (y + 4)^2 - 34 = 0 \\cr &(x - 3)^2 + (y + 4)^2 = 34 \\end{aligned}Thus, the centre of $C$ is $(3, -4)$ and the exact radius is $r = \\sqrt{34}$.",
    "<strong>Part (b): Showing $P(6, 1)$ lies on the circle</strong><br><br>Substitute the coordinates $x = 6, y = 1$ into our completed square equation:\\begin{aligned} (6 - 3)^2 + (1 + 4)^2 &= 3^2 + 5^2 \\cr &= 9 + 25 \\cr &= 34 \\end{aligned}Since the substitution satisfies the circle's equation, the point $P(6, 1)$ lies on the circle.",
    "<strong>Part (c): Finding the equation of the tangent at $P$</strong><br><br>First, find the gradient of the radius connecting the centre $C(3, -4)$ to $P(6, 1)$:\\begin{aligned} m_r &= \\dfrac{1 - (-4)}{6 - 3} \\cr &= \\dfrac{5}{3} \\end{aligned}Since the tangent is perpendicular to the radius, its gradient ($m_t$) is the negative reciprocal:\\begin{aligned} m_t &= -\\dfrac{1}{m_r} \\cr &= -\\dfrac{3}{5} \\end{aligned}",
    "Use the point-slope formula with $P(6, 1)$ and $m_t = -\\dfrac{3}{5}$:\\begin{aligned} y - 1 &= -\\dfrac{3}{5}(x - 6) \\cr 5(y - 1) &= -3(x - 6) \\cr 5y - 5 &= -3x + 18 \\cr 3x + 5y - 23 &= 0 \\end{aligned}Thus, the equation of the tangent is $3x + 5y - 23 = 0$.",
    "Final Answer:\\begin{aligned} &\\text{Centre: } (3, -4) \\cr &\\text{Radius} = \\sqrt{34} \\cr &3x + 5y - 23 = 0 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &\\text{Centre: } (3, -4) \\cr &\\text{Radius} = 34 \\cr &3x + 5y - 23 = 0 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\text{Centre: } (-3, 4) \\cr &\\text{Radius} = \\sqrt{34} \\cr &3x + 5y + 23 = 0 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\text{Centre: } (3, -4) \\cr &\\text{Radius} = \\sqrt{34} \\cr &5x - 3y - 27 = 0 \\end{aligned}",
...
},
{
  ...
  "steps": [
    "<strong>Part (a): Showing the intersection points</strong><br><br>Substitute the equation of the line $y = x - 2$ into the equation of the circle:\\begin{aligned} (x - 2)^2 + (x - 2 - 1)^2 &= 25 \\cr (x - 2)^2 + (x - 3)^2 &= 25 \\end{aligned}Expand both brackets and simplify:\\begin{aligned} &(x^2 - 4x + 4) \\cr &\\qquad + (x^2 - 6x + 9) = 25 \\cr &2x^2 - 10x + 13 = 25 \\cr &2x^2 - 10x - 12 = 0 \\end{aligned}",
    "Divide the entire equation by 2 and factor the resulting quadratic:\\begin{aligned} x^2 - 5x - 6 &= 0 \\cr (x - 6)(x + 1) &= 0 \\end{aligned}This gives $x = 6$ or $x = -1$.",
    "Now substitute these $x$-values back into $y = x - 2$ to find the corresponding $y$-coordinates:<br><br>1. For $x = 6$:\\begin{aligned} y &= 6 - 2 \\cr &= 4 \\end{aligned}This gives $P(6, 4)$.<br><br>2. For $x = -1$:\\begin{aligned} y &= -1 - 2 \\cr &= -3 \\end{aligned}This gives $Q(-1, -3)$.<br><br>This confirms that the line intersects the circle at $P(6, 4)$ and $Q(-1, -3)$.",
    "<strong>Part (b): Calculating the chord length $PQ$</strong><br><br>Use the distance formula between the points $P(6, 4)$ and $Q(-1, -3)$:\\begin{aligned} PQ &= \\sqrt{(6 - (-1))^2 + (4 - (-3))^2} \\cr &= \\sqrt{7^2 + 7^2} \\cr &= \\sqrt{49 + 49} \\cr &= \\sqrt{98} \\cr &= 7\\sqrt{2} \\end{aligned}Thus, the exact length of the chord $PQ$ is $7\\sqrt{2}$ units.",
    "Final Answer:\\begin{aligned} &\\text{Points: } P(6, 4) \\text{ and } Q(-1, -3) \\cr &PQ = 7\\sqrt{2} \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} PQ = \\sqrt{14} \\end{aligned}",
      "feedback": "This error occurs if you subtract the coordinates incorrectly or forget to square the differences before adding, calculating $PQ = \\sqrt{(6 - (-1)) + (4 - (-3))}$, which gives $\\sqrt{14}$."
    },
    {
      "ans": "\\begin{aligned} PQ = 14 \\end{aligned}",
      "feedback": "This error occurs if you assume $PQ = 7 + 7 = 14$. You must use the Pythagorean distance formula $PQ = \\sqrt{\\Delta x^2 + \\Delta y^2}$, which evaluates to $7\\sqrt{2}$."
    },
    {
      "ans": "\\begin{aligned} &PQ = 7\\sqrt{2} \\cr &\\text{with } P(6, 4) \\text{ and } Q(1, -1) \\end{aligned}",
...
},
{
  ...
  "steps": [
    "<strong>Part (a): Finding the centre of $C$</strong><br><br>Since $A$ and $B$ are the endpoints of a diameter, the centre of the circle is the midpoint of the line segment $AB$:\\begin{aligned} \\text{Centre } (h, k) &= \\left( \\dfrac{-2 + 6}{2}, \\dfrac{5 + 11}{2} \\right) \\cr &= \\left( \\dfrac{4}{2}, \\dfrac{16}{2} \\right) \\cr &= (2, 8) \\end{aligned}",
    "<strong>Part (b): Finding the radius of $C$</strong><br><br>First, calculate the length of the diameter $AB$ using the distance formula:\\begin{aligned} AB &= \\sqrt{(6 - (-2))^2 + (11 - 5)^2} \\cr &= \\sqrt{8^2 + 6^2} \\cr &= \\sqrt{64 + 36} \\cr &= \\sqrt{100} \\cr &= 10 \\end{aligned}The radius $r$ is half the length of the diameter:\\begin{aligned} r &= \\dfrac{AB}{2} \\cr &= \\dfrac{10}{2} \\cr &= 5 \\end{aligned}",
    "<strong>Part (c): Determining the expanded equation of the circle</strong><br><br>First, write the equation of the circle in standard centre-radius form:\\begin{aligned} (x - 2)^2 + (y - 8)^2 &= 5^2 \\cr (x - 2)^2 + (y - 8)^2 &= 25 \\end{aligned}",
    "Now, fully expand the brackets and group the terms:\\begin{aligned} &(x^2 - 4x + 4) \\cr &\\qquad + (y^2 - 16y + 64) = 25 \\cr &x^2 + y^2 - 4x - 16y \\cr &\\qquad + 68 = 25 \\cr &x^2 + y^2 - 4x - 16y \\cr &\\qquad + 43 = 0 \\end{aligned}",
    "Final Answer:\\begin{aligned} &\\text{Centre: } (2, 8) \\cr &r = 5 \\cr &x^2 + y^2 - 4x - 16y \\cr &\\qquad + 43 = 0 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &x^2 + y^2 - 4x - 16y \\cr &\\qquad + 93 = 0 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &x^2 + y^2 + 4x + 16y \\cr &\\qquad + 43 = 0 \\end{aligned}",
      "feedback": "This is a sign error in the expanded form, which happens if you use a centre of $(-2, -8)$ instead of $(2, 8)$."
    },
    {
      "ans": "\\begin{aligned} &x^2 + y^2 - 4x - 16y \\cr &\\qquad + 68 = 0 \\end{aligned}",
...
},
{
  ...
  "steps": [
    "<strong>Part (a): Setting up the simultaneous equation and discriminant</strong><br><br>Substitute the line equation $y = 2x + k$ into the circle equation:\\begin{aligned} x^2 + (2x + k)^2 &= 20 \\cr x^2 + (4x^2 + 4kx + k^2) &= 20 \\cr 5x^2 + 4kx + k^2 - 20 &= 0 \\end{aligned}",
    "This is a quadratic equation of the form $ax^2 + bx + c = 0$, where:\\begin{aligned} a &= 5 \\cr b &= 4k \\cr c &= k^2 - 20 \\end{aligned}For the line to be tangent to the circle, they must intersect at exactly one point. This means our quadratic equation must have exactly one real root, so its discriminant must equal zero ($b^2 - 4ac = 0$):\\begin{aligned} (4k)^2 - 4(5)(k^2 - 20) &= 0 \\cr 16k^2 - 20(k^2 - 20) &= 0 \\cr 16k^2 - 20k^2 + 400 &= 0 \\cr -4k^2 + 400 &= 0 \\end{aligned}",
    "Divide the entire equation by $-4$ to simplify:\\begin{aligned} k^2 - 100 = 0 \\end{aligned}This is the required equation.",
    "<strong>Part (b): Solving for $k$</strong><br><br>Solve the equation by taking square roots:\\begin{aligned} k^2 &= 100 \\cr k &= \\pm 10 \\end{aligned}Thus, the two possible values of $k$ are $k = 10$ or $k = -10$.",
    "Final Answer:\\begin{aligned} k = 10 \\text{ or } k = -10 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} k = 100 \\text{ or } k = -100 \\end{aligned}",
      "feedback": "This is a basic algebraic error where taking the square root is omitted: taking the square root of $k^2 = 100$ gives $k = \\pm 10$, not $\\pm 100$."
    },
    {
      "ans": "\\begin{aligned} k = 20 \\text{ or } k = -20 \\end{aligned}",
      "feedback": "This error occurs if you make a calculation slip in evaluating the discriminant, such as calculating $16k^2 - 20(k^2 - 20) = 0$ as $-4k^2 + 80 = 0$, giving $k^2 = 20$."
    },
    {
      "ans": "\\begin{aligned} k = 10 \\end{aligned}",
  ...
  "topic": "Algebraic Methods",
  "subtopic": [
    "Simultaneous Linear Equations in 3 Variables"
  ],
  "img": false,
  "question": "Solve the following simultaneous equations:\\begin{aligned} 2x + y - z &= 5 \\cr x - 2y + 3z &= -6 \\cr 3x + y + 2z &= 3 \\end{aligned}Show all of your algebraic working clearly.",
  "steps": [
    "We label our three equations to keep our working organized:<br><br>1. $2x + y - z = 5$<br><br>2. $x - 2y + 3z = -6$<br><br>3. $3x + y + 2z = 3$",
    "<strong>Step 1: Eliminate $y$ using Equations 1 and 3</strong><br><br>Rearrange Equation 1 to express $y$ in terms of $x$ and $z$:\\begin{aligned} y = 5 - 2x + z \\end{aligned}Substitute this expression into Equation 3:\\begin{aligned} &3x + (5 - 2x + z) \\cr &\\qquad + 2z = 3 \\cr &3x + 5 - 2x + z \\cr &\\qquad + 2z = 3 \\cr &x + 3z + 5 = 3 \\cr &x + 3z = -2 \\end{aligned}We call this Equation 4: $x + 3z = -2$. Rearranging gives:\\begin{aligned} x = -2 - 3z \\end{aligned}",
    "<strong>Step 2: Substitute our expressions into Equation 2</strong><br><br>First, substitute $x = -2 - 3z$ into our expression for $y$:\\begin{aligned} y &= 5 - 2(-2 - 3z) + z \\cr &= 5 + 4 + 6z + z \\cr &= 9 + 7z \\end{aligned}Substitute $y = 9 + 7z$ and $x = -2 - 3z$ directly into Equation 2:\\begin{aligned} &(-2 - 3z) - 2(9 + 7z) \\cr &\\qquad + 3z = -6 \\cr &-2 - 3z - 18 \\cr &\\qquad - 14z + 3z = -6 \\cr &-20 - 14z = -6 \\cr &-14z = 14 \\cr &z = -1 \\end{aligned}",
    "<strong>Step 3: Solve for $x$ and $y$</strong><br><br>Substitute $z = -1$ back into our expression for $x$:\\begin{aligned} x &= -2 - 3(-1) \\cr &= -2 + 3 \\cr &= 1 \\end{aligned}Substitute $x = 1$ and $z = -1$ back into our expression for $y$ (Equation 1):\\begin{aligned} y &= 5 - 2(1) + (-1) \\cr &= 5 - 2 - 1 \\cr &= 2 \\end{aligned}Thus, the solutions are $x = 1, y = 2, z = -1$.",
    "Final Answer:\\begin{aligned} &x = 1 \\cr &y = 2 \\cr &z = -1 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &x = 2 \\cr &y = -1 \\cr &z = 3 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &x = 1 \\cr &y = 2 \\cr &z = 1 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &x = -1 \\cr &y = 2 \\cr &z = -1 \\end{aligned}",
      "feedback": "This error occurs if you make a calculation slip when evaluating the linear equation $x + 3z = -2$. Double-check that substituting $z = -1$ yields $x - 3 = -2$, which gives $x = 1$."
    }
  ],
  "bradley_insight": {
    "type": "pro-tip",
...
},
{
  ...
  "img": false,
  "question": "Solve the simultaneous equations:\\begin{aligned} x + 3y + z &= 1 \\cr 2x - y &= 8 \\cr x - 2y - z &= 3 \\end{aligned}",
  "steps": [
    "We label our three equations to analyze the system:<br><br>1. $x + 3y + z = 1$<br><br>2. $2x - y = 8$<br><br>3. $x - 2y - z = 3$",
    "<strong>Step 1: Eliminate $z$ using Equations 1 and 3</strong><br><br>Notice that Equation 2 does not contain the variable $z$. We can easily eliminate $z$ from the other two equations by adding Equation 1 and Equation 3 directly:\\begin{aligned} &(x + 3y + z) \\cr &\\qquad + (x - 2y - z) = 1 + 3 \\cr &2x + y = 4 \\end{aligned}We call this Equation 4: $2x + y = 4$.",
    "<strong>Step 2: Solve the two-variable system</strong><br><br>We now have a simple system of two simultaneous equations in terms of $x$ and $y$:\\begin{aligned} 2x - y &= 8 \\cr 2x + y &= 4 \\end{aligned}Add Equation 2 and Equation 4 to eliminate $y$:\\begin{aligned} (2x - y) + (2x + y) &= 8 + 4 \\cr 4x &= 12 \\cr x &= 3 \\end{aligned}",
    "Substitute $x = 3$ back into Equation 4 to solve for $y$:\\begin{aligned} 2(3) + y &= 4 \\cr 6 + y &= 4 \\cr y &= -2 \\end{aligned}",
    "<strong>Step 3: Solve for $z$</strong><br><br>Substitute $x = 3$ and $y = -2$ into Equation 1 to find $z$:\\begin{aligned} x + 3y + z &= 1 \\cr 3 + 3(-2) + z &= 1 \\cr 3 - 6 + z &= 1 \\cr -3 + z &= 1 \\cr z &= 4 \\end{aligned}Thus, the solutions are $x = 3, y = -2, z = 4$.",
    "Final Answer:\\begin{aligned} &x = 3 \\cr &y = -2 \\cr &z = 4 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &x = 3 \\cr &y = -2 \\cr &z = 1 \\end{aligned}",
      "feedback": "This is a calculation slip in the final step. Substituting $x = 3$ and $y = -2$ back into the first equation yields $3 - 6 + z = 1$, which gives $z = 4$, not $z = 1$."
    },
    {
      "ans": "\\begin{aligned} &x = -3 \\cr &y = 2 \\cr &z = 4 \\end{aligned}",
...
},
{
  ...
  "img": false,
  "question": "At a local cinema, ticket prices are £$x$ for children, £$y$ for students, and £$z$ for adults.<br><br>* The cost of $1$ child ticket, $2$ student tickets, and $1$ adult ticket is £$26$.<br><br>* The cost of $2$ child tickets, $1$ student ticket, and $3$ adult tickets is £$44$.<br><br>* The cost of $3$ child tickets and $2$ adult tickets is £$32$.<br><br><strong>(a)</strong> Write down three equations in terms of $x$, $y$, and $z$ to represent this information.<br><br><strong>(b)</strong> Solve your equations algebraically to find the price of each type of ticket.",
  "steps": [
    "<strong>Part (a): Writing the equations</strong><br><br>Translate each bullet point into an algebraic equation:<br><br>1. $x + 2y + z = 26$<br><br>2. $2x + y + 3z = 44$<br><br>3. $3x + 2z = 32$",
    "<strong>Part (b): Solving the system</strong><br><br>We notice that Equation 3 does not contain $y$. Let's express $z$ in terms of $x$ from Equation 3:\\begin{aligned} 2z &= 32 - 3x \\cr z &= 16 - 1.5x \\end{aligned}",
    "Now, eliminate $y$ from Equations 1 and 2. Rearrange Equation 1 to express $y$:\\begin{aligned} 2y &= 26 - x - z \\cr y &= 13 - 0.5x - 0.5z \\end{aligned}Substitute this expression for $y$ into Equation 2:\\begin{aligned} &2x + y + 3z = 44 \\cr &2x + (13 - 0.5x - 0.5z) \\cr &\\qquad + 3z = 44 \\cr &1.5x + 13 + 2.5z = 44 \\cr &1.5x + 2.5z = 31 \\end{aligned}",
    "Multiply this simplified equation by 2 to clear the decimals, forming Equation 4:\\begin{aligned} 3x + 5z = 62 \\end{aligned}Substitute our expression for $z$ ($z = 16 - 1.5x$) into Equation 4:\\begin{aligned} 3x + 5(16 - 1.5x) &= 62 \\cr 3x + 80 - 7.5x &= 62 \\cr -4.5x + 80 &= 62 \\cr -4.5x &= -18 \\cr x &= 4 \\end{aligned}",
    "Now, find $y$ and $z$ by substituting $x = 4$ back into our expressions:<br><br>1. For $z$:\\begin{aligned} z &= 16 - 1.5(4) \\cr &= 16 - 6 \\cr &= 10 \\end{aligned}<br><br>2. For $y$ (substituting $x = 4, z = 10$ into Equation 1):\\begin{aligned} 4 + 2y + 10 &= 26 \\cr 14 + 2y &= 26 \\cr 2y &= 12 \\cr y &= 6 \\end{aligned}Thus, the ticket prices are £$4$ for children, £$6$ for students, and £$10$ for adults.",
    "Final Answer:\\begin{aligned} &\\text{Child: } £4 \\cr &\\text{Student: } £6 \\cr &\\text{Adult: } £10 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &\\text{Child: } £5 \\cr &\\text{Student: } £5 \\cr &\\text{Adult: } £11 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\text{Child: } £4 \\cr &\\text{Student: } £6 \\cr &\\text{Adult: } £8 \\end{aligned}",
      "feedback": "This is a substitution error when solving for the adult ticket price $z$. Substituting $x = 4$ into the third equation yields $12 + 2z = 32$, which gives $2z = 20$, so $z = 10$, not $8$."
    },
    {
      "ans": "\\begin{aligned} &\\text{Child: } £6 \\cr &\\text{Student: } £4 \\cr &\\text{Adult: } £10 \\end{aligned}",
...
},
{
  ...
  "img": false,
  "question": "A quadratic curve has the equation:$$y = ax^2 + bx + c$$The curve passes through the three coordinates $(1, 2)$, $(2, 9)$, and $(-1, 0)$.<br><br><strong>(a)</strong> Show that these coordinates lead to the following system of linear equations:\\begin{aligned} a + b + c &= 2 \\cr 4a + 2b + c &= 9 \\cr a - b + c &= 0 \\end{aligned}<strong>(b)</strong> Solve the system of equations algebraically to determine the values of $a$, $b$, and $c$.",
  "steps": [
    "<strong>Part (a): Setting up the equations</strong><br><br>Substitute each coordinate $(x, y)$ into the quadratic curve equation $y = ax^2 + bx + c$:<br><br>1. For $(1, 2)$:\\begin{aligned} a(1)^2 + b(1) + c &= 2 \\cr a + b + c &= 2 \\end{aligned}<br><br>2. For $(2, 9)$:\\begin{aligned} a(2)^2 + b(2) + c &= 9 \\cr 4a + 2b + c &= 9 \\end{aligned}<br><br>3. For $(-1, 0)$:\\begin{aligned} a(-1)^2 + b(-1) + c &= 0 \\cr a - b + c &= 0 \\end{aligned}This confirms the system of equations.",
    "<strong>Part (b): Solving the system</strong><br><br>Label the three equations:<br><br>1. $a + b + c = 2$<br><br>2. $4a + 2b + c = 9$<br><br>3. $a - b + c = 0$",
    "Subtract Equation 3 from Equation 1 to eliminate $a$ and $c$ directly:\\begin{aligned} &(a + b + c) \\cr &\\qquad - (a - b + c) = 2 - 0 \\cr &2b = 2 \\cr &b = 1 \\end{aligned}",
    "Substitute $b = 1$ back into Equation 1 and Equation 2:<br><br>1. From Equation 1:\\begin{aligned} a + 1 + c &= 2 \\cr a + c &= 1 \\cr c &= 1 - a \\end{aligned}<br><br>2. From Equation 2:\\begin{aligned} 4a + 2(1) + c &= 9 \\cr 4a + c &= 7 \\end{aligned}",
    "Substitute $c = 1 - a$ into our simplified Equation 2:\\begin{aligned} 4a + (1 - a) &= 7 \\cr 3a + 1 &= 7 \\cr 3a &= 6 \\cr a &= 2 \\end{aligned}Finally, solve for $c$:\\begin{aligned} c &= 1 - a \\cr &= 1 - 2 \\cr &= -1 \\end{aligned}Thus, the values are $a = 2, b = 1, c = -1$.",
    "Final Answer:\\begin{aligned} &a = 2 \\cr &b = 1 \\cr &c = -1 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &a = 2 \\cr &b = -1 \\cr &c = 1 \\end{aligned}",
      "feedback": "This is a sign slip. Subtracting the third equation from the first equation yields $2b = 2$, giving $b = 1$. Substituting this back yields $a = 2$ and $c = -1$."
    },
    {
    ...
    {
      "ans": "\\begin{aligned} &a = 2 \\cr &b = 1 \\cr &c = 1 \\end{aligned}",
      "feedback": "This is a calculation error in evaluating $c$. Since $a - b + c = 0$, substituting $a=2, b=1$ yields $2 - 1 + c = 0$, giving $c = -1$, not $1$."
    }
  ],
  "bradley_insight": {
    "type": "deeper",
...
},
{
  ...
  "img": false,
  "question": "Solve the simultaneous equations:\\begin{aligned} x + 2y - z &= 3 \\cr 3x - y + 2z &= -7 \\cr 2x + 3y + 3z &= 8 \\end{aligned}",
  "steps": [
    "We label our three equations to begin the algebraic elimination process:<br><br>1. $x + 2y - z = 3$<br><br>2. $3x - y + 2z = -7$<br><br>3. $2x + 3y + 3z = 8$",
    "<strong>Step 1: Express $z$ from Equation 1</strong><br><br>Equation 1 has a coefficient of $-1$ for $z$. Rearrange it to express $z$ in terms of $x$ and $y$:\\begin{aligned} z = x + 2y - 3 \\end{aligned}",
    "<strong>Step 2: Substitute $z$ into Equations 2 and 3</strong><br><br>1. Substitute into Equation 2:\\begin{aligned} &3x - y + 2(x + 2y - 3) = -7 \\cr &3x - y + 2x \\cr &\\qquad + 4y - 6 = -7 \\cr &5x + 3y = -1 \\end{aligned}<br><br>2. Substitute into Equation 3:\\begin{aligned} &2x + 3y + 3(x + 2y - 3) = 8 \\cr &2x + 3y + 3x \\cr &\\qquad + 6y - 9 = 8 \\cr &5x + 9y = 17 \\end{aligned}",
    "<strong>Step 3: Solve the two-variable system</strong><br><br>We now have a simplified system of two equations:\\begin{aligned} 5x + 3y &= -1 \\cr 5x + 9y &= 17 \\end{aligned}Subtract Equation 4 from Equation 5 to eliminate the $x$ terms:\\begin{aligned} &(5x + 9y) - (5x + 3y) \\cr &\\qquad = 17 - (-1) \\cr &6y = 18 \\cr &y = 3 \\end{aligned}",
    "Substitute $y = 3$ back into Equation 4 to solve for $x$:\\begin{aligned} 5x + 3(3) &= -1 \\cr 5x + 9 &= -1 \\cr 5x &= -10 \\cr x &= -2 \\end{aligned}Substitute $x = -2$ and $y = 3$ back into our expression for $z$:\\begin{aligned} z &= x + 2y - 3 \\cr &= -2 + 2(3) - 3 \\cr &= 1 \\end{aligned}Thus, the solutions are $x = -2, y = 3, z = 1$.",
    "Final Answer:\\begin{aligned} &x = -2 \\cr &y = 3 \\cr &z = 1 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &x = -2 \\cr &y = 3 \\cr &z = -1 \\end{aligned}",
      "feedback": "This represents a sign error in the final step. Evaluating $z = x + 2y - 3$ with $x = -2$ and $y = 3$ yields $z = -2 + 2(3) - 3$, which evaluates to $1$, not $-1$."
    },
    {
      "ans": "\\begin{aligned} &x = 2 \\cr &y = -3 \\cr &z = 1 \\end{aligned}",
...
},
{
  ...
  "img": false,
  "question": "The position vectors of the points $A$ and $B$ relative to an origin $O$ are given by:\\begin{aligned} \\vec{OA} &= 3\\mathbf{i} - 2\\mathbf{j} \\cr \\vec{OB} &= 7\\mathbf{i} + \\mathbf{j} \\end{aligned}Find:<br><br><strong>(a)</strong> the magnitude of the vector $\\vec{AB}$,<br><br><strong>(b)</strong> the angle $\\vec{AB}$ makes with the positive $x$-axis.",
  "steps": [
    "<strong>Part (a): Finding the magnitude of $\\vec{AB}$</strong><br><br>First, we find the vector $\\vec{AB}$ by subtracting the position vector of $A$ from the position vector of $B$:\\begin{aligned} \\vec{AB} &= \\vec{OB} - \\vec{OA} \\cr &= (7\\mathbf{i} + \\mathbf{j}) - (3\\mathbf{i} - 2\\mathbf{j}) \\cr &= (7 - 3)\\mathbf{i} + (1 - (-2))\\mathbf{j} \\cr &= 4\\mathbf{i} + 3\\mathbf{j} \\end{aligned}",
    "Next, calculate the magnitude of the vector $\\vec{AB}$ using Pythagoras' theorem:\\begin{aligned} |\\vec{AB}| &= \\sqrt{4^2 + 3^2} \\cr &= \\sqrt{16 + 9} \\cr &= \\sqrt{25} \\cr &= 5 \\end{aligned}Thus, the magnitude of the vector $\\vec{AB}$ is $5$ units.",
    "<strong>Part (b): Finding the angle with the positive $x$-axis</strong><br><br>The vector $\\vec{AB} = 4\\mathbf{i} + 3\\mathbf{j}$ lies in the first quadrant because both the $\\mathbf{i}$ and $\\mathbf{j}$ components are positive.<br><br>We find the angle $\\theta$ that the vector makes with the positive $x$-axis using trigonometry:\\begin{aligned} \\tan\\theta &= \\dfrac{3}{4} \\cr \\theta &= \\tan^{-1}\\left(\\dfrac{3}{4}\\right) \\cr &\\approx 36.9^\\circ \\end{aligned}Thus, the angle the vector makes with the positive $x$-axis is approximately $36.9^\\circ$.",
    "Final Answer:\\begin{aligned} &|\\vec{AB}| = 5 \\cr &\\theta \\approx 36.9^\\circ \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &|\\vec{AB}| = 5 \\cr &\\theta \\approx 53.1^\\circ \\end{aligned}",
      "feedback": "This error occurs if you calculate the angle using the $x$-component divided by the $y$-component, evaluating $\\tan\\theta = \\dfrac{4}{3}$ instead of $\\tan\\theta = \\dfrac{y}{x}$, which gives $\\dfrac{3}{4}$."
    },
    {
      "ans": "\\begin{aligned} &|\\vec{AB}| = \\sqrt{7} \\cr &\\theta \\approx 36.9^\\circ \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &|\\vec{AB}| = 7 \\cr &\\theta \\approx 36.9^\\circ \\end{aligned}",
      "feedback": "This is the result of adding the components directly ($4 + 3 = 7$) instead of using Pythagoras' theorem to find the magnitude ($|\\vec{AB}| = \\sqrt{4^2 + 3^2}$, which gives $5$)."
    }
  ],
  "bradley_insight": {
    "type": "pro-tip",
...
},
{
  ...
  "img": false,
  "question": "The position vectors of the points $A$ and $B$ relative to an origin $O$ are given by:\\begin{aligned} \\vec{OA} &= 2\\mathbf{i} + 5\\mathbf{j} \\cr \\vec{OB} &= -2\\mathbf{i} + 8\\mathbf{j} \\end{aligned}Find:<br><br><strong>(a)</strong> the magnitude of the vector $\\vec{AB}$,<br><br><strong>(b)</strong> the angle $\\vec{AB}$ makes with the positive $x$-axis, giving your answer to the nearest tenth of a degree.",
  "steps": [
    "<strong>Part (a): Finding the magnitude of $\\vec{AB}$</strong><br><br>First, find the vector $\\vec{AB}$:\\begin{aligned} \\vec{AB} &= \\vec{OB} - \\vec{OA} \\cr &= (-2\\mathbf{i} + 8\\mathbf{j}) - (2\\mathbf{i} + 5\\mathbf{j}) \\cr &= (-2 - 2)\\mathbf{i} + (8 - 5)\\mathbf{j} \\cr &= -4\\mathbf{i} + 3\\mathbf{j} \\end{aligned}",
    "Next, calculate the magnitude of the vector $\\vec{AB}$:\\begin{aligned} |\\vec{AB}| &= \\sqrt{(-4)^2 + 3^2} \\cr &= \\sqrt{16 + 9} \\cr &= \\sqrt{25} \\cr &= 5 \\end{aligned}Thus, the magnitude of the vector $\\vec{AB}$ is $5$ units.",
    "<strong>Part (b): Finding the angle with the positive $x$-axis</strong><br><br>The vector $\\vec{AB} = -4\\mathbf{i} + 3\\mathbf{j}$ has a negative $\\mathbf{i}$ component and a positive $\\mathbf{j}$ component, which places it in the second quadrant.<br><br>First, calculate the acute base angle $\\alpha$ that the vector makes with the negative $x$-axis:\\begin{aligned} \\tan\\alpha &= \\dfrac{3}{4} \\cr \\alpha &= \\tan^{-1}\\left(\\dfrac{3}{4}\\right) \\cr &\\approx 36.87^\\circ \\end{aligned}",
    "The angle $\\theta$ with the positive $x$-axis (measured counter-clockwise) is found by subtracting the acute base angle from $180^\\circ$:\\begin{aligned} \\theta &= 180^\\circ - 36.87^\\circ \\cr &= 143.13^\\circ \\end{aligned}Rounding to the nearest tenth of a degree gives $\\theta \\approx 143.1^\\circ$.",
    "Final Answer:\\begin{aligned} &|\\vec{AB}| = 5 \\cr &\\theta \\approx 143.1^\\circ \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &|\\vec{AB}| = 5 \\cr &\\theta \\approx 36.9^\\circ \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &|\\vec{AB}| = 5 \\cr &\\theta \\approx 126.9^\\circ \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &|\\vec{AB}| = \\sqrt{7} \\cr &\\theta \\approx 143.1^\\circ \\end{aligned}",
      "feedback": "This error occurs if you subtract the squares of the components under the square root when finding the magnitude. Always add them: $(-4)^2 + 3^2 = 16 + 9$, which gives $25$."
    }
  ],
  "bradley_insight": {
    "type": "caution",
...
},
{
  ...
  "img": false,
  "question": "Two vectors $\\vec{a}$ and $\\vec{b}$ are defined as:\\begin{aligned} \\vec{a} &= 5\\mathbf{i} - 2\\mathbf{j} \\cr \\vec{b} &= -\\mathbf{i} + 5\\mathbf{j} \\end{aligned}The vector $\\vec{c}$ is given by $\\vec{c} = \\vec{a} + 2\\vec{b}$.<br><br>Find:<br><br><strong>(a)</strong> the vector $\\vec{c}$ in the form $x\\mathbf{i} + y\\mathbf{j}$,<br><br><strong>(b)</strong> the magnitude of $\\vec{c}$, giving your answer correct to 3 significant figures,<br><br><strong>(c)</strong> the angle $\\vec{c}$ makes with the positive $x$-axis, to the nearest tenth of a degree.",
  "steps": [
    "<strong>Part (a): Finding the vector $\\vec{c}$</strong><br><br>First, multiply the vector $\\vec{b}$ by the scalar $2$:\\begin{aligned} 2\\vec{b} &= 2(-\\mathbf{i} + 5\\mathbf{j}) \\cr &= -2\\mathbf{i} + 10\\mathbf{j} \\end{aligned}Now, add this to vector $\\vec{a}$ to find $\\vec{c}$:\\begin{aligned} \\vec{c} &= \\vec{a} + 2\\vec{b} \\cr &= (5\\mathbf{i} - 2\\mathbf{j}) + (-2\\mathbf{i} + 10\\mathbf{j}) \\cr &= (5 - 2)\\mathbf{i} + (-2 + 10)\\mathbf{j} \\cr &= 3\\mathbf{i} + 8\\mathbf{j} \\end{aligned}",
    "<strong>Part (b): Finding the magnitude of $\\vec{c}$</strong><br><br>Calculate the magnitude using Pythagoras' theorem:\\begin{aligned} |\\vec{c}| &= \\sqrt{3^2 + 8^2} \\cr &= \\sqrt{9 + 64} \\cr &= \\sqrt{73} \\cr &\\approx 8.54400 \\end{aligned}Rounding to 3 significant figures gives $|\\vec{c}| \\approx 8.54$ units.",
    "<strong>Part (c): Finding the angle with the positive $x$-axis</strong><br><br>Since both components of $\\vec{c} = 3\\mathbf{i} + 8\\mathbf{j}$ are positive, the vector lies in the first quadrant.<br><br>Calculate the angle $\\theta$:\\begin{aligned} \\tan\\theta &= \\dfrac{8}{3} \\cr \\theta &= \\tan^{-1}\\left(\\dfrac{8}{3}\\right) \\cr &\\approx 69.44^\\circ \\end{aligned}Rounding to the nearest tenth of a degree gives $\\theta \\approx 69.4^\\circ$.",
    "Final Answer:\\begin{aligned} &\\vec{c} = 3\\mathbf{i} + 8\\mathbf{j} \\cr &|\\vec{c}| \\approx 8.54 \\cr &\\theta \\approx 69.4^\\circ \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &\\vec{c} = 3\\mathbf{i} + 8\\mathbf{j} \\cr &|\\vec{c}| = 8.54 \\cr &\\theta \\approx 20.6^\\circ \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\vec{c} = 4\\mathbf{i} + 3\\mathbf{j} \\cr &|\\vec{c}| = 5.00 \\cr &\\theta \\approx 36.9^\\circ \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\vec{c} = 3\\mathbf{i} + 8\\mathbf{j} \\cr &|\\vec{c}| = 11.0 \\cr &\\theta \\approx 69.4^\\circ \\end{aligned}",
      "feedback": "This represents adding the components directly ($3 + 8 = 11$) to find the magnitude, rather than using Pythagoras' theorem: $|\\vec{c}| = \\sqrt{3^2 + 8^2}$, which gives $\\sqrt{73} \\approx 8.54$."
    }
  ],
  "bradley_insight": {
    "type": "pro-tip",
...
},
{
  ...
  "img": false,
  "question": "The position vectors of the points $P$ and $Q$ relative to an origin $O$ are:\\begin{aligned} \\vec{OP} &= \\mathbf{i} + 4\\mathbf{j} \\cr \\vec{OQ} &= 9\\mathbf{i} - 2\\mathbf{j} \\end{aligned}The point $R$ lies on the line segment $PQ$ such that $PR:RQ = 1:3$.<br><br><strong>(a)</strong> Find the vector $\\vec{PQ}$.<br><br><strong>(b)</strong> Calculate the magnitude of $\\vec{PQ}$.<br><br><strong>(c)</strong> Determine the position vector of the point $R$.",
  "steps": [
    "<strong>Part (a): Finding the vector $\\vec{PQ}$</strong><br><br>The vector $\\vec{PQ}$ is found by subtracting the position vector of the starting point $P$ from the position vector of the endpoint $Q$:\\begin{aligned} \\vec{PQ} &= \\vec{OQ} - \\vec{OP} \\cr &= (9\\mathbf{i} - 2\\mathbf{j}) - (\\mathbf{i} + 4\\mathbf{j}) \\cr &= (9 - 1)\\mathbf{i} + (-2 - 4)\\mathbf{j} \\cr &= 8\\mathbf{i} - 6\\mathbf{j} \\end{aligned}",
    "<strong>Part (b): Finding the magnitude of $\\vec{PQ}$</strong><br><br>Calculate the magnitude using Pythagoras' theorem:\\begin{aligned} |\\vec{PQ}| &= \\sqrt{8^2 + (-6)^2} \\cr &= \\sqrt{64 + 36} \\cr &= \\sqrt{100} \\cr &= 10 \\end{aligned}Thus, the magnitude of $\\vec{PQ}$ is $10$ units.",
    "<strong>Part (c): Finding the position vector of $R$</strong><br><br>The ratio $PR:RQ = 1:3$ means that the segment is split into $1 + 3 = 4$ equal parts, and point $R$ lies $\\dfrac{1}{4}$ of the way along the vector $\\vec{PQ}$ starting from point $P$:\\begin{aligned} \\vec{OR} &= \\vec{OP} + \\dfrac{1}{4}\\vec{PQ} \\cr &= (\\mathbf{i} + 4\\mathbf{j}) + \\dfrac{1}{4}(8\\mathbf{i} - 6\\mathbf{j}) \\cr &= \\mathbf{i} + 4\\mathbf{j} + 2\\mathbf{i} - 1.5\\mathbf{j} \\cr &= 3\\mathbf{i} + 2.5\\mathbf{j} \\end{aligned}",
    "Final Answer:\\begin{aligned} &\\vec{PQ} = 8\\mathbf{i} - 6\\mathbf{j} \\cr &|\\vec{PQ}| = 10 \\cr &\\vec{OR} = 3\\mathbf{i} + 2.5\\mathbf{j} \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &\\vec{PQ} = 8\\mathbf{i} - 6\\mathbf{j} \\cr &|\\vec{PQ}| = 10 \\cr &\\vec{OR} = 5\\mathbf{i} + \\mathbf{j} \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\vec{PQ} = 8\\mathbf{i} - 6\\mathbf{j} \\cr &|\\vec{PQ}| = 10 \\cr &\\vec{OR} = 3\\mathbf{i} - 2.5\\mathbf{j} \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\vec{PQ} = 10\\mathbf{i} + 2\\mathbf{j} \\cr &|\\vec{PQ}| = 10.2 \\cr &\\vec{OR} = 3.5\\mathbf{i} + 4.5\\mathbf{j} \\end{aligned}",
...
},
{
  ...
  "img": false,
  "question": "The position vectors of points $A$ and $B$ relative to an origin $O$ are given by:\\begin{aligned} \\vec{OA} &= 2\\mathbf{i} - 3\\mathbf{j} \\cr \\vec{OB} &= 5\\mathbf{i} + k\\mathbf{j} \\end{aligned}where $k$ is a constant.<br><br>Given that the magnitude of the vector $\\vec{AB}$ is $5$ units:<br><br><strong>(a)</strong> Find the vector $\\vec{AB}$ in terms of $k$,<br><br><strong>(b)</strong> Find the two possible values of the constant $k$.",
  "steps": [
    "<strong>Part (a): Finding $\\vec{AB}$ in terms of $k$</strong><br><br>Find the vector $\\vec{AB}$ by subtracting position vectors:\\begin{aligned} \\vec{AB} &= \\vec{OB} - \\vec{OA} \\cr &= (5\\mathbf{i} + k\\mathbf{j}) - (2\\mathbf{i} - 3\\mathbf{j}) \\cr &= (5 - 2)\\mathbf{i} + (k - (-3))\\mathbf{j} \\cr &= 3\\mathbf{i} + (k + 3)\\mathbf{j} \\end{aligned}",
    "<strong>Part (b): Finding the two possible values of $k$</strong><br><br>We are given that the magnitude of $\\vec{AB}$ is $5$ units:\\begin{aligned} |\\vec{AB}| &= 5 \\cr \\sqrt{3^2 + (k + 3)^2} &= 5 \\end{aligned}Square both sides of the equation:\\begin{aligned} 3^2 + (k + 3)^2 &= 25 \\cr 9 + (k + 3)^2 &= 25 \\cr (k + 3)^2 &= 16 \\end{aligned}",
    "Take the square root of both sides, keeping in mind both the positive and negative roots:\\begin{aligned} k + 3 = \\pm 4 \\end{aligned}This gives two possible linear equations to solve:<br><br>1. $k + 3 = 4$, which gives $k = 1$.<br><br>2. $k + 3 = -4$, which gives $k = -7$.<br><br>Thus, the two possible values of $k$ are $k = 1$ and $k = -7$.",
    "Final Answer:\\begin{aligned} &\\vec{AB} = 3\\mathbf{i} + (k + 3)\\mathbf{j} \\cr &k = 1 \\text{ or } k = -7 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} k = 1 \\end{aligned}",
      "feedback": "This is only one of the possible values. When solving $(k + 3)^2 = 16$, taking the square of both sides yields two equations: $k + 3 = 4$, giving $k = 1$, and $k + 3 = -4$, giving $k = -7$."
    },
    {
      "ans": "\\begin{aligned} k = 1 \\text{ or } k = -1 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} k = 2 \\text{ or } k = -8 \\end{aligned}",
      "feedback": "This is a calculation error. Ensure you correctly set up the magnitude equation as $3^2 + (k + 3)^2 = 25$, giving $(k + 3)^2 = 16$, which yields $k = 1$ and $k = -7$."
    }
  ],
  "bradley_insight": {
    "type": "pro-tip",
...
}, 
{
  ...
  "img": "images/Pure_SVGs/004391.svg",
  "question": "A curve has the equation $y = f(x)$. The point $A(0, 2)$ lies on the curve.<br><br><strong>(a)</strong> Write down the coordinates of the point $A$ under the following transformations:<br>* <strong>(i)</strong> $y = f(x) + 3$<br>* <strong>(ii)</strong> $y = f(x - 4)$<br>* <strong>(iii)</strong> $y = f(-x)$<br><br><strong>(b)</strong> Given that the curve $y = f(x)$ has an asymptote given by the equation $y = 1$, write down the equation of the asymptote of the curve under the transformation:$$y + 3 = f(x)$$",
  "steps": [
    "<strong>Part (a)(i): Under the transformation $y = f(x) + 3$</strong><br><br>The transformation $+3$ outside the function represents a vertical translation upwards by $3$ units.<br><br>Apply this to the coordinates of $A(0, 2)$:\\begin{aligned} (x, y) &\\to (x, y + 3) \\cr (0, 2) &\\to (0, 2 + 3) \\cr &\\to (0, 5) \\end{aligned}",
    "<strong>Part (a)(ii): Under the transformation $y = f(x - 4)$</strong><br><br>The transformation $-4$ inside the function arguments represents a horizontal translation to the right by $4$ units.<br><br>Apply this to the coordinates of $A(0, 2)$:\\begin{aligned} (x, y) &\\to (x + 4, y) \\cr (0, 2) &\\to (0 + 4, 2) \\cr &\\to (4, 2) \\end{aligned}",
    "<strong>Part (a)(iii): Under the transformation $y = f(-x)$</strong><br><br>The negative sign inside the function arguments represents a reflection of the graph in the $y$-axis, which flips the sign of all $x$-coordinates.<br><br>Apply this to the coordinates of $A(0, 2)$:\\begin{aligned} (x, y) &\\to (-x, y) \\cr (0, 2) &\\to (-0, 2) \\cr &\\to (0, 2) \\end{aligned}",
    "<strong>Part (b): Finding the transformed asymptote</strong><br><br>Rearrange the given transformation equation $y + 3 = f(x)$ to express $y$ explicitly:\\begin{aligned} y = f(x) - 3 \\end{aligned}This represents a vertical translation downwards by $3$ units.<br><br>Apply this translation to the original horizontal asymptote equation $y = 1$:\\begin{aligned} y &= 1 - 3 \\cr &= -2 \\end{aligned}Thus, the new horizontal asymptote is $y = -2$.",
    "Final Answer:\\begin{aligned} &\\text{(a)(i) } (0, 5) \\cr &\\text{(a)(ii) } (4, 2) \\cr &\\text{(a)(iii) } (0, 2) \\cr &\\text{(b) } y = -2 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &\\text{(a)(i) } (0, 5) \\cr &\\text{(a)(ii) } (-4, 2) \\cr &\\text{(a)(iii) } (0, 2) \\cr &\\text{(b) } y = 4 \\end{aligned}",
      "feedback": "This option contains horizontal translation errors. For part (a)(ii), $y = f(x-4)$ translates the graph 4 units to the right, so the $x$-coordinate increases from $0$ to $+4$, not $-4$. For part (b), rearranging $y + 3 = f(x)$ gives $y = f(x) - 3$, shifting the asymptote down to $y = -2$ (since $1 - 3 = -2$)."
    },
    {
      "ans": "\\begin{aligned} &\\text{(a)(i) } (3, 2) \\cr &\\text{(a)(ii) } (4, 2) \\cr &\\text{(a)(iii) } (0, -2) \\cr &\\text{(b) } y = -2 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\text{(a)(i) } (0, 5) \\cr &\\text{(a)(ii) } (4, 2) \\cr &\\text{(a)(iii) } (0, -2) \\cr &\\text{(b) } y = -2 \\end{aligned}",
...
},
{
  ...
  "steps": [
    "<strong>Part (a): Under the transformation $y = f(2x)$</strong><br><br>A multiplier inside the function represents a horizontal stretch. Because it is inside, it behaves counter-intuitively: we stretch by a scale factor of $\\dfrac{1}{2}$, which divides all $x$-coordinates by $2$ while keeping $y$-coordinates unchanged:\\begin{aligned} (x, y) &\\to \\left( \\dfrac{x}{2}, y \\right) \\cr (2, -3) &\\to \\left( \\dfrac{2}{2}, -3 \\right) \\cr &\\to (1, -3) \\end{aligned}",
    "<strong>Part (b): Under the transformation $y = -f(x)$</strong><br><br>A negative sign outside the function represents a vertical reflection in the $x$-axis. This multiplies all $y$-coordinates by $-1$ while keeping $x$-coordinates unchanged:\\begin{aligned} (x, y) &\\to (x, -y) \\cr (2, -3) &\\to (2, -(-3)) \\cr &\\to (2, 3) \\end{aligned}",
    "<strong>Part (c): Under the transformation $y = 3f(x + 1)$</strong><br><br>This transformation combines two distinct shifts:<br><br>1. An addition of $+1$ inside ($f(x+1)$) is a horizontal translation left by $1$ unit ($x \\to x - 1$).<br><br>2. A multiplier of $3$ outside ($3f(x)$) is a vertical stretch by factor $3$ ($y \\to 3y$).<br><br>Apply both transformations to $A(2, -3)$:\\begin{aligned} (x, y) &\\to (x - 1, 3y) \\cr (2, -3) &\\to (2 - 1, 3(-3)) \\cr &\\to (1, -9) \\end{aligned}",
    "Final Answer:\\begin{aligned} &\\text{(a) } (1, -3) \\cr &\\text{(b) } (2, 3) \\cr &\\text{(c) } (1, -9) \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &\\text{(a) } (4, -3) \\cr &\\text{(b) } (-2, -3) \\cr &\\text{(c) } (3, -9) \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\text{(a) } (1, -3) \\cr &\\text{(b) } (2, 3) \\cr &\\text{(c) } (1, -1) \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\text{(a) } (1, -3) \\cr &\\text{(b) } (2, 3) \\cr &\\text{(c) } (3, -9) \\end{aligned}",
...
},
{
  ...
  "img": false,
  "question": "A quadratic curve $C$ has the equation $y = x^2 - 4x + 7$.<br><br><strong>(a)</strong> By completing the square, write down the coordinates of the vertex of $C$.<br><br><strong>(b)</strong> Find the coordinates of the vertex of the curve after each of the following transformations:<br><br><strong>(i)</strong> $y = f(x + 2) - 4$<br><br><strong>(ii)</strong> $y = -f(2x)$",
  "steps": [
    "<strong>Part (a): Completing the square to find the vertex</strong><br><br>First, rewrite the quadratic equation in completed square form $(x - h)^2 + k$:\\begin{aligned} y &= x^2 - 4x + 7 \\cr &= (x^2 - 4x + 4) - 4 + 7 \\cr &= (x - 2)^2 + 3 \\end{aligned}The vertex (minimum point) of this parabola is $(2, 3)$. We define this function as $f(x) = (x-2)^2 + 3$.",
    "<strong>Part (b)(i): Under the transformation $y = f(x + 2) - 4$</strong><br><br>This compound transformation shifts the graph:<br><br>1. Horizontal translation left by $2$ units ($x \\to x - 2$).<br><br>2. Vertical translation downwards by $4$ units ($y \\to y - 4$).<br><br>Apply these transformations to the vertex $(2, 3)$:\\begin{aligned} (x, y) &\\to (x - 2, y - 4) \\cr (2, 3) &\\to (2 - 2, 3 - 4) \\cr &\\to (0, -1) \\end{aligned}Alternatively, substituting algebraically yields $y = (x+2-2)^2 + 3 - 4$, which simplifies to $y = x^2 - 1$, having its vertex at $(0, -1)$.",
    "<strong>Part (b)(ii): Under the transformation $y = -f(2x)$</strong><br><br>This compound transformation shifts the graph:<br><br>1. Horizontal compression by factor $\\dfrac{1}{2}$ ($x \\to \\dfrac{x}{2}$).<br><br>2. Vertical reflection in the $x$-axis ($y \\to -y$).<br><br>Apply these transformations to the vertex $(2, 3)$:\\begin{aligned} (x, y) &\\to \\left( \\dfrac{x}{2}, -y \\right) \\cr (2, 3) &\\to \\left( \\dfrac{2}{2}, -3 \\right) \\cr &\\to (1, -3) \\end{aligned}",
    "Final Answer:\\begin{aligned} &\\text{(a) } (2, 3) \\cr &\\text{(b)(i) } (0, -1) \\cr &\\text{(b)(ii) } (1, -3) \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &\\text{(a) } (2, 3) \\cr &\\text{(b)(i) } (0, -4) \\cr &\\text{(b)(ii) } (1, -3) \\end{aligned}",
      "feedback": "This is a common calculation slip in part (b)(i). Simplifying $y = f(x+2) - 4$ yields $y = x^2 - 1$, which has its vertex at $(0, -1)$, not $(0, -4)$."
    },
    {
      "ans": "\\begin{aligned} &\\text{(a) } (-2, 3) \\cr &\\text{(b)(i) } (0, -1) \\cr &\\text{(b)(ii) } (2, -3) \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\text{(a) } (2, 3) \\cr &\\text{(b)(i) } (0, -1) \\cr &\\text{(b)(ii) } (1, 3) \\end{aligned}",
...
},
{
  ...
  "steps": [
    "<strong>Part (a): Under the transformation $y = 3\\cos x$</strong><br><br>A coefficient of $3$ outside the function represents a vertical stretch by factor $3$. This multiplies all $y$-coordinates by $3$ while keeping $x$-coordinates unchanged:\\begin{aligned} (x, y) &\\to (x, 3y) \\cr (180^\\circ, -1) &\\to (180^\\circ, 3(-1)) \\cr &\\to (180^\\circ, -3) \\end{aligned}",
    "<strong>Part (b): Under the transformation $y = \\cos(x - 30^\\circ)$</strong><br><br>Subtracting $30^\\circ$ inside the function represents a horizontal translation to the right by $30^\\circ$. This adds $30^\\circ$ to all $x$-coordinates while keeping $y$-coordinates unchanged:\\begin{aligned} (x, y) &\\to (x + 30^\\circ, y) \\cr (180^\\circ, -1) &\\to (180^\\circ + 30^\\circ, -1) \\cr &\\to (210^\\circ, -1) \\end{aligned}",
    "<strong>Part (c): Under the transformation $y = \\cos(2x) + 1$</strong><br><br>This compound transformation contains two shifts:<br><br>1. A multiplier of $2$ inside ($\\cos(2x)$) is a horizontal compression by factor $\\dfrac{1}{2}$ ($x \\to \\dfrac{x}{2}$).<br><br>2. An addition of $+1$ outside is a vertical translation up by $1$ unit ($y \\to y + 1$).<br><br>Apply both transformations to $M(180^\\circ, -1)$:\\begin{aligned} (x, y) &\\to \\left( \\dfrac{x}{2}, y + 1 \\right) \\cr (180^\\circ, -1) &\\to \\left( \\dfrac{180^\\circ}{2}, -1 + 1 \\right) \\cr &\\to (90^\\circ, 0) \\end{aligned}",
    "Final Answer:\\begin{aligned} &\\text{(a) } (180^\\circ, -3) \\cr &\\text{(b) } (210^\\circ, -1) \\cr &\\text{(c) } (90^\\circ, 0) \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &\\text{(a) } (540^\\circ, -1) \\cr &\\text{(b) } (150^\\circ, -1) \\cr &\\text{(c) } (90^\\circ, 1) \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\text{(a) } (180^\\circ, -3) \\cr &\\text{(b) } (210^\\circ, -1) \\cr &\\text{(c) } (360^\\circ, 0) \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\text{(a) } (180^\\circ, -3) \\cr &\\text{(b) } (150^\\circ, -1) \\cr &\\text{(c) } (90^\\circ, 0) \\end{aligned}",
...
},
{
  ...
  "steps": [
    "<strong>Part (a): Under the transformation $y = f(x) + a$</strong><br><br>Since the $x$-coordinate is unchanged ($3 \\to 3$), this is a pure vertical translation.<br><br>Equate the original and new $y$-coordinates to find $a$:\\begin{aligned} 4 + a &= 9 \\cr a &= 5 \\end{aligned}",
    "<strong>Part (b): Under the transformation $y = f(x + b)$</strong><br><br>Since the $y$-coordinate is unchanged ($4 \\to 4$), this is a pure horizontal translation.<br><br>The original maximum occurs when the input to $f$ is $3$. For the new maximum to occur at $x = 1$, the input $(x + b)$ must evaluate to $3$ when $x = 1$:\\begin{aligned} 1 + b &= 3 \\cr b &= 2 \\end{aligned}Thus, $b = 2$, which represents a shift left by $2$ units ($y = f(x + 2)$).",
    "<strong>Part (c): Under the transformation $y = af(bx)$</strong><br><br>This transformation represents a vertical stretch by factor $a$ and a horizontal stretch by factor $\\dfrac{1}{b}$.<br><br>1. For the vertical stretch ($y$-coordinates):\\begin{aligned} a \\times 4 &= 12 \\cr a &= 3 \\end{aligned}<br><br>2. For the horizontal stretch ($x$-coordinates): the input $bx$ must evaluate to $3$ when the new $x = 6$:\\begin{aligned} b(6) &= 3 \\cr b &= \\dfrac{3}{6} \\cr &= 0.5 \\text{ (or } \\dfrac{1}{2}\\text{)} \\end{aligned}Thus, the constants are $a = 3$ and $b = 0.5$.",
    "Final Answer:\\begin{aligned} &\\text{(a) } a = 5 \\cr &\\text{(b) } b = 2 \\cr &\\text{(c) } a = 3, b = 0.5 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &\\text{(a) } a = 5 \\cr &\\text{(b) } b = -2 \\cr &\\text{(c) } a = 3, b = 2 \\end{aligned}",
      "feedback": "This option contains sign and scaling reciprocal errors. For part (b), shifting the maximum horizontally from $3$ to $1$ is a shift to the left, which corresponds to $f(x+2)$, so $b = 2$, not $-2$. For part (c), stretching the graph horizontally from $3$ to $6$ is a stretch of factor 2, which corresponds to $f\\left(\\dfrac{1}{2}x\\right)$, so $b = 0.5$, not $2$."
    },
    {
      "ans": "\\begin{aligned} &\\text{(a) } a = 9 \\cr &\\text{(b) } b = 2 \\cr &\\text{(c) } a = 3, b = 0.5 \\end{aligned}",
      "feedback": "This error is in part (a). The vertical transformation $y = f(x) + a$ shifts the graph by $a$ units, meaning the new $y$-coordinate is $4 + a = 9$, which gives $a = 5$, not $9$."
    },
    {
      "ans": "\\begin{aligned} &\\text{(a) } a = 5 \\cr &\\text{(b) } b = 2 \\cr &\\text{(c) } a = 12, b = 2 \\end{aligned}",
      "feedback": "This error is in part (c). Under $y = af(bx)$, the new vertical maximum is $4a = 12$, giving $a = 3$, and the new horizontal maximum is $\\dfrac{3}{b} = 6$, giving $b = 0.5$."
    }
  ],
  "bradley_insight": {
    "type": "pro-tip",
...
},
{
  ...
  "steps": [
    "<strong>Part (a): Stating the value of $a$</strong><br><br>To find $a$, rewrite the logarithmic equation in its equivalent exponential form:\\begin{aligned} \\log_3 a &= 2 \\cr a &= 3^2 \\cr &= 9 \\end{aligned}",
    "<strong>Part (b): Solving the logarithmic equation</strong><br><br>Since $\\log_3 a = 2$ gives $a = 9$, we can solve the equation $\\log_3 \\left( \\dfrac{2x}{x-2} \\right) = 2$ by setting the argument equal to $9$:\\begin{aligned} \\dfrac{2x}{x-2} &= 9 \\cr 2x &= 9(x - 2) \\cr 2x &= 9x - 18 \\cr -7x &= -18 \\cr x &= \\dfrac{18}{7} \\end{aligned}Check the domain: since $\\dfrac{18}{7} \\approx 2.57$ is greater than $2$, the argument remains positive, so $x = \\dfrac{18}{7}$ is a valid solution.",
    "<strong>Part (c): Solving the exponential equation</strong><br><br>First, isolate the exponential term by dividing both sides of $5e^{3x} = 7$ by $5$:\\begin{aligned} e^{3x} &= \\dfrac{7}{5} \\cr &= 1.4 \\end{aligned}Now, take the natural logarithm ($\\ln$) of both sides to remove the exponential:\\begin{aligned} 3x &= \\ln(1.4) \\cr x &= \\dfrac{1}{3}\\ln(1.4) \\end{aligned}",
    "Evaluate this expression numerically using a calculator:\\begin{aligned} x &\\approx \\dfrac{0.336472}{3} \\cr &\\approx 0.112157 \\end{aligned}Rounding to 3 decimal places gives $x \\approx 0.112$.",
    "Final Answer:\\begin{aligned} &\\text{(a) } a = 9 \\cr &\\text{(b) } x = \\dfrac{18}{7} \\cr &\\text{(c) } x \\approx 0.112 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} &\\text{(a) } a = 6 \\cr &\\text{(b) } x = \\dfrac{18}{7} \\cr &\\text{(c) } x \\approx 0.112 \\end{aligned}",
      "feedback": "In part (a), the equation $\\log_3 a = 2$ converts to exponential form as $a = 3^2$, which equals $9$. Multiplying $3 \\times 2 = 6$ is a basic operational error."
    },
    {
      "ans": "\\begin{aligned} &\\text{(a) } a = 9 \\cr &\\text{(b) } x = \\dfrac{18}{7} \\cr &\\text{(c) } x \\approx 0.118 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} &\\text{(a) } a = 9 \\cr &\\text{(b) } x = \\dfrac{9}{7} \\cr &\\text{(c) } x \\approx 0.112 \\end{aligned}",
      "feedback": "This error is in part (b). Solving $\\dfrac{2x}{x-2} = 9$ gives $2x = 9x - 18$, which leads to $-7x = -18$, so $x = \\dfrac{18}{7}$, not $\\dfrac{9}{7}$ (which occurs if you forget to distribute the multiplier 9 to the constant term $-2$)."
    }
  ],
  "bradley_insight": {
    "type": "pro-tip",
...
},
{
  ...
  "steps": [
    "Apply the subtraction law of logarithms ($\\log_b A - \\log_b B = \\log_b \\left(\\dfrac{A}{B}\\right)$) to combine the left-hand side:\\begin{aligned} \\log_5 \\left( \\dfrac{3x + 1}{x - 1} \\right) = 1 \\end{aligned}",
    "Convert the logarithmic equation to its equivalent exponential form to eliminate the log:\\begin{aligned} \\dfrac{3x + 1}{x - 1} &= 5^1 \\cr &= 5 \\end{aligned}",
    "Solve the resulting linear equation for $x$:\\begin{aligned} 3x + 1 &= 5(x - 1) \\cr 3x + 1 &= 5x - 5 \\cr -2x &= -6 \\cr x &= 3 \\end{aligned}",
    "Verify the solution against the domain of the original logarithms:<br><br>1. For $\\log_5 (3x + 1)$: $3(3) + 1 = 10$, which is $> 0$ (valid).<br><br>2. For $\\log_5 (x - 1)$: $3 - 1 = 2$, which is $> 0$ (valid).<br><br>Thus, the solution is $x = 3$.",
    "Final Answer:\\begin{aligned} x = 3 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} x = -3 \\end{aligned}",
      "feedback": "This is a sign error during algebraic rearrangement. Solving $3x + 1 = 5x - 5$ yields $-2x = -6$, which gives $x = 3$, not $-3$."
    },
    {
      "ans": "\\begin{aligned} x = 2 \\end{aligned}",
      "feedback": "This error occurs if you convert the log equation incorrectly, such as writing $\\dfrac{3x + 1}{x - 1} = 1$ (forgetting that $\\log_5 A = 1$ implies $A = 5$)."
    },
    {
      "ans": "\\begin{aligned} x = 3.5 \\end{aligned}",
...
},
{
  ...
  "steps": [
    "First, isolate the exponential term on one side of the equation by dividing both sides by $2$:\\begin{aligned} 10^{4x} = 25 \\end{aligned}",
    "To solve this base 10 exponential equation, take the common logarithm ($\\log_{10}$) of both sides:\\begin{aligned} 4x = \\log_{10}(25) \\end{aligned}",
    "Rearrange to solve for $x$:\\begin{aligned} x = \\dfrac{1}{4}\\log_{10}(25) \\end{aligned}",
    "Evaluate this expression numerically using a calculator:\\begin{aligned} x &\\approx \\dfrac{1.397940}{4} \\cr &\\approx 0.349485 \\end{aligned}Rounding to 3 decimal places gives $x \\approx 0.349$.",
    "Final Answer:\\begin{aligned} x \\approx 0.349 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} x \\approx 0.350 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} x \\approx 0.805 \\end{aligned}",
    ...
    {
      "ans": "\\begin{aligned} x \\approx 0.174 \\end{aligned}",
      "feedback": "This error happens if you take the log of 50 before dividing by 2, evaluating $4x = \\log_{10}(50)$, giving $x = \\dfrac{\\log_{10}(50)}{4} \\approx 0.174$, which violates algebraic order of operations."
    }
  ],
  "bradley_insight": {
    "type": "pro-tip",
...
},
{
  ...
  "steps": [
    "Introduce a substitution variable. Let $y = e^x$. Since $e^{2x} = (e^x)^2$, which equals $y^2$, the equation becomes a standard quadratic equation in terms of $y$:\\begin{aligned} y^2 - 5y + 6 = 0 \\end{aligned}",
    "Solve this quadratic equation by factoring:\\begin{aligned} (y - 2)(y - 3) = 0 \\end{aligned}This yields $y = 2$ or $y = 3$. Both are valid since $y = e^x > 0$ for all real $x$.",
    "Substitute back $y = e^x$ and solve for $x$ by taking natural logarithms:<br><br>1. For $y = 2$:\\begin{aligned} e^x &= 2 \\cr x &= \\ln(2) \\end{aligned}<br><br>2. For $y = 3$:\\begin{aligned} e^x &= 3 \\cr x &= \\ln(3) \\end{aligned}Thus, the exact solutions are $x = \\ln(2)$ and $x = \\ln(3)$.",
    "Final Answer:\\begin{aligned} x = \\ln(2) \\text{ or } x = \\ln(3) \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} x = 2 \\text{ or } x = 3 \\end{aligned}",
      "feedback": "These are the solutions for the substitution variable $y$, where $y = e^x$. You must complete the final step by taking the natural logarithm: writing $e^x = 2$, giving $x = \\ln 2$, and $e^x = 3$, giving $x = \\ln 3$."
    },
    {
      "ans": "\\begin{aligned} x = \\ln(-2) \\text{ or } x = \\ln(-3) \\end{aligned}",
      "feedback": "This is a sign error when factoring the quadratic $y^2 - 5y + 6 = 0$. Factoring correctly gives $(y-2)(y-3) = 0$, yielding $y = 2$ or $y = 3$, not negative values."
    },
    {
      "ans": "\\begin{aligned} x = \\ln(6) \\end{aligned}",
      "feedback": "This is an index law misconception, where you incorrectly assume that $e^{2x} - 5e^x + 6 = 0$ leads to $e^x = 6$. You must use a substitution variable to solve this quadratic-form equation."
    }
  ],
  "bradley_insight": {
    "type": "caution",
...
},
{
  ...
  "steps": [
    "<strong>Part (a): Proving the identity</strong><br><br>We begin with the left-hand side and apply the laws of indices to express the fraction as a negative power:\\begin{aligned} \\log_a \\left( \\dfrac{1}{k} \\right) &= \\log_a(k^{-1}) \\end{aligned}Using the power law of logarithms ($\\log_b (A^r) = r\\log_b A$):\\begin{aligned} \\log_a(k^{-1}) &= -1 \\times \\log_a k \\cr &= -\\log_a k \\end{aligned}This completes the proof.",
    "<strong>Part (b): Solving the equation</strong><br><br>Using the identity proved in Part (a), we can replace the term $\\log_4 \\left( \\dfrac{1}{x} \\right)$ with $-\\log_4 x$:\\begin{aligned} \\log_4 (x - 3) - \\log_4 x = -1 \\end{aligned}Apply the subtraction law of logarithms:\\begin{aligned} \\log_4 \\left( \\dfrac{x - 3}{x} \\right) = -1 \\end{aligned}",
    "Convert to exponential form to remove the logarithm:\\begin{aligned} \\dfrac{x - 3}{x} &= 4^{-1} \\cr &= \\dfrac{1}{4} \\end{aligned}",
    "Solve the resulting linear equation for $x$:\\begin{aligned} 4(x - 3) &= x \\cr 4x - 12 &= x \\cr 3x &= 12 \\cr x &= 4 \\end{aligned}Check the domain: for $x = 4$, the arguments are $x - 3 = 1 > 0$ and $x = 4 > 0$. Both are valid. Thus, $x = 4$.",
    "Final Answer:\\begin{aligned} &\\text{(a) Identity proven} \\cr &\\text{(b) } x = 4 \\end{aligned}"
  ],
  "pi_options": [
    {
      "ans": "\\begin{aligned} x = 2 \\end{aligned}",
      "feedback": "This is a calculation error. Solving $\\dfrac{x - 3}{x} = \\dfrac{1}{4}$ gives $4x - 12 = x$, leading to $3x = 12$, which gives $x = 4$, not $2$."
    },
    {
    ...
    {
      "ans": "\\begin{aligned} x = 12 \\end{aligned}",
