...
},
{
        ...
        "steps": [
                ...
                "Calculate magnitudes:\\begin{aligned} &|\\vec{QP}| = \\sqrt{(-2)^2 + (-3)^2 + 1^2} = \\sqrt{14} \\cr &|\\vec{QR}| = \\sqrt{(-10)^2 + 1^2 + (-3)^2} = \\sqrt{110} \\end{aligned}",
...
},
{
        ...
        "steps": [
                ...
                "The vector $\\vec{AR}$ is:\\begin{aligned} &\\vec{AR} = \\begin{pmatrix} 1 + \\lambda - 1 \\cr 2 + 2\\lambda - 4 \\cr 3 - 2\\lambda - (-4) \\end{pmatrix} = \\begin{pmatrix} \\lambda \\cr 2\\lambda - 2 \\cr 7 - 2\\lambda \\end{pmatrix} \\end{aligned}",
