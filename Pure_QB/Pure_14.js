...
},
{
        ...
        "steps": [
                ...
                "Substitute $r = 6$ and $\\theta = \\dfrac{2\\pi}{3}$ into the segment formula:\\begin{aligned} &A_{\\text{segment}} \\cr &\\quad = \\dfrac{1}{2}(6)^2\\left(\\dfrac{2\\pi}{3}\\right) - \\dfrac{1}{2}(6)^2\\sin\\left(\\dfrac{2\\pi}{3}\\right) \\cr &\\quad = 12\\pi - 18\\left(\\dfrac{\\sqrt{3}}{2}\\right) \\cr &\\quad = 12\\pi - 9\\sqrt{3} \\end{aligned}",
