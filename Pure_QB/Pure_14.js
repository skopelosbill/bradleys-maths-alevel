...
},
{
        ...
        "steps": [
                ...
                "Integrate $y$ from $x = 0$ to $x = 1$:\\begin{aligned} &\\text{Area} \\cr &\\quad = \\int_{0}^{1} \\left(-\\dfrac{2}{x + 1} + \\dfrac{6}{3x + 2} \\cr &\\qquad - \\dfrac{3}{(3x + 2)^2}\\right)\\text{d}x \\cr &\\quad = \\big[-2\\ln|x + 1| + 2\\ln|3x + 2| \\cr &\\qquad + \\dfrac{1}{3x + 2}\\big]_{0}^{1} \\end{aligned}",
