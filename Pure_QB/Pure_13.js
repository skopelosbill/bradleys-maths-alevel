...
},
{
...
},
 {
        ...
        "steps": [
                "<strong>(i) Finding the gradient at $t = 3$:</strong><br>Differentiate $x$ with respect to $t$ using the quotient rule:\\begin{aligned} &\\dfrac{\\text{d}x}{\\text{d}t} \\cr &\\quad = \\dfrac{(1 + t^2)(1) - t(2t)}{(1 + t^2)^2} \\cr &\\quad = \\dfrac{1 + t^2 - 2t^2}{(1 + t^2)^2} \\cr &\\quad = \\dfrac{1 - t^2}{(1 + t^2)^2} \\end{aligned}",
                "Differentiate $y$ with respect to $t$:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}t} \\cr &\\quad = \\dfrac{(1 + t^2)(2t) - t^2(2t)}{(1 + t^2)^2} \\cr &\\quad = \\dfrac{2t + 2t^3 - 2t^3}{(1 + t^2)^2} \\cr &\\quad = \\dfrac{2t}{(1 + t^2)^2} \\end{aligned}",
                "Use the chain rule to find $\\dfrac{\\text{d}y}{\\text{d}x}$:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{\\text{d}y/\\text{d}t}{\\text{d}x/\\text{d}t} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = \\dfrac{\\dfrac{2t}{(1 + t^2)^2}}{\\dfrac{1 - t^2}{(1 + t^2)^2}} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = \\dfrac{2t}{1 - t^2} \\end{aligned}",
                "Substitute $t = 3$ to evaluate the gradient:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{2(3)}{1 - 3^2} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = \\dfrac{6}{-8} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = -\\dfrac{3}{4} \\end{aligned}",
                "<strong>(ii) Verifying the Cartesian equation $x^2 + y^2 = y$:</strong><br>Substitute $x$ and $y$ into the left-hand side:\\begin{aligned} &x^2 + y^2 \\cr &\\quad = \\left(\\dfrac{t}{1 + t^2}\\right)^2 + \\left(\\dfrac{t^2}{1 + t^2}\\right)^2 \\cr &\\quad = \\dfrac{t^2}{(1 + t^2)^2} + \\dfrac{t^4}{(1 + t^2)^2} \\cr &\\quad = \\dfrac{t^2(1 + t^2)}{(1 + t^2)^2} \\cr &\\quad = \\dfrac{t^2}{1 + t^2} \\cr &\\quad = y \\end{aligned}<br><br>Thus, the Cartesian equation $x^2 + y^2 = y$ is verified.",
                "Final Answer: $\\dfrac{\\text{d}y}{\\text{d}x} = -\\dfrac{3}{4}$, Cartesian: $x^2 + y^2 = y$"
        ],
        "pi_options": [
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = -\\dfrac{3}{4}$, Cartesian: $x^2 + y^2 = y^2$",
                ...
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{3}{4}$, Cartesian: $x^2 + y^2 = y$",
                        "feedback": "This option has a sign error in the gradient. Evaluating $\\dfrac{2t}{1-t^2}$ at $t = 3$ gives $\\dfrac{6}{-8} = -\\dfrac{3}{4}$. Be careful when substituting into denominators containing subtraction!"
                },
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = -\\dfrac{3}{5}$, Cartesian: $x^2 + y^2 = y$",
                        "feedback": "This option arises from an error when simplifying the derivative expressions or making an arithmetic mistake in the denominator, such as calculating $1 - 3^2 = -10$."
                }
        ],
        "bradley_insight": {
                "type": "caution",
                "title": "Simplification Safety",
                "content": "When differentiating rational parametric equations, always simplify your derivatives $\\dfrac{\\text{d}x}{\\text{d}t}$ and $\\dfrac{\\text{d}y}{\\text{d}t}$ completely before dividing them to find $\\dfrac{\\text{d}y}{\\text{d}x}$. Leaving common denominators un-cancelled leads to algebraic chaos and makes evaluating the gradient much more difficult."
        }
},
{
        "id": "004647",
        ...
        "steps": [
                "<strong>(i) Finding the gradient at $\\theta = \\dfrac{\\pi}{6}$:</strong><br>Differentiate both equations with respect to $\\theta$:\\begin{aligned} &\\dfrac{\\text{d}x}{\\text{d}\\theta} = -3\\sin\\theta \\cr &\\dfrac{\\text{d}y}{\\text{d}\\theta} = 4\\cos\\theta \\end{aligned}",
                "Use the chain rule to find $\\dfrac{\\text{d}y}{\\text{d}x}$:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{\\text{d}y/\\text{d}\\theta}{\\text{d}x/\\text{d}\\theta} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = \\dfrac{4\\cos\\theta}{-3\\sin\\theta} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = -\\dfrac{4}{3}\\cot\\theta \\end{aligned}",
                "Evaluate the gradient at $\\theta = \\dfrac{\\pi}{6}$:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}x} = -\\dfrac{4}{3}\\cot\\left(\\dfrac{\\pi}{6}\\right) \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = -\\dfrac{4}{3}(\\sqrt{3}) \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = -\\dfrac{4\\sqrt{3}}{3} \\end{aligned}",
                "<strong>(ii) Verifying the Cartesian equation:</strong><br>Substitute $x = 3\\cos\\theta$ and $y = 4\\sin\\theta$ into the left-hand side:\\begin{aligned} &\\dfrac{x^2}{9} + \\dfrac{y^2}{16} \\cr &\\quad = \\dfrac{(3\\cos\\theta)^2}{9} + \\dfrac{(4\\sin\\theta)^2}{16} \\cr &\\quad = \\dfrac{9\\cos^2\\theta}{9} + \\dfrac{16\\sin^2\\theta}{16} \\cr &\\quad = \\cos^2\\theta + \\sin^2\\theta \\cr &\\quad = 1 \\end{aligned}<br><br>Thus, the Cartesian equation $\\dfrac{x^2}{9} + \\dfrac{y^2}{16} = 1$ is verified.",
                "Final Answer: $\\dfrac{\\text{d}y}{\\text{d}x} = -\\dfrac{4\\sqrt{3}}{3}$, Cartesian: $\\dfrac{x^2}{9} + \\dfrac{y^2}{16} = 1$"
        ],
        "pi_options": [
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = -\\dfrac{4\\sqrt{3}}{9}$, Cartesian: $\\dfrac{x^2}{9} + \\dfrac{y^2}{16} = 1$",
                        "feedback": "This option results from a trigonometric error where you evaluated $\\cot\\left(\\dfrac{\\pi}{6}\\right)$ as $\\dfrac{\\sqrt{3}}{3}$ instead of $\\sqrt{3}$. Note that $\\cot\\left(\\dfrac{\\pi}{6}\\right) = \\dfrac{\\cos(\\pi/6)}{\\sin(\\pi/6)}$, which simplifies to $\\sqrt{3}$."
                },
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = -\\dfrac{4\\sqrt{3}}{3}$, Cartesian: $\\dfrac{x^2}{3} + \\dfrac{y^2}{4} = 1$",
                ...
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{4\\sqrt{3}}{3}$, Cartesian: $\\dfrac{x^2}{9} + \\dfrac{y^2}{16} = 1$",
                        "feedback": "This option has a sign error on the gradient. Since $\\dfrac{\\text{d}x}{\\text{d}\\theta} = -3\\sin\\theta$ has a negative sign, the resulting gradient function must be negative on the interval $0 < \\theta < \\dfrac{\\pi}{2}$."
                }
        ],
        "bradley_insight": {
                "type": "pro-tip",
                "title": "Cotangent Conversions",
                "content": "When dealing with ellipse parametrics $x = a\\cos\\theta$ and $y = b\\sin\\theta$, your gradient $\\dfrac{\\text{d}y}{\\text{d}x}$ will always simplify into a form involving $\\cot\\theta$. Converting $\\dfrac{\\cos\\theta}{-\\sin\\theta}$ directly to $-\\cot\\theta$ makes it quick to evaluate the gradient, since $\\cot\\left(\\dfrac{\\pi}{6}\\right) = \\sqrt{3}$ is a standard exact value."
        }
},
{
        "id": "004648",
        ...
        "steps": [
                "<strong>(i) Finding the gradient at $t = 0$:</strong><br>Differentiate $x = \\mathrm{e}^{2t}$ with respect to $t$:\\begin{aligned} &\\dfrac{\\text{d}x}{\\text{d}t} = 2\\mathrm{e}^{2t} \\end{aligned}",
                "Differentiate $y = t\\mathrm{e}^{-t}$ using the product rule:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}t} \\cr &\\quad = (1)\\mathrm{e}^{-t} + t(-\\mathrm{e}^{-t}) \\cr &\\quad = \\mathrm{e}^{-t}(1 - t) \\end{aligned}",
                "Use the chain rule to find $\\dfrac{\\text{d}y}{\\text{d}x}$:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{\\text{d}y/\\text{d}t}{\\text{d}x/\\text{d}t} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = \\dfrac{\\mathrm{e}^{-t}(1 - t)}{2\\mathrm{e}^{2t}} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = \\dfrac{1 - t}{2\\mathrm{e}^{3t}} \\end{aligned}",
                "Evaluate the gradient at $t = 0$:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{1 - 0}{2\\mathrm{e}^0} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = \\dfrac{1}{2} \\end{aligned}",
                "<strong>(ii) Verifying the Cartesian equation $4y^2x = (\\ln x)^2$:</strong><br>From the equation for $x$, isolate $t$:\\begin{aligned} &x = \\mathrm{e}^{2t} \\cr &\\ln x = 2t \\cr &(\\ln x)^2 = 4t^2 \\end{aligned}",
                "Substitute $x$ and $y$ into the left-hand side of the Cartesian equation:\\begin{aligned} &4y^2x \\cr &\\quad = 4\\left(t\\mathrm{e}^{-t}\\right)^2 \\left(\\mathrm{e}^{2t}\\right) \\cr &\\quad = 4\\left(t^2\\mathrm{e}^{-2t}\\right) \\left(\\mathrm{e}^{2t}\\right) \\cr &\\quad = 4t^2 \\mathrm{e}^{-2t + 2t} \\cr &\\quad = 4t^2 \\mathrm{e}^0 \\cr &\\quad = 4t^2 \\end{aligned}<br><br>Since both sides simplify to $4t^2$, the Cartesian equation $4y^2x = (\\ln x)^2$ is verified.",
                "Final Answer: $\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{1}{2}$, Cartesian: $4y^2x = (\\ln x)^2$"
        ],
        "pi_options": [
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = -\\dfrac{1}{2}$, Cartesian: $4y^2x = (\\ln x)^2$",
                ...
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{1}{2}$, Cartesian: $2y^2x = (\\ln x)^2$",
                        "feedback": "This option contains an incorrect coefficient in the Cartesian equation. Squaring $y = t\\mathrm{e}^{-t}$ gives $y^2 = t^2\\mathrm{e}^{-2t}$. When multiplied by $x = \\mathrm{e}^{2t}$, you get $y^2x = t^2$. Therefore, you need a factor of $4$ to match $(\\ln x)^2 = 4t^2$, making the equation $4y^2x = (\\ln x)^2$."
                },
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = 1$, Cartesian: $4y^2x = (\\ln x)^2$",
...
},
{
        ...
        "steps": [
                "<strong>(i) Finding the gradient at $t = 2$:</strong><br>Differentiate both parametric equations with respect to $t$:\\begin{aligned} &\\dfrac{\\text{d}x}{\\text{d}t} = 1 - \\dfrac{2}{t^2} \\cr &\\dfrac{\\text{d}y}{\\text{d}t} = 1 + \\dfrac{2}{t^2} \\end{aligned}",
                "Use the chain rule to obtain the gradient function $\\dfrac{\\text{d}y}{\\text{d}x}$:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{\\text{d}y/\\text{d}t}{\\text{d}x/\\text{d}t} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = \\dfrac{1 + \\dfrac{2}{t^2}}{1 - \\dfrac{2}{t^2}} \\end{aligned}",
                "Substitute $t = 2$ into the gradient function:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{1 + \\dfrac{2}{2^2}}{1 - \\dfrac{2}{2^2}} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = \\dfrac{1 + 0.5}{1 - 0.5} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = \\dfrac{1.5}{0.5} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = 3 \\end{aligned}",
                "<strong>(ii) Verifying the Cartesian equation $x^2 - y^2 = 8$:</strong><br>Substitute $x$ and $y$ into the left-hand side of the Cartesian equation:\\begin{aligned} &x^2 - y^2 \\cr &\\quad = \\left(t + \\dfrac{2}{t}\\right)^2 - \\left(t - \\dfrac{2}{t}\\right)^2 \\cr &\\quad = \\left(t^2 + 4 + \\dfrac{4}{t^2}\\right) \\cr &\\qquad - \\left(t^2 - 4 + \\dfrac{4}{t^2}\\right) \\cr &\\quad = t^2 + 4 + \\dfrac{4}{t^2} - t^2 + 4 - \\dfrac{4}{t^2} \\cr &\\quad = 8 \\end{aligned}<br><br>Thus, the Cartesian equation of the curve is verified.",
                "Final Answer: $\\dfrac{\\text{d}y}{\\text{d}x} = 3$, Cartesian: $x^2 - y^2 = 8$"
        ],
        "pi_options": [
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = -3$, Cartesian: $x^2 - y^2 = 8$",
                ...
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = 3$, Cartesian: $x^2 - y^2 = 4$",
                ...
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = 1$, Cartesian: $x^2 - y^2 = 8$",
...
},
{
        ...
        "steps": [
                "<strong>(i) Finding the gradient at $\\theta = \\dfrac{\\pi}{3}$:</strong><br>Differentiate with respect to $\\theta$:\\begin{aligned} &\\dfrac{\\text{d}x}{\\text{d}\\theta} = \\cos\\theta \\cr &\\dfrac{\\text{d}y}{\\text{d}\\theta} = -2\\sin 2\\theta \\end{aligned}",
                "Use the chain rule to obtain $\\dfrac{\\text{d}y}{\\text{d}x}$:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{\\text{d}y/\\text{d}\\theta}{\\text{d}x/\\text{d}\\theta} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = \\dfrac{-2\\sin 2\\theta}{\\cos\\theta} \\end{aligned}",
                "Evaluate the trigonometric terms at $\\theta = \\dfrac{\\pi}{3}$:\\begin{aligned} &\\cos\\left(\\dfrac{\\pi}{3}\\right) = \\dfrac{1}{2} \\cr &\\sin\\left(\\dfrac{2\\pi}{3}\\right) = \\dfrac{\\sqrt{3}}{2} \\end{aligned}",
                "Substitute these exact values into the gradient function:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{-2\\left(\\dfrac{\\sqrt{3}}{2}\\right)}{\\dfrac{1}{2}} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = \\dfrac{-\\sqrt{3}}{\\dfrac{1}{2}} \\cr &\\hphantom{\\dfrac{\\text{d}y}{\\text{d}x}} = -2\\sqrt{3} \\end{aligned}",
                "<strong>(ii) Verifying the Cartesian equation $y = 1 - 2x^2$:</strong><br>Recall the cosine double-angle identity:\\begin{aligned} &\\cos 2\\theta = 1 - 2\\sin^2\\theta \\end{aligned}",
                "Substitute $x = \\sin\\theta$ and $y = \\cos 2\\theta$ into the identity:\\begin{aligned} &y = 1 - 2x^2 \\end{aligned}<br><br>Thus, the Cartesian equation of the curve is verified.",
                "Final Answer: $\\dfrac{\\text{d}y}{\\text{d}x} = -2\\sqrt{3}$, Cartesian: $y = 1 - 2x^2$"
        ],
        "pi_options": [
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = -\\sqrt{3}$, Cartesian: $y = 1 - 2x^2$",
                ...
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = -2\\sqrt{3}$, Cartesian: $y = 2x^2 - 1$",
                ...
                {
                        "ans": "$\\dfrac{\\text{d}y}{\\text{d}x} = 2\\sqrt{3}$, Cartesian: $y = 1 - 2x^2$",
