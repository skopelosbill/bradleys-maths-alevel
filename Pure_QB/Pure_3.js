window.ALEVEL_QUESTIONS = [
        ...
        },
       {
        ...
        },
        {
                ...
                "img": false,
                "question": "A student is trying to prove the identity for $\\tan(A+B)$ using the known identities for $\\sin(A+B)$ and $\\cos(A+B)$. The student's proof starts:<br>\\begin{aligned}&\\tan(A+B) \\cr & \\quad = \\dfrac{\\sin(A+B)}{\\cos(A+B)} \\cr & \\quad = \\dfrac{\\sin A \\cos B + \\cos A \\sin B}{\\cos A \\cos B - \\sin A \\sin B}\\end{aligned}<br><br>To convert this expression into terms of $\\tan A$ and $\\tan B$, the student decides to divide both the numerator and the denominator by $\\cos A \\cos B$.<br><br>1. Show that this division leads to the identity:<br>\\begin{aligned}&\\tan(A+B) \\cr & \\quad = \\dfrac{\\tan A + \\tan B}{1 - \\tan A \\tan B}\\end{aligned}<br>2. Explain why this identity is not valid if $\\cos A \\cos B = 0$ or if $\\tan A \\tan B = 1$. State the geometric meaning of these restrictions.<br><br>3. Given that $\\tan A = 2$ and $\\tan B = 3$, find the exact value of $\\tan(A+B)$ and deduce the value of the angle $(A+B)$ in degrees, where $A$ and $B$ are acute angles.",
                "steps": [
                        "Dividing each term in the numerator of the expression by $\\cos A \\cos B$ gives:<br>\\begin{aligned}&\\dfrac{\\sin A \\cos B + \\cos A \\sin B}{\\cos A \\cos B} \\cr & \\quad \\quad = \\dfrac{\\sin A \\cos B}{\\cos A \\cos B} \\cr & \\quad \\quad \\quad \\quad + \\dfrac{\\cos A \\sin B}{\\cos A \\cos B} \\cr & \\quad \\quad= \\dfrac{\\sin A}{\\cos A} + \\dfrac{\\sin B}{\\cos B} \\cr & \\quad \\quad = \\tan A + \\tan B\\end{aligned}",
                        "Dividing each term in the denominator of the expression by $\\cos A \\cos B$ gives:<br>\\begin{aligned}&\\dfrac{\\cos A \\cos B - \\sin A \\sin B}{\\cos A \\cos B} \\cr & \\quad \\quad = \\dfrac{\\cos A \\cos B}{\\cos A \\cos B} \\cr & \\quad \\quad \\quad \\quad - \\dfrac{\\sin A \\sin B}{\\cos A \\cos B} \\cr & \\quad \\quad = 1 - \\left(\\dfrac{\\sin A}{\\cos A}\\right)\\left(\\dfrac{\\sin B}{\\cos B}\\right) \\cr & \\quad \\quad = 1 - \\tan A \\tan B\\end{aligned}",
                        "Combining these two results into the original fraction yields the required identity:<br>\\begin{aligned}&\\tan(A+B) \\cr & \\quad = \\dfrac{\\tan A + \\tan B}{1 - \\tan A \\tan B}\\end{aligned}",
                        ...
                        "To find the value when $\\tan A = 2$ and $\\tan B = 3$, we substitute these into the identity:<br>\\begin{aligned}&\\tan(A+B) \\cr & \\quad = \\dfrac{2 + 3}{1 - (2)(3)} \\cr & \\quad = \\dfrac{5}{1 - 6} \\cr & \\quad = \\dfrac{5}{-5} \\cr & \\quad = -1\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Collect like terms to complete the algebraic proof:<br>\\begin{aligned}&\\cos(3\\theta) \\cr & \\quad = (2\\cos^3\\theta + 2\\cos^3\\theta) \\cr & \\quad \\quad + (-\\cos\\theta - 2\\cos\\theta) \\cr & \\quad = 4\\cos^3\\theta - 3\\cos\\theta\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Simplify the fractions:<br>\\begin{aligned}&\\sin(15^\\circ) \\cr & \\quad = \\dfrac{\\sqrt{6}}{4} - \\dfrac{\\sqrt{2}}{4} \\cr & \\quad = \\dfrac{\\sqrt{6} - \\sqrt{2}}{4}\\end{aligned}",
