window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Since $C$ is the midpoint of $OB$, $OC = \\dfrac{1}{2}r$. The area of triangle $OAC$ is: \\begin{aligned}\\text{Area}_{\\triangleOAC} &= \\dfrac{1}{2}(r)\\left(\\dfrac{1}{2}r\\right)\\sin\\theta \\cr&= \\dfrac{r^2}{4}\\sin\\theta\\end{aligned}",
