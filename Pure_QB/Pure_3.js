window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Apply the Cosine Rule to find $\\angle AOC$:  \\begin{aligned}16^2 &= 10^2 + 10^2  \\cr &\\quad - 2(10)(10)\\cos(\\angle AOC) \\cr 256 &= 200 - 200\\cos(\\angle AOC) \\cr \\cos(\\angle AOC) &= -0.28 \\cr \\angle AOC &\\approx 106.26^\\circ\\end{aligned}",
                        ...
                        "Apply the Cosine Rule on triangle $ABC$: \\footnotesize\\begin{aligned}16^2 &= 320 + 320 \\cr &\\quad - 2(\\sqrt{ 320 })(\\sqrt{ 320 })\\cos(\\angle ABC) \\cr 256 &= 640 - 640\\cos(\\angle ABC) \\cr 640\\cos(\\angle ABC) &= 384 \\cr \\cos(\\angle ABC) &= 0.6 \\cr \\angle ABC &\\approx 53.13^{ \\circ }\\end{aligned}\\normalsize",
        ...
        },
        {
                ...
                "img": false,
                "question": "A student attempts to prove the trigonometric identity:<br>$$\\dfrac{1}{\\cos\\theta} - \\cos\\theta = \\sin\\theta\\tan\\theta$$<br>Their written proof is shown below:<br><em>Line 1:</em> $\\text{LHS} = \\dfrac{1}{\\cos\\theta} - \\cos\\theta$<br><em>Line 2:</em> $= \\dfrac{1 - \\cos^2\\theta}{\\cos\\theta}$<br><em>Line 3:</em> $= \\dfrac{\\sin^2\\theta}{\\cos\\theta}$<br><em>Line 4:</em> $= \\sin\\theta \\left(\\dfrac{\\sin\\theta}{\\cos\\theta}\\right)$<br><em>Line 5:</em> $= \\sin\\theta\\tan\\theta = \\text{RHS}$<br><br>1. State the name of the fundamental trigonometric identity used to transition from Line 2 to Line 3.<br>2. Explain why this proof is invalid for $\\theta = 90^\\circ$ and $\\theta = 270^\\circ$.<br>3. Hence, or otherwise, solve the equation:<br>$$\\dfrac{1}{\\cos\\theta} - \\cos\\theta = 3\\sin\\theta$$<br>for $0^\\circ \\le \\theta \\le 180^\\circ$.",
                "steps": [
