window.ALEVEL_QUESTIONS = [
        ...
        },
       {
        ...
        },
        {
                ...
                "question": "Some students are trying to prove an identity for $\\cos(A+B)$. They start by drawing two right-angled triangles $ODE$ and $OEF$ as shown in the diagram below. Let angle $DOE = A$ and angle $EOF = B$. In triangle $OFR$, the horizontal line is $OD$, and $FR$ is perpendicular to $OD$ at $R$. The line $EP$ is perpendicular to $FR$ at $P$.<br><br>The students' incomplete proof continues:<br>Line 1: $\\cos(A+B) = \\dfrac{OR}{OF}$<br><br>Line 2: $= \\dfrac{OD - RD}{OF}$<br>Line 3: $= \\dfrac{OD - EP}{OF}$ since $RD = EP$<br>Line 4: $= \\dfrac{OD}{OF} - \\dfrac{EP}{OF}$<br>Line 4 (expanded): $= \\dfrac{OD}{OE} \\times \\dfrac{OE}{OF} - \\dfrac{EP}{EF} \\times \\dfrac{EF}{OF}$<br><br>1. Explain why $\\dfrac{EP}{EF} \\times \\dfrac{EF}{OF}$ in Line 4 leads to $\\sin A \\sin B$ in Line 5.<br><br>2. Complete Line 4 and Line 5 to prove the identity \\begin{align} & \\cos(A+B) \\cr & quad = \\cos A \\cos B - \\sin A \\sin B\\end{align}<br>3. Explain why the argument used only proves the identity when $A$ and $B$ are acute angles.<br>4. Show how to prove the identity for $\\cos(A-B)$ by substituting $-B$ into the identity for $\\cos(A+B)$, stating any properties of trigonometric functions that you use.",
                "steps": [
                        "To show why $\\dfrac{EP}{EF} \\times \\dfrac{EF}{OF} = \\sin A \\sin B$, we first identify the angles in our coordinate setup:<br><br>Since $EP \\parallel OD$ (both are horizontal), the alternate angle $\\angle OEP = \\angle DOE = A$.<br><br>Since the triangle $OEF$ is right-angled at $E$, $\\angle OEF = 90^\\circ$. This gives:<br>\\begin{aligned}\\angle PEF &= 90^\\circ - \\angle OEP \\cr&= 90^\\circ - A\\end{aligned}<br>Inside the right-angled triangle $EPF$, the angles must sum to $180^\\circ$, meaning:<br>\\begin{aligned}\\angle EFP &= 90^\\circ - \\angle PEF \\cr&= 90^\\circ - (90^\\circ - A) \\cr&= A\\end{aligned}",
