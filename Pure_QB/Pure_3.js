window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        "For Part (a), calculate the side lengths of triangle $ADC$ to find angle $\\angle ADC$: \\begin{aligned}&DA \\cr &= \\sqrt{(-3-(-4))^2 + (4-(-3))^2} \\cr &= \\sqrt{50}\\cr &DC\\cr & = \\sqrt{(4-(-4))^2 + (-3-(-3))^2}\\cr & = 8 \\cr &AC = \\sqrt{(4-(-3))^2 + (-3-4)^2} \\cr&= \\sqrt{98}\\end{aligned}",
