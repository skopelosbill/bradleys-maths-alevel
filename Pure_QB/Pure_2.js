window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Now, we express this integrand in <strong>partial fractions</strong>:\\begin{aligned} & -\\dfrac{x - 4}{(x - 1)(x + 2)} \\cr & \\quad \\quad = \\dfrac{A}{x - 1} + \\dfrac{B}{x + 2}\\cr 4 - x &= A(x + 2) + B(x - 1)$$",
                        "Using the substitution method to solve for the coefficients:<br>1. \\begin{aligned} $x &= 1\\cr \\implies 4 - (1) &= A(1 + 2)\\cr \\implies 3 &= 3A \\implies\\cr A &= 1\\end{aligned}.<br>2. \\begin{aligned} $x &= -2\\cr \\implies 4 - (-2) &= B(-2 - 1)\\cr \\implies 6 ^= -3B\\cr \\implies B &= -2$.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Using the substitution method to solve for the coefficients:<br>1. \\begin{aligned}x &= 2 \\cr \\implies 8 - 2(2) &= A(2 + 1)\\cr \\implies 4 &= 3A\\cr \\implies A &= \\frac{4}{3}.<br>2. \\begin{aligned}x &= -1 \\cr\\implies 8 - 2(-1) &= B(-1 - 2) \\cr\\implies 10 &= -3B\\cr \\implies B &= -\\frac{10}{3}\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Using the substitution method to solve for the coefficients:<br>1. \\begin{aligned} $x &= 2 \\cr \\implies 12 - 2(2) &= 3A(2 + 1)\\cr \\implies 8 &= 9A\\cr \\implies A = \\frac{8}{9}\\end{aligned}<br>2. \\begin{aligned} x &= -1 \\cr \\implies 12 - 2(-1) &= 3B(-1 - 2) \\cr \\implies 14 &= -9B \\cr \\implies B &= -\\frac{14}{9}$.",
