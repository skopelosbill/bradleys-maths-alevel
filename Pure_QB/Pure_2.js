window.ALEVEL_QUESTIONS = [
        {
                ...
                "steps": [
                        ...
                        "Using the sum formula, $S_N = \\dfrac{a(r_{\\text{gp}}^N - 1)}{r_{\\text{gp}} - 1}$:<br>\\begin{aligned}S_{12} &= \\dfrac{20.8(1.04^{12} - 1)}{1.04 - 1} \\cr&= \\dfrac{20.8(1.04^{12} - 1)}{0.04} \\cr&= 520(1.04^{12} - 1)\\cr &\\approx 520(1.601032 - 1)\\cr & \\approx 312.537\\text{ minutes}$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Adding the initial $300\\text{ minutes}$ gives the total estimated time:<br>\\begin{aligned}\\text{Total Time} &= 300 + 2964.711 \\cr&= 3264.711\\text{ minutes}\\end{aligned}<br>Converting to hours, minutes, and seconds:\\begin{aligned} & \\dfrac{3264.711}{60}\\cr & \\quad = 54\\text{ hours and } 24.711\\text{ minutes}$$<br>$$0.711 \\times 60 = 42.66 \\approx 43\\text{ seconds}$$<br>Therefore, the total estimated time is <strong>54 hours, 24 minutes, and 43 seconds</strong>.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Using the sum formula, $S_N = \\dfrac{a(r_{\\text{gp}}^N - 1)}{r_{\\text{gp}} - 1}$:<br>\\begin{aligned}S_8 &= \\dfrac{8.32(1.04^8 - 1)}{1.04 - 1} \\cr&= \\dfrac{8.32(1.04^8 - 1)}{0.04} \\cr&= 208(1.04^8 - 1)\\cr & \\approx 208(1.368569 - 1)\cr & \\approx 76.662\\text{ minutes}\\end{align}",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 15\\text{e}^{-0.5x}$ and $v = \\sin x$:<br>$$u' = -7.5\\text{e}^{-0.5x}$$<br>$$v' = \\cos x$$<br>\\begin{aligned}f'(x) &= u'v + uv' \\cr&= -7.5\\text{e}^{-0.5x}\\sin x + 15\\text{e}^{-0.5x}\\cos x\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 8\\text{e}^{-0.2x}$ and $v = \\sin x$:<br>$$u' = -1.6\\text{e}^{-0.2x}$$<br>$$v' = \\cos x$$<br>\\begin{aligned}f'(x) &= u'v + uv' \\cr&= -1.6\\text{e}^{-0.2x}\\sin x + 8\\text{e}^{-0.2x}\\cos x\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 12\\text{e}^{-\\frac{1}{3}x}$ and $v = \\sin x$:<br>$$u' = -4\\text{e}^{-\\frac{1}{3}x}$$<br>$$v' = \\cos x$$<br>\\begin{aligned}f'(x) &= u'v + uv' \\cr&= -4\\text{e}^{-\\frac{1}{3}x}\\sin x + 12\\text{e}^{-\\frac{1}{3}x}\\cos x\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 6\\text{e}^{-0.125x}$ and $v = \\sin x$:<br>$$u' = -0.75\\text{e}^{-0.125x}$$<br>$$v' = \\cos x$$<br>\\begin{aligned}f'(x) &= u'v + uv' \\cr&= -0.75\\text{e}^{-0.125x}\\sin x + 6\\text{e}^{-0.125x}\\cos x\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> We find the derivative of $f(x) $ with respect to $x$ using the <strong>Product Rule</strong>, where $u = 20\\text{e}^{-\\frac{1}{6}x}$ and $v = \\sin x$:<br>$$u' = -\\frac{10}{3}\\text{e}^{-\\frac{1}{6}x}$$<br>$$v' = \\cos x$$<br>\\begin{aligned}f'(x) &= u'v + uv' \\cr&= -\\frac{10}{3}\\text{e}^{-\\frac{1}{6}x}\\sin x + 20\\text{e}^{-\\frac{1}{6}x}\\cos x\\end{aligned}",
