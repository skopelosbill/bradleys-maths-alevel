window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Part (b):</strong> The graph of \\begin{aligned}H(t) = \\left|15\\text{e}^{-0.5t}\\sin t\\right|$ is a damped sine wave with all its negative lobes reflected above the $t$-axis. This models the successive decreasing bounces of the ball tending to $0$ as $t \\to \\infty$.<br><br>Here is the completed sketch showing this long-term behaviour:<br><img src='images/Pure_SVGs/004056_ans.svg' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'>",
