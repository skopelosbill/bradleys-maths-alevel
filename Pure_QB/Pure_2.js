window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Since the curve passes through the point $(4, \\frac{1}{2})$, we substitute $x = 4$ and $y = \\frac{1}{2}$ into the equation to solve for $p$:<br>\\begin{aligned}\\frac{1}{2} &= \\dfrac{p - 2(4)}{(2(4) - 6)(4 + 2)} \\cr\\frac{1}{2} &= \\dfrac{p - 8}{(2)(6)}\\end{aligned}<br>\\begin{aligned}\\frac{1}{2} &= \\dfrac{p - 8}{12} \\cr6 &= p - 8 \\cr p &= 14\\end{aligned}",
