window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Using the substitution method to solve for the coefficients:<br>1. \\begin{aligned} $x &= 1\\cr \\implies 4 - (1) &= A(1 + 2)\\cr \\implies 3 &= 3A \\implies\\cr A &= 1\\end{aligned}.<br>2. \\begin{aligned} x &= -2\\cr \\implies 4 - (-2) &= B(-2 - 1)\\cr \\implies 6 ^= -3B\\cr \\implies B &= -2\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Substituting these coefficients back into our integral gives:\\begin{aligned}&\\text{Area} = \\int_{3}^{4} \\left( \\dfrac{4/3}{x - 2} - \\dfrac{10/3}{x + 1} \\right) \\text{ d}x \\cr & \\quad \\quad = \\left[ \\frac{4}{3}\\ln|x - 2| - \\frac{10}{3}\\ln|x + 1| \\right]_{3}^{4}\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Substituting these coefficients back into our integral gives:<br>\\begin{aligned} & \\text{Area} = \\int_{3}^{6} \\left( \\dfrac{8/9}{x - 2} - \\dfrac{14/9}{x + 1} \\right) \\text{ d}x \\cr & \\quad \\quad= \\left[ \\frac{8}{9}\\ln|x - 2| - \\frac{14}{9}\\ln|x + 1| \\right]_{3}^{6}\\end{aligned}",
