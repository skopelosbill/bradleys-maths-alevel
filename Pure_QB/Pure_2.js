window.ALEVEL_QUESTIONS = [
...
},
       {
        ...
        "steps": [
                ...
                "For Part (d)(ii), the expansion converges only for \\begin{aligned}|u| &< 1 \\cr \\implies \\left|\\dfrac{ x^3 }{ 16 }\\right| &< 1 \\cr\\implies |x| &< 16^{\\frac{ 1 }{ 3 }} \\cr &\\approx 2.52$. Since the lower limit is $x = -3$ and $| -3 | = 3 \\ge 2.52$, the series does not converge on this interval.",
        ...
        "steps": [
                ...
                "For Part (d)(ii), the expansion converges only for \\begin{aligned}|u| &< 1 \\cr \\implies \\left|\\dfrac{ x^4 }{ 4 }\\right| &< 1 \\cr \\implies |x| &< 4^{\\frac{ 1 }{ 4 }}\\cr & \\approx 1.414$. Since the lower limit is $x = -2$ and $| -2 | = 2 \\ge 1.414$, the series does not converge on this interval.",
