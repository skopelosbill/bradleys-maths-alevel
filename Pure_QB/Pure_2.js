window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Since the curve passes through the point $(2, \\frac{1}{2})$, we substitute $x = 2$ and $y = \\frac{1}{2}$ into the equation to solve for $p$:<br>\\begin{aligned}\\frac{1}{2} &= \\dfrac{p - 3(2)}{(3(2) - 3)(2 + 2)} \\cr\\frac{1}{2} &= \\dfrac{p - 6}{(3)(4)}\\end{aligned}<br>\\begin{aligned}\\frac{1}{2} &= \\dfrac{p - 6}{12} \\cr6 &= p - 6 \\cr p &= 12\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a)(i):</strong> Vertical asymptotes occur where the denominator of the rational function is equal to zero, which means:<br>\\begin{aligned}(2x - q)(x + 1) &= 0 \\cr x &= \\frac{q}{2} \\quad \\text{and} \\quad x = -1\\end{aligned}",
                        ...
                        "Since the curve passes through the point $(3, \\frac{1}{2})$, we substitute $x = 3$ and $y = \\frac{1}{2}$ into the equation to solve for $p$:<br>\\begin{aligned}\\frac{1}{2} &= \\dfrac{p - 4(3)}{(2(3) - 4)(3 + 1)} \\cr\\frac{1}{2} &= \\dfrac{p - 12}{(2)(4)}\\end{aligned}<br>\\begin{aligned}\\frac{1}{2} &= \\dfrac{p - 12}{8} \\cr4 &= p - 12 \\cr p &= 16\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Since the curve passes through the point $(3, \\frac{1}{2})$, we substitute $x = 3$ and $y = \\frac{1}{2}$ into the equation to solve for $p$:<br>\\begin{aligned}\\frac{1}{2} &= \\dfrac{p - 2(3)}{(3(3) - 6)(3 + 1)} \\cr\\frac{1}{2} &= \\dfrac{p - 6}{(3)(4)}\\end{aligned}<br>\\begin{aligned}\\frac{1}{2} &= \\dfrac{p - 6}{12} \\cr6 &= p - 6 \\cr p &= 12\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Since the curve passes through the point $(4, \\frac{1}{2})$, we substitute $x = 4$ and $y = \\frac{1}{2}$ into the equation to solve for $p$:<br>\\begin{aligned}\\frac{1}{2} &= \\dfrac{p - 3(4)}{(2(4) - 6)(4 + 2)} \\cr\\frac{1}{2} &= \\dfrac{p - 12}{(2)(6)}\\end{aligned}<br>\\begin{aligned}\\frac{1}{2} &= \\dfrac{p - 12}{12} \\cr6 &= p - 12 \\cr p &= 18\\end{aligned}",
