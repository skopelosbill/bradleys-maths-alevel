window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Check for any secondary solutions within the translated range $30^\\circ \\le \\phi \\le 390^\\circ$ by adding multiples of $360^\\circ$:<br>\\begin{aligned} \\phi &= 60^\\circ + 360^\\circ = 420^\\circ \\cr  \\phi &= 120^\\circ + 360^\\circ = 480^\\circ \\end{aligned}<br>Both values are outside of the given range, thus the only valid values of $\\phi$ are $60^\\circ$ and $120^\\circ$.",
        ...
        },
  {
    ...
    "branch": "Pure",
    "level": "AS",
    "major_area": "Differentiation and Integration",
    "topic": [
        "Differentiation",
        "Integration"
    ],
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>Showing all your working, solve the following:<br><br>1. Given that $y = \\dfrac{4}{3x^2} + 10\\sqrt{x}$, find the value of $\\dfrac{\\text{d}y}{\\text{d}x}$ when $x = 8$.<br><br>2. Find $\\int \\left( 3x^{5/2} + 15x^{-4} + 8 \\right) \\text{d}x$.",
    "steps": [
      "First, rewrite the terms of the equation for $y$ using fractional and negative indices so they are ready to be differentiated:\\begin{aligned} y &= \\dfrac{4}{3}x^{-2} + 10x^{1/2} \\end{aligned}",
      "Differentiate each term with respect to $x$ using the standard power rule $\\dfrac{\\text{d}}{\\text{d}x}(x^n) = nx^{n-1}$:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}x} \\cr &\\quad = \\dfrac{4}{3}(-2)x^{-3} \\cr &\\qquad + 10\\left(\\dfrac{1}{2}\\right)x^{-1/2} \\cr &\\quad = -\\dfrac{8}{3}x^{-3} + 5x^{-1/2} \\cr &\\quad = -\\dfrac{8}{3x^3} + \\dfrac{5}{\\sqrt{x}} \\end{aligned}",
      "To evaluate the derivative at $x = 8$, substitute $x = 8$ into the derivative expression:\\begin{aligned} &\\dfrac{\\text{d}y}{\\text{d}x}\\Big|_{x=8} \\cr &\\quad = -\\dfrac{8}{3(8)^3} + \\dfrac{5}{\\sqrt{8}} \\cr &\\quad = -\\dfrac{8}{3(512)} + \\dfrac{5}{2\\sqrt{2}} \\cr &\\quad = -\\dfrac{1}{192} + \\dfrac{5}{2\\sqrt{2}} \\end{aligned}",
      "Rationalise the denominator of the second term and combine:\\begin{aligned} \\dfrac{5}{2\\sqrt{2}} &= \\dfrac{5\\sqrt{2}}{4} \\cr \\dfrac{\\text{d}y}{\\text{d}x}\\Big|_{x=8} &= \\dfrac{5\\sqrt{2}}{4} - \\dfrac{1}{192} \\end{aligned}",
      "For part 2, integrate the expression term by term using the integration power rule $\\int x^n \\text{d}x = \\dfrac{x^{n+1}}{n+1}$:\\begin{aligned} &\\int \\left( 3x^{5/2} + 15x^{-4} + 8 \\right) \\text{d}x \\cr &\\quad = \\dfrac{3x^{7/2}}{7/2} + \\dfrac{15x^{-3}}{-3} + 8x + C \\cr &\\quad = \\dfrac{6}{7}x^{7/2} - 5x^{-3} + 8x + C \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\text{1. } \\dfrac{5\\sqrt{2}}{4} - \\dfrac{1}{192} \\cr &\\text{2. } \\dfrac{6}{7}x^{7/2} - 5x^{-3} + 8x + C \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{1. } \\dfrac{5\\sqrt{2}}{4} - \\dfrac{1}{192} \\cr &\\text{2. } \\dfrac{6}{7}x^{7/2} - 5x^{-3} + 8x \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{1. } \\dfrac{5\\sqrt{2}}{4} + \\dfrac{1}{192} \\cr &\\text{2. } \\dfrac{6}{7}x^{7/2} - 5x^{-3} + 8x + C \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{1. } \\dfrac{5\\sqrt{2}}{4} - \\dfrac{1}{192} \\cr &\\text{2. } \\dfrac{3}{7}x^{7/2} - 15x^{-3} + 8x + C \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      "Begin by writing down the formal definition of the derivative from first principles:$$\\dfrac{\\text{d}y}{\\text{d}x} = \\lim_{h \\to 0} \\dfrac{f(x + h) - f(x)}{h}$$",
      "Substitute the function $f(x) = 5x^2 - 3x$ into the expression for $f(x + h)$ and expand:\\begin{aligned} &f(x + h) \\cr &\\quad = 5(x + h)^2 - 3(x + h) \\cr &\\quad = 5(x^2 + 2xh + h^2) \\cr &\\qquad - 3x - 3h \\cr &\\quad = 5x^2 + 10xh + 5h^2 \\cr &\\qquad - 3x - 3h \\end{aligned}",
      "Substitute $f(x + h)$ and $f(x)$ into the numerator of our limit definition and simplify:\\begin{aligned} &f(x + h) - f(x) \\cr &\\quad = (5x^2 + 10xh + 5h^2 \\cr &\\qquad - 3x - 3h) \\cr &\\qquad - (5x^2 - 3x) \\cr &\\quad = 10xh + 5h^2 - 3h \\end{aligned}",
      "Divide each term in the simplified numerator expression by $h$:\\begin{aligned} &\\dfrac{f(x + h) - f(x)}{h} \\cr &\\quad = \\dfrac{10xh + 5h^2 - 3h}{h} \\cr &\\quad = \\dfrac{h(10x + 5h - 3)}{h} \\cr &\\quad = 10x + 5h - 3 \\end{aligned}",
      "Evaluate the limit of this expression as $h \\to 0$ to find the derivative:\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\lim_{h \\to 0} (10x + 5h - 3) \\cr &= 10x + 5(0) - 3 \\cr &= 10x - 3 \\end{aligned}",
      "Final Answer: $$10x - 3$$"
    ],
    "pi_options": [
      {
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>A curve has the equation:$$y = 3x^2 - \\dfrac{4}{x} + 2$$Find the equation of the tangent to the curve at the point where $x = 2$, giving your answer in the form $y = mx + c$.",
    "steps": [
      "First, find the $y$-coordinate of the point of tangency by substituting $x = 2$ back into the original curve's equation:\\begin{aligned} y(2) &= 3(2)^2 - \\dfrac{4}{2} + 2 \\cr &= 3(4) - 2 + 2 \\cr &= 12 \\end{aligned}Thus, the point of tangency is $P(2, 12)$.",
      "Rewrite the equation of the curve using negative indices so that it is ready to be differentiated:\\begin{aligned} y &= 3x^2 - 4x^{-1} + 2 \\end{aligned}",
      "Differentiate the curve's equation with respect to $x$ using the standard power rule:\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= 6x - 4(-1)x^{-2} \\cr &= 6x + 4x^{-2} \\cr &= 6x + \\dfrac{4}{x^2} \\end{aligned}",
      "Find the gradient $m$ of the tangent line by substituting $x = 2$ into the derivative expression:\\begin{aligned} m &= 6(2) + \\dfrac{4}{2^2} \\cr &= 12 + \\dfrac{4}{4} \\cr &= 12 + 1 \\cr &= 13 \\end{aligned}",
      "Use the point-gradient formula $y - y_1 = m(x - x_1)$ with the point $P(2, 12)$ and gradient $m = 13$ to find the equation of the tangent:\\begin{aligned} y - 12 &= 13(x - 2) \\cr y - 12 &= 13x - 26 \\cr y &= 13x - 14 \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>A curve has the equation:$$y = 2x^3 - 3x^2 - 12x + 5$$1. Find the coordinates of the stationary points on the curve.<br><br>2. Determine the nature of each stationary point.",
    "steps": [
      "To find the coordinates of the stationary points, differentiate the curve's equation to find the first derivative:\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= 6x^2 - 6x - 12 \\end{aligned}",
      "Set the first derivative to $0$ and solve the quadratic equation to find the stationary $x$-coordinates:\\begin{aligned} 6x^2 - 6x - 12 &= 0 \\cr x^2 - x - 2 &= 0 \\cr (x - 2)(x + 1) &= 0 \\end{aligned}This yields two stationary values: $x = 2$ and $x = -1$.",
      "Substitute these $x$-values back into the original curve's equation to find their corresponding $y$-coordinates:<br><br><ul><li>For $x = 2$: $y = -15$, giving $(2, -15)$</li><li>For $x = -1$: $y = 12$, giving $(-1, 12)$</li></ul>",
      "Find the second derivative of the curve's equation to help determine the nature of these points:\\begin{aligned} \\dfrac{\\text{d}^2y}{\\text{d}x^2} &= 12x - 6 \\end{aligned}",
      "Evaluate the second derivative at each stationary point:<br><br><ul><li>At $x = 2$: $\\dfrac{\\text{d}^2y}{\\text{d}x^2} = 18 > 0$ (Local Minimum)</li><li>At $x = -1$: $\\dfrac{\\text{d}^2y}{\\text{d}x^2} = -18 < 0$ (Local Maximum)</li></ul>",
      "Final Answer: \\begin{aligned} &(2, -15) \\text{ (local minimum)} \\cr &(-1, 12) \\text{ (local maximum)} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &(2, -15) \\text{ (local maximum)} \\cr &(-1, 12) \\text{ (local minimum)} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(2, -3) \\cr &(-1, 12) \\end{aligned}",
        "feedback": "Check your calculations for the $y$-coordinate of the first point. Substituting $x = 2$ yields $y = -15$. It seems you may have calculated the $12(2)$ term as $12$ or made an arithmetic slip."
      },
      {
        "ans": "\\begin{aligned} &(2, -15) \\cr &(1, 8) \\end{aligned}",
...
},
  {
    ...
    "question": "In this question you must show detailed reasoning.<br><br>The diagram shows a sketch of $y = f(x)$, which is a reciprocal-type curve with asymptotes $x = 0$ and $y = 0$.<br><br>1. Sketch the graph of $y = f(x) - 3$, clearly indicating the equation of any asymptotes.<br><br>2. Sketch the graph of $y = f(x + 2)$, clearly indicating the equation of any asymptotes.",
    "steps": [
      "For part 1, the transformation $y = f(x) - 3$ represents a vertical translation downwards by $3$ units.<br><br>This transformation shifts every point on the original curve downwards, which also shifts the horizontal asymptote:\\begin{aligned} &\\text{Vertical asymptote: } x = 0 \\cr &\\text{Horizontal asymptote: } y = -3 \\end{aligned}",
      ...
      "For part 2, the transformation $y = f(x + 2)$ represents a horizontal translation to the left by $2$ units.<br><br>This transformation shifts every point on the original curve to the left, which also shifts the vertical asymptote:\\begin{aligned} &\\text{Vertical asymptote: } x = -2 \\cr &\\text{Horizontal asymptote: } y = 0 \\end{aligned}",
      "Using these new asymptotes, sketch the shifted reciprocal curve:<br><br><img src='images/Pure_SVGs/004311_ans2.svg' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
      "Final Answer: \\begin{aligned} &\\text{1. } y = -3, \\; x = 0 \\cr &\\text{2. } x = -2, \\; y = 0 \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{1. } y = -3, \\; x = 0 \\cr &\\text{2. } y = 0, \\; x = 2 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{1. } y = 0, \\; x = -3 \\cr &\\text{2. } y = -2, \\; x = 0 \\end{aligned}",
  ...
  },
  {
    ...
    "question": "In this question you must show detailed reasoning.<br><br>The diagram shows a sketch of the curve $y = f(x)$, which has a local maximum at $P(2, 6)$ and a local minimum at $Q(4, -2)$.<br><br>1. Sketch the graph of $y = -f(x)$, clearly indicating the new coordinates and nature of the stationary points.<br><br>2. Sketch the graph of $y = f(2x)$, clearly indicating the new coordinates and nature of the stationary points.",
    "steps": [
      "For part 1, the transformation $y = -f(x)$ represents a vertical reflection of the curve in the $x$-axis.<br><br>This operation negates all $y$-coordinates of the stationary points while keeping their $x$-coordinates unchanged. It also reverses their mathematical nature:\\begin{aligned} &P(2, 6) \\implies P'(2, -6) \\cr &\\quad \\text{(local minimum)} \\cr &Q(4, -2) \\implies Q'(4, 2) \\cr &\\quad \\text{(local maximum)} \\end{aligned}",
      ...
      "For part 2, the transformation $y = f(2x)$ represents a horizontal stretch by a factor of $\\dfrac{1}{2}$ (horizontal compression).<br><br>This operation halves the $x$-coordinates of all points on the curve while keeping their $y$-coordinates and mathematical nature completely unchanged:\\begin{aligned} &P(2, 6) \\implies P''(1, 6) \\cr &\\quad \\text{(local maximum)} \\cr &Q(4, -2) \\implies Q''(2, -2) \\cr &\\quad \\text{(local minimum)} \\end{aligned}",
      "Using these compressed coordinate points, sketch the horizontally scaled cubic curve:<br><br><img src='images/Pure_SVGs/004312_ans2.svg' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
      "Final Answer: \\begin{aligned} &\\text{1. } P'(2, -6) \\text{ min}, \\; Q'(4, 2) \\text{ max} \\cr &\\text{2. } P''(1, 6) \\text{ max}, \\; Q''(2, -2) \\text{ min} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &P'(2, -6) \\text{ (maximum)} \\cr &Q'(4, 2) \\text{ (minimum)} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &P''(4, 6) \\cr &Q''(8, -2) \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &P''(1, 12) \\cr &Q''(2, -4) \\end{aligned}",
  ...
  },
  {
    ...
    "question": "In this question you must show detailed reasoning.<br><br>The diagram shows a sketch of the quadratic curve $y = f(x)$, which has its vertex (minimum point) at $(3, -4)$ and crosses the $x$-axis at $(1, 0)$ and $(5, 0)$.<br><br>1. Sketch the graph of $y = f(x) + 4$, clearly indicating the coordinates of the new vertex and any $x$-intercepts.<br><br>2. Sketch the graph of $y = f(x - 2)$, clearly indicating the coordinates of the new vertex.",
    "steps": [
      "For part 1, the transformation $y = f(x) + 4$ represents a vertical translation upwards by $4$ units.<br><br>This operation adds $4$ to the $y$-coordinates of all points on the curve while keeping their $x$-coordinates unchanged:\\begin{aligned} \\text{New Vertex} &= (3, -4 + 4) \\cr &= (3, 0) \\end{aligned}",
      ...
      "For part 2, the transformation $y = f(x - 2)$ represents a horizontal translation to the right by $2$ units.<br><br>This operation adds $2$ to the $x$-coordinates of all points on the curve while keeping their $y$-coordinates completely unchanged:\\begin{aligned} \\text{New Vertex} &= (3 + 2, -4) \\cr &= (5, -4) \\end{aligned}",
      "Using this new vertex coordinate, sketch the horizontally translated parabola:<br><br><img src='images/Pure_SVGs/004313_ans2.svg' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
      "Final Answer: \\begin{aligned} &\\text{1. Vertex } (3, 0), \\; x\\text{-intercept } (3, 0) \\cr &\\text{2. Vertex } (5, -4) \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{Vertex: } (3, 0) \\cr &\\text{Intercepts: } (1, 4), \\; (5, 4) \\end{aligned}",
  ...
  },
  {
    ...
    "question": "In this question you must show detailed reasoning.<br><br>The diagram shows a sketch of the curve $y = f(x)$ where $f(x) = 3^x$, which passes through the point $(0, 1)$ and has a horizontal asymptote at $y = 0$.<br><br>1. Sketch the graph of $y = f(x) - 2$, clearly indicating the equation of the new horizontal asymptote and the coordinates of the point where the curve crosses the $y$-axis.<br><br>2. Sketch the graph of $y = f(-x)$, clearly indicating the coordinates of the point where the curve crosses the $y$-axis.",
    "steps": [
      "For part 1, the transformation $y = f(x) - 2$ represents a vertical translation downwards by $2$ units.<br><br>This operation shifts both the curve and its horizontal asymptote downwards by $2$ units:\\begin{aligned} \\text{New Asymptote: } y &= -2 \\end{aligned}",
    ...
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{Asymptote: } y = 0 \\cr &y\\text{-intercept: } (0, -1) \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Asymptote: } y = -2 \\cr &y\\text{-intercept: } (0, 1) \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{Asymptote: } x = 0 \\cr &y\\text{-intercept: } (1, 0) \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>The point $P(4, -6)$ lies on the curve with equation $y = f(x)$. Find the coordinates of the corresponding point on the curve with equation:<br><br>1. $y = f(x + 3) - 5$<br><br>2. $y = -2f(x)$",
    "steps": [
      "For part 1, analyze the horizontal and vertical transformations in $y = f(x + 3) - 5$ individually:<br><br><ul><li>The term $f(x + 3)$ represents a horizontal translation to the left by $3$ units, which affects the $x$-coordinate.</li><li>The term $- 5$ represents a vertical translation downwards by $5$ units, which affects the $y$-coordinate.</li></ul>",
      "Apply these operations to the coordinates of the original point $P(4, -6)$:\\begin{aligned} x' &= 4 - 3 \\cr &= 1 \\cr y' &= -6 - 5 \\cr &= -11 \\end{aligned}Thus, the coordinates of the corresponding point are $(1, -11)$.",
      "For part 2, analyze the vertical transformations in $y = -2f(x)$:<br><br><ul><li>The coefficient $-2$ represents a vertical stretch by a scale factor of $2$ combined with a vertical reflection in the $x$-axis.</li><li>Because there are no horizontal terms inside the bracket, the $x$-coordinate remains completely unchanged.</li></ul>",
      "Apply these vertical operations to the $y$-coordinate of the original point $P(4, -6)$:\\begin{aligned} x'' &= 4 \\cr y'' &= -2 \\times (-6) \\cr &= 12 \\end{aligned}Thus, the coordinates of the corresponding point are $(4, 12)$.",
      "Final Answer: \\begin{aligned} &\\text{1. } (1, -11) \\cr &\\text{2. } (4, 12) \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{1. } (7, -11) \\cr &\\text{2. } (4, 12) \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{1. } (1, -11) \\cr &\\text{2. } (2, -12) \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{1. } (1, -11) \\cr &\\text{2. } (4, -12) \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      "To find the coordinates of the intersection points, set the equation of the curve equal to the equation of the line:\\begin{aligned} 5 + 4x - x^2 &= x + 1 \\cr -x^2 + 3x + 4 &= 0 \\end{aligned}Multiply the entire quadratic equation by $-1$ to make factoring easier:\\begin{aligned} x^2 - 3x - 4 &= 0 \\cr (x - 4)(x + 1) &= 0 \\end{aligned}",
    ...
    "pi_options": [
      {
        "ans": "\\begin{aligned} &A(-1, 0) \\cr &B(4, 5) \\cr &\\text{Area} = \\dfrac{99}{6} \\end{aligned}",
        "feedback": "Check your sign operation in the final limit subtraction step. The exact area is $\\dfrac{112}{6} - \\left(-\\dfrac{13}{6}\\right)$, which simplifies to $\\dfrac{125}{6}$. It seems you may have subtracted the absolute values instead of adding them."
      },
      {
        "ans": "\\begin{aligned} &A(1, 2) \\cr &B(-4, -3) \\cr &\\text{Area} = \\dfrac{125}{6} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &A(-1, 0) \\cr &B(4, 5) \\cr &\\text{Area} = 40 \\end{aligned}",
  ...
  },
  {
    ...
    "pi_options": [
      {
        "ans": "\\begin{aligned} &(0, 0) \\text{ and } (3, 0) \\cr &\\text{Area} = -\\dfrac{27}{4} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &(0, 0) \\text{ and } (9, 0) \\cr &\\text{Area} = \\dfrac{27}{4} \\end{aligned}",
        "feedback": "Check your factorization of $x^3 - 3x^2 = 0$. Factoring out $x^2$ gives $x^2(x - 3) = 0$, which yields $x = 3$, not $x = 9$."
      },
      {
        "ans": "\\begin{aligned} &(0, 0) \\text{ and } (3, 0) \\cr &\\text{Area} = 27 \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      "To find the intersection coordinates, set the equations of the two curves equal to each other:\\begin{aligned} 8 - x^2 &= x^2 \\cr 2x^2 &= 8 \\cr x^2 &= 4 \\cr x &= \\pm 2 \\end{aligned}",
    ...
    "pi_options": [
      ...
      {
        "ans": "\\begin{aligned} &P(-2, 4) \\cr &Q(2, 4) \\cr &\\text{Area} = 16 \\end{aligned}",
    ...
    "pi_options": [
      {
        ...
        "feedback": "Check your sign operation in the final limit subtraction step. The exact area is $\\dfrac{9}{2} - \\left(-\\dfrac{5}{6}\\right)$, which simplifies to $\\dfrac{16}{3}$. It seems you may have subtracted the absolute values instead of adding them."
      },
      {
      ...
      {
        "ans": "$$\\text{Area} = \\dfrac{16}{3} \\text{ on } [0, 9]$$",
  ...
  },
  {
    ...
    "pi_options": [
      {
        "ans": "\\begin{aligned} &A\\left(\\dfrac{4}{9}, 0\\right) \\cr &\\text{Area} = \\dfrac{208}{27} \\end{aligned}",
        "feedback": "Check your sign operation in the final limit subtraction step. The exact area is $8 - \\left(-\\dfrac{8}{27}\\right)$, which simplifies to \\dfrac{224}{27}. It seems you may have subtracted the absolute values instead of adding them."
      },
      {
        "ans": "\\begin{aligned} &A\\left(\\dfrac{2}{3}, 0\\right) \\cr &\\text{Area} = \\dfrac{224}{27} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &A\\left(\\dfrac{4}{9}, 0\\right) \\cr &\\text{Area} = 8 \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Next, test $x = -1$:\\begin{aligned} f(-1) &= 2(-1)^3 - 5(-1)^2 \\cr & \\qquad- 4(-1) + 3 \\cr &= -2 - 5 + 4 + 3 \\cr &= 0 \\end{aligned}Since $f(-1) = 0$, $x = -1$ is verified to be an integer root, and $(x + 1)$ is a factor of the polynomial.",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Use the Sine Rule to find the two possible values for the angle $C = \\angle ACB$:\\begin{aligned} \\dfrac{\\sin C}{c} &= \\dfrac{\\sin B}{b} \\cr \\dfrac{\\sin C}{18} &= \\dfrac{\\sin 35^\\circ}{12} \\cr \\sin C &= 1.5\\sin 35^\\circ \\cr \\sin C &\\approx 0.860364 \\end{aligned}",
      "Find the acute angle $C_1$ and the obtuse angle $C_2$ (where $C_2 = 180^\\circ - C_1$):\\begin{aligned} C_1 &= \\arcsin(0.860364) \\cr C_1 &\\approx 59.4^\\circ \\cr C_2 &= 180^\\circ - 59.4^\\circ \\cr C_2 &= 120.6^\\circ \\end{aligned}",
      "For each case, calculate the corresponding third angle $A = \\angle BAC$:\\begin{aligned} A_1 &= 180^\\circ - 35^\\circ - 59.4^\\circ \\cr &= 85.6^\\circ \\cr A_2 &= 180^\\circ - 35^\\circ - 120.6^\\circ \\cr &= 24.4^\\circ \\end{aligned}",
      "Calculate the area for Case 1 using the area formula $\\text{Area} = \\dfrac{1}{2}bc\\sin A$ with $b = 12$ and $c = 18$:\\begin{aligned} \\text{Area}_1 &= \\dfrac{1}{2}(12)(18)\\sin(85.6^\\circ) \\cr &= 108\\sin(85.6^\\circ) \\cr &\\approx 107.7\\text{ cm}^2 \\end{aligned}",
      "Calculate the area for Case 2:\\begin{aligned} \\text{Area}_2 &= \\dfrac{1}{2}(12)(18)\\sin(24.4^\\circ) \\cr &= 108\\sin(24.4^\\circ) \\cr &\\approx 44.5\\text{ cm}^2 \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\text{Area}_1 = 107.7\\text{ cm}^2 \\cr &\\text{Area}_2 = 44.5\\text{ cm}^2 \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &107.7\\text{ cm}^2 \\cr &54.0\\text{ cm}^2 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &107.7\\text{ cm}^2 \\cr &10.8\\text{ cm}^2 \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Calculate the interior angle $\\angle PAB$ using parallel North lines. The line $PA$ pointing South-West from $A$ makes an angle of $45^\\circ$ with the South line (alternate interior angles with the bearing at $P$). Since the bearing of $B$ from $A$ is $130^\\circ$:\\begin{aligned} \\angle PAB &= (180^\\circ + 45^\\circ) - 130^\\circ \\cr &= 225^\\circ - 130^\\circ \\cr &= 95^\\circ \\end{aligned}",
      "Use the Cosine Rule to find the unknown direct distance $PB$ in triangle $PAB$ with sides $PA = 12$, $AB = 15$, and included angle $\\angle PAB = 95^\\circ$:\\begin{aligned} &PB^2 \\cr &\\quad = PA^2 + AB^2 \\cr &\\qquad - 2(PA)(AB)\\cos\\angle PAB \\cr &\\quad = 12^2 + 15^2 \\cr &\\qquad - 2(12)(15)\\cos(95^\\circ) \\end{aligned}",
      "Substitute the values and evaluate, noting that $\\cos(95^\\circ) \\approx -0.087156$ is negative:\\begin{aligned} PB^2 &= 144 + 225 - 360(-0.087156) \\cr &= 369 + 31.376 \\cr &= 400.376 \\end{aligned}",
      "Take the square root to find the direct distance $PB$:\\begin{aligned} PB &= \\sqrt{400.376} \\cr &\\approx 20.0\\text{ km} \\end{aligned}",
    ...
    "pi_options": [
      ...
      {
        "ans": "$$19.1\\text{ km}$$",
        "feedback": "Check your Cosine Rule signs. Because $\\cos(95^\\circ)$ is negative, the last term in the formula becomes positive: $-2bc\\cos A = -360(-0.087)$, which equals $+31.4$. It seems you may have subtracted this term instead of adding it."
      },
      {
        "ans": "$$27.0\\text{ km}$$",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Apply the Cosine Rule, using the opposite side $a = 10$, and the adjacent sides $b = x$ and $c = x + 2$:\\begin{aligned} &a^2 = b^2 + c^2 - 2bc\\cos A \\cr &10^2 = x^2 + (x + 2)^2 \\cr &\\qquad - 2x(x + 2)\\cos(60^\\circ) \\end{aligned}",
      "Substitute $\\cos(60^\\circ) = 0.5$ and expand the algebraic terms:\\begin{aligned} &100 = x^2 + (x^2 + 4x + 4) \\cr &\\qquad - 2x(x + 2)(0.5) \\cr &100 = 2x^2 + 4x + 4 \\cr &\\qquad - (x^2 + 2x) \\cr &100 = x^2 + 2x + 4 \\end{aligned}",
      "Rearrange the terms into a standard quadratic equation of the form $ax^2 + bx + c = 0$:\\begin{aligned} x^2 + 2x - 96 &= 0 \\end{aligned}",
      "Solve the quadratic equation using the quadratic formula:\\begin{aligned} x &= \\dfrac{-2 \\pm \\sqrt{2^2 - 4(1)(-96)}}{2(1)} \\cr &= \\dfrac{-2 \\pm \\sqrt{4 + 384}}{2} \\cr &= \\dfrac{-2 \\pm \\sqrt{388}}{2} \\end{aligned}",
      "Find the positive root since a side length must be positive, noting that $\\sqrt{388} \\approx 19.6977$:\\begin{aligned} x &\\approx \\dfrac{-2 + 19.6977}{2} \\cr &\\approx \\dfrac{17.6977}{2} \\cr &\\approx 8.8\\text{ cm} \\end{aligned}",
    ...
    "pi_options": [
      ...
      {
        "ans": "\\begin{aligned} &8.8\\text{ cm} \\cr &-10.8\\text{ cm} \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Find the length of the base diagonal $BD$ using Pythagoras' theorem on the horizontal square base $ABCD$ of side $8\\text{ cm}$:\\begin{aligned} BD &= \\sqrt{8^2 + 8^2} \\cr &= \\sqrt{64 + 64} \\cr &= \\sqrt{128} \\cr &= 8\\sqrt{2}\\text{ cm} \\end{aligned}",
      "The center $O$ of the square base bisects the diagonal $BD$, so find the length of $OB$:\\begin{aligned} OB &= \\dfrac{BD}{2} \\cr &= \\dfrac{8\\sqrt{2}}{2} \\cr &= 4\\sqrt{2}\\text{ cm} \\cr &\\approx 5.65685\\text{ cm} \\end{aligned}",
      "The vertical height $VO = 12\\text{ cm}$ is perpendicular to $OB$. In the right-angled triangle $VOB$, the angle $\\theta = \\angle VBO$ represents the angle of elevation of $VB$ from the base:\\begin{aligned} \\tan\\theta &= \\dfrac{VO}{OB} \\cr &= \\dfrac{12}{4\\sqrt{2}} \\cr &= \\dfrac{3}{\\sqrt{2}} \\cr &\\approx 2.12132 \\end{aligned}",
      "Solve for the angle $\\theta$ by taking the inverse tangent:\\begin{aligned} \\theta &= \\arctan(2.12132) \\cr &\\approx 64.76059^\\circ \\cr &\\approx 64.8^\\circ \\end{aligned}",
    ...
    "pi_options": [
      ...
      {
        "ans": "$$56.3^\\circ$$",
        "feedback": "Check your baseline length. The horizontal distance is $OB$ (half the diagonal of the base), which is $4\\sqrt{2} \\approx 5.66\\text{ cm}$. It seems you may have mistakenly used half the side length ($4\\text{ cm}$), leading to $\\tan\\theta = 3$."
      },
      {
        "ans": "$$71.6^\\circ$$",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Write down the formulas for the arc length $s$ and area $A$ of a circular sector in radians:\\begin{aligned} s &= r\\theta \\cr A &= \\dfrac{1}{2}r^2\\theta \\end{aligned}",
      "Substitute the given values $s = 10$ and $A = 40$ into the equations:\\begin{aligned} r\\theta &= 10 \\cr \\dfrac{1}{2}r^2\\theta &= 40 \\end{aligned}",
      "Substitute Equation 1 ($r\\theta = 10$) into Equation 2 by rewriting $r^2\\theta$ as $r(r\\theta)$:\\begin{aligned} \\dfrac{1}{2}r(r\\theta) &= 40 \\cr \\dfrac{1}{2}r(10) &= 40 \\cr 5r &= 40 \\cr r &= 8\\text{ cm} \\end{aligned}",
      "Substitute $r = 8$ back into Equation 1 to find the central angle $\\theta$ in radians:\\begin{aligned} 8\\theta &= 10 \\cr \\theta &= \\dfrac{10}{8} \\cr &= 1.25\\text{ radians} \\end{aligned}",
      "Final Answer: \\begin{aligned} &r = 8\\text{ cm} \\cr &\\theta = 1.25\\text{ radians} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &r = 4\\text{ cm} \\cr &\\theta = 2.5\\text{ radians} \\end{aligned}",
        "feedback": "Check your substitution steps. When substituting $r\\theta = 10$ into $\\dfrac{1}{2}r^2\\theta = 40$, we get $5r = 40$, so $r = 8$. It seems you may have missed the factor of $\\dfrac{1}{2}$."
      },
      {
        "ans": "\\begin{aligned} &r = 8\\text{ cm} \\cr &\\theta = 0.8\\text{ radians} \\end{aligned}",
        "feedback": "Check your division step when isolating $\\theta$. From $8\\theta = 10$, dividing by 8 yields $\\theta = 1.25$ radians. It seems you may have divided 8 by 10 instead."
      },
      {
        "ans": "\\begin{aligned} &r = 8\\text{ cm} \\cr &\\theta = 71.6^\\circ \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>1. Use the Binomial Theorem to expand:$$\\left(x + \\sqrt{y}\\right)^4$$2. Hence, write down the expansion of $(x - \\sqrt{y})^4$ and find a simplified expression for:$$(x + \\sqrt{y})^4 + (x - \\sqrt{y})^4$$giving your answer in terms of $x$ and $y$.",
    "steps": [
      "Use the Binomial Theorem to expand $(x + \\sqrt{y})^4$ term by term using the binomial coefficients $1, 4, 6, 4, 1$:\\begin{aligned} &(x + \\sqrt{y})^4 \\cr &\\quad = \\binom{4}{0}x^4(\\sqrt{y})^0 + \\binom{4}{1}x^3(\\sqrt{y})^1 \\cr &\\qquad + \\binom{4}{2}x^2(\\sqrt{y})^2 + \\binom{4}{3}x(\\sqrt{y})^3 \\cr &\\qquad + \\binom{4}{4}x^0(\\sqrt{y})^4 \\end{aligned}",
      "Simplify each term of the expansion individually, noting that $(\\sqrt{y})^3 = y\\sqrt{y}$:\\begin{aligned} &(x + \\sqrt{y})^4 \\cr &\\quad = 1(x^4)(1) + 4(x^3)(\\sqrt{y}) \\cr &\\qquad + 6(x^2)(y) + 4(x)(y\\sqrt{y}) \\cr &\\qquad + 1(1)(y^2) \\cr &\\quad = x^4 + 4x^3\\sqrt{y} + 6x^2y \\cr &\\qquad + 4xy\\sqrt{y} + y^2 \\end{aligned}",
      "To write down the expansion of the conjugate term $(x - \\sqrt{y})^4$, simply negate the odd powers of $\\sqrt{y}$ from the previous expansion:\\begin{aligned} &(x - \\sqrt{y})^4 \\cr &\\quad = x^4 - 4x^3\\sqrt{y} + 6x^2y \\cr &\\qquad - 4xy\\sqrt{y} + y^2 \\end{aligned}",
      "Add the two expansions together. Notice that the irrational terms containing $\\sqrt{y}$ have opposite signs and cancel out completely:\\begin{aligned} &(x + \\sqrt{y})^4 + (x - \\sqrt{y})^4 \\cr &\\quad = (x^4 + 4x^3\\sqrt{y} + 6x^2y \\cr &\\qquad + 4xy\\sqrt{y} + y^2) \\cr &\\qquad + (x^4 - 4x^3\\sqrt{y} + 6x^2y \\cr &\\qquad - 4xy\\sqrt{y} + y^2) \\cr &\\quad = 2x^4 + 12x^2y + 2y^2 \\cr &\\quad = 2(x^4 + 6x^2y + y^2) \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\text{1. } x^4 + 4x^3\\sqrt{y} + 6x^2y \\cr &\\qquad + 4xy\\sqrt{y} + y^2 \\cr &\\text{2. } 2(x^4 + 6x^2y + y^2) \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\text{1. } x^4 + 4x^3\\sqrt{y} + 6x^2y \\cr &\\qquad + 4xy\\sqrt{y} + y^2 \\cr &\\text{2. } 2x^4 + 2y^2 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\text{1. } x^4 + 4x^3\\sqrt{y} + 6x^2y \\cr &\\qquad + 4xy^2 + y^2 \\cr &\\text{2. } 2(x^4 + 6x^2y + y^2) \\end{aligned}",
        "feedback": "Check your fourth term in the first expansion. The term is $\\binom{4}{3}x(\\sqrt{y})^3$. Since $(\\sqrt{y})^3 = y\\sqrt{y}$, this term simplifies to $4xy\\sqrt{y}$, not $4xy^2$."
      },
      {
        "ans": "\\begin{aligned} &\\text{1. } x^4 + 4x^3\\sqrt{y} + 6x^2y \\cr &\\qquad + 4xy\\sqrt{y} + y^2 \\cr &\\text{2. } 8x^3\\sqrt{y} + 8xy\\sqrt{y} \\end{aligned}",
  ...
  },
  {
   ...
   "major_area": "Algebra",
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>Find the coefficient of $x^3$ in the binomial expansion of:$$(2 - 3x)^6$$",
    "steps": [
      "Write down the general term formula $T_{r+1}$ for the binomial expansion of $(a + b)^n$:\\begin{aligned} T_{r+1} &= \\binom{n}{r} a^{n-r} b^r \\end{aligned}",
      "Substitute the given parameters $a = 2$, $b = -3x$, and $n = 6$ into the general term formula:\\begin{aligned} T_{r+1} &= \\binom{6}{r} (2)^{6-r} (-3x)^r \\cr &= \\binom{6}{r} (2)^{6-r} (-3)^r x^r \\end{aligned}",
      "To find the coefficient of the term in $x^3$, we require the exponent of $x$ to be $3$, which means setting $r = 3$:\\begin{aligned} T_4 &= \\binom{6}{3} (2)^{6-3} (-3)^3 x^3 \\cr &= \\binom{6}{3} (2)^3 (-3)^3 x^3 \\end{aligned}",
      "Evaluate the constant components of the term individually, taking extreme care with the negative base raised to an odd power:\\begin{aligned} \\binom{6}{3} &= 20 \\cr 2^3 &= 8 \\cr (-3)^3 &= -27 \\end{aligned}",
      "Multiply these evaluated constants together to find the final coefficient of $x^3$:\\begin{aligned} T_4 &= 20 \\times 8 \\times (-27)x^3 \\cr &= 160 \\times (-27)x^3 \\cr &= -4320x^3 \\end{aligned}Thus, the coefficient of $x^3$ in the expansion is $-4320$.",
      "Final Answer: $$-4320$$"
    ],
    "pi_options": [
      {
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>Use the Binomial Theorem to expand:$$\\left(x^2 - \\dfrac{2}{x}\\right)^4, \\quad x \\neq 0$$giving each term in its simplest form.",
    "steps": [
      "Write the binomial expansion of $(a + b)^4$ using the binomial coefficients $1, 4, 6, 4, 1$:\\begin{aligned} &(a + b)^4 \\cr &\\quad = a^4 + 4a^3b + 6a^2b^2 \\cr &\\qquad + 4ab^3 + b^4 \\end{aligned}",
      "Substitute $a = x^2$ and $b = -\\dfrac{2}{x}$ into the expansion formula:\\begin{aligned} &\\left(x^2 - \\dfrac{2}{x}\\right)^4 \\cr &\\quad = (x^2)^4 + 4(x^2)^3\\left(-\\dfrac{2}{x}\\right) \\cr &\\qquad + 6(x^2)^2\\left(-\\dfrac{2}{x}\\right)^2 \\cr &\\qquad + 4(x^2)\\left(-\\dfrac{2}{x}\\right)^3 \\cr &\\qquad + \\left(-\\dfrac{2}{x}\\right)^4 \\end{aligned}",
      ...
      "Combine the simplified terms to write the final expanded expression in descending powers of $x$:\\begin{aligned} &\\left(x^2 - \\dfrac{2}{x}\\right)^4 \\cr &\\quad = x^8 - 8x^5 + 24x^2 \\cr &\\qquad - \\dfrac{32}{x} + \\dfrac{16}{x^4} \\end{aligned}",
      "Final Answer: \\begin{aligned} &x^8 - 8x^5 + 24x^2 \\cr &\\quad - \\dfrac{32}{x} + \\dfrac{16}{x^4} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &x^8 + 8x^5 + 24x^2 \\cr &\\quad + \\dfrac{32}{x} + \\dfrac{16}{x^4} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &x^8 - 8x^6 + 24x^4 \\cr &\\quad - \\dfrac{32}{x^2} + \\dfrac{16}{x^4} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &x^8 - 2x^5 + 6x^2 \\cr &\\quad - \\dfrac{8}{x} + \\dfrac{16}{x^4} \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "In this question you must show detailed reasoning.<br><br>1. Find the first four terms in the binomial expansion of $(1 + 2x)^5$ in ascending powers of $x$.<br><br>2. By substituting an appropriate value of $x$ into your expansion, find an approximate value for $1.02^5$. Show all your working.",
    "steps": [
      "Find the first four terms ($r = 0, 1, 2, 3$) of the binomial expansion of $(1 + 2x)^5$ using the binomial coefficients $1, 5, 10, 10$:\\begin{aligned} &(1 + 2x)^5 \\cr &\\quad \\approx \\binom{5}{0}(1)^5(2x)^0 \\cr &\\qquad + \\binom{5}{1}(1)^4(2x)^1 \\cr &\\qquad + \\binom{5}{2}(1)^3(2x)^2 \\cr &\\qquad + \\binom{5}{3}(1)^2(2x)^3 \\end{aligned}",
      "Simplify each of the four terms individually:\\begin{aligned} \\text{Term 1} &= 1 \\cr \\text{Term 2} &= 10x \\cr \\text{Term 3} &= 40x^2 \\cr \\text{Term 4} &= 80x^3 \\end{aligned}Thus, the truncated expansion is:$$(1 + 2x)^5 \\approx 1 + 10x + 40x^2 + 80x^3$$",
      "To approximate $1.02^5$, set the base of our binomial $(1 + 2x)$ equal to the target base $1.02$ to solve for $x$:\\begin{aligned} 1 + 2x &= 1.02 \\cr 2x &= 0.02 \\cr x &= 0.01 \\end{aligned}",
      "Substitute $x = 0.01$ into the truncated binomial expansion:\\begin{aligned} 1.02^5 &\\approx 1 + 10(0.01) \\cr &\\quad + 40(0.01)^2 + 80(0.01)^3 \\end{aligned}",
      "Evaluate each decimal term carefully, keeping track of the decimal places:\\begin{aligned} 10(0.01) &= 0.1 \\cr 40(0.0001) &= 0.004 \\cr 80(0.000001) &= 0.00008 \\end{aligned}",
      "Combine the evaluated decimal terms to find the final approximation:\\begin{aligned} 1.02^5 &\\approx 1 + 0.1 + 0.004 + 0.00008 \\cr &= 1.10408 \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\text{1. } 1 + 10x + 40x^2 + 80x^3 \\cr &\\text{2. } 1.10408 \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &1 + 5x + 10x^2 + 10x^3 \\cr &1.0511 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &1 + 10x + 40x^2 + 80x^3 \\cr &1.20408 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &1 + 10x + 40x^2 + 80x^3 \\cr &1.14080 \\end{aligned}",
        "feedback": "Check your decimal places during addition. Note that $40(0.01)^2 = 0.0040$. It seems you made an addition alignment slip, placing the 4 in the hundredths place instead of the thousandths place."
      }
    ],
    "bradley_insight": {
      "type": "pro-tip",
  ...
  },
  {
    ...
    "steps": [
      "Write down the general term formula $T_{r+1}$ for the binomial expansion of $(1 + kx)^7$:\\begin{aligned} T_{r+1} &= \\binom{7}{r} (1)^{7-r} (kx)^r \\cr &= \\binom{7}{r} k^r x^r \\end{aligned}",
      "To find the coefficient of the term in $x^2$, set $r = 2$ in the general term formula:\\begin{aligned} T_3 &= \\binom{7}{2} k^2 x^2 \\end{aligned}",
      "Evaluate the binomial coefficient $\\binom{7}{2}$:\\begin{aligned} \\binom{7}{2} &= \\dfrac{7 \\times 6}{2 \\times 1} \\cr &= 21 \\end{aligned}",
      "Set the expression for the coefficient of $x^2$ equal to the given value of $189$:\\begin{aligned} 21k^2 &= 189 \\end{aligned}",
      "Solve the quadratic equation to find the value of $k$:\\begin{aligned} k^2 &= \\dfrac{189}{21} \\cr k^2 &= 9 \\cr k &= \\pm 3 \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "<strong>Part (a)</strong><br>The vectors <strong>u</strong> and <strong>v</strong> are defined by $\\mathbf{u} = 8\\mathbf{i} - 15\\mathbf{j}$ and $\\mathbf{v} = 3\\mathbf{i} + 4\\mathbf{j}$. Determine the range of values for $\\mu$ such that:$$\\mu|\\mathbf{v}| > |\\mathbf{u}|$$<br><strong>Part (b)</strong><br>The point $A$ has position vector $5\\mathbf{i} - 8\\mathbf{j}$ and the point $B$ has position vector $17\\mathbf{i} + 10\\mathbf{j}$. Determine the position vector of the point $C$, which lies between $A$ and $B$, such that $AC : CB$ is $1 : 2$.",
    "steps": [
      "<strong>Part (a): Find the magnitude of each vector</strong><br>To start, compute the magnitudes of <strong>u</strong> and <strong>v</strong> using the Pythagorean formula $|x\\mathbf{i} + y\\mathbf{j}| = \\sqrt{x^2 + y^2}$:\\begin{aligned} |\\mathbf{u}| &= \\sqrt{8^2 + (-15)^2} \\cr &= \\sqrt{64 + 225} \\cr &= \\sqrt{289} \\cr &= 17 \\end{aligned}Now find the magnitude of <strong>v</strong>:\\begin{aligned} |\\mathbf{v}| &= \\sqrt{3^2 + 4^2} \\cr &= \\sqrt{9 + 16} \\cr &= \\sqrt{25} \\cr &= 5 \\end{aligned}",
      "<strong>Part (a): Solve the inequality</strong><br>Substitute the computed magnitudes into the inequality $\\mu|\\mathbf{v}| > |\\mathbf{u}|$:\\begin{aligned} 5\\mu &> 17 \\cr \\mu &> \\dfrac{17}{5} \\cr \\mu &> 3.4 \\end{aligned}",
      "<strong>Part (b): Calculate vector $\\vec{AB}$ and find $\\vec{AC}$</strong><br>Find the displacement vector $\\vec{AB}$ by subtracting the position vector of $A$ from $B$:\\begin{aligned} \\vec{AB} &= \\mathbf{b} - \\mathbf{a} \\cr &= (17\\mathbf{i} + 10\\mathbf{j}) - (5\\mathbf{i} - 8\\mathbf{j}) \\cr &= 12\\mathbf{i} + 18\\mathbf{j} \\end{aligned}Now multiply this displacement vector by $\\dfrac{1}{3}$ to find $\\vec{AC}$:\\begin{aligned} \\vec{AC} &= \\dfrac{1}{3}\\vec{AB} \\cr &= \\dfrac{1}{3}(12\\mathbf{i} + 18\\mathbf{j}) \\cr &= 4\\mathbf{i} + 6\\mathbf{j} \\end{aligned}",
      "<strong>Part (b): Determine the position vector of point $C$</strong><br>Add the displacement $\\vec{AC}$ to the starting position vector $\\mathbf{a}$:\\begin{aligned} \\mathbf{c} &= \\mathbf{a} + \\vec{AC} \\cr &= (5\\mathbf{i} - 8\\mathbf{j}) + (4\\mathbf{i} + 6\\mathbf{j}) \\cr &= 9\\mathbf{i} - 2\\mathbf{j} \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\mu > 3.4 \\cr &\\mathbf{c} = 9\\mathbf{i} - 2\\mathbf{j} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\mu > 3.4 \\cr &\\mathbf{c} = 13\\mathbf{i} + 4\\mathbf{j} \\end{aligned}",
        "feedback": "Your range for $\\mu$ is correct, but check how you divided the segment. A position vector of $13\\mathbf{i} + 4\\mathbf{j}$ suggests you used a $2 : 1$ ratio from $A$ to $B$ (i.e. multiplying by $\\dfrac{2}{3}$) instead of the correct $1 : 2$ ratio (which corresponds to $\\dfrac{1}{3}$)."
      },
      {
        "ans": "\\begin{aligned} &\\mu > 2.125 \\cr &\\mathbf{c} = 9\\mathbf{i} - 2\\mathbf{j} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\mu > 3.4 \\cr &\\mathbf{c} = 11\\mathbf{i} - 2\\mathbf{j} \\end{aligned}",
        "feedback": "Your range for $\\mu$ is correct, but check your addition or scalar multiplication when finding $\\mathbf{c}$. Ensure you correctly calculated $\\vec{AC} = 4\\mathbf{i} + 6\\mathbf{j}$ before adding it to $\\mathbf{a}$."
      }
    ],
    "bradley_insight": {
      "type": "caution",
      "title": "The Head Teacher's Eye: Ratio Partitioning",
      "content": "Always remember that a ratio of $m : n$ divides a line segment into $m + n$ total parts. For $AC : CB = 1 : 2$, the fraction used to find the displacement of $C$ from $A$ is $\\dfrac{1}{1 + 2} = \\dfrac{1}{3}$, not $\\dfrac{1}{2}$. Drawing a quick 1D sketch will save you from this very common mistake."
    }
  },
  {
    "id": "004342",
    ...
    "steps": [
      "<strong>Part (a): Find the magnitude of <strong>w</strong></strong><br>The magnitude $|\\mathbf{w}|$ is computed as:\\begin{aligned} |\\mathbf{w}| &= \\sqrt{(-12)^2 + 5^2} \\cr &= \\sqrt{144 + 25} \\cr &= \\sqrt{169} \\cr &= 13 \\end{aligned}",
      "<strong>Part (a): Construct the unit vector</strong><br>To find the unit vector $\\hat{\\mathbf{w}}$ in the direction of <strong>w</strong>, divide <strong>w</strong> by its magnitude $|\\mathbf{w}|$:\\begin{aligned} \\hat{\\mathbf{w}} &= \\dfrac{\\mathbf{w}}{|\\mathbf{w}|} \\cr &= \\dfrac{-12\\mathbf{i} + 5\\mathbf{j}}{13} \\cr &= -\\dfrac{12}{13}\\mathbf{i} + \\dfrac{5}{13}\\mathbf{j} \\end{aligned}",
      "<strong>Part (b): Find the magnitude and unit vector of <strong>p</strong></strong><br>First find the magnitude $|\\mathbf{p}|$:\\begin{aligned} |\\mathbf{p}| &= \\sqrt{4^2 + (-3)^2} \\cr &= \\sqrt{16 + 9} \\cr &= \\sqrt{25} \\cr &= 5 \\end{aligned}Now find the unit vector $\\hat{\\mathbf{p}}$:\\begin{aligned} \\hat{\\mathbf{p}} &= \\dfrac{\\mathbf{p}}{|\\mathbf{p}|} \\cr &= \\dfrac{4}{5}\\mathbf{i} - \\dfrac{3}{5}\\mathbf{j} \\end{aligned}",
      "<strong>Part (b): Scale to the required distance</strong><br>Since $X$ is at a distance of $35$ units from the origin in the direction of <strong>p</strong>, scale the unit vector $\\hat{\\mathbf{p}}$ by a factor of $35$:\\begin{aligned} \\mathbf{x} &= 35\\hat{\\mathbf{p}} \\cr &= 35\\left( \\dfrac{4}{5}\\mathbf{i} - \\dfrac{3}{5}\\mathbf{j} \\right) \\cr &= 7(4\\mathbf{i} - 3\\mathbf{j}) \\cr &= 28\\mathbf{i} - 21\\mathbf{j} \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\hat{\\mathbf{w}} = -\\dfrac{12}{13}\\mathbf{i} + \\dfrac{5}{13}\\mathbf{j} \\cr &\\mathbf{x} = 28\\mathbf{i} - 21\\mathbf{j} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\hat{\\mathbf{w}} = -\\dfrac{12}{7}\\mathbf{i} + \\dfrac{5}{7}\\mathbf{j} \\cr &\\mathbf{x} = 28\\mathbf{i} - 21\\mathbf{j} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\hat{\\mathbf{w}} = -\\dfrac{12}{13}\\mathbf{i} + \\dfrac{5}{13}\\mathbf{j} \\cr &\\mathbf{x} = 140\\mathbf{i} - 105\\mathbf{j} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\hat{\\mathbf{w}} = \\dfrac{12}{13}\\mathbf{i} - \\dfrac{5}{13}\\mathbf{j} \\cr &\\mathbf{x} = -28\\mathbf{i} + 21\\mathbf{j} \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      "<strong>Part (a): Find the midpoint of $PQ$</strong><br>The position vector of the midpoint $\\mathbf{m}$ is the average of the position vectors $\\mathbf{p}$ and $\\mathbf{q}$:\\begin{aligned} \\mathbf{m} &= \\dfrac{\\mathbf{p} + \\mathbf{q}}{2} \\cr &= \\dfrac{(-3 + 7)\\mathbf{i} + (10 - 4)\\mathbf{j}}{2} \\cr &= \\dfrac{4\\mathbf{i} + 6\\mathbf{j}}{2} \\cr &= 2\\mathbf{i} + 3\\mathbf{j} \\end{aligned}",
      "<strong>Part (b): Compute the vector $\\vec{PQ}$</strong><br>Find the vector $\\vec{PQ}$ by subtracting the position vector of $P$ from $Q$:\\begin{aligned} \\vec{PQ} &= \\mathbf{q} - \\mathbf{p} \\cr &= (7\\mathbf{i} - 4\\mathbf{j}) - (-3\\mathbf{i} + 10\\mathbf{j}) \\cr &= 10\\mathbf{i} - 14\\mathbf{j} \\end{aligned}",
      "<strong>Part (b): Find vector $\\vec{QR}$ and position vector $\\mathbf{r}$</strong><br>Now find $\\vec{QR}$:\\begin{aligned} \\vec{QR} &= \\dfrac{1}{2}\\vec{PQ} \\cr &= \\dfrac{1}{2}(10\\mathbf{i} - 14\\mathbf{j}) \\cr &= 5\\mathbf{i} - 7\\mathbf{j} \\end{aligned}Add this displacement to the position vector of $Q$ to find the position vector of $R$:\\begin{aligned} \\mathbf{r} &= \\mathbf{q} + \\vec{QR} \\cr &= (7\\mathbf{i} - 4\\mathbf{j}) + (5\\mathbf{i} - 7\\mathbf{j}) \\cr &= 12\\mathbf{i} - 11\\mathbf{j} \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\mathbf{m} = 2\\mathbf{i} + 3\\mathbf{j} \\cr &\\mathbf{r} = 12\\mathbf{i} - 11\\mathbf{j} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\mathbf{m} = 4\\mathbf{i} + 6\\mathbf{j} \\cr &\\mathbf{r} = 12\\mathbf{i} - 11\\mathbf{j} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\mathbf{m} = 2\\mathbf{i} + 3\\mathbf{j} \\cr &\\mathbf{r} = 27\\mathbf{i} - 32\\mathbf{j} \\end{aligned}",
        "feedback": "Your midpoint is correct, but check how you interpreted the ratio for $R$. It looks like you calculated $\\vec{QR} = 2\\vec{PQ}$ instead of $\\dfrac{1}{2}\\vec{PQ}$. The ratio $PQ : QR = 2 : 1$ means $PQ$ is twice the length of $QR$."
      },
      {
        "ans": "\\begin{aligned} &\\mathbf{m} = 2\\mathbf{i} + 3\\mathbf{j} \\cr &\\mathbf{r} = 2\\mathbf{i} + 3\\mathbf{j} \\end{aligned}",
  ...
  },
  {
    ...
    "img": false,
    "question": "<strong>Part (a)</strong><br>Relative to a fixed origin $O$, the points $D$, $E$, and $F$ have position vectors $\\mathbf{d} = \\mathbf{i} - 2\\mathbf{j}$, $\\mathbf{e} = 5\\mathbf{i} + 4\\mathbf{j}$, and $\\mathbf{f} = k\\mathbf{i} + 13\\mathbf{j}$ respectively, where $k$ is a constant.<br><br>&bull; (i) Express $\\vec{DE}$ and $\\vec{EF}$ in terms of $\\mathbf{i}$, $\\mathbf{j}$, and $k$.<br>&bull; (ii) Given that the points $D$, $E$, and $F$ are collinear, determine the value of $k$.<br><br><strong>Part (b)</strong><br>Using the value of $k$ found in part (a), find the ratio $DE : EF$.",
    "steps": [
      "<strong>Part (a)(i): Express the displacement vectors</strong><br>Find $\\vec{DE}$ and $\\vec{EF}$ by subtracting the respective position vectors:\\begin{aligned} \\vec{DE} &= \\mathbf{e} - \\mathbf{d} \\cr &= (5\\mathbf{i} + 4\\mathbf{j}) - (\\mathbf{i} - 2\\mathbf{j}) \\cr &= 4\\mathbf{i} + 6\\mathbf{j} \\end{aligned}Now find $\\vec{EF}$:\\begin{aligned} \\vec{EF} &= \\mathbf{f} - \\mathbf{e} \\cr &= (k\\mathbf{i} + 13\\mathbf{j}) - (5\\mathbf{i} + 4\\mathbf{j}) \\cr &= (k - 5)\\mathbf{i} + 9\\mathbf{j} \\end{aligned}",
      ...
      "<strong>Part (a)(ii): Equate the components</strong><br>Equate the $\\mathbf{j}$ components to find $\\lambda$:\\begin{aligned} 9 &= 6\\lambda \\cr \\lambda &= 1.5 \\end{aligned}Now equate the $\\mathbf{i}$ components and substitute $\\lambda = 1.5$:\\begin{aligned} k - 5 &= 4\\lambda \\cr k - 5 &= 4(1.5) \\cr k - 5 &= 6 \\cr k &= 11 \\end{aligned}",
      "<strong>Part (b): Determine the ratio $DE : EF$</strong><br>From the relation $\\vec{EF} = 1.5 \\vec{DE}$ (since $\\lambda = 1.5$), we know that the length of segment $EF$ is $1.5$ times the length of segment $DE$:\\begin{aligned} DE : EF &= 1 : 1.5 \\cr &= 2 : 3 \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\vec{DE} = 4\\mathbf{i} + 6\\mathbf{j} \\cr &\\vec{EF} = (k - 5)\\mathbf{i} + 9\\mathbf{j} \\cr &k = 11 \\cr &DE : EF = 2 : 3 \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &k = 11 \\cr &DE : EF = 3 : 2 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &k = 8 \\cr &DE : EF = 2 : 3 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &k = 14 \\cr &DE : EF = 1 : 2 \\end{aligned}",
  ...
  },
  {
    ...
    "steps": [
      ...
      "<strong>Part (a): Equate components to find $\\lambda$</strong><br>Equate the $\\mathbf{i}$ components:\\begin{aligned} -6 &= 2k \\cr k &= -3 \\end{aligned}Now equate the $\\mathbf{j}$ components and substitute $k = -3$:\\begin{aligned} 9 &= k\\lambda \\cr 9 &= -3\\lambda \\cr \\lambda &= -3 \\end{aligned}",
      "<strong>Part (b): Find the resultant vector $\\mathbf{r}$</strong><br>Substitute $\\lambda = -3$ into <strong>a</strong> to get $\\mathbf{a} = 2\\mathbf{i} - 3\\mathbf{j}$. Then calculate the linear combination $\\mathbf{r} = 4\\mathbf{a} + \\mathbf{b}$:\\begin{aligned} \\mathbf{r} &= 4(2\\mathbf{i} - 3\\mathbf{j}) + (-6\\mathbf{i} + 9\\mathbf{j}) \\cr &= (8\\mathbf{i} - 12\\mathbf{j}) + (-6\\mathbf{i} + 9\\mathbf{j}) \\cr &= 2\\mathbf{i} - 3\\mathbf{j} \\end{aligned}",
      "<strong>Part (b): Calculate the magnitude of $\\mathbf{r}$</strong><br>Compute the magnitude using the Pythagorean formula:\\begin{aligned} |\\mathbf{r}| &= \\sqrt{2^2 + (-3)^2} \\cr &= \\sqrt{4 + 9} \\cr &= \\sqrt{13} \\end{aligned}",
      "Final Answer: \\begin{aligned} &\\lambda = -3 \\cr &|\\mathbf{r}| = \\sqrt{13} \\end{aligned}"
    ],
    "pi_options": [
      {
        "ans": "\\begin{aligned} &\\lambda = -3 \\cr &|\\mathbf{r}| = 13 \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\lambda = -4.5 \\cr &|\\mathbf{r}| = \\sqrt{13} \\end{aligned}",
      ...
      {
        "ans": "\\begin{aligned} &\\lambda = 3 \\cr &|\\mathbf{r}| = \\sqrt{205} \\end{aligned}",
