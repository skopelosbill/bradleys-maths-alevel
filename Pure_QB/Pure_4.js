window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Rewrite the constant term $5$ as $4 + 1$ to allow factorisation:\\begin{aligned} &= 8k^3 + 12k^2 + 16k + 4 + 1\\cr &= 2(4k^3 + 6k^2 + 8k + 2) + 1\\end{aligned}Since $k$ is an integer, the bracketed term is an integer. Any integer in the form $2p + 1$ is odd, so the expression is odd when $n$ is odd.",
        ...
        },
        {
                ...
                "img": false,
                "question": "The equation of a circle is $x^2 + y^2 + 4x - 6y + 3 = 0$.<br><br>1. Find the centre and radius of the circle.<br><br>2. Find the coordinates of any points where the line $y = -3x + 7$ meets the circle $x^2 + y^2 + 4x - 6y + 3 = 0$.<br><br>3. State what can be deduced from your answer to part (2) about the line $y = -3x + 7$ and the circle.",
                "steps": [
                        ...
                        "Substitute $x = 1$ back into the line equation to find the corresponding $y$-coordinate:<br>\\begin{aligned}y &= -3(1) + 7 \\cr &= 4\\end{aligned}<br><br>So, the line meets the circle at the single coordinate point $(1, 4)$.",
                        ...
                        "Final Answer:<br>\\begin{aligned}&(-2, 3), \\quad \\sqrt{10} \\cr &(1, 4), \\quad \\text{tangent}\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&(2, -3), \\quad \\sqrt{10} \\cr &(1, 4), \\quad \\text{tangent}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(-2, 3), \\quad 10 \\cr &(1, 4), \\quad \\text{secant}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(-2, 3), \\quad \\sqrt{10} \\cr &(1, 4) \\text{ and } (-1, 10), \\quad \\text{secant}\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The equation of a circle is $x^2 + y^2 - 6x - 4y - 12 = 0$.<br><br>1. Show that the circle has centre $(3, 2)$ and find its radius.<br><br>2. Find the coordinates of the points of intersection of the line $y = x + 4$ and the circle.<br><br>3. State what can be deduced from your answer to part (2) about the relationship between the line and the circle.",
                "steps": [
                        ...
                        "Substitute these $x$ values back into the line equation $y = x + 4$ to find the corresponding $y$-coordinates:<br><br>For $x = 3$:<br>\\begin{aligned}y &= 3 + 4 \\cr&= 7 \\implies (3, 7)\\end{aligned}<br><br>For $x = -2$:<br>\\begin{aligned}y &= -2 + 4 \\cr&= 2 \\implies (-2, 2)\\end{aligned}",
                        ...
                        "Final Answer:<br>\\begin{aligned}&5 \\cr &(3, 7) \\text{ and } (-2, 2) \\cr &\\text{secant}\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&5 \\cr &(3, 7) \\text{ and } (-2, 2) \\cr &\\text{tangent}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&\\sqrt{12} \\cr &(3, 7) \\text{ and } (-2, 2) \\cr &\\text{secant}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&5 \\cr &(3, 7) \\text{ and } (2, 6) \\cr &\\text{secant}\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Complete the square for both $x$ and $y$ to write the circle in standard form:\\begin{aligned}x^2 - 2x + y^2 - & 8y + 12 = 0 \\cr (x - 1)^2 - 1 + \\cr  (y - 4)^2 - 16 & + 12 = 0 \\cr (x - 1)^2 + & (y - 4)^2 = 5\\end{aligned}<br><br>So, the centre of the circle is $(1, 4)$ and the radius is $\\sqrt{5}$.",
                        ...
                        "To prove there are no real roots (no intersection points), calculate the discriminant $\\Delta = b^2 - 4ac$ of this quadratic equation, where $a = 1, b = 3, c = 6$:<br>\\begin{aligned}\\Delta &= 3^2 - 4(1)(6) \\cr &= 9 - 24 \\cr &= -15\\end{aligned}",
                        ...
                        "Final Answer:<br>\\begin{aligned}&(1, 4), \\quad \\sqrt{5} \\cr &\\Delta = -15 < 0\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&(1, 4), \\quad 5 \\cr &\\Delta = -15 < 0\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(-1, -4), \\quad \\sqrt{5} \\cr &\\Delta = -15 < 0\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(1, 4), \\quad \\sqrt{5} \\cr &\\Delta = 57 > 0\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The circle $C$ has equation $x^2 + y^2 = 5$.<br><br>1. Write down the coordinates of the centre of the circle and state its radius.<br><br>2. The line $L$ has equation $y = 2x + k$, where $k$ is a constant. Show that if $L$ is a tangent to the circle, then $k = \\pm 5$.",
                "steps": [
                        ...
                        "Substitute the coordinates of the centre $(0, 0)$ and the coefficients of our line ($A = 2, B = -1, C = k$) into the formula:<br>\\begin{aligned}d &= \\dfrac{|2(0) - 0 + k|}{\\sqrt{2^2 + (-1)^2}} \\cr &= \\dfrac{|k|}{\\sqrt{5}}\\end{aligned}",
                        "Set this distance equal to the radius $\\sqrt{5}$ and solve for $k$:<br>\\begin{aligned}\\dfrac{|k|}{\\sqrt{5}} &= \\sqrt{5} \\cr |k| &= 5 \\cr k &= \\pm 5\\end{aligned}",
                        "Final Answer: $$k = \\pm 5$$"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "img": false,
                "question": "The circle $C$ has equation $x^2 + y^2 - 6x - 8y + 15 = 0$.<br><br>1. Find the centre and radius of the circle.<br><br>2. Show that the point $P(2, 1)$ lies on the circle.<br><br>3. Find the equation of the tangent to the circle at the point $P$. Give your answer in the form $ax + by = c$, where $a$, $b$, and $c$ are integers.",
                "steps": [
                        "Complete the square for the circle equation to find its centre and radius:<br>\\begin{aligned}x^2 - 6x + y^2 - & 8y + 15 = 0 \\cr (x - 3)^2 - 9 + \\cr (y - 4)^2 - 16 & + 15 = 0 \\cr (x - 3)^2 + & (y - 4)^2 = 10\\end{aligned}<br><br>So, the centre of the circle is $C(3, 4)$ and the radius is $\\sqrt{10}$.",
                        "To show that point $P(2, 1)$ lies on the circle, substitute $x = 2$ and $y = 1$ into the original equation:<br>\\begin{aligned}2^2 + 1^2 & -  6(2) - 8(1) + 15\\cr &= 4 + 1 - 12 - 8 + 15 = 0\\end{aligned}<br><br>Since the point satisfies the equation, $P(2, 1)$ lies on the circle.",
                        ...
                        "Write the equation of the tangent line passing through $P(2, 1)$ using the point-slope formula:<br>$$y - 1 = -\\dfrac{1}{3}(x - 2)$$",
                        "Multiply by $3$ to clear the fraction and rearrange into the form $ax + by = c$ where $a, b, c \\in \\mathbb{Z}$:<br>\\begin{aligned}3(y - 1) &= -(x - 2) \\cr 3y - 3 &= -x + 2 \\cr x + 3y &= 5\\end{aligned}",
                        "Final Answer: $$x + 3y = 5$$"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "img": false,
                "question": "The cubic polynomial $f(x)$ is defined by $f(x) = 2x^3 - 5x^2 - 4x + 3$.<br><br>1. Given that $(x - 3)$ is a factor of $f(x)$, express $f(x)$ in a fully factorised form.<br><br>2. Sketch the graph of $y = f(x)$, indicating the coordinates of any points of intersection with the axes.<br><br>3. Solve the inequality $f(x) < 0$, giving your answer in set notation.<br><br>4. The graph of $y = f(x)$ is transformed by a stretch parallel to the $x$-axis, scale factor $\\dfrac{1}{3}$. Find the equation of the transformed graph.",
                "steps": [
                        "Since $(x - 3)$ is a factor of $f(x)$, we divide $2x^3 - 5x^2 - 4x + 3$ by $(x - 3)$ using algebraic long division or synthetic division to find the quadratic factor:<br>\\begin{aligned}2x^3 - 5x^2 &- 4x + 3 \\cr &= (x - 3)(2x^2 + x - 1)\\end{aligned}<br><br>Base factors can be checked by expansion.",
                        "Factorise the quadratic factor $2x^2 + x - 1$ into linear brackets:<br>\\begin{aligned}2x^2 + x - 1 &= (2x - 1)(x + 1)\\end{aligned}<br><br>Combining these yields the fully factorised form of $f(x)$:<br>\\begin{aligned}f(x) &= (x - 3)(2x - 1)(x + 1)\\end{aligned}",
                        "To sketch the graph of $y = f(x)$, find the axes intercepts:<br><br>The $x$-intercepts occur where \\begin{align}f(x) &= 0 \\cr \\implies x = 3, \\, x = 0.5, \\, x = -1\\end{aligned} These are the points $(3, 0)$, $(0.5, 0)$, and $(-1, 0)$.<br><br>The $y$-intercept occurs where $x = 0 \\implies f(0) = 3$. This is the point $(0, 3)$.<br><br>Since the leading coefficient $2$ is positive, the cubic curve starts in the bottom-left and heads up to the top-right:<br><br><img src='images/Pure_SVGs/004171_ans.svg' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
                        "To solve the inequality $f(x) < 0$, determine the intervals where the cubic curve lies below the $x$-axis. The roots partition the $x$-axis into intervals: $x < -1$, $-1 < x < 0.5$, $0.5 < x < 3$, and $x > 3$.<br><br>By testing values or observing our sketch, we see that $f(x) < 0$ on:<br>\\begin{aligned}x < -1 \\quad \\text{and} \\quad 0.5 < x < 3\\end{aligned}",
                        "Express this solution in formal set notation:<br>$$ {x : x < -1 } \\cup {x : 0.5 < x < 3 }$$",
                        "A stretch parallel to the $x$-axis with a scale factor of $\\dfrac{1}{3}$ replaces $x$ with $3x$ in the equation:<br>\\begin{aligned}y &= 2(3x)^3 - 5(3x)^2 - 4(3x) + 3 \\cr &= 2(27x^3) - 5(9x^2) - 12x + 3 \\cr &= 54x^3 - 45x^2 - 12x + 3\\end{aligned}",
                        "Final Answer:<br>\\begin{aligned}&(x - 3)(2x - 1)(x + 1) \\cr & {x : x < -1 } \\cup {x : 0.5 < x < 3 } \\cr &y = 54x^3 - 45x^2 - 12x + 3\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "$$5.03$$",
                        ...
                        {
                                "ans": "\\begin{aligned}&(x - 3)(2x - 1)(x + 1) \\cr &{x : -1 < x < 0.5} \\cup {x : x > 3} \\cr &y = 54x^3 - 45x^2 - 12x + 3\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(x - 3)(2x - 1)(x + 1) \\cr & {x : x < -1 } \\cup {x : 0.5 < x < 3 } \\cr &y = 6x^3 - 15x^2 - 12x + 3\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The cubic polynomial $g(x)$ is defined by $g(x) = x^3 - 6x^2 + 11x - 6$.<br><br>1. Show that $x = 1$ is a root of the equation $g(x) = 0$, and hence express $g(x)$ in a fully factorised form.<br><br>2. Sketch the graph of $y = g(x)$, indicating the coordinates of any points of intersection with the axes.<br><br>3. Solve the inequality $g(x) \\ge 0$, giving your answer in set notation.<br><br>4. The graph of $y = g(x)$ is transformed by a translation of vector $\\begin{pmatrix} 2 \\\\\\ -1 \\end{pmatrix}$. Find the equation of the transformed graph.",
                "steps": [
                        "To prove $x = 1$ is a root, substitute $1$ into the polynomial $g(x)$:<br>\\begin{aligned}g(1) &= 1^3 - 6(1)^2 + 11(1) - 6 \\cr &= 1 - 6 + 11 - 6 \\cr &= 0\\end{aligned}<br><br>Since $g(1) = 0$, the factor theorem states that $(x - 1)$ is a factor of $g(x)$.",
                        "Divide $x^3 - 6x^2 + 11x - 6$ by $(x - 1)$ to find the quadratic factor:<br>$$g(x) = (x - 1)(x^2 - 5x + 6)$$",
                        "Factorise the quadratic factor $x^2 - 5x + 6$ into linear terms:<br>\\begin{aligned}x^2 - 5x + 6 &= (x - 2)(x - 3)\\end{aligned}<br><br>This gives the fully factorised form:<br>\\begin{aligned}g(x) &= (x - 1)(x - 2)(x - 3)\\end{aligned}",
                        "To sketch the graph of $y = g(x)$, determine the intercepts:<br><br>The $x$-intercepts occur where \\begin{aligned}g(x) &= 0 \\cr &\\implies x = 1, \\, x = 2, \\, x = 3\\end{aligned} This gives the points $(1, 0)$, $(2, 0)$, and $(3, 0)$.<br><br>The $y$-intercept occurs where $x = 0 \\implies g(0) = -6$. This is the point $(0, -6)$.<br><br>Sketch the positive cubic passing through these points:<br><br><img src='images/Pure_SVGs/004172_ans.svg' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
                        ...
                        "A translation of vector $\\begin{pmatrix} 2 \\\\\\ -1 \\end{pmatrix}$ shifts the graph $2$ units to the right and $1$ unit down. This replaces $x$ with $(x - 2)$ and $y$ with $(y + 1)$:<br>\\begin{aligned}y + 1 &= g(x - 2) \\cr y &= g(x - 2) - 1\\end{aligned}<br><br>Substituting our factorised expression yields:<br>$$y = (x - 3)(x - 4)(x - 5) - 1$$",
                        "Final Answer:<br>\\begin{aligned}&(x - 1)(x - 2)(x - 3) \\cr & {x : 1 \\le x \\le 2 } \\cup {x : x \\ge 3 } \\cr &y = (x - 3)(x - 4)(x - 5) - 1\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&(x - 1)(x - 2)(x - 3) \\cr & {x : x \\le 1 } \\cup {x : 2 \\le x \\le 3 } \\cr &y = (x - 3)(x - 4)(x - 5) - 1\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(x - 1)(x - 2)(x - 3) \\cr & {x : 1 \\le x \\le 2 } \\cup {x : x \\ge 3 } \\cr &y = (x - 1)(x - 2)(x - 3) - 1\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(x - 1)(x - 2)(x - 3) \\cr & {x : 1 \\le x \\le 2 } \\cup {x : x \\ge 3 } \\cr &y = (x - 3)(x - 4)(x - 5) + 1\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The cubic polynomial $h(x)$ is defined by $h(x) = x^3 - 3x^2 + 4$.<br><br>1. Show that $(x + 1)$ is a factor of $h(x)$, and express $h(x)$ as a product of linear factors (one of which is repeated).<br><br>2. Sketch the graph of $y = h(x)$, indicating the coordinates of any points of intersection with the axes.<br><br>3. Solve the inequality $h(x) > 0$, giving your answer in set notation.<br><br>4. The graph of $y = h(x)$ is transformed by a stretch parallel to the $y$-axis with scale factor $3$. Find the equation of the transformed graph.",
                "steps": [
                        "To prove $(x + 1)$ is a factor, evaluate $h(-1)$ using the factor theorem:<br>\\begin{aligned}h(-1) &= (-1)^3 - 3(-1)^2 + 4 \\cr &= -1 - 3 + 4 \\cr &= 0\\end{aligned}<br><br>Since $h(-1) = 0$, $(x + 1)$ is indeed a factor of $h(x)$.",
                        "Divide $x^3 - 3x^2 + 4$ by $(x + 1)$ to find the quadratic factor:<br>$$h(x) = (x + 1)(x^2 - 4x + 4)$$",
                        "Factorise the quadratic factor $x^2 - 4x + 4$:<br>\\begin{aligned}x^2 - 4x + 4 &= (x - 2)^2\\end{aligned}<br><br>Thus, the fully factorised form with a repeated factor is:<br>\\begin{aligned}h(x) &= (x + 1)(x - 2)^2\\end{aligned}",
                        "To sketch the graph of $y = h(x)$, determine the intercepts:<br><br>The $x$-intercepts occur where $h(x) = 0 \\implies x = -1$ and $x = 2$ (repeated root). The points are $(-1, 0)$ and $(2, 0)$.<br><br>The $y$-intercept occurs where $x = 0 \\implies h(0) = 4$. This is the point $(0, 4)$.<br><br>Sketch the curve. Note that because $x = 2$ is a repeated root of even multiplicity, the curve touches the $x$-axis and turns around at $(2, 0)$ instead of crossing it:<br><br><img src='images/Pure_SVGs/004173_ans.svg' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
                        ...
                        "A stretch parallel to the $y$-axis with a scale factor of $3$ multiplies the entire function by $3$:<br>\\begin{aligned}y &= 3h(x) \\cr &= 3(x^3 - 3x^2 + 4) \\cr &= 3x^3 - 9x^2 + 12\\end{aligned}",
                        "Final Answer:<br>\\begin{aligned}&(x + 1)(x - 2)^2 \\cr & {x : -1 < x < 2 } \\cup {x : x > 2 } \\cr &y = 3x^3 - 9x^2 + 12\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&(x + 1)(x - 2)^2 \\cr & {x : x > -1 } \\cr &y = 3x^3 - 9x^2 + 12\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(x + 1)(x - 2)^2 \\cr & {x : -1 < x < 2 } \\cup {x : x > 2 } \\cr &y = 27x^3 - 27x^2 + 4\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(x + 1)(x - 2)^2 \\cr & {x : x > -1 } \\cup {2 } \\cr &y = 3x^3 - 9x^2 + 12\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The cubic polynomial $f(x)$ is defined by $f(x) = 3x^2 - x^3 - 4$.<br><br>1. Show that $x = -1$ is a root of $f(x) = 0$, and express $f(x)$ in a fully factorised form.<br><br>2. Sketch the graph of $y = f(x)$, indicating the coordinates of any points of intersection with the axes.<br><br>3. Solve the inequality $f(x) \\ge 0$, giving your answer in set notation.<br><br>4. The graph of $y = f(x)$ is transformed by a reflection in the $x$-axis. Find the equation of the transformed graph.",
                "steps": [
                        "To prove $x = -1$ is a root, substitute $-1$ into the polynomial $f(x)$:<br>\\begin{aligned}f(-1) &= 3(-1)^2 - (-1)^3 - 4 \\cr &= 3(1) - (-1) - 4 \\cr &= 3 + 1 - 4 \\cr &= 0\\end{aligned}<br><br>Since $f(-1) = 0$, $x = -1$ is indeed a root, and $(x + 1)$ is a factor of $f(x)$.",
                        "Divide $3x^2 - x^3 - 4$ (rearranged as $-x^3 + 3x^2 - 4$) by $(x + 1)$ to find the quadratic factor:<br>$$f(x) = (x + 1)(-x^2 + 4x - 4)$$",
                        "Factorise out the negative sign to simplify:<br>\\begin{aligned}f(x) &= -(x + 1)(x^2 - 4x + 4) \\cr &= -(x + 1)(x - 2)^2\\end{aligned}<br><br>This is the fully factorised form.",
                        "To sketch the graph of $y = f(x)$, determine the axes intercepts:<br><br>The $x$-intercepts occur where $f(x) = 0 \\implies x = -1$ and $x = 2$ (repeated root). This gives the points $(-1, 0)$ and $(2, 0)$.<br><br>The $y$-intercept occurs where $x = 0 \\implies f(0) = -4$. This is the point $(0, -4)$.<br><br>Since the leading coefficient is negative ($-1$), the curve starts in the top-left and heads down to the bottom-right. It touches the axis and turns around at $(2, 0)$:<br><br><img src='images/Pure_SVGs/004174_ans.svg' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
                        ...
                        "A reflection in the $x$-axis replaces $y$ with $-y$:<br>\\begin{aligned}-y &= f(x) \\cr y &= -f(x)\\end{aligned}<br><br>\\begin{aligned}y &= -(3x^2 - x^3 - 4) \\cr &= x^3 - 3x^2 + 4\\end{aligned}",
                        "Final Answer:<br>\\begin{aligned}&-(x + 1)(x - 2)^2 \\cr & {x : x \\le -1 } \\cup {2 } \\cr &y = x^3 - 3x^2 + 4\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&-(x + 1)(x - 2)^2 \\cr & {x : x \\le -1 } \\cr &y = x^3 - 3x^2 + 4\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&-(x + 1)(x - 2)^2 \\cr & {x : x \\le -1 } \\cup {2 } \\cr &y = -x^3 + 3x^2 - 4\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(x + 1)(x - 2)^2 \\cr & {x : x \\ge -1 } \\cr &y = x^3 - 3x^2 + 4\\end{aligned}",
        ...
        },
  {
                ...
                "img": false,
                "question": "The quartic polynomial $g(x)$ is defined by $g(x) = (x - 2)^2 (x^2 - 9)$.<br><br>1. Express $g(x)$ in a fully factorised form as the product of linear factors.<br><br>2. Sketch the graph of $y = g(x)$, indicating the coordinates of any points of intersection with the axes.<br><br>3. Solve the inequality $g(x) \\le 0$, giving your answer in set notation.<br><br>4. Describe a sequence of two transformations that maps the graph of $y = x^4$ onto the graph of $y = (2x - 6)^4$.",
                "steps": [
                        "To express $g(x)$ in fully factorised form, expand the quadratic term $(x^2 - 9)$ using the difference of two squares identity, $a^2 - b^2 = (a-b)(a+b)$:<br>$$x^2 - 9 = (x - 3)(x + 3)$$<br><br>Substituting this back yields:<br>$$g(x) = (x - 2)^2 (x - 3)(x + 3)$$",
                        "To sketch the graph of the quartic $y = g(x)$, determine the axes intercepts:<br><br>The $x$-intercepts occur where $g(x) = 0  \\implies x = 2$ (repeated root), $x = 3$ and} $x = -3$. These are the points $(2, 0)$, $(3, 0)$, and $(-3, 0)$.<br><br>The $y$-intercept occurs where \\begin{aligned}x &= 0 \\cr & \\implies g(0) = (-2)^2(0^2 - 9) \\cr & = 4(-9) \\cr &= -36\\end{aligned} This is the point $(0, -36)$.<br><br>Since the leading coefficient of $x^4$ is positive ($+1$), the curve is positive on both ends (heads up to the far-left and far-right). It touches the axis and turns around at $(2, 0)$:<br><br><img src='images/Pure_SVGs/004171_ans.svg' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
                        ...
                        "To map $y = x^4$ onto $y = (2x - 6)^4$, we can rewrite the target equation as $y = [2(x - 3)]^4$. This can be achieved by the following sequence of two transformations:<br><br>1. A horizontal stretch parallel to the $x$-axis with scale factor $\\dfrac{1}{2}$, which transforms $y = x^4$ into $y = (2x)^4$.<br><br>2. A horizontal translation $3$ units to the right (vector $\\begin{pmatrix} 3 \\\\\\ 0 \\end{pmatrix}$), which replaces $x$ with $(x - 3)$, transforming $y = (2x)^4$ into $y = [2(x - 3)]^4 = (2x - 6)^4$.<br><br><em>Alternative Sequence:</em> First translate horizontally $3$ units to the right (transforming $y = x^4$ into $y = (x - 3)^4$), followed by a vertical stretch parallel to the $y$-axis with scale factor $16$ (transforming $y = (x - 3)^4$ into $y = 16(x - 3)^4 = (2x - 6)^4$).",
                        "Final Answer:\\begin{aligned}&(x - 2)^2 (x - 3)(x + 3) \\cr & {x : -3 \\le x \\le 3 } \\cr &\\text{Translation right by } 3 \\cr &\\text{ then vertical stretch sf } 16\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&(x - 2)^2 (x - 3)(x + 3) \\cr & {x : -3 \\le x \\le 2 } \\cup {x : 2 \\le x \\le 3 } \\cr &\\text{Translation right by } 3 \\cr &\\text{ then vertical stretch sf } 16\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(x - 2)^2 (x - 3)(x + 3) \\cr & {x : -3 \\le x \\le 3 } \\cr &\\text{Horizontal stretch sf } 2 \\cr &\\text{ then translation right by } 6\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(x - 2)^2 (x^2 - 9) \\cr & {x : -3 \\le x \\le 3 } \\cr &\\text{Translation right by } 3 \\cr &\\text{ then vertical stretch sf } 16\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "Sarah runs half marathons and is following a training programme to improve her times. Her time for her first half marathon is 160 minutes, and her time for her second half marathon is 156.8 minutes. Sarah believes that her times can be modelled by a geometric progression.<br><br>1. Sarah sets herself a target of completing a half marathon in less than 130 minutes. Show that this model predicts she will achieve her target on her twelfth half marathon.<br><br>2. After several months, Sarah has spent a total of 2091 minutes, to the nearest minute, running half marathons. Use this model to find how many half marathons she has run.<br><br>3. Give two reasons why this model may not be appropriate when predicting the time for a half marathon.",
                "steps": [
                        "To model Sarah's times using a geometric progression, we find the first term $a$ and the common ratio $r$.<br><br>The first term is the time for her first run: $a = 160$ minutes.<br><br>The second term is $ar = 156.8$ minutes, so:\\begin{aligned}r &= \\dfrac{156.8}{160} \\cr &= 0.98\\end{aligned}",
                        "Write the formula for the time of her $n$-th half marathon, $T_n = a r^{n-1}$:\\begin{aligned}T_n &= 160(0.98)^{n-1}\\end{aligned}",
                        "To find when her time falls below $130$ minutes, set up the inequality $T_n < 130$:\\begin{aligned}160(0.98)^{n-1} &< 130 \\cr (0.98)^{n-1} &< \\dfrac{130}{160} \\cr (0.98)^{n-1} &< 0.8125\\end{aligned}",
                        "Take natural logarithms of both sides to solve for $n$. Note that because $\\ln(0.98) < 0$, dividing by it reverses the inequality sign:\\begin{aligned}(n - 1)\\ln(0.98) &< \\ln(0.8125) \\cr n - 1 &> \\dfrac{\\ln(0.8125)}{\\ln(0.98)} \\cr n - 1 &> \\dfrac{-0.20764}{-0.02020} \\cr n - 1 &\\approx 10.28 \\cr n &> 11.28\\end{aligned}<br><br>Since $n$ must be an integer, the smallest valid value is $n = 12$. This proves she achieves her target on her twelfth half marathon.",
                        "To find the number of runs $n$ completed for a total time of $2091$ minutes, apply the geometric series sum formula $S_n = \\dfrac{a(1 - r^n)}{1 - r}$:\\begin{aligned}S_n &= \\dfrac{160(1 - 0.98^n)}{1 - 0.98} \\cr &= \\dfrac{160(1 - 0.98^n)}{0.02} \\cr &= 8000(1 - 0.98^n)\\end{aligned}",
                ...
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&11, \\quad 15 \\cr &\\text{athletic plateau}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&12, \\quad 13 \\cr &\\text{athletic plateau}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&12, \\quad 15 \\cr &\\text{Sarah runs faster in rain}\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "James is training for a marathon. In his first week of training, he runs a total distance of $25\\text{ km}$. He decides to increase his weekly distance by a constant amount, $d\\text{ km}$, each week. In his tenth week of training, his weekly distance is $52\\text{ km}$.<br><br>1. Show that $d = 3$.<br><br>2. Find the total distance James runs during his first $20$ weeks of training.<br><br>3. State one practical reason why James cannot continue this training pattern indefinitely.",
                "steps": [
                        ...
                        "For the tenth week, we are given $u_{10} = 52$:\\begin{aligned}25 + (10 - 1)d &= 52 \\cr 25 + 9d &= 52\\end{aligned}",
                        "Solve for $d$:\\begin{aligned}9d &= 52 - 25 \\cr 9d &= 27 \\cr d &= 3\\end{aligned}<br><br>This confirms that the weekly increase is $3\\text{ km}$.",
                        "To find the total distance run over $20$ weeks, apply the arithmetic series sum formula $S_n = \\dfrac{n}{2}[2a + (n-1)d]$ with $n=20, a=25, d=3$:\\begin{aligned}S_{20} &= \\dfrac{20}{2} [ 2(25) + (20 - 1)3 ]\\end{aligned}",
                        "Simplify inside the brackets and calculate:\\begin{aligned}S_{20} &= 10 [ 50 + 19(3) ] \\cr &= 10 [ 50 + 57 ] \\cr &= 10 [ 107 ] \\cr &= 1070\\end{aligned}<br><br>So, James runs a total of $1070\\text{ km}$ over the first $20$ weeks.",
                        ...
                        "Final Answer:\\begin{aligned}&d = 3 \\cr &1070\\text{ km} \\cr &\\text{physical limits and risk of injury}\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&d = 3 \\cr &1070\\text{ km} \\cr &\\text{running is boring}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&d = 3 \\cr &1540\\text{ km} \\cr &\\text{physical limits}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&d = 2.7 \\cr &1070\\text{ km} \\cr &\\text{physical limits}\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "This series is a geometric progression where:<br><br>The first term $a = 2000(1.04) = 2080$<br><br>The common ratio $r = 1.04$<br><br>The number of terms $n = 10$",
                ...
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&£24,962 \\cr &\\text{constant interest rate}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&£24,012 \\cr &\\text{constant interest rate}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&£26,080 \\cr &\\text{constant interest rate}\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The mass of a radioactive sample is monitored daily. On the first day of monitoring, the mass is $80\\text{ grams}$. On the second day, the mass is $76\\text{ grams}$. The mass is modelled as a geometric progression.<br><br>1. Show that the mass of the sample is predicted to fall below $40\\text{ grams}$ for the first day on the fifteenth day of monitoring.<br><br>2. Find the total mass loss over the first 30 days, giving your answer to the nearest gram.<br><br>3. Why might a discrete geometric progression model be highly appropriate for radioactive decay over short periods, but why might a continuous exponential model be preferred in physics?",
                "steps": [
                        "First, determine the first term $a$ and common ratio $r$ of the geometric progression:<br><br>The mass on the first day is $a = 80$ grams.<br><br>The mass on the second day is $ar = 76$ grams, so:\\begin{aligned}r &= \\dfrac{76}{80} \\cr &= 0.95\\end{aligned}",
                        "Write the formula for the mass on the $n$-th day, $M_n = a r^{n-1}$:\\begin{aligned}M_n &= 80(0.95)^{n-1}\\end{aligned}",
                        "Set up the inequality $M_n < 40$ to find when the mass falls below $40$ grams:\\begin{aligned}80(0.95)^{n-1} &< 40 \\cr (0.95)^{n-1} &< \\dfrac{40}{80} \\cr (0.95)^{n-1} &< 0.5\\end{aligned}",
                        "Take natural logarithms of both sides to solve for $n$. Note that because $\\ln(0.95) < 0$, dividing by it reverses the inequality sign:\\begin{aligned}(n - 1)\\ln(0.95) &< \\ln(0.5) \\cr n - 1 &> \\dfrac{\\ln(0.5)}{\\ln(0.95)} \\cr n - 1 &> \\dfrac{-0.69315}{-0.05129} \\cr n - 1 &\\approx 13.52 \\cr n &> 14.52\\end{aligned}<br><br>Since $n$ must be an integer, the smallest valid value is $n = 15$. This proves the mass falls below $40$ grams on the fifteenth day.",
                ...
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&14 \\cr &62\\text{ grams} \\cr &\\text{discrete vs continuous}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&15 \\cr &18\\text{ grams} \\cr &\\text{discrete vs continuous}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&15 \\cr &62\\text{ grams} \\cr &\\text{geometric models are always better}\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "A company buys a piece of machinery for £50,000. At the end of each year, the value of the machinery depreciates by $15\\%$ of its value at the start of that year.<br><br>1. Show that the value of the machinery at the end of the fourth year is £26,100 to the nearest pound.<br><br>2. Find the total depreciation of the machinery over the first 8 years, giving your answer to the nearest pound.",
                "steps": [
                ...
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&£26,100 \\cr &£13,625\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&£26,100 \\cr &£36,375\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&£30,700 \\cr &£36,375\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "To expand $(9 - x)^{-1/2}$, we first factorise out the $9$ so the first term inside the bracket is $1$:\\begin{aligned}(9 - x)^{-1/2} &= [9(1 - \\dfrac{x}{9})]^{-1/2} \\cr &= 9^{-1/2} (1 - \\dfrac{x}{9})^{-1/2} \\cr &= \\dfrac{1}{3} (1 - \\dfrac{x}{9})^{-1/2}\\end{aligned}",
                        "Apply the binomial expansion formula $(1 + y)^n = 1 + ny + \\dfrac{n(n-1)}{2!}y^2 + \\dots$ with $n = -\\dfrac{1}{2}$ and $y = -\\dfrac{x}{9}$:\\begin{aligned}&(1 - \\dfrac{x}{9})^{-1/2} \\cr & \\quad = 1 + (-\\dfrac{1}{2})(-\\dfrac{x}{9}) \\cr & \\quad \\quad + \\dfrac{(-\\dfrac{1}{2})(-\\dfrac{3}{2})}{2} (-\\dfrac{x}{9})^2 + \\dots \\cr & \\quad = 1 + \\dfrac{x}{18} + \\dfrac{3}{8}(\\dfrac{x^2}{81}) + \\dots \\cr & \\quad = 1 + \\dfrac{x}{18} + \\dfrac{x^2}{216} + \\dots\\end{aligned}",
                        "Multiply the entire expansion by the constant factor of $\\dfrac{1}{3}$:\\begin{aligned}&\\dfrac{1}{3}(1 + \\dfrac{x}{18} + \\dfrac{x^2}{216} + \\dots) \\cr & \\quad = \\dfrac{1}{3} + \\dfrac{x}{54} + \\dfrac{x^2}{648} + \\dots\\end{aligned}",
                        "To find the constants $a$ and $b$, write the rational expression as a product of $(a+bx)$ and the binomial expansion:\\begin{aligned}\\dfrac{a + bx}{\\sqrt{9 - x}} &= (a + bx)(9 - x)^{-1/2} \\cr &\\approx (a + bx)(\\dfrac{1}{3} + \\dfrac{x}{54} + \\dots)\\end{aligned}<br><br>Expand the terms up to the $x$ term:\\begin{aligned}\\text{Expansion} &= \\dfrac{a}{3} + (\\dfrac{a}{54} + \\dfrac{b}{3})x + \\dots\\end{aligned}",
                        "Equate this expansion to the given expression $12 - x \\dots$:<br><br>By comparing the constant terms:\\begin{aligned}\\dfrac{a}{3} &= 12 \\cr a &= 36\\end{aligned}",
                        "By comparing the coefficients of the $x$ terms and substituting $a = 36$:\\begin{aligned}\\dfrac{a}{54} + \\dfrac{b}{3} &= -1 \\cr \\dfrac{36}{54} + \\dfrac{b}{3} &= -1 \\cr \\dfrac{2}{3} + \\dfrac{b}{3} &= -1 \\cr 2 + b &= -3 \\cr b &= -5\\end{aligned}",
                        "Final Answer:\\begin{aligned}&\\dfrac{1}{3} + \\dfrac{x}{54} + \\dfrac{x^2}{648} \\cr &a = 36, \\quad b = -5\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&\\dfrac{1}{3} - \\dfrac{x}{54} + \\dfrac{x^2}{648} \\cr &a = 36, \\quad b = -5\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&\\dfrac{1}{3} + \\dfrac{x}{54} + \\dfrac{x^2}{648} \\cr &a = 12, \\quad b = -5\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&\\dfrac{1}{3} + \\dfrac{x}{54} + \\dfrac{x^2}{648} \\cr &a = 36, \\quad b = -11\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Apply the binomial expansion formula for negative integer powers, $(1 + y)^{-1} = 1 - y + y^2 - y^3 + \\dots$, with $y = 2x$:\\begin{aligned}(1 + 2x)^{-1} &= 1 - (2x) + (2x)^2 - \\dots \\cr &= 1 - 2x + 4x^2 - \\dots\\end{aligned}",
                        "For the binomial expansion to converge and be valid, the absolute value of the horizontal variable $2x$ must be strictly less than $1$:\\begin{aligned}|2x| &< 1 \\cr |x| &< \\dfrac{1}{2}\\end{aligned}",
                        "To find $a$ and $b$, multiply the linear factor by our binomial expansion series up to the quadratic term:\\begin{aligned}(1 + ax)&(1 + 2x)^{-1}\\cr & \\quad \\approx (1 + ax)(1 - 2x + 4x^2)\\end{aligned}",
                        "Expand the brackets and group terms by powers of $x$:\\begin{aligned}&(1 + ax)(1 - 2x + 4x^2) \\cr & \\quad = 1(1 - 2x + 4x^2) + ax(1 - 2x) \\cr & \\quad = 1 - 2x + 4x^2 + ax - 2ax^2 \\cr & \\quad = 1 + (a - 2)x + (4 - 2a)x^2\\end{aligned}",
                        "Compare this result with the given expansion $1 + 5x + bx^2 \\dots$:<br><br>By comparing the coefficients of the $x$ terms:\\begin{aligned}a - 2 &= 5 \\cr a &= 7\\end{aligned}",
                        "By comparing the coefficients of the $x^2$ terms and substituting $a = 7$:\\begin{aligned}b &= 4 - 2a \\cr b &= 4 - 2(7) \\cr &= 4 - 14 \\cr &= -10\\end{aligned}",
                        "Final Answer:\\begin{aligned}&1 - 2x + 4x^2, \\quad |x| < \\dfrac{1}{2} \\cr &a = 7, \\quad b = -10\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&1 - 2x + 4x^2, \\quad |x| < 2 \\cr &a = 7, \\quad b = -10\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&1 - 2x + 4x^2, \\quad |x| < \\dfrac{1}{2} \\cr &a = 7, \\quad b = 18\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&1 + 2x + 4x^2, \\quad |x| < \\dfrac{1}{2} \\cr &a = 3, \\quad b = -2\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Apply the binomial expansion formula \\begin{aligned}(1 + y)^n &= 1 + ny + \\dfrac{n(n-1)}{2!}y^2 \\cr & \\quad + \\dots\\end{aligned} with $n = \\dfrac{1}{2}$ and $y = 4x$:\\begin{aligned}(1 + 4x)^{1/2} &= 1 + (\\dfrac{1}{2})(4x) \\cr & \\quad + \\dfrac{(\\dfrac{1}{2})(-\\dfrac{1}{2})}{2}(4x)^2 + \\dots\\end{aligned}",
                        "Simplify the terms of the expansion:\\begin{aligned}(1 + 4x)^{1/2} &= 1 + 2x \\cr & \\quad + (-\\dfrac{1}{8})(16x^2) + \\dots \\cr &= 1 + 2x - 2x^2 + \\dots\\end{aligned}",
                        "To approximate $\\sqrt{1.04}$, we substitute $x = 0.01$ into both the left-hand and right-hand sides of our expansion:\\begin{aligned}\\text{LHS} &= (1 + 4(0.01))^{1/2} \\cr &= \\sqrt{1.04}\\end{aligned}",
                        "Substitute $x = 0.01$ into our simplified binomial expansion:\\begin{aligned}\\text{RHS} &= 1 + 2(0.01) - 2(0.01)^2 \\cr &= 1 + 0.02 - 2(0.0001) \\cr &= 1 + 0.02 - 0.0002\\end{aligned}",
                        "Evaluate the arithmetic expression:\\begin{aligned}\\text{RHS} &= 1.02 - 0.0002 \\cr &= 1.0198\\end{aligned}",
                        "Write the final answer correct to $5$ decimal places:\\begin{aligned}\\sqrt{1.04} &\\approx 1.01980\\end{aligned}",
                        "Final Answer:\\begin{aligned}&1 + 2x - 2x^2 \\cr &1.01980\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&1 + 2x + 2x^2 \\cr &1.02020\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&1 + 2x - 2x^2 \\cr &1.0198\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&1 + 2x - 8x^2 \\cr &1.01920\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Apply the binomial expansion formula for negative integer powers, $(1 + y)^{-2} = 1 - 2y + 3y^2 - 4y^3 + \\dots$ with $y = -3x$:\\begin{aligned}&(1 - 3x)^{-2} \\cr & \\quad = 1 - 2(-3x) \\cr & \\quad + 3(-3x)^2 - \\dots \\cr & \\quad = 1 + 6x + 27x^2 - \\dots\\end{aligned}",
                        "To find the coefficient of the rational expression, rewrite it as a product:\\begin{aligned}\\dfrac{2 + x}{(1 - 3x)^2} &= (2 + x)(1 - 3x)^{-2}\\end{aligned}",
                        "Substitute our binomial expansion into the product:\\begin{aligned}&\\approx (2 + x)(1 + 6x + 27x^2)\\end{aligned}",
                        "To find the coefficient of $x^2$, identify only the terms in the expansion that will result in an $x^2$ term after multiplying out the brackets:\\begin{aligned}\\text{Term } 1: 2 \\times 27x^2 &= 54x^2 \\cr \\text{Term } 2: x \\times 6x &= 6x^2\\end{aligned}",
                        "Sum these two components to find the total $x^2$ term:\\begin{aligned}\\text{Total } x^2 \\text{ term} &= 54x^2 + 6x^2 \\cr &= 60x^2\\end{aligned}<br><br>The coefficient of $x^2$ is indeed $60$.",
                        "Final Answer:\\begin{aligned}&1 + 6x + 27x^2 \\cr &60\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&1 - 6x + 27x^2 \\cr &48\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&1 + 6x + 27x^2 \\cr &54\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&1 + 6x + 9x^2 \\cr &24\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Apply the binomial expansion formula for negative fractional powers with $n = -\\dfrac{1}{2}$ and $y = -8x$:\\begin{aligned}&(1 - 8x)^{-1/2} \\cr & \\quad = 1 + (-\\dfrac{1}{2})(-8x) \\cr & \\quad + \\dfrac{(-\\dfrac{1}{2})(-\\dfrac{3}{2})}{2}(-8x)^2 + \\dots \\cr & \\quad = 1 + 4x + \\dfrac{3}{8}(64x^2) + \\dots \\cr & \\quad = 1 + 4x + 24x^2 + \\dots\\end{aligned}",
                        "To find the composite expansion, we first expand $(1 + 4x)^3$ fully using the standard binomial theorem:\\begin{aligned}&(1 + 4x)^3 \\cr &  = 1^3 + 3(1)^2(4x) + 3(1)(4x)^2 + (4x)^3 \\cr & = 1 + 12x + 48x^2 + 64x^3\\end{aligned}",
                        "Write the composite product as a multiplication of these two expansion series up to the $x^2$ terms:\\begin{aligned}&\\text{Product} \\cr & \\approx (1 + 12x + 48x^2)(1 + 4x + 24x^2)\\end{aligned}",
                        "Identify the cross-multiplications that yield an $x^2$ term:\\begin{aligned}\\text{Term } 1: 1 \\times 24x^2 &= 24x^2 \\cr \\text{Term } 2: 12x \\times 4x &= 48x^2 \\cr \\text{Term } 3: 48x^2 \\times 1 &= 48x^2\\end{aligned}",
                        "Sum these three components to obtain the final coefficient of $x^2$:\\begin{aligned}\\text{Total } x^2 &\\text{ term} \\cr & \\quad = 24x^2 + 48x^2 + 48x^2 \\cr & \\quad = 120x^2\\end{aligned}<br><br>So the coefficient of $x^2$ is $120$.",
                        "Final Answer:\\begin{aligned}&1 + 4x + 24x^2 \\cr &120\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&1 + 4x + 24x^2 \\cr &72\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&1 + 4x + 16x^2 \\cr &104\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&1 + 4x + 24x^2 \\cr &144\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The function $f$ is defined for all real values of $x$ as $f(x) = c + 6x - x^2$, where $c$ is a constant.<br><br>1. Given that the range of $f$ is $f(x) \\le 14$, find the value of $c$.<br><br>2. Given instead that $ff(3) = 3$, find the possible values of $c$.",
                "steps": [
                ...
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}c &= 8 \\cr c &= -5 \\quad \\text{or} \\quad c = -6\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}c &= 5 \\cr c &= 5 \\quad \\text{or} \\quad c = 6\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}c &= 5 \\cr c &= -5\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "A curve has parametric equations $x = t + \\dfrac{4}{t}$ and $y = t - \\dfrac{4}{t}$, for $t \\ne 0$.<br><br>1. Find $\\dfrac{\\text{d}y}{\\text{d}x}$ in terms of $t$, giving your answer in its simplest form.<br><br>2. Explain why the curve has no stationary points.<br><br>3. By considering $x + y$, or otherwise, find a cartesian equation of the curve, giving your answer in a form not involving fractions or brackets.",
                "steps": [
                        "To find the derivative $\\dfrac{\\text{d}y}{\\text{d}x}$, we first differentiate $x$ and $y$ with respect to the parameter $t$:\\begin{aligned}\\dfrac{\\text{d}x}{\\text{d}t} &= 1 - \\dfrac{4}{t^2} \\cr &= \\dfrac{t^2 - 4}{t^2}\\end{aligned}<br><br>\\begin{aligned}\\dfrac{\\text{d}y}{\\text{d}t} &= 1 + \\dfrac{4}{t^2} \\cr &= \\dfrac{t^2 + 4}{t^2}\\end{aligned}",
                        "Apply the parametric chain rule and simplify the compound fraction:\\begin{aligned}\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{\\dfrac{\\text{d}y}{\\text{d}t}}{\\dfrac{\\text{d}x}{\\text{d}t}} \\cr &= \\dfrac{\\dfrac{t^2 + 4}{t^2}}{\\dfrac{t^2 - 4}{t^2}} \\cr &= \\dfrac{t^2 + 4}{t^2 - 4}\\end{aligned}",
                        "Stationary points require the derivative $\\dfrac{\\text{d}y}{\\text{d}x} = 0$, which occurs when the numerator of the derivative is equal to zero:\\begin{aligned}t^2 + 4 &= 0 \\cr t^2 &= -4\\end{aligned}<br><br>Since the square of any real number must be non-negative ($t^2 \\ge 0$), the equation $t^2 = -4$ has no real solutions. Since $\\dfrac{\\text{d}y}{\\text{d}t}$ is never zero, the curve has no stationary points.",
                        "To eliminate the parameter $t$ and find the Cartesian equation, calculate $x + y$ and $x - y$:<br><br>For $x + y$:\\begin{aligned}x + y &= (t + \\dfrac{4}{t}) + (t - \\dfrac{4}{t}) \\cr &= 2t \\cr t &= \\dfrac{x + y}{2}\\end{aligned}<br><br>For $x - y$:\\begin{aligned}x - y &= (t + \\dfrac{4}{t}) - (t - \\dfrac{4}{t}) \\cr &= \\dfrac{8}{t} \\cr t &= \\dfrac{8}{x - y}\\end{aligned}",
                        "Equate the two expressions for $t$ to eliminate the parameter:\\begin{aligned}\\dfrac{x + y}{2} &= \\dfrac{8}{x - y} \\cr (x + y)(x - y) &= 16 \\cr x^2 - y^2 &= 16\\end{aligned}",
                        "Final Answer:\\begin{aligned}&\\dfrac{t^2 + 4}{t^2 - 4} \\cr &\\text{no stationary points} \\cr &x^2 - y^2 = 16\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&\\dfrac{t^2 - 4}{t^2 + 4} \\cr &t = \\pm 2 \\implies \\text{two stationary points} \\cr &x^2 - y^2 = 16\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&\\dfrac{t^2 + 4}{t^2 - 4} \\cr &\\text{no stationary points} \\cr &x^2 - y^2 = 8\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&\\dfrac{t^2 + 4}{t^2 - 4} \\cr &\\text{no stationary points} \\cr &x^2 + y^2 = 16\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "A curve has parametric equations $x = 3\\cos\\theta$ and $y = 4\\sin\\theta$, for $0 \\le \\theta < 2\\pi$.<br><br>1. Find $\\dfrac{\\text{d}y}{\\text{d}x}$ in terms of $\\theta$.<br><br>2. Find the equation of the tangent to the curve at the point where $\\theta = \\dfrac{\\pi}{4}$. Give your answer in the form $ax + by = c$, where $a$, $b$, and $c$ are exact constants.<br><br>3. Eliminate $\\theta$ to find a cartesian equation of the curve.",
                "steps": [
                        "Differentiate the parametric equations $x = 3\\cos\\theta$ and $y = 4\\sin\\theta$ with respect to the parameter $\\theta$:\\begin{aligned}\\dfrac{\\text{d}x}{\\text{d}\\theta} &= -3\\sin\\theta \\cr \\dfrac{\\text{d}y}{\\text{d}\\theta} &= 4\\cos\\theta\\end{aligned}",
                        "Apply the parametric differentiation formula:\\begin{aligned}\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{\\dfrac{\\text{d}y}{\\text{d}\\theta}}{\\dfrac{\\text{d}x}{\\text{d}\\theta}} \\cr &= \\dfrac{4\\cos\\theta}{-3\\sin\\theta} \\cr &= -\\dfrac{4}{3}\\cot\\theta\\end{aligned}",
                        "To find the tangent at $\\theta = \\dfrac{\\pi}{4}$, first evaluate the coordinates of the point of contact:<br><br>For $x_1$:\\begin{aligned}x_1 &= 3\\cos(\\dfrac{\\pi}{4}) \\cr &= \\dfrac{3\\sqrt{2}}{2}\\end{aligned}<br><br>For $y_1$:\\begin{aligned}y_1 &= 4\\sin(\\dfrac{\\pi}{4}) \\cr &= 4(\\dfrac{\\sqrt{2}}{2}) \\cr &= 2\\sqrt{2}\\end{aligned}",
                        "Evaluate the gradient of the tangent at $\\theta = \\dfrac{\\pi}{4}$:\\begin{aligned}m &= -\\dfrac{4}{3}\\cot(\\dfrac{\\pi}{4}) \\cr &= -\\dfrac{4}{3}(1) \\cr &= -\\dfrac{4}{3}\\end{aligned}",
                        "Write the equation of the tangent line passing through $(\\dfrac{3\\sqrt{2}}{2}, \\, 2\\sqrt{2})$ using the point-slope formula:\\begin{aligned}y - 2\\sqrt{2} &= -\\dfrac{4}{3}(x - \\dfrac{3\\sqrt{2}}{2})\\end{aligned}",
                        "Multiply by $3$ and collect terms to rearrange into the form $ax + by = c$:\\begin{aligned}3(y - 2\\sqrt{2}) &= -4(x - \\dfrac{3\\sqrt{2}}{2}) \\cr 3y - 6\\sqrt{2} &= -4x + 6\\sqrt{2} \\cr 4x + 3y &= 12\\sqrt{2}\\end{aligned}",
                        "To find the Cartesian equation, rearrange the parametric equations to isolate the trigonometric functions:\\begin{aligned}\\cos\\theta &= \\dfrac{x}{3} \\cr \\sin\\theta &= \\dfrac{y}{4}\\end{aligned}<br><br>Substitute these into the fundamental Pythagorean identity $\\sin^2\\theta + \\cos^2\\theta = 1$:\\begin{aligned}(\\dfrac{x}{3})^2 + (\\dfrac{y}{4})^2 &= 1 \\cr \\dfrac{x^2}{9} + \\dfrac{y^2}{16} &= 1\\end{aligned}",
                        "Final Answer:\\begin{aligned}&-\\dfrac{4}{3}\\cot\\theta \\cr &4x + 3y = 12\\sqrt{2} \\cr &\\dfrac{x^2}{9} + \\dfrac{y^2}{16} = 1\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&-\\dfrac{4}{3}\\cot\\theta \\cr &4x + 3y = 12\\sqrt{2} \\cr &\\dfrac{x^2}{3} + \\dfrac{y^2}{4} = 1\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&-\\dfrac{3}{4}\\tan\\theta \\cr &3x + 4y = 12\\sqrt{2} \\cr &\\dfrac{x^2}{9} + \\dfrac{y^2}{16} = 1\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&-\\dfrac{4}{3}\\cot\\theta \\cr &4x - 3y = 0 \\cr &\\dfrac{x^2}{9} + \\dfrac{y^2}{16} = 1\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "A curve has parametric equations $x = e^t + 2$ and $y = e^{2t} - 3$ for all real $t$.<br><br>1. Find $\\dfrac{\\text{d}y}{\\text{d}x}$ in terms of $t$.<br><br>2. Show that the curve has no stationary points.<br><br>3. By eliminating $t$, find the cartesian equation of the curve in the form $y = f(x)$, stating its domain.",
                "steps": [
                        "Differentiate the parametric equations $x = e^t + 2$ and $y = e^{2t} - 3$ with respect to the parameter $t$:\\begin{aligned}\\dfrac{\\text{d}x}{\\text{d}t} &= e^t \\cr \\dfrac{\\text{d}y}{\\text{d}t} &= 2e^{2t}\\end{aligned}",
                        "Apply the parametric chain rule formula:\\begin{aligned}\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{\\dfrac{\\text{d}y}{\\text{d}t}}{\\dfrac{\\text{d}x}{\\text{d}t}} \\cr &= \\dfrac{2e^{2t}}{e^t} \\cr &= 2e^t\\end{aligned}",
                        "For a stationary point, we require $\\dfrac{\\text{d}y}{\\text{d}x} = 0$, which implies:\\begin{aligned}2e^t &= 0\\end{aligned}<br><br>The exponential function $e^t$ is strictly positive for all real values of $t$ ($e^t > 0$). Therefore, the derivative $2e^t$ can never equal zero, meaning the curve has no stationary points.",
                        "To find the Cartesian equation, isolate $e^t$ in the equation for $x$:\\begin{aligned}x &= e^t + 2 \\cr e^t &= x - 2\\end{aligned}",
                        "Substitute $e^t = x - 2$ into the parametric equation for $y$ using the identity $e^{2t} = (e^t)^2$:\\begin{aligned}y &= (e^t)^2 - 3 \\cr y &= (x - 2)^2 - 3\\end{aligned}",
                        "To state the domain of our Cartesian equation, consider the range of $x$ in terms of the parameter $t$. Since $e^t > 0$ for all real $t$, we have:\\begin{aligned}x &= e^t + 2 \\cr &> 2 \\cr x &> 2\\end{aligned}",
                        "Final Answer:\\begin{aligned}&2e^t \\cr &\\text{no stationary points} \\cr &y = (x - 2)^2 - 3 \\quad \\text{for} \\quad x > 2\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&2e^t \\cr &\\text{no stationary points} \\cr &y = (x - 2)^2 - 3 \\quad \\text{for all } x\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&2e^{2t} \\cr &\\text{no stationary points} \\cr &y = (x - 2)^2 - 3 \\quad \\text{for } x > 2\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&2e^t \\cr &\\text{no stationary points} \\cr &y = x^2 - 7 \\quad \\text{for } x > 2\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "A curve has parametric equations $x = t^2$ and $y = t^3 - 3t$ for all real $t$.<br><br>1. Find the coordinates of the points where the curve meets the coordinate axes.<br><br>2. Find $\\dfrac{\\text{d}y}{\\text{d}x}$ in terms of $t$.<br><br>3. Show that there are exactly two stationary points on the curve, and find their coordinates.",
                "steps": [
                        "To find where the curve meets the axes, we analyze the conditions $x=0$ and $y=0$ separately:<br><br>For $x = 0 \\implies t^2 = 0 \\implies t = 0$. Substituting $t=0$ into $y$ gives $y = 0^3 - 3(0) = 0$, giving the origin $(0, 0)$.",
                        "For the $y$-intercepts, set $y = 0$:\\begin{aligned}t^3 - 3t &= 0 \\cr t(t^2 - 3) &= 0\\end{aligned}<br><br>This yields three solutions for $t$:<br><br>For $t = 0$:\\begin{aligned}x &= 0^2 = 0 \\implies (0, 0)\\end{aligned}<br><br>For $t = \\sqrt{3}$:\\begin{aligned}x &= (\\sqrt{3})^2 = 3 \\implies (3, 0)\\end{aligned}<br><br>For $t = -\\sqrt{3}$:\\begin{aligned}x &= (-\\sqrt{3})^2 = 3 \\implies (3, 0)\\end{aligned}<br><br>So the curve meets the axes at the distinct points $(0, 0)$ and $(3, 0)$.",
                        "Differentiate the parametric equations with respect to the parameter $t$:\\begin{aligned}\\dfrac{\\text{d}x}{\\text{d}t} &= 2t \\cr \\dfrac{\\text{d}y}{\\text{d}t} &= 3t^2 - 3\\end{aligned}",
                        "Apply the parametric chain rule to find $\\dfrac{\\text{d}y}{\\text{d}x}$:\\begin{aligned}\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{\\dfrac{\\text{d}y}{\\text{d}t}}{\\dfrac{\\text{d}x}{\\text{d}t}} \\cr &= \\dfrac{3t^2 - 3}{2t}\\end{aligned}",
                        "Stationary points occur when the derivative $\\dfrac{\\text{d}y}{\\text{d}x} = 0$, which requires the numerator to be zero (where the denominator is non-zero):\\begin{aligned}3t^2 - 3 &= 0 \\cr t^2 &= 1 \\cr t &= \\pm 1\\end{aligned}",
                        "Find the Cartesian coordinates corresponding to these two parameter values:<br><br>For $t = 1$:\\begin{aligned}x &= 1^2 = 1 \\cr y &= 1^3 - 3(1) \\cr &= -2 \\implies (1, -2)\\end{aligned}<br><br>For $t = -1$:\\begin{aligned}x &= (-1)^2 = 1 \\cr y &= (-1)^3 - 3(-1) \\cr &= 2 \\implies (1, 2)\\end{aligned}<br><br>This confirms there are exactly two stationary points on the curve: $(1, -2)$ and $(1, 2)$.",
                        "Final Answer:\\begin{aligned}&(0,0) \\text{ and } (3,0) \\cr &\\dfrac{3t^2 - 3}{2t} \\cr &(1, -2) \\text{ and } (1, 2)\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&(0,0) \\text{ and } (3,0) \\cr &\\dfrac{3t^2 - 3}{2t} \\cr &(1, -2)\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(0,0) \\text{ and } (\\sqrt{3},0) \\cr &\\dfrac{3t^2 - 3}{2t} \\cr &(1, -2) \\text{ and } (1, 2)\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&(0,0) \\text{ and } (3,0) \\cr &\\dfrac{3t^2 - 3}{2} \\cr &(1, -2) \\text{ and } (1, 2)\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "A curve has parametric equations $x = 2t + \\dfrac{1}{t}$ and $y = 2t - \\dfrac{1}{t}$ for $t \\ne 0$.<br><br>1. Find $\\dfrac{\\text{d}y}{\\text{d}x}$ in terms of $t$, simplifying your answer as far as possible.<br><br>2. Show that the curve has no stationary points.<br><br>3. By eliminating $t$, find the cartesian equation of the curve in a form not involving fractions or brackets.",
                "steps": [
                        "Differentiate $x$ and $y$ with respect to the parameter $t$:\\begin{aligned}\\dfrac{\\text{d}x}{\\text{d}t} &= 2 - \\dfrac{1}{t^2} \\cr &= \\dfrac{2t^2 - 1}{t^2}\\end{aligned}<br><br>\\begin{aligned}\\dfrac{\\text{d}y}{\\text{d}t} &= 2 + \\dfrac{1}{t^2} \\cr &= \\dfrac{2t^2 + 1}{t^2}\\end{aligned}",
                        "Apply the parametric differentiation rule and simplify:\\begin{aligned}\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{\\dfrac{\\text{d}y}{\\text{d}t}}{\\dfrac{\\text{d}x}{\\text{d}t}} \\cr &= \\dfrac{\\dfrac{2t^2 + 1}{t^2}}{\\dfrac{2t^2 - 1}{t^2}} \\cr &= \\dfrac{2t^2 + 1}{2t^2 - 1}\\end{aligned}",
                        "Stationary points require $\\dfrac{\\text{d}y}{\\text{d}x} = 0$, which occurs when the numerator is zero:\\begin{aligned}2t^2 + 1 &= 0 \\cr t^2 &= -0.5\\end{aligned}<br><br>Since $t^2 \\ge 0$ for all real values of $t$, the equation $t^2 = -0.5$ has no real solutions. Thus, the derivative can never be zero, and there are no stationary points.",
                        "To find the Cartesian equation, eliminate the parameter $t$ by evaluating the linear combinations $x + y$ and $x - y$:<br><br>For $x + y$:\\begin{aligned}x + y &= (2t + \\dfrac{1}{t}) + (2t - \\dfrac{1}{t}) \\cr &= 4t \\cr t &= \\dfrac{x + y}{4}\\end{aligned}<br><br>For $x - y$:\\begin{aligned}x - y &= (2t + \\dfrac{1}{t}) - (2t - \\dfrac{1}{t}) \\cr &= \\dfrac{2}{t} \\cr t &= \\dfrac{2}{x - y}\\end{aligned}",
                        "Equate these two expressions for $t$ to eliminate the parameter:\\begin{aligned}\\dfrac{x + y}{4} &= \\dfrac{2}{x - y} \\cr (x + y)(x - y) &= 8 \\cr x^2 - y^2 &= 8\\end{aligned}",
                        "Final Answer:\\begin{aligned}&\\dfrac{2t^2 + 1}{2t^2 - 1} \\cr &\\text{no stationary points} \\cr &x^2 - y^2 = 8\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&\\dfrac{2t^2 + 1}{2t^2 - 1} \\cr &\\text{no stationary points} \\cr &x^2 - y^2 = 4\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&\\dfrac{2t^2 - 1}{2t^2 + 1} \\cr &t = \\pm \\dfrac{1}{\\sqrt{2}}\\cr & \\implies \\text{two stationary points} \\cr &x^2 - y^2 = 8\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&\\dfrac{2t^2 + 1}{2t^2 - 1} \\cr &\\text{no stationary points} \\cr &x^2 + y^2 = 8\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Set $M = 100$ and solve for $t$ using natural logarithms:\\begin{aligned}200e^{-0.04t} &= 100 \\cr e^{-0.04t} &= 0.5 \\cr -0.04t &= \\ln(0.5) \\cr &= -\\ln(2) \\cr t &= \\dfrac{\\ln(2)}{0.04} \\cr &= 25\\ln(2) \\cr &\\approx 17.3\\text{ minutes}\\end{aligned}",
                        "For the second substance, its mass $N$ at time $t$ can be modelled by $N = 500e^{-kt}$, where $k$ is the positive decay constant. Since $N = 400$ at $t = 10$:\\begin{aligned}400 &= 500e^{-10k} \\cr e^{-10k} &= 0.8 \\cr -10k &= \\ln(0.8) \\cr k &= -0.1\\ln(0.8) \\cr &= 0.1\\ln(1.25) \\cr &\\approx 0.022314\\end{aligned}",
                        "To find when both substances are decaying at the same rate, find the derivatives $\\dfrac{\\text{d}M}{\\text{d}t}$ and $\\dfrac{\\text{d}N}{\\text{d}t}$:<br><br>For $\\dfrac{\\text{d}M}{\\text{d}t}$:\\begin{aligned}\\dfrac{\\text{d}M}{\\text{d}t} &= 200(-0.04)e^{-0.04t} \\cr &= -8e^{-0.04t}\\end{aligned}<br><br>For $\\dfrac{\\text{d}N}{\\text{d}t}$:\\begin{aligned}\\dfrac{\\text{d}N}{\\text{d}t} &= 500(-k)e^{-kt} \\cr &= -500ke^{-kt}\\end{aligned}",
                        "Equate the rates of decay (the positive magnitudes of the derivatives) and substitute $k \\approx 0.022314$:\\begin{aligned}8e^{-0.04t} &= 500(0.022314)e^{-0.022314t} \\cr &= 11.157e^{-0.022314t}\\end{aligned}",
                        "Rearrange to solve for $t$:\\begin{aligned}\\dfrac{e^{-0.022314t}}{e^{-0.04t}} &= \\dfrac{8}{11.157} \\cr e^{0.017686t} &= 0.71704 \\cr 0.017686t &= \\ln(0.71704) \\cr &\\approx -0.33266 \\cr t &= \\dfrac{-0.33266}{-0.017686} \\cr &\\approx 18.8\\text{ minutes}\\end{aligned}",
                        "Final Answer:\\begin{aligned}&17.3\\text{ minutes} \\cr &18.8\\text{ minutes}\\end{aligned}"
                ],
                "pi_options": [
                        {
                        ...
                        {
                                "ans": "\\begin{aligned}&8.66\\text{ minutes} \\cr &18.8\\text{ minutes}\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "A cup of coffee is cooling in a room with a constant temperature of $20^\\circ\\text{C}$. The temperature, $\\theta^\\circ\\text{C}$, of the coffee at time $t$ minutes is modelled by the equation:\\begin{aligned}\\theta &= 20 + 65e^{-0.08t}\\end{aligned}<br><br>1. Write down the initial temperature of the coffee.<br><br>2. Find the time taken for the temperature of the coffee to fall to $50^\\circ\\text{C}$, giving your answer correct to 3 significant figures.<br><br>3. Differentiate the equation to find the rate of change of temperature, $\\dfrac{\\text{d}\\theta}{\\text{d}t}$, at the instant when $t = 15$ minutes, giving your answer to 3 significant figures.",
                "steps": [
                        "To find the initial temperature, substitute $t = 0$ into the temperature equation:\\begin{aligned}\\theta &= 20 + 65e^{-0.08(0)} \\cr &= 20 + 65e^0 \\cr &= 20 + 65(1) \\cr &= 85^\\circ\\text{C}\\end{aligned}",
                        "To find the time taken to cool to $50^\\circ\\text{C}$, set $\\theta = 50$ and solve for $t$:\\begin{aligned}50 &= 20 + 65e^{-0.08t} \\cr 30 &= 65e^{-0.08t}\\end{aligned}",
                        "Isolate the exponential term and take natural logarithms:\\begin{aligned}e^{-0.08t} &= \\dfrac{30}{65} \\cr &\\approx 0.461538 \\cr -0.08t &= \\ln(0.461538) \\cr &\\approx -0.773190\\end{aligned}",
                        "Solve for $t$:\\begin{aligned}t &= \\dfrac{-0.773190}{-0.08} \\cr &\\approx 9.6648\\end{aligned}<br><br>Rounding to 3 significant figures gives $9.66$ minutes.",
                        "To find the rate of change of temperature, differentiate $\\theta$ with respect to $t$ using the chain rule:\\begin{aligned}\\dfrac{\\text{d}\\theta}{\\text{d}t} &= 65(-0.08)e^{-0.08t} \\cr &= -5.2e^{-0.08t}\\end{aligned}",
                        "Substitute $t = 15$ into the derivative expression to find the rate at that instant:\\begin{aligned}\\dfrac{\\text{d}\\theta}{\\text{d}t} &= -5.2e^{-0.08(15)} \\cr &= -5.2e^{-1.2} \\cr &\\approx -5.2(0.301194) \\cr &\\approx -1.57^\\circ\\text{C per minute}\\end{aligned}",
                        "Final Answer:\\begin{aligned}&85^\\circ\\text{C} \\cr &9.66\\text{ minutes} \\cr &-1.57^\\circ\\text{C per minute}\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&65^\\circ\\text{C} \\cr &9.66\\text{ minutes} \\cr &-1.57^\\circ\\text{C per minute}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&85^\\circ\\text{C} \\cr &14.1\\text{ minutes} \\cr &-1.57^\\circ\\text{C per minute}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&85^\\circ\\text{C} \\cr &9.66\\text{ minutes} \\cr &-5.2^\\circ\\text{C per minute}\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The population of a species of bacteria, $P$, in a laboratory culture at time $t$ hours is modelled by the equation:\\begin{aligned}P &= 800e^{0.15t}\\end{aligned}<br><br>1. State the initial population of the bacteria.<br><br>2. Find the time taken for the population of the bacteria to double, giving your answer correct to 3 significant figures.<br><br>3. Find the rate of change of the population at the instant when $t = 4$ hours, giving your answer to the nearest integer.",
                "steps": [
                        "To find the initial population, substitute $t = 0$ into the population model:\\begin{aligned}P &= 800e^{0.15(0)} \\cr &= 800e^0 \\cr &= 800\\end{aligned}",
                        "To find the doubling time, we set the population $P$ equal to double the initial value ($2 \\times 800 = 1600$) and solve for $t$:\\begin{aligned}1600 &= 800e^{0.15t} \\cr e^{0.15t} &= 2\\end{aligned}",
                        "Take the natural logarithm of both sides to isolate $t$:\\begin{aligned}0.15t &= \\ln(2) \\cr &\\approx 0.693147 \\cr t &= \\dfrac{\\ln(2)}{0.15} \\cr &\\approx 4.6209\\text{ hours}\\end{aligned}<br><br>Rounding to 3 significant figures gives $4.62$ hours.",
                        "To find the rate of change of the population, differentiate $P$ with respect to $t$ using the chain rule:\\begin{aligned}\\dfrac{\\text{d}P}{\\text{d}t} &= 800(0.15)e^{0.15t} \\cr &= 120e^{0.15t}\\end{aligned}",
                        "Substitute $t = 4$ into the derivative expression to find the rate at that instant:\\begin{aligned}\\dfrac{\\text{d}P}{\\text{d}t} &= 120e^{0.15(4)} \\cr &= 120e^{0.6} \\cr &\\approx 120(1.822118) \\cr &\\approx 218.65\\end{aligned}<br><br>Rounding to the nearest integer gives $219$ bacteria per hour.",
                        "Final Answer:\\begin{aligned}&800 \\cr &4.62\\text{ hours} \\cr &219\\text{ bacteria per hour}\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&800 \\cr &4.62\\text{ hours} \\cr &120\\text{ bacteria per hour}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&800 \\cr &9.24\\text{ hours} \\cr &219\\text{ bacteria per hour}\\end{aligned}",
                                "feedback": "Check your doubling equation. Setting $e^{0.15t} = 2$ means $0.15t = \\ln\\left(2\\right)$, not $0.15t = 2\\ln\\left(2\\right)$."
                        },
                        {
                                "ans": "\\begin{aligned}&800 \\cr &4.62\\text{ hours} \\cr &1458\\text{ bacteria per hour}\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The concentration of a drug in a patient's bloodstream, $C\\text{ mg/L}$, at time $t$ hours after injection is modelled by the equation:\\begin{aligned}C &= 50e^{-0.25t} \\quad \\text{for} \\quad t \\ge 0\\end{aligned}<br><br>1. Find the time at which the concentration has decreased to $10\\%$ of its initial value, giving your answer correct to 3 significant figures.<br><br>2. Differentiate the equation to find the rate of change of concentration, $\\dfrac{\\text{d}C}{\\text{d}t}$, and calculate the magnitude of this rate when $t = 4$ hours, giving your answer correct to 3 significant figures.",
                "steps": [
                        ...
                        "Set $C = 5$ and solve for $t$ using natural logarithms:\\begin{aligned}5 &= 50e^{-0.25t} \\cr e^{-0.25t} &= 0.1 \\cr -0.25t &= \\ln(0.1) \\cr &= -\\ln(10) \\cr t &= \\dfrac{\\ln(10)}{0.25} \\cr &= 4\\ln(10) \\cr &\\approx 9.2103\\text{ hours}\\end{aligned}<br><br>Rounding to 3 significant figures gives $9.21$ hours.",
                        "To find the rate of change of concentration, differentiate $C$ with respect to $t$ using the chain rule:\\begin{aligned}\\dfrac{\\text{d}C}{\\text{d}t} &= 50(-0.25)e^{-0.25t} \\cr &= -12.5e^{-0.25t}\\end{aligned}",
                        "Evaluate this derivative at the instant when $t = 4$ hours:\\begin{aligned}\\dfrac{\\text{d}C}{\\text{d}t} &= -12.5e^{-0.25(4)} \\cr &= -12.5e^{-1} \\cr &\\approx -12.5(0.367879) \\cr &\\approx -4.5985\\text{ mg/L per hour}\\end{aligned}",
                        "The magnitude represents the absolute value (the positive rate of decrease):\\begin{aligned}\\text{Magnitude} &= |-4.5985| \\cr &\\approx 4.60\\text{ mg/L per hour}\\end{aligned}",
                        "Final Answer:\\begin{aligned}&9.21\\text{ hours} \\cr &4.60\\text{ mg/L per hour}\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&9.21\\text{ hours} \\cr &-4.60\\text{ mg/L per hour}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&4.00\\text{ hours} \\cr &4.60\\text{ mg/L per hour}\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&9.21\\text{ hours} \\cr &1.15\\text{ mg/L per hour}\\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "The populations of two different insects, $X$ and $Y$, in a controlled greenhouse are modelled by the equations:\\begin{aligned}X(t) &= 300e^{0.06t} \\cr Y(t) &= 100e^{0.10t}\\end{aligned}<br><br>where $t$ is the number of days after monitoring begins.<br><br>1. Differentiate both equations to find expressions for the rates of increase, $\\dfrac{\\text{d}X}{\\text{d}t}$ and $\\dfrac{\\text{d}Y}{\\text{d}t}$.<br><br>2. Find the exact time $t$ at which both populations are increasing at the same rate. Give your answer in the form $t = a\\ln b$, where $a$ is an integer and $b$ is a rational number.",
                "steps": [
                        "Differentiate $X(t)$ and $Y(t)$ with respect to $t$ using the chain rule:<br><br>For $\\dfrac{\\text{d}X}{\\text{d}t}$:\\begin{aligned}\\dfrac{\\text{d}X}{\\text{d}t} &= 300(0.06)e^{0.06t} \\cr &= 18e^{0.06t}\\end{aligned}<br><br>For $\\dfrac{\\text{d}Y}{\\text{d}t}$:\\begin{aligned}\\dfrac{\\text{d}Y}{\\text{d}t} &= 100(0.10)e^{0.10t} \\cr &= 10e^{0.10t}\\end{aligned}",
                        "Set these two rates of increase equal to each other to find when they are equal:\\begin{aligned}18e^{0.06t} &= 10e^{0.10t}\\end{aligned}",
                        "Isolate the exponential terms on one side of the equation:\\begin{aligned}\\dfrac{18}{10} &= \\dfrac{e^{0.10t}}{e^{0.06t}} \\cr \\dfrac{9}{5} &= e^{0.10t - 0.06t} \\cr e^{0.04t} &= \\dfrac{9}{5}\\end{aligned}",
                        "Take the natural logarithm of both sides to solve for $t$:\\begin{aligned}0.04t &= \\ln\\left(\\dfrac{9}{5}\\right)\\end{aligned}",
                        "Express the decimal coefficient $0.04$ as a fraction, $0.04 = \\dfrac{1}{25}$:\\begin{aligned}\\dfrac{1}{25}t &= \\ln\\left(\\dfrac{9}{5}\\right) \\cr t &= 25\\ln\\left(\\dfrac{9}{5}\\right)\\end{aligned}<br><br>This is exactly in the required form $a\\ln b$, where $a = 25$ is an integer and $b = \\dfrac{9}{5}$ is a rational number.",
                        "Final Answer:\\begin{aligned}&\\dfrac{\\text{d}X}{\\text{d}t} = 18e^{0.06t} \\cr &\\dfrac{\\text{d}Y}{\\text{d}t} = 10e^{0.10t} \\cr &t = 25\\ln\\left(\\dfrac{9}{5}\\right)\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned}&\\dfrac{\\text{d}X}{\\text{d}t} = 18e^{0.06t} \\cr &\\dfrac{\\text{d}Y}{\\text{d}t} = 10e^{0.10t} \\cr &t = 10\\ln\\left(\\dfrac{9}{5}\\right)\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&\\dfrac{\\text{d}X}{\\text{d}t} = 18e^{0.06t} \\cr &\\dfrac{\\text{d}Y}{\\text{d}t} = 10e^{0.10t} \\cr &t = 25\\ln(1.8)\\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned}&\\dfrac{\\text{d}X}{\\text{d}t} = 300e^{0.06t} \\cr &\\dfrac{\\text{d}Y}{\\text{d}t} = 100e^{0.10t} \\cr &t = 25\\ln(3)\\end{aligned}",
