window.ALEVEL_QUESTIONS = [
        ...
        },
  {
        ...
        },
        {
                ...
                "steps": [
                        "Apply the binomial expansion formula \\begin{aligned}(1 + y)^n &= 1 + ny + \\dfrac{n(n-1)}{2!}y^2 \\cr & \\quad + \\dots$ with $n = \\dfrac{1}{2}$ and $y = 4x$:\\begin{aligned}(1 + 4x)^{1/2} &= 1 + (\\dfrac{1}{2})(4x) \\cr & \\quad + \\dfrac{(\\dfrac{1}{2})(-\\dfrac{1}{2})}{2}(4x)^2 + \\dots\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "To find the composite expansion, we first expand $(1 + 4x)^3$ fully using the standard binomial theorem:\\begin{aligned}&(1 + 4x)^3 \\cr & \\quad = 1^3 + 3(1)^2(4x) + 3(1)(4x)^2 + (4x)^3 \\cr & \\quad = 1 + 12x + 48x^2 + 64x^3\\end{aligned}",
                        "Write the composite product as a multiplication of these two expansion series up to the $x^2$ terms:\\begin{aligned}&\\text{Product} \\cr & \\quad \\approx (1 + 12x + 48x^2)(1 + 4x + 24x^2)\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Substitute $e^t = x - 2$ into the parametric equation for $y$ using the identity $e^{2t} = \\left(e^t\\right)^2$:<br>\\begin{aligned}y &= \\left(e^t\\right)^2 - 3 \\cr y &= \\left(x - 2\\right)^2 - 3\\end{aligned}",
