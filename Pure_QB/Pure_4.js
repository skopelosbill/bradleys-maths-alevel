window.ALEVEL_QUESTIONS = [
        ...
        },
  {
                ...
                "steps": [
                        ...
                        "To sketch the graph of the quartic $y = g(x)$, determine the axes intercepts:<br><br>The $x$-intercepts occur where $g(x) &= 0 \\cr & \\implies x = 2$ (repeated root), \\cr $x &= 3$, and $x = -3$, These are the points $(2, 0)$, $(3, 0)$, and $(-3, 0)$.<br><br>The $y$-intercept occurs where begin{aligned}x &= 0 \\cr & \\implies g(0) = (-2)^2(0^2 - 9) \\cr & = 4(-9) \\cr &= -36$. This is the point $(0, -36)$.<br><br>Since the leading coefficient of $x^4$ is positive ($+1$), the curve is positive on both ends (heads up to the far-left and far-right). It touches the axis and turns around at $(2, 0)$:<br><br><img src='images/Pure_SVGs/004171_ans.svg' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
