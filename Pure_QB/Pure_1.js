        ...
        },
       {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Case B: For $x < 6$</strong>, the term inside the absolute value is negative, so \\begin{aligned}|2x - 12| &= -(2x - 12) \\cr &= 12 - 2x\\end{aligned}. Our inequality becomes:\\begin{aligned}12 - 2x &\\ge x - 5\\cr \\implies 17 &\\ge 3x \\cr \\implies x &\\le 5.67$$<br>This means the inequality is true for $x \\le 5.67$ and $x \\ge 7$, but fails in the gap $5.67 < x < 7$.",
