        ...
        },
       {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Case A: For $x \\ge 6$</strong>, the term inside the absolute value is positive, so $|2x - 12| = 2x - 12\\end{aligned}. Our inequality becomes:\\begin{aligned}2x - 12 &\\ge x - 5 \\cr\\implies x &\\ge 7\\end{aligned}<br>This means that in the interval $6 \\le x < 7$, the inequality is <strong>false</strong> (for example, at $x = 6$, we get $0 \\ge 1$, which is false).",
                        "<strong>Case B: For $x < 6$</strong>, the term inside the absolute value is negative, so \\begin{aligned}|2x - 12| &= -(2x - 12) \\cr &= 12 - 2x\\. Our inequality becomes:\\begin{aligned}12 - 2x &\\ge x - 5\\cr \\implies 17 &\\ge 3x \\cr \\implies x &\\le 5.67$$<br>This means the inequality is true for $x \\le 5.67$ and $x \\ge 7$, but fails in the gap $5.67 < x < 7$.",
