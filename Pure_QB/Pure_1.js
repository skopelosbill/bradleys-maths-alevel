        ...
        },
       {
        ...
        "bradley_insight": {
...
},
           {
                ...
                "steps": [
                        "<strong>Part (a):</strong> Rewrite f(x) in binomial form by factorising the constant inside the square root:<br>\\begin{aligned}f(x) &= (9 - 2x)^{ -1/2 } \\cr&= \\left[9\\left(1 - \\tfrac{2}{9}x\\right)\\right]^{ -1/2 } \\cr&= 9^{ -1/2 }\\left(1 - \\tfrac{2}{9}x\\right)^{ -1/2 } \\cr&= \\tfrac{1}{3}\\left(1 - \\tfrac{2}{9}x\\right)^{ -1/2 }.\\end{aligned}",
                        ...
                        "<strong>Part (b)(ii):</strong> To approximate $\\sqrt{3}$, we need \\begin{aligned}f(x) &= \\dfrac{1}{ \\sqrt{9 - 2x }} \\cr&= \\dfrac{1}{\\sqrt{3}}.\\end{aligned} This occurs when $9 - 2x = 3$, so $2x = 6$ and $x = 3$. Thus $x = 3$ is the value that leads to an approximation of $\\sqrt{3}$.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> Factorise the constant from the bracket:<br>\\begin{aligned}g(x) &= (5 - x)^{ -1/2 } \\cr&= \\left[5\\left(1 - \\tfrac{1}{5}x\\right)\\right]^{ -1/2 } \\cr&= 5^{ -1/2 }\\left(1 - \\tfrac{1}{5}x\\right)^{ -1/2 } \\cr&= \\dfrac{1}{\\sqrt{5}}\\left(1 - \\tfrac{1}{5}x\\right)^{ -1/2 }.\\end{aligned}",
                        ...
                        "<strong>Part (b)(ii):</strong> To approximate $\\dfrac{1}{\\sqrt{5.2}}$, we need \\begin{aligned}g(x) &= \\dfrac{1}{ \\sqrt{5 - x }} \\cr&= \\dfrac{1}{\\sqrt{5.2}}.\\end{aligned} This occurs when $5 - x = 5.2$, so $x = -0.2$. Also, |-0.2| is small, so the series converges rapidly. Thus $x = -0.2$ gives the most accurate approximation.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> Rewrite h(x) in binomial form by factorising the constant:<br>\\begin{aligned}h(x) &= (3 + x)^{ -1/2 } \\cr&= \\left[3\\left(1 + \\tfrac{1}{3}x\\right)\\right]^{ -1/2 } \\cr&= 3^{ -1/2 }\\left(1 + \\tfrac{1}{3}x\\right)^{ -1/2 } \\cr&= \\dfrac{1}{\\sqrt{3}}\\left(1 + \\tfrac{1}{3}x\\right)^{ -1/2 }.\\end{aligned}",
                        ...
                        "<strong>Part (b)(ii):</strong> To approximate $\\dfrac{1}{\\sqrt{2.7}}$, we need \\begin{aligned}h(x) &= \\dfrac{1}{ \\sqrt{3 + x }} \\cr&= \\dfrac{1}{\\sqrt{2.7}}.\\end{aligned} This occurs when $3 + x = 2.7$, so $x = -0.3$. Also, |-0.3| is small, so the series converges quickly. Therefore, $x = -0.3$ gives the most accurate approximation.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> Factorise the constant from the bracket:<br>\\begin{aligned}y &= (4 + 3x)^{ -1/2 } \\cr&= \\left[4\\left(1 + \\tfrac{3}{4}x\\right)\\right]^{ -1/2 } \\cr&= 4^{ -1/2 }\\left(1 + \\tfrac{3}{4}x\\right)^{ -1/2 } \\cr&= \\dfrac{1}{2}\\left(1 + \\tfrac{3}{4}x\\right)^{ -1/2 }.\\end{aligned}",
                        ...
                        "<strong>Part (b)(ii):</strong> To approximate $\\dfrac{1}{\\sqrt{3.1}}$, we need \\begin{aligned}y &= \\dfrac{1}{ \\sqrt{4 + 3x }} \\cr&= \\dfrac{1}{\\sqrt{3.1}}.\\end{aligned} This occurs when $4 + 3x = 3.1$, so $3x = -0.9$ and $x = -0.3$. Also, |-0.3| is smaller than |1|, so the series converges more rapidly. Thus $x = -0.3$ gives the most accurate approximation.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> Rewrite F(x) in binomial form by factorising the constant inside the square root:<br>\\begin{aligned}F(x) &= (16 - x)^{ -1/2 } \\cr&= \\left[16\\left(1 - \\tfrac{1}{16}x\\right)\\right]^{ -1/2 } \\cr&= 16^{ -1/2 }\\left(1 - \\tfrac{1}{16}x\\right)^{ -1/2 } \\cr&= \\dfrac{1}{4}\\left(1 - \\tfrac{1}{16}x\\right)^{ -1/2 }.\\end{aligned}",
                        ...
                        "<strong>Part (b)(ii):</strong> To approximate $\\dfrac{1}{\\sqrt{15.5}}$, we need \\begin{aligned}F(x) &= \\dfrac{1}{ \\sqrt{16 - x }} \\cr&= \\dfrac{1}{\\sqrt{15.5}}.\\end{aligned} This occurs when $16 - x = 15.5$, so $x = 0.5$. Also, |0.5| is smaller than |3|, so the series converges more rapidly. Thus $x = 0.5$ gives the most accurate approximation.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Part (c)(i):</strong> First, we expand and complete the square for g(x) to find its vertex:<br>$$g(x) = 3(x^2 - 4x + 4) + 6x - 7$$<br>\\begin{aligned}g(x) &= 3x^2 - 12x + 12 + 6x - 7 \\cr&= 3x^2 - 6x + 5\\end{aligned}<br>\\begin{aligned}g(x) &= 3(x^2 - 2x) + 5 \\cr&= 3\\left[(x-1)^2 - 1\\right] + 5\\end{aligned}<br>$$g(x) = 3(x-1)^2 + 2$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Part (c)(i):</strong> First, we expand and complete the square for g(x) to find its vertex:<br>$$g(x) = 2(x^2 - 6x + 9) + 8x - 15$$<br>\\begin{aligned}g(x) &= 2x^2 - 12x + 18 + 8x - 15 \\cr&= 2x^2 - 4x + 3\\end{aligned}<br>\\begin{aligned}g(x) &= 2(x^2 - 2x) + 3 \\cr&= 2\\left[(x-1)^2 - 1\\right] + 3\\end{aligned}<br>$$g(x) = 2(x-1)^2 + 1$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Part (c)(i):</strong> First, we expand and complete the square for g(x) to find its vertex:<br>$$g(x) = 4(x^2 - 6x + 9) + 8x - 19$$<br>\\begin{aligned}g(x) &= 4x^2 - 24x + 36 + 8x - 19 \\cr&= 4x^2 - 16x + 17\\end{aligned}<br>\\begin{aligned}g(x) &= 4(x^2 - 4x) + 17 \\cr&= 4\\left[(x-2)^2 - 4\\right] + 17\\end{aligned}<br>$$g(x) = 4(x-2)^2 - 16 + 17$$<br>$$g(x) = 4(x-2)^2 + 1$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Part (c)(i):</strong> First, we expand and complete the square for g(x) to find its vertex:<br>$$g(x) = 3(x^2 - 6x + 9) + 12x - 22$$<br>\\begin{aligned}g(x) &= 3x^2 - 18x + 27 + 12x - 22 \\cr&= 3x^2 - 6x + 5\\end{aligned}<br>\\begin{aligned}g(x) &= 3(x^2 - 2x) + 5 \\cr&= 3\\left[(x-1)^2 - 1\\right] + 5\\end{aligned}<br>$$g(x) = 3(x-1)^2 - 3 + 5$$<br>$$g(x) = 3(x-1)^2 + 2$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Part (c)(i):</strong> First, we expand and complete the square for g(x) to find its vertex:<br>$$g(x) = 2(x^2 - 6x + 9) + 4x - 9$$<br>\\begin{aligned}g(x) &= 2x^2 - 12x + 18 + 4x - 9 \\cr&= 2x^2 - 8x + 9\\end{aligned}<br>\\begin{aligned}g(x) &= 2(x^2 - 4x) + 9 \\cr&= 2\\left[(x-2)^2 - 4\\right] + 9\\end{aligned}<br>$$g(x) = 2(x-2)^2 - 8 + 9$$<br>$$g(x) = 2(x-2)^2 + 1$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Part (b):</strong> Note that $$2x + 20^\\circ = 2(x + 10^\\circ).$$ Let $$\\theta = x + 10^\\circ.$$ Then the equation becomes the same as in Part (a).<br>Thus the smallest positive solution is:<br>\\begin{aligned}x &= 61.0^\\circ - 10^\\circ \\cr&= 51.0^\\circ.\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Part (b):</strong> Note that $$2x - 40^\\circ = 2(x - 20^\\circ).$$ Let $$\\theta = x - 20^\\circ.$$<br>Smallest positive solution:<br>\\begin{aligned}x &= 24.4^\\circ + 20^\\circ \\cr&= 44.4^\\circ.\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Part (b):</strong> Note that $$2x + 60^\\circ = 2(x + 30^\\circ).$$ Let $$\\theta = x + 30^\\circ.$$<br>Smallest positive solution:<br>\\begin{aligned}x &= 163.7^\\circ - 30^\\circ \\cr&= 133.7^\\circ.\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> First, we expand the cubic equation to make it easy to integrate:<br>\\begin{aligned}y &= x(x+1)(x-2) \\cr&= x(x^2 - x - 2) \\cr&= x^3 - x^2 - 2x\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Evaluating this at the limits 0 and -1:\\begin{aligned} &\\text{Area } R_1\\cr & \\quad = 0 - \\bigg( \\frac{ (-1)^4 }{4} - \\frac{ 2(-1)^3 }{3}\\cr &\\qquad \\qquad- \\frac{ 3(-1)^2 }{2}\\bigg) \\cr & \\quad = - \\left( \\frac{1}{4} + \\frac{2}{3} - \\frac{3}{2} \\right) \\cr & \\quad = - \\left( -\\frac{7}{12} \\right) \\cr & \\quad = \\frac{7}{12}\\end{aligned}",
                        ...
                        "Final Answer: <strong>(a)</strong> $$\\text{Area } R_1 = \\dfrac{7}{12}$$ <strong>(b)</strong> $$(b+1)^2(3b^2 - 14b + 7) = 0 \\text{ verified}$$ <strong>(c)</strong> $$b \\approx 4.097 \\text{ signed area cancellation}$$"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> First, we expand the cubic equation to make it easy to integrate:<br>\\begin{aligned}y &= x(x+2)(x-3) \\cr&= x(x^2 - x - 6) \\cr&= x^3 - x^2 - 6x\\end{aligned}",
                        ...
                        "Evaluating this at the limits 0 and -2:<br>\\begin{aligned} & \\text{Area } R_1\\cr & \\quad  = 0 - \\bigg( \\frac{ (-2)^4 }{4} - \\frac{ (-2)^3 }{3}\\cr &\\qquad \\qquad - 3(-2)^2 \\bigg)\\cr & \\quad = - \\left( 4 + \\frac{8}{3} - 12 \\right) \\cr & \\quad = - \\left( -\\frac{16}{3} \\right) \\cr & \\quad = \\frac{16}{3}\\end{aligned}",
                        ...
                        "Final Answer: <strong>(a)</strong> $$\\text{Area } R_1 = \\dfrac{16}{3}$$ <strong>(b)</strong> $$(b+2)^2(3b^2 - 16b + 16) = 0 \\text{ verified}$$ <strong>(c)</strong> $$b = 4 \\text{ signed area cancellation}$$"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> First, we expand the cubic equation to make it easy to integrate:<br>\\begin{aligned}y &= x(x+3)(x-3) \\cr&= x(x^2 - 9) \\cr&= x^3 - 9x\\end{aligned}",
                        ...
                        "<strong>Part (b):</strong> Since $R_2$ lies entirely below the x-axis in the interval $0 < b < 3$, its area is given by the negative integral:\\begin{aligned}\\text{Area } R_2 &= -\\int_{0}^{b} (x^3 - 9x) \\text{ d}x \\cr & = -\\left[ \\frac{ x^4 }{4} - \\frac{ 9x^2 }{2} \\right]_{0}^{b}\\cr & = -\\left( \\frac{ b^4 }{4} - \\frac{ 9b^2 }{2} \\right)\\end{aligned}",
                        ...
                        "We can verify that this factorises to $(b+3)^2(b-3)^2 = 0$ (which is $(b^2 - 9)^2 = 0$) by expanding the brackets:<br>\\begin{aligned}(b^2 - 9)^2 &= (b^2)^2 - 2(9)(b^2) + 81 \\cr&= b^4 - 18b^2 + 81 \\cr&= 0 \\quad \\text{(verified)}\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> First, we expand the cubic equation to make it easy to integrate:<br>\\begin{aligned}y &= x(x+2)(x-5) \\cr&= x(x^2 - 3x - 10) \\cr&= x^3 - 3x^2 - 10x\\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Case 1: $n = 3k$ (multiples of 3)</strong><br>\\begin{aligned}n^2 + 1 &= (3k)^2 + 1 \\cr&= 9k^2 + 1 \\cr&= 3(3k^2) + 1\\end{aligned}<br>Since $3(3k^2)$ is divisible by 3, $n^2+1$ leaves a remainder of 1 when divided by 3, so it is not divisible.",
                        "<strong>Case 2: $n = 3k + 1$</strong><br>\\begin{aligned}n^2 + 1 &= (3k+1)^2 + 1 \\cr&= 9k^2 + 6k + 1 + 1 \\cr&= 3(3k^2 + 2k) + 2\\end{aligned}<br>This leaves a remainder of 2 when divided by 3, so it is not divisible.",
                        "<strong>Case 3: $n = 3k + 2$</strong><br>\\begin{aligned}n^2 + 1 &= (3k+2)^2 + 1 \\cr&= 9k^2 + 12k + 4 + 1 \\cr&= 9k^2 + 12k + 5 \\cr&= 3(3k^2 + 4k + 1) + 2\\end{aligned}<br>This also leaves a remainder of 2 when divided by 3, so it is not divisible.<br>Therefore, since all possible cases have been exhausted, $n^2 + 1$ is never divisible by 3 for any $n \\in \\mathbb{N}$.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Case 1: n is even ($n = 2k$)</strong>\\begin{aligned}n^2 + 1 &= (2k)^2 + 1 \\cr&= 4k^2 + 1 \\cr&= 4(k^2) + 1\\end{aligned}<br>Since $4(k^2)$ is divisible by 4, $n^2+1$ leaves a remainder of 1 when divided by 4, so it is not divisible.",
                        "<strong>Case 2: n is odd ($n = 2k + 1$)</strong><br>\\begin{aligned}n^2 + 1 &= (2k+1)^2 + 1 \\cr&= 4k^2 + 4k + 1 + 1 \\cr&= 4(k^2 + k) + 2\\end{aligned}<br>This leaves a remainder of 2 when divided by 4, so it is not divisible.<br>Therefore, since all possible cases have been exhausted, $n^2 + 1$ is never divisible by 4 for any $n \\in \\mathbb{N}$.",
                        ...
                        "<strong>Case A: For $x \\ge 4.67$</strong>, the term inside the absolute value is positive, so $|3x - 14| = 3x - 14$. Our inequality becomes:\\begin{aligned}3x - 14 &\\ge x - 4\\cr \\implies 2x & \\ge 10 \\cr\\implies x &\\ge 5\\end{aligned} This means that in the interval $4.67 \\le x < 5$, the inequality is <strong>false</strong> (for example, at $x = 4.8$, we get $0.4 \\ge 0.8$, which is false).",
                        "<strong>Case B: For $x < 4.67$</strong>, the term inside the absolute value is negative, so $|3x - 14| = 14 - 3x$. Our inequality becomes:\\begin{aligned}14 - 3x & \\ge x - 4 \\cr \\implies 18 &\\ge 4x \\cr \\implies x & \\le 4.5\\end{aligned}>This means the inequality is true for $x \\le 4.5$ and $x \\ge 5$, but fails in the gap $4.5 < x < 5$.",
                        ...
                        "Final Answer: <strong>(i)</strong> $$\\text{Proof by cases is completed}$$ <strong>(ii)</strong> $$\\text{Sometimes true}$$ $$\\text{fails in the interval } 4.5 < x < 5\\text{)}$$"
                ],
                "pi_options": [
                        {
                                "ans": "<strong>(i)</strong> $$\\text{Proof by cases is completed}$$ <strong>(ii)</strong> $$\\text{Always true}$$",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (i):</strong> We use <strong>proof by exhaustion</strong> by splitting the natural numbers into two cases: even numbers ($n = 2k$) and odd numbers ($n = 2k + 1$) for some non-negative integer k.",
                        "<strong>Case 1: n is even ($n = 2k$)</strong><br>\\begin{aligned}n^2 + 5 &= (2k)^2 + 5 \\cr&= 4k^2 + 5 \\cr&= 4(k^2 + 1) + 1\\end{aligned}<br>Since $4(k^2+1)$ is divisible by 4, $n^2+5$ leaves a remainder of 1 when divided by 4, so it is not divisible.",
                        "<strong>Case 2: n is odd ($n = 2k + 1$)</strong><br>\\begin{aligned}n^2 + 5 &= (2k+1)^2 + 5 \\cr&= 4k^2 + 4k + 1 + 5 \\cr&= 4k^2 + 4k + 6 \\cr&= 4(k^2 + k + 1) + 2\\end{aligned}<br>This leaves a remainder of 2 when divided by 4, so it is not divisible.<br>Therefore, since all possible cases have been exhausted, $n^2 + 5$ is never divisible by 4 for any $n \\in \\mathbb{N}$.",
                        ...
                        "<strong>Case B: For $x < 4$</strong>, the term inside the absolute value is negative, so $|2x - 8| = 8 - 2x$. Our inequality becomes:\\begin{aligned}8 - 2x & \\ge x - 3 \\cr \\implies 11 & \\ge 3x\\cr \\implies x & \\le 3.67\\end{aligned} This means the inequality is true for $x \\le 3.67$ and $x \\ge 5$, but fails in the gap $3.67 < x < 5$.",
                        ...
                        "Final Answer: <strong>(i)</strong> $$\\text{Proof by cases is completed}$$ <strong>(ii)</strong> $$\\text{Sometimes true}$$ $$\\text{(fails in the interval } 3.67 < x < 5\\text{)}$$"
                ],
                "pi_options": [
                        {
                        ...
                        {
                                "ans": "<strong>(a)</strong> $$\\text{Proof by counter example}$$ $$\\text{is completed}$$ <strong>(b)</strong> $$\\text{Sometimes true}$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Case 1: $n = 5k$ (multiples of 5)</strong><br>\\begin{aligned}n^2 + 2 &= (5k)^2 + 2 \\cr&= 25k^2 + 2 \\cr&= 5(5k^2) + 2\\end{aligned}<br>This leaves a remainder of 2 when divided by 5, so it is not divisible.",
                        "<strong>Case 2: $n = 5k \\pm 1$</strong><br>\\begin{aligned}n^2 + 2 &= (5k \\pm 1)^2 + 2 \\cr&= 25k^2 \\pm 10k + 1 + 2 \\cr&= 5(5k^2 \\pm 2k) + 3\\end{aligned}<br>This leaves a remainder of 3 when divided by 5, so it is not divisible.",
                        "<strong>Case 3: $n = 5k \\pm 2$</strong><br>\\begin{aligned}n^2 + 2 &= (5k \\pm 2)^2 + 2 \\cr&= 25k^2 \\pm 20k + 4 + 2 \\cr&= 25k^2 \\pm 20k + 6 \\cr&= 5(5k^2 \\pm 4k + 1) + 1\\end{aligned}<br>This leaves a remainder of 1 when divided by 5, so it is not divisible.<br>Therefore, since all possible cases have been exhausted, $n^2 + 2$ is never divisible by 5 for any $n \\in \\mathbb{N}$.",
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (i):</strong> We use <strong>proof by exhaustion</strong> by splitting the natural numbers into five cases based on their divisibility by 5. Any natural number n can be written as 5k, $5k \\pm 1$, or $5k \\pm 2$ for some non-negative integer k.",
                        "<strong>Case 1: $n = 5k$ (multiples of 5)</strong><br>\\begin{aligned}n^2 + 3 &= (5k)^2 + 3 \\cr&= 25k^2 + 3 \\cr&= 5(5k^2) + 3\\end{aligned}<br>This leaves a remainder of 3 when divided by 5, so it is not divisible.",
                        "<strong>Case 2: $n = 5k \\pm 1$</strong><br>\\begin{aligned}n^2 + 3 &= (5k \\pm 1)^2 + 3 \\cr&= 25k^2 \\pm 10k + 1 + 3 \\cr&= 5(5k^2 \\pm 2k) + 4\\end{aligned}<br>This leaves a remainder of 4 when divided by 5, so it is not divisible.",
                        "<strong>Case 3: $n = 5k \\pm 2$</strong><br>\\begin{aligned}n^2 + 3 &= (5k \\pm 2)^2 + 3 \\cr&= 25k^2 \\pm 20k + 4 + 3 \\cr&= 25k^2 \\pm 20k + 7 \\cr&= 5(5k^2 \\pm 4k + 1) + 2\\end{aligned}<br>This leaves a remainder of 2 when divided by 5, so it is not divisible.<br>Therefore, since all possible cases have been exhausted, $n^2 + 3$ is never divisible by 5 for any $n \\in \\mathbb{N}$.",
                        ...
                        "<strong>Case A: For $x \\ge 5.67$</strong>, the term inside the absolute value is positive, so $|3x - 17| = 3x - 17$. Our inequality becomes:\\begin{aligned}3x - 17 & \\ge x - 5 \\cr \\implies 2x & \\ge 12 \\cr \\implies x & \\ge 6\\end{aligned} This means that in the interval $5.67 \\le x < 6$, the inequality is <strong>false</strong> (for example, at $x = 5.8$, we get $0.4 \\ge 0.8$, which is false).",
                        "<strong>Case B: For $x < 5.67$</strong>, the term inside the absolute value is negative, so $|3x - 17| = 17 - 3x$. Our inequality becomes:\\begin{aligned}17 - 3x & \\ge x - 5 \\cr \\implies 22 & \\ge 4x \\cr \\implies x &\\le 5.5\\end{aligned} This means the inequality is true for $x \\le 5.5$ and $x \\ge 6$, but fails in the gap $5.5 < x < 6$.",
                        ...
                        "Final Answer: <strong>(i)</strong> $$\\text{Proof by cases is completed}$$ <strong>(ii)</strong> $$\\text{Sometimes true}$$ $$\\text{(fails in the interval } 5.5 < x < 6\\text{)}$$"
                ],
                "pi_options": [
                        {
                                "ans": "<strong>(a)</strong> $$\\text{Proof by cases is completed}$$ <strong>(b)</strong> $$\\text{Always true}$$",
