        ...
        },
       {
        ...
        "bradley_insight": {
...
},
           {
                ...
                "steps": [
                        ...
                        "Use the binomial expansion $(1 + y)^{ -1/2 } = 1 - \\tfrac{1}{2}y + \\tfrac{3}{8}y^2 + \\dots$ with y = -\\tfrac{2}{9}x$:<br>\\begin{aligned} \\left(1 - \\tfrac{2}{9}x\\right)^{-1/2} &= 1 - \\tfrac{1}{2}\\left(-\\tfrac{2}{9}x\\right) \\cr &\\quad + \\tfrac{3}{8}\\left(-\\tfrac{2}{9}x\\right)^2 + \\dots \\cr &= 1 + \\tfrac{1}{9}x + \\tfrac{1}{54}x^2 + \\dots \\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Use the binomial expansion $(1 + y)^{ -1/2 } = 1 - \\tfrac{1}{2}y + \\tfrac{3}{8}y^2 + \\dots$ with $y = -\\tfrac{1}{5}x$:<br>\\begin{aligned}\\left(1 - \\tfrac{1}{5}x\\right)^{ -1/2 }\\cr = 1 - \\tfrac{1}{2}\\left(-\\tfrac{1}{5}x\\right) + \\tfrac{3}{8}\\left(-\\tfrac{1}{5}x\\right)^2 + \\dots$$<br>$$= 1 + \\tfrac{1}{10}x + \\tfrac{3}{200}x^2 + \\dots$$",
                        "Multiply by $\\dfrac{1}{\\sqrt{5}} = \\dfrac{\\sqrt{5}}{5}$:<br>\begin{aligned}g(x) &\\approx \\dfrac{\\sqrt{5}}{5}\\left(1 + \\tfrac{1}{10}x + \\tfrac{3}{200}x^2\\right)\\cr &= \\dfrac{\\sqrt{5}}{5} + \\dfrac{\\sqrt{5}}{50}x + \\dfrac{3\\sqrt{5}}{1000}x^2.$$",
