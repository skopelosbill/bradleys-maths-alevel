window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "Expanding and simplifying the remaining terms in the numerator:<br>\\beegin{aligned}(6x+12)(x+2)\\cr &= 6x^2 + 24x + 24\\end{aligned}<br>$$2(3x^2+12x) = 6x^2 + 24x$$<br>begin{aligned}\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{ (6x^2 + 24x + 24) }{ (x+2)^3 }\\cr & \\quad-\\dfrac (6x^2 + 24x) }{ (x+2)^3 }\\end{aligned}<br>$$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{24}{ (x+2)^3 }$$<br>Therefore, the constants are $A = 24$ and $n = 3$.",
