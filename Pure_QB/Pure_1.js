        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Differentiating both terms with respect to x gives:<br>\\begin{aligned}\nu' &= 6x + 12 \\cr\n&= 6(x+2)\n\\end{aligned}<br>$$v' = 2(x+2)$$",
                                "Using the <strong>Quotient Rule</strong>, $\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{ u'v - uv' }{ v^2 }$:<br>\\begin{aligned}\\dfrac{\\text{d}y}{\\text{d}x}\\cr  &= \\dfrac{ (6x+12)(x+2)^2}{ (x+2)^4 } \\cr &\\quad - \\dfrac{(3x^2+12x) \\cdot 2(x+2) }{ (x+2)^4 }\\end{aligned}",
