window.ALEVEL_QUESTIONS = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "Factorising out $(x+3)$ from the numerator to simplify:<br>\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{ (x+3) \\left[ (4x+12)(x+3) - 2(2x^2+12x) \\right] }{ (x+3)^4 } \\cr \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{ (4x+12)(x+3) }{ (x+3)^3 } \\cr &\\quad - \\dfrac{ 2(2x^2+12x) }{ (x+3)^3 } \\end{aligned}",
            "Expanding and simplifying the remaining terms in the numerator:<br>\\begin{aligned} (4x+12)(x+3) &= 4x^2 + 24x + 36 \\cr 2(2x^2+12x) &= 4x^2 + 24x \\end{aligned}<br>\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{ (4x^2 + 24x + 36) }{ (x+3)^3 } \\cr &\\quad - \\dfrac{ (4x^2 + 24x) }{ (x+3)^3 } \\end{aligned}<br>$$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{36}{ (x+3)^3 }$$<br>Therefore, the constants are $A = 36$ and $n = 3$.",
            "<strong>Part (b):</strong> For $\\dfrac{\\text{d}y}{\\text{d}x} > 0$:<br>$$\\dfrac{36}{ (x+3)^3 } > 0$$",
            "Since the numerator is a positive constant ($36 > 0$), the fraction will only be positive when the denominator is positive. Therefore, we require:<br>\\begin{aligned} (x+3)^3 &> 0 \\cr \\implies x + 3 &> 0 \\cr \\implies x &> -3 \\end{aligned}",
    ...
    },
    {
        ...
        "steps": [
            ...
            "Using the <strong>Quotient Rule</strong>, $\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{ u'v - uv' }{ v^2 }$:<br>\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{ (-6x-12)(x+2)^2 }{ (x+2)^4 } \\cr &\\quad - \\dfrac{ (-3x^2-12x) \\cdot 2(x+2) }{ (x+2)^4 } \\end{aligned}",
            "Factorising out $(x+2)$ from the numerator to simplify:<br>\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{ (x+2) \\left[ (-6x-12)(x+2) - 2(-3x^2-12x) \\right] }{ (x+2)^4 } \\cr \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{ (-6x-12)(x+2) }{ (x+2)^3 } \\cr &\\quad - \\dfrac{ 2(-3x^2-12x) }{ (x+2)^3 } \\end{aligned}",
            "Expanding and simplifying the remaining terms in the numerator:<br>\\begin{aligned} (-6x-12)(x+2) &= -6x^2 - 24x - 24 \\cr 2(-3x^2-12x) &= -6x^2 - 24x \\end{aligned}<br>\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{ (-6x^2 - 24x - 24) }{ (x+2)^3 } \\cr &\\quad - \\dfrac{ (-6x^2 - 24x) }{ (x+2)^3 } \\end{aligned}<br>$$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{ -24 }{ (x+2)^3 }$$<br>Therefore, the constants are $A = -24$ and $n = 3$.",
            "<strong>Part (b):</strong> For $\\dfrac{\\text{d}y}{\\text{d}x} > 0$:<br>$$\\dfrac{ -24 }{ (x+2)^3 } > 0$$",
            "Since the numerator is a negative constant ($-24 < 0$), the fraction will only be positive when the denominator is negative. Therefore, we require:<br>\\begin{aligned} (x+2)^3 &< 0 \\cr \\implies x + 2 &< 0 \\cr \\implies x &< -2 \\end{aligned}",
            "Final Answer: <strong>(a)</strong> $$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{ -24 }{ (x+2)^3 }$$ <strong>(b)</strong> $$x < -2$$"
        ],
        "pi_options": [
            {
    ...
    },
    {
        ...
        "steps": [
            ...
            "Expanding and simplifying the remaining terms in the numerator:<br>\\begin{aligned} (8x+8)(x+1) &= 8x^2 + 16x + 8 \\cr 2(4x^2+8x) &= 8x^2 + 16x \\end{aligned}<br>\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{ (8x^2 + 16x + 8) }{ (x+1)^3 } \\cr &\\quad - \\dfrac{ (8x^2 + 16x) }{ (x+1)^3 } \\end{aligned}<br>$$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{8}{ (x+1)^3 }$$<br>Therefore, the constants are $A = 8$ and $n = 3$.",
            "<strong>Part (b):</strong> For $\\dfrac{\\text{d}y}{\\text{d}x} < 0$:<br>$$\\dfrac{8}{ (x+1)^3 } < 0$$",
            "Since the numerator is a positive constant ($8 > 0$), the fraction will only be negative when the denominator is negative. Therefore, we require:<br>\\begin{aligned} (x+1)^3 &< 0 \\cr \\implies x + 1 &< 0 \\cr \\implies x &< -1 \\end{aligned}",
            "Final Answer: <strong>(a)</strong> $$\\dfrac{\\text{d}y}{\\text{d}x} = \\dfrac{8}{ (x+1)^3 }$$ <strong>(b)</strong> $$x < -1$$"
        ],
        "pi_options": [
            {
    ...
    },
       {
        ...
        },
        {
                ...
                "steps": [
                        "<strong>Part (a):</strong> Use the identity $$\\sin 2\\theta = 2\\sin\\theta\\cos\\theta.$$<br>$$4(2\\sin\\theta\\cos\\theta) = 7\\cos\\theta$$<br>$$8\\sin\\theta\\cos\\theta - 7\\cos\\theta = 0$$<br>Factorise:<br>$$\\cos\\theta(8\\sin\\theta - 7) = 0.$$<br>This gives two branches:<br><em>Branch 1:</em> \\begin{aligned}\n\\cos\\theta &= 0 \\Rightarrow \\theta \\cr\n&= -90^\\circ,\\\\\\ 90^\\circ.\n\\end{aligned}<br><em>Branch 2:</em> $$\\sin\\theta = \\frac{7}{8} \\Rightarrow \\theta \\approx 61.0^\\circ,\\\\\\ 119.0^\\circ.$$",
                        ...
                        "Final Answer: \\begin{aligned}\n\\theta &= -90^\\circ,\\\\\\ 61.0^\\circ,\\\\\\ 90^\\circ,\\\\\\ 119.0^\\circ; \\quad x \\cr\n&= 51.0^\\circ.\n\\end{aligned}"
                ],
                "pi_options": [
                        {
