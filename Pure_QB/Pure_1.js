window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "We can factorise out a common term of (x+2) from the numerator to simplify:<br>\\begin{aligned}\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{ (x+2) \\left[ (6x+12)(x+2)\\right]}{ (x+2)^4 }\\cr &\\quad - \\dfrac{\\left[ 2(3x^2+12x) \\right] }{ (x+2)^4 }\\end{aligned}<br>\\begin{aligned}\\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{ (6x+12)(x+2){ (x+2)^3 }\\cr & \\quod-\\dfrac{ 2(3x^2+12x) }{ (x+2)^3 }\\end{aligned}",
