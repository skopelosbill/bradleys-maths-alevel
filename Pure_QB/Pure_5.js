window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Differentiate the equation of the curve using the product rule:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= 8\\cos^4 x \\cr &\\quad - 24\\sin^2 x \\cos^2 x \\cr &= 8\\cos^2 x \\big( \\cos^2 x - 3\\sin^2 x \\big) \\cr &= 8\\cos^2 x \\big[ \\cos^2 x \\cr & \\quad- 3(1 - \\cos^2 x) \\big] \\cr &= 8\\cos^2 x(4\\cos^2 x - 3) \\end{aligned}$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Evaluate $A_1 = \\int_{1/2}^{e/2} 4x\\ln(2x) \\text{d}x$ using integration by parts, setting:<br><br>$$\\begin{aligned} u &= \\ln(2x) \\cr \\text{d}u &= \\dfrac{1}{x} \\text{d}x \\cr \\text{d}v &= 4x \\text{d}x \\cr v &= 2x^2 \\end{aligned}$$<br><br>The integration is calculated as:<br><br>$$\\begin{aligned} \\int 4x\\ln(2x) \\text{d}x &= 2x^2\\ln(2x) - \\int 2x^2\\big(\\dfrac{1}{x}\\big) \\text{d}x \\cr &= 2x^2\\ln(2x) - \\int 2x \\text{d}x \\cr &= 2x^2\\ln(2x) - x^2 \\end{aligned}$$<br><br>Evaluating this from $x = \\dfrac{1}{2}$ to $x = \\dfrac{1}{2}e$:<br><br>$$\\begin{aligned} A_1 &= \\left[ 2x^2\\ln(2x) - x^2 \\right]_{1/2}^{e/2} \\cr &= \\bigg( 2\\big(\\dfrac{e}{2}\\big)^2\\ln e - \\big(\\dfrac{e}{2}\\big)^2 \\bigg) \\cr &\\quad - \\bigg( 2\\big(\\dfrac{1}{2}\\big)^2\\ln 1 - \\big(\\dfrac{1}{2}\\big)^2 \\bigg) \\cr &= \\big( \\dfrac{e^2}{2} - \\dfrac{e^2}{4} \\big) - \\big( 0 - \\dfrac{1}{4} \\big) \\cr &= \\dfrac{e^2}{4} + \\dfrac{1}{4} \\end{aligned}$$",
