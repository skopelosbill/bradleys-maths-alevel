        ...
        },
       {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Assemble and simplify the terms to find the total area $A = c I_1 - I_2$:<br>\\begin{aligned} A &= c(c\\ln c - c + 1) - \\left( \\dfrac{c^2}{2}\\ln c - \\dfrac{c^2}{4} + \\dfrac{1}{4} \\right) \\\\\\ &= c^2\\ln c - c^2 + c - \\dfrac{c^2}{2}\\ln c + \\dfrac{c^2}{4} - \\dfrac{1}{4} \\\\\\ &= \\dfrac{c^2}{2}\\ln c - \\dfrac{3c^2}{4} + c - \\dfrac{1}{4} \\end{aligned}",
                "Final Answer: $$\\dfrac{c^2}{2}\\ln c - \\dfrac{3c^2}{4} + c - \\dfrac{1}{4}$$"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        "Set up the definite integral for the area bounded by the curve, $x = 1$, and $x = e$:<br>\\begin{aligned}A &= \\int_{1}^{e} 3x^2 \\ln x \\text{d}x  \\cr&= 3 \\int_{1}^{e} x^2 \\ln x \\text{d}x\\end{aligned}",
                        ...
                        "Multiply the indefinite integral by the coefficient $3$ before substituting the limits:<br>\\begin{aligned}3 \\int x^2 \\ln x \\text{d}x &= 3\\left( \\dfrac{x^3}{3}\\ln x - \\dfrac{x^3}{9} \\right)  \\cr&= x^3\\ln x - \\dfrac{x^3}{3}\\end{aligned}",
                        "Evaluate the definite integral using the upper limit $x = e$ and the lower limit $x = 1$:<br>\\begin{aligned} A = \\left[ x^3\\ln x - \\dfrac{x^3}{3} \\right]_{1}^{e} &= \\left( e^3\\ln e - \\dfrac{e^3}{3} \\right) - \\left( 1^3\\ln 1 - \\dfrac{1}{3} \\right) \\\\\\ &= \\left( e^3 - \\dfrac{e^3}{3} \\right) - \\left( 0 - \\dfrac{1}{3} \\right) \\\\\\ &= \\dfrac{2e^3}{3} + \\dfrac{1}{3} \\\\\\ &= \\dfrac{2e^3 + 1}{3} \\end{aligned}",
                "Final Answer: $$\\dfrac{2e^3 + 1}{3}$$"
                ],
                "pi_options": [
                        {
                                "ans": "$$\\dfrac{2e^3 - 1}{3}$$",
        ...
        },
        {
                ...
                "steps": [
                        "Find the $x$-intercept by setting $y = 0$:<br>$$(x - 2)e^{-x} = 0$$<br>Since $e^{-x} \\ne 0$ for all real $x$, we must have:<br>\\begin{aligned}x - 2 &= 0  \\cr x &= 2\\end{aligned}<br>This confirms the curve intersects the $x$-axis at the point $(2,0)$.",
                        ...
                        "Evaluate the definite integral using the upper limit $x = 4$ and the lower limit $x = 2$:<br>\\begin{aligned} A = \\Big[ -(x - 1)e^{-x} \\Big]_{2}^{4} &= \\left( -(4 - 1)e^{-4} \\right) - \\left( -(2 - 1)e^{-2} \\right) \\\\\\ &= -3e^{-4} - \\left( -e^{-2} \\right) \\\\\\ &= e^{-2} - 3e^{-4} \\end{aligned}",
                "Final Answer: $$e^{-2} - 3e^{-4}$$"
                ],
                "pi_options": [
                        {
                                "ans": "$$-3e^{-4} - e^{-2}$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Evaluate the definite integral using the upper limit $x = \\dfrac{1}{2}\\pi$ and the lower limit $x = 0$:<br>\\begin{aligned} A = \\Big[ x\\sin x + \\cos x \\Big]_{0}^{\\frac{1}{2}\\pi} &= \\left( \\dfrac{1}{2}\\pi\\sin\\left(\\dfrac{1}{2}\\pi\\right) + \\cos\\left(\\dfrac{1}{2}\\pi\\right) \\right) - \\left( 0\\sin 0 + \\cos 0 \\right) \\\\\\ &= \\left( \\dfrac{1}{2}\\pi(1) + 0 \\right) - \\left( 0 + 1 \\right) \\\\\\ &= \\dfrac{1}{2}\\pi - 1 \\end{aligned}",
                "Final Answer: $$\\dfrac{1}{2}\\pi - 1$$"
                ],
                "pi_options": [
                        {
                                "ans": "$$\\dfrac{1}{2}\\pi + 1$$",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Show that the tangent passes through the origin by substituting $x = 0$ into its equation:<br>\\begin{aligned}y &= \\dfrac{0}{e}  \\cr&= 0\\end{aligned}<br>This confirms that the tangent passes through the origin $(0,0)$.",
                        ...
                        "Evaluate the first part, which is a right-angled triangle of base $e$ and height $1$:<br>\\begin{aligned}\\int_{0}^{e} \\dfrac{x}{e} \\text{d}x &= \\left[ \\dfrac{x^2}{2e} \\right]_{0}^{e}  \\cr&= \\dfrac{e^2}{2e} - 0  \\cr&= \\dfrac{e}{2}\\end{aligned}",
                        ...
                        "Subtract the area under the curve from the area under the tangent to find the exact area of the region:<br>$$A = \\dfrac{e}{2} - 1$$",
                "Final Answer: \\begin{aligned}y &= \\dfrac{x}{e}, \\quad \\text{Area}  \\cr&= \\dfrac{e}{2} - 1\\end{aligned}"
                ],
                "pi_options": [
                        {
