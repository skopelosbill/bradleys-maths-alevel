window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Evaluate and compare the long-term behaviour as $t \\to \\infty$:<br>For the first model:<br>$$\\text{As } t \\to \\infty, \\quad P(t) = \\sqrt{6250t + 10000} \\to \\infty$$<br>For the revised model:<br>\\begin{aligned}\\text{As } t \\to \\infty, \\quad e^{-0.5t} \\to 0  \\cr P(t) \\to \\dfrac{300}{1} &= 300\\end{aligned}<br>The first model predicts unbounded growth, while the revised model predicts the population will level off and saturate at $300$ cells.",
                "Final Answer: \\begin{aligned}P(t) &= \\sqrt{6250t + 10000}, \\quad P(t)  \\cr&= \\dfrac{300}{2e^{-0.5t} + 1}\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Substitute $C'$ and isolate $\\theta$:<br>$$\\begin{aligned} (\\theta - 20)^{-1/2} &= \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\\\\\ \\theta(t) - 20 &= \\left( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\right)^{-2} \\\\\\ \\theta(t) &= 20 + \\left( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\right)^{-2} \\end{aligned}$$",
                        "Examine the long-term behaviour as $t \\to \\infty$:<br>For the first model:<br>\\begin{aligned}\\text{As } t \\to \\infty, \\quad 2^{-t/10} \\to 0  \\cr\\theta(t) \\to 20 + 0 &= 20\\end{aligned}<br>For the revised model:<br>\\begin{aligned}\\text{As } t \\to \\infty, \\quad \\sqrt{t + 4} \\to \\infty  \\cr\\left( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\right)^{-2} \\to 0  \\cr\\theta(t) \\to 20 + 0 &= 20\\end{aligned}<br>Both models predict that the liquid will cool down to approach the room temperature of $20^\\circ\\text{C}$ in the long term, and neither model projects that the temperature will fall below this ambient level.",
                "Final Answer: \\begin{aligned}\\theta(t) &= 20 + 64\\cdot 2^{-t/10}, \\quad \\theta(t)  \\cr&= 20 + \\left( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\right)^{-2}\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Integrate the separable differential equation:<br>$$\\begin{aligned} \\int \\dfrac{1}{V} \\,\\text{d}V &= \\int k \\,\\text{d}t \\\\\\ \\ln V &= kt + C \\\\ V(t) &= Ae^{kt} \\end{aligned}$$<br>where $A = e^C$. Substitute the boundary conditions:<br>Substitute $t = 0, \\, V = 10 \\implies A = 10$.<br>Now substitute $t = 5, \\, V = 20$ into $V(t) = 10e^{kt}$:<br>$$\\begin{aligned} 20 &= 10e^{5k} \\\\\\ 2 &= e^{5k} \\\\\\ 5k &= \\ln 2 \\\\ k &= \\dfrac{\\ln 2}{5} \\end{aligned}$$<br>Substituting $k$ back into the model gives:<br>\\begin{aligned}V(t) &= 10e^{\\frac{\\ln 2}{5}t}  \\cr&= 10\\cdot 2^{t/5}\\end{aligned}",
                        ...
                        "Compare the long-term behaviour and find the depletion point:<br>For the first model, $V(t) = 10\\cdot 2^{t/5} \\to \\infty$ as $t \\to \\infty$, representing unbounded compound growth.<br>For the revised model, $V(t) = 20 - 10e^{0.1t}$ eventually decreases because the withdrawal term exceeds the growth term. The fund is exhausted when $V(t) = 0$:<br>$$\\begin{aligned} 20 - 10e^{0.1t} &= 0 \\\\\\ 10e^{0.1t} &= 20 \\\\ e^{0.1t} &= 2 \\\\\\ 0.1t &= \\ln 2 \\\\ t &= 10\\ln 2 \\end{aligned}$$<br>The fund runs out after exactly $10\\ln 2$ years (approximately $6.93$ years).",
                "Final Answer: \\begin{aligned}V(t) &= 10\\cdot 2^{t/5}, \\quad V(t)  \\cr&= 20 - 10e^{0.1t}, \\quad t  \\cr&= 10\\ln 2 \\text{ years}\\end{aligned}"
                ],
                "pi_options": [
                        {
