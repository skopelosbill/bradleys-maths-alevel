window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "img": false,
                "question": "A biologist is attempting to model the population of a yeast colony, $P$, at time $t$ hours. When $t = 0$ there are $100$ cells, and when $t = 2$ there are $150$ cells.<br><br>1. The biologist first assumes that the rate of increase of the yeast population is inversely proportional to the population size present at time $t$.<br>&nbsp;&nbsp;&nbsp;&nbsp;(a) Write down a differential equation to model this situation.<br>&nbsp;&nbsp;&nbsp;&nbsp;(b) Solve this differential equation to find $P$ in terms of $t$.<br><br>2. In a revised model, it is assumed that:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}P}{\\text{d}t} \\cr &\\quad = \\dfrac{P^2}{300e^{0.5t}} \\end{aligned}$$<br><br>Solve this differential equation to find $P$ in terms of $t$, using the same initial population of $100$ cells at $t = 0$.<br><br>3. Compare the long-term behaviour of the two models.",
                "steps": [
                        ...
                        "For the revised model, separate the variables and integrate both sides:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}P}{\\text{d}t} &= \\dfrac{P^2}{300e^{0.5t}} \\cr \\dfrac{1}{P^2} \\,\\text{d}P &= \\dfrac{1}{300}e^{-0.5t} \\,\\text{d}t \\cr \\int P^{-2} \\,\\text{d}P \\cr &\\quad = \\int \\dfrac{1}{300}e^{-0.5t} \\,\\text{d}t \\cr -\\dfrac{1}{P} \\cr &\\quad = -\\dfrac{1}{150}e^{-0.5t} + A \\end{aligned}$$",
        ...
        },
        {
                ...
                "img": false,
                "question": "A clinical researcher is studying the concentration of a newly administered drug in a patient's bloodstream. Let $x$ represent the concentration of the drug (in units/L) at time $t$ hours. Initially, when $t = 0$, the concentration is $x = 0$. After $1$ hour, the concentration is $2$ units/L.<br><br>1. The researcher first assumes that the rate of increase of the drug concentration is proportional to the difference between a maximum saturation level of $10$ units/L and the current concentration $x$.<br>&nbsp;&nbsp;&nbsp;&nbsp;(a) Write down a differential equation to model this situation.<br>&nbsp;&nbsp;&nbsp;&nbsp;(b) Solve this differential equation to find $x$ in terms of $t$.<br><br>2. In a revised model, it is assumed that:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}x}{\\text{d}t} &= \\dfrac{3(10 - x)^2}{100(t + 1)} \\end{aligned}$$<br><br>Solve this differential equation to find $x$ in terms of $t$, using the same initial condition of $x = 0$ at $t = 0$.<br><br>3. Compare the long-term behaviour of the two models as $t \\to \\infty$.",
                "steps": [
                        "Write the rate of increase for the first model as a differential equation:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}x}{\\text{d}t} &= k(10 - x) \\end{aligned}$$<br><br>where $k > 0$ is a constant of proportionality.",
                        "Solve the differential equation by separating the variables and integrating both sides:<br><br>$$\\begin{aligned} \\dfrac{1}{10 - x} \\,\\text{d}x &= k \\,\\text{d}t \\cr \\int \\dfrac{1}{10 - x} \\,\\text{d}x \\cr &\\quad = \\int k \\,\\text{d}t \\cr -\\ln(10 - x) &= kt + C \\cr \\ln(10 - x) &= -kt - C \\cr 10 - x &= Ae^{-kt} \\end{aligned}$$<br><br>where $A = e^{-C}$ is a constant of integration.",
                        "Apply the boundary conditions to find the values of $A$ and $k$:<br><br>Substitute $t = 0, \\, x = 0$ into the equation:<br><br>$$\\begin{aligned} 10 - 0 &= Ae^{0} \\cr A &= 10 \\end{aligned}$$<br><br>This gives $x(t) = 10(1 - e^{-kt})$. Now substitute $t = 1, \\, x = 2$ to find $k$:<br><br>$$\\begin{aligned} 2 &= 10(1 - e^{-k}) \\cr 0.2 &= 1 - e^{-k} \\cr e^{-k} &= 0.8 \\cr -k &= \\ln 0.8 \\cr k &= -\\ln 0.8 \\end{aligned}$$<br><br>Substituting $e^{-kt} = (e^{-k})^t = 0.8^t$ yields:<br><br>$$\\begin{aligned} x(t) &= 10(1 - 0.8^t) \\end{aligned}$$",
                        "For the revised model, separate the variables and integrate both sides:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}x}{\\text{d}t} &= \\dfrac{3(10 - x)^2}{100(t + 1)} \\cr \\dfrac{1}{(10 - x)^2} \\,\\text{d}x \\cr &\\quad = \\dfrac{3}{100(t + 1)} \\,\\text{d}t \\cr \\int (10 - x)^{-2} \\,\\text{d}x \\cr &\\quad = \\int \\dfrac{3}{100(t + 1)} \\,\\text{d}t \\cr \\dfrac{1}{10 - x} \\cr &\\quad = \\dfrac{3}{100}\\ln(t + 1) + C' \\end{aligned}$$",
                        "Apply the initial condition $t = 0, \\, x = 0$ to find $C'$:<br><br>$$\\begin{aligned} \\dfrac{1}{10 - 0} &= \\dfrac{3}{100}\\ln(1) + C' \\cr \\dfrac{1}{10} &= 0 + C' \\cr C' &= \\dfrac{1}{10} \\end{aligned}$$<br><br>Now substitute $C' = \\dfrac{1}{10}$ back and isolate $x$:<br><br>$$\\begin{aligned} \\dfrac{1}{10 - x} \\cr &\\quad = \\dfrac{3}{100}\\ln(t + 1) + \\dfrac{1}{10} \\cr \\dfrac{1}{10 - x} \\cr &\\quad = \\dfrac{3\\ln(t + 1) + 10}{100} \cr 10 - x \\cr &\\quad = \\dfrac{100}{3\\ln(t + 1) + 10} \\cr x(t) \\cr &\\quad = 10 - \\dfrac{100}{3\\ln(t + 1) + 10} \\end{aligned}$$",
                        "Analyze the long-term behaviour as $t \\to \\infty$:<br><br>For the first model:<br><br>$$\\begin{aligned} \\text{As } t &\\to \\infty: \\cr 0.8^t &\\to 0 \\cr x(t) &\\to 10(1 - 0) \\cr &= 10 \\end{aligned}$$<br><br>For the revised model:<br><br>$$\\begin{aligned} \\text{As } t &\\to \\infty: \\cr \\ln(t + 1) &\\to \\infty \\cr \\dfrac{100}{3\\ln(t + 1) + 10} &\\to 0 \\cr x(t) &\\to 10 \\end{aligned}$$<br><br>Both models predict that the concentration will saturate at a limit of $10$ units/L. However, the first model approaches this limit much faster (exponential decay of the remaining concentration gap) compared to the slow logarithmic decay of the revised model.",
        ...
        },
        {
                ...
                "img": false,
                "question": "A liquid is cooling in a temperature-controlled laboratory. Let $\\theta$ be the temperature of the liquid in $^\\circ\\text{C}$ at time $t$ minutes. The ambient room temperature is kept constant at $20^\\circ\\text{C}$. At $t = 0$, the liquid is at $84^\\circ\\text{C}$, and at $t = 10$ minutes, it has cooled to $52^\\circ\\text{C}$.<br><br>1. A classic model assumes that the rate of decrease of the liquid's temperature is proportional to the difference between its current temperature $\\theta$ and the ambient room temperature.<br>&nbsp;&nbsp;&nbsp;&nbsp;(a) Write down a differential equation to model this situation.<br>&nbsp;&nbsp;&nbsp;&nbsp;(b) Solve this differential equation to find $\\theta$ in terms of $t$.<br><br>2. In a revised model, the rate of cooling is assumed to be governed by:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}\\theta}{\\text{d}t} \\cr &\\quad = -\\dfrac{(\\theta - 20)^{3/2}}{30\\sqrt{t + 4}} \\end{aligned}$$<br><br>Solve this differential equation to find $\\theta$ in terms of $t$, using the same initial temperature of $84^\\circ\\text{C}$ at $t = 0$.<br><br>3. State, with a brief reason, what both models predict about the temperature of the liquid in the long term.",
                "steps": [
                        "Represent Newton's Law of Cooling as a differential equation, writing the rate of decrease as a negative rate of change:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}\\theta}{\\text{d}t} &= -k(\\theta - 20) \\end{aligned}$$<br><br>where $k > 0$ is a constant of proportionality.",
                        "Separate the variables and integrate to solve the equation:<br><br>$$\\begin{aligned} \\dfrac{1}{\\theta - 20} \\,\\text{d}\\theta &= -k \\,\\text{d}t \\cr \\int \\dfrac{1}{\\theta - 20} \\,\\text{d}\\theta \\cr &\\quad = \\int -k \\,\\text{d}t \\cr \\ln(\\theta - 20) &= -kt + C \\cr \\theta - 20 &= Ae^{-kt} \\cr \\theta(t) &= 20 + Ae^{-kt} \\end{aligned}$$",
                        "Apply the initial conditions to find the constants $A$ and $k$:<br><br>Substitute $t = 0, \\, \\theta = 84$:<br><br>$$\\begin{aligned} 84 &= 20 + Ae^{0} \\cr A &= 64 \\end{aligned}$$<br><br>This gives $\\theta(t) = 20 + 64e^{-kt}$. Substitute $t = 10, \\, \\theta = 52$:<br><br>$$\\begin{aligned} 52 &= 20 + 64e^{-10k} \\cr 32 &= 64e^{-10k} \\cr e^{-10k} &= 0.5 \\cr -10k &= \\ln 0.5 \\cr k &= \\dfrac{\\ln 2}{10} \\end{aligned}$$<br><br>Substituting $e^{-kt} = (e^{-10k})^{t/10} = 0.5^{t/10} = 2^{-t/10}$ yields:<br><br>$$\\begin{aligned} \\theta(t) &= 20 + 64\\cdot 2^{-t/10} \\end{aligned}$$",
                        "For the revised model, separate variables and integrate:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}\\theta}{\\text{d}t} \\cr &\\quad = -\\dfrac{(\\theta - 20)^{3/2}}{30\\sqrt{t + 4}} \\cr (\\theta - 20)^{-3/2} \\,\\text{d}\\theta \\cr &\\quad = -\\dfrac{1}{30}(t + 4)^{-1/2} \\,\\text{d}t \\cr \\int (\\theta - 20)^{-3/2} \\,\\text{d}\\theta \\cr &\\quad = -\\dfrac{1}{30}\\int (t + 4)^{-1/2} \\,\\text{d}t \\cr -2(\\theta - 20)^{-1/2} \\cr &\\quad = -\\dfrac{1}{30}\\big(2\\sqrt{t + 4}\\big) + C \\cr 2(\\theta - 20)^{-1/2} \\cr &\\quad = \\dfrac{1}{15}\\sqrt{t + 4} - C \\end{aligned}$$",
                        "Multiply both sides by $\\dfrac{1}{2}$ to simplify:<br><br>$$\\begin{aligned} (\\theta - 20)^{-1/2} \\cr &\\quad = \\dfrac{1}{30}\\sqrt{t + 4} + C' \\end{aligned}$$<br><br>where $C' = -\\dfrac{1}{2}C$. Use the initial condition $t = 0, \\, \\theta = 84$ to find $C'$:<br><br>$$\\begin{aligned} (84 - 20)^{-1/2} \\cr &\\quad = \\dfrac{1}{30}\\sqrt{0 + 4} + C' \\cr 64^{-1/2} &= \\dfrac{1}{30}(2) + C' \\cr \\dfrac{1}{8} &= \\dfrac{1}{15} + C' \\cr C' &= \\dfrac{1}{8} - \\dfrac{1}{15} \\cr &= \\dfrac{7}{120} \\end{aligned}$$",
                        "Substitute $C'$ and isolate $\\theta$:<br><br>$$\\begin{aligned} (\\theta - 20)^{-1/2} \\cr &\\quad = \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\cr \\theta(t) - 20 \\cr &\\quad = \\big( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\big)^{-2} \cr \\theta(t) \\cr &\\quad = 20 + \\big( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\big)^{-2} \\end{aligned}$$",
                        "Examine the long-term behaviour as $t \\to \\infty$:<br><br>For the first model:<br><br>$$\\begin{aligned} \\text{As } t &\\to \\infty: \\cr 2^{-t/10} &\\to 0 \\cr \\theta(t) &\\to 20 \\end{aligned}$$<br><br>For the revised model:<br><br>$$\\begin{aligned} \\text{As } t &\\to \\infty: \\cr \\sqrt{t + 4} &\\to \\infty \\cr \\big( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\big)^{-2} &\\to 0 \\cr \\theta(t) &\\to 20 \\end{aligned}$$<br><br>Both models predict that the liquid will cool down to approach the room temperature of $20^\\circ\\text{C}$ in the long term, and neither model projects that the temperature will fall below this ambient level.",
        ...
        },
        {
                ...
                "img": false,
                "question": "An investor establishes a retirement fund. Let $V$ represent the value of the fund (in thousands of pounds) at time $t$ years. Initially, when $t = 0$, the fund has a value of $V = 10$. After $5$ years, the value of the fund is $V = 20$.<br><br>1. A simple model assumes that the rate of increase of the fund's value is directly proportional to its current value.<br>&nbsp;&nbsp;&nbsp;&nbsp;(a) Write down a differential equation to model this situation.<br>&nbsp;&nbsp;&nbsp;&nbsp;(b) Solve this differential equation to find $V$ in terms of $t$.<br><br>2. In a revised model, the investor makes continuous annual withdrawals, and the rate of change of the fund's value is given by:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}V}{\\text{d}t} &= 0.1V - 2 \\end{aligned}$$<br><br>Solve this differential equation to find $V$ in terms of $t$, using the same initial value of $V = 10$ at $t = 0$.<br><br>3. Compare the long-term behaviour predicted by the two models. Determine the exact time at which the fund is projected to run out under the revised model.",
                "steps": [
                        "Represent the rate of change for direct proportionality as a differential equation:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}V}{\\text{d}t} &= kV \\end{aligned}$$<br><br>where $k > 0$ is a constant of proportionality.",
                        "Integrate the separable differential equation:<br><br>$$\\begin{aligned} \\int \\dfrac{1}{V} \\,\\text{d}V &= \\int k \\,\\text{d}t \\cr \\ln V &= kt + C \\cr V(t) &= Ae^{kt} \\end{aligned}$$<br><br>where $A = e^C$. Substitute the boundary conditions:<br><br>Substitute $t = 0, \\, V = 10 \\implies A = 10$.<br><br>Now substitute $t = 5, \\, V = 20$ into $V(t) = 10e^{kt}$:<br><br>$$\\begin{aligned} 20 &= 10e^{5k} \\cr 2 &= e^{5k} \\cr 5k &= \\ln 2 \\cr k &= \\dfrac{\\ln 2}{5} \\end{aligned}$$<br><br>Substituting $k$ back into the model gives:<br><br>$$\\begin{aligned} V(t) &= 10e^{\\frac{\\ln 2}{5}t} \\cr &= 10\\cdot 2^{t/5} \\end{aligned}$$",
                        "For the revised model, separate variables and integrate:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}V}{\\text{d}t} &= 0.1V - 2 \\cr \\dfrac{1}{0.1V - 2} \\,\\text{d}V &= \\text{d}t \\cr \\int \\dfrac{1}{0.1V - 2} \\,\\text{d}V \\cr &\\quad = \\int \\text{d}t \\cr 10\\ln|0.1V - 2| &= t + C' \\end{aligned}$$",
                        "Solve for $V(t)$:<br><br>$$\\begin{aligned} \\ln|0.1V - 2| &= 0.1t + 0.1C' \\cr 0.1V - 2 &= Be^{0.1t} \\cr 0.1V &= 2 + Be^{0.1t} \\cr V(t) &= 20 + A'e^{0.1t} \\end{aligned}$$<br><br>where $A' = 10B$. Substitute the initial condition $t = 0, \\, V = 10$ to find $A'$:<br><br>$$\\begin{aligned} 10 &= 20 + A'e^{0} \\cr A' &= -10 \\end{aligned}$$<br><br>So the value of the fund under the revised model is:<br><br>$$\\begin{aligned} V(t) &= 20 - 10e^{0.1t} \\end{aligned}$$",
                        "Compare the long-term behaviour and find the depletion point:<br><br>For the first model, $V(t) = 10\\cdot 2^{t/5} \\to \\infty$ as $t \\to \\infty$, representing unbounded compound growth.<br><br>For the revised model, $V(t) = 20 - 10e^{0.1t}$ eventually decreases because the withdrawal term exceeds the growth term. The fund is exhausted when $V(t) = 0$:<br><br>$$\\begin{aligned} 20 - 10e^{0.1t} &= 0 \\cr 10e^{0.1t} &= 20 \\cr e^{0.1t} &= 2 \\cr 0.1t &= \\ln 2 \\cr t &= 10\\ln 2 \\end{aligned}$$<br><br>The fund runs out after exactly $10\\ln 2$ years (approximately $6.93$ years).",
        ...
        },
        {
                ...
                "img": false,
                "question": "An environmental scientist is monitoring a bird population, $B$, on an isolated island. When monitoring begins at $t = 0$, there are $100$ birds, and at $t = 1$ year, there are $150$ birds.<br><br>1. A simple geometric model assumes that the rate of increase of the bird population is directly proportional to the number of birds present.<br>&nbsp;&nbsp;&nbsp;&nbsp;(a) Write down a differential equation to model this situation.<br>&nbsp;&nbsp;&nbsp;&nbsp;(b) Solve this differential equation to find $B$ in terms of $t$.<br><br>2. A more realistic logistic model assumes that the island has a maximum carrying capacity of $500$ birds, and that the rate of growth is modeled by the differential equation:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}B}{\\text{d}t} \\cr &\\quad = \\dfrac{B(500 - B)}{2000} \\end{aligned}$$<br><br>Solve this differential equation to find $B$ in terms of $t$, using the same initial population of $100$ birds at $t = 0$.<br><br>3. Compare the long-term behaviour predicted by the two models as $t \\to \\infty$.",
                "steps": [
                        "Represent exponential growth as a differential equation:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}B}{\\text{d}t} &= kB \\end{aligned}$$<br><br>where $k > 0$ is a constant of proportionality.",
                        "Solve by separating the variables and integrating both sides:<br><br>$$\\begin{aligned} \\int \\dfrac{1}{B} \\,\\text{d}B &= \\int k \\,\\text{d}t \\cr \\ln B &= kt + C \\cr B(t) &= Ae^{kt} \\end{aligned}$$<br><br>where $A = e^C$. Substitute $t = 0, \\, B = 100 \\implies A = 100$.<br><br>Substitute $t = 1, \\, B = 150$ into $B(t) = 100e^{kt}$:<br><br>$$\\begin{aligned} 150 &= 100e^{k} \\cr e^k &= 1.5 \\cr k &= \\ln 1.5 \\end{aligned}$$<br><br>So the first model is:<br><br>$$\\begin{aligned} B(t) &= 100e^{(\\ln 1.5)t} \\cr &= 100\\cdot 1.5^t \\end{aligned}$$",
                        "For the logistic model, separate the variables:<br><br>$$\\begin{aligned} \\dfrac{1}{B(500 - B)} \\,\\text{d}B \\cr &\\quad = \\dfrac{1}{2000} \\,\\text{d}t \\end{aligned}$$<br><br>Decompose the left-hand fraction using partial fractions:<br><br>$$\\begin{aligned} \\dfrac{1}{B(500 - B)} \\cr &\\quad = \\dfrac{X}{B} + \\dfrac{Y}{500 - B} \\cr 1 &= X(500 - B) + YB \\end{aligned}$$<br><br>By substituting $B = 0 \\implies X = \\dfrac{1}{500}$, and $B = 500 \\implies Y = \\dfrac{1}{500}$.<br><br>So the decomposed expression is:<br><br>$$\\begin{aligned} \\dfrac{1}{B(500 - B)} \\cr &\\quad = \\dfrac{1}{500}\\big( \\dfrac{1}{B} + \\dfrac{1}{500 - B} \\big) \\end{aligned}$$",
                        "Integrate both sides using the partial fraction decomposition:<br><br>$$\\begin{aligned} \\dfrac{1}{500} \\int \\big( \\dfrac{1}{B} + \\dfrac{1}{500 - B} \\big) \\,\\text{d}B \\cr &\\quad = \\int \\dfrac{1}{2000} \\,\\text{d}t \\cr \\dfrac{1}{500}\\big( \\ln|B| - \\ln|500 - B| \\big) \\cr &\\quad = \\dfrac{t}{2000} + C_1 \\cr \\ln\\big( \\dfrac{B}{500 - B} \\big) \\cr &\\quad = \\dfrac{t}{4} + C' \\end{aligned}$$<br><br>where $C' = 500C_1$. Taking exponentials of both sides:<br><br>$$\\begin{aligned} \\dfrac{B}{500 - B} &= Ke^{t/4} \\end{aligned}$$",
                        "Substitute the initial condition $t = 0, \\, B = 100$ to find $K$:<br><br>$$\\begin{aligned} \\dfrac{100}{500 - 100} &= Ke^{0} \\cr \\dfrac{100}{400} &= K \\cr K &= \\dfrac{1}{4} \\end{aligned}$$<br><br>This gives:<br><br>$$\\begin{aligned} \\dfrac{B}{500 - B} &= \\dfrac{1}{4}e^{t/4} \\end{aligned}$$",
                        "Rearrange to isolate $B(t)$:<br><br>$$\\begin{aligned} B &= (500 - B)\\big(\\dfrac{1}{4}e^{t/4}\\big) \\cr B &= 125e^{t/4} - \\dfrac{1}{4}Be^{t/4} \\cr B\\big(1 + \\dfrac{1}{4}e^{t/4}\\big) \\cr &\\quad = 125e^{t/4} \\cr B(t) &= \\dfrac{125e^{t/4}}{1 + \\dfrac{1}{4}e^{t/4}} \\cr B(t) &= \\dfrac{500e^{t/4}}{4 + e^{t/4}} \\end{aligned}$$",
                        "Examine the long-term behaviour as $t \\to \\infty$:<br><br>For the simple geometric model, $B(t) = 100\\cdot 1.5^t \\to \\infty$, which predicts unbounded population expansion.<br><br>For the logistic model, divide numerator and denominator by $e^{t/4}$:<br><br>$$\\begin{aligned} B(t) &= \\dfrac{500}{4e^{-t/4} + 1} \\cr B(t) &\\to \\dfrac{500}{0 + 1} \\cr &= 500 \\end{aligned}$$<br><br>The simple model assumes infinite growth, whereas the logistic model predicts the population is bounded and will level off at the carrying capacity of $500$ birds.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Conclude the proof based on the result:<br>Since $f(3) = 0$, by the Factor Theorem, $(x - 3)$ is indeed a factor of $2x^3 - 5x^2 - 4x + 3$.",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Set $f(-2)$ equal to $0$ and solve for the constant $k$:<br>$$\\begin{aligned} 4k - 4 &= 0 \\\\\\ 4k &= 4 \\\\ k &= 1 \\end{aligned}$$",
                "Final Answer: $$k = 1$$"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Finally, divide the leading term of the new partial remainder, $-3x$, by $x$ to get $-3$. Multiply $-3$ by the divisor $(x - 2)$:<br>$$-3(x - 2) = -3x + 6$$<br>Subtract this to find the final numerical remainder:<br>$$\\left(-3x + 8\\right) - \\left(-3x + 6\\right) = 2$$",
                "Final Answer: $$\\text{Remainder} = 2$$"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Fully factorise the quadratic quotient $2x^2 + 5x + 2$ into two linear factors:<br>$$2x^2 + 5x + 2 = (2x + 1)(x + 2)$$<br>Combine all three factors to express $f(x)$ in its fully factorised form:<br>$$f(x) = (x - 3)(2x + 1)(x + 2)$$",
                "Final Answer: $$f(x) = (x - 3)(2x + 1)(x + 2)$$"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        "According to the Factor Theorem, because $(x - 2)$ and $(x + 3)$ are factors, evaluating $f(x)$ at their roots $x = 2$ and $x = -3$ must result in $0$:<br>\\begin{aligned}f(2) &= 0 \\quad \\text{and} \\quad f(-3)  \\cr&= 0\\end{aligned}",
                        "Evaluate $f(2) = 0$ to set up the first equation:<br>$$\\begin{aligned} f(2) &= a(2)^3 + b(2)^2 - 11(2) - 6 \\\\\\ &= 8a + 4b - 22 - 6 \\\\\\ &= 8a + 4b - 28 \\end{aligned}$$<br>Setting this to $0$ and dividing by $4$ gives:<br>\\begin{aligned}2a + b &= 7 \\quad  \\cr\\quad b &= 7 - 2a \\quad \\text{--- (Equation 1)}\\end{aligned}",
                        "Evaluate $f(-3) = 0$ to set up the second equation:<br>$$\\begin{aligned} f(-3) &= a(-3)^3 + b(-3)^2 - 11(-3) - 6 \\\\\\ &= -27a + 9b + 33 - 6 \\\\\\ &= -27a + 9b + 27 \\end{aligned}$$<br>Setting this to $0$ and dividing by $9$ gives:<br>\\begin{aligned}-3a + b &= -3 \\quad  \\cr\\quad b &= 3a - 3 \\quad \\text{--- (Equation 2)}\\end{aligned}",
                        "Solve the simultaneous equations by equating the two expressions for $b$:<br>$$\\begin{aligned} 7 - 2a &= 3a - 3 \\\\\\ 10 &= 5a \\\\ a &= 2 \\end{aligned}$$",
                        "Substitute $a = 2$ back into Equation 1 to find $b$:<br>$$\\begin{aligned} b &= 7 - 2(2) \\\\ b &= 3 \\end{aligned}$$",
                "Final Answer: \\begin{aligned}a &= 2, \\quad b  \\cr&= 3\\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "$$a = -2, \\quad b = 11$$",
