        ...
        },
       {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Finally, divide the leading term of the new partial remainder, $-3x$, by $x$ to get $-3$. Multiply $-3$ by the divisor $(x - 2)$:\\begin{aligned} -3(x - 2) = -3x + 6 \\end{aligned}Subtract this to find the final numerical remainder:\\begin{aligned} &(-3x + 8) - (-3x + 6) \\cr &\\quad = 2 \\end{aligned}",
        ...
        },
{
                ...
                "steps": [
                        ...
                        "Conclude based on the change of sign:<br>Since $f(x)$ is continuous on the interval $[0.5, 1.0]$, and there is a change of sign between $x = 0.5$ ($f(0.5) > 0$) and $x = 1.0$ ($f(1.0) < 0$), there must be a root $\\alpha$ in the interval $0.5 < \\alpha < 1.0$.",
                "Final Answer: \\begin{aligned}f(0.5) &= 1.1487 > 0, \\quad f(1.0) = -1.2817 < 0  \\cr0.5 < \\alpha < 1.0\\end{aligned}"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Conclude based on the sign change:<br>Since $f(0.655) > 0$ and $f(0.66) < 0$, the root $\\alpha$ must lie in the interval $0.655 < \\alpha < 0.66$. Because any value within this narrow interval rounds directly to $0.66$ to $2$ decimal places, the proof is complete.",
                "Final Answer: $$0.655 < \\alpha < 0.66 \\implies \\alpha \\approx 0.66 \\text{ (to 2 d.p.)}$$"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Calculate $x_4$ by substituting $x_3 \\approx 1.878916$:<br>$$\\begin{aligned} x_4 &= \\sqrt{3 + \\dfrac{1}{1.878917}} \\\\\\ &\\approx \\sqrt{3 + 0.5322} \\\\\\ &= \\sqrt{3.5322} \\\\\\ &\\approx 1.8794 \\end{aligned}$$",
                "Final Answer: $$x_2 \\approx 1.8856, \\quad x_3 \\approx 1.8789, \\quad x_4 \\approx 1.8794$$"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Calculate $x_4$ by substituting $x_3 \\approx 1.676626$:<br>$$\\begin{aligned} x_4 &= \\sqrt{3 - e^{-1.676626}} \\\\\\ &\\approx \\sqrt{3 - 0.1870} \\\\\\ &= \\sqrt{2.8130} \\\\\\ &\\approx 1.6772 \\end{aligned}$$",
                "Final Answer: $$x_2 \\approx 1.6664, \\quad x_3 \\approx 1.6766, \\quad x_4 \\approx 1.6772$$"
                ],
                "pi_options": [
                        {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Calculate $x_3$ using $x_2 = 0.7546$:<br>$$\\begin{aligned} f(0.7546) &= e^{0.7546} - 5(0.7546)^3 \\\\\\ &\\approx 2.1267 - 2.1465 \\\\\\ &= -0.0198 \\\\ f'(0.7546) &= e^{0.7546} - 15(0.7546)^2 \\\\\\ &\\approx 2.1267 - 8.5410 \\\\\\ &= -6.4143 \\\\ x_3 &= 0.7546 - \\dfrac{-0.0198}{-6.4143} \\\\\\ &\\approx 0.7546 - 0.0031 \\\\\\ &= 0.7515 \\end{aligned}$$",
                "Final Answer: $$x_2 \\approx 0.7546, \\quad x_3 \\approx 0.7515$$"
                ],
                "pi_options": [
                        {
