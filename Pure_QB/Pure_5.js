window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "For the revised model, separate variables and integrate:\\tiny\\begin{aligned} \\dfrac{\\text{d}\\theta}{\\text{d}t} &= -\\dfrac{(\\theta - 20)^{3/2}}{30\\sqrt{t + 4}} \\cr (\\theta - 20)^{-3/2} \\text{d}\\theta &= -\\dfrac{1}{30}(t + 4)^{-1/2} \\text{d}t \\cr \\int (\\theta - 20)^{-3/2} \\text{d}\\theta &= -\\dfrac{1}{30}\\int (t + 4)^{-1/2} \\text{d}t \\cr -2(\\theta - 20)^{-1/2} &= -\\dfrac{1}{30}\\big(2\\sqrt{t + 4}\\big) + C \\cr 2(\\theta - 20)^{-1/2} &= \\dfrac{1}{15}\\sqrt{t + 4} - C \\end{aligned}\\normalsize",
