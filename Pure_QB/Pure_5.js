window.ALEVEL_QUESTIONS = [
        {
                ...
                "question": "The curve $C$ has equation:<br><br>$$\\begin{aligned} y &= \\dfrac{6\\sin 2x}{4 - \\cos 2x} \\cr \\text{for } x &\\ge 0 \\end{aligned}$$<br><br>1. Find the equation of the normal to the curve $C$ at the point $P\\big(\\dfrac{1}{2}\\pi, 0\\big)$.<br><br>2. Find the exact area of the shaded region enclosed by the curve $C$, the normal to the curve, and the $y$-axis.",
                "steps": [
                        "Differentiate the equation of the curve using the quotient rule, setting:<br><br>$$\\begin{aligned} u &= 6\\sin 2x \\cr u' &= 12\\cos 2x \\cr v &= 4 - \\cos 2x \\cr v' &= 2\\sin 2x \\end{aligned}$$<br><br>Applying the quotient rule, the numerator of the derivative is:<br><br>$$\\begin{aligned} \\text{Num} &= 12\\cos 2x(4 - \\cos 2x) \\cr &\\quad - 6\\sin 2x(2\\sin 2x) \\cr &= 48\\cos 2x - 12\\cos^2 2x \\cr &\\quad - 12\\sin^2 2x \\cr &= 48\\cos 2x \\cr &\\quad - 12(\\cos^2 2x + \\sin^2 2x) \\cr &= 48\\cos 2x - 12 \\end{aligned}$$<br><br>Thus, the derivative is:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{48\\cos 2x - 12}{(4 - \\cos 2x)^2} \\end{aligned}$$",
                        "Substitute $x = \\dfrac{1}{2}\\pi$ into the derivative to find the gradient of the tangent at $P$:<br><br>$$\\begin{aligned} x &= \\dfrac{1}{2}\\pi \\cr 2x &= \\pi \\cr \\cos 2x &= -1 \\end{aligned}$$<br><br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{x=\\pi/2} &= \\dfrac{48(-1) - 12}{(4 - (-1))^2} \\cr &= \\dfrac{-60}{25} \\cr &= -\\dfrac{12}{5} \\end{aligned}$$<br><br>The gradient of the normal is the negative reciprocal of the tangent gradient:<br><br>$$\\begin{aligned} m_{\\text{normal}} &= \\dfrac{5}{12} \\end{aligned}$$",
                        "Use the point-gradient formula $y - y_1 = m(x - x_1)$ with the point $P\\big(\\dfrac{1}{2}\\pi, 0\\big)$ to find the equation of the normal:<br><br>$$\\begin{aligned} y - 0 &= \\dfrac{5}{12}\\big(x - \\dfrac{1}{2}\\pi\\big) \\cr y &= \\dfrac{5}{12}x - \\dfrac{5}{24}\\pi \\end{aligned}$$",
                        "Set up the integral for the area. The curve and the normal meet at $x = \\dfrac{1}{2}\\pi$, and the region is bounded on the left by the $y$-axis ($x = 0$). For $0 \\le x \\le \\dfrac{1}{2}\\pi$, the curve lies above the normal line. Therefore, the area is:<br><br>$$\\begin{aligned} A &= \\int_{0}^{\\pi/2} \\bigg[ \\dfrac{6\\sin 2x}{4 - \\cos 2x} \\cr &\\quad - \\big( \\dfrac{5}{12}x - \\dfrac{5\\pi}{24} \\big) \\bigg] \\text{d}x \\cr &= I_1 - I_2 \\end{aligned}$$",
                        "Evaluate the first integral $I_1 = \\int_{0}^{\\pi/2} \\dfrac{6\\sin 2x}{4 - \\cos 2x} \\text{d}x$ using the substitution $u = 4 - \\cos 2x$, which gives $\\text{d}u = 2\\sin 2x \\text{d}x$:<br><br>$$\\begin{aligned} \\text{At } x &= 0: \\cr u &= 4 - \\cos 0 \\cr &= 3 \\cr \\text{At } x &= \\dfrac{1}{2}\\pi: \\cr u &= 4 - \\cos \\pi \\cr &= 5 \\end{aligned}$$<br><br>$$\\begin{aligned} I_1 &= \\int_{3}^{5} \\dfrac{3}{u} \\text{d}u \\cr &= \\Big[ 3\\ln u \\Big]_{3}^{5} \\cr &= 3\\ln 5 - 3\\ln 3 \\cr &= \\ln\\big(\\dfrac{125}{27}\\big) \\end{aligned}$$",
                        "Evaluate the second integral $I_2 = \\int_{0}^{\\pi/2} \\big( \\dfrac{5}{12}x - \\dfrac{5\\pi}{24} \\big) \\text{d}x$:<br><br>$$\\begin{aligned} I_2 &= \\left[ \\dfrac{5}{24}x^2 - \\dfrac{5\\pi}{24}x \\right]_{0}^{\\pi/2} \\cr &= \\dfrac{5}{24}\\big(\\dfrac{\\pi^2}{4}\\big) - \\dfrac{5\\pi}{24}\\big(\\dfrac{\\pi}{2}\\big) \\cr &= \\dfrac{5\\pi^2}{96} - \\dfrac{10\\pi^2}{96} \\cr &= -\\dfrac{5\\pi^2}{96} \\end{aligned}$$<br><br>Subtracting $I_2$ from $I_1$ yields the final exact area:<br><br>$$\\begin{aligned} A &= I_1 - I_2 \\cr &= \\ln\\big(\\dfrac{125}{27}\\big) - \\big(-\\dfrac{5\\pi^2}{96}\\big) \\cr &= \\ln\\big(\\dfrac{125}{27}\\big) + \\dfrac{5}{96}\\pi^2 \\end{aligned}$$",
                        "Final Answer: \\begin{aligned} y &= \\dfrac{5}{12}x - \\dfrac{5\\pi}{24} \\cr \\text{Area} &= \\ln\\big(\\dfrac{125}{27}\\big) + \\dfrac{5}{96}\\pi^2 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "$$\\begin{aligned} y &= -\\dfrac{12}{5}x + \\dfrac{6\\pi}{5} \\cr \\text{Area} &= \\ln\\big(\\dfrac{125}{27}\\big) + \\dfrac{5}{96}\\pi^2 \\end{aligned}$$",
                        ...
                        {
                                "ans": "$$\\begin{aligned} y &= \\dfrac{5}{12}x - \\dfrac{5\\pi}{24} \\cr \\text{Area} &= \\ln\\big(\\dfrac{5}{3}\\big) + \\dfrac{5}{96}\\pi^2 \\end{aligned}$$",
                                "feedback": "Check your substitution step in the first integral. The derivative of $u = 4 - \\cos 2x$ is $\\text{d}u = 2\\sin 2x \\text{d}x$. Since the numerator has $6\\sin 2x$, the integral becomes $\\int \\dfrac{3}{u} \\text{d}u = 3\\ln u$. This results in $3\\ln\\big(\\dfrac{5}{3}\\big) = \\ln\\big(\\dfrac{125}{27}\\big)$, not $\\ln\\big(\\dfrac{5}{3}\\big)$."
                        },
                        {
                                "ans": "$$\\begin{aligned} y &= \\dfrac{5}{12}x - \\dfrac{5\\pi}{24} \\cr \\text{Area} &= \\ln\\big(\\dfrac{125}{27}\\big) - \\dfrac{5}{96}\\pi^2 \\end{aligned}$$",
        ...
        },
        {
                ...
                "question": "The curve $C$ has equation:<br><br>$$\\begin{aligned} y &= \\dfrac{2x + 1}{x^2 + x + 2} \\cr \\text{for } x &\\ge 0 \\end{aligned}$$<br><br>1. Show that the equation of the normal to the curve $C$ at the point $P$ where $x = 1$ is $y = 16x - \\dfrac{61}{4}$.<br><br>2. Find the exact area of the shaded region bounded by the curve $C$, the normal to the curve, and the $y$-axis.",
                "steps": [
                        "Find the coordinates of the point $P$. Substitute $x = 1$ into the curve's equation:<br><br>$$\\begin{aligned} y &= \\dfrac{2(1) + 1}{1^2 + 1 + 2} \\cr &= \\dfrac{3}{4} \\end{aligned}$$<br><br>So the coordinates of $P$ are $P\\big(1, \\dfrac{3}{4}\\big)$.",
                        "Differentiate the equation of the curve using the quotient rule, setting:<br><br>$$\\begin{aligned} u &= 2x + 1 \\cr u' &= 2 \\cr v &= x^2 + x + 2 \\cr v' &= 2x + 1 \\end{aligned}$$<br><br>Applying the quotient rule, the numerator of the derivative is:<br><br>$$\\begin{aligned} \\text{Num} &= 2(x^2 + x + 2) \\cr &\\quad - (2x + 1)^2 \\cr &= 2x^2 + 2x + 4 \\cr &\\quad - (4x^2 + 4x + 1) \\cr &= -2x^2 - 2x + 3 \\end{aligned}$$<br><br>Thus, the derivative is:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{-2x^2 - 2x + 3}{(x^2 + x + 2)^2} \\end{aligned}$$",
                        "Substitute $x = 1$ into the derivative to find the tangent gradient at $P$:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{x = 1} &= \\dfrac{-2(1)^2 - 2(1) + 3}{(1^2 + 1 + 2)^2} \\cr &= -\\dfrac{1}{16} \\end{aligned}$$<br><br>The gradient of the normal is the negative reciprocal of the tangent gradient, which is $16$.",
                        "Find the equation of the normal line using the point-gradient formula with $P\\big(1, \\dfrac{3}{4}\\big)$:<br><br>$$\\begin{aligned} y - \\dfrac{3}{4} &= 16(x - 1) \\cr y &= 16x - 16 + \\dfrac{3}{4} \\cr y &= 16x - \\dfrac{61}{4} \\end{aligned}$$",
                        "Set up the integral for the area bounded by the curve, the normal, and the $y$-axis from $x = 0$ to $x = 1$. Since the curve lies above the normal in this interval, the area is:<br><br>$$\\begin{aligned} A &= \\int_{0}^{1} \\bigg[ \\dfrac{2x + 1}{x^2 + x + 2} \\cr &\\quad - \\big( 16x - \\dfrac{61}{4} \\big) \\bigg] \\text{d}x \\cr &= I_1 - I_2 \\end{aligned}$$",
                        "Evaluate the curve integral $I_1 = \\int_{0}^{1} \\dfrac{2x + 1}{x^2 + x + 2} \\text{d}x$ using the logarithmic substitution $u = x^2 + x + 2$, where $\\text{d}u = (2x + 1)\\text{d}x$:<br><br>$$\\begin{aligned} I_1 &= \\Big[ \\ln(x^2 + x + 2) \\Big]_{0}^{1} \\cr &= \\ln 4 - \\ln 2 \\cr &= \\ln\\big(\\dfrac{4}{2}\\big) \\cr &= \\ln 2 \\end{aligned}$$",
                        "Evaluate the normal line integral $I_2 = \\int_{0}^{1} \\big( 16x - \\dfrac{61}{4} \\big) \\text{d}x$:<br><br>$$\\begin{aligned} I_2 &= \\left[ 8x^2 - \\dfrac{61}{4}x \\right]_{0}^{1} \\cr &= 8 - \\dfrac{61}{4} \\cr &= -\\dfrac{29}{4} \\end{aligned}$$<br><br>Subtracting the two results gives the final exact area:<br><br>$$\\begin{aligned} A &= I_1 - I_2 \\cr &= \\ln 2 - \\big(-\\dfrac{29}{4}\\big) \\cr &= \\ln 2 + \\dfrac{29}{4} \\end{aligned}$$",
                        "Final Answer: \\begin{aligned} y &= 16x - \\dfrac{61}{4} \\cr \\text{Area} &= \\ln 2 + \\dfrac{29}{4} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "$$\\begin{aligned} y &= -\\dfrac{1}{16}x + \\dfrac{13}{16} \\cr \\text{Area} &= \\ln 2 + \\dfrac{29}{4} \\end{aligned}$$",
                        ...
                        {
                                "ans": "$$\\begin{aligned} y &= 16x - \\dfrac{61}{4} \\cr \\text{Area} &= \\ln 4 + \\dfrac{29}{4} \\end{aligned}$$",
                        ...
                        {
                                "ans": "$$\\begin{aligned} y &= 16x - \\dfrac{61}{4} \\cr \\text{Area} &= \\ln 2 - \\dfrac{29}{4} \\end{aligned}$$",
        ...
        },
        {
                ...
                "question": "The curve $C$ has equation:<br><br>$$\\begin{aligned} y &= 8\\sin x \\cos^3 x \\cr \\text{for } &0 \\le x \\le \\dfrac{1}{2}\\pi \\end{aligned}$$<br><br>1. Show that the equation of the normal to the curve $C$ at the point $P$ where $x = \\dfrac{1}{3}\\pi$ is $y = \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2}$.<br><br>2. Find the exact area of the shaded region bounded by the curve $C$, the normal to the curve, and the $y$-axis.",
                "steps": [
                        "Find the coordinates of the point $P$. Substitute $x = \\dfrac{1}{3}\\pi$ into the curve's equation:<br><br>$$\\begin{aligned} y &= 8\\sin\\big(\\dfrac{1}{3}\\pi\\big)\\cos^3\\big(\\dfrac{1}{3}\\pi\\big) \\cr &= 8\\big(\\dfrac{\\sqrt{3}}{2}\\big)\\big(\\dfrac{1}{2}\\big)^3 \\cr &= \\dfrac{\\sqrt{3}}{2} \\end{aligned}$$<br><br>The coordinates of $P$ are $P\\big(\\dfrac{1}{3}\\pi, \\dfrac{\\sqrt{3}}{2}\\big)$.",
                        "Differentiate the equation of the curve using the product rule:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= 8\\cos^4 x \\cr &\\quad - 24\\sin^2 x \\cos^2 x \\cr &= 8\\cos^2 x \\big( \\cos^2 x - 3\\sin^2 x \\big) \\cr &= 8\\cos^2 x \\cr & \\quad\\big[ \\cos^2 x - 3(1 - \\cos^2 x) \\big] \\cr &= 8\\cos^2 x(4\\cos^2 x - 3) \\end{aligned}$$",
                        "Substitute $x = \\dfrac{1}{3}\\pi$ into the derivative to find the tangent gradient at $P$:<br><br>$$\\begin{aligned} \\cos\\big(\\dfrac{1}{3}\\pi\\big) &= \\dfrac{1}{2} \\cr \\cos^2\\big(\\dfrac{1}{3}\\pi\\big) &= \\dfrac{1}{4} \\end{aligned}$$<br><br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{x = \\pi/3} &= 8\\big(\\dfrac{1}{4}\\big)\\big[4\\big(\\dfrac{1}{4}\\big) - 3\\big] \\cr &= 2(1 - 3) \\cr &= -4 \\end{aligned}$$<br><br>The gradient of the normal is the negative reciprocal of the tangent gradient, which is $\\dfrac{1}{4}$.",
                        "Use the point-gradient formula with $P\\big(\\dfrac{1}{3}\\pi, \\dfrac{\\sqrt{3}}{2}\\big)$ to obtain the equation of the normal:<br><br>$$\\begin{aligned} y - \\dfrac{\\sqrt{3}}{2} &= \\dfrac{1}{4}\\big(x - \\dfrac{1}{3}\\pi\\big) \\cr y &= \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2} \\end{aligned}$$",
                        "Set up the integral for the area bounded by the curve, the normal, and the $y$-axis from $x = 0$ to $x = \\dfrac{1}{3}\\pi$. The curve lies above the normal, so:<br><br>$$\\begin{aligned} A &= \\int_{0}^{\\pi/3} \\bigg[ 8\\sin x \\cos^3 x \\cr &\\quad - \\big( \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2} \\big) \\bigg] \\text{d}x \\cr &= I_1 - I_2 \\end{aligned}$$",
                        "Evaluate the first integral $I_1 = \\int_{0}^{\\pi/3} 8\\sin x \\cos^3 x \\text{d}x$ using substitution with $u = \\cos x$, which gives $\\text{d}u = -\\sin x \\text{d}x$:<br><br>$$\\begin{aligned} \\text{At } x &= 0: \\cr u &= \\cos 0 \\cr &= 1 \\cr \\text{At } x &= \\dfrac{1}{3}\\pi: \\cr u &= \\cos\\big(\\dfrac{1}{3}\\pi\\big) \\cr &= \\dfrac{1}{2} \\end{aligned}$$<br><br>$$\\begin{aligned} I_1 &= \\int_{1/2}^{1} 8u^3 \\text{d}u \\cr &= \\Big[ 2u^4 \\Big]_{1/2}^{1} \\cr &= 2(1)^4 - 2\\big(\\dfrac{1}{2}\\big)^4 \\cr &= 2 - \\dfrac{1}{8} \\cr &= \\dfrac{15}{8} \\end{aligned}$$",
                        "Evaluate the second integral $I_2 = \\int_{0}^{\\pi/3} \\left( \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2} \\right) \\text{d}x$:<br><br>$$\\begin{aligned} I_2 &= \\int_{0}^{\\pi/3} \\big( \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2} \\big) \\text{d}x \\cr &= \\left[ \\dfrac{1}{8}x^2 + \\big( \\dfrac{\\sqrt{3}}{2} - \\dfrac{\\pi}{12} \\big)x \\right]_{0}^{\\pi/3} \\cr &= \\dfrac{1}{8}\\big(\\dfrac{\\pi^2}{9}\\big) \\cr &\\quad + \\big( \\dfrac{\\sqrt{3}}{2} - \\dfrac{\\pi}{12} \\big)\\big(\\dfrac{\\pi}{3}\\big) \\cr &= \\dfrac{\\pi^2}{72} + \\dfrac{\\sqrt{3}\\pi}{6} - \\dfrac{\\pi^2}{36} \\cr &= \\dfrac{\\sqrt{3}\\pi}{6} - \\dfrac{\\pi^2}{72} \\end{aligned}$$<br><br>Subtracting $I_2$ from $I_1$ yields the final exact area:<br><br>$$\\begin{aligned} A &= I_1 - I_2 \\cr &= \\dfrac{15}{8} - \\big( \\dfrac{\\sqrt{3}\\pi}{6} - \\dfrac{\\pi^2}{72} \\big) \\cr &= \\dfrac{15}{8} - \\dfrac{\\sqrt{3}}{6}\\pi + \\dfrac{1}{72}\\pi^2 \\end{aligned}$$",
                        "Final Answer: \\begin{aligned} y &= \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2} \\cr \\text{Area} &= \\dfrac{15}{8} - \\dfrac{\\sqrt{3}}{6}\\pi + \\dfrac{1}{72}\\pi^2 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "$$\\begin{aligned} y &= -4x + \\dfrac{4\\pi}{3} + \\dfrac{\\sqrt{3}}{2} \\cr \\text{Area} &= \\dfrac{15}{8} - \\dfrac{\\sqrt{3}}{6}\\pi + \\dfrac{1}{72}\\pi^2 \\end{aligned}$$",
                        ...
                        {
                                "ans": "$$\\begin{aligned} y &= \\dfrac{1}{4}x - \\dfrac{1}{12}\\pi + \\dfrac{\\sqrt{3}}{2} \\cr \\text{Area} &= -\\dfrac{15}{8} - \\dfrac{\\sqrt{3}}{6}\\pi + \\dfrac{1}{72}\\pi^2 \\end{aligned}$$",
        ...
        },
        {
                ...
                "question": "A curve $C$ is defined parametrically by the equations:<br><br>$$\\begin{aligned} x &= \\sin t \\cr y &= \\sin 2t \\cr \\text{for } &0 \\le t \\le \\dfrac{1}{2}\\pi \\end{aligned}$$<br><br>1. Find the equation of the normal to the curve $C$ at the point where $t = \\dfrac{1}{6}\\pi$.<br><br>2. Find the exact area of the region bounded by the curve $C$, the normal to the curve, and the $x$-axis.",
                "steps": [
                        "Find the coordinates of the point at $t = \\dfrac{1}{6}\\pi$:<br><br>$$\\begin{aligned} x &= \\sin\\big(\\dfrac{1}{6}\\pi\\big) \\cr &= \\dfrac{1}{2} \\cr y &= \\sin\\big(\\dfrac{1}{3}\\pi\\big) \\cr &= \\dfrac{\\sqrt{3}}{2} \\end{aligned}$$<br><br>The point is $\\big(\\dfrac{1}{2}, \\dfrac{\\sqrt{3}}{2}\\big)$.",
                        "Differentiate the parametric equations with respect to $t$ to find $\\dfrac{\\text{d}y}{\\text{d}x}$:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}x}{\\text{d}t} &= \\cos t \\cr \\dfrac{\\text{d}y}{\\text{d}t} &= 2\\cos 2t \\cr \\dfrac{\\text{d}y}{\\text{d}x} &= \\dfrac{2\\cos 2t}{\\cos t} \\end{aligned}$$<br><br>Substitute $t = \\dfrac{1}{6}\\pi$ to find the tangent gradient:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{t=\\pi/6} &= \\dfrac{2\\cos\\big(\\dfrac{1}{3}\\pi\\big)}{\\cos\\big(\\dfrac{1}{6}\\pi\\big)} \\cr &= \\dfrac{2\\big(\\dfrac{1}{2}\\big)}{\\dfrac{\\sqrt{3}}{2}} \\cr &= \\dfrac{2}{\\sqrt{3}} \\end{aligned}$$",
                        "Find the normal gradient, which is the negative reciprocal of the tangent gradient:<br><br>$$\\begin{aligned} m_{\\text{normal}} &= -\\dfrac{\\sqrt{3}}{2} \\end{aligned}$$<br><br>Use the point-gradient formula with $\\big(\\dfrac{1}{2}, \\dfrac{\\sqrt{3}}{2}\\big)$ to get the equation of the normal:<br><br>$$\\begin{aligned} y - \\dfrac{\\sqrt{3}}{2} &= -\\dfrac{\\sqrt{3}}{2}\\big(x - \\dfrac{1}{2}\\big) \\cr y &= -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4} \\end{aligned}$$",
                        "Find the intersections of the curve and the normal with the $x$-axis ($y = 0$):<br><br>The curve intersects the $x$-axis when:<br>$$\\begin{aligned} y &= \\sin 2t \\cr &= 0 \\end{aligned}$$<br><br>This gives:<br>$$\\begin{aligned} t &= 0 \\implies x = 0 \\cr t &= \\dfrac{1}{2}\\pi \\implies x = 1 \\end{aligned}$$<br><br>The normal intersects the $x$-axis when:<br>$$\\begin{aligned} 0 &= -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4} \\cr x &= \\dfrac{3}{2} \\end{aligned}$$<br><br>The curve and normal meet at $x = \\dfrac{1}{2}$.",
                        "Divide the area into two separate parts:<br><br>Part 1 ($A_1$): Area under the curve from $x = 0$ to $x = 1$.<br>Part 2 ($A_2$): Area under the normal from $x = 1$ to $x = \\dfrac{3}{2}$.<br><br>$$\\begin{aligned} \\text{Area} &= A_1 + A_2 \\end{aligned}$$",
                        "Evaluate the parametric curve area $A_1 = \\int_{0}^{1} y \\text{d}x$ by changing the variable to $t$ where $\\text{d}x = \\cos t \\text{d}t$:<br><br>$$\\begin{aligned} A_1 &= \\int_{0}^{\\pi/2} (\\sin 2t)(\\cos t) \\text{d}t \\cr &= \\int_{0}^{\\pi/2} 2\\sin t \\cos^2 t \\text{d}t \\end{aligned}$$<br><br>Using substitution $u = \\cos t$, $\\text{d}u = -\\sin t \\text{d}t$, the limits are:<br>$$\\begin{aligned} u &= \\cos t \\cr \\text{d}u &= -\\sin t \\text{d}t \\cr u(0) &= 1 \\cr u\\big(\\dfrac{1}{2}\\pi\\big) &= 0 \\end{aligned}$$<br><br>Then:<br>$$\\begin{aligned} A_1 &= \\int_{0}^{1} 2u^2 \\text{d}u \\cr &= \\left[ \\dfrac{2}{3}u^3 \\right]_{0}^{1} \\cr &= \\dfrac{2}{3} \\end{aligned}$$",
                        "Evaluate the normal line area $A_2 = \\int_{1}^{3/2} \\left( -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4} \\right) \\text{d}x$:<br><br>$$\\begin{aligned} A_2 &= \\int_{1}^{3/2} \\big( -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4} \\big) \\text{d}x \\cr &= \\left[ -\\dfrac{\\sqrt{3}}{4}x^2 + \\dfrac{3\\sqrt{3}}{4}x \\right]_{1}^{3/2} \\cr &= \\bigg( -\\dfrac{\\sqrt{3}}{4}\\big(\\dfrac{9}{4}\\big) + \\dfrac{3\\sqrt{3}}{4}\\big(\\dfrac{3}{2}\\big) \\bigg) \\cr &\\quad - \\bigg( -\\dfrac{\\sqrt{3}}{4} + \\dfrac{3\\sqrt{3}}{4} \\bigg) \\cr &= \\big( -\\dfrac{9\\sqrt{3}}{16} + \\dfrac{18\\sqrt{3}}{16} \\big) - \\dfrac{2\\sqrt{3}}{4} \\cr &= \\dfrac{9\\sqrt{3}}{16} - \\dfrac{8\\sqrt{3}}{16} \\cr &= \\dfrac{\\sqrt{3}}{16} \\end{aligned}$$<br><br>Summing $A_1$ and $A_2$ yields the total exact area:<br><br>$$\\begin{aligned} \\text{Area} &= A_1 + A_2 \\cr &= \\dfrac{2}{3} + \\dfrac{\\sqrt{3}}{16} \\end{aligned}$$",
                        "Final Answer: \\begin{aligned} y &= -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4} \\cr \\text{Area} &= \\dfrac{2}{3} + \\dfrac{\\sqrt{3}}{16} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "$$\\begin{aligned} y &= \\dfrac{2}{\\sqrt{3}}x - \\dfrac{1}{2\\sqrt{3}} \\cr \\text{Area} &= \\dfrac{2}{3} + \\dfrac{\\sqrt{3}}{16} \\end{aligned}$$",
                        ...
                        {
                                "ans": "$$\\begin{aligned} y &= -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4} \\cr \\text{Area} &= \\dfrac{1}{3} + \\dfrac{\\sqrt{3}}{16} \\end{aligned}$$",
                        ...
                        {
                                "ans": "$$\\begin{aligned} y &= -\\dfrac{\\sqrt{3}}{2}x + \\dfrac{3\\sqrt{3}}{4} \\cr \\text{Area} &= \\dfrac{2}{3} + \\dfrac{\\sqrt{3}}{4} \\end{aligned}$$",
        ...
        },
        {
                ...
                "question": "The curve $C$ has equation:<br><br>$$\\begin{aligned} y &= 4x \\ln(2x) \\cr \\text{for } &x > 0 \\end{aligned}$$<br><br>1. Find the equation of the normal to the curve $C$ at the point $P$ where $x = \\dfrac{1}{2}e$.<br><br>2. Find the exact area of the region bounded by the curve $C$, the normal to the curve, and the $x$-axis.",
                "steps": [
                        "Find the coordinates of the point $P$. Substitute $x = \\dfrac{1}{2}e$ into the curve's equation:<br><br>$$\\begin{aligned} y &= 4\\big(\\dfrac{1}{2}e\\big)\\ln\\big(2\\big(\\dfrac{1}{2}e\\big)\\big) \\cr &= 2e\\ln e \\cr &= 2e \\end{aligned}$$<br><br>So the coordinates of $P$ are $P\\big(\\dfrac{1}{2}e, 2e\\big)$.",
                        "Differentiate the curve's equation using the product rule:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= 4\\ln(2x) + 4x\\big(\\dfrac{2}{2x}\\big) \\cr &= 4\\ln(2x) + 4 \\end{aligned}$$<br><br>Substitute $x = \\dfrac{1}{2}e$ to find the tangent gradient at $P$:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x}\\bigg|_{x = e/2} &= 4\\ln e + 4 \\cr &= 8 \\end{aligned}$$<br><br>The gradient of the normal is the negative reciprocal of the tangent gradient, which is $-\\dfrac{1}{8}$.",
                        "Use the point-gradient formula with $P\\big(\\dfrac{1}{2}e, 2e\\big)$ to get the equation of the normal:<br><br>$$\\begin{aligned} y - 2e &= -\\dfrac{1}{8}\\big(x - \\dfrac{1}{2}e\\big) \\cr y &= -\\dfrac{1}{8}x + \\dfrac{e}{16} + 2e \\cr y &= -\\dfrac{1}{8}x + \\dfrac{33e}{16} \\end{aligned}$$",
                        "Find the intersections of the curve and normal with the $x$-axis ($y = 0$):<br><br>The curve intersects the $x$-axis when:<br>$$\\begin{aligned} 4x\\ln(2x) &= 0 \\cr 2x &= 1 \\cr x &= \\dfrac{1}{2} \\end{aligned}$$<br><br>The normal intersects the $x$-axis when:<br>$$\\begin{aligned} 0 &= -\\dfrac{1}{8}x + \\dfrac{33e}{16} \\cr x &= \\dfrac{33e}{2} \\end{aligned}$$<br><br>The boundary between the curve and the normal is at $x = \\dfrac{1}{2}e$.",
                        "Set up the integrals to find the area of the region. The area is divided into two parts:<br><br>Part 1 ($A_1$): Area under the curve from $x = \\dfrac{1}{2}$ to $x = \\dfrac{1}{2}e$.<br>Part 2 ($A_2$): Area under the normal from $x = \\dfrac{1}{2}e$ to $x = \\dfrac{33e}{2}$.",
                        "Evaluate $A_1 = \\int_{1/2}^{e/2} 4x\\ln(2x) \\text{d}x$ using integration by parts, setting:<br><br>$$\\begin{aligned} u &= \\ln(2x) \\cr \\text{d}u &= \\dfrac{1}{x} \\text{d}x \\cr \\text{d}v &= 4x \\text{d}x \\cr v &= 2x^2 \\end{aligned}$$<br><br>The integration is calculated as:\\begin{aligned} & \\int 4x\\ln(2x) \\text{d}x \\cr & \\quad \\quad = 2x^2\\ln(2x) - \\int 2x^2\\big(\\dfrac{1}{x}\\big) \\text{d}x  \\cr & \\quad \\quad = 2x^2\\ln(2x) - \\int 2x \\text{d}x  \\cr & \\quad \\quad = 2x^2\\ln(2x) - x^2 \\end{aligned}<br><br>Evaluating this from $x = \\dfrac{1}{2}$ to $x = \\dfrac{1}{2}e$:<br><br>$$\\begin{aligned} A_1 &= \\left[ 2x^2\\ln(2x) - x^2 \\right]_{1/2}^{e/2} \\cr &= \\bigg( 2\\big(\\dfrac{e}{2}\\big)^2\\ln e - \\big(\\dfrac{e}{2}\\big)^2 \\bigg) \\cr &\\quad - \\bigg( 2\\big(\\dfrac{1}{2}\\big)^2\\ln 1 - \\big(\\dfrac{1}{2}\\big)^2 \\bigg) \\cr &= \\big( \\dfrac{e^2}{2} - \\dfrac{e^2}{4} \\big) - \\big( 0 - \\dfrac{1}{4} \\big) \\cr &= \\dfrac{e^2}{4} + \\dfrac{1}{4} \\end{aligned}$$",
                        "Evaluate $A_2 = \\int_{e/2}^{33e/2} \\left( -\\dfrac{1}{8}x + \\dfrac{33e}{16} \\right) \\text{d}x$. Since this region is a right-angled triangle with base $\\dfrac{33e}{2} - \\dfrac{e}{2} = 16e$ and height $2e$:<br><br>$$\\begin{aligned} A_2 &= \\dfrac{1}{2} \\times 16e \\times 2e \\cr &= 16e^2 \\end{aligned}$$<br><br>Summing the two areas gives the final exact area:<br><br>$$\\begin{aligned} \\text{Area} &= A_1 + A_2 \\cr &= \\big( \\dfrac{e^2}{4} + \\dfrac{1}{4} \\big) + 16e^2 \\cr &= \\dfrac{65}{4}e^2 + \\dfrac{1}{4} \\end{aligned}$$",
                        "Final Answer: \\begin{aligned} y &= -\\dfrac{1}{8}x + \\dfrac{33e}{16} \\cr \\text{Area} &= \\dfrac{65}{4}e^2 + \\dfrac{1}{4} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "$$\\begin{aligned} y &= 8x - 2e \\cr \\text{Area} &= \\dfrac{65}{4}e^2 + \\dfrac{1}{4} \\end{aligned}$$",
                        ...
                        {
                                "ans": "$$\\begin{aligned} y &= -\\dfrac{1}{8}x + \\dfrac{33e}{16} \\cr \\text{Area} &= \\dfrac{65}{4}e^2 - \\dfrac{1}{4} \\end{aligned}$$",
                        ...
                        {
                                "ans": "$$\\begin{aligned} y &= -\\dfrac{1}{8}x + \\dfrac{33e}{16} \\cr \\text{Area} &= \\dfrac{33}{4}e^2 + \\dfrac{1}{4} \\end{aligned}$$",
        ...
        },
        {
                ...
                "img": false,
                "question": "A biologist is attempting to model the population of a yeast colony, $P$, at time $t$ hours. When $t = 0$ there are $100$ cells, and when $t = 2$ there are $150$ cells.<br><br>1. The biologist first assumes that the rate of increase of the yeast population is inversely proportional to the population size present at time $t$.<br>(a) Write down a differential equation to model this situation.<br>(b) Solve this differential equation to find $P$ in terms of $t$.<br><br>2. In a revised model, it is assumed that:\\begin{aligned} \\dfrac{\\text{d}P}{\\text{d}t} = \\dfrac{P^2}{300e^{0.5t}} \\end{aligned}Solve this differential equation to find $P$ in terms of $t$, using the same initial population of $100$ cells at $t = 0$.<br><br>3. Compare the long-term behaviour of the two models.",
                "steps": [
                        "Write the rate of increase as a differential equation representing inverse proportionality:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}P}{\\text{d}t} &= \\dfrac{k}{P} \\end{aligned}$$<br><br>where $k > 0$ is a constant of proportionality.",
                        "Solve the differential equation by separating the variables and integrating both sides:<br><br>$$\\begin{aligned} P \\text{d}P &= k \\text{d}t \\cr \\int P \\text{d}P &= \\int k \\text{d}t \\cr \\dfrac{1}{2}P^2 &= kt + C \\cr P^2 &= 2kt + D \\end{aligned}$$<br><br>where $D = 2C$ is a constant of integration.",
                        "Apply the boundary conditions to find the constant values $D$ and $2k$:<br><br>Substitute $t = 0,  P = 100$ into the equation:<br><br>$$\\begin{aligned} 100^2 &= 2k(0) + D \\cr D &= 10000 \\end{aligned}$$<br><br>Now substitute $t = 2,  P = 150$ and $D = 10000$ to find $2k$:<br><br>$$\\begin{aligned} 150^2 &= 2k(2) + 10000 \\cr 22500 &= 4k + 10000 \\cr 4k &= 12500 \\cr 2k &= 6250 \\end{aligned}$$<br><br>Substitute $2k = 6250$ and $D = 10000$ back into the solved equation and take the positive square root as $P \\ge 0$:<br><br>$$\\begin{aligned} P(t) &= \\sqrt{6250t + 10000} \\end{aligned}$$",
                        "For the revised model, separate the variables and integrate both sides:\\begin{aligned} \\dfrac{\\text{d}P}{\\text{d}t} &= \\dfrac{P^2}{300e^{0.5t}} \\cr \\dfrac{1}{P^2} \\text{d}P &= \\dfrac{1}{300}e^{-0.5t} \\text{d}t \\cr \\int P^{-2} \\text{d}P & = \\int \\dfrac{1}{300}e^{-0.5t} \\text{d}t \\cr -\\dfrac{1}{P} & = -\\dfrac{1}{150}e^{-0.5t} + A \\end{aligned}",
                        "Clean up the equation by multiplying both sides by $-1$:<br><br>$$\\begin{aligned} \\dfrac{1}{P} &= \\dfrac{1}{150}e^{-0.5t} + A' \\end{aligned}$$<br><br>where $A' = -A$. Substitute the initial condition $t = 0,  P = 100$ to find $A'$:<br><br>$$\\begin{aligned} \\dfrac{1}{100} &= \\dfrac{1}{150}e^{0} + A' \\cr \\dfrac{1}{100} &= \\dfrac{1}{150} + A' \\cr A' &= \\dfrac{1}{100} - \\dfrac{1}{150} \\cr &= \\dfrac{1}{300} \\end{aligned}$$<br><br>Combine the fractions and solve for $P$:<br><br>$$\\begin{aligned} \\dfrac{1}{P} &= \\dfrac{1}{150}e^{-0.5t} + \\dfrac{1}{300} \\cr \\dfrac{1}{P} &= \\dfrac{2e^{-0.5t} + 1}{300} \\cr P(t) &= \\dfrac{300}{2e^{-0.5t} + 1} \\end{aligned}$$",
                        "Evaluate and compare the long-term behaviour as $t \\to \\infty$:<br><br>For the first model:<br><br>$$\\begin{aligned} \\text{As } t &\\to \\infty: \\cr P(t) &= \\sqrt{6250t + 10000} \\cr &\\to \\infty \\end{aligned}$$<br><br>For the revised model:<br><br>$$\\begin{aligned} \\text{As } t &\\to \\infty: \\cr e^{-0.5t} &\\to 0 \\cr P(t) &\\to \\dfrac{300}{1} \\cr &= 300 \\end{aligned}$$<br><br>The first model predicts unbounded growth, while the revised model predicts the population will level off and saturate at $300$ cells.",
                        "Final Answer: \\begin{aligned} P(t) &= \\sqrt{6250t + 10000} \\cr P(t) &= \\dfrac{300}{2e^{-0.5t} + 1} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "$$\\begin{aligned} P(t) &= \\sqrt{6250t + 10000} \\cr P(t) &= \\dfrac{300}{e^{-0.5t} + 2} \\end{aligned}$$",
                        ...
                        {
                                "ans": "$$\\begin{aligned} P(t) &= \\sqrt{6250t + 10000} \\cr P(t) &= \\dfrac{300}{2e^{-0.5t} - 1} \\end{aligned}$$",
                        ...
                        {
                                "ans": "$$\\begin{aligned} P(t) &= 6250t + 10000 \\cr P(t) &= \\dfrac{300}{2e^{-0.5t} + 1} \\end{aligned}$$",
        ...
        },
        {
                ...
                "img": false,
                "question": "A clinical researcher is studying the concentration of a newly administered drug in a patient's bloodstream. Let $x$ represent the concentration of the drug (in units/L) at time $t$ hours. Initially, when $t = 0$, the concentration is $x = 0$. After $1$ hour, the concentration is $2$ units/L.<br><br>1. The researcher first assumes that the rate of increase of the drug concentration is proportional to the difference between a maximum saturation level of $10$ units/L and the current concentration $x$.<br>(a) Write down a differential equation to model this situation.<br>(b) Solve this differential equation to find $x$ in terms of $t$.<br><br>2. In a revised model, it is assumed that:\\begin{aligned} \\dfrac{\\text{d}x}{\\text{d}t} = \\dfrac{3(10 - x)^2}{100(t + 1)} \\end{aligned}Solve this differential equation to find $x$ in terms of $t$, using the same initial condition of $x = 0$ at $t = 0$.<br><br>3. Compare the long-term behaviour of the two models as $t \\to \\infty$.",
                "steps": [
                        "Write the rate of increase for the first model as a differential equation:\\begin{aligned} \\dfrac{\\text{d}x}{\\text{d}t} = k(10 - x) \\end{aligned}where $k > 0$ is a constant of proportionality.",
                        "Solve the differential equation by separating the variables and integrating both sides:\\begin{aligned} \\dfrac{1}{10 - x} \\text{d}x &= k \\text{d}t \\cr \\int \\dfrac{1}{10 - x} \\text{d}x &= \\int k \\text{d}t \\cr -\\ln(10 - x) &= kt + C \\cr \\ln(10 - x) &= -kt - C \\cr 10 - x &= Ae^{-kt} \\end{aligned}where $A = e^{-C}$ is a constant of integration.",
                        "Apply the boundary conditions to find the values of $A$ and $k$:<br><br>Substitute $t = 0,  x = 0$ into the equation:\\begin{aligned} 10 - 0 &= Ae^{0} \\cr A &= 10 \\end{aligned}This gives $x(t) = 10(1 - e^{-kt})$. Now substitute $t = 1,  x = 2$ to find $k$:\\begin{aligned} 2 &= 10(1 - e^{-k}) \\cr 0.2 &= 1 - e^{-k} \\cr e^{-k} &= 0.8 \\cr -k &= \\ln 0.8 \\cr k &= -\\ln 0.8 \\end{aligned}Substituting $e^{-kt} = (e^{-k})^t = 0.8^t$ yields:\\begin{aligned} x(t) = 10(1 - 0.8^t) \\end{aligned}",
                        "For the revised model, separate the variables and integrate both sides:\\begin{aligned} \\dfrac{\\text{d}x}{\\text{d}t} &= \\dfrac{3(10 - x)^2}{100(t + 1)} \\cr \\dfrac{1}{(10 - x)^2} \\text{d}x &= \\dfrac{3}{100(t + 1)} \\text{d}t \\cr \\int (10 - x)^{-2} \\text{d}x &= \\int \\dfrac{3}{100(t + 1)} \\text{d}t \\cr \\dfrac{1}{10 - x} &= \\dfrac{3}{100}\\ln(t + 1) + C' \\end{aligned}",
                        "Apply the initial condition $t = 0,  x = 0$ to find $C'$:\\begin{aligned} \\dfrac{1}{10 - 0} &= \\dfrac{3}{100}\\ln(1) + C' \\cr \\dfrac{1}{10} &= 0 + C' \\cr C' &= \\dfrac{1}{10} \\end{aligned}Now substitute $C' = \\dfrac{1}{10}$ back and isolate $x$:\\begin{aligned} \\dfrac{1}{10 - x} &= \\dfrac{3}{100}\\ln(t + 1) + \\dfrac{1}{10} \\cr \\dfrac{1}{10 - x} &= \\dfrac{3\\ln(t + 1) + 10}{100} \\cr 10 - x &= \\dfrac{100}{3\\ln(t + 1) + 10} \\cr x(t) &= 10 - \\dfrac{100}{3\\ln(t + 1) + 10} \\end{aligned}",
                        "Analyze the long-term behaviour as $t \\to \\infty$:<br><br>For the first model:\\begin{aligned} \\text{As } t &\\to \\infty: \\cr 0.8^t &\\to 0 \\cr x(t) &\\to 10(1 - 0) \\cr &= 10 \\end{aligned}For the revised model:\\begin{aligned} \\text{As } t &\\to \\infty: \\cr \\ln(t + 1) &\\to \\infty \\cr \\dfrac{100}{3\\ln(t + 1) + 10} &\\to 0 \\cr x(t) &\\to 10 \\end{aligned}Both models predict that the concentration will saturate at a limit of $10$ units/L. However, the first model approaches this limit much faster (exponential decay of the remaining concentration gap) compared to the slow logarithmic decay of the revised model.",
                        "Final Answer: \\begin{aligned} x(t) &= 10(1 - 0.8^t) \\cr x(t) &= 10 - \\dfrac{100}{3\\ln(t + 1) + 10} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} x(t) &= 10(1 - 0.8^t) \\cr x(t) &= 10 - \\dfrac{100}{3\\ln(t + 1) - 10} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} x(t) &= 10(1 - 0.2^t) \\cr x(t) &= 10 - \\dfrac{100}{3\\ln(t + 1) + 10} \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "A liquid is cooling in a temperature-controlled laboratory. Let $\\theta$ be the temperature of the liquid in $^\\circ\\text{C}$ at time $t$ minutes. The ambient room temperature is kept constant at $20^\\circ\\text{C}$. At $t = 0$, the liquid is at $84^\\circ\\text{C}$, and at $t = 10$ minutes, it has cooled to $52^\\circ\\text{C}$.<br><br>1. A classic model assumes that the rate of decrease of the liquid's temperature is proportional to the difference between its current temperature $\\theta$ and the ambient room temperature.<br>(a) Write down a differential equation to model this situation.<br>(b) Solve this differential equation to find $\\theta$ in terms of $t$.<br><br>2. In a revised model, the rate of cooling is assumed to be governed by:\\begin{aligned} \\dfrac{\\text{d}\\theta}{\\text{d}t} = -\\dfrac{(\\theta - 20)^{3/2}}{30\\sqrt{t + 4}} \\end{aligned}Solve this differential equation to find $\\theta$ in terms of $t$, using the same initial temperature of $84^\\circ\\text{C}$ at $t = 0$.<br><br>3. State, with a brief reason, what both models predict about the temperature of the liquid in the long term.",
                "steps": [
                        "Represent Newton's Law of Cooling as a differential equation, writing the rate of decrease as a negative rate of change:\\begin{aligned} \\dfrac{\\text{d}\\theta}{\\text{d}t} = -k(\\theta - 20) \\end{aligned}where $k > 0$ is a constant of proportionality.",
                        "Separate the variables and integrate to solve the equation:\\begin{aligned} \\dfrac{1}{\\theta - 20} \\text{d}\\theta &= -k \\text{d}t \\cr \\int \\dfrac{1}{\\theta - 20} \\text{d}\\theta &= \\int -k \\text{d}t \\cr \\ln(\\theta - 20) &= -kt + C \\cr \\theta - 20 &= Ae^{-kt} \\cr \\theta(t) &= 20 + Ae^{-kt} \\end{aligned}",
                        "Apply the initial conditions to find the constants $A$ and $k$:<br><br>Substitute $t = 0,  \\theta = 84$:\\begin{aligned} 84 &= 20 + Ae^{0} \\cr A &= 64 \\end{aligned}This gives $\\theta(t) = 20 + 64e^{-kt}$. Substitute $t = 10,  \\theta = 52$:\\begin{aligned} 52 &= 20 + 64e^{-10k} \\cr 32 &= 64e^{-10k} \\cr e^{-10k} &= 0.5 \\cr -10k &= \\ln 0.5 \\cr k &= \\dfrac{\\ln 2}{10} \\end{aligned}Substituting $e^{-kt} = (e^{-10k})^{t/10} = 0.5^{t/10} = 2^{-t/10}$ yields:\\begin{aligned} \\theta(t) = 20 + 64\\cdot 2^{-t/10} \\end{aligned}",
                        "For the revised model, separate variables and integrate:\\begin{aligned} &\\dfrac{\\text{d}\\theta}{\\text{d}t} = -\\dfrac{(\\theta - 20)^{3/2}}{30\\sqrt{t + 4}} \\cr & (\\theta - 20)^{-3/2} \\text{d}\\theta\\cr & \\quad = -\\dfrac{1}{30}(t + 4)^{-1/2} \\text{d}t \\cr &\\int (\\theta - 20)^{-3/2} \\text{d}\\theta \\cr & \\quad= -\\dfrac{1}{30}\\int (t + 4)^{-1/2} \\text{d}t \\cr &-2(\\theta - 20)^{-1/2} \\cr & \\quad = -\\dfrac{1}{30}\\big(2\\sqrt{t + 4}\\big) + C \\cr &2(\\theta - 20)^{-1/2} = \\dfrac{1}{15}\\sqrt{t + 4} - C \\end{aligned}",
                        "Multiply both sides by $\\dfrac{1}{2}$ to simplify:\\begin{aligned} (\\theta - 20)^{-1/2} = \\dfrac{1}{30}\\sqrt{t + 4} + C' \\end{aligned}where $C' = -\\dfrac{1}{2}C$. Use the initial condition $t = 0,  \\theta = 84$ to find $C'$:\\begin{aligned} (84 - 20)^{-1/2} &= \\dfrac{1}{30}\\sqrt{0 + 4} + C' \\cr 64^{-1/2} &= \\dfrac{1}{30}(2) + C' \\cr \\dfrac{1}{8} &= \\dfrac{1}{15} + C' \\cr C' &= \\dfrac{1}{8} - \\dfrac{1}{15} \\cr &= \\dfrac{7}{120} \\end{aligned}",
                        "Substitute $C'$ and isolate $\\theta$:\\begin{aligned} &(\\theta - 20)^{-1/2} = \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\cr &\\theta(t) - 20 = \\big( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\big)^{-2} \\cr & \\theta(t) = 20 + \\big( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\big)^{-2} \\end{aligned}",
                        "Examine the long-term behaviour as $t \\to \\infty$:<br><br>For the first model:\\begin{aligned} \\text{As } t &\\to \\infty: \\cr 2^{-t/10} &\\to 0 \\cr \\theta(t) &\\to 20 \\end{aligned}For the revised model:\\begin{aligned} \\text{As } t &\\to \\infty: \\cr \\sqrt{t + 4} &\\to \\infty \\cr \\big( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\big)^{-2} &\\to 0 \\cr \\theta(t) &\\to 20 \\end{aligned}Both models predict that the liquid will cool down to approach the room temperature of $20^\\circ\\text{C}$ in the long term, and neither model projects that the temperature will fall below this ambient level.",
                        "Final Answer: \\begin{aligned} \\theta(t) &= 20 + 64\\cdot 2^{-t/10} \\cr \\theta(t) &= 20 + \\big( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\big)^{-2} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} \\theta(t) &= 20 + 64\\cdot 2^{-t/10} \\cr \\theta(t) &= 20 + \\big( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{1}{15} \\big)^{-2} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\theta(t) &= 20 + 64\\cdot 2^{-t/10} \\cr \\theta(t) &= 20 + \\big( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\big)^{2} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\theta(t) &= 20 + 84\\cdot 2^{-t/10} \\cr \\theta(t) &= 20 + \\big( \\dfrac{1}{30}\\sqrt{t + 4} + \\dfrac{7}{120} \\big)^{-2} \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "An investor establishes a retirement fund. Let $V$ represent the value of the fund (in thousands of pounds) at time $t$ years. Initially, when $t = 0$, the fund has a value of $V = 10$. After $5$ years, the value of the fund is $V = 20$.<br><br>1. A simple model assumes that the rate of increase of the fund's value is directly proportional to its current value.<br>(a) Write down a differential equation to model this situation.<br>(b) Solve this differential equation to find $V$ in terms of $t$.<br><br>2. In a revised model, the investor makes continuous annual withdrawals, and the rate of change of the fund's value is given by:\\begin{aligned} \\dfrac{\\text{d}V}{\\text{d}t} = 0.1V - 2 \\end{aligned}Solve this differential equation to find $V$ in terms of $t$, using the same initial value of $V = 10$ at $t = 0$.<br><br>3. Compare the long-term behaviour predicted by the two models. Determine the exact time at which the fund is projected to run out under the revised model.",
                "steps": [
                        "Represent the rate of change for direct proportionality as a differential equation:\\begin{aligned} \\dfrac{\\text{d}V}{\\text{d}t} = kV \\end{aligned}where $k > 0$ is a constant of proportionality.",
                        "Integrate the separable differential equation:\\begin{aligned} \\int \\dfrac{1}{V} \\text{d}V &= \\int k \\text{d}t \\cr \\ln V &= kt + C \\cr V(t) &= Ae^{kt} \\end{aligned}where $A = e^C$. Substitute the boundary conditions:<br><br>Substitute $t = 0,  V = 10 \\implies A = 10$.<br><br>Now substitute $t = 5,  V = 20$ into $V(t) = 10e^{kt}$:\\begin{aligned} 20 &= 10e^{5k} \\cr 2 &= e^{5k} \\cr 5k &= \\ln 2 \\cr k &= \\dfrac{\\ln 2}{5} \\end{aligned}Substituting $k$ back into the model gives:\\begin{aligned} V(t) &= 10e^{\\frac{\\ln 2}{5}t} \\cr &= 10\\cdot 2^{t/5} \\end{aligned}",
                        "For the revised model, separate variables and integrate:\\begin{aligned} \\dfrac{\\text{d}V}{\\text{d}t} &= 0.1V - 2 \\cr \\dfrac{1}{0.1V - 2} \\text{d}V &= \\text{d}t \\cr \\int \\dfrac{1}{0.1V - 2} \\text{d}V &= \\int \\text{d}t \\cr 10\\ln|0.1V - 2| &= t + C' \\end{aligned}",
                        "Solve for $V(t)$:\\begin{aligned} \\ln|0.1V - 2| &= 0.1t + 0.1C' \\cr 0.1V - 2 &= Be^{0.1t} \\cr 0.1V &= 2 + Be^{0.1t} \\cr V(t) &= 20 + A'e^{0.1t} \\end{aligned}where $A' = 10B$. Substitute the initial condition $t = 0,  V = 10$ to find $A'$:\\begin{aligned} 10 &= 20 + A'e^{0} \\cr A' &= -10 \\end{aligned}So the value of the fund under the revised model is:\\begin{aligned} V(t) = 20 - 10e^{0.1t} \\end{aligned}",
                        "Compare the long-term behaviour and find the depletion point:<br><br>For the first model, $V(t) = 10\\cdot 2^{t/5} \\to \\infty$ as $t \\to \\infty$, representing unbounded compound growth.<br><br>For the revised model, $V(t) = 20 - 10e^{0.1t}$ eventually decreases because the withdrawal term exceeds the growth term. The fund is exhausted when $V(t) = 0$:\\begin{aligned} 20 - 10e^{0.1t} &= 0 \\cr 10e^{0.1t} &= 20 \\cr e^{0.1t} &= 2 \\cr 0.1t &= \\ln 2 \\cr t &= 10\\ln 2 \\end{aligned}The fund runs out after exactly $10\\ln 2$ years (approximately $6.93$ years).",
                        "Final Answer: \\begin{aligned} V(t) &= 10\\cdot 2^{t/5} \\cr V(t) &= 20 - 10e^{0.1t} \\cr t &= 10\\ln 2 \\text{ years} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} V(t) &= 10\\cdot 2^{t/5} \\cr V(t) &= 20 - 10e^{0.1t} \\cr t &= 5\\ln 2 \\text{ years} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} V(t) &= 10\\cdot 2^{t/5} \\cr V(t) &= 20 + 10e^{0.1t} \\cr t &= 10\\ln 2 \\text{ years} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} V(t) &= 10\\cdot 2^{t/5} \\cr V(t) &= 20 - 10e^{t} \\cr t &= \\ln 2 \\text{ years} \\end{aligned}",
        ...
        },
       {
...
},
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>Show that $(x - 3)$ is a factor of:\\begin{aligned} 2x^3 - 5x^2 - 4x + 3 \\end{aligned}",
                "steps": [
                        "Define the polynomial as a function $f(x)$:\\begin{aligned} f(x) = 2x^3 - 5x^2 - 4x + 3 \\end{aligned}According to the Factor Theorem, a linear term $(x - a)$ is a factor of a polynomial $f(x)$ if and only if $f(a) = 0$. Therefore, $(x - 3)$ is a factor if $f(3) = 0$.",
                        "Substitute $x = 3$ into the polynomial and evaluate step-by-step:\\begin{aligned} f(3) &= 2(3)^3 - 5(3)^2 - 4(3) + 3 \\cr &= 2(27) - 5(9) - 12 + 3 \\cr &= 54 - 45 - 12 + 3 \\cr &= 9 - 12 + 3 \\cr &= 0 \\end{aligned}",
                        "Conclude the proof based on the result:<br><br>Since $f(3) = 0$, by the Factor Theorem, $(x - 3)$ is indeed a factor of $2x^3 - 5x^2 - 4x + 3$.",
                        "Final Answer: \\begin{aligned} f(3) &= 0 \\cr (x - 3) &\\text{ is a factor} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} f(-3) &= 0 \\cr \\implies (x - 3) &\\text{ is a factor} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} f(3) &= 12 \\cr \\implies (x - 3) &\\text{ is a factor} \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>The polynomial $f(x)$ is defined by:\\begin{aligned} f(x) = 3x^3 + kx^2 - 4x + 12 \\end{aligned}where $k$ is a constant.<br><br>Given that $(x + 2)$ is a factor of $f(x)$, find the value of $k$.",
                "steps": [
                        "According to the Factor Theorem, since $(x + 2)$ is a factor of $f(x)$, the polynomial evaluated at the root $x = -2$ must equal $0$. That is:\\begin{aligned} f(-2) = 0 \\end{aligned}",
                        "Substitute $x = -2$ into the expression for $f(x)$:\\begin{aligned} f(-2) &= 3(-2)^3 + k(-2)^2 \\cr &\\quad - 4(-2) + 12 \\cr &= 3(-8) + 4k + 8 + 12 \\cr &= -24 + 4k + 20 \\cr &= 4k - 4 \\end{aligned}",
                        "Set $f(-2)$ equal to $0$ and solve for the constant $k$:\\begin{aligned} 4k - 4 &= 0 \\cr 4k &= 4 \\cr k &= 1 \\end{aligned}",
                        "Final Answer: \\begin{aligned} k = 1 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} k = -11 \\end{aligned}",
                                "feedback": "Check your evaluation of $(-2)^3$. It is $-8$, not $+8$. Using $+8$ gives \\begin{aligned} 24 + 4k + 20 &= 0 \\cr 4k &= -44 \\cr k &= -11 \\end{aligned."
                        },
                        {
                                "ans": "\\begin{aligned} k = -1 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} k = -4 \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>Find the remainder when the polynomial:\\begin{aligned} 2x^3 - 3x^2 - 5x + 8 \\end{aligned}is divided by $(x - 2)$ using algebraic division.",
                "steps": [
                        "To find the remainder, we perform polynomial division on $2x^3 - 3x^2 - 5x + 8$ using the divisor $(x - 2)$.<br><br>First, divide the leading term $2x^3$ by $x$ to get $2x^2$. Multiply $2x^2$ by the divisor $(x - 2)$:\\begin{aligned} 2x^2(x - 2) = 2x^3 - 4x^2 \\end{aligned}Subtract this from the original polynomial to find the first partial remainder:\\begin{aligned} &(2x^3 - 3x^2 - 5x + 8) \\cr &\\quad - (2x^3 - 4x^2) \\cr &\\quad = x^2 - 5x + 8 \\end{aligned}",
                        "Next, divide the leading term of the partial remainder, $x^2$, by $x$ to get $x$. Multiply $x$ by the divisor $(x - 2)$:\\begin{aligned} x(x - 2) = x^2 - 2x \\end{aligned}Subtract this from the current partial remainder:\\begin{aligned} &(x^2 - 5x + 8) \\cr &\\quad - (x^2 - 2x) \\cr &\\quad = -3x + 8 \\end{aligned}",
                        "Finally, divide the leading term of the new partial remainder, $-3x$, by $x$ to get $-3$. Multiply $-3$ by the divisor $(x - 2)$:\\begin{aligned} -3(x - 2) = -3x + 6 \\end{aligned}Subtract this to find the final numerical remainder:\\begin{aligned}(-3x + 8) - (-3x + 6) = 2 \\end{aligned}",
                        "Final Answer: \\begin{aligned} \\text{Remainder} = 2 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} \\text{Remainder} = -30 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\text{Remainder} = 10 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\text{Remainder} = 0 \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>The cubic polynomial $f(x)$ is given by:\\begin{aligned} f(x) = 2x^3 - x^2 - 13x - 6 \\end{aligned}1. Use the Factor Theorem to show that $(x - 3)$ is a linear factor of $f(x)$.<br><br>2. Hence, express $f(x)$ as the product of three linear factors.",
                "steps": [
                        "To prove that $(x - 3)$ is a factor of $f(x) = 2x^3 - x^2 - 13x - 6$, apply the Factor Theorem and evaluate $f(3)$:\\begin{aligned} f(3) &= 2(3)^3 - (3)^2 - 13(3) - 6 \\cr &= 2(27) - 9 - 39 - 6 \\cr &= 54 - 9 - 39 - 6 \\cr &= 0 \\end{aligned}Since $f(3) = 0$, by the Factor Theorem, $(x - 3)$ is a linear factor of $f(x)$.",
                        "Perform polynomial division or equate coefficients to divide $f(x)$ by $(x - 3)$ and find the quadratic quotient:\\begin{aligned} &2x^3 - x^2 - 13x - 6 \\cr &\\quad = (x - 3)(2x^2 + ax + 2) \\end{aligned}Compare the $x^2$ coefficient on both sides:\\begin{aligned} -1 &= -3(2) + a \\cr -1 &= -6 + a \\cr a &= 5 \\end{aligned}So, the quadratic quotient is $2x^2 + 5x + 2$.",
                        "Fully factorise the quadratic quotient $2x^2 + 5x + 2$ into two linear factors:\\begin{aligned} 2x^2 + 5x + 2 = (2x + 1)(x + 2) \\end{aligned}Combine all three factors to express $f(x)$ in its fully factorised form:\\begin{aligned} &f(x) \\cr &\\quad = (x - 3)(2x + 1)(x + 2) \\end{aligned}",
                        "Final Answer: \\begin{aligned} &f(x) \\cr &\\quad = (x - 3)(2x + 1)(x + 2) \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} &f(x) \\cr &\\quad = (x - 3)(2x - 1)(x - 2) \\end{aligned}",
                                "feedback": "Check your quadratic factorization. Factoring the positive terms of $2x^2 + 5x + 2$ must yield $(2x + 1)(x + 2)$, not $(2x - 1)(x - 2)$."
                        },
                        {
                                "ans": "\\begin{aligned} &f(x) \\cr &\\quad = (x - 3)(2x^2 + 5x + 2) \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>The polynomial $f(x)$ is defined by:\\begin{aligned} f(x) = ax^3 + bx^2 - 11x - 6 \\end{aligned}where $a$ and $b$ are constants.<br><br>Given that both $(x - 2)$ and $(x + 3)$ are factors of $f(x)$, find the values of $a$ and $b$.",
                "steps": [
                        "According to the Factor Theorem, because $(x - 2)$ and $(x + 3)$ are factors, evaluating $f(x)$ at their roots $x = 2$ and $x = -3$ must result in $0$:\\begin{aligned} f(2) &= 0 \\cr f(-3) &= 0 \\end{aligned}",
                        "Evaluate $f(2) = 0$ to set up the first equation:\\begin{aligned} f(2) &= a(2)^3 + b(2)^2 - 11(2) - 6 \\cr &= 8a + 4b - 22 - 6 \\cr &= 8a + 4b - 28 \\end{aligned}Setting this to $0$ and dividing by $4$ gives:\\begin{aligned} 2a + b &= 7 \\cr b &= 7 - 2a \\quad \\text{--- (1)} \\end{aligned}",
                        "Evaluate $f(-3) = 0$ to set up the second equation:\\begin{aligned} f(-3) &= a(-3)^3 + b(-3)^2 \\cr &\\quad - 11(-3) - 6 \\cr &= -27a + 9b + 33 - 6 \\cr &= -27a + 9b + 27 \\end{aligned}Setting this to $0$ and dividing by $9$ gives:\\begin{aligned} -3a + b &= -3 \\cr b &= 3a - 3 \\quad \\text{--- (2)} \\end{aligned}",
                        "Solve the simultaneous equations by equating the two expressions for $b$:\\begin{aligned} 7 - 2a &= 3a - 3 \\cr 10 &= 5a \\cr a &= 2 \\end{aligned}",
                        "Substitute $a = 2$ back into Equation 1 to find $b$:\\begin{aligned} b &= 7 - 2(2) \\cr b &= 3 \\end{aligned}",
                        "Final Answer: \\begin{aligned} a &= 2 \\cr b &= 3 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} a &= -2 \\cr b &= 11 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} a &= 3 \\cr b &= 2 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} a &= 2 \\cr b &= -3 \\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Define the equation as a function $f(x)$:\\begin{aligned} f(x) = e^x - 4x^3 \\end{aligned}According to the Change of Sign rule, if a continuous function $f(x)$ changes sign over an interval $[a, b]$, then there must be at least one root of the equation $f(x) = 0$ in the interval $a < x < b$.",
                        "Evaluate the function at the lower boundary $x = 0.5$:\\begin{aligned} f(0.5) &= e^{0.5} - 4(0.5)^3 \\cr &\\approx 1.6487 - 4(0.125) \\cr &\\approx 1.6487 - 0.5 \\cr &= 1.1487 \\end{aligned}Since $1.1487 > 0$, the function is positive at $x = 0.5$.",
                        "Evaluate the function at the upper boundary $x = 1.0$:\\begin{aligned} f(1.0) &= e^{1.0} - 4(1.0)^3 \\cr &\\approx 2.7183 - 4 \\cr &= -1.2817 \\end{aligned}Since $-1.2817 < 0$, the function is negative at $x = 1.0$.",
                        "Conclude based on the change of sign:<br><br>Since $f(x)$ is continuous on the interval $[0.5, 1.0]$, and there is a change of sign between $x = 0.5$ ($f(0.5) > 0$) and $x = 1.0$ ($f(1.0) < 0$), there must be a root $\\alpha$ in the interval $0.5 < \\alpha < 1.0$.",
                        "Final Answer: \\begin{aligned} f(0.5) &= 1.1487 > 0 \\cr f(1.0) &= -1.2817 < 0 \\cr 0.5 &< \\alpha < 1.0 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} f(0.5) &= -1.1487 < 0 \\cr f(1.0) &= 1.2817 > 0 \\cr \\implies 0.5 &< \\alpha < 1.0 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} f(0.5) &= 1.1487 > 0 \\cr f(1.0) &= -1.2817 < 0 \\cr \\implies \\alpha &= 0.5 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} f(0) &= 1 > 0 \\cr f(1.0) &= -1.2817 < 0 \\cr \\implies 0.5 &< \\alpha < 1.0 \\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Define the function $f(x) = x^3 - 5x + 3$. To show that the root $\\alpha$ lies in the interval $[0.6, 0.7]$, evaluate $f(x)$ at the boundaries $x = 0.6$ and $x = 0.7$:\\begin{aligned} f(0.6) &= 0.6^3 - 5(0.6) + 3 \\cr &= 0.216 - 3 + 3 \\cr &= 0.216 > 0 \\cr f(0.7) &= 0.7^3 - 5(0.7) + 3 \\cr &= 0.343 - 3.5 + 3 \\cr &= -0.157 < 0 \\end{aligned}Since $f(0.6) > 0$ and $f(0.7) < 0$, the change of sign confirms that $0.6 < \\alpha < 0.7$.",
                        "To prove that the root is $0.66$ correct to $2$ decimal places, we must establish that it lies within the rounding boundary interval $[0.655, 0.665]$. Let's test the lower rounding boundary $x = 0.655$:\\begin{aligned} f(0.655) &= 0.655^3 - 5(0.655) + 3 \\cr &\\approx 0.2809 - 3.2750 + 3 \\cr &= 0.0059 > 0 \\end{aligned}",
                        "Now evaluate the function at the target value $x = 0.66$:\\begin{aligned} f(0.66) &= 0.66^3 - 5(0.66) + 3 \\cr &\\approx 0.2875 - 3.3000 + 3 \\cr &= -0.0125 < 0 \\end{aligned}",
                        "Conclude based on the sign change:<br><br>Since $f(0.655) > 0$ and $f(0.66) < 0$, the root $\\alpha$ must lie in the interval $0.655 < \\alpha < 0.66$. Because any value within this narrow interval rounds directly to $0.66$ to $2$ decimal places, the proof is complete.",
                        "Final Answer: \\begin{aligned} &0.655 < \\alpha < 0.66 \\cr &\\implies \\alpha \\approx 0.66 \\text{ (to 2 d.p.)} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} &0.65 < \\alpha < 0.66 \\cr &\\implies \\alpha \\approx 0.66 \\text{ (to 2 d.p.)} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} f(0.6) &= -0.216 \\cr f(0.7) &= 0.157 \\cr \\implies 0.6 &< \\alpha < 0.7 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} &0.66 < \\alpha < 0.665 \\cr &\\implies \\alpha \\approx 0.66 \\text{ (to 2 d.p.)} \\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Rearrange the equation $x^3 - 3x - 1 = 0$ to isolate $x$ on one side (dividing by $x \\ne 0$):\\begin{aligned} x^3 &= 3x + 1 \\cr x^2 &= 3 + \\dfrac{1}{x} \\cr x &= \\sqrt{3 + \\dfrac{1}{x}} \\end{aligned}Writing this in iterative form yields the required formula:\\begin{aligned} x_{n+1} = \\sqrt{3 + \\dfrac{1}{x_n}} \\end{aligned}",
                        "Calculate $x_2$ by substituting $x_1 = 1.8$ into the formula:\\begin{aligned} x_2 &= \\sqrt{3 + \\dfrac{1}{1.8}} \\cr &= \\sqrt{3 + 0.5556} \\cr &= \\sqrt{3.5556} \\cr &\\approx 1.8856 \\end{aligned}",
                        "Calculate $x_3$ by substituting $x_2 \\approx 1.885618$ (using full calculator precision to prevent intermediate rounding errors):\\begin{aligned} x_3 &= \\sqrt{3 + \\dfrac{1}{1.885618}} \\cr &\\approx \\sqrt{3 + 0.5303} \\cr &= \\sqrt{3.5303} \\cr &\\approx 1.8789 \\end{aligned}",
                        "Calculate $x_4$ by substituting $x_3 \\approx 1.878916$:\\begin{aligned} x_4 &= \\sqrt{3 + \\dfrac{1}{1.878917}} \\cr &\\approx \\sqrt{3 + 0.5322} \\cr &= \\sqrt{3.5322} \\cr &\\approx 1.8794 \\end{aligned}",
                        "Final Answer: \\begin{aligned} x_2 &\\approx 1.8856 \\cr x_3 &\\approx 1.8789 \\cr x_4 &\\approx 1.8794 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} x_2 &\\approx 1.8878 \\cr x_3 &\\approx 1.8790 \\cr x_4 &\\approx 1.8800 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} x_2 &\\approx 1.8856 \\cr x_3 &\\approx 1.8789 \\cr x_4 &\\approx 1.8812 \\end{aligned}",
                                "feedback": "Check your calculations for $x_4$. Substituting $x_3 \\approx 1.8789$ back into the formula yields $\\sqrt{3.5322} \\approx 1.8794$, not $1.8812$."
                        },
                        {
                                "ans": "\\begin{aligned} x_2 &\\approx 1.8856 \\cr x_3 &\\approx 1.8924 \\cr x_4 &\\approx 1.8794 \\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Set $y = 0$ to find the $x$-intercept root of the equation:\\begin{aligned} e^{-x} + x^2 - 3 &= 0 \\cr x^2 &= 3 - e^{-x} \\cr x &= \\sqrt{3 - e^{-x}} \\end{aligned}Writing this in iterative form yields the required equation:\\begin{aligned} x_{n+1} = \\sqrt{3 - e^{-x_n}} \\end{aligned}",
                        "Calculate $x_2$ by substituting $x_1 = 1.5$ into the formula:\\begin{aligned} x_2 &= \\sqrt{3 - e^{-1.5}} \\cr &\\approx \\sqrt{3 - 0.2231} \\cr &= \\sqrt{2.7769} \\cr &\\approx 1.6664 \\end{aligned}",
                        "Calculate $x_3$ by substituting $x_2 \\approx 1.666394$ (using full calculator precision):\\begin{aligned} x_3 &= \\sqrt{3 - e^{-1.666394}} \\cr &\\approx \\sqrt{3 - 0.1889} \\cr &= \\sqrt{2.8111} \\cr &\\approx 1.6766 \\end{aligned}",
                        "Calculate $x_4$ by substituting $x_3 \\approx 1.676626$:\\begin{aligned} x_4 &= \\sqrt{3 - e^{-1.676626}} \\cr &\\approx \\sqrt{3 - 0.1870} \\cr &= \\sqrt{2.8130} \\cr &\\approx 1.6772 \\end{aligned}",
                        "Final Answer: \\begin{aligned} x_2 &\\approx 1.6664 \\cr x_3 &\\approx 1.6766 \\cr x_4 &\\approx 1.6772 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} x_2 &\\approx 1.6664 \\cr x_3 &\\approx 1.6772 \\cr x_4 &\\approx 1.6775 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} x_2 &\\approx 1.6664 \\cr x_3 &\\approx 1.6766 \\cr x_4 &\\approx 1.6912 \\end{aligned}",
                                "feedback": "Check your calculations for $x_4$. Substituting $x_3 \\approx 1.6766$ into the formula yields $\\sqrt{2.8130} \\approx 1.6772$, not $1.6912$."
                        },
                        {
                                "ans": "\\begin{aligned} x_2 &\\approx 1.6664 \\cr x_3 &\\approx 1.5831 \\cr x_4 &\\approx 1.6772 \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>The equation $f(x) = 0$ is to be solved, where $f(x) = e^x - 5x^3$.<br><br>1. Show that the Newton-Raphson formula for this equation can be written in the form:\\begin{aligned} &x_{n+1} \\cr &\\quad = \\dfrac{e^{x_n}(x_n - 1) - 10x_n^3}{e^{x_n} - 15x_n^2} \\end{aligned}2. Using the starting value $x_1 = 0.8$, find the values of $x_2$ and $x_3$ correct to $4$ decimal places.",
                "steps": [
                        "Find the derivative of $f(x) = e^x - 5x^3$:\\begin{aligned} f'(x) = e^x - 15x^2 \\end{aligned}The general Newton-Raphson formula is:\\begin{aligned} x_{n+1} = x_n - \\dfrac{f(x_n)}{f'(x_n)} \\end{aligned}",
                        "Substitute $f(x_n)$ and $f'(x_n)$ into the formula:\\begin{aligned} &x_{n+1} \\cr &\\quad = x_n - \\dfrac{e^{x_n} - 5x_n^3}{e^{x_n} - 15x_n^2} \\end{aligned}Combining over a common denominator, the numerator simplifies to:\\begin{aligned} &x_n(e^{x_n} - 15x_n^2) - (e^{x_n} - 5x_n^3) \\cr &\\quad = x_n e^{x_n} - 15x_n^3 - e^{x_n} + 5x_n^3 \\cr &\\quad = e^{x_n}(x_n - 1) - 10x_n^3 \\end{aligned}Thus, the formula becomes:\\begin{aligned} &x_{n+1} \\cr &\\quad = \\dfrac{e^{x_n}(x_n - 1) - 10x_n^3}{e^{x_n} - 15x_n^2} \\end{aligned}",
                        "Calculate $x_2$ using the starting value $x_1 = 0.8$:\\begin{aligned} f(0.8) &= e^{0.8} - 5(0.8)^3 \\cr &\\approx 2.2255 - 2.5600 \\cr &= -0.3345 \\cr f'(0.8) &= e^{0.8} - 15(0.8)^2 \\cr &\\approx 2.2255 - 9.6000 \\cr &= -7.3745 \\cr x_2 &= 0.8 - \\dfrac{-0.3345}{-7.3745} \\cr &\\approx 0.8 - 0.0454 \\cr &= 0.7546 \\end{aligned}",
                        "Calculate $x_3$ using $x_2 = 0.7546$:\\begin{aligned} f(0.7546) &= e^{0.7546} - 5(0.7546)^3 \\cr &\\approx 2.1267 - 2.1465 \\cr &= -0.0198 \\cr f'(0.7546) &= e^{0.7546} - 15(0.7546)^2 \\cr &\\approx 2.1267 - 8.5410 \\cr &= -6.4143 \\cr x_3 &= 0.7546 - \\dfrac{-0.0198}{-6.4143} \\cr &\\approx 0.7546 - 0.0031 \\cr &= 0.7515 \\end{aligned}",
                        "Final Answer: \\begin{aligned} x_2 &\\approx 0.7546 \\cr x_3 &\\approx 0.7515 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} x_2 &\\approx 0.7546 \\cr x_3 &\\approx 0.7577 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} x_2 &\\approx 0.8454 \\cr x_3 &\\approx 0.7515 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} x_2 &\\approx 0.7546 \\cr x_3 &\\approx 0.7512 \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>Solve the equation:\\begin{aligned} \\sec^2 \\theta + 3\\tan \\theta = 5 \\end{aligned}for $0^\\circ \\le \\theta \\le 360^\\circ$, giving your answers correct to $1$ decimal place where appropriate.",
                "steps": [
                        "Use the fundamental trigonometric identity $\\sec^2 \\theta = 1 + \\tan^2 \\theta$ to write the entire equation in terms of $\\tan \\theta$:\\begin{aligned} (1 + \\tan^2 \\theta) + 3\\tan \\theta = 5 \\end{aligned}",
                        "Rearrange the equation to form a standard quadratic equation in $\\tan \\theta$:\\begin{aligned} \\tan^2 \\theta + 3\\tan \\theta - 4 = 0 \\end{aligned}",
                        "Factorise the quadratic equation:\\begin{aligned} (\\tan \\theta + 4)(\\tan \\theta - 1) = 0 \\end{aligned}This gives two possible values for $\\tan \\theta$:\\begin{aligned} \\tan \\theta &= 1 \\cr \\tan \\theta &= -4 \\end{aligned}",
                        "Solve for the first case, $\\tan \\theta = 1$, in the domain $0^\\circ \\le \\theta \\le 360^\\circ$:\\begin{aligned} \\theta &= \\tan^{-1}(1) \\cr &= 45.0^\\circ, \\, 225.0^\\circ \\end{aligned}",
                        "Solve for the second case, $\\tan \\theta = -4$, in the domain $0^\\circ \\le \\theta \\le 360^\\circ$:<br><br>The principal value is $\\theta \\approx -75.96^\\circ$. Find the positive solutions within the required domain:\\begin{aligned} \\theta &= 180^\\circ - 75.96^\\circ \\cr &= 104.0^\\circ \\cr \\theta &= 360^\\circ - 75.96^\\circ \\cr &= 284.0^\\circ \\end{aligned}Combining all solutions gives the final set of answers.",
                        "Final Answer: \\begin{aligned} \\theta &= 45.0^\\circ, \\, 104.0^\\circ, \\cr &\\quad 225.0^\\circ, \\, 284.0^\\circ \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} \\theta &= 45.0^\\circ, \\, 225.0^\\circ, \\cr &\\quad 284.0^\\circ \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\theta &= 45.0^\\circ, \\, 76.0^\\circ, \\cr &\\quad 225.0^\\circ, \\, 256.0^\\circ \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\theta = 45.0^\\circ, \\, 225.0^\\circ \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>Solve the equation:\\begin{aligned} 2\\text{cosec}^2 \\theta + 5\\cot \\theta = 5 \\end{aligned}for $0^\\circ \\le \\theta \\le 360^\\circ$, giving your answers correct to $1$ decimal place where appropriate.",
                "steps": [
                        "Use the cosecant-cotangent identity $\\csc^2 \\theta = 1 + \\cot^2 \\theta$ to rewrite the equation in terms of $\\cot \\theta$:\\begin{aligned} 2(1 + \\cot^2 \\theta) + 5\\cot \\theta = 5 \\end{aligned}",
                        "Expand and rearrange to form a standard quadratic equation:\\begin{aligned} 2 + 2\\cot^2 \\theta + 5\\cot \\theta &= 5 \\cr 2\\cot^2 \\theta + 5\\cot \\theta - 3 &= 0 \\end{aligned}",
                        "Factorise the quadratic expression:\\begin{aligned} (2\\cot \\theta - 1)(\\cot \\theta + 3) &= 0 \\cr \\cot \\theta &= 0.5 \\cr \\cot \\theta &= -3 \\end{aligned}",
                        "Solve the first branch, $\\cot \\theta = 0.5$, which is equivalent to $\\tan \\theta = 2$:\\begin{aligned} \\theta &= \\tan^{-1}(2) \\cr &\\approx 63.4^\\circ, \\, 243.4^\\circ \\end{aligned}",
                        "Solve the second branch, $\\cot \\theta = -3$, which is equivalent to $\\tan \\theta = -\\dfrac{1}{3}$:<br><br>The principal value is $\\theta \\approx -18.4^\\circ$. Finding the positive solutions in the domain:\\begin{aligned} \\theta &= 180^\\circ - 18.4^\\circ \\cr &= 161.6^\\circ \\cr \\theta &= 360^\\circ - 18.4^\\circ \\cr &= 341.6^\\circ \\end{aligned}Combining all solutions yields the final set of answers.",
                        "Final Answer: \\begin{aligned} \\theta &= 63.4^\\circ, \\, 161.6^\\circ, \\cr &\\quad 243.4^\\circ, \\, 341.6^\\circ \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} \\theta &= 63.4^\\circ, \\, 243.4^\\circ, \\cr &\\quad 341.6^\\circ \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\theta &= 26.6^\\circ, \\, 161.6^\\circ, \\cr &\\quad 206.6^\\circ, \\, 341.6^\\circ \\end{aligned}",
                                "feedback": "When taking the reciprocal of $\\cot \\theta = 0.5$, you must solve $\\tan \\theta = 2$. It seems you may have mistakenly solved $\\tan \\theta = 0.5$, which yields $\\theta \\approx 26.6^\\circ$."
                        },
                        {
                                "ans": "\\begin{aligned} \\theta &= 63.4^\\circ, \\, 161.6^\\circ, \\cr &\\quad 243.4^\\circ \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>Solve the equation:\\begin{aligned} 3\\cos 2\\theta - \\sin \\theta = 2 \\end{aligned}for $0^\\circ \\le \\theta \\le 360^\\circ$, giving your answers correct to $1$ decimal place where appropriate.",
                "steps": [
                        "Use the double-angle cosine identity $\\cos 2\\theta = 1 - 2\\sin^2 \\theta$ to write the equation in terms of $\\sin \\theta$:\\begin{aligned} 3(1 - 2\\sin^2 \\theta) - \\sin \\theta = 2 \\end{aligned}",
                        "Expand, simplify, and rearrange the terms into a standard quadratic form:\\begin{aligned} 3 - 6\\sin^2 \\theta - \\sin \\theta &= 2 \\cr -6\\sin^2 \\theta - \\sin \\theta + 1 &= 0 \\cr 6\\sin^2 \\theta + \\sin \\theta - 1 &= 0 \\end{aligned}",
                        "Factorise the quadratic equation:\\begin{aligned} (3\\sin \\theta - 1)(2\\sin \\theta + 1) = 0 \\end{aligned}This gives two possible values for $\\sin \\theta$:\\begin{aligned} \\sin \\theta &= \\dfrac{1}{3} \\cr \\sin \\theta &= -\\dfrac{1}{2} \\end{aligned}",
                        "Solve the first case, $\\sin \\theta = \\dfrac{1}{3}$, in the domain $0^\\circ \\le \\theta \\le 360^\\circ$:\\begin{aligned} \\theta &= \\sin^{-1}\\big(\\dfrac{1}{3}\\big) \\cr &\\approx 19.5^\\circ, \\, 160.5^\\circ \\end{aligned}",
                        "Solve the second case, $\\sin \\theta = -\\dfrac{1}{2}$, in the domain $0^\\circ \\le \\theta \\le 360^\\circ$:<br><br>The principal value is $\\theta = -30.0^\\circ$. The positive angles within the domain are:\\begin{aligned} \\theta &= 180^\\circ - (-30.0^\\circ) \\cr &= 210.0^\\circ \\cr \\theta &= 360^\\circ + (-30.0^\\circ) \\cr &= 330.0^\\circ \\end{aligned}Combining all solutions gives the final set of answers.",
                        "Final Answer: \\begin{aligned} \\theta &= 19.5^\\circ, \\, 160.5^\\circ, \\cr &\\quad 210.0^\\circ, \\, 330.0^\\circ \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} \\theta &= 19.5^\\circ, \\, 160.5^\\circ, \\cr &\\quad 150.0^\\circ, \\, 330.0^\\circ \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\theta &= 19.5^\\circ, \\, 160.5^\\circ, \\cr &\\quad 210.0^\\circ \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\theta &= 19.5^\\circ, \\, 210.0^\\circ, \\cr &\\quad 330.0^\\circ \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>Solve the equation:\\begin{aligned} 4\\sin^2 \\theta - 8\\cos \\theta = 1 \\end{aligned}for $0 \\le \\theta \\le 2\\pi$, giving your answers in terms of $\\arccos$.",
                "steps": [
                        "Use the fundamental identity $\\sin^2 \\theta = 1 - \\cos^2 \\theta$ to write the entire equation in terms of $\\cos \\theta$:\\begin{aligned} 4(1 - \\cos^2 \\theta) - 8\\cos \\theta = 1 \\end{aligned}",
                        "Expand, simplify, and rearrange the quadratic equation:\\begin{aligned} 4 - 4\\cos^2 \\theta - 8\\cos \\theta - 1 &= 0 \\cr -4\\cos^2 \\theta - 8\\cos \\theta + 3 &= 0 \\cr 4\\cos^2 \\theta + 8\\cos \\theta - 3 &= 0 \\end{aligned}",
                        "Since the quadratic expression does not factorise cleanly, apply the quadratic formula to solve for $\\cos \\theta$:\\begin{aligned} &\\cos \\theta \\cr &\\quad = \\dfrac{-8 \\pm \\sqrt{8^2 - 4(4)(-3)}}{2(4)} \\cr &\\quad = \\dfrac{-8 \\pm \\sqrt{112}}{8} \\cr &\\quad = \\dfrac{-8 \\pm 4\\sqrt{7}}{8} \\cr &\\quad = \\dfrac{-2 \\pm \\sqrt{7}}{2} \\end{aligned}",
                        "Determine the valid branch of solutions by checking the range constraint of cosine, $-1 \\le \\cos \\theta \\le 1$:\\begin{aligned} \\dfrac{-2 - \\sqrt{7}}{2} &\\approx -2.32 \\quad \\text{(outside range)} \\cr \\dfrac{-2 + \\sqrt{7}}{2} &\\approx 0.32 \\quad \\text{(within range)} \\end{aligned}Therefore, we only solve the equation for the valid branch: $\\cos \\theta = \\dfrac{-2 + \\sqrt{7}}{2}$.",
                        "Find the solutions in radians within the domain $0 \\le \\theta \\le 2\\pi$:\\begin{aligned} \\theta &= \\arccos\\big(\\dfrac{-2 + \\sqrt{7}}{2}\\big) \\cr \\theta &= 2\\pi - \\arccos\\big(\\dfrac{-2 + \\sqrt{7}}{2}\\big) \\end{aligned}",
                        "Final Answer: \\begin{aligned} \\theta &= \\arccos\\big(\\dfrac{-2 + \\sqrt{7}}{2}\\big), \\cr &\\quad 2\\pi - \\arccos\\big(\\dfrac{-2 + \\sqrt{7}}{2}\\big) \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} \\theta &= \\arccos\\big(\\dfrac{-2 - \\sqrt{7}}{2}\\big), \\cr &\\quad \\arccos\\big(\\dfrac{-2 + \\sqrt{7}}{2}\\big) \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\theta &= \\arccos\\big(\\dfrac{-2 + \\sqrt{7}}{2}\\big), \\cr &\\quad \\pi - \\arccos\\big(\\dfrac{-2 + \\sqrt{7}}{2}\\big) \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\theta = \\arccos\\big(\\dfrac{-2 + \\sqrt{7}}{2}\\big) \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>Solve the equation:\\begin{aligned} 3\\sin 2\\theta = 4\\cos \\theta \\end{aligned}for $0^\\circ \\le \\theta \\le 360^\\circ$, giving your answers correct to $1$ decimal place where appropriate.",
                "steps": [
                        "Use the double-angle sine identity $\\sin 2\\theta = 2\\sin \\theta \\cos \\theta$ to expand the left-hand side:\\begin{aligned} 3(2\\sin \\theta \\cos \\theta) = 4\\cos \\theta \\end{aligned}",
                        "Bring all terms to one side of the equation:\\begin{aligned} 6\\sin \\theta \\cos \\theta - 4\\cos \\theta = 0 \\end{aligned}",
                        "Factorise out the common term $2\\cos \\theta$:\\begin{aligned} 2\\cos \\theta(3\\sin \\theta - 2) = 0 \\end{aligned}This gives two branches to solve:\\begin{aligned} \\cos \\theta &= 0 \\cr \\sin \\theta &= \\dfrac{2}{3} \\end{aligned}",
                        "Solve the first branch, $\\cos \\theta = 0$, in the domain $0^\\circ \\le \\theta \\le 360^\\circ$:\\begin{aligned} \\theta = 90.0^\\circ, \\, 270.0^\\circ \\end{aligned}",
                        "Solve the second branch, $\\sin \\theta = \\dfrac{2}{3}$, in the domain $0^\\circ \\le \\theta \\le 360^\\circ$:\\begin{aligned} \\theta &= \\sin^{-1}\\big(\\dfrac{2}{3}\\big) \\cr &\\approx 41.8^\\circ \\cr \\theta &= 180^\\circ - 41.8^\\circ \\cr &= 138.2^\\circ \\end{aligned}Combining all solutions yields the final set of answers.",
                        "Final Answer: \\begin{aligned} \\theta &= 41.8^\\circ, \\, 90.0^\\circ, \\cr &\\quad 138.2^\\circ, \\, 270.0^\\circ \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} \\theta = 41.8^\\circ, \\, 138.2^\\circ \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\theta &= 41.8^\\circ, \\, 90.0^\\circ, \\cr &\\quad 221.8^\\circ, \\, 270.0^\\circ \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\theta = 90.0^\\circ, \\, 270.0^\\circ \\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "The curve intersects the $x$-axis at the boundaries $x = 1$ and $x = c$. To find the exact area, set up the definite integral of the function over this interval:\\begin{aligned} A = \\int_{1}^{c} (c - x)\\ln x \\text{d}x \\end{aligned}We can split this into two separate integrals to simplify the integration by parts:\\begin{aligned} A &= c \\int_{1}^{c} \\ln x \\text{d}x - \\int_{1}^{c} x\\ln x \\text{d}x \\cr &= c I_1 - I_2 \\end{aligned}",
                        "Evaluate the first integral $I_1 = \\int_{1}^{c} \\ln x \\text{d}x$ using integration by parts, where $u = \\ln x$ and $v' = 1$:\\begin{aligned} u &= \\ln x \\implies u' = \\dfrac{1}{x} \\cr v' &= 1 \\implies v = x \\cr \\int \\ln x \\text{d}x &= x\\ln x - \\int 1 \\text{d}x \\cr &= x\\ln x - x + C \\end{aligned}",
                        "Evaluate the definite limits for $I_1$ from $1$ to $c$:\\begin{aligned} I_1 &= \\Big[ x\\ln x - x \\Big]_{1}^{c} \\cr &= (c\\ln c - c) - (1\\ln 1 - 1) \\cr &= c\\ln c - c + 1 \\end{aligned}",
                        "Evaluate the second integral $I_2 = \\int_{1}^{c} x\\ln x \\text{d}x$ using integration by parts, where $u = \\ln x$ and $v' = x$:\\begin{aligned} u &= \\ln x \\implies u' = \\dfrac{1}{x} \\cr v' &= x \\implies v = \\dfrac{x^2}{2} \\cr \\int x\\ln x \\text{d}x &= \\dfrac{x^2}{2}\\ln x - \\int \\dfrac{x}{2} \\text{d}x \\cr &= \\dfrac{x^2}{2}\\ln x - \\dfrac{x^2}{4} + C \\end{aligned}",
                        "Evaluate the definite limits for $I_2$ from $1$ to $c$:\\begin{aligned} I_2 &= \\left[ \\dfrac{x^2}{2}\\ln x - \\dfrac{x^2}{4} \\right]_{1}^{c} \\cr &= \\big( \\dfrac{c^2}{2}\\ln c - \\dfrac{c^2}{4} \\big) - \\big( \\dfrac{1}{2}\\ln 1 - \\dfrac{1}{4} \\big) \\cr &= \\dfrac{c^2}{2}\\ln c - \\dfrac{c^2}{4} + \\dfrac{1}{4} \\end{aligned}",
                        "Assemble and simplify the terms to find the total area $A = c I_1 - I_2$:\\begin{aligned} A &= c(c\\ln c - c + 1) \\cr &\\quad - \\big( \\dfrac{c^2}{2}\\ln c - \\dfrac{c^2}{4} + \\dfrac{1}{4} \\big) \\cr &= c^2\\ln c - c^2 + c \\cr &\\quad - \\dfrac{c^2}{2}\\ln c + \\dfrac{c^2}{4} - \\dfrac{1}{4} \\cr &= \\dfrac{c^2}{2}\\ln c - \\dfrac{3c^2}{4} + c - \\dfrac{1}{4} \\end{aligned}",
                        "Final Answer: \\begin{aligned} \\dfrac{c^2}{2}\\ln c - \\dfrac{3c^2}{4} + c - \\dfrac{1}{4} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} \\dfrac{c^2}{2}\\ln c - \\dfrac{c^2}{4} + c - \\dfrac{1}{4} \\end{aligned}",
                                "feedback": "Check your collection of the $-c^2$ terms. Combining $-c^2 + \\dfrac{c^2}{4}$ yields $-\\dfrac{3c^2}{4}$, not $-\\dfrac{c^2}{4}$."
                        },
                        {
                                "ans": "\\begin{aligned} \\dfrac{c^2}{2}\\ln c - \\dfrac{3c^2}{4} + c + \\dfrac{1}{4} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} c^2\\ln c - \\dfrac{3c^2}{4} + c - \\dfrac{1}{4} \\end{aligned}",
        ...
        },
        {
               ...
               "major_area": "Integration",
                ...
                "steps": [
                        "Set up the definite integral for the area bounded by the curve, $x = 1$, and $x = e$:\\begin{aligned} A &= \\int_{1}^{e} 3x^2 \\ln x \\text{d}x \\cr &= 3 \\int_{1}^{e} x^2 \\ln x \\text{d}x \\end{aligned}",
                        "Evaluate the indefinite integral $\\int x^2 \\ln x \\text{d}x$ using integration by parts, where $u = \\ln x$ and $v' = x^2$:\\begin{aligned} u &= \\ln x \\implies u' = \\dfrac{1}{x} \\cr v' &= x^2 \\implies v = \\dfrac{x^3}{3} \\cr \\int x^2 \\ln x \\text{d}x &= \\dfrac{x^3}{3}\\ln x - \\int \\dfrac{x^2}{3} \\text{d}x \\cr &= \\dfrac{x^3}{3}\\ln x - \\dfrac{x^3}{9} + C \\end{aligned}",
                        "Multiply the indefinite integral by the coefficient $3$ before substituting the limits:\\begin{aligned} 3 \\int x^2 \\ln x \\text{d}x &= 3\\big( \\dfrac{x^3}{3}\\ln x - \\dfrac{x^3}{9} \\big) \\cr &= x^3\\ln x - \\dfrac{x^3}{3} \\end{aligned}",
                        "Evaluate the definite integral using the upper limit $x = e$ and the lower limit $x = 1$:\\begin{aligned} A &= \\left[ x^3\\ln x - \\dfrac{x^3}{3} \\right]_{1}^{e} \\cr &= \\big( e^3\\ln e - \\dfrac{e^3}{3} \\big) - \\big( 1^3\\ln 1 - \\dfrac{1}{3} \\big) \\cr &= \\big( e^3 - \\dfrac{e^3}{3} \\big) - \\big( 0 - \\dfrac{1}{3} \\big) \\cr &= \\dfrac{2e^3}{3} + \\dfrac{1}{3} \\cr &= \\dfrac{2e^3 + 1}{3} \\end{aligned}",
                        "Final Answer: \\begin{aligned} \\dfrac{2e^3 + 1}{3} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} \\dfrac{2e^3 - 1}{3} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\dfrac{2e^3 + 1}{9} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} e^3\\ln e - \\dfrac{e^3}{3} \\end{aligned}",
        ...
        },
        {
                ...
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} -3e^{-4} - e^{-2} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} e^{-2} + 3e^{-4} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} (x - 1)e^{-x} \\end{aligned}",
        ...
        },
        {
                ...
                "steps": [
                        "Set up the definite integral for the area under the curve from $x = 0$ to $x = \\dfrac{1}{2}\\pi$:\\begin{aligned} A = \\int_{0}^{\\frac{1}{2}\\pi} x \\cos x \\text{d}x \\end{aligned}",
                        "Evaluate the indefinite integral $\\int x \\cos x \\text{d}x$ using integration by parts, where $u = x$ and $v' = \\cos x$:\\begin{aligned} u &= x \\implies u' = 1 \\cr v' &= \\cos x \\implies v = \\sin x \\cr \\int x \\cos x \\text{d}x &= x\\sin x - \\int \\sin x \\text{d}x \\cr &= x\\sin x + \\cos x + C \\end{aligned}",
                        "Evaluate the definite integral using the upper limit $x = \\dfrac{1}{2}\\pi$ and the lower limit $x = 0$:\\begin{aligned} A &= \\Big[ x\\sin x + \\cos x \\Big]_{0}^{\\frac{1}{2}\\pi} \\cr &= \\big( \\dfrac{1}{2}\\pi\\sin\\big(\\dfrac{1}{2}\\pi\\big) + \\cos\\big(\\dfrac{1}{2}\\pi\\big) \\big) \\cr &\\quad - (0\\sin 0 + \\cos 0) \\cr &= \\big(\\dfrac{1}{2}\\pi(1) + 0\\big) - (0 + 1) \\cr &= \\dfrac{1}{2}\\pi - 1 \\end{aligned}",
                        "Final Answer: \\begin{aligned} \\dfrac{1}{2}\\pi - 1 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} \\dfrac{1}{2}\\pi + 1 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} \\dfrac{1}{2}\\pi \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} x\\sin x - \\cos x + C \\end{aligned}",
        ...
        },
        {
                ...
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} y &= \\dfrac{x}{e} \\cr \\text{Area} &= 1 - \\dfrac{e}{2} + \\dfrac{1}{e} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} y &= \\dfrac{x}{e} \\cr \\text{Area} &= \\dfrac{e}{2} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} y &= \\dfrac{x}{e} \\cr \\text{Area} &= \\dfrac{e}{2} + 1 \\end{aligned}",
        ...
        },
        {
                ...
                "question": "In this question you must show detailed reasoning.<br><br>The circle $C$ has equation:\\begin{aligned} (x - 2)^2 + (y - 1)^2 = 25 \\end{aligned}The point $A(6, 4)$ lies on the circle. The tangent to the circle at $A$ intersects the line $4y = 3x - 27$ at the point $D$.<br><br>1. Write down the coordinates of $C$, the centre of the circle.<br><br>2. Show that the line $4y = 3x - 27$ is a tangent to the circle, and find the coordinates of $B$, the point where this line touches the circle.<br><br>3. Prove that $ADBC$ is a square.<br><br>4. The point $E$ is the lowest point on the circle. Find the exact area of the sector $ECB$.",
                "steps": [
                        "Identify the centre and the radius of the circle directly from its standard form $(x - x_0)^2 + (y - y_0)^2 = R^2$\\begin{aligned} \\text{Centre: } &C(2, 1) \\cr \\text{Radius: } &R = 5 \\end{aligned}",
                        "Write the line equation in standard linear form $ax + by + c = 0$:\\begin{aligned} 4y &= 3x - 27 \\cr 3x - 4y - 27 &= 0 \\end{aligned}Show the line is a tangent by finding the perpendicular distance from the centre $C(2,1)$ to this line and verifying it equals the radius:\\begin{aligned} &\\text{Distance} \\cr &\\quad = \\dfrac{|3(2) - 4(1) - 27|}{\\sqrt{3^2 + (-4)^2}} \\cr &\\quad = \\dfrac{|6 - 4 - 27|}{5} \\cr &\\quad = \\dfrac{25}{5} \\cr &\\quad = 5 \\end{aligned}Since the perpendicular distance is exactly $5$ (equal to the radius), the line is indeed a tangent.",
                        "To find the point of contact $B$, solve the system of equations by substituting $y = \\dfrac{3x - 27}{4}$ into the circle equation and multiplying by $16$ to clear the denominator:\\begin{aligned} &(x - 2)^2 + \\big( \\dfrac{3x - 31}{4} \\big)^2 = 25 \\cr &16(x - 2)^2 + (3x - 31)^2 = 400 \\cr &16(x^2 - 4x + 4) \\cr &\\quad + (9x^2 - 186x + 961) = 400 \\cr &25x^2 - 250x + 625 = 0 \\cr &x^2 - 10x + 25 = 0 \\cr &(x - 5)^2 = 0 \\cr &x = 5 \\end{aligned}",
                        "Substitute $x = 5$ back into the line equation to find the $y$-coordinate of $B$:\\begin{aligned} y &= \\dfrac{3(5) - 27}{4} \\cr &= \\dfrac{15 - 27}{4} \\cr &= -3 \\end{aligned}So, the point of contact is $B(5, -3)$.",
                        "To prove $ADBC$ is a square, find the equation of the tangent at $A(6,4)$. The gradient of the radius $CA$ is:\\begin{aligned} m_{CA} &= \\dfrac{4 - 1}{6 - 2} \\cr &= \\dfrac{3}{4} \\end{aligned}Since the tangent is perpendicular to the radius, its gradient is $m_{\\text{tangent}} = -\\dfrac{4}{3}$. Use the point-gradient formula with $A(6,4)$ to find its equation:\\begin{aligned} y - 4 &= -\\dfrac{4}{3}(x - 6) \\cr y &= -\\dfrac{4}{3}x + 12 \\end{aligned}",
                        "Find the intersection point $D$ of the two tangents by substituting the equation of the tangent at $A$ into the tangent at $B$:\\begin{aligned} 4\\big(-\\dfrac{4}{3}x + 12\\big) &= 3x - 27 \\cr -\\dfrac{16}{3}x + 48 &= 3x - 27 \\cr -16x + 144 &= 9x - 81 \\cr -25x &= -225 \\cr x &= 9 \\cr y &= -\\dfrac{4}{3}(9) + 12 \\cr &= 0 \\end{aligned}This gives the coordinates of $D(9, 0)$.",
                        "Calculate all four side lengths using the distance formula:\\begin{aligned} |AD| &= \\sqrt{3^2 + (-4)^2} = 5 \\cr |DB| &= \\sqrt{(-4)^2 + (-3)^2} = 5 \\cr |BC| &= \\sqrt{(-3)^2 + 4^2} = 5 \\cr |CA| &= \\sqrt{4^2 + 3^2} = 5 \\end{aligned}Adjacent sides are perpendicular since:\\begin{aligned} m_{AD} \\cdot m_{DB} &= -\\dfrac{4}{3} \\cdot \\dfrac{3}{4} \\cr &= -1 \\end{aligned}Since all four sides are equal to $5$ and adjacent sides are perpendicular, $ADBC$ is a square.",
                        "Find the coordinates of $E$, the lowest point of the circle, by subtracting the radius from the $y$-coordinate of the centre:\\begin{aligned} E &= (2, 1 - 5) \\cr &= (2, -4) \\end{aligned}Find the angle $\\theta = \\angle ECB$ using the dot product of vectors $\\mathbf{CE} = \\begin{pmatrix} 0 \\cr -5 \\end{pmatrix}$ and $\\mathbf{CB} = \\begin{pmatrix} 3 \\cr -4 \\end{pmatrix}$:\\begin{aligned} \\mathbf{CE} \\cdot \\mathbf{CB} &= 0(3) + (-5)(-4) \\cr &= 20 \\cr \\cos \\theta &= \\dfrac{20}{5 \\cdot 5} \\cr &= \\dfrac{4}{5} \\cr \\theta &= \\arccos\\big(\\dfrac{4}{5}\\big) \\end{aligned}",
                        "Calculate the exact area of the sector $ECB$ using the sector area formula, $A = \\dfrac{1}{2}r^2 \\theta$:\\begin{aligned} \\text{Area} &= \\dfrac{1}{2}(25)\\arccos\\big(\\dfrac{4}{5}\\big) \\cr &= \\dfrac{25}{2}\\arccos\\big(\\dfrac{4}{5}\\big) \\end{aligned}",
                        "Final Answer: \\begin{aligned} C(2, 1), \\quad &B(5, -3) \\cr \\text{Area} &= \\dfrac{25}{2}\\arccos\\big(\\dfrac{4}{5}\\big) \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} C(2, 1), \\quad &B(5, -3) \\cr \\text{Area} &= 25\\arccos\\big(\\dfrac{4}{5}\\big) \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} C(2, 1), \\quad &B(5, 3) \\cr \\text{Area} &= \\dfrac{25}{2}\\arccos\\big(\\dfrac{4}{5}\\big) \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>A circle has equation:\\begin{aligned} (x - 1)^2 + (y - 2)^2 = 5 \\end{aligned}1. Show that the line $y = 2x - 5$ is a tangent to the circle.<br><br>2. Find the coordinates of the point of contact, $P$, where this line touches the circle.",
                "steps": [
                        "Identify the centre and the radius of the circle directly from its standard form $(x - x_0)^2 + (y - y_0)^2 = R^2$:\\begin{aligned} \\text{Centre: } &(1, 2) \\cr \\text{Radius: } &R = \\sqrt{5} \\end{aligned}",
                        "Write the line equation in standard linear form $ax + by + c = 0$:\\begin{aligned} y &= 2x - 5 \\cr 2x - y - 5 &= 0 \\end{aligned}To show the line is a tangent, calculate the perpendicular distance from the centre $(1,2)$ to the line and check if it equals the radius:\\begin{aligned} \\text{Distance} &= \\dfrac{|2(1) - 2 - 5|}{\\sqrt{2^2 + (-1)^2}} \\cr &= \\dfrac{|-5|}{\\sqrt{5}} \\cr &= \\dfrac{5}{\\sqrt{5}} \\cr &= \\sqrt{5} \\end{aligned}Since the perpendicular distance from the centre to the line is exactly equal to the radius, the line is indeed a tangent to the circle.",
                        "To find the point of contact $P$, substitute $y = 2x - 5$ into the equation of the circle:\\begin{aligned} &(x - 1)^2 + (2x - 7)^2 = 5 \\cr & (x^2 - 2x + 1)\\cr & \\quad \\quad+ (4x^2 - 28x + 49) = 5 \\cr & 5x^2 - 30x + 50 = 5 \\cr & 5x^2 - 30x + 45 = 0 \\end{aligned}",
                        "Divide the quadratic equation by $5$ and solve for $x$:\\begin{aligned} x^2 - 6x + 9 &= 0 \\cr (x - 3)^2 &= 0 \\cr x &= 3 \\end{aligned}Since there is a repeated root at $x = 3$, it confirms there is exactly one point of contact, supporting the proof of tangency.",
                        "Substitute $x = 3$ back into the line equation to find the $y$-coordinate of $P$:\\begin{aligned} y &= 2(3) - 5 \\cr &= 1 \\end{aligned}So, the coordinates of the point of contact are $P(3, 1)$.",
                        "Final Answer: \\begin{aligned} P(3, 1) \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} P(3, -1) \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} P(3, 5) \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>The points $A(1, 2)$ and $B(7, 10)$ are the endpoints of a diameter of a circle $C$.<br><br>1. Find the coordinates of the centre of the circle.<br><br>2. Find the exact radius of the circle, and hence write down the equation of the circle in the form $(x - a)^2 + (y - b)^2 = r^2$.<br><br>3. Find the equation of the tangent to the circle at the point $B$, giving your answer in the form $ax + by + c = 0$, where $a, b, c$ are integers.",
                "steps": [
                        "The centre of the circle is the midpoint of the diameter $AB$. Use the midpoint formula:\\begin{aligned} \\text{Centre} &= \\big( \\dfrac{1 + 7}{2}, \\, \\dfrac{2 + 10}{2} \\big) \\cr &= (4, 6) \\end{aligned}",
                        "The radius $r$ is the distance from the centre $(4,6)$ to endpoint $A(1,2)$:\\begin{aligned} r &= \\sqrt{(1 - 4)^2 + (2 - 6)^2} \\cr &= \\sqrt{(-3)^2 + (-4)^2} \\cr &= \\sqrt{9 + 16} \\cr &= 5 \\end{aligned}",
                        "Write down the equation of the circle using the centre $(4,6)$ and radius $r = 5$:\\begin{aligned} (x - 4)^2 + (y - 6)^2 = 25 \\end{aligned}",
                        "To find the tangent at $B(7,10)$, calculate the gradient of the radius $CB$:\\begin{aligned} m_{CB} &= \\dfrac{10 - 6}{7 - 4} \\cr &= \\dfrac{4}{3} \\end{aligned}Since the tangent is perpendicular to the radius at the point of contact, its gradient is the negative reciprocal:\\begin{aligned} m_{\\text{tangent}} = -\\dfrac{3}{4} \\end{aligned}",
                        "Use the point-gradient formula with $B(7,10)$ to obtain the tangent equation and rearrange it into integer standard form:\\begin{aligned} y - 10 &= -\\dfrac{3}{4}(x - 7) \\cr 4(y - 10) &= -3(x - 7) \\cr 4y - 40 &= -3x + 21 \\cr 3x + 4y - 61 &= 0 \\end{aligned}",
                        "Final Answer: \\begin{aligned} (x - 4)^2 + (y - 6)^2 &= 25 \\cr 3x + 4y - 61 &= 0 \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} (x - 4)^2 + (y - 6)^2 &= 25 \\cr 3x - 4y + 19 &= 0 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} (x - 4)^2 + (y - 6)^2 &= 25 \\cr 4x + 3y - 68 &= 0 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} (x + 4)^2 + (y + 6)^2 &= 25 \\cr 3x + 4y - 61 &= 0 \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>A circle has the equation:\\begin{aligned} (x - 2)^2 + (y - 3)^2 = 25 \\end{aligned}1. Show that the line $y = x + 2$ intersects the circle at two distinct points, $P$ and $Q$.<br><br>2. Find the coordinates of $P$ and $Q$.<br><br>3. Calculate the exact length of the chord $PQ$.",
                "steps": [
                        "Substitute $y = x + 2$ into the circle equation to find the $x$-coordinates of the intersection points:\\begin{aligned} &(x - 2)^2 + (x - 1)^2 = 25 \\cr & (x^2 - 4x + 4) \\cr &\\quad + (x^2 - 2x + 1) = 25 \\cr & 2x^2 - 6x + 5 = 25 \\cr & 2x^2 - 6x - 20 = 0 \\end{aligned}",
                        "Divide by $2$ to simplify the quadratic equation:\\begin{aligned} x^2 - 3x - 10 = 0 \\end{aligned}Calculate the discriminant ($b^2 - 4ac$) to show there are two distinct real roots (intersections):\\begin{aligned} \\text{Discriminant} &= (-3)^2 - 4(1)(-10) \\cr &= 9 + 40 \\cr &= 49 \\end{aligned}Since the discriminant $49 > 0$, the equation has two real roots, proving the line intersects the circle at two distinct points.",
                        "Solve the quadratic equation by factorisation:\\begin{aligned} (x - 5)(x + 2) &= 0 \\cr x &= 5 \\cr x &= -2 \\end{aligned}",
                        "Substitute the $x$-values back into the line equation $y = x + 2$ to find the corresponding $y$-coordinates:\\begin{aligned} \\text{For } x &= 5: \\cr y &= 5 + 2 \\cr &= 7 \\implies P(5, 7) \\cr \\text{For } x &= -2: \\cr y &= -2 + 2 \\cr &= 0 \\implies Q(-2, 0) \\end{aligned}",
                        "Calculate the exact length of the chord $PQ$ using the distance formula:\\begin{aligned} |PQ| &= \\sqrt{(5 - (-2))^2 + (7 - 0)^2} \\cr &= \\sqrt{7^2 + 7^2} \\cr &= \\sqrt{98} \\cr &= 7\\sqrt{2} \\end{aligned}",
                        "Final Answer: \\begin{aligned} P(5, 7), \\quad &Q(-2, 0) \\cr |PQ| &= 7\\sqrt{2} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} P(5, 7), \\quad &Q(-2, 0) \\cr |PQ| &= 98 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} P(5, 7), \\quad &Q(-2, 0) \\cr |PQ| &= 14 \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} P(5, 7), \\quad &Q(2, 4) \\cr |PQ| &= 3\\sqrt{2} \\end{aligned}",
        ...
        },
        {
                ...
                "img": false,
                "question": "In this question you must show detailed reasoning.<br><br>The circle $C$ has equation:\\begin{aligned} x^2 + y^2 - 6x - 8y = 0 \\end{aligned}1. Find the coordinates of the centre and the exact radius of the circle $C$.<br><br>2. Given that the line $y = 2x + c$ is a tangent to the circle, find the two possible exact values of the constant $c$.",
                "steps": [
                        "Complete the square for both the $x$ and $y$ terms in the general equation $x^2 + y^2 - 6x - 8y = 0$:\\begin{aligned} &(x^2 - 6x) + (y^2 - 8y) = 0 \\cr &\\big((x - 3)^2 - 9\\big) \\cr &\\quad + \\big((y - 4)^2 - 16\\big) = 0 \\cr &(x - 3)^2 + (y - 4)^2 = 25 \\end{aligned}This shows that the centre is $C(3, 4)$ and the radius is $R = \\sqrt{25} = 5$.",
                        "Write the tangent line equation $y = 2x + c$ in standard form $ax + by + c = 0$:\\begin{aligned} 2x - y + c = 0 \\end{aligned}",
                        "Set the perpendicular distance from the centre $C(3, 4)$ to this line equal to the radius $5$:\\begin{aligned} \\dfrac{|2(3) - 4 + c|}{\\sqrt{2^2 + (-1)^2}} = 5 \\end{aligned}",
                        "Simplify the equation to solve for $c$:\\begin{aligned} \\dfrac{|2 + c|}{\\sqrt{5}} &= 5 \\cr |2 + c| &= 5\\sqrt{5} \\end{aligned}This gives two possible equations:\\begin{aligned} 2 + c &= 5\\sqrt{5} \\cr 2 + c &= -5\\sqrt{5} \\end{aligned}",
                        "Isolate $c$ to find the two possible exact values:\\begin{aligned} c &= -2 + 5\\sqrt{5} \\cr c &= -2 - 5\\sqrt{5} \\end{aligned}",
                        "Final Answer: \\begin{aligned} C(3, 4), \\quad &R = 5 \\cr c &= -2 \\pm 5\\sqrt{5} \\end{aligned}"
                ],
                "pi_options": [
                        {
                                "ans": "\\begin{aligned} C(3, 4), \\quad &R = 5 \\cr c &= 2 \\pm 5\\sqrt{5} \\end{aligned}",
                        ...
                        {
                                "ans": "\\begin{aligned} C(3, 4), \\quad &R = 5 \\cr c &= -2 \\pm 25 \\end{aligned}",
