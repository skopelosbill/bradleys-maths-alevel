window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Differentiate the equation of the curve using the product rule:<br><br>$$\\begin{aligned} \\dfrac{\\text{d}y}{\\text{d}x} &= 8\\cos^4 x \\cr &\\quad - 24\\sin^2 x \\cos^2 x \\cr &= 8\\cos^2 x \\big( \\cos^2 x - 3\\sin^2 x \\big) \\cr &= 8\\cos^2 x \\big[ \\cos^2 x - 3(1 - \\cos^2 x) \\big] \\cr &= 8\\cos^2 x(4\\cos^2 x - 3) \\end{aligned}$$",
