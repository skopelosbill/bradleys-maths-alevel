window.ALEVEL_QUESTIONS = [
 {
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "Find the scalar product $\\vec{AB} \\cdot \\vec{AC}$ using components:\\begin{aligned} \\vec{AB} \\cdot \\vec{AC} &= \\begin{pmatrix} 1 \\cr -2 \\cr 3 \\end{pmatrix} \\cdot \\begin{pmatrix} 3 \\cr 1 \\cr 2 \\end{pmatrix} \\cr &= (1)(3) + (-2)(1) + (3)(2) \\cr &= 3 - 2 + 6 \\cr &= 7 \\end{aligned}",
