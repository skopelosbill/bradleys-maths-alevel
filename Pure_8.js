window.ALEVEL_QUESTIONS = [
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Step 4: Sketch the curve</strong><br>Find the $y$-intercept by setting $x = 0$:<br>\\begin{aligned}\ny &= 2(0)^3 - 3(0)^2 - 12(0) + 8 \\cr\ny &= 8 \\implies (0, 8)\n\\end{aligned}<br>Sketch the positive cubic shape passing through the maximum $(-1, 15)$, the intercept $(0, 8)$, and the minimum $(2, -12)$:<br><br><img src='images/Pure/004352_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Step 4: Determine coordinate intercepts and sketch</strong><br>Find where the curve crosses the axes:<br><br><strong>To find the $y$-intercept, set $x = 0$:</strong><br>\\begin{aligned}\ny &= 12(0) - 0^3 \\cr\ny &= 0 \\implies (0, 0)\n\\end{aligned}<br><br><strong>To find the $x$-intercepts, set $y = 0$:</strong><br>\\begin{aligned}\n12x - x^3 &= 0 \\cr\nx(12 - x^2) &= 0\n\\end{aligned}<br><br>This gives the intercepts $x = 0$ or $x = \\pm\\sqrt{ 12 } \\approx \\pm 3.46$.<br>Using these features, the sketch of the curve $C$ is shown below:<br><br><img src='images/Pure/004353_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>",
        ...
        },
        {
                ...
                "steps": [
                        ...
                        "<strong>Step 3: Sketch the transformed curves</strong><br>The separate sets of axes for the original function and its two transformations are shown side-by-side below:<br><br><img src='images/Pure/004355_ans.png' style='width:100%; max-width:400px; margin: 15px auto; display:block; border: 1px solid #ccc;'></img>"
                ],
                "pi_options": [
                        {
